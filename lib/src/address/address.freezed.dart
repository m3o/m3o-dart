...
class _$_Record implements _Record {
  ...
  @override
  String toString() {
    return 'Record(street: $street, town: $town, building_name: $building_name, county: $county, locality: $locality, postcode: $postcode, premise: $premise, line_one: $line_one, line_two: $line_two, organisation: $organisation, summary: $summary)';
  }
...
abstract class _Record implements Record {
  const factory _Record(
      ...
      final String? line_two,
      final String? organisation,
      final String? summary}) = _$_Record;
