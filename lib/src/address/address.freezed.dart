...
class _$_Record implements _Record {
  ...
  @override
  String toString() {
    return 'Record(summary: $summary, building_name: $building_name, county: $county, locality: $locality, organisation: $organisation, postcode: $postcode, premise: $premise, street: $street, town: $town, line_one: $line_one, line_two: $line_two)';
  }
...
abstract class _Record implements Record {
  const factory _Record(
      ...
      final String? town,
      final String? line_one,
      final String? line_two}) = _$_Record;
