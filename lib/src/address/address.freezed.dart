...
class _$_Record implements _Record {
  ...
  @override
  String toString() {
    return 'Record(town: $town, building_name: $building_name, county: $county, postcode: $postcode, summary: $summary, premise: $premise, street: $street, line_one: $line_one, line_two: $line_two, locality: $locality, organisation: $organisation)';
  }
...
abstract class _Record implements Record {
  const factory _Record(
      ...
      final String? line_two,
      final String? locality,
      final String? organisation}) = _$_Record;
