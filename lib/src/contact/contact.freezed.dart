...
class _$_ContactInfo implements _ContactInfo {
  ...
  @override
  String toString() {
    return 'ContactInfo(addresses: $addresses, created_at: $created_at, links: $links, note: $note, phones: $phones, social_medias: $social_medias, updated_at: $updated_at, birthday: $birthday, emails: $emails, id: $id, name: $name)';
  }
...
class _$_UpdateRequest implements _UpdateRequest {
  ...
  @override
  String toString() {
    return 'UpdateRequest(emails: $emails, name: $name, social_medias: $social_medias, addresses: $addresses, id: $id, links: $links, note: $note, phones: $phones, birthday: $birthday)';
  }
