...
class _$_ContactInfo implements _ContactInfo {
  ...
  @override
  String toString() {
    return 'ContactInfo(id: $id, name: $name, phones: $phones, updated_at: $updated_at, addresses: $addresses, created_at: $created_at, emails: $emails, social_medias: $social_medias, birthday: $birthday, links: $links, note: $note)';
  }
...
class _$_UpdateRequest implements _UpdateRequest {
  ...
  @override
  String toString() {
    return 'UpdateRequest(addresses: $addresses, birthday: $birthday, id: $id, emails: $emails, links: $links, name: $name, note: $note, phones: $phones, social_medias: $social_medias)';
  }
