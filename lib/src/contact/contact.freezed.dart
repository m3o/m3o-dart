...
class _$_ContactInfo implements _ContactInfo {
  ...
  @override
  String toString() {
    return 'ContactInfo(links: $links, note: $note, social_medias: $social_medias, birthday: $birthday, created_at: $created_at, emails: $emails, id: $id, name: $name, phones: $phones, updated_at: $updated_at, addresses: $addresses)';
  }
...
class _$_UpdateRequest implements _UpdateRequest {
  ...
  @override
  String toString() {
    return 'UpdateRequest(addresses: $addresses, id: $id, phones: $phones, social_medias: $social_medias, birthday: $birthday, emails: $emails, links: $links, name: $name, note: $note)';
  }
