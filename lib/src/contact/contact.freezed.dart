...
class _$_ContactInfo implements _ContactInfo {
  ...
  @override
  String toString() {
    return 'ContactInfo(addresses: $addresses, birthday: $birthday, note: $note, links: $links, name: $name, phones: $phones, social_medias: $social_medias, updated_at: $updated_at, created_at: $created_at, emails: $emails, id: $id)';
  }
...
class _$_UpdateRequest implements _UpdateRequest {
  ...
  @override
  String toString() {
    return 'UpdateRequest(addresses: $addresses, birthday: $birthday, name: $name, note: $note, social_medias: $social_medias, emails: $emails, id: $id, links: $links, phones: $phones)';
  }
