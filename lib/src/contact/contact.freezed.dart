...
class _$_ContactInfo implements _ContactInfo {
  ...
  @override
  String toString() {
    return 'ContactInfo(note: $note, social_medias: $social_medias, updated_at: $updated_at, addresses: $addresses, birthday: $birthday, emails: $emails, id: $id, links: $links, created_at: $created_at, name: $name, phones: $phones)';
  }
...
class _$_UpdateRequest implements _UpdateRequest {
  ...
  @override
  String toString() {
    return 'UpdateRequest(birthday: $birthday, emails: $emails, links: $links, name: $name, note: $note, social_medias: $social_medias, addresses: $addresses, id: $id, phones: $phones)';
  }
