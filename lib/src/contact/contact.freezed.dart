...
class _$_ContactInfo implements _ContactInfo {
  ...
  @override
  String toString() {
    return 'ContactInfo(name: $name, note: $note, social_medias: $social_medias, updated_at: $updated_at, addresses: $addresses, birthday: $birthday, id: $id, links: $links, created_at: $created_at, emails: $emails, phones: $phones)';
  }
...
class _$_UpdateRequest implements _UpdateRequest {
  ...
  @override
  String toString() {
    return 'UpdateRequest(name: $name, note: $note, social_medias: $social_medias, emails: $emails, id: $id, links: $links, addresses: $addresses, birthday: $birthday, phones: $phones)';
  }
