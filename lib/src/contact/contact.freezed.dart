...
class _$_ContactInfo implements _ContactInfo {
  ...
  @override
  String toString() {
    return 'ContactInfo(created_at: $created_at, id: $id, links: $links, name: $name, note: $note, updated_at: $updated_at, birthday: $birthday, emails: $emails, phones: $phones, social_medias: $social_medias, addresses: $addresses)';
  }
...
class _$_UpdateRequest implements _UpdateRequest {
  ...
  @override
  String toString() {
    return 'UpdateRequest(note: $note, name: $name, birthday: $birthday, emails: $emails, id: $id, links: $links, phones: $phones, social_medias: $social_medias, addresses: $addresses)';
  }
