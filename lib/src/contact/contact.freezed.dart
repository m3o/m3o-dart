...
class _$_ContactInfo implements _ContactInfo {
  ...
  @override
  String toString() {
    return 'ContactInfo(addresses: $addresses, id: $id, name: $name, phones: $phones, social_medias: $social_medias, birthday: $birthday, created_at: $created_at, emails: $emails, links: $links, note: $note, updated_at: $updated_at)';
  }
...
class _$_UpdateRequest implements _UpdateRequest {
  ...
  @override
  String toString() {
    return 'UpdateRequest(emails: $emails, phones: $phones, addresses: $addresses, birthday: $birthday, name: $name, note: $note, social_medias: $social_medias, id: $id, links: $links)';
  }
