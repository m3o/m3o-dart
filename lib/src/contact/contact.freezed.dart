...
class _$_ContactInfo implements _ContactInfo {
  ...
  @override
  String toString() {
    return 'ContactInfo(id: $id, name: $name, social_medias: $social_medias, updated_at: $updated_at, addresses: $addresses, emails: $emails, links: $links, note: $note, phones: $phones, birthday: $birthday, created_at: $created_at)';
  }
...
class _$_UpdateRequest implements _UpdateRequest {
  ...
  @override
  String toString() {
    return 'UpdateRequest(addresses: $addresses, birthday: $birthday, emails: $emails, note: $note, social_medias: $social_medias, id: $id, links: $links, name: $name, phones: $phones)';
  }
