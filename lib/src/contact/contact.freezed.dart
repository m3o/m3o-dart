...
class _$_ContactInfo implements _ContactInfo {
  ...
  @override
  String toString() {
    return 'ContactInfo(updated_at: $updated_at, addresses: $addresses, created_at: $created_at, emails: $emails, links: $links, name: $name, phones: $phones, birthday: $birthday, id: $id, note: $note, social_medias: $social_medias)';
  }
...
class _$_UpdateRequest implements _UpdateRequest {
  ...
  @override
  String toString() {
    return 'UpdateRequest(addresses: $addresses, birthday: $birthday, name: $name, phones: $phones, emails: $emails, id: $id, links: $links, note: $note, social_medias: $social_medias)';
  }
