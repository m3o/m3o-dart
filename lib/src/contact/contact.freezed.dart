...
class _$_ContactInfo implements _ContactInfo {
  ...
  @override
  String toString() {
    return 'ContactInfo(birthday: $birthday, emails: $emails, name: $name, note: $note, phones: $phones, updated_at: $updated_at, addresses: $addresses, created_at: $created_at, id: $id, links: $links, social_medias: $social_medias)';
  }
...
class _$_UpdateRequest implements _UpdateRequest {
  ...
  @override
  String toString() {
    return 'UpdateRequest(birthday: $birthday, links: $links, name: $name, note: $note, addresses: $addresses, emails: $emails, id: $id, phones: $phones, social_medias: $social_medias)';
  }
