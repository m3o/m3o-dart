...
class _$_ContactInfo implements _ContactInfo {
  ...
  @override
  String toString() {
    return 'ContactInfo(id: $id, name: $name, note: $note, phones: $phones, social_medias: $social_medias, addresses: $addresses, birthday: $birthday, links: $links, updated_at: $updated_at, created_at: $created_at, emails: $emails)';
  }
...
class _$_UpdateRequest implements _UpdateRequest {
  ...
  @override
  String toString() {
    return 'UpdateRequest(birthday: $birthday, emails: $emails, id: $id, phones: $phones, addresses: $addresses, name: $name, note: $note, social_medias: $social_medias, links: $links)';
  }
