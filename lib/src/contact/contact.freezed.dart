...
abstract class _Address implements Address {
  const factory _Address({final String? location, final String? label}) =
      _$_Address;
...
class _$_ContactInfo implements _ContactInfo {
  ...
  @override
  String toString() {
    return 'ContactInfo(links: $links, note: $note, phones: $phones, updated_at: $updated_at, birthday: $birthday, created_at: $created_at, emails: $emails, id: $id, name: $name, social_medias: $social_medias, addresses: $addresses)';
  }
...
class _$_UpdateRequest implements _UpdateRequest {
  ...
  @override
  String toString() {
    return 'UpdateRequest(birthday: $birthday, id: $id, name: $name, social_medias: $social_medias, addresses: $addresses, emails: $emails, links: $links, note: $note, phones: $phones)';
  }
