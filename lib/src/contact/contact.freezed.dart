...
class _$_ContactInfo implements _ContactInfo {
  ...
  @override
  String toString() {
    return 'ContactInfo(links: $links, phones: $phones, social_medias: $social_medias, addresses: $addresses, birthday: $birthday, created_at: $created_at, emails: $emails, id: $id, name: $name, note: $note, updated_at: $updated_at)';
  }
...
class _$_UpdateRequest implements _UpdateRequest {
  ...
  @override
  String toString() {
    return 'UpdateRequest(phones: $phones, social_medias: $social_medias, birthday: $birthday, links: $links, note: $note, name: $name, addresses: $addresses, emails: $emails, id: $id)';
  }
