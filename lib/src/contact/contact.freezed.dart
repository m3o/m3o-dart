...
class _$_ContactInfo implements _ContactInfo {
  ...
  @override
  String toString() {
    return 'ContactInfo(birthday: $birthday, name: $name, phones: $phones, updated_at: $updated_at, links: $links, note: $note, social_medias: $social_medias, addresses: $addresses, created_at: $created_at, emails: $emails, id: $id)';
  }
...
class _$_UpdateRequest implements _UpdateRequest {
  ...
  @override
  String toString() {
    return 'UpdateRequest(addresses: $addresses, social_medias: $social_medias, note: $note, phones: $phones, birthday: $birthday, emails: $emails, id: $id, links: $links, name: $name)';
  }
