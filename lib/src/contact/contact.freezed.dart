...
class _$_ContactInfo implements _ContactInfo {
  ...
  @override
  String toString() {
    return 'ContactInfo(created_at: $created_at, id: $id, name: $name, note: $note, updated_at: $updated_at, birthday: $birthday, emails: $emails, links: $links, phones: $phones, social_medias: $social_medias, addresses: $addresses)';
  }
...
class _$_UpdateRequest implements _UpdateRequest {
  ...
  @override
  String toString() {
    return 'UpdateRequest(id: $id, name: $name, note: $note, phones: $phones, addresses: $addresses, birthday: $birthday, emails: $emails, links: $links, social_medias: $social_medias)';
  }
