...
class _$_ContactInfo implements _ContactInfo {
  ...
  @override
  String toString() {
    return 'ContactInfo(addresses: $addresses, note: $note, phones: $phones, social_medias: $social_medias, birthday: $birthday, created_at: $created_at, emails: $emails, id: $id, links: $links, name: $name, updated_at: $updated_at)';
  }
...
class _$_UpdateRequest implements _UpdateRequest {
  ...
  @override
  String toString() {
    return 'UpdateRequest(name: $name, addresses: $addresses, emails: $emails, id: $id, links: $links, birthday: $birthday, note: $note, phones: $phones, social_medias: $social_medias)';
  }
