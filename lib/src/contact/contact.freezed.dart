...
class _$_ContactInfo implements _ContactInfo {
  ...
  @override
  String toString() {
    return 'ContactInfo(note: $note, social_medias: $social_medias, addresses: $addresses, birthday: $birthday, id: $id, name: $name, phones: $phones, updated_at: $updated_at, created_at: $created_at, emails: $emails, links: $links)';
  }
...
class _$_UpdateRequest implements _UpdateRequest {
  ...
  @override
  String toString() {
    return 'UpdateRequest(emails: $emails, id: $id, addresses: $addresses, birthday: $birthday, links: $links, name: $name, note: $note, phones: $phones, social_medias: $social_medias)';
  }
