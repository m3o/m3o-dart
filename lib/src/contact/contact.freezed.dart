...
class _$_ContactInfo implements _ContactInfo {
  ...
  @override
  String toString() {
    return 'ContactInfo(id: $id, links: $links, note: $note, phones: $phones, birthday: $birthday, emails: $emails, name: $name, social_medias: $social_medias, updated_at: $updated_at, addresses: $addresses, created_at: $created_at)';
  }
...
class _$_UpdateRequest implements _UpdateRequest {
  ...
  @override
  String toString() {
    return 'UpdateRequest(id: $id, name: $name, phones: $phones, social_medias: $social_medias, birthday: $birthday, emails: $emails, note: $note, addresses: $addresses, links: $links)';
  }
