...
class _$_ContactInfo implements _ContactInfo {
  ...
  @override
  String toString() {
    return 'ContactInfo(phones: $phones, social_medias: $social_medias, addresses: $addresses, birthday: $birthday, created_at: $created_at, id: $id, updated_at: $updated_at, emails: $emails, links: $links, name: $name, note: $note)';
  }
...
class _$_UpdateRequest implements _UpdateRequest {
  ...
  @override
  String toString() {
    return 'UpdateRequest(phones: $phones, birthday: $birthday, emails: $emails, links: $links, name: $name, addresses: $addresses, id: $id, note: $note, social_medias: $social_medias)';
  }
