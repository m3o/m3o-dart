...
class _$_ContactInfo implements _ContactInfo {
  ...
  @override
  String toString() {
    return 'ContactInfo(links: $links, name: $name, note: $note, phones: $phones, updated_at: $updated_at, addresses: $addresses, id: $id, emails: $emails, social_medias: $social_medias, birthday: $birthday, created_at: $created_at)';
  }
...
class _$_UpdateRequest implements _UpdateRequest {
  ...
  @override
  String toString() {
    return 'UpdateRequest(social_medias: $social_medias, birthday: $birthday, emails: $emails, name: $name, note: $note, addresses: $addresses, id: $id, links: $links, phones: $phones)';
  }
