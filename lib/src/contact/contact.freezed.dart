...
class _$_ContactInfo implements _ContactInfo {
  ...
  @override
  String toString() {
    return 'ContactInfo(addresses: $addresses, birthday: $birthday, emails: $emails, id: $id, name: $name, note: $note, updated_at: $updated_at, created_at: $created_at, links: $links, phones: $phones, social_medias: $social_medias)';
  }
...
class _$_UpdateRequest implements _UpdateRequest {
  ...
  @override
  String toString() {
    return 'UpdateRequest(birthday: $birthday, social_medias: $social_medias, addresses: $addresses, id: $id, links: $links, name: $name, note: $note, phones: $phones, emails: $emails)';
  }
