...
class _$_ContactInfo implements _ContactInfo {
  ...
  @override
  String toString() {
    return 'ContactInfo(created_at: $created_at, id: $id, links: $links, name: $name, updated_at: $updated_at, addresses: $addresses, birthday: $birthday, emails: $emails, note: $note, phones: $phones, social_medias: $social_medias)';
  }
