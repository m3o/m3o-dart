...
class _$_ContactInfo implements _ContactInfo {
  ...
  @override
  String toString() {
    return 'ContactInfo(links: $links, name: $name, note: $note, updated_at: $updated_at, social_medias: $social_medias, addresses: $addresses, birthday: $birthday, created_at: $created_at, emails: $emails, id: $id, phones: $phones)';
  }
...
class _$_UpdateRequest implements _UpdateRequest {
  ...
  @override
  String toString() {
    return 'UpdateRequest(links: $links, note: $note, phones: $phones, social_medias: $social_medias, addresses: $addresses, id: $id, name: $name, birthday: $birthday, emails: $emails)';
  }
