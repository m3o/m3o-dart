...
class _$_ContactInfo implements _ContactInfo {
  ...
  @override
  String toString() {
    return 'ContactInfo(name: $name, note: $note, birthday: $birthday, created_at: $created_at, emails: $emails, links: $links, updated_at: $updated_at, addresses: $addresses, id: $id, phones: $phones, social_medias: $social_medias)';
  }
...
class _$_UpdateRequest implements _UpdateRequest {
  ...
  @override
  String toString() {
    return 'UpdateRequest(note: $note, phones: $phones, addresses: $addresses, birthday: $birthday, emails: $emails, links: $links, name: $name, id: $id, social_medias: $social_medias)';
  }
