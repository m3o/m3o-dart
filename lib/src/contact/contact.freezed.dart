...
class _$_ContactInfo implements _ContactInfo {
  ...
  @override
  String toString() {
    return 'ContactInfo(created_at: $created_at, social_medias: $social_medias, updated_at: $updated_at, addresses: $addresses, emails: $emails, id: $id, links: $links, name: $name, note: $note, phones: $phones, birthday: $birthday)';
  }
