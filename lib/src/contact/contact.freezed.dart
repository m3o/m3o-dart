...
class _$_ContactInfo implements _ContactInfo {
  ...
  @override
  String toString() {
    return 'ContactInfo(birthday: $birthday, emails: $emails, id: $id, links: $links, social_medias: $social_medias, updated_at: $updated_at, addresses: $addresses, created_at: $created_at, name: $name, note: $note, phones: $phones)';
  }
...
class _$_UpdateRequest implements _UpdateRequest {
  ...
  @override
  String toString() {
    return 'UpdateRequest(links: $links, name: $name, social_medias: $social_medias, emails: $emails, id: $id, note: $note, phones: $phones, addresses: $addresses, birthday: $birthday)';
  }
