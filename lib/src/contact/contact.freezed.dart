...
class _$_ContactInfo implements _ContactInfo {
  ...
  @override
  String toString() {
    return 'ContactInfo(updated_at: $updated_at, birthday: $birthday, created_at: $created_at, id: $id, links: $links, name: $name, note: $note, addresses: $addresses, emails: $emails, phones: $phones, social_medias: $social_medias)';
  }
...
class _$_UpdateRequest implements _UpdateRequest {
  ...
  @override
  String toString() {
    return 'UpdateRequest(links: $links, addresses: $addresses, birthday: $birthday, name: $name, note: $note, phones: $phones, social_medias: $social_medias, emails: $emails, id: $id)';
  }
