...
class _$_ContactInfo implements _ContactInfo {
  ...
  @override
  String toString() {
    return 'ContactInfo(created_at: $created_at, emails: $emails, name: $name, social_medias: $social_medias, addresses: $addresses, birthday: $birthday, id: $id, links: $links, note: $note, phones: $phones, updated_at: $updated_at)';
  }
...
class _$_UpdateRequest implements _UpdateRequest {
  ...
  @override
  String toString() {
    return 'UpdateRequest(social_medias: $social_medias, id: $id, note: $note, phones: $phones, links: $links, name: $name, addresses: $addresses, birthday: $birthday, emails: $emails)';
  }
