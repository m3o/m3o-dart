...
class _$_ContactInfo implements _ContactInfo {
  ...
  @override
  String toString() {
    return 'ContactInfo(created_at: $created_at, id: $id, links: $links, note: $note, updated_at: $updated_at, addresses: $addresses, emails: $emails, name: $name, phones: $phones, social_medias: $social_medias, birthday: $birthday)';
  }
...
class _$_UpdateRequest implements _UpdateRequest {
  ...
  @override
  String toString() {
    return 'UpdateRequest(links: $links, name: $name, birthday: $birthday, emails: $emails, id: $id, social_medias: $social_medias, addresses: $addresses, note: $note, phones: $phones)';
  }
