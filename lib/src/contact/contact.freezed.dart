...
class _$_ContactInfo implements _ContactInfo {
  ...
  @override
  String toString() {
    return 'ContactInfo(emails: $emails, id: $id, links: $links, name: $name, updated_at: $updated_at, addresses: $addresses, birthday: $birthday, created_at: $created_at, note: $note, phones: $phones, social_medias: $social_medias)';
  }
...
class _$_UpdateRequest implements _UpdateRequest {
  ...
  @override
  String toString() {
    return 'UpdateRequest(id: $id, links: $links, name: $name, social_medias: $social_medias, addresses: $addresses, birthday: $birthday, phones: $phones, emails: $emails, note: $note)';
  }
