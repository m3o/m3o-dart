...
class _$_ContactInfo implements _ContactInfo {
  ...
  @override
  String toString() {
    return 'ContactInfo(birthday: $birthday, emails: $emails, id: $id, social_medias: $social_medias, phones: $phones, updated_at: $updated_at, addresses: $addresses, created_at: $created_at, links: $links, name: $name, note: $note)';
  }
...
class _$_UpdateRequest implements _UpdateRequest {
  ...
  @override
  String toString() {
    return 'UpdateRequest(links: $links, note: $note, phones: $phones, id: $id, name: $name, social_medias: $social_medias, addresses: $addresses, birthday: $birthday, emails: $emails)';
  }
