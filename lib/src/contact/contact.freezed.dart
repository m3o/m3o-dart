...
class _$_ContactInfo implements _ContactInfo {
  ...
  @override
  String toString() {
    return 'ContactInfo(id: $id, name: $name, addresses: $addresses, birthday: $birthday, created_at: $created_at, emails: $emails, links: $links, note: $note, phones: $phones, social_medias: $social_medias, updated_at: $updated_at)';
  }
...
class _$_UpdateRequest implements _UpdateRequest {
  ...
  @override
  String toString() {
    return 'UpdateRequest(addresses: $addresses, name: $name, phones: $phones, social_medias: $social_medias, birthday: $birthday, emails: $emails, id: $id, links: $links, note: $note)';
  }
