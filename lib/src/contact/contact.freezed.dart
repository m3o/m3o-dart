...
class _$_ContactInfo implements _ContactInfo {
  ...
  @override
  String toString() {
    return 'ContactInfo(addresses: $addresses, created_at: $created_at, id: $id, links: $links, name: $name, note: $note, phones: $phones, social_medias: $social_medias, updated_at: $updated_at, birthday: $birthday, emails: $emails)';
  }
...
class _$_UpdateRequest implements _UpdateRequest {
  ...
  @override
  String toString() {
    return 'UpdateRequest(birthday: $birthday, id: $id, links: $links, note: $note, social_medias: $social_medias, addresses: $addresses, emails: $emails, name: $name, phones: $phones)';
  }
