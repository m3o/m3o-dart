...
class _$_ContactInfo implements _ContactInfo {
  ...
  @override
  String toString() {
    return 'ContactInfo(created_at: $created_at, note: $note, phones: $phones, updated_at: $updated_at, addresses: $addresses, birthday: $birthday, links: $links, name: $name, social_medias: $social_medias, emails: $emails, id: $id)';
  }
...
class _$_UpdateRequest implements _UpdateRequest {
  ...
  @override
  String toString() {
    return 'UpdateRequest(addresses: $addresses, birthday: $birthday, links: $links, name: $name, phones: $phones, social_medias: $social_medias, emails: $emails, id: $id, note: $note)';
  }
