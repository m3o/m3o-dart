...
class _$_ContactInfo implements _ContactInfo {
  ...
  @override
  String toString() {
    return 'ContactInfo(links: $links, name: $name, social_medias: $social_medias, updated_at: $updated_at, addresses: $addresses, id: $id, emails: $emails, note: $note, phones: $phones, birthday: $birthday, created_at: $created_at)';
  }
...
class _$_UpdateRequest implements _UpdateRequest {
  ...
  @override
  String toString() {
    return 'UpdateRequest(addresses: $addresses, birthday: $birthday, links: $links, name: $name, emails: $emails, id: $id, note: $note, phones: $phones, social_medias: $social_medias)';
  }
