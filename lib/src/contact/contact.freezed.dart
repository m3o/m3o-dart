...
class _$_ContactInfo implements _ContactInfo {
  ...
  @override
  String toString() {
    return 'ContactInfo(birthday: $birthday, emails: $emails, id: $id, name: $name, note: $note, updated_at: $updated_at, addresses: $addresses, created_at: $created_at, links: $links, phones: $phones, social_medias: $social_medias)';
  }
...
class _$_UpdateRequest implements _UpdateRequest {
  ...
  @override
  String toString() {
    return 'UpdateRequest(birthday: $birthday, emails: $emails, id: $id, links: $links, social_medias: $social_medias, addresses: $addresses, note: $note, phones: $phones, name: $name)';
  }
