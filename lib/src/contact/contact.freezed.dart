...
class _$_ContactInfo implements _ContactInfo {
  ...
  @override
  String toString() {
    return 'ContactInfo(name: $name, phones: $phones, social_medias: $social_medias, emails: $emails, birthday: $birthday, created_at: $created_at, id: $id, links: $links, note: $note, updated_at: $updated_at, addresses: $addresses)';
  }
