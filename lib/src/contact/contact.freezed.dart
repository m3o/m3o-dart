...
class _$_ContactInfo implements _ContactInfo {
  ...
  @override
  String toString() {
    return 'ContactInfo(addresses: $addresses, id: $id, name: $name, note: $note, phones: $phones, updated_at: $updated_at, birthday: $birthday, created_at: $created_at, emails: $emails, links: $links, social_medias: $social_medias)';
  }
...
class _$_UpdateRequest implements _UpdateRequest {
  ...
  @override
  String toString() {
    return 'UpdateRequest(addresses: $addresses, birthday: $birthday, note: $note, phones: $phones, emails: $emails, id: $id, links: $links, name: $name, social_medias: $social_medias)';
  }
