...
class _$_ContactInfo implements _ContactInfo {
  ...
  @override
  String toString() {
    return 'ContactInfo(social_medias: $social_medias, addresses: $addresses, created_at: $created_at, id: $id, links: $links, name: $name, note: $note, phones: $phones, updated_at: $updated_at, birthday: $birthday, emails: $emails)';
  }
...
class _$_UpdateRequest implements _UpdateRequest {
  ...
  @override
  String toString() {
    return 'UpdateRequest(birthday: $birthday, links: $links, name: $name, phones: $phones, addresses: $addresses, emails: $emails, id: $id, note: $note, social_medias: $social_medias)';
  }
