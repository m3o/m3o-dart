...
class _$_ContactInfo implements _ContactInfo {
  ...
  @override
  String toString() {
    return 'ContactInfo(id: $id, links: $links, name: $name, updated_at: $updated_at, addresses: $addresses, created_at: $created_at, emails: $emails, social_medias: $social_medias, birthday: $birthday, note: $note, phones: $phones)';
  }
...
class _$_UpdateRequest implements _UpdateRequest {
  ...
  @override
  String toString() {
    return 'UpdateRequest(phones: $phones, social_medias: $social_medias, id: $id, note: $note, emails: $emails, links: $links, name: $name, addresses: $addresses, birthday: $birthday)';
  }
