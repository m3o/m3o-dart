...
class _$_ContactInfo implements _ContactInfo {
  ...
  @override
  String toString() {
    return 'ContactInfo(note: $note, phones: $phones, social_medias: $social_medias, emails: $emails, id: $id, created_at: $created_at, links: $links, name: $name, updated_at: $updated_at, addresses: $addresses, birthday: $birthday)';
  }
...
class _$_UpdateRequest implements _UpdateRequest {
  ...
  @override
  String toString() {
    return 'UpdateRequest(name: $name, phones: $phones, social_medias: $social_medias, links: $links, note: $note, addresses: $addresses, birthday: $birthday, emails: $emails, id: $id)';
  }
