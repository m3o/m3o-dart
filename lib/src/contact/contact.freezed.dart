...
class _$_ContactInfo implements _ContactInfo {
  ...
  @override
  String toString() {
    return 'ContactInfo(birthday: $birthday, note: $note, phones: $phones, social_medias: $social_medias, name: $name, updated_at: $updated_at, addresses: $addresses, created_at: $created_at, emails: $emails, id: $id, links: $links)';
  }
...
class _$_UpdateRequest implements _UpdateRequest {
  ...
  @override
  String toString() {
    return 'UpdateRequest(phones: $phones, emails: $emails, id: $id, links: $links, name: $name, note: $note, social_medias: $social_medias, addresses: $addresses, birthday: $birthday)';
  }
