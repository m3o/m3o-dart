...
class _$_ContactInfo implements _ContactInfo {
  ...
  @override
  String toString() {
    return 'ContactInfo(emails: $emails, links: $links, note: $note, phones: $phones, addresses: $addresses, birthday: $birthday, name: $name, social_medias: $social_medias, updated_at: $updated_at, created_at: $created_at, id: $id)';
  }
...
class _$_UpdateRequest implements _UpdateRequest {
  ...
  @override
  String toString() {
    return 'UpdateRequest(id: $id, links: $links, phones: $phones, emails: $emails, birthday: $birthday, name: $name, note: $note, social_medias: $social_medias, addresses: $addresses)';
  }
