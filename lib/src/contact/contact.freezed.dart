...
class _$_ContactInfo implements _ContactInfo {
  ...
  @override
  String toString() {
    return 'ContactInfo(note: $note, addresses: $addresses, birthday: $birthday, created_at: $created_at, id: $id, links: $links, emails: $emails, name: $name, phones: $phones, social_medias: $social_medias, updated_at: $updated_at)';
  }
