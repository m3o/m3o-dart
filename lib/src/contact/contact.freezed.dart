...
class _$_ContactInfo implements _ContactInfo {
  ...
  @override
  String toString() {
    return 'ContactInfo(social_medias: $social_medias, addresses: $addresses, birthday: $birthday, emails: $emails, links: $links, phones: $phones, created_at: $created_at, id: $id, name: $name, note: $note, updated_at: $updated_at)';
  }
...
class _$_UpdateRequest implements _UpdateRequest {
  ...
  @override
  String toString() {
    return 'UpdateRequest(emails: $emails, id: $id, name: $name, phones: $phones, birthday: $birthday, links: $links, note: $note, social_medias: $social_medias, addresses: $addresses)';
  }
