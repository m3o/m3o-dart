...
class _$_ContactInfo implements _ContactInfo {
  ...
  @override
  String toString() {
    return 'ContactInfo(id: $id, name: $name, note: $note, social_medias: $social_medias, addresses: $addresses, emails: $emails, links: $links, phones: $phones, updated_at: $updated_at, birthday: $birthday, created_at: $created_at)';
  }
...
class _$_UpdateRequest implements _UpdateRequest {
  ...
  @override
  String toString() {
    return 'UpdateRequest(birthday: $birthday, emails: $emails, name: $name, phones: $phones, addresses: $addresses, id: $id, links: $links, note: $note, social_medias: $social_medias)';
  }
