...
class _$_ContactInfo implements _ContactInfo {
  ...
  @override
  String toString() {
    return 'ContactInfo(created_at: $created_at, links: $links, note: $note, addresses: $addresses, birthday: $birthday, name: $name, phones: $phones, social_medias: $social_medias, updated_at: $updated_at, emails: $emails, id: $id)';
  }
...
class _$_UpdateRequest implements _UpdateRequest {
  ...
  @override
  String toString() {
    return 'UpdateRequest(birthday: $birthday, note: $note, social_medias: $social_medias, addresses: $addresses, id: $id, links: $links, name: $name, phones: $phones, emails: $emails)';
  }
