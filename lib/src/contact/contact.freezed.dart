...
class _$_ContactInfo implements _ContactInfo {
  ...
  @override
  String toString() {
    return 'ContactInfo(id: $id, links: $links, note: $note, phones: $phones, addresses: $addresses, birthday: $birthday, created_at: $created_at, emails: $emails, social_medias: $social_medias, name: $name, updated_at: $updated_at)';
  }
...
class _$_UpdateRequest implements _UpdateRequest {
  ...
  @override
  String toString() {
    return 'UpdateRequest(phones: $phones, addresses: $addresses, birthday: $birthday, emails: $emails, links: $links, name: $name, id: $id, note: $note, social_medias: $social_medias)';
  }
