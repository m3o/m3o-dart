...
class _$_ContactInfo implements _ContactInfo {
  ...
  @override
  String toString() {
    return 'ContactInfo(phones: $phones, updated_at: $updated_at, addresses: $addresses, created_at: $created_at, name: $name, links: $links, note: $note, social_medias: $social_medias, birthday: $birthday, emails: $emails, id: $id)';
  }
...
abstract class _ContactInfo implements ContactInfo {
  const factory _ContactInfo(
      ...
      final String? birthday,
      final List<Email>? emails,
      final String? id}) = _$_ContactInfo;
...
class _$_UpdateRequest implements _UpdateRequest {
  ...
  @override
  String toString() {
    return 'UpdateRequest(name: $name, addresses: $addresses, links: $links, id: $id, note: $note, phones: $phones, social_medias: $social_medias, birthday: $birthday, emails: $emails)';
  }
...
abstract class _UpdateRequest implements UpdateRequest {
  const factory _UpdateRequest(
      ...
      final List<SocialMedia>? social_medias,
      final String? birthday,
      final List<Email>? emails}) = _$_UpdateRequest;
