...
class _$_ContactInfo implements _ContactInfo {
  ...
  @override
  String toString() {
    return 'ContactInfo(links: $links, name: $name, social_medias: $social_medias, updated_at: $updated_at, addresses: $addresses, created_at: $created_at, emails: $emails, id: $id, note: $note, phones: $phones, birthday: $birthday)';
  }
...
class _$_UpdateRequest implements _UpdateRequest {
  ...
  @override
  String toString() {
    return 'UpdateRequest(addresses: $addresses, id: $id, birthday: $birthday, emails: $emails, links: $links, name: $name, note: $note, phones: $phones, social_medias: $social_medias)';
  }
