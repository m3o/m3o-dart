...
class _$_ContactInfo implements _ContactInfo {
  ...
  @override
  String toString() {
    return 'ContactInfo(created_at: $created_at, updated_at: $updated_at, addresses: $addresses, emails: $emails, id: $id, links: $links, name: $name, note: $note, phones: $phones, social_medias: $social_medias, birthday: $birthday)';
  }
...
class _$_UpdateRequest implements _UpdateRequest {
  ...
  @override
  String toString() {
    return 'UpdateRequest(note: $note, phones: $phones, social_medias: $social_medias, addresses: $addresses, emails: $emails, id: $id, links: $links, name: $name, birthday: $birthday)';
  }
