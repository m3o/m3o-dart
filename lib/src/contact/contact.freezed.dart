...
class _$_ContactInfo implements _ContactInfo {
  ...
  @override
  String toString() {
    return 'ContactInfo(updated_at: $updated_at, addresses: $addresses, created_at: $created_at, emails: $emails, id: $id, name: $name, social_medias: $social_medias, birthday: $birthday, links: $links, note: $note, phones: $phones)';
  }
...
abstract class _ContactInfo implements ContactInfo {
  const factory _ContactInfo(
      ...
      final List<Link>? links,
      final String? note,
      final List<Phone>? phones}) = _$_ContactInfo;
...
abstract class _CreateRequest implements CreateRequest {
  const factory _CreateRequest(
      ...
      final String? note,
      final List<Phone>? phones,
      final List<SocialMedia>? social_medias}) = _$_CreateRequest;
...
abstract class _Link implements Link {
  const factory _Link({final String? url, final String? label}) = _$_Link;
...
class _$_UpdateRequest implements _UpdateRequest {
  ...
  @override
  String toString() {
    return 'UpdateRequest(addresses: $addresses, emails: $emails, name: $name, social_medias: $social_medias, phones: $phones, birthday: $birthday, id: $id, links: $links, note: $note)';
  }
