...
class _$_ContactInfo implements _ContactInfo {
  ...
  @override
  String toString() {
    return 'ContactInfo(birthday: $birthday, emails: $emails, links: $links, name: $name, note: $note, social_medias: $social_medias, addresses: $addresses, created_at: $created_at, id: $id, phones: $phones, updated_at: $updated_at)';
  }
...
class _$_UpdateRequest implements _UpdateRequest {
  ...
  @override
  String toString() {
    return 'UpdateRequest(birthday: $birthday, emails: $emails, note: $note, phones: $phones, social_medias: $social_medias, addresses: $addresses, id: $id, links: $links, name: $name)';
  }
