...
class _$_ContactInfo implements _ContactInfo {
  ...
  @override
  String toString() {
    return 'ContactInfo(phones: $phones, updated_at: $updated_at, addresses: $addresses, created_at: $created_at, emails: $emails, id: $id, links: $links, name: $name, birthday: $birthday, note: $note, social_medias: $social_medias)';
  }
...
class _$_UpdateRequest implements _UpdateRequest {
  ...
  @override
  String toString() {
    return 'UpdateRequest(addresses: $addresses, emails: $emails, links: $links, note: $note, phones: $phones, social_medias: $social_medias, birthday: $birthday, id: $id, name: $name)';
  }
