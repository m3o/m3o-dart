...
class _$_ContactInfo implements _ContactInfo {
  ...
  @override
  String toString() {
    return 'ContactInfo(note: $note, phones: $phones, social_medias: $social_medias, birthday: $birthday, emails: $emails, id: $id, links: $links, name: $name, updated_at: $updated_at, addresses: $addresses, created_at: $created_at)';
  }
...
class _$_UpdateRequest implements _UpdateRequest {
  ...
  @override
  String toString() {
    return 'UpdateRequest(birthday: $birthday, emails: $emails, links: $links, social_medias: $social_medias, addresses: $addresses, name: $name, note: $note, phones: $phones, id: $id)';
  }
