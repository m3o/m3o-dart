...
class _$_ContactInfo implements _ContactInfo {
  ...
  @override
  String toString() {
    return 'ContactInfo(id: $id, links: $links, note: $note, social_medias: $social_medias, updated_at: $updated_at, addresses: $addresses, created_at: $created_at, emails: $emails, name: $name, phones: $phones, birthday: $birthday)';
  }
...
class _$_UpdateRequest implements _UpdateRequest {
  ...
  @override
  String toString() {
    return 'UpdateRequest(emails: $emails, links: $links, name: $name, phones: $phones, birthday: $birthday, id: $id, note: $note, social_medias: $social_medias, addresses: $addresses)';
  }
