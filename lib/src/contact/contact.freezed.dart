...
class _$_ContactInfo implements _ContactInfo {
  ...
  @override
  String toString() {
    return 'ContactInfo(birthday: $birthday, id: $id, note: $note, updated_at: $updated_at, name: $name, phones: $phones, social_medias: $social_medias, addresses: $addresses, created_at: $created_at, emails: $emails, links: $links)';
  }
...
class _$_UpdateRequest implements _UpdateRequest {
  ...
  @override
  String toString() {
    return 'UpdateRequest(addresses: $addresses, emails: $emails, links: $links, birthday: $birthday, id: $id, name: $name, note: $note, phones: $phones, social_medias: $social_medias)';
  }
