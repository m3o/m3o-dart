...
class _$_ContactInfo implements _ContactInfo {
  ...
  @override
  String toString() {
    return 'ContactInfo(addresses: $addresses, birthday: $birthday, emails: $emails, id: $id, links: $links, name: $name, phones: $phones, social_medias: $social_medias, created_at: $created_at, note: $note, updated_at: $updated_at)';
  }
...
class _$_UpdateRequest implements _UpdateRequest {
  ...
  @override
  String toString() {
    return 'UpdateRequest(social_medias: $social_medias, id: $id, name: $name, note: $note, links: $links, phones: $phones, addresses: $addresses, birthday: $birthday, emails: $emails)';
  }
