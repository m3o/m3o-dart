...
class _$_ContactInfo implements _ContactInfo {
  ...
  @override
  String toString() {
    return 'ContactInfo(created_at: $created_at, emails: $emails, note: $note, social_medias: $social_medias, updated_at: $updated_at, addresses: $addresses, birthday: $birthday, id: $id, links: $links, name: $name, phones: $phones)';
  }
...
class _$_UpdateRequest implements _UpdateRequest {
  ...
  @override
  String toString() {
    return 'UpdateRequest(addresses: $addresses, id: $id, links: $links, social_medias: $social_medias, birthday: $birthday, emails: $emails, name: $name, note: $note, phones: $phones)';
  }
