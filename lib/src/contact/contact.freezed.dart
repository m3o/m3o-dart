...
class _$_ContactInfo implements _ContactInfo {
  ...
  @override
  String toString() {
    return 'ContactInfo(birthday: $birthday, created_at: $created_at, id: $id, updated_at: $updated_at, addresses: $addresses, links: $links, name: $name, note: $note, phones: $phones, social_medias: $social_medias, emails: $emails)';
  }
...
class _$_UpdateRequest implements _UpdateRequest {
  ...
  @override
  String toString() {
    return 'UpdateRequest(birthday: $birthday, links: $links, social_medias: $social_medias, addresses: $addresses, id: $id, name: $name, note: $note, phones: $phones, emails: $emails)';
  }
