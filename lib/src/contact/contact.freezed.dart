...
class _$_ContactInfo implements _ContactInfo {
  ...
  @override
  String toString() {
    return 'ContactInfo(social_medias: $social_medias, birthday: $birthday, created_at: $created_at, emails: $emails, id: $id, links: $links, name: $name, note: $note, addresses: $addresses, updated_at: $updated_at, phones: $phones)';
  }
...
class _$_UpdateRequest implements _UpdateRequest {
  ...
  @override
  String toString() {
    return 'UpdateRequest(birthday: $birthday, emails: $emails, note: $note, phones: $phones, addresses: $addresses, links: $links, name: $name, social_medias: $social_medias, id: $id)';
  }
