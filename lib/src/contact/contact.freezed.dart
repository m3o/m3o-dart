...
class _$_ContactInfo implements _ContactInfo {
  ...
  @override
  String toString() {
    return 'ContactInfo(addresses: $addresses, created_at: $created_at, id: $id, name: $name, note: $note, phones: $phones, social_medias: $social_medias, updated_at: $updated_at, birthday: $birthday, emails: $emails, links: $links)';
  }
...
class _$_UpdateRequest implements _UpdateRequest {
  ...
  @override
  String toString() {
    return 'UpdateRequest(addresses: $addresses, name: $name, id: $id, links: $links, note: $note, phones: $phones, social_medias: $social_medias, birthday: $birthday, emails: $emails)';
  }
