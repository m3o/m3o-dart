...
class _$_ContactInfo implements _ContactInfo {
  ...
  @override
  String toString() {
    return 'ContactInfo(addresses: $addresses, birthday: $birthday, links: $links, updated_at: $updated_at, phones: $phones, social_medias: $social_medias, created_at: $created_at, emails: $emails, id: $id, name: $name, note: $note)';
  }
...
class _$_UpdateRequest implements _UpdateRequest {
  ...
  @override
  String toString() {
    return 'UpdateRequest(addresses: $addresses, emails: $emails, id: $id, links: $links, name: $name, birthday: $birthday, note: $note, phones: $phones, social_medias: $social_medias)';
  }
