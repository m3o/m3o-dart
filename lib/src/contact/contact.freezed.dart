...
class _$_ContactInfo implements _ContactInfo {
  ...
  @override
  String toString() {
    return 'ContactInfo(emails: $emails, id: $id, links: $links, name: $name, phones: $phones, addresses: $addresses, created_at: $created_at, social_medias: $social_medias, updated_at: $updated_at, birthday: $birthday, note: $note)';
  }
...
class _$_UpdateRequest implements _UpdateRequest {
  ...
  @override
  String toString() {
    return 'UpdateRequest(links: $links, name: $name, note: $note, phones: $phones, addresses: $addresses, birthday: $birthday, emails: $emails, id: $id, social_medias: $social_medias)';
  }
