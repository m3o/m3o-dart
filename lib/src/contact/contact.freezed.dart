...
class _$_ContactInfo implements _ContactInfo {
  ...
  @override
  String toString() {
    return 'ContactInfo(social_medias: $social_medias, addresses: $addresses, birthday: $birthday, created_at: $created_at, id: $id, name: $name, note: $note, phones: $phones, emails: $emails, links: $links, updated_at: $updated_at)';
  }
...
class _$_UpdateRequest implements _UpdateRequest {
  ...
  @override
  String toString() {
    return 'UpdateRequest(emails: $emails, id: $id, links: $links, addresses: $addresses, birthday: $birthday, phones: $phones, social_medias: $social_medias, name: $name, note: $note)';
  }
