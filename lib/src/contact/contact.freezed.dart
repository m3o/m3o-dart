...
class _$_ContactInfo implements _ContactInfo {
  ...
  @override
  String toString() {
    return 'ContactInfo(addresses: $addresses, birthday: $birthday, created_at: $created_at, links: $links, note: $note, updated_at: $updated_at, emails: $emails, id: $id, name: $name, phones: $phones, social_medias: $social_medias)';
  }
...
class _$_UpdateRequest implements _UpdateRequest {
  ...
  @override
  String toString() {
    return 'UpdateRequest(links: $links, name: $name, note: $note, phones: $phones, birthday: $birthday, id: $id, social_medias: $social_medias, addresses: $addresses, emails: $emails)';
  }
