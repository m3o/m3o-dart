...
class _$_ContactInfo implements _ContactInfo {
  ...
  @override
  String toString() {
    return 'ContactInfo(created_at: $created_at, emails: $emails, id: $id, links: $links, name: $name, social_medias: $social_medias, addresses: $addresses, birthday: $birthday, note: $note, phones: $phones, updated_at: $updated_at)';
  }
...
class _$_UpdateRequest implements _UpdateRequest {
  ...
  @override
  String toString() {
    return 'UpdateRequest(addresses: $addresses, note: $note, birthday: $birthday, emails: $emails, id: $id, links: $links, name: $name, phones: $phones, social_medias: $social_medias)';
  }
