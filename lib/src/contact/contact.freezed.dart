...
class _$_ContactInfo implements _ContactInfo {
  ...
  @override
  String toString() {
    return 'ContactInfo(links: $links, name: $name, social_medias: $social_medias, addresses: $addresses, created_at: $created_at, id: $id, note: $note, phones: $phones, updated_at: $updated_at, birthday: $birthday, emails: $emails)';
  }
...
class _$_UpdateRequest implements _UpdateRequest {
  ...
  @override
  String toString() {
    return 'UpdateRequest(addresses: $addresses, id: $id, links: $links, note: $note, social_medias: $social_medias, birthday: $birthday, emails: $emails, name: $name, phones: $phones)';
  }
