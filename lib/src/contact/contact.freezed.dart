...
class _$_ContactInfo implements _ContactInfo {
  ...
  @override
  String toString() {
    return 'ContactInfo(links: $links, phones: $phones, updated_at: $updated_at, emails: $emails, id: $id, name: $name, note: $note, social_medias: $social_medias, addresses: $addresses, birthday: $birthday, created_at: $created_at)';
  }
...
class _$_UpdateRequest implements _UpdateRequest {
  ...
  @override
  String toString() {
    return 'UpdateRequest(birthday: $birthday, links: $links, name: $name, addresses: $addresses, emails: $emails, id: $id, note: $note, phones: $phones, social_medias: $social_medias)';
  }
