...
class _$_ContactInfo implements _ContactInfo {
  ...
  @override
  String toString() {
    return 'ContactInfo(created_at: $created_at, emails: $emails, id: $id, links: $links, name: $name, updated_at: $updated_at, addresses: $addresses, birthday: $birthday, note: $note, phones: $phones, social_medias: $social_medias)';
  }
...
class _$_UpdateRequest implements _UpdateRequest {
  ...
  @override
  String toString() {
    return 'UpdateRequest(addresses: $addresses, links: $links, note: $note, phones: $phones, birthday: $birthday, emails: $emails, id: $id, name: $name, social_medias: $social_medias)';
  }
