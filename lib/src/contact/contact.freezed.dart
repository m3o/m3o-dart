...
class _$_ContactInfo implements _ContactInfo {
  ...
  @override
  String toString() {
    return 'ContactInfo(addresses: $addresses, birthday: $birthday, links: $links, note: $note, phones: $phones, social_medias: $social_medias, created_at: $created_at, emails: $emails, id: $id, name: $name, updated_at: $updated_at)';
  }
...
class _$_UpdateRequest implements _UpdateRequest {
  ...
  @override
  String toString() {
    return 'UpdateRequest(name: $name, phones: $phones, social_medias: $social_medias, addresses: $addresses, birthday: $birthday, links: $links, emails: $emails, id: $id, note: $note)';
  }
