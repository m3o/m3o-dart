...
class _$_ContactInfo implements _ContactInfo {
  ...
  @override
  String toString() {
    return 'ContactInfo(addresses: $addresses, emails: $emails, name: $name, note: $note, updated_at: $updated_at, birthday: $birthday, created_at: $created_at, id: $id, links: $links, phones: $phones, social_medias: $social_medias)';
  }
...
class _$_UpdateRequest implements _UpdateRequest {
  ...
  @override
  String toString() {
    return 'UpdateRequest(phones: $phones, addresses: $addresses, birthday: $birthday, id: $id, name: $name, emails: $emails, links: $links, note: $note, social_medias: $social_medias)';
  }
