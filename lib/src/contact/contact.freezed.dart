...
class _$_ContactInfo implements _ContactInfo {
  ...
  @override
  String toString() {
    return 'ContactInfo(id: $id, note: $note, phones: $phones, social_medias: $social_medias, updated_at: $updated_at, emails: $emails, birthday: $birthday, created_at: $created_at, links: $links, name: $name, addresses: $addresses)';
  }
...
class _$_UpdateRequest implements _UpdateRequest {
  ...
  @override
  String toString() {
    return 'UpdateRequest(id: $id, name: $name, note: $note, addresses: $addresses, birthday: $birthday, emails: $emails, links: $links, phones: $phones, social_medias: $social_medias)';
  }
