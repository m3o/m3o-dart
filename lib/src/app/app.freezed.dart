...
class _$_Service implements _Service {
  ...
  @override
  String toString() {
    return 'Service(branch: $branch, created: $created, id: $id, repo: $repo, region: $region, status: $status, updated: $updated, url: $url, custom_domains: $custom_domains, env_vars: $env_vars, name: $name, port: $port)';
  }
