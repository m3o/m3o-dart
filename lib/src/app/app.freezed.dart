...
class _$_Service implements _Service {
  ...
  @override
  String toString() {
    return 'Service(env_vars: $env_vars, region: $region, updated: $updated, branch: $branch, created: $created, custom_domains: $custom_domains, repo: $repo, status: $status, url: $url, id: $id, name: $name, port: $port)';
  }
