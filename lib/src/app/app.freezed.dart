...
class _$_Service implements _Service {
  ...
  @override
  String toString() {
    return 'Service(branch: $branch, name: $name, region: $region, repo: $repo, status: $status, created: $created, custom_domains: $custom_domains, env_vars: $env_vars, id: $id, port: $port, updated: $updated, url: $url)';
  }
