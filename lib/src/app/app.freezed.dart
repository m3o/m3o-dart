...
class _$_Service implements _Service {
  ...
  @override
  String toString() {
    return 'Service(updated: $updated, branch: $branch, created: $created, port: $port, region: $region, repo: $repo, status: $status, url: $url, custom_domains: $custom_domains, env_vars: $env_vars, id: $id, name: $name)';
  }
