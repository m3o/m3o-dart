...
class _$_Service implements _Service {
  ...
  @override
  String toString() {
    return 'Service(name: $name, port: $port, region: $region, url: $url, updated: $updated, branch: $branch, created: $created, custom_domains: $custom_domains, env_vars: $env_vars, id: $id, repo: $repo, status: $status)';
  }
