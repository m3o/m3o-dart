...
class _$_Service implements _Service {
  ...
  @override
  String toString() {
    return 'Service(region: $region, updated: $updated, branch: $branch, custom_domains: $custom_domains, port: $port, name: $name, repo: $repo, status: $status, url: $url, created: $created, env_vars: $env_vars, id: $id)';
  }
