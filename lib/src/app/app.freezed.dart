...
class _$_Service implements _Service {
  ...
  @override
  String toString() {
    return 'Service(updated: $updated, branch: $branch, created: $created, custom_domains: $custom_domains, env_vars: $env_vars, port: $port, region: $region, status: $status, url: $url, backend: $backend, id: $id, name: $name, repo: $repo)';
  }
