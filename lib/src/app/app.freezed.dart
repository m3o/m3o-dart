...
class _$_Service implements _Service {
  ...
  @override
  String toString() {
    return 'Service(created: $created, id: $id, name: $name, repo: $repo, status: $status, branch: $branch, custom_domains: $custom_domains, env_vars: $env_vars, port: $port, region: $region, updated: $updated, url: $url)';
  }
