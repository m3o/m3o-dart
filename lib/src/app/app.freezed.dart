...
class _$_Service implements _Service {
  ...
  @override
  String toString() {
    return 'Service(created: $created, id: $id, region: $region, url: $url, branch: $branch, env_vars: $env_vars, name: $name, port: $port, repo: $repo, status: $status, updated: $updated, custom_domains: $custom_domains)';
  }
