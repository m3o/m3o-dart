...
class _$_Service implements _Service {
  ...
  @override
  String toString() {
    return 'Service(created: $created, region: $region, status: $status, url: $url, repo: $repo, updated: $updated, branch: $branch, custom_domains: $custom_domains, env_vars: $env_vars, id: $id, name: $name, port: $port)';
  }
