...
class _$_Service implements _Service {
  ...
  @override
  String toString() {
    return 'Service(status: $status, created: $created, env_vars: $env_vars, name: $name, port: $port, repo: $repo, updated: $updated, url: $url, branch: $branch, custom_domains: $custom_domains, id: $id, region: $region)';
  }
