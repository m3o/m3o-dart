...
class _$_Service implements _Service {
  ...
  @override
  String toString() {
    return 'Service(branch: $branch, env_vars: $env_vars, region: $region, updated: $updated, url: $url, created: $created, custom_domains: $custom_domains, id: $id, name: $name, port: $port, repo: $repo, status: $status)';
  }
