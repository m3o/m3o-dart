...
class _$_Service implements _Service {
  ...
  @override
  String toString() {
    return 'Service(region: $region, env_vars: $env_vars, created: $created, custom_domains: $custom_domains, id: $id, name: $name, port: $port, repo: $repo, status: $status, branch: $branch, url: $url, updated: $updated)';
  }
