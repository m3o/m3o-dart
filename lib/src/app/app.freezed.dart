...
class _$_Service implements _Service {
  ...
  @override
  String toString() {
    return 'Service(region: $region, repo: $repo, url: $url, id: $id, created: $created, custom_domains: $custom_domains, env_vars: $env_vars, name: $name, port: $port, status: $status, updated: $updated, branch: $branch)';
  }
