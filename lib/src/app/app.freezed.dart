...
class _$_Service implements _Service {
  ...
  @override
  String toString() {
    return 'Service(custom_domains: $custom_domains, name: $name, status: $status, branch: $branch, env_vars: $env_vars, id: $id, port: $port, region: $region, repo: $repo, updated: $updated, url: $url, created: $created)';
  }
