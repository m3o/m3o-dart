...
class _$_Service implements _Service {
  ...
  @override
  String toString() {
    return 'Service(status: $status, updated: $updated, url: $url, branch: $branch, name: $name, port: $port, region: $region, repo: $repo, created: $created, custom_domains: $custom_domains, env_vars: $env_vars, id: $id)';
  }
