...
class _$_Service implements _Service {
  ...
  @override
  String toString() {
    return 'Service(branch: $branch, repo: $repo, status: $status, updated: $updated, port: $port, region: $region, url: $url, created: $created, custom_domains: $custom_domains, env_vars: $env_vars, id: $id, name: $name)';
  }
