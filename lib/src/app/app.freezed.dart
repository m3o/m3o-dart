...
class _$_Service implements _Service {
  ...
  @override
  String toString() {
    return 'Service(id: $id, port: $port, status: $status, env_vars: $env_vars, created: $created, custom_domains: $custom_domains, name: $name, region: $region, repo: $repo, updated: $updated, url: $url, branch: $branch)';
  }
