...
class _$_Service implements _Service {
  ...
  @override
  String toString() {
    return 'Service(name: $name, port: $port, region: $region, updated: $updated, branch: $branch, id: $id, env_vars: $env_vars, repo: $repo, status: $status, url: $url, created: $created, custom_domains: $custom_domains)';
  }
