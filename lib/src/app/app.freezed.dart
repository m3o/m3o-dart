...
class _$_Service implements _Service {
  ...
  @override
  String toString() {
    return 'Service(custom_domains: $custom_domains, env_vars: $env_vars, port: $port, repo: $repo, region: $region, status: $status, updated: $updated, url: $url, branch: $branch, created: $created, id: $id, name: $name)';
  }
