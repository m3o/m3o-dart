...
class _$_Service implements _Service {
  ...
  @override
  String toString() {
    return 'Service(status: $status, updated: $updated, branch: $branch, created: $created, env_vars: $env_vars, id: $id, region: $region, repo: $repo, url: $url, custom_domains: $custom_domains, name: $name, port: $port)';
  }
