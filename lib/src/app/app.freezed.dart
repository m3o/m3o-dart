...
class _$_Service implements _Service {
  ...
  @override
  String toString() {
    return 'Service(env_vars: $env_vars, id: $id, port: $port, region: $region, url: $url, branch: $branch, custom_domains: $custom_domains, name: $name, repo: $repo, status: $status, updated: $updated, created: $created)';
  }
