...
class _$_Service implements _Service {
  ...
  @override
  String toString() {
    return 'Service(branch: $branch, created: $created, custom_domains: $custom_domains, port: $port, region: $region, status: $status, updated: $updated, env_vars: $env_vars, id: $id, name: $name, repo: $repo, url: $url)';
  }
