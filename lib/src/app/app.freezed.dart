...
class _$_Service implements _Service {
  ...
  @override
  String toString() {
    return 'Service(branch: $branch, custom_domains: $custom_domains, id: $id, port: $port, repo: $repo, url: $url, created: $created, env_vars: $env_vars, name: $name, region: $region, status: $status, updated: $updated)';
  }
