...
class _$_Service implements _Service {
  ...
  @override
  String toString() {
    return 'Service(port: $port, repo: $repo, updated: $updated, branch: $branch, created: $created, id: $id, name: $name, region: $region, status: $status, url: $url, custom_domains: $custom_domains, env_vars: $env_vars)';
  }
