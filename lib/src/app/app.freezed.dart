...
class _$_Service implements _Service {
  ...
  @override
  String toString() {
    return 'Service(created: $created, custom_domains: $custom_domains, id: $id, name: $name, port: $port, status: $status, branch: $branch, region: $region, repo: $repo, updated: $updated, url: $url, env_vars: $env_vars)';
  }
