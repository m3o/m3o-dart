...
class _$_Service implements _Service {
  ...
  @override
  String toString() {
    return 'Service(custom_domains: $custom_domains, env_vars: $env_vars, repo: $repo, updated: $updated, url: $url, branch: $branch, created: $created, port: $port, region: $region, status: $status, id: $id, name: $name)';
  }
