...
class _$_Service implements _Service {
  ...
  @override
  String toString() {
    return 'Service(region: $region, url: $url, branch: $branch, custom_domains: $custom_domains, env_vars: $env_vars, id: $id, name: $name, updated: $updated, backend: $backend, created: $created, port: $port, repo: $repo, status: $status)';
  }
