...
class _$_Service implements _Service {
  ...
  @override
  String toString() {
    return 'Service(name: $name, port: $port, url: $url, branch: $branch, created: $created, env_vars: $env_vars, repo: $repo, status: $status, updated: $updated, custom_domains: $custom_domains, id: $id, region: $region)';
  }
