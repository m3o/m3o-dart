...
class _$_Service implements _Service {
  ...
  @override
  String toString() {
    return 'Service(updated: $updated, env_vars: $env_vars, id: $id, name: $name, port: $port, repo: $repo, status: $status, branch: $branch, created: $created, custom_domains: $custom_domains, region: $region, url: $url)';
  }
