...
class _$_Service implements _Service {
  ...
  @override
  String toString() {
    return 'Service(created: $created, custom_domains: $custom_domains, env_vars: $env_vars, port: $port, region: $region, repo: $repo, url: $url, branch: $branch, name: $name, status: $status, updated: $updated, id: $id)';
  }
