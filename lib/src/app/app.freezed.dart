...
class _$_Service implements _Service {
  ...
  @override
  String toString() {
    return 'Service(branch: $branch, created: $created, custom_domains: $custom_domains, env_vars: $env_vars, id: $id, repo: $repo, status: $status, name: $name, port: $port, region: $region, updated: $updated, url: $url)';
  }
