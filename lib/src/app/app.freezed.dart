...
class _$_Service implements _Service {
  ...
  @override
  String toString() {
    return 'Service(created: $created, id: $id, port: $port, region: $region, updated: $updated, branch: $branch, custom_domains: $custom_domains, env_vars: $env_vars, name: $name, repo: $repo, status: $status, url: $url)';
  }
