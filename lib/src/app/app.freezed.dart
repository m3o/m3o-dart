...
class _$_Service implements _Service {
  ...
  @override
  String toString() {
    return 'Service(repo: $repo, url: $url, created: $created, custom_domains: $custom_domains, env_vars: $env_vars, name: $name, region: $region, branch: $branch, id: $id, port: $port, status: $status, updated: $updated)';
  }
