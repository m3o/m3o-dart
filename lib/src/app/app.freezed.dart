...
class _$_Service implements _Service {
  ...
  @override
  String toString() {
    return 'Service(id: $id, repo: $repo, updated: $updated, url: $url, created: $created, env_vars: $env_vars, name: $name, port: $port, region: $region, status: $status, branch: $branch, custom_domains: $custom_domains)';
  }
