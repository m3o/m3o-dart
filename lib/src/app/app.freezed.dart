...
class _$_Service implements _Service {
  ...
  @override
  String toString() {
    return 'Service(created: $created, env_vars: $env_vars, port: $port, region: $region, repo: $repo, status: $status, updated: $updated, branch: $branch, url: $url, id: $id, name: $name, custom_domains: $custom_domains)';
  }
