...
class _$_Service implements _Service {
  ...
  @override
  String toString() {
    return 'Service(name: $name, port: $port, region: $region, repo: $repo, status: $status, updated: $updated, id: $id, created: $created, custom_domains: $custom_domains, env_vars: $env_vars, url: $url, branch: $branch)';
  }
