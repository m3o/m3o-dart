...
class _$_Service implements _Service {
  ...
  @override
  String toString() {
    return 'Service(name: $name, region: $region, repo: $repo, status: $status, updated: $updated, created: $created, env_vars: $env_vars, id: $id, url: $url, branch: $branch, custom_domains: $custom_domains, port: $port)';
  }
