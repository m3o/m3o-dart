...
class _$_Service implements _Service {
  ...
  @override
  String toString() {
    return 'Service(branch: $branch, custom_domains: $custom_domains, id: $id, name: $name, port: $port, status: $status, updated: $updated, created: $created, env_vars: $env_vars, region: $region, repo: $repo, url: $url)';
  }
