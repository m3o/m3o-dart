...
class _$_Service implements _Service {
  ...
  @override
  String toString() {
    return 'Service(repo: $repo, url: $url, branch: $branch, created: $created, custom_domains: $custom_domains, id: $id, name: $name, env_vars: $env_vars, port: $port, region: $region, status: $status, updated: $updated)';
  }
