...
class _$_Service implements _Service {
  ...
  @override
  String toString() {
    return 'Service(created: $created, updated: $updated, url: $url, id: $id, name: $name, port: $port, region: $region, repo: $repo, branch: $branch, custom_domains: $custom_domains, env_vars: $env_vars, status: $status)';
  }
