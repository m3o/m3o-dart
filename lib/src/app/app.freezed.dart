...
class _$_Service implements _Service {
  ...
  @override
  String toString() {
    return 'Service(port: $port, repo: $repo, updated: $updated, custom_domains: $custom_domains, id: $id, env_vars: $env_vars, name: $name, region: $region, status: $status, url: $url, branch: $branch, created: $created)';
  }
