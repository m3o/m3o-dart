...
class _$_Service implements _Service {
  ...
  @override
  String toString() {
    return 'Service(region: $region, url: $url, created: $created, custom_domains: $custom_domains, id: $id, name: $name, status: $status, updated: $updated, branch: $branch, env_vars: $env_vars, port: $port, repo: $repo)';
  }
