...
class _$_Service implements _Service {
  ...
  @override
  String toString() {
    return 'Service(branch: $branch, env_vars: $env_vars, status: $status, updated: $updated, url: $url, region: $region, repo: $repo, created: $created, custom_domains: $custom_domains, id: $id, name: $name, port: $port)';
  }
