...
class _$_Service implements _Service {
  ...
  @override
  String toString() {
    return 'Service(url: $url, custom_domains: $custom_domains, env_vars: $env_vars, port: $port, name: $name, region: $region, repo: $repo, status: $status, updated: $updated, branch: $branch, created: $created, id: $id)';
  }
