...
class _$_Service implements _Service {
  ...
  @override
  String toString() {
    return 'Service(url: $url, custom_domains: $custom_domains, env_vars: $env_vars, name: $name, port: $port, region: $region, status: $status, branch: $branch, created: $created, id: $id, repo: $repo, updated: $updated)';
  }
