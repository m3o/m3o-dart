...
class _$_Service implements _Service {
  ...
  @override
  String toString() {
    return 'Service(repo: $repo, branch: $branch, created: $created, custom_domains: $custom_domains, env_vars: $env_vars, id: $id, name: $name, region: $region, url: $url, port: $port, status: $status, updated: $updated)';
  }
