...
class _$_Service implements _Service {
  ...
  @override
  String toString() {
    return 'Service(env_vars: $env_vars, id: $id, name: $name, port: $port, url: $url, custom_domains: $custom_domains, created: $created, region: $region, repo: $repo, status: $status, updated: $updated, branch: $branch)';
  }
