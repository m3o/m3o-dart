...
class _$_Service implements _Service {
  ...
  @override
  String toString() {
    return 'Service(region: $region, status: $status, updated: $updated, branch: $branch, port: $port, env_vars: $env_vars, id: $id, name: $name, repo: $repo, url: $url, created: $created, custom_domains: $custom_domains)';
  }
...
abstract class _Service implements Service {
  const factory _Service(
      ...
      final String? url,
      final String? created,
      final List<String>? custom_domains}) = _$_Service;
