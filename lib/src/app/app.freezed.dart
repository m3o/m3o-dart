...
class _$_Service implements _Service {
  ...
  @override
  String toString() {
    return 'Service(name: $name, port: $port, region: $region, repo: $repo, status: $status, created: $created, env_vars: $env_vars, id: $id, updated: $updated, branch: $branch, custom_domains: $custom_domains, url: $url)';
  }
