...
class _$_Service implements _Service {
  ...
  @override
  String toString() {
    return 'Service(name: $name, branch: $branch, custom_domains: $custom_domains, env_vars: $env_vars, id: $id, status: $status, updated: $updated, url: $url, created: $created, port: $port, region: $region, repo: $repo)';
  }
