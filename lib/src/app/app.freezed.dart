...
class _$_Service implements _Service {
  ...
  @override
  String toString() {
    return 'Service(port: $port, repo: $repo, status: $status, updated: $updated, created: $created, custom_domains: $custom_domains, env_vars: $env_vars, region: $region, url: $url, branch: $branch, id: $id, name: $name)';
  }
