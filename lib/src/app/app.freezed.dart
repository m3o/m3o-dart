...
class _$_Service implements _Service {
  ...
  @override
  String toString() {
    return 'Service(created: $created, name: $name, port: $port, region: $region, repo: $repo, status: $status, branch: $branch, custom_domains: $custom_domains, env_vars: $env_vars, id: $id, updated: $updated, url: $url)';
  }
