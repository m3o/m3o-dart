...
class _$_Service implements _Service {
  ...
  @override
  String toString() {
    return 'Service(name: $name, repo: $repo, status: $status, updated: $updated, branch: $branch, custom_domains: $custom_domains, env_vars: $env_vars, region: $region, url: $url, created: $created, id: $id, port: $port)';
  }
