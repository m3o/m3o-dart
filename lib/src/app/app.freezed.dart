...
class _$_Service implements _Service {
  ...
  @override
  String toString() {
    return 'Service(region: $region, repo: $repo, status: $status, branch: $branch, created: $created, custom_domains: $custom_domains, env_vars: $env_vars, id: $id, name: $name, port: $port, updated: $updated, url: $url)';
  }
