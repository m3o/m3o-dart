...
class _$_Service implements _Service {
  ...
  @override
  String toString() {
    return 'Service(id: $id, region: $region, updated: $updated, custom_domains: $custom_domains, env_vars: $env_vars, name: $name, port: $port, repo: $repo, status: $status, url: $url, branch: $branch, created: $created)';
  }
