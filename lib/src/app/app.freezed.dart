...
class _$_Service implements _Service {
  ...
  @override
  String toString() {
    return 'Service(status: $status, branch: $branch, custom_domains: $custom_domains, env_vars: $env_vars, id: $id, port: $port, repo: $repo, created: $created, name: $name, region: $region, updated: $updated, url: $url)';
  }
