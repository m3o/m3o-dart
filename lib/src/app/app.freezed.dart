...
class _$_Service implements _Service {
  ...
  @override
  String toString() {
    return 'Service(env_vars: $env_vars, id: $id, port: $port, repo: $repo, updated: $updated, branch: $branch, custom_domains: $custom_domains, name: $name, region: $region, status: $status, url: $url, created: $created)';
  }
