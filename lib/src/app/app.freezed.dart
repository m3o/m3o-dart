...
class _$_Service implements _Service {
  ...
  @override
  String toString() {
    return 'Service(branch: $branch, custom_domains: $custom_domains, id: $id, port: $port, repo: $repo, updated: $updated, url: $url, backend: $backend, created: $created, env_vars: $env_vars, name: $name, region: $region, status: $status)';
  }
...
abstract class _Service implements Service {
  const factory _Service(
      ...
      final String? name,
      final String? region,
      final String? status}) = _$_Service;
