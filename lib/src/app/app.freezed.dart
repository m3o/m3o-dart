...
class _$_Service implements _Service {
  ...
  @override
  String toString() {
    return 'Service(id: $id, name: $name, port: $port, region: $region, status: $status, branch: $branch, created: $created, env_vars: $env_vars, updated: $updated, url: $url, custom_domains: $custom_domains, repo: $repo)';
  }
