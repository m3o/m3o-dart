...
class _$_Service implements _Service {
  ...
  @override
  String toString() {
    return 'Service(branch: $branch, custom_domains: $custom_domains, id: $id, region: $region, repo: $repo, status: $status, created: $created, env_vars: $env_vars, name: $name, port: $port, updated: $updated, url: $url)';
  }
