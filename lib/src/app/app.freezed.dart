...
class _$_Service implements _Service {
  ...
  @override
  String toString() {
    return 'Service(id: $id, name: $name, port: $port, updated: $updated, created: $created, custom_domains: $custom_domains, env_vars: $env_vars, region: $region, repo: $repo, status: $status, url: $url, branch: $branch)';
  }
