...
class _$_Service implements _Service {
  ...
  @override
  String toString() {
    return 'Service(name: $name, region: $region, updated: $updated, url: $url, created: $created, env_vars: $env_vars, id: $id, port: $port, repo: $repo, status: $status, branch: $branch, custom_domains: $custom_domains)';
  }
