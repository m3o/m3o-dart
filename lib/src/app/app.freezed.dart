...
class _$_Service implements _Service {
  ...
  @override
  String toString() {
    return 'Service(branch: $branch, env_vars: $env_vars, name: $name, port: $port, status: $status, url: $url, created: $created, custom_domains: $custom_domains, id: $id, region: $region, repo: $repo, updated: $updated)';
  }
