...
class _$_Service implements _Service {
  ...
  @override
  String toString() {
    return 'Service(url: $url, branch: $branch, created: $created, env_vars: $env_vars, region: $region, updated: $updated, status: $status, custom_domains: $custom_domains, id: $id, name: $name, port: $port, repo: $repo)';
  }
