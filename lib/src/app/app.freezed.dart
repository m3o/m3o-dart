...
class _$_Service implements _Service {
  ...
  @override
  String toString() {
    return 'Service(repo: $repo, created: $created, custom_domains: $custom_domains, env_vars: $env_vars, id: $id, name: $name, port: $port, region: $region, status: $status, branch: $branch, updated: $updated, url: $url)';
  }
