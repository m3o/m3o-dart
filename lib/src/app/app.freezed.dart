...
class _$_Service implements _Service {
  ...
  @override
  String toString() {
    return 'Service(env_vars: $env_vars, port: $port, region: $region, repo: $repo, updated: $updated, branch: $branch, created: $created, custom_domains: $custom_domains, id: $id, name: $name, status: $status, url: $url)';
  }
