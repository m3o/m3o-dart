...
class _$_Service implements _Service {
  ...
  @override
  String toString() {
    return 'Service(updated: $updated, branch: $branch, custom_domains: $custom_domains, env_vars: $env_vars, repo: $repo, status: $status, url: $url, created: $created, id: $id, name: $name, port: $port, region: $region)';
  }
