...
class _$_Service implements _Service {
  ...
  @override
  String toString() {
    return 'Service(branch: $branch, custom_domains: $custom_domains, name: $name, repo: $repo, status: $status, created: $created, env_vars: $env_vars, id: $id, port: $port, region: $region, updated: $updated, url: $url)';
  }
