...
class _$_Service implements _Service {
  ...
  @override
  String toString() {
    return 'Service(updated: $updated, url: $url, created: $created, id: $id, port: $port, repo: $repo, status: $status, branch: $branch, custom_domains: $custom_domains, env_vars: $env_vars, name: $name, region: $region)';
  }
