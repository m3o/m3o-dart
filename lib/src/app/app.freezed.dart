...
class _$_Service implements _Service {
  ...
  @override
  String toString() {
    return 'Service(id: $id, port: $port, region: $region, updated: $updated, url: $url, branch: $branch, custom_domains: $custom_domains, env_vars: $env_vars, status: $status, created: $created, name: $name, repo: $repo)';
  }
