...
class _$_Service implements _Service {
  ...
  @override
  String toString() {
    return 'Service(env_vars: $env_vars, name: $name, port: $port, updated: $updated, url: $url, branch: $branch, created: $created, custom_domains: $custom_domains, id: $id, region: $region, repo: $repo, status: $status)';
  }
