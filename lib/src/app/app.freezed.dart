...
class _$_Service implements _Service {
  ...
  @override
  String toString() {
    return 'Service(branch: $branch, created: $created, env_vars: $env_vars, name: $name, updated: $updated, status: $status, url: $url, custom_domains: $custom_domains, id: $id, port: $port, region: $region, repo: $repo)';
  }
