...
class _$_Service implements _Service {
  ...
  @override
  String toString() {
    return 'Service(repo: $repo, status: $status, url: $url, branch: $branch, created: $created, id: $id, port: $port, region: $region, custom_domains: $custom_domains, env_vars: $env_vars, name: $name, updated: $updated)';
  }
