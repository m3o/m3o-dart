...
class _$_Service implements _Service {
  ...
  @override
  String toString() {
    return 'Service(custom_domains: $custom_domains, env_vars: $env_vars, repo: $repo, status: $status, updated: $updated, branch: $branch, created: $created, id: $id, name: $name, port: $port, region: $region, url: $url)';
  }
