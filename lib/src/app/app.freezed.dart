...
class _$_Service implements _Service {
  ...
  @override
  String toString() {
    return 'Service(env_vars: $env_vars, name: $name, port: $port, region: $region, repo: $repo, status: $status, created: $created, custom_domains: $custom_domains, updated: $updated, url: $url, branch: $branch, id: $id)';
  }
