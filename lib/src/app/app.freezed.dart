...
class _$_Service implements _Service {
  ...
  @override
  String toString() {
    return 'Service(id: $id, name: $name, port: $port, region: $region, url: $url, created: $created, custom_domains: $custom_domains, repo: $repo, status: $status, updated: $updated, branch: $branch, env_vars: $env_vars)';
  }
