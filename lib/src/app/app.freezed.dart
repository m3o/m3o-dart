...
class _$_Service implements _Service {
  ...
  @override
  String toString() {
    return 'Service(created: $created, custom_domains: $custom_domains, port: $port, repo: $repo, status: $status, branch: $branch, env_vars: $env_vars, id: $id, name: $name, region: $region, updated: $updated, url: $url)';
  }
