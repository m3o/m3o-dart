...
class _$_Service implements _Service {
  ...
  @override
  String toString() {
    return 'Service(branch: $branch, created: $created, env_vars: $env_vars, region: $region, status: $status, url: $url, custom_domains: $custom_domains, id: $id, name: $name, port: $port, repo: $repo, updated: $updated)';
  }
