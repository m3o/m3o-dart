...
class _$_Service implements _Service {
  ...
  @override
  String toString() {
    return 'Service(custom_domains: $custom_domains, env_vars: $env_vars, id: $id, name: $name, port: $port, region: $region, repo: $repo, branch: $branch, updated: $updated, status: $status, url: $url, created: $created)';
  }
