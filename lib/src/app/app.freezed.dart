...
class _$_Service implements _Service {
  ...
  @override
  String toString() {
    return 'Service(env_vars: $env_vars, id: $id, name: $name, port: $port, url: $url, branch: $branch, created: $created, repo: $repo, status: $status, updated: $updated, custom_domains: $custom_domains, region: $region)';
  }
