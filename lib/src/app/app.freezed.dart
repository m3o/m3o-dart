...
class _$_Service implements _Service {
  ...
  @override
  String toString() {
    return 'Service(custom_domains: $custom_domains, name: $name, repo: $repo, url: $url, branch: $branch, created: $created, port: $port, region: $region, status: $status, updated: $updated, env_vars: $env_vars, id: $id)';
  }
