...
class _$_Service implements _Service {
  ...
  @override
  String toString() {
    return 'Service(env_vars: $env_vars, port: $port, region: $region, repo: $repo, created: $created, custom_domains: $custom_domains, name: $name, status: $status, updated: $updated, url: $url, branch: $branch, id: $id)';
  }
