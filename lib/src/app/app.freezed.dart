...
class _$_Service implements _Service {
  ...
  @override
  String toString() {
    return 'Service(url: $url, created: $created, id: $id, port: $port, region: $region, repo: $repo, status: $status, updated: $updated, branch: $branch, custom_domains: $custom_domains, env_vars: $env_vars, name: $name)';
  }
