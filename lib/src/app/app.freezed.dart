...
class _$_Service implements _Service {
  ...
  @override
  String toString() {
    return 'Service(repo: $repo, url: $url, id: $id, name: $name, port: $port, env_vars: $env_vars, region: $region, status: $status, updated: $updated, branch: $branch, created: $created, custom_domains: $custom_domains)';
  }
