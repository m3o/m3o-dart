...
class _$_Service implements _Service {
  ...
  @override
  String toString() {
    return 'Service(url: $url, branch: $branch, custom_domains: $custom_domains, id: $id, name: $name, port: $port, region: $region, repo: $repo, created: $created, env_vars: $env_vars, status: $status, updated: $updated)';
  }
