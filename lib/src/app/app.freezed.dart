...
class _$_Service implements _Service {
  ...
  @override
  String toString() {
    return 'Service(custom_domains: $custom_domains, env_vars: $env_vars, port: $port, region: $region, url: $url, branch: $branch, created: $created, id: $id, name: $name, repo: $repo, status: $status, updated: $updated)';
  }
