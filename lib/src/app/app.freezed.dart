...
class _$_Service implements _Service {
  ...
  @override
  String toString() {
    return 'Service(id: $id, name: $name, region: $region, repo: $repo, status: $status, updated: $updated, url: $url, branch: $branch, created: $created, custom_domains: $custom_domains, env_vars: $env_vars, port: $port)';
  }
