...
class _$_Service implements _Service {
  ...
  @override
  String toString() {
    return 'Service(url: $url, custom_domains: $custom_domains, env_vars: $env_vars, name: $name, port: $port, repo: $repo, updated: $updated, branch: $branch, created: $created, id: $id, region: $region, status: $status)';
  }
