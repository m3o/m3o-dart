...
class _$_CreateRequest implements _CreateRequest {
  ...
  int get hashCode => Object.hash(runtimeType, private,
      const DeepCollectionEquality().hash(_user_ids), description, name);
...
class _$_Message implements _Message {
  ...
  int get hashCode => Object.hash(
      runtimeType, text, user_id, client, group_id, id, sent_at, subject);
...
class _$_SendRequest implements _SendRequest {
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, client, group_id, subject, text, user_id);
