...
class _$_Result implements _Result {
  ...
  @override
  String toString() {
    return 'Result(types: $types, address: $address, location: $location, name: $name, rating: $rating, type: $type, icon_url: $icon_url, open_now: $open_now, opening_hours: $opening_hours, vicinity: $vicinity)';
  }
