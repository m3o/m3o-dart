...
class _$_Result implements _Result {
  ...
  @override
  String toString() {
    return 'Result(location: $location, open_now: $open_now, opening_hours: $opening_hours, rating: $rating, types: $types, address: $address, icon_url: $icon_url, vicinity: $vicinity, name: $name, type: $type)';
  }
