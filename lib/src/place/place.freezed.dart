...
class _$_Result implements _Result {
  ...
  @override
  String toString() {
    return 'Result(vicinity: $vicinity, icon_url: $icon_url, open_now: $open_now, opening_hours: $opening_hours, types: $types, type: $type, address: $address, location: $location, name: $name, rating: $rating)';
  }
