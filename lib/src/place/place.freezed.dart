...
class _$_Result implements _Result {
  ...
  @override
  String toString() {
    return 'Result(icon_url: $icon_url, rating: $rating, opening_hours: $opening_hours, type: $type, types: $types, vicinity: $vicinity, address: $address, location: $location, name: $name, open_now: $open_now)';
  }
