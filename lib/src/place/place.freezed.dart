...
class _$_Result implements _Result {
  ...
  @override
  String toString() {
    return 'Result(type: $type, vicinity: $vicinity, address: $address, name: $name, opening_hours: $opening_hours, rating: $rating, icon_url: $icon_url, location: $location, open_now: $open_now, types: $types)';
  }
