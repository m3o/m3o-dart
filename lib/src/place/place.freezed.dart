...
class _$_Result implements _Result {
  ...
  @override
  String toString() {
    return 'Result(open_now: $open_now, rating: $rating, types: $types, vicinity: $vicinity, address: $address, icon_url: $icon_url, location: $location, name: $name, opening_hours: $opening_hours, type: $type)';
  }
