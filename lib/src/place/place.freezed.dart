...
class _$_Result implements _Result {
  ...
  @override
  String toString() {
    return 'Result(icon_url: $icon_url, location: $location, opening_hours: $opening_hours, rating: $rating, vicinity: $vicinity, address: $address, name: $name, open_now: $open_now, type: $type, types: $types)';
  }
