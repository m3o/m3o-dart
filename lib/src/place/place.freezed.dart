...
class _$_Result implements _Result {
  ...
  @override
  String toString() {
    return 'Result(icon_url: $icon_url, name: $name, open_now: $open_now, type: $type, vicinity: $vicinity, address: $address, location: $location, opening_hours: $opening_hours, rating: $rating, types: $types)';
  }
