...
class _$_Result implements _Result {
  ...
  @override
  String toString() {
    return 'Result(rating: $rating, types: $types, icon_url: $icon_url, name: $name, open_now: $open_now, type: $type, vicinity: $vicinity, address: $address, location: $location, opening_hours: $opening_hours)';
  }
...
abstract class _Result implements Result {
  const factory _Result(
      ...
      final String? address,
      final String? location,
      final List<String>? opening_hours}) = _$_Result;
