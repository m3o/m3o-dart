...
class _$_NearbyRequest implements _NearbyRequest {
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, keyword, location, name, open_now, radius, type);
...
class _$_Result implements _Result {
  ...
  List<String>? get opening_hours {
    ...
    if (value == null) return null;
    if (_opening_hours is EqualUnmodifiableListView) return _opening_hours;
    // ignore: implicit_dynamic_type
    return EqualUnmodifiableListView(value);
  }
  ...
  @override
  String toString() {
    return 'Result(open_now: $open_now, opening_hours: $opening_hours, type: $type, address: $address, icon_url: $icon_url, rating: $rating, types: $types, vicinity: $vicinity, location: $location, name: $name)';
  }
...
class _$_SearchRequest implements _SearchRequest {
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, radius, type, location, open_now, query);
