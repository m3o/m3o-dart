...
class _$_Result implements _Result {
  ...
  @override
  String toString() {
    return 'Result(opening_hours: $opening_hours, rating: $rating, address: $address, icon_url: $icon_url, name: $name, open_now: $open_now, location: $location, type: $type, types: $types, vicinity: $vicinity)';
  }
