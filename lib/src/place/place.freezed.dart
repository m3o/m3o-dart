...
class _$_Result implements _Result {
  ...
  @override
  String toString() {
    return 'Result(opening_hours: $opening_hours, icon_url: $icon_url, location: $location, name: $name, open_now: $open_now, vicinity: $vicinity, address: $address, rating: $rating, type: $type, types: $types)';
  }
