...
class _$_Result implements _Result {
  ...
  @override
  String toString() {
    return 'Result(rating: $rating, location: $location, name: $name, open_now: $open_now, opening_hours: $opening_hours, vicinity: $vicinity, address: $address, icon_url: $icon_url, type: $type, types: $types)';
  }
