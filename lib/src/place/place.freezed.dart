...
class _$_Result implements _Result {
  ...
  @override
  String toString() {
    return 'Result(open_now: $open_now, rating: $rating, type: $type, address: $address, icon_url: $icon_url, opening_hours: $opening_hours, types: $types, vicinity: $vicinity, location: $location, name: $name)';
  }
