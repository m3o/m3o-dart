...
class _$_Result implements _Result {
  ...
  @override
  String toString() {
    return 'Result(rating: $rating, type: $type, types: $types, address: $address, icon_url: $icon_url, name: $name, open_now: $open_now, opening_hours: $opening_hours, vicinity: $vicinity, location: $location)';
  }
