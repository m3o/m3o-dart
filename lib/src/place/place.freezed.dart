...
class _$_Result implements _Result {
  ...
  @override
  String toString() {
    return 'Result(address: $address, name: $name, rating: $rating, types: $types, icon_url: $icon_url, location: $location, open_now: $open_now, opening_hours: $opening_hours, type: $type, vicinity: $vicinity)';
  }
