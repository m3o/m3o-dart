...
class _$_Result implements _Result {
  ...
  @override
  String toString() {
    return 'Result(types: $types, icon_url: $icon_url, location: $location, open_now: $open_now, opening_hours: $opening_hours, rating: $rating, address: $address, name: $name, type: $type, vicinity: $vicinity)';
  }
