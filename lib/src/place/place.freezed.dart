...
class _$_Result implements _Result {
  ...
  @override
  String toString() {
    return 'Result(opening_hours: $opening_hours, rating: $rating, type: $type, vicinity: $vicinity, icon_url: $icon_url, name: $name, open_now: $open_now, address: $address, location: $location, types: $types)';
  }
