...
class _$_Result implements _Result {
  ...
  @override
  String toString() {
    return 'Result(name: $name, open_now: $open_now, opening_hours: $opening_hours, rating: $rating, vicinity: $vicinity, address: $address, location: $location, types: $types, icon_url: $icon_url, type: $type)';
  }
