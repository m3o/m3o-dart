...
class _$_Result implements _Result {
  ...
  @override
  String toString() {
    return 'Result(type: $type, types: $types, vicinity: $vicinity, open_now: $open_now, opening_hours: $opening_hours, location: $location, name: $name, rating: $rating, address: $address, icon_url: $icon_url)';
  }
