...
class _$_Result implements _Result {
  ...
  @override
  String toString() {
    return 'Result(icon_url: $icon_url, name: $name, rating: $rating, type: $type, types: $types, address: $address, location: $location, open_now: $open_now, opening_hours: $opening_hours, vicinity: $vicinity)';
  }
