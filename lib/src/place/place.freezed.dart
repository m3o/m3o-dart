...
class _$_Result implements _Result {
  ...
  @override
  String toString() {
    return 'Result(opening_hours: $opening_hours, vicinity: $vicinity, icon_url: $icon_url, name: $name, open_now: $open_now, type: $type, types: $types, address: $address, location: $location, rating: $rating)';
  }
