...
class _$_Result implements _Result {
  ...
  @override
  String toString() {
    return 'Result(opening_hours: $opening_hours, rating: $rating, types: $types, vicinity: $vicinity, name: $name, open_now: $open_now, location: $location, type: $type, address: $address, icon_url: $icon_url)';
  }
