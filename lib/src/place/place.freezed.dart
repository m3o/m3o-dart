...
class _$_Result implements _Result {
  ...
  @override
  String toString() {
    return 'Result(rating: $rating, type: $type, address: $address, open_now: $open_now, name: $name, opening_hours: $opening_hours, types: $types, vicinity: $vicinity, icon_url: $icon_url, location: $location)';
  }
