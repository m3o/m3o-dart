...
class _$_Result implements _Result {
  ...
  @override
  String toString() {
    return 'Result(types: $types, address: $address, icon_url: $icon_url, location: $location, name: $name, vicinity: $vicinity, open_now: $open_now, opening_hours: $opening_hours, rating: $rating, type: $type)';
  }
