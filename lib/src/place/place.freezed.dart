...
class _$_Result implements _Result {
  ...
  @override
  String toString() {
    return 'Result(rating: $rating, types: $types, icon_url: $icon_url, open_now: $open_now, opening_hours: $opening_hours, type: $type, vicinity: $vicinity, address: $address, location: $location, name: $name)';
  }
