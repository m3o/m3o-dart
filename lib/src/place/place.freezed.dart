...
class _$_Result implements _Result {
  ...
  @override
  String toString() {
    return 'Result(rating: $rating, vicinity: $vicinity, icon_url: $icon_url, open_now: $open_now, name: $name, opening_hours: $opening_hours, type: $type, types: $types, address: $address, location: $location)';
  }
