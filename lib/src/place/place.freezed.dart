...
class _$_Result implements _Result {
  ...
  @override
  String toString() {
    return 'Result(types: $types, address: $address, icon_url: $icon_url, open_now: $open_now, opening_hours: $opening_hours, rating: $rating, type: $type, location: $location, name: $name, vicinity: $vicinity)';
  }
