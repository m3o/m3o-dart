...
class _$_Result implements _Result {
  ...
  @override
  String toString() {
    return 'Result(types: $types, vicinity: $vicinity, icon_url: $icon_url, open_now: $open_now, rating: $rating, type: $type, address: $address, location: $location, name: $name, opening_hours: $opening_hours)';
  }
