...
class _$_Result implements _Result {
  ...
  @override
  String toString() {
    return 'Result(icon_url: $icon_url, types: $types, opening_hours: $opening_hours, rating: $rating, type: $type, vicinity: $vicinity, address: $address, location: $location, name: $name, open_now: $open_now)';
  }
