...
class _$_Result implements _Result {
  ...
  @override
  String toString() {
    return 'Result(icon_url: $icon_url, name: $name, type: $type, vicinity: $vicinity, types: $types, address: $address, location: $location, open_now: $open_now, opening_hours: $opening_hours, rating: $rating)';
  }
