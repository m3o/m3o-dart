...
class _$_Result implements _Result {
  ...
  @override
  String toString() {
    return 'Result(address: $address, name: $name, open_now: $open_now, rating: $rating, type: $type, icon_url: $icon_url, location: $location, opening_hours: $opening_hours, types: $types, vicinity: $vicinity)';
  }
