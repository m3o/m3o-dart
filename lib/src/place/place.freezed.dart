...
class _$_Result implements _Result {
  ...
  @override
  String toString() {
    return 'Result(address: $address, icon_url: $icon_url, rating: $rating, type: $type, vicinity: $vicinity, location: $location, name: $name, open_now: $open_now, opening_hours: $opening_hours, types: $types)';
  }
