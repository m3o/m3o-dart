...
class _$_Result implements _Result {
  ...
  @override
  String toString() {
    return 'Result(address: $address, icon_url: $icon_url, name: $name, opening_hours: $opening_hours, vicinity: $vicinity, location: $location, open_now: $open_now, rating: $rating, type: $type, types: $types)';
  }
