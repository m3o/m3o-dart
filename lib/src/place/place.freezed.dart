...
class _$_Result implements _Result {
  ...
  @override
  String toString() {
    return 'Result(vicinity: $vicinity, location: $location, rating: $rating, type: $type, types: $types, opening_hours: $opening_hours, address: $address, icon_url: $icon_url, name: $name, open_now: $open_now)';
  }
