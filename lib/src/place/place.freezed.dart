...
class _$_Result implements _Result {
  ...
  @override
  String toString() {
    return 'Result(opening_hours: $opening_hours, rating: $rating, vicinity: $vicinity, icon_url: $icon_url, location: $location, name: $name, types: $types, address: $address, open_now: $open_now, type: $type)';
  }
