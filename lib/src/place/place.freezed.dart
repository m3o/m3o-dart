...
class _$_Result implements _Result {
  ...
  @override
  String toString() {
    return 'Result(name: $name, opening_hours: $opening_hours, rating: $rating, types: $types, location: $location, icon_url: $icon_url, open_now: $open_now, type: $type, vicinity: $vicinity, address: $address)';
  }
