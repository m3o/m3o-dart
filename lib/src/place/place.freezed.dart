...
class _$_Result implements _Result {
  ...
  @override
  String toString() {
    return 'Result(open_now: $open_now, opening_hours: $opening_hours, type: $type, vicinity: $vicinity, location: $location, icon_url: $icon_url, name: $name, rating: $rating, types: $types, address: $address)';
  }
