...
class _$_Result implements _Result {
  ...
  @override
  String toString() {
    return 'Result(address: $address, location: $location, opening_hours: $opening_hours, types: $types, icon_url: $icon_url, name: $name, open_now: $open_now, rating: $rating, type: $type, vicinity: $vicinity)';
  }
