...
class _$_Result implements _Result {
  ...
  @override
  String toString() {
    return 'Result(name: $name, open_now: $open_now, opening_hours: $opening_hours, rating: $rating, type: $type, icon_url: $icon_url, location: $location, vicinity: $vicinity, address: $address, types: $types)';
  }
