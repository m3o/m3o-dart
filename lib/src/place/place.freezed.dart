...
class _$_Result implements _Result {
  ...
  @override
  String toString() {
    return 'Result(type: $type, vicinity: $vicinity, address: $address, rating: $rating, name: $name, open_now: $open_now, opening_hours: $opening_hours, types: $types, icon_url: $icon_url, location: $location)';
  }
