...
class _$_Result implements _Result {
  ...
  @override
  String toString() {
    return 'Result(types: $types, vicinity: $vicinity, address: $address, icon_url: $icon_url, name: $name, type: $type, location: $location, open_now: $open_now, opening_hours: $opening_hours, rating: $rating)';
  }
