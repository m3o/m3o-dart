...
class _$_Result implements _Result {
  ...
  @override
  String toString() {
    return 'Result(address: $address, icon_url: $icon_url, type: $type, opening_hours: $opening_hours, rating: $rating, types: $types, vicinity: $vicinity, location: $location, name: $name, open_now: $open_now)';
  }
