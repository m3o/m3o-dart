...
class _$_Result implements _Result {
  ...
  @override
  String toString() {
    return 'Result(type: $type, address: $address, name: $name, opening_hours: $opening_hours, rating: $rating, vicinity: $vicinity, icon_url: $icon_url, location: $location, open_now: $open_now, types: $types)';
  }
