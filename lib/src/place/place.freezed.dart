...
class _$_Result implements _Result {
  ...
  @override
  String toString() {
    return 'Result(opening_hours: $opening_hours, rating: $rating, name: $name, open_now: $open_now, type: $type, types: $types, vicinity: $vicinity, address: $address, icon_url: $icon_url, location: $location)';
  }
