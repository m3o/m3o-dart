...
class _$_Result implements _Result {
  ...
  @override
  String toString() {
    return 'Result(location: $location, rating: $rating, type: $type, vicinity: $vicinity, opening_hours: $opening_hours, types: $types, address: $address, icon_url: $icon_url, name: $name, open_now: $open_now)';
  }
