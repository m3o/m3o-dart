...
class _$_Result implements _Result {
  ...
  @override
  String toString() {
    return 'Result(name: $name, opening_hours: $opening_hours, rating: $rating, type: $type, icon_url: $icon_url, location: $location, types: $types, vicinity: $vicinity, address: $address, open_now: $open_now)';
  }
