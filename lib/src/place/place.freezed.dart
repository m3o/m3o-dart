...
class _$_Result implements _Result {
  ...
  @override
  String toString() {
    return 'Result(location: $location, name: $name, rating: $rating, types: $types, vicinity: $vicinity, address: $address, icon_url: $icon_url, type: $type, open_now: $open_now, opening_hours: $opening_hours)';
  }
