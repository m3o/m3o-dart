...
class _$_Result implements _Result {
  ...
  @override
  String toString() {
    return 'Result(opening_hours: $opening_hours, rating: $rating, type: $type, vicinity: $vicinity, location: $location, name: $name, open_now: $open_now, types: $types, address: $address, icon_url: $icon_url)';
  }
