...
class _$_Result implements _Result {
  ...
  @override
  String toString() {
    return 'Result(open_now: $open_now, rating: $rating, type: $type, address: $address, location: $location, name: $name, vicinity: $vicinity, icon_url: $icon_url, opening_hours: $opening_hours, types: $types)';
  }
