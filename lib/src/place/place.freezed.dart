...
class _$_Result implements _Result {
  ...
  @override
  String toString() {
    return 'Result(vicinity: $vicinity, location: $location, name: $name, rating: $rating, opening_hours: $opening_hours, type: $type, types: $types, address: $address, icon_url: $icon_url, open_now: $open_now)';
  }
