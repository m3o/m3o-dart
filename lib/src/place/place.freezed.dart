...
class _$_Result implements _Result {
  ...
  @override
  String toString() {
    return 'Result(type: $type, vicinity: $vicinity, open_now: $open_now, rating: $rating, location: $location, name: $name, opening_hours: $opening_hours, types: $types, address: $address, icon_url: $icon_url)';
  }
