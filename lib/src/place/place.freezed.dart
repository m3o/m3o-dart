...
class _$_Result implements _Result {
  ...
  @override
  String toString() {
    return 'Result(type: $type, types: $types, icon_url: $icon_url, location: $location, name: $name, open_now: $open_now, opening_hours: $opening_hours, rating: $rating, vicinity: $vicinity, address: $address)';
  }
