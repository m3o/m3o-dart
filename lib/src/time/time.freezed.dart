...
class _$ZoneResponseData implements ZoneResponseData {
  ...
  @override
  String toString() {
    return 'ZoneResponse(region: $region, timezone: $timezone, abbreviation: $abbreviation, longitude: $longitude, latitude: $latitude, localtime: $localtime, location: $location, offset: $offset, country: $country, dst: $dst)';
  }
  ...
  TResult when<TResult extends Object?>(
    ...
    return $default(region, timezone, abbreviation, longitude, latitude,
        localtime, location, offset, country, dst);
  }
  ...
  TResult? whenOrNull<TResult extends Object?>(
    ...
    return $default?.call(region, timezone, abbreviation, longitude, latitude,
        localtime, location, offset, country, dst);
  }
