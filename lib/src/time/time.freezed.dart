...
class _$ZoneResponseData implements ZoneResponseData {
  ...
  @override
  String toString() {
    return 'ZoneResponse(region: $region, country: $country, dst: $dst, localtime: $localtime, location: $location, longitude: $longitude, offset: $offset, timezone: $timezone, abbreviation: $abbreviation, latitude: $latitude)';
  }
  ...
  TResult when<TResult extends Object?>(
    ...
    return $default(region, country, dst, localtime, location, longitude,
        offset, timezone, abbreviation, latitude);
  }
  ...
  TResult? whenOrNull<TResult extends Object?>(
    ...
    return $default?.call(region, country, dst, localtime, location, longitude,
        offset, timezone, abbreviation, latitude);
  }
