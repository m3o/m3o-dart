...
class _$ZoneResponseData implements ZoneResponseData {
  ...
  @override
  String toString() {
    return 'ZoneResponse(abbreviation: $abbreviation, location: $location, longitude: $longitude, region: $region, timezone: $timezone, country: $country, dst: $dst, latitude: $latitude, localtime: $localtime, offset: $offset)';
  }
  ...
  TResult when<TResult extends Object?>(
    ...
    return $default(abbreviation, location, longitude, region, timezone,
        country, dst, latitude, localtime, offset);
  }
  ...
  TResult? whenOrNull<TResult extends Object?>(
    ...
    return $default?.call(abbreviation, location, longitude, region, timezone,
        country, dst, latitude, localtime, offset);
  }
