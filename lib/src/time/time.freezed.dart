...
class _$ZoneResponseData implements ZoneResponseData {
  ...
  @override
  String toString() {
    return 'ZoneResponse(offset: $offset, region: $region, dst: $dst, latitude: $latitude, localtime: $localtime, location: $location, abbreviation: $abbreviation, country: $country, longitude: $longitude, timezone: $timezone)';
  }
  ...
  TResult when<TResult extends Object?>(
    ...
    return $default(offset, region, dst, latitude, localtime, location,
        abbreviation, country, longitude, timezone);
  }
  ...
  TResult? whenOrNull<TResult extends Object?>(
    ...
    return $default?.call(offset, region, dst, latitude, localtime, location,
        abbreviation, country, longitude, timezone);
  }
