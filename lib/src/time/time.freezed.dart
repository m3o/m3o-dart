...
class _$ZoneResponseData implements ZoneResponseData {
  ...
  @override
  String toString() {
    return 'ZoneResponse(country: $country, location: $location, region: $region, abbreviation: $abbreviation, dst: $dst, latitude: $latitude, localtime: $localtime, longitude: $longitude, offset: $offset, timezone: $timezone)';
  }
  ...
  TResult when<TResult extends Object?>(
    ...
    return $default(country, location, region, abbreviation, dst, latitude,
  ...
  TResult? whenOrNull<TResult extends Object?>(
    ...
    return $default?.call(country, location, region, abbreviation, dst,
