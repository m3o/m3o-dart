...
class _$ZoneResponseData implements ZoneResponseData {
  ...
  @override
  String toString() {
    return 'ZoneResponse(abbreviation: $abbreviation, country: $country, dst: $dst, localtime: $localtime, longitude: $longitude, offset: $offset, timezone: $timezone, latitude: $latitude, location: $location, region: $region)';
  }
  ...
  TResult when<TResult extends Object?>(
    ...
    return $default(abbreviation, country, dst, localtime, longitude, offset,
        timezone, latitude, location, region);
  }
  ...
  TResult? whenOrNull<TResult extends Object?>(
    ...
    return $default?.call(abbreviation, country, dst, localtime, longitude,
        offset, timezone, latitude, location, region);
  }
