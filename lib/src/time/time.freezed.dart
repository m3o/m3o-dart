...
class _$ZoneResponseData implements ZoneResponseData {
  ...
  @override
  String toString() {
    return 'ZoneResponse(location: $location, abbreviation: $abbreviation, dst: $dst, localtime: $localtime, offset: $offset, region: $region, timezone: $timezone, country: $country, latitude: $latitude, longitude: $longitude)';
  }
  ...
  TResult when<TResult extends Object?>(
    ...
    return $default(location, abbreviation, dst, localtime, offset, region,
        timezone, country, latitude, longitude);
  }
  ...
  TResult? whenOrNull<TResult extends Object?>(
    ...
    return $default?.call(location, abbreviation, dst, localtime, offset,
        region, timezone, country, latitude, longitude);
  }
