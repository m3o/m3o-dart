...
class _$ZoneResponseData implements ZoneResponseData {
  ...
  @override
  String toString() {
    return 'ZoneResponse(latitude: $latitude, offset: $offset, region: $region, abbreviation: $abbreviation, country: $country, dst: $dst, localtime: $localtime, location: $location, longitude: $longitude, timezone: $timezone)';
  }
  ...
  TResult when<TResult extends Object?>(
    ...
    return $default(latitude, offset, region, abbreviation, country, dst,
  ...
  TResult? whenOrNull<TResult extends Object?>(
    ...
    return $default?.call(latitude, offset, region, abbreviation, country, dst,
        localtime, location, longitude, timezone);
  }
