...
class _$ZoneResponseData implements ZoneResponseData {
  ...
  @override
  String toString() {
    return 'ZoneResponse(localtime: $localtime, location: $location, offset: $offset, region: $region, timezone: $timezone, abbreviation: $abbreviation, country: $country, longitude: $longitude, dst: $dst, latitude: $latitude)';
  }
  ...
  TResult when<TResult extends Object?>(
    ...
    return $default(localtime, location, offset, region, timezone, abbreviation,
        country, longitude, dst, latitude);
  }
  ...
  TResult? whenOrNull<TResult extends Object?>(
    ...
    return $default?.call(localtime, location, offset, region, timezone,
        abbreviation, country, longitude, dst, latitude);
  }
  ...
  TResult maybeWhen<TResult extends Object?>(
    ...
    if ($default != null) {
      return $default(localtime, location, offset, region, timezone,
          abbreviation, country, longitude, dst, latitude);
    }
    return orElse();
  }
