...
class _$ZoneResponseData implements ZoneResponseData {
  ...
  @override
  String toString() {
    return 'ZoneResponse(abbreviation: $abbreviation, latitude: $latitude, offset: $offset, region: $region, country: $country, dst: $dst, localtime: $localtime, location: $location, longitude: $longitude, timezone: $timezone)';
  }
  ...
  TResult when<TResult extends Object?>(
    ...
    return $default(abbreviation, latitude, offset, region, country, dst,
  ...
  TResult? whenOrNull<TResult extends Object?>(
    ...
    return $default?.call(abbreviation, latitude, offset, region, country, dst,
        localtime, location, longitude, timezone);
  }
