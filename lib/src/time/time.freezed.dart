...
class _$ZoneResponseData implements ZoneResponseData {
  ...
  @override
  String toString() {
    return 'ZoneResponse(timezone: $timezone, abbreviation: $abbreviation, offset: $offset, region: $region, localtime: $localtime, location: $location, longitude: $longitude, country: $country, dst: $dst, latitude: $latitude)';
  }
  ...
  TResult when<TResult extends Object?>(
    ...
    return $default(timezone, abbreviation, offset, region, localtime, location,
        longitude, country, dst, latitude);
  }
  ...
  TResult? whenOrNull<TResult extends Object?>(
    ...
    return $default?.call(timezone, abbreviation, offset, region, localtime,
        location, longitude, country, dst, latitude);
  }
  ...
  TResult maybeWhen<TResult extends Object?>(
    ...
    if ($default != null) {
      return $default(timezone, abbreviation, offset, region, localtime,
          location, longitude, country, dst, latitude);
    }
    return orElse();
  }
