...
class _$ZoneResponseData implements ZoneResponseData {
  ...
  @override
  String toString() {
    return 'ZoneResponse(location: $location, offset: $offset, timezone: $timezone, abbreviation: $abbreviation, dst: $dst, localtime: $localtime, longitude: $longitude, region: $region, country: $country, latitude: $latitude)';
  }
  ...
  TResult when<TResult extends Object?>(
    ...
    return $default(location, offset, timezone, abbreviation, dst, localtime,
        longitude, region, country, latitude);
  }
  ...
  TResult? whenOrNull<TResult extends Object?>(
    ...
    return $default?.call(location, offset, timezone, abbreviation, dst,
        localtime, longitude, region, country, latitude);
  }
