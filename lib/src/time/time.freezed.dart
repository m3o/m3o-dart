...
class _$ZoneResponseData implements ZoneResponseData {
  ...
  @override
  String toString() {
    return 'ZoneResponse(latitude: $latitude, location: $location, longitude: $longitude, timezone: $timezone, abbreviation: $abbreviation, country: $country, dst: $dst, localtime: $localtime, offset: $offset, region: $region)';
  }
  ...
  TResult when<TResult extends Object?>(
    ...
    return $default(latitude, location, longitude, timezone, abbreviation,
        country, dst, localtime, offset, region);
  }
  ...
  TResult? whenOrNull<TResult extends Object?>(
    ...
    return $default?.call(latitude, location, longitude, timezone, abbreviation,
        country, dst, localtime, offset, region);
  }
