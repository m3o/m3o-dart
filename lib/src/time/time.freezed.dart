...
class _$ZoneResponseData implements ZoneResponseData {
  ...
  @override
  String toString() {
    return 'ZoneResponse(longitude: $longitude, abbreviation: $abbreviation, country: $country, dst: $dst, latitude: $latitude, location: $location, localtime: $localtime, offset: $offset, region: $region, timezone: $timezone)';
  }
  ...
  TResult when<TResult extends Object?>(
    ...
    return $default(longitude, abbreviation, country, dst, latitude, location,
  ...
  TResult? whenOrNull<TResult extends Object?>(
    ...
    return $default?.call(longitude, abbreviation, country, dst, latitude,
        location, localtime, offset, region, timezone);
  }
