...
class _$ZoneResponseData implements ZoneResponseData {
  ...
  @override
  String toString() {
    return 'ZoneResponse(region: $region, timezone: $timezone, dst: $dst, latitude: $latitude, longitude: $longitude, offset: $offset, abbreviation: $abbreviation, country: $country, localtime: $localtime, location: $location)';
  }
  ...
  TResult when<TResult extends Object?>(
    ...
    return $default(region, timezone, dst, latitude, longitude, offset,
        abbreviation, country, localtime, location);
  }
  ...
  TResult? whenOrNull<TResult extends Object?>(
    ...
    return $default?.call(region, timezone, dst, latitude, longitude, offset,
        abbreviation, country, localtime, location);
  }
