...
class _$ZoneResponseData implements ZoneResponseData {
  ...
  @override
  String toString() {
    return 'ZoneResponse(abbreviation: $abbreviation, latitude: $latitude, location: $location, region: $region, timezone: $timezone, country: $country, dst: $dst, localtime: $localtime, longitude: $longitude, offset: $offset)';
  }
  ...
  TResult when<TResult extends Object?>(
    ...
    return $default(abbreviation, latitude, location, region, timezone, country,
  ...
  TResult? whenOrNull<TResult extends Object?>(
    ...
    return $default?.call(abbreviation, latitude, location, region, timezone,
  ...
  TResult maybeWhen<TResult extends Object?>(
    ...
    if ($default != null) {
      return $default(abbreviation, latitude, location, region, timezone,
          country, dst, localtime, longitude, offset);
    }
    return orElse();
  }
