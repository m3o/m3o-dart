...
class _$ZoneResponseData implements ZoneResponseData {
  ...
  @override
  String toString() {
    return 'ZoneResponse(longitude: $longitude, offset: $offset, timezone: $timezone, abbreviation: $abbreviation, country: $country, dst: $dst, latitude: $latitude, localtime: $localtime, location: $location, region: $region)';
  }
  ...
  TResult when<TResult extends Object?>(
    ...
    return $default(longitude, offset, timezone, abbreviation, country, dst,
  ...
  TResult? whenOrNull<TResult extends Object?>(
    ...
    return $default?.call(longitude, offset, timezone, abbreviation, country,
        dst, latitude, localtime, location, region);
  }
