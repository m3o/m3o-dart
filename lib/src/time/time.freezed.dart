...
class _$ZoneResponseData implements ZoneResponseData {
  ...
  @override
  String toString() {
    return 'ZoneResponse(offset: $offset, region: $region, abbreviation: $abbreviation, location: $location, latitude: $latitude, localtime: $localtime, longitude: $longitude, timezone: $timezone, country: $country, dst: $dst)';
  }
  ...
  TResult when<TResult extends Object?>(
    ...
    return $default(offset, region, abbreviation, location, latitude, localtime,
        longitude, timezone, country, dst);
  }
  ...
  TResult? whenOrNull<TResult extends Object?>(
    ...
    return $default?.call(offset, region, abbreviation, location, latitude,
        localtime, longitude, timezone, country, dst);
  }
  ...
  TResult maybeWhen<TResult extends Object?>(
    ...
    if ($default != null) {
      return $default(offset, region, abbreviation, location, latitude,
          localtime, longitude, timezone, country, dst);
    }
    return orElse();
  }
