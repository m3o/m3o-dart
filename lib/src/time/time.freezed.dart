...
class _$ZoneResponseData implements ZoneResponseData {
  ...
  @override
  String toString() {
    return 'ZoneResponse(abbreviation: $abbreviation, dst: $dst, location: $location, region: $region, timezone: $timezone, country: $country, latitude: $latitude, localtime: $localtime, longitude: $longitude, offset: $offset)';
  }
  ...
  TResult when<TResult extends Object?>(
    ...
    return $default(abbreviation, dst, location, region, timezone, country,
        latitude, localtime, longitude, offset);
  }
  ...
  TResult? whenOrNull<TResult extends Object?>(
    ...
    return $default?.call(abbreviation, dst, location, region, timezone,
        country, latitude, localtime, longitude, offset);
  }
