...
class _$ZoneResponseData implements ZoneResponseData {
  ...
  @override
  String toString() {
    return 'ZoneResponse(location: $location, offset: $offset, region: $region, timezone: $timezone, country: $country, dst: $dst, latitude: $latitude, abbreviation: $abbreviation, localtime: $localtime, longitude: $longitude)';
  }
  ...
  TResult when<TResult extends Object?>(
    ...
    return $default(location, offset, region, timezone, country, dst, latitude,
        abbreviation, localtime, longitude);
  }
  ...
  TResult? whenOrNull<TResult extends Object?>(
    ...
    return $default?.call(location, offset, region, timezone, country, dst,
        latitude, abbreviation, localtime, longitude);
  }
