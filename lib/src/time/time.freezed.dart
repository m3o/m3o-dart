...
class _$ZoneResponseData implements ZoneResponseData {
  ...
  @override
  String toString() {
    return 'ZoneResponse(localtime: $localtime, location: $location, offset: $offset, region: $region, timezone: $timezone, dst: $dst, latitude: $latitude, longitude: $longitude, abbreviation: $abbreviation, country: $country)';
  }
  ...
  TResult when<TResult extends Object?>(
    ...
    return $default(localtime, location, offset, region, timezone, dst,
        latitude, longitude, abbreviation, country);
  }
  ...
  TResult? whenOrNull<TResult extends Object?>(
    ...
    return $default?.call(localtime, location, offset, region, timezone, dst,
        latitude, longitude, abbreviation, country);
  }
