...
class _$ZoneResponseData implements ZoneResponseData {
  ...
  @override
  String toString() {
    return 'ZoneResponse(abbreviation: $abbreviation, dst: $dst, location: $location, longitude: $longitude, country: $country, latitude: $latitude, localtime: $localtime, offset: $offset, region: $region, timezone: $timezone)';
  }
  ...
  TResult when<TResult extends Object?>(
    ...
    return $default(abbreviation, dst, location, longitude, country, latitude,
        localtime, offset, region, timezone);
  }
  ...
  TResult? whenOrNull<TResult extends Object?>(
    ...
    return $default?.call(abbreviation, dst, location, longitude, country,
        latitude, localtime, offset, region, timezone);
  }
