...
class _$ZoneResponseData implements ZoneResponseData {
  ...
  @override
  String toString() {
    return 'ZoneResponse(dst: $dst, latitude: $latitude, longitude: $longitude, offset: $offset, region: $region, abbreviation: $abbreviation, country: $country, localtime: $localtime, location: $location, timezone: $timezone)';
  }
  ...
  TResult when<TResult extends Object?>(
    ...
    return $default(dst, latitude, longitude, offset, region, abbreviation,
  ...
  TResult? whenOrNull<TResult extends Object?>(
    ...
    return $default?.call(dst, latitude, longitude, offset, region,
        abbreviation, country, localtime, location, timezone);
  }
