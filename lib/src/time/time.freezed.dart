...
class _$ZoneResponseData implements ZoneResponseData {
  ...
  @override
  String toString() {
    return 'ZoneResponse(dst: $dst, location: $location, longitude: $longitude, region: $region, country: $country, latitude: $latitude, localtime: $localtime, offset: $offset, timezone: $timezone, abbreviation: $abbreviation)';
  }
  ...
  TResult when<TResult extends Object?>(
    ...
    return $default(dst, location, longitude, region, country, latitude,
  ...
  TResult? whenOrNull<TResult extends Object?>(
    ...
    return $default?.call(dst, location, longitude, region, country, latitude,
        localtime, offset, timezone, abbreviation);
  }
