...
class _$ZoneResponseData implements ZoneResponseData {
  ...
  @override
  String toString() {
    return 'ZoneResponse(timezone: $timezone, abbreviation: $abbreviation, localtime: $localtime, longitude: $longitude, location: $location, offset: $offset, region: $region, country: $country, dst: $dst, latitude: $latitude)';
  }
  ...
  TResult when<TResult extends Object?>(
    ...
    return $default(timezone, abbreviation, localtime, longitude, location,
        offset, region, country, dst, latitude);
  }
  ...
  TResult? whenOrNull<TResult extends Object?>(
    ...
    return $default?.call(timezone, abbreviation, localtime, longitude,
        location, offset, region, country, dst, latitude);
  }
