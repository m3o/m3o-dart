...
class _$ZoneResponseData implements ZoneResponseData {
  ...
  @override
  String toString() {
    return 'ZoneResponse(longitude: $longitude, timezone: $timezone, country: $country, dst: $dst, localtime: $localtime, offset: $offset, region: $region, abbreviation: $abbreviation, latitude: $latitude, location: $location)';
  }
  ...
  TResult when<TResult extends Object?>(
    ...
    return $default(longitude, timezone, country, dst, localtime, offset,
        region, abbreviation, latitude, location);
  }
  ...
  TResult? whenOrNull<TResult extends Object?>(
    ...
    return $default?.call(longitude, timezone, country, dst, localtime, offset,
        region, abbreviation, latitude, location);
  }
