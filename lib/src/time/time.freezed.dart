...
class _$ZoneResponseData implements ZoneResponseData {
  ...
  @override
  String toString() {
    return 'ZoneResponse(dst: $dst, latitude: $latitude, localtime: $localtime, longitude: $longitude, abbreviation: $abbreviation, country: $country, location: $location, offset: $offset, region: $region, timezone: $timezone)';
  }
  ...
  TResult when<TResult extends Object?>(
    ...
    return $default(dst, latitude, localtime, longitude, abbreviation, country,
  ...
  TResult? whenOrNull<TResult extends Object?>(
    ...
    return $default?.call(dst, latitude, localtime, longitude, abbreviation,
        country, location, offset, region, timezone);
  }
  ...
  TResult maybeWhen<TResult extends Object?>(
    ...
    if ($default != null) {
      return $default(dst, latitude, localtime, longitude, abbreviation,
          country, location, offset, region, timezone);
    }
    return orElse();
  }
