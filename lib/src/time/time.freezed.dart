...
class _$ZoneResponseData implements ZoneResponseData {
  ...
  @override
  String toString() {
    return 'ZoneResponse(location: $location, longitude: $longitude, dst: $dst, localtime: $localtime, latitude: $latitude, offset: $offset, region: $region, timezone: $timezone, abbreviation: $abbreviation, country: $country)';
  }
  ...
  TResult when<TResult extends Object?>(
    ...
    return $default(location, longitude, dst, localtime, latitude, offset,
  ...
  TResult? whenOrNull<TResult extends Object?>(
    ...
    return $default?.call(location, longitude, dst, localtime, latitude, offset,
        region, timezone, abbreviation, country);
  }
