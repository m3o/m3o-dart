...
class _$ZoneResponseData implements ZoneResponseData {
  ...
  @override
  String toString() {
    return 'ZoneResponse(location: $location, longitude: $longitude, country: $country, latitude: $latitude, localtime: $localtime, region: $region, timezone: $timezone, abbreviation: $abbreviation, dst: $dst, offset: $offset)';
  }
  ...
  TResult when<TResult extends Object?>(
    ...
    return $default(location, longitude, country, latitude, localtime, region,
        timezone, abbreviation, dst, offset);
  }
  ...
  TResult? whenOrNull<TResult extends Object?>(
    ...
    return $default?.call(location, longitude, country, latitude, localtime,
        region, timezone, abbreviation, dst, offset);
  }
