...
class _$ZoneResponseData implements ZoneResponseData {
  ...
  @override
  String toString() {
    return 'ZoneResponse(country: $country, latitude: $latitude, localtime: $localtime, longitude: $longitude, offset: $offset, region: $region, abbreviation: $abbreviation, dst: $dst, location: $location, timezone: $timezone)';
  }
  ...
  TResult when<TResult extends Object?>(
    ...
    return $default(country, latitude, localtime, longitude, offset, region,
        abbreviation, dst, location, timezone);
  }
  ...
  TResult? whenOrNull<TResult extends Object?>(
    ...
    return $default?.call(country, latitude, localtime, longitude, offset,
        region, abbreviation, dst, location, timezone);
  }
