...
class _$ZoneResponseData implements ZoneResponseData {
  ...
  @override
  String toString() {
    return 'ZoneResponse(region: $region, timezone: $timezone, country: $country, latitude: $latitude, localtime: $localtime, location: $location, longitude: $longitude, offset: $offset, abbreviation: $abbreviation, dst: $dst)';
  }
  ...
  TResult when<TResult extends Object?>(
    ...
    return $default(region, timezone, country, latitude, localtime, location,
        longitude, offset, abbreviation, dst);
  }
  ...
  TResult? whenOrNull<TResult extends Object?>(
    ...
    return $default?.call(region, timezone, country, latitude, localtime,
        location, longitude, offset, abbreviation, dst);
  }
