...
class _$ZoneResponseData implements ZoneResponseData {
  ...
  @override
  String toString() {
    return 'ZoneResponse(abbreviation: $abbreviation, latitude: $latitude, location: $location, offset: $offset, country: $country, dst: $dst, localtime: $localtime, longitude: $longitude, region: $region, timezone: $timezone)';
  }
  ...
  TResult when<TResult extends Object?>(
    ...
    return $default(abbreviation, latitude, location, offset, country, dst,
  ...
  TResult? whenOrNull<TResult extends Object?>(
    ...
    return $default?.call(abbreviation, latitude, location, offset, country,
        dst, localtime, longitude, region, timezone);
  }
