...
class _$ZoneResponseData implements ZoneResponseData {
  ...
  @override
  String toString() {
    return 'ZoneResponse(timezone: $timezone, dst: $dst, location: $location, offset: $offset, region: $region, longitude: $longitude, abbreviation: $abbreviation, country: $country, latitude: $latitude, localtime: $localtime)';
  }
  ...
  TResult when<TResult extends Object?>(
    ...
    return $default(timezone, dst, location, offset, region, longitude,
        abbreviation, country, latitude, localtime);
  }
  ...
  TResult? whenOrNull<TResult extends Object?>(
    ...
    return $default?.call(timezone, dst, location, offset, region, longitude,
        abbreviation, country, latitude, localtime);
  }
