...
class _$ZoneResponseData implements ZoneResponseData {
  ...
  @override
  String toString() {
    return 'ZoneResponse(longitude: $longitude, offset: $offset, region: $region, country: $country, dst: $dst, latitude: $latitude, localtime: $localtime, abbreviation: $abbreviation, location: $location, timezone: $timezone)';
  }
  ...
  TResult when<TResult extends Object?>(
    ...
    return $default(longitude, offset, region, country, dst, latitude,
        localtime, abbreviation, location, timezone);
  }
  ...
  TResult? whenOrNull<TResult extends Object?>(
    ...
    return $default?.call(longitude, offset, region, country, dst, latitude,
        localtime, abbreviation, location, timezone);
  }
