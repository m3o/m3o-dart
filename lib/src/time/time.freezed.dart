...
class _$ZoneResponseData implements ZoneResponseData {
  ...
  @override
  String toString() {
    return 'ZoneResponse(offset: $offset, region: $region, timezone: $timezone, abbreviation: $abbreviation, dst: $dst, latitude: $latitude, localtime: $localtime, location: $location, country: $country, longitude: $longitude)';
  }
  ...
  TResult when<TResult extends Object?>(
    ...
    return $default(offset, region, timezone, abbreviation, dst, latitude,
        localtime, location, country, longitude);
  }
  ...
  TResult? whenOrNull<TResult extends Object?>(
    ...
    return $default?.call(offset, region, timezone, abbreviation, dst, latitude,
        localtime, location, country, longitude);
  }
