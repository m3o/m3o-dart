...
class _$ZoneResponseData implements ZoneResponseData {
  ...
  @override
  String toString() {
    return 'ZoneResponse(abbreviation: $abbreviation, dst: $dst, location: $location, offset: $offset, country: $country, latitude: $latitude, localtime: $localtime, longitude: $longitude, region: $region, timezone: $timezone)';
  }
  ...
  TResult when<TResult extends Object?>(
    ...
    return $default(abbreviation, dst, location, offset, country, latitude,
        localtime, longitude, region, timezone);
  }
  ...
  TResult? whenOrNull<TResult extends Object?>(
    ...
    return $default?.call(abbreviation, dst, location, offset, country,
        latitude, localtime, longitude, region, timezone);
  }
