...
class _$ZoneResponseData implements ZoneResponseData {
  ...
  @override
  String toString() {
    return 'ZoneResponse(abbreviation: $abbreviation, country: $country, dst: $dst, region: $region, timezone: $timezone, latitude: $latitude, localtime: $localtime, location: $location, longitude: $longitude, offset: $offset)';
  }
  ...
  TResult when<TResult extends Object?>(
    ...
    return $default(abbreviation, country, dst, region, timezone, latitude,
  ...
  TResult? whenOrNull<TResult extends Object?>(
    ...
    return $default?.call(abbreviation, country, dst, region, timezone,
        latitude, localtime, location, longitude, offset);
  }
