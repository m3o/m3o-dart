...
class _$ZoneResponseData implements ZoneResponseData {
  ...
  @override
  String toString() {
    return 'ZoneResponse(country: $country, latitude: $latitude, localtime: $localtime, region: $region, offset: $offset, timezone: $timezone, abbreviation: $abbreviation, dst: $dst, location: $location, longitude: $longitude)';
  }
  ...
  TResult when<TResult extends Object?>(
    ...
    return $default(country, latitude, localtime, region, offset, timezone,
        abbreviation, dst, location, longitude);
  }
  ...
  TResult? whenOrNull<TResult extends Object?>(
    ...
    return $default?.call(country, latitude, localtime, region, offset,
        timezone, abbreviation, dst, location, longitude);
  }
