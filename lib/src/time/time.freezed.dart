...
class _$ZoneResponseData implements ZoneResponseData {
  ...
  @override
  String toString() {
    return 'ZoneResponse(longitude: $longitude, offset: $offset, region: $region, timezone: $timezone, abbreviation: $abbreviation, dst: $dst, latitude: $latitude, location: $location, country: $country, localtime: $localtime)';
  }
  ...
  TResult when<TResult extends Object?>(
    ...
    return $default(longitude, offset, region, timezone, abbreviation, dst,
        latitude, location, country, localtime);
  }
  ...
  TResult? whenOrNull<TResult extends Object?>(
    ...
    return $default?.call(longitude, offset, region, timezone, abbreviation,
        dst, latitude, location, country, localtime);
  }
