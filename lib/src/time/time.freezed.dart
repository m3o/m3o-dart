...
class _$ZoneResponseData implements ZoneResponseData {
  ...
  @override
  String toString() {
    return 'ZoneResponse(latitude: $latitude, localtime: $localtime, location: $location, region: $region, abbreviation: $abbreviation, dst: $dst, offset: $offset, timezone: $timezone, country: $country, longitude: $longitude)';
  }
  ...
  TResult when<TResult extends Object?>(
    ...
    return $default(latitude, localtime, location, region, abbreviation, dst,
        offset, timezone, country, longitude);
  }
  ...
  TResult? whenOrNull<TResult extends Object?>(
    ...
    return $default?.call(latitude, localtime, location, region, abbreviation,
        dst, offset, timezone, country, longitude);
  }
