...
class _$ZoneResponseData implements ZoneResponseData {
  ...
  @override
  String toString() {
    return 'ZoneResponse(latitude: $latitude, longitude: $longitude, dst: $dst, country: $country, localtime: $localtime, location: $location, offset: $offset, region: $region, timezone: $timezone, abbreviation: $abbreviation)';
  }
  ...
  TResult when<TResult extends Object?>(
    ...
    return $default(latitude, longitude, dst, country, localtime, location,
        offset, region, timezone, abbreviation);
  }
  ...
  TResult? whenOrNull<TResult extends Object?>(
    ...
    return $default?.call(latitude, longitude, dst, country, localtime,
        location, offset, region, timezone, abbreviation);
  }
