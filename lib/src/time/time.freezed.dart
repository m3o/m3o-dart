...
class _$ZoneResponseData implements ZoneResponseData {
  ...
  @override
  String toString() {
    return 'ZoneResponse(longitude: $longitude, timezone: $timezone, abbreviation: $abbreviation, localtime: $localtime, latitude: $latitude, location: $location, offset: $offset, region: $region, country: $country, dst: $dst)';
  }
  ...
  TResult when<TResult extends Object?>(
    ...
    return $default(longitude, timezone, abbreviation, localtime, latitude,
        location, offset, region, country, dst);
  }
  ...
  TResult? whenOrNull<TResult extends Object?>(
    ...
    return $default?.call(longitude, timezone, abbreviation, localtime,
        latitude, location, offset, region, country, dst);
  }
