...
class _$ZoneResponseData implements ZoneResponseData {
  ...
  @override
  String toString() {
    return 'ZoneResponse(abbreviation: $abbreviation, localtime: $localtime, longitude: $longitude, region: $region, timezone: $timezone, country: $country, dst: $dst, latitude: $latitude, location: $location, offset: $offset)';
  }
  ...
  TResult when<TResult extends Object?>(
    ...
    return $default(abbreviation, localtime, longitude, region, timezone,
        country, dst, latitude, location, offset);
  }
  ...
  TResult? whenOrNull<TResult extends Object?>(
    ...
    return $default?.call(abbreviation, localtime, longitude, region, timezone,
        country, dst, latitude, location, offset);
  }
