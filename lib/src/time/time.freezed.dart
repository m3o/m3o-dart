...
class _$ZoneResponseData implements ZoneResponseData {
  ...
  @override
  String toString() {
    return 'ZoneResponse(region: $region, timezone: $timezone, country: $country, latitude: $latitude, localtime: $localtime, longitude: $longitude, offset: $offset, abbreviation: $abbreviation, dst: $dst, location: $location)';
  }
  ...
  TResult when<TResult extends Object?>(
    ...
    return $default(region, timezone, country, latitude, localtime, longitude,
        offset, abbreviation, dst, location);
  }
  ...
  TResult? whenOrNull<TResult extends Object?>(
    ...
    return $default?.call(region, timezone, country, latitude, localtime,
        longitude, offset, abbreviation, dst, location);
  }
