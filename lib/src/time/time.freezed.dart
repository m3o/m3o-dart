...
class _$ZoneResponseData implements ZoneResponseData {
  ...
  @override
  String toString() {
    return 'ZoneResponse(abbreviation: $abbreviation, dst: $dst, latitude: $latitude, localtime: $localtime, offset: $offset, region: $region, country: $country, location: $location, longitude: $longitude, timezone: $timezone)';
  }
  ...
  TResult when<TResult extends Object?>(
    ...
    return $default(abbreviation, dst, latitude, localtime, offset, region,
        country, location, longitude, timezone);
  }
  ...
  TResult? whenOrNull<TResult extends Object?>(
    ...
    return $default?.call(abbreviation, dst, latitude, localtime, offset,
        region, country, location, longitude, timezone);
  }
