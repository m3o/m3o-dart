...
class _$ZoneResponseData implements ZoneResponseData {
  ...
  @override
  String toString() {
    return 'ZoneResponse(dst: $dst, latitude: $latitude, location: $location, longitude: $longitude, timezone: $timezone, abbreviation: $abbreviation, localtime: $localtime, offset: $offset, region: $region, country: $country)';
  }
  ...
  TResult when<TResult extends Object?>(
    ...
    return $default(dst, latitude, location, longitude, timezone, abbreviation,
        localtime, offset, region, country);
  }
  ...
  TResult? whenOrNull<TResult extends Object?>(
    ...
    return $default?.call(dst, latitude, location, longitude, timezone,
        abbreviation, localtime, offset, region, country);
  }
