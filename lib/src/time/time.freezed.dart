...
class _$ZoneResponseData implements ZoneResponseData {
  ...
  @override
  String toString() {
    return 'ZoneResponse(latitude: $latitude, location: $location, longitude: $longitude, offset: $offset, region: $region, abbreviation: $abbreviation, country: $country, dst: $dst, localtime: $localtime, timezone: $timezone)';
  }
  ...
  TResult when<TResult extends Object?>(
    ...
    return $default(latitude, location, longitude, offset, region, abbreviation,
        country, dst, localtime, timezone);
  }
  ...
  TResult? whenOrNull<TResult extends Object?>(
    ...
    return $default?.call(latitude, location, longitude, offset, region,
        abbreviation, country, dst, localtime, timezone);
  }
  ...
  TResult maybeWhen<TResult extends Object?>(
    ...
    if ($default != null) {
      return $default(latitude, location, longitude, offset, region,
          abbreviation, country, dst, localtime, timezone);
    }
    return orElse();
  }
