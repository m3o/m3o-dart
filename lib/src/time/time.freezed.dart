...
class _$ZoneResponseData implements ZoneResponseData {
  ...
  @override
  String toString() {
    return 'ZoneResponse(country: $country, longitude: $longitude, offset: $offset, abbreviation: $abbreviation, dst: $dst, latitude: $latitude, localtime: $localtime, location: $location, region: $region, timezone: $timezone)';
  }
  ...
  TResult when<TResult extends Object?>(
    ...
    return $default(country, longitude, offset, abbreviation, dst, latitude,
        localtime, location, region, timezone);
  }
  ...
  TResult? whenOrNull<TResult extends Object?>(
    ...
    return $default?.call(country, longitude, offset, abbreviation, dst,
        latitude, localtime, location, region, timezone);
  }
