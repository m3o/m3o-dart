...
class _$ZoneResponseData implements ZoneResponseData {
  ...
  @override
  String toString() {
    return 'ZoneResponse(longitude: $longitude, offset: $offset, region: $region, country: $country, dst: $dst, latitude: $latitude, localtime: $localtime, location: $location, timezone: $timezone, abbreviation: $abbreviation)';
  }
  ...
  TResult when<TResult extends Object?>(
    ...
    return $default(longitude, offset, region, country, dst, latitude,
        localtime, location, timezone, abbreviation);
  }
