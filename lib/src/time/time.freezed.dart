...
class _$ZoneResponseData implements ZoneResponseData {
  ...
  @override
  String toString() {
    return 'ZoneResponse(location: $location, offset: $offset, region: $region, timezone: $timezone, country: $country, dst: $dst, localtime: $localtime, longitude: $longitude, abbreviation: $abbreviation, latitude: $latitude)';
  }
  ...
  TResult when<TResult extends Object?>(
    ...
    return $default(location, offset, region, timezone, country, dst, localtime,
        longitude, abbreviation, latitude);
  }
  ...
  TResult? whenOrNull<TResult extends Object?>(
    ...
    return $default?.call(location, offset, region, timezone, country, dst,
        localtime, longitude, abbreviation, latitude);
  }
  ...
  TResult maybeWhen<TResult extends Object?>(
    ...
    if ($default != null) {
      return $default(location, offset, region, timezone, country, dst,
          localtime, longitude, abbreviation, latitude);
    }
    return orElse();
  }
