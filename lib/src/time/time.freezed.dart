...
class _$ZoneResponseData implements ZoneResponseData {
  ...
  @override
  String toString() {
    return 'ZoneResponse(latitude: $latitude, localtime: $localtime, location: $location, longitude: $longitude, region: $region, country: $country, dst: $dst, timezone: $timezone, abbreviation: $abbreviation, offset: $offset)';
  }
  ...
  TResult when<TResult extends Object?>(
    ...
    return $default(latitude, localtime, location, longitude, region, country,
        dst, timezone, abbreviation, offset);
  }
  ...
  TResult? whenOrNull<TResult extends Object?>(
    ...
    return $default?.call(latitude, localtime, location, longitude, region,
        country, dst, timezone, abbreviation, offset);
  }
