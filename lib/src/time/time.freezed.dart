...
class _$ZoneResponseData implements ZoneResponseData {
  ...
  @override
  String toString() {
    return 'ZoneResponse(offset: $offset, region: $region, abbreviation: $abbreviation, country: $country, latitude: $latitude, localtime: $localtime, location: $location, longitude: $longitude, dst: $dst, timezone: $timezone)';
  }
  ...
  TResult when<TResult extends Object?>(
    ...
    return $default(offset, region, abbreviation, country, latitude, localtime,
        location, longitude, dst, timezone);
  }
  ...
  TResult? whenOrNull<TResult extends Object?>(
    ...
    return $default?.call(offset, region, abbreviation, country, latitude,
        localtime, location, longitude, dst, timezone);
  }
  ...
  TResult maybeWhen<TResult extends Object?>(
    ...
    if ($default != null) {
      return $default(offset, region, abbreviation, country, latitude,
          localtime, location, longitude, dst, timezone);
    }
    return orElse();
  }
