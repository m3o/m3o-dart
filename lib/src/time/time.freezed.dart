...
class _$ZoneResponseData implements ZoneResponseData {
  ...
  @override
  String toString() {
    return 'ZoneResponse(offset: $offset, region: $region, dst: $dst, longitude: $longitude, latitude: $latitude, localtime: $localtime, location: $location, timezone: $timezone, abbreviation: $abbreviation, country: $country)';
  }
  ...
  TResult when<TResult extends Object?>(
    ...
    return $default(offset, region, dst, longitude, latitude, localtime,
        location, timezone, abbreviation, country);
  }
  ...
  TResult? whenOrNull<TResult extends Object?>(
    ...
    return $default?.call(offset, region, dst, longitude, latitude, localtime,
        location, timezone, abbreviation, country);
  }
