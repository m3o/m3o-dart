...
class _$ZoneResponseData implements ZoneResponseData {
  ...
  @override
  String toString() {
    return 'ZoneResponse(country: $country, latitude: $latitude, localtime: $localtime, offset: $offset, timezone: $timezone, abbreviation: $abbreviation, dst: $dst, location: $location, longitude: $longitude, region: $region)';
  }
  ...
  TResult when<TResult extends Object?>(
    ...
    return $default(country, latitude, localtime, offset, timezone,
        abbreviation, dst, location, longitude, region);
  }
  ...
  TResult? whenOrNull<TResult extends Object?>(
    ...
    return $default?.call(country, latitude, localtime, offset, timezone,
        abbreviation, dst, location, longitude, region);
  }
