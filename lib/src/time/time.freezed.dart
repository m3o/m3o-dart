...
class _$ZoneResponseData implements ZoneResponseData {
  ...
  @override
  String toString() {
    return 'ZoneResponse(localtime: $localtime, longitude: $longitude, offset: $offset, region: $region, timezone: $timezone, abbreviation: $abbreviation, dst: $dst, latitude: $latitude, country: $country, location: $location)';
  }
  ...
  TResult when<TResult extends Object?>(
    ...
    return $default(localtime, longitude, offset, region, timezone,
        abbreviation, dst, latitude, country, location);
  }
  ...
  TResult? whenOrNull<TResult extends Object?>(
    ...
    return $default?.call(localtime, longitude, offset, region, timezone,
        abbreviation, dst, latitude, country, location);
  }
