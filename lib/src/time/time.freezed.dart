...
class _$ZoneResponseData implements ZoneResponseData {
  ...
  @override
  String toString() {
    return 'ZoneResponse(country: $country, localtime: $localtime, location: $location, longitude: $longitude, region: $region, timezone: $timezone, abbreviation: $abbreviation, dst: $dst, latitude: $latitude, offset: $offset)';
  }
  ...
  TResult when<TResult extends Object?>(
    ...
    return $default(country, localtime, location, longitude, region, timezone,
        abbreviation, dst, latitude, offset);
  }
  ...
  TResult? whenOrNull<TResult extends Object?>(
    ...
    return $default?.call(country, localtime, location, longitude, region,
        timezone, abbreviation, dst, latitude, offset);
  }
