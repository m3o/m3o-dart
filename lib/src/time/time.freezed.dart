...
class _$ZoneResponseData implements ZoneResponseData {
  ...
  @override
  String toString() {
    return 'ZoneResponse(latitude: $latitude, location: $location, offset: $offset, timezone: $timezone, abbreviation: $abbreviation, dst: $dst, localtime: $localtime, longitude: $longitude, region: $region, country: $country)';
  }
  ...
  TResult when<TResult extends Object?>(
    ...
    return $default(latitude, location, offset, timezone, abbreviation, dst,
        localtime, longitude, region, country);
  }
  ...
  TResult? whenOrNull<TResult extends Object?>(
    ...
    return $default?.call(latitude, location, offset, timezone, abbreviation,
        dst, localtime, longitude, region, country);
  }
