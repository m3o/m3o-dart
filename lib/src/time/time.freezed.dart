...
class _$ZoneResponseData implements ZoneResponseData {
  ...
  @override
  String toString() {
    return 'ZoneResponse(region: $region, abbreviation: $abbreviation, country: $country, latitude: $latitude, localtime: $localtime, location: $location, offset: $offset, dst: $dst, longitude: $longitude, timezone: $timezone)';
  }
  ...
  TResult when<TResult extends Object?>(
    ...
    return $default(region, abbreviation, country, latitude, localtime,
        location, offset, dst, longitude, timezone);
  }
  ...
  TResult? whenOrNull<TResult extends Object?>(
    ...
    return $default?.call(region, abbreviation, country, latitude, localtime,
        location, offset, dst, longitude, timezone);
  }
