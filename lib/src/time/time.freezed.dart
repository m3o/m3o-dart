...
class _$ZoneResponseData implements ZoneResponseData {
  ...
  @override
  String toString() {
    return 'ZoneResponse(localtime: $localtime, longitude: $longitude, offset: $offset, region: $region, timezone: $timezone, abbreviation: $abbreviation, country: $country, dst: $dst, latitude: $latitude, location: $location)';
  }
  ...
  TResult when<TResult extends Object?>(
    ...
    return $default(localtime, longitude, offset, region, timezone,
        abbreviation, country, dst, latitude, location);
  }
