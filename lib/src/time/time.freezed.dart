...
class _$ZoneResponseData implements ZoneResponseData {
  ...
  @override
  String toString() {
    return 'ZoneResponse(dst: $dst, localtime: $localtime, offset: $offset, timezone: $timezone, abbreviation: $abbreviation, country: $country, longitude: $longitude, region: $region, latitude: $latitude, location: $location)';
  }
  ...
  TResult when<TResult extends Object?>(
    ...
    return $default(dst, localtime, offset, timezone, abbreviation, country,
        longitude, region, latitude, location);
  }
  ...
  TResult? whenOrNull<TResult extends Object?>(
    ...
    return $default?.call(dst, localtime, offset, timezone, abbreviation,
        country, longitude, region, latitude, location);
  }
