...
class _$ZoneResponseData implements ZoneResponseData {
  ...
  @override
  String toString() {
    return 'ZoneResponse(latitude: $latitude, offset: $offset, country: $country, dst: $dst, location: $location, longitude: $longitude, region: $region, timezone: $timezone, abbreviation: $abbreviation, localtime: $localtime)';
  }
  ...
  TResult when<TResult extends Object?>(
    ...
    return $default(latitude, offset, country, dst, location, longitude, region,
        timezone, abbreviation, localtime);
  }
  ...
  TResult? whenOrNull<TResult extends Object?>(
    ...
    return $default?.call(latitude, offset, country, dst, location, longitude,
        region, timezone, abbreviation, localtime);
  }
  ...
  TResult maybeWhen<TResult extends Object?>(
    ...
    if ($default != null) {
      return $default(latitude, offset, country, dst, location, longitude,
          region, timezone, abbreviation, localtime);
    }
    return orElse();
  }
