...
class _$ZoneResponseData implements ZoneResponseData {
  ...
  @override
  String toString() {
    return 'ZoneResponse(country: $country, dst: $dst, localtime: $localtime, longitude: $longitude, offset: $offset, abbreviation: $abbreviation, latitude: $latitude, location: $location, region: $region, timezone: $timezone)';
  }
  ...
  TResult when<TResult extends Object?>(
    ...
    return $default(country, dst, localtime, longitude, offset, abbreviation,
        latitude, location, region, timezone);
  }
  ...
  TResult? whenOrNull<TResult extends Object?>(
    ...
    return $default?.call(country, dst, localtime, longitude, offset,
        abbreviation, latitude, location, region, timezone);
  }
