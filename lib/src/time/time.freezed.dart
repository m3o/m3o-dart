...
class _$ZoneResponseData implements ZoneResponseData {
  ...
  @override
  String toString() {
    return 'ZoneResponse(dst: $dst, timezone: $timezone, abbreviation: $abbreviation, latitude: $latitude, localtime: $localtime, location: $location, longitude: $longitude, offset: $offset, region: $region, country: $country)';
  }
  ...
  TResult when<TResult extends Object?>(
    ...
    return $default(dst, timezone, abbreviation, latitude, localtime, location,
  ...
  TResult? whenOrNull<TResult extends Object?>(
    ...
    return $default?.call(dst, timezone, abbreviation, latitude, localtime,
        location, longitude, offset, region, country);
  }
  ...
  TResult maybeWhen<TResult extends Object?>(
    ...
    if ($default != null) {
      return $default(dst, timezone, abbreviation, latitude, localtime,
          location, longitude, offset, region, country);
    }
    return orElse();
  }
