...
class _$ZoneResponseData implements ZoneResponseData {
  ...
  @override
  String toString() {
    return 'ZoneResponse(localtime: $localtime, region: $region, timezone: $timezone, abbreviation: $abbreviation, country: $country, latitude: $latitude, offset: $offset, dst: $dst, location: $location, longitude: $longitude)';
  }
  ...
  TResult when<TResult extends Object?>(
    ...
    return $default(localtime, region, timezone, abbreviation, country,
        latitude, offset, dst, location, longitude);
  }
  ...
  TResult? whenOrNull<TResult extends Object?>(
    ...
    return $default?.call(localtime, region, timezone, abbreviation, country,
        latitude, offset, dst, location, longitude);
  }
