...
class _$ZoneResponseData implements ZoneResponseData {
  ...
  @override
  String toString() {
    return 'ZoneResponse(timezone: $timezone, abbreviation: $abbreviation, country: $country, dst: $dst, localtime: $localtime, longitude: $longitude, latitude: $latitude, location: $location, offset: $offset, region: $region)';
  }
  ...
  TResult when<TResult extends Object?>(
    ...
    return $default(timezone, abbreviation, country, dst, localtime, longitude,
  ...
  TResult? whenOrNull<TResult extends Object?>(
    ...
    return $default?.call(timezone, abbreviation, country, dst, localtime,
        longitude, latitude, location, offset, region);
  }
  ...
  TResult maybeWhen<TResult extends Object?>(
    ...
    if ($default != null) {
      return $default(timezone, abbreviation, country, dst, localtime,
          longitude, latitude, location, offset, region);
    }
    return orElse();
  }
