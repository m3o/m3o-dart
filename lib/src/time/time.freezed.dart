...
class _$ZoneResponseData implements ZoneResponseData {
  ...
  @override
  String toString() {
    return 'ZoneResponse(longitude: $longitude, timezone: $timezone, country: $country, latitude: $latitude, localtime: $localtime, offset: $offset, region: $region, abbreviation: $abbreviation, dst: $dst, location: $location)';
  }
  ...
  TResult when<TResult extends Object?>(
    ...
    return $default(longitude, timezone, country, latitude, localtime, offset,
        region, abbreviation, dst, location);
  }
  ...
  TResult? whenOrNull<TResult extends Object?>(
    ...
    return $default?.call(longitude, timezone, country, latitude, localtime,
        offset, region, abbreviation, dst, location);
  }
