...
class _$ZoneResponseData implements ZoneResponseData {
  ...
  @override
  String toString() {
    return 'ZoneResponse(localtime: $localtime, location: $location, offset: $offset, longitude: $longitude, region: $region, timezone: $timezone, abbreviation: $abbreviation, country: $country, dst: $dst, latitude: $latitude)';
  }
  ...
  TResult when<TResult extends Object?>(
    ...
    return $default(localtime, location, offset, longitude, region, timezone,
  ...
  TResult? whenOrNull<TResult extends Object?>(
    ...
    return $default?.call(localtime, location, offset, longitude, region,
