...
class _$ZoneResponseData implements ZoneResponseData {
  ...
  @override
  String toString() {
    return 'ZoneResponse(localtime: $localtime, longitude: $longitude, timezone: $timezone, abbreviation: $abbreviation, dst: $dst, location: $location, offset: $offset, region: $region, country: $country, latitude: $latitude)';
  }
  ...
  TResult when<TResult extends Object?>(
    ...
    return $default(localtime, longitude, timezone, abbreviation, dst, location,
        offset, region, country, latitude);
  }
  ...
  TResult? whenOrNull<TResult extends Object?>(
    ...
    return $default?.call(localtime, longitude, timezone, abbreviation, dst,
        location, offset, region, country, latitude);
  }
  ...
  TResult maybeWhen<TResult extends Object?>(
    ...
    if ($default != null) {
      return $default(localtime, longitude, timezone, abbreviation, dst,
          location, offset, region, country, latitude);
    }
    return orElse();
  }
