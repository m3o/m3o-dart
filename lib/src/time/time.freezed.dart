...
class _$ZoneResponseData implements ZoneResponseData {
  ...
  @override
  String toString() {
    return 'ZoneResponse(region: $region, country: $country, dst: $dst, location: $location, longitude: $longitude, offset: $offset, timezone: $timezone, abbreviation: $abbreviation, latitude: $latitude, localtime: $localtime)';
  }
  ...
  TResult when<TResult extends Object?>(
    ...
    return $default(region, country, dst, location, longitude, offset, timezone,
        abbreviation, latitude, localtime);
  }
  ...
  TResult? whenOrNull<TResult extends Object?>(
    ...
    return $default?.call(region, country, dst, location, longitude, offset,
        timezone, abbreviation, latitude, localtime);
  }
  ...
  TResult maybeWhen<TResult extends Object?>(
    ...
    if ($default != null) {
      return $default(region, country, dst, location, longitude, offset,
          timezone, abbreviation, latitude, localtime);
    }
    return orElse();
  }
