...
class _$ZoneResponseData implements ZoneResponseData {
  ...
  @override
  String toString() {
    return 'ZoneResponse(country: $country, localtime: $localtime, timezone: $timezone, region: $region, abbreviation: $abbreviation, dst: $dst, latitude: $latitude, location: $location, longitude: $longitude, offset: $offset)';
  }
  ...
  TResult when<TResult extends Object?>(
    ...
    return $default(country, localtime, timezone, region, abbreviation, dst,
  ...
  TResult? whenOrNull<TResult extends Object?>(
    ...
    return $default?.call(country, localtime, timezone, region, abbreviation,
        dst, latitude, location, longitude, offset);
  }
