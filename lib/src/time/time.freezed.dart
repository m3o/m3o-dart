...
class _$ZoneResponseData implements ZoneResponseData {
  ...
  @override
  String toString() {
    return 'ZoneResponse(location: $location, abbreviation: $abbreviation, latitude: $latitude, localtime: $localtime, longitude: $longitude, offset: $offset, region: $region, timezone: $timezone, country: $country, dst: $dst)';
  }
  ...
  TResult when<TResult extends Object?>(
    ...
    return $default(location, abbreviation, latitude, localtime, longitude,
        offset, region, timezone, country, dst);
  }
  ...
  TResult? whenOrNull<TResult extends Object?>(
    ...
    return $default?.call(location, abbreviation, latitude, localtime,
        longitude, offset, region, timezone, country, dst);
  }
...
abstract class ZoneResponseData implements ZoneResponse {
  const factory ZoneResponseData(
      ...
      final String? timezone,
      final String? country,
      final bool? dst}) = _$ZoneResponseData;
