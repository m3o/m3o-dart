...
class _$ZoneResponseData implements ZoneResponseData {
  ...
  @override
  String toString() {
    return 'ZoneResponse(country: $country, longitude: $longitude, offset: $offset, region: $region, abbreviation: $abbreviation, dst: $dst, latitude: $latitude, localtime: $localtime, location: $location, timezone: $timezone)';
  }
  ...
  TResult when<TResult extends Object?>(
    ...
    return $default(country, longitude, offset, region, abbreviation, dst,
        latitude, localtime, location, timezone);
  }
  ...
  TResult? whenOrNull<TResult extends Object?>(
    ...
    return $default?.call(country, longitude, offset, region, abbreviation, dst,
        latitude, localtime, location, timezone);
  }
