...
class _$ZoneResponseData implements ZoneResponseData {
  ...
  @override
  String toString() {
    return 'ZoneResponse(abbreviation: $abbreviation, latitude: $latitude, longitude: $longitude, region: $region, timezone: $timezone, country: $country, dst: $dst, localtime: $localtime, location: $location, offset: $offset)';
  }
  ...
  TResult when<TResult extends Object?>(
    ...
    return $default(abbreviation, latitude, longitude, region, timezone,
        country, dst, localtime, location, offset);
  }
  ...
  TResult? whenOrNull<TResult extends Object?>(
    ...
    return $default?.call(abbreviation, latitude, longitude, region, timezone,
        country, dst, localtime, location, offset);
  }
