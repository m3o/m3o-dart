...
class _$ZoneResponseData implements ZoneResponseData {
  ...
  @override
  String toString() {
    return 'ZoneResponse(timezone: $timezone, abbreviation: $abbreviation, dst: $dst, location: $location, longitude: $longitude, offset: $offset, country: $country, latitude: $latitude, localtime: $localtime, region: $region)';
  }
  ...
  TResult when<TResult extends Object?>(
    ...
    return $default(timezone, abbreviation, dst, location, longitude, offset,
  ...
  TResult? whenOrNull<TResult extends Object?>(
    ...
    return $default?.call(timezone, abbreviation, dst, location, longitude,
        offset, country, latitude, localtime, region);
  }
