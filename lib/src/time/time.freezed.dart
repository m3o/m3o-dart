...
class _$ZoneResponseData implements ZoneResponseData {
  ...
  @override
  String toString() {
    return 'ZoneResponse(country: $country, location: $location, longitude: $longitude, timezone: $timezone, offset: $offset, region: $region, abbreviation: $abbreviation, dst: $dst, latitude: $latitude, localtime: $localtime)';
  }
  ...
  TResult when<TResult extends Object?>(
    ...
    return $default(country, location, longitude, timezone, offset, region,
  ...
  TResult? whenOrNull<TResult extends Object?>(
    ...
    return $default?.call(country, location, longitude, timezone, offset,
        region, abbreviation, dst, latitude, localtime);
  }
