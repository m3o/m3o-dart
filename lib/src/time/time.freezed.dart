...
class _$ZoneResponseData implements ZoneResponseData {
  ...
  @override
  String toString() {
    return 'ZoneResponse(longitude: $longitude, offset: $offset, region: $region, dst: $dst, location: $location, latitude: $latitude, localtime: $localtime, timezone: $timezone, abbreviation: $abbreviation, country: $country)';
  }
  ...
  TResult when<TResult extends Object?>(
    ...
    return $default(longitude, offset, region, dst, location, latitude,
        localtime, timezone, abbreviation, country);
  }
  ...
  TResult? whenOrNull<TResult extends Object?>(
    ...
    return $default?.call(longitude, offset, region, dst, location, latitude,
        localtime, timezone, abbreviation, country);
  }
