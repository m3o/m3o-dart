...
class _$ZoneResponseData implements ZoneResponseData {
  ...
  @override
  String toString() {
    return 'ZoneResponse(location: $location, offset: $offset, abbreviation: $abbreviation, country: $country, latitude: $latitude, region: $region, timezone: $timezone, dst: $dst, localtime: $localtime, longitude: $longitude)';
  }
  ...
  TResult when<TResult extends Object?>(
    ...
    return $default(location, offset, abbreviation, country, latitude, region,
        timezone, dst, localtime, longitude);
  }
  ...
  TResult? whenOrNull<TResult extends Object?>(
    ...
    return $default?.call(location, offset, abbreviation, country, latitude,
        region, timezone, dst, localtime, longitude);
  }
