...
class _$ZoneResponseData implements ZoneResponseData {
  ...
  @override
  String toString() {
    return 'ZoneResponse(abbreviation: $abbreviation, country: $country, dst: $dst, longitude: $longitude, offset: $offset, region: $region, timezone: $timezone, latitude: $latitude, localtime: $localtime, location: $location)';
  }
  ...
  TResult when<TResult extends Object?>(
    ...
    return $default(abbreviation, country, dst, longitude, offset, region,
        timezone, latitude, localtime, location);
  }
  ...
  TResult? whenOrNull<TResult extends Object?>(
    ...
    return $default?.call(abbreviation, country, dst, longitude, offset, region,
        timezone, latitude, localtime, location);
  }
