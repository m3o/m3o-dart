...
class _$ZoneResponseData implements ZoneResponseData {
  ...
  @override
  String toString() {
    return 'ZoneResponse(abbreviation: $abbreviation, country: $country, region: $region, timezone: $timezone, longitude: $longitude, offset: $offset, dst: $dst, latitude: $latitude, localtime: $localtime, location: $location)';
  }
  ...
  TResult when<TResult extends Object?>(
    ...
    return $default(abbreviation, country, region, timezone, longitude, offset,
  ...
  TResult? whenOrNull<TResult extends Object?>(
    ...
    return $default?.call(abbreviation, country, region, timezone, longitude,
        offset, dst, latitude, localtime, location);
  }
  ...
  TResult maybeWhen<TResult extends Object?>(
    ...
    if ($default != null) {
      return $default(abbreviation, country, region, timezone, longitude,
          offset, dst, latitude, localtime, location);
    }
    return orElse();
  }
