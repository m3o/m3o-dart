...
class _$ZoneResponseData implements ZoneResponseData {
  ...
  @override
  String toString() {
    return 'ZoneResponse(localtime: $localtime, offset: $offset, latitude: $latitude, location: $location, longitude: $longitude, region: $region, timezone: $timezone, abbreviation: $abbreviation, country: $country, dst: $dst)';
  }
  ...
  TResult when<TResult extends Object?>(
    ...
    return $default(localtime, offset, latitude, location, longitude, region,
  ...
  TResult? whenOrNull<TResult extends Object?>(
    ...
    return $default?.call(localtime, offset, latitude, location, longitude,
