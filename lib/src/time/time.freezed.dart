...
class _$ZoneResponseData implements ZoneResponseData {
  ...
  @override
  String toString() {
    return 'ZoneResponse(timezone: $timezone, localtime: $localtime, location: $location, offset: $offset, latitude: $latitude, longitude: $longitude, region: $region, abbreviation: $abbreviation, country: $country, dst: $dst)';
  }
  ...
  TResult when<TResult extends Object?>(
    ...
    return $default(timezone, localtime, location, offset, latitude, longitude,
  ...
  TResult? whenOrNull<TResult extends Object?>(
    ...
    return $default?.call(timezone, localtime, location, offset, latitude,
        longitude, region, abbreviation, country, dst);
  }
  ...
  TResult maybeWhen<TResult extends Object?>(
    ...
    if ($default != null) {
      return $default(timezone, localtime, location, offset, latitude,
          longitude, region, abbreviation, country, dst);
    }
    return orElse();
  }
