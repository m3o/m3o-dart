...
class _$ZoneResponseData implements ZoneResponseData {
  ...
  @override
  String toString() {
    return 'ZoneResponse(dst: $dst, latitude: $latitude, longitude: $longitude, region: $region, timezone: $timezone, abbreviation: $abbreviation, country: $country, localtime: $localtime, location: $location, offset: $offset)';
  }
  ...
  TResult when<TResult extends Object?>(
    ...
    return $default(dst, latitude, longitude, region, timezone, abbreviation,
        country, localtime, location, offset);
  }
  ...
  TResult? whenOrNull<TResult extends Object?>(
    ...
    return $default?.call(dst, latitude, longitude, region, timezone,
        abbreviation, country, localtime, location, offset);
  }
