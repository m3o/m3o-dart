...
class _$ZoneResponseData implements ZoneResponseData {
  ...
  @override
  String toString() {
    return 'ZoneResponse(latitude: $latitude, localtime: $localtime, location: $location, offset: $offset, abbreviation: $abbreviation, country: $country, dst: $dst, longitude: $longitude, region: $region, timezone: $timezone)';
  }
  ...
  TResult when<TResult extends Object?>(
    ...
    return $default(latitude, localtime, location, offset, abbreviation,
        country, dst, longitude, region, timezone);
  }
  ...
  TResult? whenOrNull<TResult extends Object?>(
    ...
    return $default?.call(latitude, localtime, location, offset, abbreviation,
        country, dst, longitude, region, timezone);
  }
