...
class _$ZoneResponseData implements ZoneResponseData {
  ...
  @override
  String toString() {
    return 'ZoneResponse(dst: $dst, localtime: $localtime, location: $location, longitude: $longitude, offset: $offset, abbreviation: $abbreviation, country: $country, latitude: $latitude, region: $region, timezone: $timezone)';
  }
  ...
  TResult when<TResult extends Object?>(
    ...
    return $default(dst, localtime, location, longitude, offset, abbreviation,
        country, latitude, region, timezone);
  }
  ...
  TResult? whenOrNull<TResult extends Object?>(
    ...
    return $default?.call(dst, localtime, location, longitude, offset,
        abbreviation, country, latitude, region, timezone);
  }
