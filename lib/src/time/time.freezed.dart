...
class _$ZoneResponseData implements ZoneResponseData {
  ...
  @override
  String toString() {
    return 'ZoneResponse(longitude: $longitude, offset: $offset, timezone: $timezone, country: $country, dst: $dst, localtime: $localtime, location: $location, region: $region, abbreviation: $abbreviation, latitude: $latitude)';
  }
  ...
  TResult when<TResult extends Object?>(
    ...
    return $default(longitude, offset, timezone, country, dst, localtime,
        location, region, abbreviation, latitude);
  }
  ...
  TResult? whenOrNull<TResult extends Object?>(
    ...
    return $default?.call(longitude, offset, timezone, country, dst, localtime,
        location, region, abbreviation, latitude);
  }
