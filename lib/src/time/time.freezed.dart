...
class _$ZoneResponseData implements ZoneResponseData {
  ...
  @override
  String toString() {
    return 'ZoneResponse(longitude: $longitude, offset: $offset, country: $country, dst: $dst, latitude: $latitude, localtime: $localtime, location: $location, abbreviation: $abbreviation, region: $region, timezone: $timezone)';
  }
  ...
  TResult when<TResult extends Object?>(
    ...
    return $default(longitude, offset, country, dst, latitude, localtime,
        location, abbreviation, region, timezone);
  }
  ...
  TResult? whenOrNull<TResult extends Object?>(
    ...
    return $default?.call(longitude, offset, country, dst, latitude, localtime,
        location, abbreviation, region, timezone);
  }
