...
class _$ZoneResponseData implements ZoneResponseData {
  ...
  @override
  String toString() {
    return 'ZoneResponse(region: $region, dst: $dst, latitude: $latitude, localtime: $localtime, longitude: $longitude, offset: $offset, timezone: $timezone, abbreviation: $abbreviation, country: $country, location: $location)';
  }
  ...
  TResult when<TResult extends Object?>(
    ...
    return $default(region, dst, latitude, localtime, longitude, offset,
        timezone, abbreviation, country, location);
  }
  ...
  TResult? whenOrNull<TResult extends Object?>(
    ...
    return $default?.call(region, dst, latitude, localtime, longitude, offset,
        timezone, abbreviation, country, location);
  }
