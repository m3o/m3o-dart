...
class _$ZoneResponseData implements ZoneResponseData {
  ...
  @override
  String toString() {
    return 'ZoneResponse(region: $region, timezone: $timezone, country: $country, dst: $dst, localtime: $localtime, location: $location, offset: $offset, abbreviation: $abbreviation, latitude: $latitude, longitude: $longitude)';
  }
  ...
  TResult when<TResult extends Object?>(
    ...
    return $default(region, timezone, country, dst, localtime, location, offset,
  ...
  TResult? whenOrNull<TResult extends Object?>(
    ...
    return $default?.call(region, timezone, country, dst, localtime, location,
        offset, abbreviation, latitude, longitude);
  }
  ...
  TResult maybeWhen<TResult extends Object?>(
    ...
    if ($default != null) {
      return $default(region, timezone, country, dst, localtime, location,
          offset, abbreviation, latitude, longitude);
    }
    return orElse();
  }
