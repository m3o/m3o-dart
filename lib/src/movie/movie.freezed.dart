...
class _$_MovieInfo implements _MovieInfo {
  ...
  @override
  String toString() {
    return 'MovieInfo(adult: $adult, genre_ids: $genre_ids, overview: $overview, vote_average: $vote_average, backdrop_path: $backdrop_path, original_title: $original_title, poster_path: $poster_path, release_date: $release_date, video: $video, vote_count: $vote_count, id: $id, popularity: $popularity, title: $title, original_language: $original_language)';
  }
