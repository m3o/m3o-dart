...
class _$_MovieInfo implements _MovieInfo {
  ...
  @override
  String toString() {
    return 'MovieInfo(title: $title, overview: $overview, popularity: $popularity, adult: $adult, backdrop_path: $backdrop_path, original_language: $original_language, original_title: $original_title, vote_average: $vote_average, vote_count: $vote_count, genre_ids: $genre_ids, id: $id, poster_path: $poster_path, release_date: $release_date, video: $video)';
  }
