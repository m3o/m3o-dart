...
class _$_MovieInfo implements _MovieInfo {
  ...
  @override
  String toString() {
    return 'MovieInfo(id: $id, original_title: $original_title, overview: $overview, original_language: $original_language, title: $title, vote_count: $vote_count, adult: $adult, genre_ids: $genre_ids, vote_average: $vote_average, backdrop_path: $backdrop_path, popularity: $popularity, poster_path: $poster_path, release_date: $release_date, video: $video)';
  }
