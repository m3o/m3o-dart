...
class _$_MovieInfo implements _MovieInfo {
  ...
  @override
  String toString() {
    return 'MovieInfo(popularity: $popularity, vote_average: $vote_average, genre_ids: $genre_ids, backdrop_path: $backdrop_path, id: $id, original_language: $original_language, release_date: $release_date, video: $video, vote_count: $vote_count, adult: $adult, overview: $overview, poster_path: $poster_path, title: $title, original_title: $original_title)';
  }
