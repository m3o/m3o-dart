...
class _$_MovieInfo implements _MovieInfo {
  ...
  @override
  String toString() {
    return 'MovieInfo(overview: $overview, id: $id, original_title: $original_title, vote_count: $vote_count, title: $title, vote_average: $vote_average, video: $video, original_language: $original_language, release_date: $release_date, genre_ids: $genre_ids, popularity: $popularity, poster_path: $poster_path, adult: $adult, backdrop_path: $backdrop_path)';
  }
...
abstract class _MovieInfo implements MovieInfo {
  const factory _MovieInfo(
      ...
      final String? poster_path,
      final bool? adult,
      final String? backdrop_path}) = _$_MovieInfo;
