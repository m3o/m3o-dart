...
class _$_MovieInfo implements _MovieInfo {
  ...
  @override
  String toString() {
    return 'MovieInfo(backdrop_path: $backdrop_path, genre_ids: $genre_ids, id: $id, video: $video, popularity: $popularity, original_language: $original_language, overview: $overview, release_date: $release_date, vote_count: $vote_count, vote_average: $vote_average, adult: $adult, original_title: $original_title, poster_path: $poster_path, title: $title)';
  }
