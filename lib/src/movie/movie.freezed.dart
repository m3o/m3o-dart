...
class _$_MovieInfo implements _MovieInfo {
  ...
  @override
  String toString() {
    return 'MovieInfo(release_date: $release_date, vote_average: $vote_average, backdrop_path: $backdrop_path, genre_ids: $genre_ids, poster_path: $poster_path, video: $video, original_title: $original_title, title: $title, vote_count: $vote_count, adult: $adult, id: $id, original_language: $original_language, overview: $overview, popularity: $popularity)';
  }
