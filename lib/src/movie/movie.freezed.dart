...
class _$_MovieInfo implements _MovieInfo {
  ...
  @override
  String toString() {
    return 'MovieInfo(overview: $overview, poster_path: $poster_path, title: $title, vote_average: $vote_average, adult: $adult, popularity: $popularity, genre_ids: $genre_ids, original_language: $original_language, video: $video, backdrop_path: $backdrop_path, id: $id, original_title: $original_title, release_date: $release_date, vote_count: $vote_count)';
  }
