...
class _$_MovieInfo implements _MovieInfo {
  ...
  @override
  String toString() {
    return 'MovieInfo(vote_count: $vote_count, popularity: $popularity, poster_path: $poster_path, vote_average: $vote_average, adult: $adult, overview: $overview, title: $title, video: $video, genre_ids: $genre_ids, id: $id, original_language: $original_language, original_title: $original_title, release_date: $release_date, backdrop_path: $backdrop_path)';
  }
