...
class _$_MovieInfo implements _MovieInfo {
  ...
  @override
  String toString() {
    return 'MovieInfo(id: $id, original_title: $original_title, vote_average: $vote_average, popularity: $popularity, poster_path: $poster_path, title: $title, vote_count: $vote_count, original_language: $original_language, release_date: $release_date, video: $video, overview: $overview, adult: $adult, backdrop_path: $backdrop_path, genre_ids: $genre_ids)';
  }
