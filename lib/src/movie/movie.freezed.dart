...
class _$_MovieInfo implements _MovieInfo {
  ...
  @override
  String toString() {
    return 'MovieInfo(release_date: $release_date, overview: $overview, popularity: $popularity, poster_path: $poster_path, vote_average: $vote_average, vote_count: $vote_count, adult: $adult, backdrop_path: $backdrop_path, original_title: $original_title, genre_ids: $genre_ids, id: $id, video: $video, original_language: $original_language, title: $title)';
  }
