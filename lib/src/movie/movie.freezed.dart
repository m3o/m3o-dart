...
class _$_MovieInfo implements _MovieInfo {
  ...
  @override
  String toString() {
    return 'MovieInfo(original_language: $original_language, title: $title, vote_average: $vote_average, release_date: $release_date, video: $video, adult: $adult, popularity: $popularity, overview: $overview, poster_path: $poster_path, vote_count: $vote_count, backdrop_path: $backdrop_path, genre_ids: $genre_ids, id: $id, original_title: $original_title)';
  }
