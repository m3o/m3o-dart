...
class _$_MovieInfo implements _MovieInfo {
  ...
  @override
  String toString() {
    return 'MovieInfo(vote_average: $vote_average, adult: $adult, video: $video, overview: $overview, vote_count: $vote_count, backdrop_path: $backdrop_path, original_language: $original_language, popularity: $popularity, poster_path: $poster_path, release_date: $release_date, genre_ids: $genre_ids, original_title: $original_title, id: $id, title: $title)';
  }
