...
class _$_MovieInfo implements _MovieInfo {
  ...
  @override
  String toString() {
    return 'MovieInfo(vote_average: $vote_average, adult: $adult, backdrop_path: $backdrop_path, original_language: $original_language, video: $video, overview: $overview, popularity: $popularity, genre_ids: $genre_ids, original_title: $original_title, release_date: $release_date, title: $title, id: $id, poster_path: $poster_path, vote_count: $vote_count)';
  }
