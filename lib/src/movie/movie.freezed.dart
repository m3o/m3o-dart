...
class _$_MovieInfo implements _MovieInfo {
  ...
  @override
  String toString() {
    return 'MovieInfo(adult: $adult, backdrop_path: $backdrop_path, id: $id, vote_average: $vote_average, original_language: $original_language, overview: $overview, title: $title, video: $video, genre_ids: $genre_ids, popularity: $popularity, poster_path: $poster_path, vote_count: $vote_count, original_title: $original_title, release_date: $release_date)';
  }
