...
class _$_MovieInfo implements _MovieInfo {
  ...
  @override
  String toString() {
    return 'MovieInfo(original_title: $original_title, popularity: $popularity, poster_path: $poster_path, vote_average: $vote_average, id: $id, title: $title, video: $video, adult: $adult, genre_ids: $genre_ids, vote_count: $vote_count, backdrop_path: $backdrop_path, original_language: $original_language, overview: $overview, release_date: $release_date)';
  }
