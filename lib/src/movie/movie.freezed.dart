...
class _$_MovieInfo implements _MovieInfo {
  ...
  @override
  String toString() {
    return 'MovieInfo(popularity: $popularity, adult: $adult, overview: $overview, poster_path: $poster_path, title: $title, original_language: $original_language, original_title: $original_title, genre_ids: $genre_ids, vote_average: $vote_average, release_date: $release_date, video: $video, vote_count: $vote_count, backdrop_path: $backdrop_path, id: $id)';
  }
