...
class _$_MovieInfo implements _MovieInfo {
  ...
  @override
  String toString() {
    return 'MovieInfo(backdrop_path: $backdrop_path, release_date: $release_date, genre_ids: $genre_ids, original_title: $original_title, popularity: $popularity, title: $title, adult: $adult, overview: $overview, video: $video, vote_average: $vote_average, id: $id, original_language: $original_language, poster_path: $poster_path, vote_count: $vote_count)';
  }
