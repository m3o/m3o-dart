...
class _$_MovieInfo implements _MovieInfo {
  ...
  @override
  String toString() {
    return 'MovieInfo(title: $title, video: $video, release_date: $release_date, overview: $overview, popularity: $popularity, poster_path: $poster_path, original_language: $original_language, backdrop_path: $backdrop_path, vote_average: $vote_average, vote_count: $vote_count, adult: $adult, id: $id, original_title: $original_title, genre_ids: $genre_ids)';
  }
