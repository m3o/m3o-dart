...
class _$_MovieInfo implements _MovieInfo {
  ...
  @override
  String toString() {
    return 'MovieInfo(title: $title, poster_path: $poster_path, video: $video, vote_count: $vote_count, id: $id, original_title: $original_title, popularity: $popularity, overview: $overview, release_date: $release_date, vote_average: $vote_average, backdrop_path: $backdrop_path, genre_ids: $genre_ids, original_language: $original_language, adult: $adult)';
  }
