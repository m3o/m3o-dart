...
class _$_MovieInfo implements _MovieInfo {
  ...
  @override
  String toString() {
    return 'MovieInfo(original_language: $original_language, popularity: $popularity, poster_path: $poster_path, release_date: $release_date, adult: $adult, backdrop_path: $backdrop_path, id: $id, genre_ids: $genre_ids, video: $video, vote_count: $vote_count, original_title: $original_title, overview: $overview, title: $title, vote_average: $vote_average)';
  }
