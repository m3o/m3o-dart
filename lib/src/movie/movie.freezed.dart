...
class _$_MovieInfo implements _MovieInfo {
  ...
  @override
  String toString() {
    return 'MovieInfo(original_language: $original_language, original_title: $original_title, vote_count: $vote_count, adult: $adult, popularity: $popularity, poster_path: $poster_path, title: $title, video: $video, backdrop_path: $backdrop_path, genre_ids: $genre_ids, overview: $overview, release_date: $release_date, vote_average: $vote_average, id: $id)';
  }
