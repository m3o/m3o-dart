...
class _$_MovieInfo implements _MovieInfo {
  ...
  @override
  String toString() {
    return 'MovieInfo(backdrop_path: $backdrop_path, id: $id, original_title: $original_title, overview: $overview, poster_path: $poster_path, title: $title, video: $video, vote_count: $vote_count, adult: $adult, genre_ids: $genre_ids, popularity: $popularity, release_date: $release_date, original_language: $original_language, vote_average: $vote_average)';
  }
