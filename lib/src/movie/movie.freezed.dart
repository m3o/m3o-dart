...
class _$_MovieInfo implements _MovieInfo {
  ...
  @override
  String toString() {
    return 'MovieInfo(genre_ids: $genre_ids, original_language: $original_language, original_title: $original_title, poster_path: $poster_path, adult: $adult, title: $title, vote_average: $vote_average, vote_count: $vote_count, overview: $overview, id: $id, popularity: $popularity, release_date: $release_date, video: $video, backdrop_path: $backdrop_path)';
  }
