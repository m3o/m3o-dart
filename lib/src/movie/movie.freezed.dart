...
class _$_MovieInfo implements _MovieInfo {
  ...
  @override
  String toString() {
    return 'MovieInfo(adult: $adult, vote_average: $vote_average, release_date: $release_date, vote_count: $vote_count, genre_ids: $genre_ids, original_language: $original_language, original_title: $original_title, popularity: $popularity, title: $title, video: $video, backdrop_path: $backdrop_path, id: $id, overview: $overview, poster_path: $poster_path)';
  }
