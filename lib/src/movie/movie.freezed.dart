...
class _$_MovieInfo implements _MovieInfo {
  ...
  @override
  String toString() {
    return 'MovieInfo(id: $id, original_language: $original_language, original_title: $original_title, popularity: $popularity, backdrop_path: $backdrop_path, genre_ids: $genre_ids, vote_average: $vote_average, vote_count: $vote_count, adult: $adult, overview: $overview, poster_path: $poster_path, video: $video, release_date: $release_date, title: $title)';
  }
