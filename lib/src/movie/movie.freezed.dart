...
class _$_MovieInfo implements _MovieInfo {
  ...
  @override
  String toString() {
    return 'MovieInfo(overview: $overview, title: $title, adult: $adult, genre_ids: $genre_ids, id: $id, original_title: $original_title, backdrop_path: $backdrop_path, popularity: $popularity, release_date: $release_date, video: $video, original_language: $original_language, vote_average: $vote_average, vote_count: $vote_count, poster_path: $poster_path)';
  }
