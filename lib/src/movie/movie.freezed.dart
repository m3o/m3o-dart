...
class _$_MovieInfo implements _MovieInfo {
  ...
  @override
  String toString() {
    return 'MovieInfo(title: $title, backdrop_path: $backdrop_path, popularity: $popularity, poster_path: $poster_path, release_date: $release_date, video: $video, vote_average: $vote_average, id: $id, original_language: $original_language, vote_count: $vote_count, adult: $adult, original_title: $original_title, genre_ids: $genre_ids, overview: $overview)';
  }
