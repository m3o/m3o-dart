...
class _$_MovieInfo implements _MovieInfo {
  ...
  @override
  String toString() {
    return 'MovieInfo(release_date: $release_date, vote_average: $vote_average, backdrop_path: $backdrop_path, id: $id, overview: $overview, vote_count: $vote_count, adult: $adult, original_language: $original_language, original_title: $original_title, video: $video, genre_ids: $genre_ids, poster_path: $poster_path, title: $title, popularity: $popularity)';
  }
