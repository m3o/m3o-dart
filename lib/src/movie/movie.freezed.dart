...
class _$_MovieInfo implements _MovieInfo {
  ...
  @override
  String toString() {
    return 'MovieInfo(release_date: $release_date, genre_ids: $genre_ids, original_title: $original_title, popularity: $popularity, vote_average: $vote_average, id: $id, title: $title, original_language: $original_language, overview: $overview, poster_path: $poster_path, video: $video, vote_count: $vote_count, adult: $adult, backdrop_path: $backdrop_path)';
  }
