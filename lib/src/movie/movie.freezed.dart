...
class _$_MovieInfo implements _MovieInfo {
  ...
  @override
  String toString() {
    return 'MovieInfo(id: $id, original_language: $original_language, vote_average: $vote_average, release_date: $release_date, video: $video, adult: $adult, genre_ids: $genre_ids, overview: $overview, popularity: $popularity, poster_path: $poster_path, backdrop_path: $backdrop_path, original_title: $original_title, title: $title, vote_count: $vote_count)';
  }
