...
class _$_MovieInfo implements _MovieInfo {
  ...
  @override
  String toString() {
    return 'MovieInfo(genre_ids: $genre_ids, title: $title, adult: $adult, id: $id, original_language: $original_language, overview: $overview, release_date: $release_date, vote_average: $vote_average, backdrop_path: $backdrop_path, original_title: $original_title, popularity: $popularity, poster_path: $poster_path, video: $video, vote_count: $vote_count)';
  }
