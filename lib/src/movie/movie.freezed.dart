...
class _$_MovieInfo implements _MovieInfo {
  ...
  @override
  String toString() {
    return 'MovieInfo(original_language: $original_language, popularity: $popularity, release_date: $release_date, adult: $adult, id: $id, overview: $overview, video: $video, vote_count: $vote_count, genre_ids: $genre_ids, original_title: $original_title, poster_path: $poster_path, title: $title, backdrop_path: $backdrop_path, vote_average: $vote_average)';
  }
