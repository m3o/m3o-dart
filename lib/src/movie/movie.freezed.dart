...
class _$_MovieInfo implements _MovieInfo {
  ...
  @override
  String toString() {
    return 'MovieInfo(adult: $adult, popularity: $popularity, release_date: $release_date, vote_average: $vote_average, genre_ids: $genre_ids, original_title: $original_title, poster_path: $poster_path, original_language: $original_language, overview: $overview, title: $title, video: $video, backdrop_path: $backdrop_path, id: $id, vote_count: $vote_count)';
  }
