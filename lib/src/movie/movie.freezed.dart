...
class _$_MovieInfo implements _MovieInfo {
  ...
  @override
  String toString() {
    return 'MovieInfo(backdrop_path: $backdrop_path, original_title: $original_title, poster_path: $poster_path, video: $video, original_language: $original_language, overview: $overview, title: $title, vote_average: $vote_average, adult: $adult, genre_ids: $genre_ids, popularity: $popularity, id: $id, release_date: $release_date, vote_count: $vote_count)';
  }
