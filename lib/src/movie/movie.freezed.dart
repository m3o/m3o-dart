...
class _$_MovieInfo implements _MovieInfo {
  ...
  @override
  String toString() {
    return 'MovieInfo(backdrop_path: $backdrop_path, id: $id, original_title: $original_title, popularity: $popularity, video: $video, poster_path: $poster_path, release_date: $release_date, title: $title, vote_average: $vote_average, vote_count: $vote_count, adult: $adult, genre_ids: $genre_ids, original_language: $original_language, overview: $overview)';
  }
