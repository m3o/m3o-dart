...
class _$_MovieInfo implements _MovieInfo {
  ...
  @override
  String toString() {
    return 'MovieInfo(vote_count: $vote_count, adult: $adult, vote_average: $vote_average, release_date: $release_date, genre_ids: $genre_ids, poster_path: $poster_path, overview: $overview, title: $title, original_language: $original_language, original_title: $original_title, popularity: $popularity, video: $video, backdrop_path: $backdrop_path, id: $id)';
  }
