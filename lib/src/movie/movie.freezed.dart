...
class _$_MovieInfo implements _MovieInfo {
  ...
  @override
  String toString() {
    return 'MovieInfo(original_title: $original_title, poster_path: $poster_path, video: $video, title: $title, vote_count: $vote_count, adult: $adult, genre_ids: $genre_ids, original_language: $original_language, overview: $overview, release_date: $release_date, id: $id, vote_average: $vote_average, backdrop_path: $backdrop_path, popularity: $popularity)';
  }
