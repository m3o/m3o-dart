...
class _$_MovieInfo implements _MovieInfo {
  ...
  @override
  String toString() {
    return 'MovieInfo(vote_average: $vote_average, genre_ids: $genre_ids, poster_path: $poster_path, video: $video, vote_count: $vote_count, adult: $adult, original_title: $original_title, release_date: $release_date, title: $title, popularity: $popularity, backdrop_path: $backdrop_path, id: $id, original_language: $original_language, overview: $overview)';
  }
