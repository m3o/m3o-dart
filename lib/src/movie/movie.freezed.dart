...
class _$_MovieInfo implements _MovieInfo {
  ...
  @override
  String toString() {
    return 'MovieInfo(adult: $adult, genre_ids: $genre_ids, backdrop_path: $backdrop_path, id: $id, original_title: $original_title, video: $video, original_language: $original_language, poster_path: $poster_path, title: $title, vote_count: $vote_count, overview: $overview, popularity: $popularity, release_date: $release_date, vote_average: $vote_average)';
  }
