...
class _$_MovieInfo implements _MovieInfo {
  ...
  @override
  String toString() {
    return 'MovieInfo(original_language: $original_language, overview: $overview, video: $video, vote_count: $vote_count, id: $id, original_title: $original_title, popularity: $popularity, poster_path: $poster_path, release_date: $release_date, title: $title, vote_average: $vote_average, genre_ids: $genre_ids, backdrop_path: $backdrop_path, adult: $adult)';
  }
