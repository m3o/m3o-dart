...
class _$_MovieInfo implements _MovieInfo {
  ...
  @override
  String toString() {
    return 'MovieInfo(popularity: $popularity, adult: $adult, id: $id, original_language: $original_language, title: $title, video: $video, vote_average: $vote_average, vote_count: $vote_count, backdrop_path: $backdrop_path, genre_ids: $genre_ids, poster_path: $poster_path, release_date: $release_date, original_title: $original_title, overview: $overview)';
  }
