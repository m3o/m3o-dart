...
class _$_MovieInfo implements _MovieInfo {
  ...
  @override
  String toString() {
    return 'MovieInfo(vote_average: $vote_average, genre_ids: $genre_ids, original_language: $original_language, overview: $overview, poster_path: $poster_path, release_date: $release_date, adult: $adult, video: $video, vote_count: $vote_count, title: $title, backdrop_path: $backdrop_path, id: $id, original_title: $original_title, popularity: $popularity)';
  }
