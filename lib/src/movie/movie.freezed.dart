...
class _$_MovieInfo implements _MovieInfo {
  ...
  @override
  String toString() {
    return 'MovieInfo(overview: $overview, vote_average: $vote_average, id: $id, original_language: $original_language, release_date: $release_date, title: $title, genre_ids: $genre_ids, original_title: $original_title, video: $video, adult: $adult, backdrop_path: $backdrop_path, popularity: $popularity, poster_path: $poster_path, vote_count: $vote_count)';
  }
