...
class _$_MovieInfo implements _MovieInfo {
  ...
  @override
  String toString() {
    return 'MovieInfo(id: $id, overview: $overview, vote_count: $vote_count, backdrop_path: $backdrop_path, poster_path: $poster_path, adult: $adult, popularity: $popularity, video: $video, vote_average: $vote_average, original_language: $original_language, original_title: $original_title, release_date: $release_date, title: $title, genre_ids: $genre_ids)';
  }
