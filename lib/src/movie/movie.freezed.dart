...
class _$_MovieInfo implements _MovieInfo {
  ...
  @override
  String toString() {
    return 'MovieInfo(genre_ids: $genre_ids, poster_path: $poster_path, backdrop_path: $backdrop_path, original_language: $original_language, original_title: $original_title, popularity: $popularity, vote_average: $vote_average, title: $title, video: $video, adult: $adult, id: $id, overview: $overview, release_date: $release_date, vote_count: $vote_count)';
  }
