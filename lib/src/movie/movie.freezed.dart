...
class _$_MovieInfo implements _MovieInfo {
  ...
  @override
  String toString() {
    return 'MovieInfo(release_date: $release_date, video: $video, overview: $overview, backdrop_path: $backdrop_path, original_language: $original_language, original_title: $original_title, poster_path: $poster_path, title: $title, id: $id, genre_ids: $genre_ids, popularity: $popularity, vote_average: $vote_average, vote_count: $vote_count, adult: $adult)';
  }
