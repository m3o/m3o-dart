...
class _$_MovieInfo implements _MovieInfo {
  ...
  @override
  String toString() {
    return 'MovieInfo(original_language: $original_language, video: $video, poster_path: $poster_path, release_date: $release_date, genre_ids: $genre_ids, id: $id, original_title: $original_title, overview: $overview, vote_count: $vote_count, adult: $adult, backdrop_path: $backdrop_path, title: $title, vote_average: $vote_average, popularity: $popularity)';
  }
