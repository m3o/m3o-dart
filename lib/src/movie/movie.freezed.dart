...
class _$_MovieInfo implements _MovieInfo {
  ...
  @override
  String toString() {
    return 'MovieInfo(release_date: $release_date, id: $id, poster_path: $poster_path, popularity: $popularity, genre_ids: $genre_ids, original_title: $original_title, video: $video, vote_average: $vote_average, original_language: $original_language, overview: $overview, title: $title, vote_count: $vote_count, adult: $adult, backdrop_path: $backdrop_path)';
  }
