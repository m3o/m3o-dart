...
class _$_MovieInfo implements _MovieInfo {
  ...
  @override
  String toString() {
    return 'MovieInfo(adult: $adult, overview: $overview, popularity: $popularity, poster_path: $poster_path, video: $video, original_title: $original_title, vote_count: $vote_count, backdrop_path: $backdrop_path, genre_ids: $genre_ids, id: $id, original_language: $original_language, release_date: $release_date, title: $title, vote_average: $vote_average)';
  }
