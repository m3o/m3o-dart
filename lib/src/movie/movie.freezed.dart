...
class _$_MovieInfo implements _MovieInfo {
  ...
  @override
  String toString() {
    return 'MovieInfo(backdrop_path: $backdrop_path, id: $id, popularity: $popularity, video: $video, adult: $adult, genre_ids: $genre_ids, poster_path: $poster_path, release_date: $release_date, vote_count: $vote_count, original_language: $original_language, original_title: $original_title, overview: $overview, title: $title, vote_average: $vote_average)';
  }
