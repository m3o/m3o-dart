...
class _$_MovieInfo implements _MovieInfo {
  ...
  @override
  String toString() {
    return 'MovieInfo(original_language: $original_language, popularity: $popularity, video: $video, adult: $adult, genre_ids: $genre_ids, id: $id, overview: $overview, vote_average: $vote_average, original_title: $original_title, poster_path: $poster_path, release_date: $release_date, title: $title, vote_count: $vote_count, backdrop_path: $backdrop_path)';
  }
