...
class _$_MovieInfo implements _MovieInfo {
  ...
  @override
  String toString() {
    return 'MovieInfo(original_title: $original_title, popularity: $popularity, release_date: $release_date, vote_count: $vote_count, backdrop_path: $backdrop_path, title: $title, video: $video, original_language: $original_language, poster_path: $poster_path, adult: $adult, genre_ids: $genre_ids, id: $id, overview: $overview, vote_average: $vote_average)';
  }
