...
class _$_MovieInfo implements _MovieInfo {
  ...
  @override
  String toString() {
    return 'MovieInfo(poster_path: $poster_path, release_date: $release_date, title: $title, adult: $adult, original_language: $original_language, overview: $overview, vote_average: $vote_average, backdrop_path: $backdrop_path, genre_ids: $genre_ids, id: $id, original_title: $original_title, video: $video, popularity: $popularity, vote_count: $vote_count)';
  }
