...
class _$_MovieInfo implements _MovieInfo {
  ...
  @override
  String toString() {
    return 'MovieInfo(overview: $overview, poster_path: $poster_path, release_date: $release_date, title: $title, popularity: $popularity, vote_average: $vote_average, adult: $adult, backdrop_path: $backdrop_path, genre_ids: $genre_ids, id: $id, original_language: $original_language, original_title: $original_title, video: $video, vote_count: $vote_count)';
  }
