...
class _$_MovieInfo implements _MovieInfo {
  ...
  @override
  String toString() {
    return 'MovieInfo(overview: $overview, backdrop_path: $backdrop_path, original_language: $original_language, release_date: $release_date, video: $video, vote_count: $vote_count, adult: $adult, genre_ids: $genre_ids, poster_path: $poster_path, title: $title, vote_average: $vote_average, id: $id, original_title: $original_title, popularity: $popularity)';
  }
