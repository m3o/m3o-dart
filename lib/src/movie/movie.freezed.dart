...
class _$_MovieInfo implements _MovieInfo {
  ...
  @override
  String toString() {
    return 'MovieInfo(poster_path: $poster_path, title: $title, genre_ids: $genre_ids, id: $id, original_title: $original_title, original_language: $original_language, vote_average: $vote_average, popularity: $popularity, vote_count: $vote_count, release_date: $release_date, video: $video, adult: $adult, backdrop_path: $backdrop_path, overview: $overview)';
  }
