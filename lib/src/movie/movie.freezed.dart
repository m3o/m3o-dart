...
class _$_MovieInfo implements _MovieInfo {
  ...
  @override
  String toString() {
    return 'MovieInfo(adult: $adult, original_title: $original_title, overview: $overview, video: $video, vote_count: $vote_count, backdrop_path: $backdrop_path, popularity: $popularity, poster_path: $poster_path, title: $title, original_language: $original_language, genre_ids: $genre_ids, id: $id, release_date: $release_date, vote_average: $vote_average)';
  }
