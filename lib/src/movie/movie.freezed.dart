...
class _$_MovieInfo implements _MovieInfo {
  ...
  @override
  String toString() {
    return 'MovieInfo(popularity: $popularity, poster_path: $poster_path, vote_count: $vote_count, backdrop_path: $backdrop_path, genre_ids: $genre_ids, original_language: $original_language, overview: $overview, original_title: $original_title, release_date: $release_date, video: $video, vote_average: $vote_average, title: $title, adult: $adult, id: $id)';
  }
