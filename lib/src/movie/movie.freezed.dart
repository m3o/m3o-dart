...
class _$_MovieInfo implements _MovieInfo {
  ...
  @override
  String toString() {
    return 'MovieInfo(adult: $adult, overview: $overview, release_date: $release_date, vote_average: $vote_average, title: $title, video: $video, vote_count: $vote_count, genre_ids: $genre_ids, original_language: $original_language, original_title: $original_title, popularity: $popularity, poster_path: $poster_path, id: $id, backdrop_path: $backdrop_path)';
  }
