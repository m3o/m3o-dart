...
class _$_MovieInfo implements _MovieInfo {
  ...
  @override
  String toString() {
    return 'MovieInfo(adult: $adult, id: $id, release_date: $release_date, video: $video, vote_count: $vote_count, vote_average: $vote_average, backdrop_path: $backdrop_path, genre_ids: $genre_ids, original_language: $original_language, original_title: $original_title, popularity: $popularity, overview: $overview, poster_path: $poster_path, title: $title)';
  }
