...
class _$_MovieInfo implements _MovieInfo {
  ...
  @override
  String toString() {
    return 'MovieInfo(overview: $overview, popularity: $popularity, video: $video, vote_average: $vote_average, original_title: $original_title, original_language: $original_language, poster_path: $poster_path, vote_count: $vote_count, id: $id, title: $title, genre_ids: $genre_ids, backdrop_path: $backdrop_path, release_date: $release_date, adult: $adult)';
  }
