...
class _$_MovieInfo implements _MovieInfo {
  ...
  @override
  String toString() {
    return 'MovieInfo(backdrop_path: $backdrop_path, original_title: $original_title, video: $video, vote_count: $vote_count, adult: $adult, id: $id, genre_ids: $genre_ids, popularity: $popularity, poster_path: $poster_path, release_date: $release_date, vote_average: $vote_average, original_language: $original_language, overview: $overview, title: $title)';
  }
