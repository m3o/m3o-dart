...
class _$_MovieInfo implements _MovieInfo {
  ...
  @override
  String toString() {
    return 'MovieInfo(id: $id, release_date: $release_date, overview: $overview, adult: $adult, backdrop_path: $backdrop_path, genre_ids: $genre_ids, original_language: $original_language, vote_count: $vote_count, popularity: $popularity, poster_path: $poster_path, video: $video, vote_average: $vote_average, original_title: $original_title, title: $title)';
  }
