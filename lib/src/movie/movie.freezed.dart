...
class _$_MovieInfo implements _MovieInfo {
  ...
  @override
  String toString() {
    return 'MovieInfo(adult: $adult, backdrop_path: $backdrop_path, vote_average: $vote_average, overview: $overview, popularity: $popularity, video: $video, genre_ids: $genre_ids, id: $id, original_language: $original_language, poster_path: $poster_path, release_date: $release_date, title: $title, vote_count: $vote_count, original_title: $original_title)';
  }
