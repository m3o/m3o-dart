...
class _$_MovieInfo implements _MovieInfo {
  ...
  @override
  String toString() {
    return 'MovieInfo(vote_count: $vote_count, genre_ids: $genre_ids, release_date: $release_date, poster_path: $poster_path, id: $id, overview: $overview, video: $video, vote_average: $vote_average, backdrop_path: $backdrop_path, title: $title, original_title: $original_title, popularity: $popularity, adult: $adult, original_language: $original_language)';
  }
