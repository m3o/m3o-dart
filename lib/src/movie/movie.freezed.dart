...
class _$_MovieInfo implements _MovieInfo {
  ...
  @override
  String toString() {
    return 'MovieInfo(title: $title, adult: $adult, overview: $overview, popularity: $popularity, poster_path: $poster_path, backdrop_path: $backdrop_path, id: $id, original_title: $original_title, vote_count: $vote_count, original_language: $original_language, release_date: $release_date, video: $video, genre_ids: $genre_ids, vote_average: $vote_average)';
  }
