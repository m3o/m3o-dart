...
class _$_MovieInfo implements _MovieInfo {
  ...
  @override
  String toString() {
    return 'MovieInfo(release_date: $release_date, video: $video, id: $id, overview: $overview, vote_count: $vote_count, genre_ids: $genre_ids, backdrop_path: $backdrop_path, popularity: $popularity, vote_average: $vote_average, adult: $adult, original_title: $original_title, poster_path: $poster_path, title: $title, original_language: $original_language)';
  }
