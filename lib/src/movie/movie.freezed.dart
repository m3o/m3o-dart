...
class _$_MovieInfo implements _MovieInfo {
  ...
  @override
  String toString() {
    return 'MovieInfo(vote_average: $vote_average, original_title: $original_title, overview: $overview, release_date: $release_date, video: $video, id: $id, poster_path: $poster_path, genre_ids: $genre_ids, original_language: $original_language, vote_count: $vote_count, adult: $adult, backdrop_path: $backdrop_path, popularity: $popularity, title: $title)';
  }
