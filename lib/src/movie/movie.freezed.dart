...
class _$_MovieInfo implements _MovieInfo {
  ...
  @override
  String toString() {
    return 'MovieInfo(backdrop_path: $backdrop_path, genre_ids: $genre_ids, original_language: $original_language, release_date: $release_date, video: $video, adult: $adult, original_title: $original_title, title: $title, vote_average: $vote_average, overview: $overview, popularity: $popularity, poster_path: $poster_path, vote_count: $vote_count, id: $id)';
  }
