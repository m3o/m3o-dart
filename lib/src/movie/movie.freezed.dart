...
class _$_MovieInfo implements _MovieInfo {
  ...
  @override
  String toString() {
    return 'MovieInfo(genre_ids: $genre_ids, original_language: $original_language, poster_path: $poster_path, title: $title, vote_count: $vote_count, original_title: $original_title, release_date: $release_date, video: $video, adult: $adult, backdrop_path: $backdrop_path, id: $id, popularity: $popularity, vote_average: $vote_average, overview: $overview)';
  }
