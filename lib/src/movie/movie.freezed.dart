...
class _$_MovieInfo implements _MovieInfo {
  ...
  @override
  String toString() {
    return 'MovieInfo(adult: $adult, genre_ids: $genre_ids, backdrop_path: $backdrop_path, id: $id, original_language: $original_language, title: $title, vote_count: $vote_count, original_title: $original_title, overview: $overview, popularity: $popularity, poster_path: $poster_path, vote_average: $vote_average, release_date: $release_date, video: $video)';
  }
