...
class _$_MovieInfo implements _MovieInfo {
  ...
  @override
  String toString() {
    return 'MovieInfo(title: $title, original_language: $original_language, original_title: $original_title, vote_count: $vote_count, genre_ids: $genre_ids, backdrop_path: $backdrop_path, overview: $overview, release_date: $release_date, video: $video, vote_average: $vote_average, adult: $adult, popularity: $popularity, poster_path: $poster_path, id: $id)';
  }
