...
class _$_MovieInfo implements _MovieInfo {
  ...
  @override
  String toString() {
    return 'MovieInfo(vote_count: $vote_count, adult: $adult, id: $id, original_title: $original_title, overview: $overview, title: $title, genre_ids: $genre_ids, popularity: $popularity, poster_path: $poster_path, release_date: $release_date, video: $video, backdrop_path: $backdrop_path, original_language: $original_language, vote_average: $vote_average)';
  }
