...
class _$_MovieInfo implements _MovieInfo {
  ...
  @override
  String toString() {
    return 'MovieInfo(adult: $adult, original_language: $original_language, original_title: $original_title, genre_ids: $genre_ids, popularity: $popularity, poster_path: $poster_path, video: $video, backdrop_path: $backdrop_path, id: $id, overview: $overview, title: $title, release_date: $release_date, vote_average: $vote_average, vote_count: $vote_count)';
  }
