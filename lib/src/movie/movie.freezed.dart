...
class _$_MovieInfo implements _MovieInfo {
  ...
  @override
  String toString() {
    return 'MovieInfo(backdrop_path: $backdrop_path, genre_ids: $genre_ids, original_language: $original_language, original_title: $original_title, vote_average: $vote_average, adult: $adult, title: $title, video: $video, release_date: $release_date, popularity: $popularity, id: $id, poster_path: $poster_path, vote_count: $vote_count, overview: $overview)';
  }
