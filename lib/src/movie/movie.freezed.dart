...
class _$_MovieInfo implements _MovieInfo {
  ...
  @override
  String toString() {
    return 'MovieInfo(backdrop_path: $backdrop_path, genre_ids: $genre_ids, original_title: $original_title, poster_path: $poster_path, vote_average: $vote_average, id: $id, overview: $overview, title: $title, adult: $adult, original_language: $original_language, popularity: $popularity, release_date: $release_date, video: $video, vote_count: $vote_count)';
  }
