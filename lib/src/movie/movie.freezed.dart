...
class _$_MovieInfo implements _MovieInfo {
  ...
  @override
  String toString() {
    return 'MovieInfo(release_date: $release_date, title: $title, adult: $adult, genre_ids: $genre_ids, original_title: $original_title, popularity: $popularity, backdrop_path: $backdrop_path, original_language: $original_language, poster_path: $poster_path, vote_average: $vote_average, overview: $overview, video: $video, id: $id, vote_count: $vote_count)';
  }
