...
class _$_MovieInfo implements _MovieInfo {
  ...
  @override
  String toString() {
    return 'MovieInfo(backdrop_path: $backdrop_path, overview: $overview, release_date: $release_date, video: $video, adult: $adult, poster_path: $poster_path, original_title: $original_title, title: $title, vote_average: $vote_average, vote_count: $vote_count, genre_ids: $genre_ids, id: $id, original_language: $original_language, popularity: $popularity)';
  }
