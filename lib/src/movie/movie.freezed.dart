...
class _$_MovieInfo implements _MovieInfo {
  ...
  @override
  String toString() {
    return 'MovieInfo(original_title: $original_title, overview: $overview, vote_average: $vote_average, adult: $adult, id: $id, release_date: $release_date, title: $title, genre_ids: $genre_ids, poster_path: $poster_path, vote_count: $vote_count, backdrop_path: $backdrop_path, original_language: $original_language, popularity: $popularity, video: $video)';
  }
