...
class _$_MovieInfo implements _MovieInfo {
  ...
  @override
  String toString() {
    return 'MovieInfo(release_date: $release_date, id: $id, original_title: $original_title, poster_path: $poster_path, vote_average: $vote_average, vote_count: $vote_count, backdrop_path: $backdrop_path, overview: $overview, title: $title, popularity: $popularity, video: $video, adult: $adult, genre_ids: $genre_ids, original_language: $original_language)';
  }
