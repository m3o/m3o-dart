...
class _$_MovieInfo implements _MovieInfo {
  ...
  @override
  String toString() {
    return 'MovieInfo(original_language: $original_language, poster_path: $poster_path, vote_count: $vote_count, genre_ids: $genre_ids, popularity: $popularity, release_date: $release_date, original_title: $original_title, overview: $overview, title: $title, video: $video, vote_average: $vote_average, adult: $adult, backdrop_path: $backdrop_path, id: $id)';
  }
