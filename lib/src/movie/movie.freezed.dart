...
class _$_MovieInfo implements _MovieInfo {
  ...
  @override
  String toString() {
    return 'MovieInfo(overview: $overview, popularity: $popularity, release_date: $release_date, backdrop_path: $backdrop_path, id: $id, original_language: $original_language, vote_count: $vote_count, poster_path: $poster_path, title: $title, video: $video, adult: $adult, vote_average: $vote_average, genre_ids: $genre_ids, original_title: $original_title)';
  }
