...
class _$_MovieInfo implements _MovieInfo {
  ...
  @override
  String toString() {
    return 'MovieInfo(release_date: $release_date, title: $title, vote_count: $vote_count, genre_ids: $genre_ids, original_language: $original_language, poster_path: $poster_path, backdrop_path: $backdrop_path, id: $id, popularity: $popularity, video: $video, vote_average: $vote_average, adult: $adult, original_title: $original_title, overview: $overview)';
  }
