...
class _$_MovieInfo implements _MovieInfo {
  ...
  @override
  String toString() {
    return 'MovieInfo(poster_path: $poster_path, release_date: $release_date, video: $video, backdrop_path: $backdrop_path, original_language: $original_language, original_title: $original_title, vote_count: $vote_count, overview: $overview, popularity: $popularity, vote_average: $vote_average, title: $title, adult: $adult, genre_ids: $genre_ids, id: $id)';
  }
