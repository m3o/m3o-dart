...
class _$_MovieInfo implements _MovieInfo {
  ...
  @override
  String toString() {
    return 'MovieInfo(release_date: $release_date, vote_count: $vote_count, genre_ids: $genre_ids, id: $id, popularity: $popularity, title: $title, poster_path: $poster_path, video: $video, vote_average: $vote_average, adult: $adult, backdrop_path: $backdrop_path, original_language: $original_language, original_title: $original_title, overview: $overview)';
  }
