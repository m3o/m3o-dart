...
class _$_MovieInfo implements _MovieInfo {
  ...
  @override
  String toString() {
    return 'MovieInfo(id: $id, title: $title, video: $video, vote_average: $vote_average, original_language: $original_language, original_title: $original_title, overview: $overview, release_date: $release_date, backdrop_path: $backdrop_path, genre_ids: $genre_ids, popularity: $popularity, poster_path: $poster_path, adult: $adult, vote_count: $vote_count)';
  }
