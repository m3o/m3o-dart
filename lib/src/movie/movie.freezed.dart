...
class _$_MovieInfo implements _MovieInfo {
  ...
  @override
  String toString() {
    return 'MovieInfo(backdrop_path: $backdrop_path, video: $video, title: $title, vote_average: $vote_average, vote_count: $vote_count, original_title: $original_title, popularity: $popularity, overview: $overview, adult: $adult, genre_ids: $genre_ids, poster_path: $poster_path, release_date: $release_date, id: $id, original_language: $original_language)';
  }
