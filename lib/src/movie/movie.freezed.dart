...
class _$_MovieInfo implements _MovieInfo {
  ...
  @override
  String toString() {
    return 'MovieInfo(original_title: $original_title, popularity: $popularity, video: $video, genre_ids: $genre_ids, poster_path: $poster_path, backdrop_path: $backdrop_path, original_language: $original_language, release_date: $release_date, adult: $adult, id: $id, overview: $overview, title: $title, vote_average: $vote_average, vote_count: $vote_count)';
  }
