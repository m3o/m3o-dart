...
class _$_MovieInfo implements _MovieInfo {
  ...
  @override
  String toString() {
    return 'MovieInfo(adult: $adult, genre_ids: $genre_ids, video: $video, vote_average: $vote_average, release_date: $release_date, original_language: $original_language, overview: $overview, popularity: $popularity, poster_path: $poster_path, backdrop_path: $backdrop_path, original_title: $original_title, title: $title, id: $id, vote_count: $vote_count)';
  }
