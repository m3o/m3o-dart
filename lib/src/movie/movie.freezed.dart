...
class _$_MovieInfo implements _MovieInfo {
  ...
  @override
  String toString() {
    return 'MovieInfo(poster_path: $poster_path, release_date: $release_date, title: $title, vote_average: $vote_average, vote_count: $vote_count, genre_ids: $genre_ids, original_title: $original_title, overview: $overview, popularity: $popularity, video: $video, id: $id, backdrop_path: $backdrop_path, original_language: $original_language, adult: $adult)';
  }
