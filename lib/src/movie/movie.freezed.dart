...
class _$_MovieInfo implements _MovieInfo {
  ...
  @override
  String toString() {
    return 'MovieInfo(backdrop_path: $backdrop_path, overview: $overview, popularity: $popularity, id: $id, original_language: $original_language, original_title: $original_title, poster_path: $poster_path, video: $video, vote_count: $vote_count, genre_ids: $genre_ids, release_date: $release_date, vote_average: $vote_average, adult: $adult, title: $title)';
  }
