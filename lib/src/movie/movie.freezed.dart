...
class _$_MovieInfo implements _MovieInfo {
  ...
  @override
  String toString() {
    return 'MovieInfo(vote_count: $vote_count, adult: $adult, video: $video, original_language: $original_language, overview: $overview, poster_path: $poster_path, title: $title, vote_average: $vote_average, backdrop_path: $backdrop_path, genre_ids: $genre_ids, id: $id, original_title: $original_title, popularity: $popularity, release_date: $release_date)';
  }
