...
class _$_MovieInfo implements _MovieInfo {
  ...
  @override
  String toString() {
    return 'MovieInfo(adult: $adult, original_language: $original_language, poster_path: $poster_path, video: $video, vote_count: $vote_count, original_title: $original_title, overview: $overview, popularity: $popularity, backdrop_path: $backdrop_path, release_date: $release_date, title: $title, vote_average: $vote_average, genre_ids: $genre_ids, id: $id)';
  }
