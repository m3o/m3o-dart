...
class _$_MovieInfo implements _MovieInfo {
  ...
  @override
  String toString() {
    return 'MovieInfo(backdrop_path: $backdrop_path, vote_count: $vote_count, id: $id, overview: $overview, release_date: $release_date, title: $title, adult: $adult, genre_ids: $genre_ids, video: $video, vote_average: $vote_average, original_language: $original_language, poster_path: $poster_path, original_title: $original_title, popularity: $popularity)';
  }
