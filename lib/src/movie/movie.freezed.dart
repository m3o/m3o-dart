...
class _$_MovieInfo implements _MovieInfo {
  ...
  @override
  String toString() {
    return 'MovieInfo(vote_count: $vote_count, poster_path: $poster_path, vote_average: $vote_average, adult: $adult, original_language: $original_language, overview: $overview, popularity: $popularity, release_date: $release_date, backdrop_path: $backdrop_path, genre_ids: $genre_ids, id: $id, original_title: $original_title, title: $title, video: $video)';
  }
