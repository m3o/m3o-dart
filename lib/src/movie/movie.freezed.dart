...
class _$_MovieInfo implements _MovieInfo {
  ...
  @override
  String toString() {
    return 'MovieInfo(adult: $adult, id: $id, original_title: $original_title, release_date: $release_date, original_language: $original_language, popularity: $popularity, title: $title, backdrop_path: $backdrop_path, genre_ids: $genre_ids, video: $video, vote_count: $vote_count, overview: $overview, poster_path: $poster_path, vote_average: $vote_average)';
  }
