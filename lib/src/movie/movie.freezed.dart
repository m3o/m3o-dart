...
class _$_MovieInfo implements _MovieInfo {
  ...
  @override
  String toString() {
    return 'MovieInfo(vote_count: $vote_count, poster_path: $poster_path, release_date: $release_date, genre_ids: $genre_ids, id: $id, original_language: $original_language, overview: $overview, adult: $adult, popularity: $popularity, vote_average: $vote_average, backdrop_path: $backdrop_path, original_title: $original_title, title: $title, video: $video)';
  }
