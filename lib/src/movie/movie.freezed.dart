...
class _$_MovieInfo implements _MovieInfo {
  ...
  @override
  String toString() {
    return 'MovieInfo(adult: $adult, id: $id, overview: $overview, video: $video, genre_ids: $genre_ids, original_language: $original_language, popularity: $popularity, poster_path: $poster_path, release_date: $release_date, title: $title, original_title: $original_title, vote_average: $vote_average, backdrop_path: $backdrop_path, vote_count: $vote_count)';
  }
