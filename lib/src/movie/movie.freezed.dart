...
class _$_MovieInfo implements _MovieInfo {
  ...
  @override
  String toString() {
    return 'MovieInfo(original_title: $original_title, overview: $overview, release_date: $release_date, backdrop_path: $backdrop_path, title: $title, video: $video, genre_ids: $genre_ids, id: $id, popularity: $popularity, vote_average: $vote_average, adult: $adult, original_language: $original_language, poster_path: $poster_path, vote_count: $vote_count)';
  }
