...
class _$_MovieInfo implements _MovieInfo {
  ...
  @override
  String toString() {
    return 'MovieInfo(popularity: $popularity, release_date: $release_date, adult: $adult, genre_ids: $genre_ids, id: $id, backdrop_path: $backdrop_path, poster_path: $poster_path, title: $title, vote_average: $vote_average, vote_count: $vote_count, original_language: $original_language, original_title: $original_title, video: $video, overview: $overview)';
  }
