...
class _$_MovieInfo implements _MovieInfo {
  ...
  @override
  String toString() {
    return 'MovieInfo(backdrop_path: $backdrop_path, genre_ids: $genre_ids, poster_path: $poster_path, release_date: $release_date, title: $title, id: $id, original_language: $original_language, overview: $overview, popularity: $popularity, video: $video, vote_count: $vote_count, adult: $adult, original_title: $original_title, vote_average: $vote_average)';
  }
