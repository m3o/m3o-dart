...
class _$_MovieInfo implements _MovieInfo {
  ...
  @override
  String toString() {
    return 'MovieInfo(genre_ids: $genre_ids, id: $id, original_title: $original_title, release_date: $release_date, title: $title, vote_count: $vote_count, adult: $adult, popularity: $popularity, poster_path: $poster_path, video: $video, vote_average: $vote_average, backdrop_path: $backdrop_path, original_language: $original_language, overview: $overview)';
  }
