...
class _$_MovieInfo implements _MovieInfo {
  ...
  @override
  String toString() {
    return 'MovieInfo(original_language: $original_language, original_title: $original_title, popularity: $popularity, release_date: $release_date, video: $video, vote_count: $vote_count, poster_path: $poster_path, title: $title, adult: $adult, genre_ids: $genre_ids, id: $id, overview: $overview, backdrop_path: $backdrop_path, vote_average: $vote_average)';
  }
