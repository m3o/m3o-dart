...
class _$_MovieInfo implements _MovieInfo {
  ...
  @override
  String toString() {
    return 'MovieInfo(adult: $adult, backdrop_path: $backdrop_path, original_language: $original_language, original_title: $original_title, poster_path: $poster_path, vote_count: $vote_count, genre_ids: $genre_ids, id: $id, overview: $overview, popularity: $popularity, title: $title, release_date: $release_date, video: $video, vote_average: $vote_average)';
  }
