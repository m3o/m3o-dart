...
class _$_MovieInfo implements _MovieInfo {
  ...
  @override
  String toString() {
    return 'MovieInfo(popularity: $popularity, release_date: $release_date, original_language: $original_language, original_title: $original_title, title: $title, backdrop_path: $backdrop_path, genre_ids: $genre_ids, overview: $overview, poster_path: $poster_path, video: $video, vote_average: $vote_average, adult: $adult, vote_count: $vote_count, id: $id)';
  }
