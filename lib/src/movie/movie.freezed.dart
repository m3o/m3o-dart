...
class _$_MovieInfo implements _MovieInfo {
  ...
  @override
  String toString() {
    return 'MovieInfo(adult: $adult, genre_ids: $genre_ids, popularity: $popularity, poster_path: $poster_path, backdrop_path: $backdrop_path, id: $id, video: $video, overview: $overview, vote_count: $vote_count, original_language: $original_language, original_title: $original_title, release_date: $release_date, title: $title, vote_average: $vote_average)';
  }
