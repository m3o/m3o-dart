...
class _$_MovieInfo implements _MovieInfo {
  ...
  @override
  String toString() {
    return 'MovieInfo(release_date: $release_date, overview: $overview, popularity: $popularity, poster_path: $poster_path, title: $title, video: $video, backdrop_path: $backdrop_path, genre_ids: $genre_ids, original_title: $original_title, vote_average: $vote_average, vote_count: $vote_count, adult: $adult, id: $id, original_language: $original_language)';
  }
