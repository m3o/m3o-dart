...
class _$_MovieInfo implements _MovieInfo {
  ...
  @override
  String toString() {
    return 'MovieInfo(vote_average: $vote_average, adult: $adult, genre_ids: $genre_ids, id: $id, original_language: $original_language, release_date: $release_date, backdrop_path: $backdrop_path, overview: $overview, poster_path: $poster_path, vote_count: $vote_count, original_title: $original_title, video: $video, popularity: $popularity, title: $title)';
  }
