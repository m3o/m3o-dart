...
class _$_MovieInfo implements _MovieInfo {
  ...
  @override
  String toString() {
    return 'MovieInfo(backdrop_path: $backdrop_path, poster_path: $poster_path, release_date: $release_date, title: $title, vote_average: $vote_average, original_language: $original_language, overview: $overview, id: $id, original_title: $original_title, video: $video, vote_count: $vote_count, adult: $adult, genre_ids: $genre_ids, popularity: $popularity)';
  }
