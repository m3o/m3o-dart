...
class _$_MovieInfo implements _MovieInfo {
  ...
  @override
  String toString() {
    return 'MovieInfo(video: $video, adult: $adult, vote_average: $vote_average, vote_count: $vote_count, release_date: $release_date, backdrop_path: $backdrop_path, id: $id, original_language: $original_language, original_title: $original_title, overview: $overview, popularity: $popularity, poster_path: $poster_path, genre_ids: $genre_ids, title: $title)';
  }
