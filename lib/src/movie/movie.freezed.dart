...
class _$_MovieInfo implements _MovieInfo {
  ...
  @override
  String toString() {
    return 'MovieInfo(poster_path: $poster_path, release_date: $release_date, title: $title, vote_average: $vote_average, adult: $adult, genre_ids: $genre_ids, id: $id, original_title: $original_title, backdrop_path: $backdrop_path, original_language: $original_language, popularity: $popularity, video: $video, vote_count: $vote_count, overview: $overview)';
  }
