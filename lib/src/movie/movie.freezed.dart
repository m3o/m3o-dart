...
class _$_MovieInfo implements _MovieInfo {
  ...
  @override
  String toString() {
    return 'MovieInfo(original_language: $original_language, overview: $overview, poster_path: $poster_path, release_date: $release_date, vote_count: $vote_count, genre_ids: $genre_ids, title: $title, adult: $adult, id: $id, video: $video, vote_average: $vote_average, backdrop_path: $backdrop_path, popularity: $popularity, original_title: $original_title)';
  }
