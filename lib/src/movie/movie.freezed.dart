...
class _$_MovieInfo implements _MovieInfo {
  ...
  @override
  String toString() {
    return 'MovieInfo(original_language: $original_language, title: $title, genre_ids: $genre_ids, popularity: $popularity, poster_path: $poster_path, video: $video, backdrop_path: $backdrop_path, original_title: $original_title, overview: $overview, release_date: $release_date, vote_count: $vote_count, adult: $adult, vote_average: $vote_average, id: $id)';
  }
