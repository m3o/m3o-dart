...
class _$_MovieInfo implements _MovieInfo {
  ...
  @override
  String toString() {
    return 'MovieInfo(release_date: $release_date, title: $title, vote_count: $vote_count, overview: $overview, popularity: $popularity, id: $id, original_language: $original_language, video: $video, vote_average: $vote_average, backdrop_path: $backdrop_path, genre_ids: $genre_ids, poster_path: $poster_path, adult: $adult, original_title: $original_title)';
  }
