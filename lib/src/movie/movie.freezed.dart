...
class _$_MovieInfo implements _MovieInfo {
  ...
  @override
  String toString() {
    return 'MovieInfo(adult: $adult, poster_path: $poster_path, vote_average: $vote_average, original_title: $original_title, release_date: $release_date, video: $video, popularity: $popularity, backdrop_path: $backdrop_path, id: $id, original_language: $original_language, vote_count: $vote_count, genre_ids: $genre_ids, overview: $overview, title: $title)';
  }
