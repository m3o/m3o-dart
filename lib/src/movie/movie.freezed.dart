...
class _$_MovieInfo implements _MovieInfo {
  ...
  @override
  String toString() {
    return 'MovieInfo(title: $title, genre_ids: $genre_ids, id: $id, original_title: $original_title, release_date: $release_date, video: $video, adult: $adult, original_language: $original_language, overview: $overview, vote_count: $vote_count, backdrop_path: $backdrop_path, popularity: $popularity, poster_path: $poster_path, vote_average: $vote_average)';
  }
