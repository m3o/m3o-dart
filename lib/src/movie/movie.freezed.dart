...
class _$_MovieInfo implements _MovieInfo {
  ...
  @override
  String toString() {
    return 'MovieInfo(genre_ids: $genre_ids, id: $id, original_title: $original_title, title: $title, backdrop_path: $backdrop_path, overview: $overview, poster_path: $poster_path, release_date: $release_date, vote_average: $vote_average, adult: $adult, original_language: $original_language, popularity: $popularity, video: $video, vote_count: $vote_count)';
  }
