...
class _$_MovieInfo implements _MovieInfo {
  ...
  @override
  String toString() {
    return 'MovieInfo(genre_ids: $genre_ids, original_language: $original_language, backdrop_path: $backdrop_path, release_date: $release_date, adult: $adult, id: $id, original_title: $original_title, overview: $overview, title: $title, video: $video, vote_average: $vote_average, popularity: $popularity, poster_path: $poster_path, vote_count: $vote_count)';
  }
