...
class _$_MovieInfo implements _MovieInfo {
  ...
  @override
  String toString() {
    return 'MovieInfo(original_language: $original_language, original_title: $original_title, vote_count: $vote_count, adult: $adult, genre_ids: $genre_ids, id: $id, overview: $overview, popularity: $popularity, poster_path: $poster_path, release_date: $release_date, video: $video, backdrop_path: $backdrop_path, title: $title, vote_average: $vote_average)';
  }
