...
class _$_MovieInfo implements _MovieInfo {
  ...
  @override
  String toString() {
    return 'MovieInfo(genre_ids: $genre_ids, release_date: $release_date, vote_count: $vote_count, poster_path: $poster_path, video: $video, vote_average: $vote_average, title: $title, adult: $adult, original_language: $original_language, popularity: $popularity, overview: $overview, backdrop_path: $backdrop_path, id: $id, original_title: $original_title)';
  }
