...
class _$_MovieInfo implements _MovieInfo {
  ...
  @override
  String toString() {
    return 'MovieInfo(original_title: $original_title, vote_average: $vote_average, genre_ids: $genre_ids, id: $id, original_language: $original_language, poster_path: $poster_path, vote_count: $vote_count, adult: $adult, backdrop_path: $backdrop_path, title: $title, overview: $overview, popularity: $popularity, release_date: $release_date, video: $video)';
  }
