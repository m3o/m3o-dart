...
class _$_MovieInfo implements _MovieInfo {
  ...
  @override
  String toString() {
    return 'MovieInfo(adult: $adult, backdrop_path: $backdrop_path, vote_count: $vote_count, original_language: $original_language, poster_path: $poster_path, release_date: $release_date, genre_ids: $genre_ids, id: $id, overview: $overview, title: $title, video: $video, vote_average: $vote_average, original_title: $original_title, popularity: $popularity)';
  }
