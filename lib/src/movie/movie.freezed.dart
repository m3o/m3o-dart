...
class _$_MovieInfo implements _MovieInfo {
  ...
  @override
  String toString() {
    return 'MovieInfo(overview: $overview, vote_count: $vote_count, genre_ids: $genre_ids, original_title: $original_title, poster_path: $poster_path, release_date: $release_date, title: $title, original_language: $original_language, backdrop_path: $backdrop_path, id: $id, adult: $adult, video: $video, vote_average: $vote_average, popularity: $popularity)';
  }
