...
class _$_MovieInfo implements _MovieInfo {
  ...
  @override
  String toString() {
    return 'MovieInfo(release_date: $release_date, vote_average: $vote_average, vote_count: $vote_count, adult: $adult, id: $id, original_language: $original_language, overview: $overview, title: $title, genre_ids: $genre_ids, poster_path: $poster_path, original_title: $original_title, popularity: $popularity, video: $video, backdrop_path: $backdrop_path)';
  }
