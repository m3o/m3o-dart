...
class _$_MovieInfo implements _MovieInfo {
  ...
  @override
  String toString() {
    return 'MovieInfo(genre_ids: $genre_ids, overview: $overview, id: $id, vote_average: $vote_average, vote_count: $vote_count, backdrop_path: $backdrop_path, original_language: $original_language, original_title: $original_title, poster_path: $poster_path, title: $title, video: $video, adult: $adult, popularity: $popularity, release_date: $release_date)';
  }
