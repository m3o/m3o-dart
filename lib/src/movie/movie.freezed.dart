...
class _$_MovieInfo implements _MovieInfo {
  ...
  @override
  String toString() {
    return 'MovieInfo(adult: $adult, poster_path: $poster_path, title: $title, video: $video, backdrop_path: $backdrop_path, overview: $overview, vote_count: $vote_count, id: $id, original_language: $original_language, original_title: $original_title, release_date: $release_date, vote_average: $vote_average, genre_ids: $genre_ids, popularity: $popularity)';
  }
