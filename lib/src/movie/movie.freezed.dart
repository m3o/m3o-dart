...
class _$_MovieInfo implements _MovieInfo {
  ...
  @override
  String toString() {
    return 'MovieInfo(overview: $overview, backdrop_path: $backdrop_path, original_title: $original_title, title: $title, vote_average: $vote_average, vote_count: $vote_count, adult: $adult, id: $id, popularity: $popularity, poster_path: $poster_path, release_date: $release_date, video: $video, genre_ids: $genre_ids, original_language: $original_language)';
  }
