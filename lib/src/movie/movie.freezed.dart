...
class _$_MovieInfo implements _MovieInfo {
  ...
  @override
  String toString() {
    return 'MovieInfo(popularity: $popularity, title: $title, video: $video, vote_count: $vote_count, id: $id, backdrop_path: $backdrop_path, genre_ids: $genre_ids, adult: $adult, poster_path: $poster_path, original_language: $original_language, overview: $overview, release_date: $release_date, vote_average: $vote_average, original_title: $original_title)';
  }
