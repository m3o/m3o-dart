...
class _$_MovieInfo implements _MovieInfo {
  ...
  @override
  String toString() {
    return 'MovieInfo(overview: $overview, genre_ids: $genre_ids, id: $id, popularity: $popularity, release_date: $release_date, title: $title, vote_average: $vote_average, adult: $adult, backdrop_path: $backdrop_path, poster_path: $poster_path, video: $video, vote_count: $vote_count, original_language: $original_language, original_title: $original_title)';
  }
