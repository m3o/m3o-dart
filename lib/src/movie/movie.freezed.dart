...
class _$_MovieInfo implements _MovieInfo {
  ...
  @override
  String toString() {
    return 'MovieInfo(adult: $adult, backdrop_path: $backdrop_path, original_title: $original_title, title: $title, release_date: $release_date, vote_count: $vote_count, genre_ids: $genre_ids, id: $id, original_language: $original_language, vote_average: $vote_average, overview: $overview, popularity: $popularity, poster_path: $poster_path, video: $video)';
  }
