...
class _$_MovieInfo implements _MovieInfo {
  ...
  @override
  String toString() {
    return 'MovieInfo(backdrop_path: $backdrop_path, original_language: $original_language, release_date: $release_date, title: $title, genre_ids: $genre_ids, id: $id, overview: $overview, video: $video, popularity: $popularity, poster_path: $poster_path, adult: $adult, original_title: $original_title, vote_average: $vote_average, vote_count: $vote_count)';
  }
