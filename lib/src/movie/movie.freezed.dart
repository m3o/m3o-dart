...
class _$_MovieInfo implements _MovieInfo {
  ...
  @override
  String toString() {
    return 'MovieInfo(original_language: $original_language, overview: $overview, video: $video, vote_average: $vote_average, adult: $adult, backdrop_path: $backdrop_path, genre_ids: $genre_ids, vote_count: $vote_count, original_title: $original_title, popularity: $popularity, title: $title, id: $id, poster_path: $poster_path, release_date: $release_date)';
  }
...
abstract class _MovieInfo implements MovieInfo {
  const factory _MovieInfo(
      ...
      final int? id,
      final String? poster_path,
      final String? release_date}) = _$_MovieInfo;
