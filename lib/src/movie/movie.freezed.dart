...
class _$_MovieInfo implements _MovieInfo {
  ...
  @override
  String toString() {
    return 'MovieInfo(genre_ids: $genre_ids, release_date: $release_date, vote_count: $vote_count, adult: $adult, original_title: $original_title, poster_path: $poster_path, original_language: $original_language, overview: $overview, video: $video, backdrop_path: $backdrop_path, id: $id, popularity: $popularity, title: $title, vote_average: $vote_average)';
  }
