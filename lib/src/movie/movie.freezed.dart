...
class _$_MovieInfo implements _MovieInfo {
  ...
  @override
  String toString() {
    return 'MovieInfo(vote_average: $vote_average, adult: $adult, original_language: $original_language, video: $video, id: $id, popularity: $popularity, title: $title, release_date: $release_date, backdrop_path: $backdrop_path, original_title: $original_title, overview: $overview, genre_ids: $genre_ids, poster_path: $poster_path, vote_count: $vote_count)';
  }
