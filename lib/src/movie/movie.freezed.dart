...
class _$_MovieInfo implements _MovieInfo {
  ...
  @override
  String toString() {
    return 'MovieInfo(vote_count: $vote_count, genre_ids: $genre_ids, id: $id, original_language: $original_language, video: $video, original_title: $original_title, release_date: $release_date, adult: $adult, backdrop_path: $backdrop_path, overview: $overview, poster_path: $poster_path, popularity: $popularity, title: $title, vote_average: $vote_average)';
  }
