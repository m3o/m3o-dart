...
class _$_MovieInfo implements _MovieInfo {
  ...
  @override
  String toString() {
    return 'MovieInfo(backdrop_path: $backdrop_path, id: $id, original_language: $original_language, popularity: $popularity, video: $video, overview: $overview, poster_path: $poster_path, title: $title, adult: $adult, genre_ids: $genre_ids, original_title: $original_title, release_date: $release_date, vote_average: $vote_average, vote_count: $vote_count)';
  }
