...
class _$_MovieInfo implements _MovieInfo {
  ...
  @override
  String toString() {
    return 'MovieInfo(poster_path: $poster_path, release_date: $release_date, vote_average: $vote_average, vote_count: $vote_count, adult: $adult, backdrop_path: $backdrop_path, title: $title, video: $video, genre_ids: $genre_ids, overview: $overview, popularity: $popularity, id: $id, original_language: $original_language, original_title: $original_title)';
  }
