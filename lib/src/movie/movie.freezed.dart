...
class _$_MovieInfo implements _MovieInfo {
  ...
  @override
  String toString() {
    return 'MovieInfo(backdrop_path: $backdrop_path, original_title: $original_title, release_date: $release_date, vote_average: $vote_average, id: $id, poster_path: $poster_path, title: $title, video: $video, original_language: $original_language, popularity: $popularity, vote_count: $vote_count, adult: $adult, genre_ids: $genre_ids, overview: $overview)';
  }
