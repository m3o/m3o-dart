...
class _$_MovieInfo implements _MovieInfo {
  ...
  @override
  String toString() {
    return 'MovieInfo(popularity: $popularity, release_date: $release_date, vote_average: $vote_average, adult: $adult, overview: $overview, poster_path: $poster_path, id: $id, original_title: $original_title, title: $title, video: $video, vote_count: $vote_count, backdrop_path: $backdrop_path, genre_ids: $genre_ids, original_language: $original_language)';
  }
