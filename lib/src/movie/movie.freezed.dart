...
class _$_MovieInfo implements _MovieInfo {
  ...
  @override
  String toString() {
    return 'MovieInfo(adult: $adult, backdrop_path: $backdrop_path, title: $title, original_language: $original_language, original_title: $original_title, overview: $overview, popularity: $popularity, poster_path: $poster_path, vote_average: $vote_average, vote_count: $vote_count, genre_ids: $genre_ids, id: $id, release_date: $release_date, video: $video)';
  }
