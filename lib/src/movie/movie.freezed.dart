...
class _$_MovieInfo implements _MovieInfo {
  ...
  @override
  String toString() {
    return 'MovieInfo(backdrop_path: $backdrop_path, genre_ids: $genre_ids, id: $id, poster_path: $poster_path, video: $video, original_language: $original_language, original_title: $original_title, release_date: $release_date, title: $title, vote_average: $vote_average, overview: $overview, vote_count: $vote_count, adult: $adult, popularity: $popularity)';
  }
