...
class _$_MovieInfo implements _MovieInfo {
  ...
  @override
  String toString() {
    return 'MovieInfo(adult: $adult, backdrop_path: $backdrop_path, original_title: $original_title, popularity: $popularity, video: $video, genre_ids: $genre_ids, id: $id, poster_path: $poster_path, release_date: $release_date, vote_average: $vote_average, original_language: $original_language, overview: $overview, vote_count: $vote_count, title: $title)';
  }
