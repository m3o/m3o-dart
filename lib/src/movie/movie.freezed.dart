...
class _$_MovieInfo implements _MovieInfo {
  ...
  @override
  String toString() {
    return 'MovieInfo(backdrop_path: $backdrop_path, release_date: $release_date, title: $title, original_title: $original_title, poster_path: $poster_path, vote_average: $vote_average, overview: $overview, popularity: $popularity, vote_count: $vote_count, adult: $adult, genre_ids: $genre_ids, id: $id, original_language: $original_language, video: $video)';
  }
