...
class _$_MovieInfo implements _MovieInfo {
  ...
  @override
  String toString() {
    return 'MovieInfo(vote_average: $vote_average, original_title: $original_title, release_date: $release_date, video: $video, adult: $adult, backdrop_path: $backdrop_path, id: $id, genre_ids: $genre_ids, overview: $overview, title: $title, vote_count: $vote_count, original_language: $original_language, popularity: $popularity, poster_path: $poster_path)';
  }
