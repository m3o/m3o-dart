...
class _$_MovieInfo implements _MovieInfo {
  ...
  @override
  String toString() {
    return 'MovieInfo(original_language: $original_language, popularity: $popularity, video: $video, vote_count: $vote_count, genre_ids: $genre_ids, id: $id, original_title: $original_title, adult: $adult, backdrop_path: $backdrop_path, poster_path: $poster_path, overview: $overview, release_date: $release_date, title: $title, vote_average: $vote_average)';
  }
