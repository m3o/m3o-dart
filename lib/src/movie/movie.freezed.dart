...
class _$_MovieInfo implements _MovieInfo {
  ...
  @override
  String toString() {
    return 'MovieInfo(genre_ids: $genre_ids, overview: $overview, release_date: $release_date, video: $video, vote_count: $vote_count, id: $id, poster_path: $poster_path, vote_average: $vote_average, adult: $adult, original_title: $original_title, popularity: $popularity, title: $title, backdrop_path: $backdrop_path, original_language: $original_language)';
  }
...
abstract class _MovieInfo implements MovieInfo {
  const factory _MovieInfo(
      ...
      final String? title,
      final String? backdrop_path,
      final String? original_language}) = _$_MovieInfo;
