...
class _$_MovieInfo implements _MovieInfo {
  ...
  @override
  String toString() {
    return 'MovieInfo(backdrop_path: $backdrop_path, vote_average: $vote_average, vote_count: $vote_count, adult: $adult, id: $id, video: $video, poster_path: $poster_path, title: $title, genre_ids: $genre_ids, overview: $overview, popularity: $popularity, original_language: $original_language, original_title: $original_title, release_date: $release_date)';
  }
