...
class _$_MovieInfo implements _MovieInfo {
  ...
  @override
  String toString() {
    return 'MovieInfo(backdrop_path: $backdrop_path, id: $id, genre_ids: $genre_ids, original_language: $original_language, popularity: $popularity, release_date: $release_date, vote_average: $vote_average, original_title: $original_title, poster_path: $poster_path, video: $video, adult: $adult, overview: $overview, title: $title, vote_count: $vote_count)';
  }
