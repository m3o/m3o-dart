...
class _$_MovieInfo implements _MovieInfo {
  ...
  @override
  String toString() {
    return 'MovieInfo(adult: $adult, poster_path: $poster_path, release_date: $release_date, title: $title, vote_average: $vote_average, backdrop_path: $backdrop_path, id: $id, popularity: $popularity, genre_ids: $genre_ids, overview: $overview, vote_count: $vote_count, original_language: $original_language, original_title: $original_title, video: $video)';
  }
