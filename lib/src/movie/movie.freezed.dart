...
class _$_MovieInfo implements _MovieInfo {
  ...
  @override
  String toString() {
    return 'MovieInfo(original_language: $original_language, overview: $overview, backdrop_path: $backdrop_path, title: $title, vote_count: $vote_count, adult: $adult, id: $id, original_title: $original_title, poster_path: $poster_path, release_date: $release_date, genre_ids: $genre_ids, popularity: $popularity, video: $video, vote_average: $vote_average)';
  }
