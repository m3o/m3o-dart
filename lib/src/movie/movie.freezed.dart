...
class _$_MovieInfo implements _MovieInfo {
  ...
  @override
  String toString() {
    return 'MovieInfo(genre_ids: $genre_ids, original_language: $original_language, overview: $overview, popularity: $popularity, poster_path: $poster_path, vote_count: $vote_count, adult: $adult, backdrop_path: $backdrop_path, id: $id, original_title: $original_title, video: $video, release_date: $release_date, title: $title, vote_average: $vote_average)';
  }
