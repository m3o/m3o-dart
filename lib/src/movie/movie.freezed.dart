...
class _$_MovieInfo implements _MovieInfo {
  ...
  @override
  String toString() {
    return 'MovieInfo(overview: $overview, release_date: $release_date, backdrop_path: $backdrop_path, id: $id, original_language: $original_language, title: $title, original_title: $original_title, popularity: $popularity, poster_path: $poster_path, video: $video, vote_average: $vote_average, adult: $adult, genre_ids: $genre_ids, vote_count: $vote_count)';
  }
