...
class _$_MovieInfo implements _MovieInfo {
  ...
  @override
  String toString() {
    return 'MovieInfo(adult: $adult, original_title: $original_title, video: $video, vote_count: $vote_count, original_language: $original_language, poster_path: $poster_path, release_date: $release_date, title: $title, backdrop_path: $backdrop_path, id: $id, overview: $overview, popularity: $popularity, vote_average: $vote_average, genre_ids: $genre_ids)';
  }
...
abstract class _MovieInfo implements MovieInfo {
  const factory _MovieInfo(
      ...
      final double? popularity,
      final double? vote_average,
      final List<int>? genre_ids}) = _$_MovieInfo;
