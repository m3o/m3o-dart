...
class _$_MovieInfo implements _MovieInfo {
  ...
  @override
  String toString() {
    return 'MovieInfo(release_date: $release_date, adult: $adult, original_language: $original_language, overview: $overview, popularity: $popularity, vote_average: $vote_average, backdrop_path: $backdrop_path, genre_ids: $genre_ids, original_title: $original_title, video: $video, id: $id, poster_path: $poster_path, title: $title, vote_count: $vote_count)';
  }
