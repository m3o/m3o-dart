...
class _$_MovieInfo implements _MovieInfo {
  ...
  @override
  String toString() {
    return 'MovieInfo(adult: $adult, backdrop_path: $backdrop_path, poster_path: $poster_path, title: $title, video: $video, id: $id, original_language: $original_language, genre_ids: $genre_ids, overview: $overview, popularity: $popularity, release_date: $release_date, vote_average: $vote_average, vote_count: $vote_count, original_title: $original_title)';
  }
