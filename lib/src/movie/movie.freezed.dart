...
class _$_MovieInfo implements _MovieInfo {
  ...
  @override
  String toString() {
    return 'MovieInfo(backdrop_path: $backdrop_path, genre_ids: $genre_ids, title: $title, original_title: $original_title, poster_path: $poster_path, video: $video, vote_count: $vote_count, adult: $adult, overview: $overview, popularity: $popularity, release_date: $release_date, id: $id, original_language: $original_language, vote_average: $vote_average)';
  }
