...
class _$_MovieInfo implements _MovieInfo {
  ...
  @override
  String toString() {
    return 'MovieInfo(original_language: $original_language, vote_average: $vote_average, vote_count: $vote_count, backdrop_path: $backdrop_path, popularity: $popularity, video: $video, genre_ids: $genre_ids, original_title: $original_title, release_date: $release_date, title: $title, adult: $adult, id: $id, overview: $overview, poster_path: $poster_path)';
  }
