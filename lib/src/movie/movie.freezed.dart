...
class _$_MovieInfo implements _MovieInfo {
  ...
  @override
  String toString() {
    return 'MovieInfo(vote_count: $vote_count, original_language: $original_language, popularity: $popularity, video: $video, vote_average: $vote_average, release_date: $release_date, adult: $adult, backdrop_path: $backdrop_path, genre_ids: $genre_ids, original_title: $original_title, poster_path: $poster_path, id: $id, overview: $overview, title: $title)';
  }
