...
class _$_MovieInfo implements _MovieInfo {
  ...
  @override
  String toString() {
    return 'MovieInfo(id: $id, vote_average: $vote_average, vote_count: $vote_count, adult: $adult, genre_ids: $genre_ids, release_date: $release_date, backdrop_path: $backdrop_path, original_language: $original_language, original_title: $original_title, overview: $overview, popularity: $popularity, video: $video, poster_path: $poster_path, title: $title)';
  }
