...
class _$_MovieInfo implements _MovieInfo {
  ...
  @override
  String toString() {
    return 'MovieInfo(genre_ids: $genre_ids, popularity: $popularity, poster_path: $poster_path, release_date: $release_date, adult: $adult, id: $id, original_language: $original_language, title: $title, video: $video, vote_count: $vote_count, backdrop_path: $backdrop_path, original_title: $original_title, overview: $overview, vote_average: $vote_average)';
  }
