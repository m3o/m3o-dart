...
class _$_MovieInfo implements _MovieInfo {
  ...
  @override
  String toString() {
    return 'MovieInfo(adult: $adult, overview: $overview, release_date: $release_date, vote_count: $vote_count, backdrop_path: $backdrop_path, original_title: $original_title, poster_path: $poster_path, vote_average: $vote_average, genre_ids: $genre_ids, original_language: $original_language, popularity: $popularity, id: $id, title: $title, video: $video)';
  }
