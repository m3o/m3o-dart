...
class _$_MovieInfo implements _MovieInfo {
  ...
  @override
  String toString() {
    return 'MovieInfo(adult: $adult, overview: $overview, title: $title, video: $video, genre_ids: $genre_ids, id: $id, original_title: $original_title, release_date: $release_date, vote_count: $vote_count, poster_path: $poster_path, backdrop_path: $backdrop_path, original_language: $original_language, popularity: $popularity, vote_average: $vote_average)';
  }
