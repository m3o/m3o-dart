...
class _$_MovieInfo implements _MovieInfo {
  ...
  @override
  String toString() {
    return 'MovieInfo(overview: $overview, vote_count: $vote_count, backdrop_path: $backdrop_path, original_language: $original_language, vote_average: $vote_average, release_date: $release_date, video: $video, original_title: $original_title, popularity: $popularity, poster_path: $poster_path, genre_ids: $genre_ids, id: $id, adult: $adult, title: $title)';
  }
