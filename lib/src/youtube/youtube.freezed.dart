...
class _$_SearchResult implements _SearchResult {
  ...
  @override
  String toString() {
    return 'SearchResult(url: $url, description: $description, id: $id, kind: $kind, published_at: $published_at, title: $title, broadcasting: $broadcasting, channel_id: $channel_id, channel_title: $channel_title)';
  }
