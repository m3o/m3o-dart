...
class _$_SearchResult implements _SearchResult {
  ...
  @override
  String toString() {
    return 'SearchResult(id: $id, published_at: $published_at, url: $url, broadcasting: $broadcasting, channel_id: $channel_id, description: $description, channel_title: $channel_title, kind: $kind, title: $title)';
  }
