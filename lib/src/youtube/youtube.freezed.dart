...
class _$_SearchResult implements _SearchResult {
  ...
  @override
  String toString() {
    return 'SearchResult(kind: $kind, title: $title, url: $url, broadcasting: $broadcasting, description: $description, id: $id, channel_id: $channel_id, channel_title: $channel_title, published_at: $published_at)';
  }
