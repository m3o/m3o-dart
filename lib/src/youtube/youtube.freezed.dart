...
class _$_SearchResult implements _SearchResult {
  ...
  @override
  String toString() {
    return 'SearchResult(description: $description, kind: $kind, title: $title, url: $url, channel_title: $channel_title, channel_id: $channel_id, id: $id, published_at: $published_at, broadcasting: $broadcasting)';
  }
