...
class _$EmbedResponseData implements EmbedResponseData {
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, long_url, short_url, embed_url, html_script);
...
abstract class EmbedResponseData implements EmbedResponse {
  const factory EmbedResponseData(
      ...
      final String? short_url,
      final String? embed_url,
      final String? html_script}) = _$EmbedResponseData;
...
class _$_SearchResult implements _SearchResult {
  ...
  @override
  String toString() {
    return 'SearchResult(broadcasting: $broadcasting, channel_id: $channel_id, description: $description, id: $id, url: $url, channel_title: $channel_title, kind: $kind, published_at: $published_at, title: $title)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, broadcasting, channel_id,
      description, id, url, channel_title, kind, published_at, title);
