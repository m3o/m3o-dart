...
class _$_SearchResult implements _SearchResult {
  ...
  @override
  String toString() {
    return 'SearchResult(url: $url, channel_title: $channel_title, channel_id: $channel_id, description: $description, id: $id, kind: $kind, published_at: $published_at, title: $title, broadcasting: $broadcasting)';
  }
