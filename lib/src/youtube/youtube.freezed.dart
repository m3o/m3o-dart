...
class _$_SearchResult implements _SearchResult {
  ...
  @override
  String toString() {
    return 'SearchResult(channel_id: $channel_id, published_at: $published_at, title: $title, broadcasting: $broadcasting, channel_title: $channel_title, description: $description, id: $id, kind: $kind, url: $url)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, channel_id, published_at, title,
      broadcasting, channel_title, description, id, kind, url);
