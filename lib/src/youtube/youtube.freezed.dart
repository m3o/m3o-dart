...
class _$_SearchResult implements _SearchResult {
  ...
  @override
  String toString() {
    return 'SearchResult(broadcasting: $broadcasting, channel_title: $channel_title, description: $description, id: $id, kind: $kind, url: $url, channel_id: $channel_id, published_at: $published_at, title: $title)';
  }
