...
class _$_SearchResult implements _SearchResult {
  ...
  @override
  String toString() {
    return 'SearchResult(broadcasting: $broadcasting, channel_title: $channel_title, title: $title, url: $url, published_at: $published_at, channel_id: $channel_id, description: $description, id: $id, kind: $kind)';
  }
