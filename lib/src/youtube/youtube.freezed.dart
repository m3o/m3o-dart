...
class _$_SearchResult implements _SearchResult {
  ...
  @override
  String toString() {
    return 'SearchResult(channel_id: $channel_id, channel_title: $channel_title, url: $url, kind: $kind, published_at: $published_at, title: $title, broadcasting: $broadcasting, description: $description, id: $id)';
  }
