...
class _$_SearchResult implements _SearchResult {
  ...
  @override
  String toString() {
    return 'SearchResult(title: $title, description: $description, id: $id, published_at: $published_at, kind: $kind, url: $url, broadcasting: $broadcasting, channel_id: $channel_id, channel_title: $channel_title)';
  }
