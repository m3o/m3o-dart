...
class _$_SearchResult implements _SearchResult {
  ...
  @override
  String toString() {
    return 'SearchResult(channel_id: $channel_id, description: $description, id: $id, kind: $kind, published_at: $published_at, url: $url, broadcasting: $broadcasting, title: $title, channel_title: $channel_title)';
  }
