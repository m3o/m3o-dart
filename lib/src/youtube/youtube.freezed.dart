...
class _$_SearchResult implements _SearchResult {
  ...
  @override
  String toString() {
    return 'SearchResult(description: $description, id: $id, broadcasting: $broadcasting, channel_title: $channel_title, published_at: $published_at, title: $title, url: $url, channel_id: $channel_id, kind: $kind)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, description, id, broadcasting,
      channel_title, published_at, title, url, channel_id, kind);
