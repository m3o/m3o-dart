...
class _$_SearchResult implements _SearchResult {
  ...
  @override
  String toString() {
    return 'SearchResult(url: $url, broadcasting: $broadcasting, channel_id: $channel_id, description: $description, id: $id, title: $title, channel_title: $channel_title, kind: $kind, published_at: $published_at)';
  }
