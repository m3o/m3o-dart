...
class _$_SearchResult implements _SearchResult {
  ...
  @override
  String toString() {
    return 'SearchResult(kind: $kind, broadcasting: $broadcasting, id: $id, description: $description, published_at: $published_at, title: $title, url: $url, channel_id: $channel_id, channel_title: $channel_title)';
  }
