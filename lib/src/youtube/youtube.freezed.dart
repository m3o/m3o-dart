...
class _$_SearchResult implements _SearchResult {
  ...
  @override
  String toString() {
    return 'SearchResult(description: $description, id: $id, kind: $kind, url: $url, channel_title: $channel_title, channel_id: $channel_id, published_at: $published_at, title: $title, broadcasting: $broadcasting)';
  }
...
abstract class _SearchResult implements SearchResult {
  const factory _SearchResult(
      ...
      final String? published_at,
      final String? title,
      final String? broadcasting}) = _$_SearchResult;
