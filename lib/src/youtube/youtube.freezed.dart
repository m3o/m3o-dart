...
class _$_SearchResult implements _SearchResult {
  ...
  @override
  String toString() {
    return 'SearchResult(id: $id, published_at: $published_at, title: $title, url: $url, broadcasting: $broadcasting, channel_title: $channel_title, description: $description, channel_id: $channel_id, kind: $kind)';
  }
