...
class _$_SearchResult implements _SearchResult {
  ...
  @override
  String toString() {
    return 'SearchResult(published_at: $published_at, broadcasting: $broadcasting, channel_title: $channel_title, description: $description, kind: $kind, channel_id: $channel_id, id: $id, title: $title, url: $url)';
  }
