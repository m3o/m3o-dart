...
class _$_SearchResult implements _SearchResult {
  ...
  @override
  String toString() {
    return 'SearchResult(broadcasting: $broadcasting, channel_title: $channel_title, published_at: $published_at, title: $title, channel_id: $channel_id, description: $description, id: $id, kind: $kind, url: $url)';
  }
