...
class _$_SearchResult implements _SearchResult {
  ...
  @override
  String toString() {
    return 'SearchResult(channel_id: $channel_id, channel_title: $channel_title, kind: $kind, published_at: $published_at, title: $title, broadcasting: $broadcasting, id: $id, url: $url, description: $description)';
  }
