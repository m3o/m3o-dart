...
class _$_SearchResult implements _SearchResult {
  ...
  @override
  String toString() {
    return 'SearchResult(description: $description, id: $id, kind: $kind, channel_title: $channel_title, channel_id: $channel_id, published_at: $published_at, title: $title, url: $url, broadcasting: $broadcasting)';
  }
