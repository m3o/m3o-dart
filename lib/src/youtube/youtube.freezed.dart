...
class _$_SearchResult implements _SearchResult {
  ...
  @override
  String toString() {
    return 'SearchResult(title: $title, url: $url, broadcasting: $broadcasting, description: $description, kind: $kind, published_at: $published_at, channel_id: $channel_id, channel_title: $channel_title, id: $id)';
  }
