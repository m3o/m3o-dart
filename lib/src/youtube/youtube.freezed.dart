...
class _$_SearchResult implements _SearchResult {
  ...
  @override
  String toString() {
    return 'SearchResult(description: $description, id: $id, url: $url, broadcasting: $broadcasting, channel_title: $channel_title, kind: $kind, published_at: $published_at, title: $title, channel_id: $channel_id)';
  }
