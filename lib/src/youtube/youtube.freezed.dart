...
class _$_SearchResult implements _SearchResult {
  ...
  @override
  String toString() {
    return 'SearchResult(channel_id: $channel_id, kind: $kind, broadcasting: $broadcasting, description: $description, id: $id, published_at: $published_at, title: $title, url: $url, channel_title: $channel_title)';
  }
