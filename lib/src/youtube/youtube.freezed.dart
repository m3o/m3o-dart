...
class _$_SearchResult implements _SearchResult {
  ...
  @override
  String toString() {
    return 'SearchResult(url: $url, broadcasting: $broadcasting, channel_id: $channel_id, description: $description, id: $id, published_at: $published_at, title: $title, channel_title: $channel_title, kind: $kind)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, url, broadcasting, channel_id,
      description, id, published_at, title, channel_title, kind);
...
abstract class _SearchResult implements SearchResult {
  const factory _SearchResult(
      ...
      final String? title,
      final String? channel_title,
      final String? kind}) = _$_SearchResult;
