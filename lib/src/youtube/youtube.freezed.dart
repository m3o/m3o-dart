...
class _$_SearchResult implements _SearchResult {
  ...
  @override
  String toString() {
    return 'SearchResult(url: $url, broadcasting: $broadcasting, description: $description, published_at: $published_at, title: $title, channel_id: $channel_id, channel_title: $channel_title, id: $id, kind: $kind)';
  }
