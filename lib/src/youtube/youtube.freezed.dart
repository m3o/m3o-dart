...
class _$_SearchResult implements _SearchResult {
  ...
  @override
  String toString() {
    return 'SearchResult(description: $description, id: $id, kind: $kind, broadcasting: $broadcasting, channel_title: $channel_title, title: $title, url: $url, channel_id: $channel_id, published_at: $published_at)';
  }
