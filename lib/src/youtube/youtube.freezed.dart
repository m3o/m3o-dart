...
class _$_SearchResult implements _SearchResult {
  ...
  @override
  String toString() {
    return 'SearchResult(broadcasting: $broadcasting, description: $description, kind: $kind, url: $url, channel_id: $channel_id, channel_title: $channel_title, id: $id, published_at: $published_at, title: $title)';
  }
