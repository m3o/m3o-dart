...
class _$_SearchResult implements _SearchResult {
  ...
  @override
  String toString() {
    return 'SearchResult(url: $url, description: $description, published_at: $published_at, channel_title: $channel_title, id: $id, kind: $kind, title: $title, broadcasting: $broadcasting, channel_id: $channel_id)';
  }
