...
class _$_SearchResult implements _SearchResult {
  ...
  @override
  String toString() {
    return 'SearchResult(id: $id, title: $title, url: $url, broadcasting: $broadcasting, channel_id: $channel_id, channel_title: $channel_title, description: $description, kind: $kind, published_at: $published_at)';
  }
