...
class _$_SearchResult implements _SearchResult {
  ...
  @override
  String toString() {
    return 'SearchResult(channel_title: $channel_title, description: $description, kind: $kind, published_at: $published_at, title: $title, broadcasting: $broadcasting, channel_id: $channel_id, id: $id, url: $url)';
  }
