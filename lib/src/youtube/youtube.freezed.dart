...
class _$_SearchResult implements _SearchResult {
  ...
  @override
  String toString() {
    return 'SearchResult(id: $id, published_at: $published_at, channel_id: $channel_id, description: $description, kind: $kind, title: $title, url: $url, broadcasting: $broadcasting, channel_title: $channel_title)';
  }
