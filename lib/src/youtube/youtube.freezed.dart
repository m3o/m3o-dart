...
class _$_SearchResult implements _SearchResult {
  ...
  @override
  String toString() {
    return 'SearchResult(channel_title: $channel_title, description: $description, title: $title, url: $url, broadcasting: $broadcasting, channel_id: $channel_id, id: $id, kind: $kind, published_at: $published_at)';
  }
