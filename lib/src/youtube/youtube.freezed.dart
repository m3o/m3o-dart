...
class _$_SearchResult implements _SearchResult {
  ...
  @override
  String toString() {
    return 'SearchResult(channel_id: $channel_id, description: $description, kind: $kind, broadcasting: $broadcasting, id: $id, published_at: $published_at, title: $title, url: $url, channel_title: $channel_title)';
  }
