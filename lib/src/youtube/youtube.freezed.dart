...
class _$_SearchResult implements _SearchResult {
  ...
  @override
  String toString() {
    return 'SearchResult(description: $description, kind: $kind, title: $title, url: $url, broadcasting: $broadcasting, channel_title: $channel_title, published_at: $published_at, channel_id: $channel_id, id: $id)';
  }
