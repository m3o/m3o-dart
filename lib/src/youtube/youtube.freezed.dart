...
class _$_SearchResult implements _SearchResult {
  ...
  @override
  String toString() {
    return 'SearchResult(title: $title, url: $url, description: $description, kind: $kind, channel_title: $channel_title, id: $id, published_at: $published_at, broadcasting: $broadcasting, channel_id: $channel_id)';
  }
