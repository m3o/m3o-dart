...
class _$_SearchResult implements _SearchResult {
  ...
  @override
  String toString() {
    return 'SearchResult(channel_title: $channel_title, description: $description, kind: $kind, title: $title, broadcasting: $broadcasting, channel_id: $channel_id, id: $id, published_at: $published_at, url: $url)';
  }
