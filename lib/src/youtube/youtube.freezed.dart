...
class _$_SearchResult implements _SearchResult {
  ...
  @override
  String toString() {
    return 'SearchResult(channel_id: $channel_id, channel_title: $channel_title, description: $description, url: $url, broadcasting: $broadcasting, id: $id, kind: $kind, published_at: $published_at, title: $title)';
  }
