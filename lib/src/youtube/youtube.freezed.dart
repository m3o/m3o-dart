...
class _$_SearchResult implements _SearchResult {
  ...
  @override
  String toString() {
    return 'SearchResult(channel_title: $channel_title, published_at: $published_at, title: $title, url: $url, broadcasting: $broadcasting, description: $description, id: $id, kind: $kind, channel_id: $channel_id)';
  }
