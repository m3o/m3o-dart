...
class _$_Profile implements _Profile {
  ...
  @override
  String toString() {
    return 'Profile(private: $private, verified: $verified, created_at: $created_at, followers: $followers, id: $id, name: $name, username: $username, description: $description, image_url: $image_url, location: $location)';
  }
