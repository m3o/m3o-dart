...
class _$_Profile implements _Profile {
  ...
  @override
  String toString() {
    return 'Profile(verified: $verified, location: $location, private: $private, username: $username, id: $id, image_url: $image_url, name: $name, created_at: $created_at, description: $description, followers: $followers)';
  }
