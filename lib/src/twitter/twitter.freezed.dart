...
class _$_Profile implements _Profile {
  ...
  @override
  String toString() {
    return 'Profile(id: $id, location: $location, name: $name, private: $private, created_at: $created_at, description: $description, followers: $followers, image_url: $image_url, username: $username, verified: $verified)';
  }
