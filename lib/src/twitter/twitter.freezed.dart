...
class _$_Profile implements _Profile {
  ...
  @override
  String toString() {
    return 'Profile(image_url: $image_url, location: $location, created_at: $created_at, description: $description, id: $id, username: $username, verified: $verified, followers: $followers, name: $name, private: $private)';
  }
