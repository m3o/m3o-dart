...
class _$_Profile implements _Profile {
  ...
  @override
  String toString() {
    return 'Profile(private: $private, verified: $verified, followers: $followers, image_url: $image_url, location: $location, name: $name, username: $username, created_at: $created_at, description: $description, id: $id)';
  }
