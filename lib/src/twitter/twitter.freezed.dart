...
class _$_Profile implements _Profile {
  ...
  @override
  String toString() {
    return 'Profile(private: $private, username: $username, created_at: $created_at, description: $description, id: $id, name: $name, followers: $followers, image_url: $image_url, location: $location, verified: $verified)';
  }
