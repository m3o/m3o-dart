...
class _$_Profile implements _Profile {
  ...
  @override
  String toString() {
    return 'Profile(description: $description, image_url: $image_url, location: $location, name: $name, verified: $verified, created_at: $created_at, id: $id, private: $private, username: $username, followers: $followers)';
  }
