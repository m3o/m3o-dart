...
class _$_Profile implements _Profile {
  ...
  @override
  String toString() {
    return 'Profile(description: $description, followers: $followers, image_url: $image_url, location: $location, private: $private, created_at: $created_at, id: $id, name: $name, username: $username, verified: $verified)';
  }
