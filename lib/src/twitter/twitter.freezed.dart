...
class _$_Profile implements _Profile {
  ...
  @override
  String toString() {
    return 'Profile(location: $location, name: $name, private: $private, username: $username, followers: $followers, id: $id, image_url: $image_url, created_at: $created_at, description: $description, verified: $verified)';
  }
