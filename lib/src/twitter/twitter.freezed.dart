...
class _$_Profile implements _Profile {
  ...
  @override
  String toString() {
    return 'Profile(created_at: $created_at, id: $id, image_url: $image_url, name: $name, private: $private, description: $description, followers: $followers, location: $location, username: $username, verified: $verified)';
  }
