...
class _$_Profile implements _Profile {
  ...
  @override
  String toString() {
    return 'Profile(followers: $followers, image_url: $image_url, username: $username, private: $private, verified: $verified, created_at: $created_at, description: $description, id: $id, location: $location, name: $name)';
  }
