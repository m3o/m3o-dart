...
class _$_Profile implements _Profile {
  ...
  @override
  String toString() {
    return 'Profile(id: $id, private: $private, username: $username, created_at: $created_at, followers: $followers, location: $location, name: $name, verified: $verified, description: $description, image_url: $image_url)';
  }
