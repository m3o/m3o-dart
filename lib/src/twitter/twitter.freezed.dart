...
class _$_Profile implements _Profile {
  ...
  @override
  String toString() {
    return 'Profile(private: $private, description: $description, followers: $followers, id: $id, image_url: $image_url, verified: $verified, created_at: $created_at, location: $location, name: $name, username: $username)';
  }
