...
class _$_Profile implements _Profile {
  ...
  @override
  String toString() {
    return 'Profile(location: $location, private: $private, username: $username, verified: $verified, description: $description, id: $id, image_url: $image_url, created_at: $created_at, followers: $followers, name: $name)';
  }
