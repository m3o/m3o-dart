...
class _$_Profile implements _Profile {
  ...
  @override
  String toString() {
    return 'Profile(followers: $followers, id: $id, image_url: $image_url, username: $username, verified: $verified, created_at: $created_at, description: $description, location: $location, name: $name, private: $private)';
  }
