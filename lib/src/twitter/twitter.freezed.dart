...
class _$_Profile implements _Profile {
  ...
  @override
  String toString() {
    return 'Profile(name: $name, private: $private, username: $username, verified: $verified, followers: $followers, description: $description, id: $id, image_url: $image_url, location: $location, created_at: $created_at)';
  }
