...
class _$_Profile implements _Profile {
  ...
  @override
  String toString() {
    return 'Profile(name: $name, verified: $verified, followers: $followers, id: $id, image_url: $image_url, location: $location, created_at: $created_at, description: $description, private: $private, username: $username)';
  }
