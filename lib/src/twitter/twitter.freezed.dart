...
class _$_Profile implements _Profile {
  ...
  @override
  String toString() {
    return 'Profile(description: $description, image_url: $image_url, private: $private, name: $name, username: $username, verified: $verified, created_at: $created_at, followers: $followers, id: $id, location: $location)';
  }
...
abstract class _Profile implements Profile {
  const factory _Profile(
      ...
      @JsonKey(fromJson: int64FromString, toJson: int64ToString)
          final int? id,
      final String? location}) = _$_Profile;
