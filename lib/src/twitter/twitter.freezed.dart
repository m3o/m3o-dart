...
class _$_Profile implements _Profile {
  ...
  @override
  String toString() {
    return 'Profile(followers: $followers, verified: $verified, created_at: $created_at, id: $id, image_url: $image_url, location: $location, name: $name, private: $private, username: $username, description: $description)';
  }
