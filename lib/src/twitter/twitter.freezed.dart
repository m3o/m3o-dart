...
class _$_Profile implements _Profile {
  ...
  @override
  String toString() {
    return 'Profile(description: $description, followers: $followers, image_url: $image_url, name: $name, private: $private, created_at: $created_at, id: $id, location: $location, username: $username, verified: $verified)';
  }
