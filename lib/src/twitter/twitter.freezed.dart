...
class _$_Profile implements _Profile {
  ...
  @override
  String toString() {
    return 'Profile(description: $description, id: $id, username: $username, verified: $verified, created_at: $created_at, followers: $followers, image_url: $image_url, location: $location, name: $name, private: $private)';
  }
