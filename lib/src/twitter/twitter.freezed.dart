...
class _$_Profile implements _Profile {
  ...
  @override
  String toString() {
    return 'Profile(followers: $followers, id: $id, location: $location, name: $name, private: $private, username: $username, verified: $verified, description: $description, image_url: $image_url, created_at: $created_at)';
  }
