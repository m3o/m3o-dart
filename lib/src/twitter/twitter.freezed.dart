...
class _$_Profile implements _Profile {
  ...
  @override
  String toString() {
    return 'Profile(description: $description, followers: $followers, name: $name, private: $private, verified: $verified, created_at: $created_at, image_url: $image_url, location: $location, username: $username, id: $id)';
  }
