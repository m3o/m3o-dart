...
class _$_Profile implements _Profile {
  ...
  @override
  String toString() {
    return 'Profile(image_url: $image_url, name: $name, private: $private, username: $username, created_at: $created_at, description: $description, followers: $followers, id: $id, location: $location, verified: $verified)';
  }
