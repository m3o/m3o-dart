...
class _$_Profile implements _Profile {
  ...
  @override
  String toString() {
    return 'Profile(id: $id, name: $name, private: $private, verified: $verified, followers: $followers, description: $description, image_url: $image_url, location: $location, username: $username, created_at: $created_at)';
  }
