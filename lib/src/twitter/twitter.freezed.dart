...
class _$_Profile implements _Profile {
  ...
  @override
  String toString() {
    return 'Profile(id: $id, image_url: $image_url, location: $location, username: $username, created_at: $created_at, description: $description, private: $private, verified: $verified, followers: $followers, name: $name)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, id, image_url, location,
      username, created_at, description, private, verified, followers, name);
