...
class _$_Profile implements _Profile {
  ...
  @override
  String toString() {
    return 'Profile(username: $username, verified: $verified, created_at: $created_at, followers: $followers, id: $id, image_url: $image_url, location: $location, description: $description, name: $name, private: $private)';
  }
