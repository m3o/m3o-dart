...
class _$_Profile implements _Profile {
  ...
  @override
  String toString() {
    return 'Profile(verified: $verified, description: $description, followers: $followers, id: $id, image_url: $image_url, private: $private, created_at: $created_at, location: $location, name: $name, username: $username)';
  }
