...
class _$_Profile implements _Profile {
  ...
  @override
  String toString() {
    return 'Profile(private: $private, username: $username, verified: $verified, created_at: $created_at, id: $id, image_url: $image_url, location: $location, name: $name, description: $description, followers: $followers)';
  }
