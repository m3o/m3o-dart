...
class _$_Profile implements _Profile {
  ...
  @override
  String toString() {
    return 'Profile(id: $id, private: $private, username: $username, description: $description, followers: $followers, location: $location, name: $name, verified: $verified, created_at: $created_at, image_url: $image_url)';
  }
