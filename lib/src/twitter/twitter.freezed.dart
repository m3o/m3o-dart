...
class _$_Profile implements _Profile {
  ...
  @override
  String toString() {
    return 'Profile(private: $private, verified: $verified, followers: $followers, id: $id, image_url: $image_url, location: $location, name: $name, created_at: $created_at, description: $description, username: $username)';
  }
