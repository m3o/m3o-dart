...
class _$_Profile implements _Profile {
  ...
  @override
  String toString() {
    return 'Profile(created_at: $created_at, image_url: $image_url, name: $name, username: $username, description: $description, followers: $followers, id: $id, location: $location, private: $private, verified: $verified)';
  }
