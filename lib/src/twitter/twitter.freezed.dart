...
class _$_Profile implements _Profile {
  ...
  @override
  String toString() {
    return 'Profile(description: $description, followers: $followers, id: $id, private: $private, created_at: $created_at, image_url: $image_url, location: $location, name: $name, username: $username, verified: $verified)';
  }
