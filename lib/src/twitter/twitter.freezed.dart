...
class _$_Profile implements _Profile {
  ...
  @override
  String toString() {
    return 'Profile(id: $id, name: $name, private: $private, username: $username, description: $description, followers: $followers, image_url: $image_url, location: $location, verified: $verified, created_at: $created_at)';
  }
