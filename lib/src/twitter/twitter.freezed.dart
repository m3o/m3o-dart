...
class _$_Profile implements _Profile {
  ...
  @override
  String toString() {
    return 'Profile(description: $description, followers: $followers, image_url: $image_url, location: $location, username: $username, created_at: $created_at, id: $id, name: $name, private: $private, verified: $verified)';
  }
