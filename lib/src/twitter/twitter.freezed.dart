...
class _$_Profile implements _Profile {
  ...
  @override
  String toString() {
    return 'Profile(location: $location, private: $private, username: $username, description: $description, id: $id, image_url: $image_url, name: $name, verified: $verified, created_at: $created_at, followers: $followers)';
  }
