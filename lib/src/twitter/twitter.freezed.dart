...
class _$_Profile implements _Profile {
  ...
  @override
  String toString() {
    return 'Profile(description: $description, location: $location, name: $name, username: $username, created_at: $created_at, followers: $followers, id: $id, image_url: $image_url, private: $private, verified: $verified)';
  }
