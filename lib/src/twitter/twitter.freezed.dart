...
class _$_Profile implements _Profile {
  ...
  @override
  String toString() {
    return 'Profile(private: $private, created_at: $created_at, image_url: $image_url, location: $location, name: $name, verified: $verified, description: $description, followers: $followers, id: $id, username: $username)';
  }
