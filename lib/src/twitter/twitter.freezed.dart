...
class _$_Profile implements _Profile {
  ...
  @override
  String toString() {
    return 'Profile(image_url: $image_url, name: $name, username: $username, id: $id, description: $description, followers: $followers, location: $location, private: $private, verified: $verified, created_at: $created_at)';
  }
