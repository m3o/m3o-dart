...
class _$_Profile implements _Profile {
  ...
  @override
  String toString() {
    return 'Profile(description: $description, id: $id, image_url: $image_url, location: $location, name: $name, verified: $verified, created_at: $created_at, private: $private, username: $username, followers: $followers)';
  }
