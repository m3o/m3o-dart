...
class _$_Profile implements _Profile {
  ...
  @override
  String toString() {
    return 'Profile(created_at: $created_at, description: $description, id: $id, private: $private, verified: $verified, followers: $followers, image_url: $image_url, location: $location, name: $name, username: $username)';
  }
