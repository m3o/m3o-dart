...
class _$_Profile implements _Profile {
  ...
  @override
  String toString() {
    return 'Profile(image_url: $image_url, location: $location, name: $name, private: $private, username: $username, followers: $followers, description: $description, id: $id, verified: $verified, created_at: $created_at)';
  }
