...
class _$_Profile implements _Profile {
  ...
  @override
  String toString() {
    return 'Profile(private: $private, created_at: $created_at, description: $description, followers: $followers, image_url: $image_url, name: $name, id: $id, location: $location, username: $username, verified: $verified)';
  }
