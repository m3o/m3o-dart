...
class _$_Profile implements _Profile {
  ...
  @override
  String toString() {
    return 'Profile(verified: $verified, followers: $followers, image_url: $image_url, location: $location, private: $private, username: $username, created_at: $created_at, description: $description, id: $id, name: $name)';
  }
