...
class _$_Profile implements _Profile {
  ...
  @override
  String toString() {
    return 'Profile(username: $username, created_at: $created_at, private: $private, id: $id, image_url: $image_url, location: $location, name: $name, verified: $verified, description: $description, followers: $followers)';
  }
