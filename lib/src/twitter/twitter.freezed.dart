...
class _$_Profile implements _Profile {
  ...
  @override
  String toString() {
    return 'Profile(name: $name, created_at: $created_at, followers: $followers, id: $id, location: $location, verified: $verified, description: $description, image_url: $image_url, private: $private, username: $username)';
  }
