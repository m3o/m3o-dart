...
class _$_Profile implements _Profile {
  ...
  @override
  String toString() {
    return 'Profile(created_at: $created_at, id: $id, image_url: $image_url, location: $location, name: $name, private: $private, username: $username, verified: $verified, description: $description, followers: $followers)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, created_at, id, image_url,
      location, name, private, username, verified, description, followers);
...
abstract class _Profile implements Profile {
  const factory _Profile(
      ...
      final String? description,
      @JsonKey(fromJson: int64FromString, toJson: int64ToString)
          final int? followers}) = _$_Profile;
...
class _$_Tweet implements _Tweet {
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, favourited_count, id,
      retweeted_count, text, username, created_at);
...
abstract class _Tweet implements Tweet {
  const factory _Tweet(
      ...
      final String? text,
      final String? username,
      final String? created_at}) = _$_Tweet;
