...
class _$_Profile implements _Profile {
  ...
  @override
  String toString() {
    return 'Profile(private: $private, description: $description, followers: $followers, image_url: $image_url, name: $name, username: $username, verified: $verified, created_at: $created_at, id: $id, location: $location)';
  }
