...
class _$_Profile implements _Profile {
  ...
  @override
  String toString() {
    return 'Profile(created_at: $created_at, description: $description, followers: $followers, id: $id, image_url: $image_url, verified: $verified, location: $location, name: $name, private: $private, username: $username)';
  }
