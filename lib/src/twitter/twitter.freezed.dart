...
class _$_Profile implements _Profile {
  ...
  @override
  String toString() {
    return 'Profile(id: $id, private: $private, created_at: $created_at, followers: $followers, image_url: $image_url, location: $location, name: $name, username: $username, verified: $verified, description: $description)';
  }
