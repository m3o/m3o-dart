...
class _$_Profile implements _Profile {
  ...
  @override
  String toString() {
    return 'Profile(username: $username, followers: $followers, image_url: $image_url, name: $name, location: $location, private: $private, verified: $verified, created_at: $created_at, description: $description, id: $id)';
  }
