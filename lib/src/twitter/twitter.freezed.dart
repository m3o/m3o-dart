...
class _$_Profile implements _Profile {
  ...
  @override
  String toString() {
    return 'Profile(created_at: $created_at, followers: $followers, location: $location, verified: $verified, description: $description, id: $id, image_url: $image_url, name: $name, private: $private, username: $username)';
  }
