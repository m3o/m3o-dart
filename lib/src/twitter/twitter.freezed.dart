...
class _$_Profile implements _Profile {
  ...
  @override
  String toString() {
    return 'Profile(followers: $followers, id: $id, image_url: $image_url, name: $name, verified: $verified, created_at: $created_at, description: $description, username: $username, location: $location, private: $private)';
  }
