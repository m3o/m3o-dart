...
class _$_Profile implements _Profile {
  ...
  @override
  String toString() {
    return 'Profile(created_at: $created_at, description: $description, name: $name, username: $username, followers: $followers, id: $id, image_url: $image_url, location: $location, private: $private, verified: $verified)';
  }
