...
class _$_Profile implements _Profile {
  ...
  @override
  String toString() {
    return 'Profile(image_url: $image_url, private: $private, verified: $verified, created_at: $created_at, description: $description, id: $id, username: $username, followers: $followers, location: $location, name: $name)';
  }
