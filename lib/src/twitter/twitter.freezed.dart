...
class _$_Profile implements _Profile {
  ...
  @override
  String toString() {
    return 'Profile(description: $description, id: $id, name: $name, private: $private, username: $username, created_at: $created_at, image_url: $image_url, location: $location, verified: $verified, followers: $followers)';
  }
