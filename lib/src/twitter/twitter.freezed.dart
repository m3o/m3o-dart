...
class _$_Profile implements _Profile {
  ...
  @override
  String toString() {
    return 'Profile(location: $location, username: $username, image_url: $image_url, description: $description, followers: $followers, id: $id, name: $name, private: $private, verified: $verified, created_at: $created_at)';
  }
