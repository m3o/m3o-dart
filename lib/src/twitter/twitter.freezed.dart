...
class _$_Profile implements _Profile {
  ...
  @override
  String toString() {
    return 'Profile(id: $id, location: $location, private: $private, verified: $verified, followers: $followers, description: $description, image_url: $image_url, name: $name, username: $username, created_at: $created_at)';
  }
