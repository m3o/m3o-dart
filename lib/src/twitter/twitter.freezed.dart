...
class _$_Profile implements _Profile {
  ...
  @override
  String toString() {
    return 'Profile(created_at: $created_at, location: $location, username: $username, verified: $verified, description: $description, followers: $followers, id: $id, image_url: $image_url, name: $name, private: $private)';
  }
