...
class _$_Profile implements _Profile {
  ...
  @override
  String toString() {
    return 'Profile(description: $description, image_url: $image_url, location: $location, private: $private, created_at: $created_at, id: $id, name: $name, username: $username, verified: $verified, followers: $followers)';
  }
