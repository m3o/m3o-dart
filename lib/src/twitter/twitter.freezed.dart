...
class _$_Profile implements _Profile {
  ...
  @override
  String toString() {
    return 'Profile(created_at: $created_at, description: $description, id: $id, image_url: $image_url, name: $name, verified: $verified, followers: $followers, location: $location, private: $private, username: $username)';
  }
