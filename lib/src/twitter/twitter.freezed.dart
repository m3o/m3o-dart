...
class _$_Profile implements _Profile {
  ...
  @override
  String toString() {
    return 'Profile(description: $description, image_url: $image_url, location: $location, name: $name, username: $username, created_at: $created_at, followers: $followers, id: $id, private: $private, verified: $verified)';
  }
