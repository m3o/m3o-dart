...
class _$_Profile implements _Profile {
  ...
  @override
  String toString() {
    return 'Profile(image_url: $image_url, location: $location, verified: $verified, id: $id, description: $description, followers: $followers, name: $name, private: $private, username: $username, created_at: $created_at)';
  }
