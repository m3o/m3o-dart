...
class _$_Profile implements _Profile {
  ...
  @override
  String toString() {
    return 'Profile(created_at: $created_at, description: $description, image_url: $image_url, name: $name, private: $private, username: $username, followers: $followers, id: $id, location: $location, verified: $verified)';
  }
