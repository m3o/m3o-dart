...
class _$_Profile implements _Profile {
  ...
  @override
  String toString() {
    return 'Profile(image_url: $image_url, location: $location, name: $name, username: $username, verified: $verified, created_at: $created_at, followers: $followers, id: $id, description: $description, private: $private)';
  }
