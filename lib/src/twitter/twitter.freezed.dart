...
class _$_Profile implements _Profile {
  ...
  @override
  String toString() {
    return 'Profile(verified: $verified, created_at: $created_at, followers: $followers, id: $id, image_url: $image_url, location: $location, name: $name, username: $username, description: $description, private: $private)';
  }
