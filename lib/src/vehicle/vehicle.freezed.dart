...
class _$LookupResponseData implements LookupResponseData {
  ...
  @override
  String toString() {
    return 'LookupResponse(type_approval: $type_approval, co2_emissions: $co2_emissions, engine_capacity: $engine_capacity, logo_url: $logo_url, tax_due_date: $tax_due_date, mot_status: $mot_status, wheelplan: $wheelplan, year_of_manufacture: $year_of_manufacture, colour: $colour, make: $make, month_of_first_registration: $month_of_first_registration, mot_expiry: $mot_expiry, fuel_type: $fuel_type, last_v5_issued: $last_v5_issued, registration: $registration, tax_status: $tax_status)';
  }
