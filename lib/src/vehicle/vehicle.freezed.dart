...
class _$LookupResponseData implements LookupResponseData {
  ...
  @override
  String toString() {
    return 'LookupResponse(fuel_type: $fuel_type, mot_expiry: $mot_expiry, type_approval: $type_approval, co2_emissions: $co2_emissions, last_v5_issued: $last_v5_issued, month_of_first_registration: $month_of_first_registration, registration: $registration, colour: $colour, engine_capacity: $engine_capacity, make: $make, tax_due_date: $tax_due_date, wheelplan: $wheelplan, year_of_manufacture: $year_of_manufacture, logo_url: $logo_url, mot_status: $mot_status, tax_status: $tax_status)';
  }
