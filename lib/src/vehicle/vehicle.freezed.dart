...
class _$LookupResponseData implements LookupResponseData {
  ...
  @override
  String toString() {
    return 'LookupResponse(make: $make, tax_status: $tax_status, type_approval: $type_approval, wheelplan: $wheelplan, colour: $colour, last_v5_issued: $last_v5_issued, mot_expiry: $mot_expiry, engine_capacity: $engine_capacity, logo_url: $logo_url, tax_due_date: $tax_due_date, year_of_manufacture: $year_of_manufacture, mot_status: $mot_status, registration: $registration, month_of_first_registration: $month_of_first_registration, co2_emissions: $co2_emissions, fuel_type: $fuel_type)';
  }
