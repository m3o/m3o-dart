...
class _$LookupResponseData implements LookupResponseData {
  ...
  @override
  String toString() {
    return 'LookupResponse(last_v5_issued: $last_v5_issued, wheelplan: $wheelplan, logo_url: $logo_url, mot_expiry: $mot_expiry, mot_status: $mot_status, registration: $registration, tax_due_date: $tax_due_date, co2_emissions: $co2_emissions, engine_capacity: $engine_capacity, fuel_type: $fuel_type, year_of_manufacture: $year_of_manufacture, colour: $colour, make: $make, tax_status: $tax_status, month_of_first_registration: $month_of_first_registration, type_approval: $type_approval)';
  }
