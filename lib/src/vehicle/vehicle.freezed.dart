...
class _$LookupResponseData implements LookupResponseData {
  ...
  @override
  String toString() {
    return 'LookupResponse(fuel_type: $fuel_type, mot_status: $mot_status, tax_due_date: $tax_due_date, tax_status: $tax_status, type_approval: $type_approval, engine_capacity: $engine_capacity, make: $make, mot_expiry: $mot_expiry, logo_url: $logo_url, month_of_first_registration: $month_of_first_registration, registration: $registration, wheelplan: $wheelplan, year_of_manufacture: $year_of_manufacture, colour: $colour, last_v5_issued: $last_v5_issued, co2_emissions: $co2_emissions)';
  }
