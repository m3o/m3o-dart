...
class _$LookupResponseData implements LookupResponseData {
  ...
  @override
  String toString() {
    return 'LookupResponse(last_v5_issued: $last_v5_issued, make: $make, month_of_first_registration: $month_of_first_registration, registration: $registration, tax_due_date: $tax_due_date, engine_capacity: $engine_capacity, mot_status: $mot_status, wheelplan: $wheelplan, fuel_type: $fuel_type, tax_status: $tax_status, co2_emissions: $co2_emissions, logo_url: $logo_url, mot_expiry: $mot_expiry, type_approval: $type_approval, year_of_manufacture: $year_of_manufacture, colour: $colour)';
  }
