...
class _$LookupResponseData implements LookupResponseData {
  ...
  @override
  String toString() {
    return 'LookupResponse(wheelplan: $wheelplan, year_of_manufacture: $year_of_manufacture, co2_emissions: $co2_emissions, month_of_first_registration: $month_of_first_registration, registration: $registration, type_approval: $type_approval, colour: $colour, tax_status: $tax_status, fuel_type: $fuel_type, make: $make, mot_expiry: $mot_expiry, mot_status: $mot_status, engine_capacity: $engine_capacity, last_v5_issued: $last_v5_issued, logo_url: $logo_url, tax_due_date: $tax_due_date)';
  }
