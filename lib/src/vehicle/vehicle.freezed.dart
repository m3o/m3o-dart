...
class _$LookupResponseData implements LookupResponseData {
  ...
  @override
  String toString() {
    return 'LookupResponse(tax_due_date: $tax_due_date, year_of_manufacture: $year_of_manufacture, logo_url: $logo_url, make: $make, engine_capacity: $engine_capacity, last_v5_issued: $last_v5_issued, month_of_first_registration: $month_of_first_registration, mot_expiry: $mot_expiry, type_approval: $type_approval, wheelplan: $wheelplan, colour: $colour, fuel_type: $fuel_type, mot_status: $mot_status, registration: $registration, tax_status: $tax_status, co2_emissions: $co2_emissions)';
  }
