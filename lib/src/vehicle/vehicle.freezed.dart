...
class _$LookupResponseData implements LookupResponseData {
  ...
  @override
  String toString() {
    return 'LookupResponse(colour: $colour, fuel_type: $fuel_type, mot_status: $mot_status, tax_status: $tax_status, year_of_manufacture: $year_of_manufacture, month_of_first_registration: $month_of_first_registration, registration: $registration, wheelplan: $wheelplan, engine_capacity: $engine_capacity, make: $make, tax_due_date: $tax_due_date, co2_emissions: $co2_emissions, last_v5_issued: $last_v5_issued, logo_url: $logo_url, mot_expiry: $mot_expiry, type_approval: $type_approval)';
  }
