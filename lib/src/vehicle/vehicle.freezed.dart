...
class _$LookupResponseData implements LookupResponseData {
  ...
  @override
  String toString() {
    return 'LookupResponse(co2_emissions: $co2_emissions, month_of_first_registration: $month_of_first_registration, mot_status: $mot_status, last_v5_issued: $last_v5_issued, make: $make, registration: $registration, tax_due_date: $tax_due_date, engine_capacity: $engine_capacity, tax_status: $tax_status, type_approval: $type_approval, year_of_manufacture: $year_of_manufacture, colour: $colour, fuel_type: $fuel_type, logo_url: $logo_url, mot_expiry: $mot_expiry, wheelplan: $wheelplan)';
  }
