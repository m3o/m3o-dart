...
class _$LookupResponseData implements LookupResponseData {
  ...
  @override
  String toString() {
    return 'LookupResponse(type_approval: $type_approval, year_of_manufacture: $year_of_manufacture, month_of_first_registration: $month_of_first_registration, tax_due_date: $tax_due_date, wheelplan: $wheelplan, co2_emissions: $co2_emissions, last_v5_issued: $last_v5_issued, make: $make, tax_status: $tax_status, engine_capacity: $engine_capacity, logo_url: $logo_url, mot_expiry: $mot_expiry, mot_status: $mot_status, registration: $registration, colour: $colour, fuel_type: $fuel_type)';
  }
