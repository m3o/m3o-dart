...
class _$LookupResponseData implements LookupResponseData {
  ...
  @override
  String toString() {
    return 'LookupResponse(colour: $colour, engine_capacity: $engine_capacity, logo_url: $logo_url, co2_emissions: $co2_emissions, fuel_type: $fuel_type, last_v5_issued: $last_v5_issued, make: $make, month_of_first_registration: $month_of_first_registration, mot_status: $mot_status, registration: $registration, mot_expiry: $mot_expiry, type_approval: $type_approval, year_of_manufacture: $year_of_manufacture, tax_due_date: $tax_due_date, tax_status: $tax_status, wheelplan: $wheelplan)';
  }
