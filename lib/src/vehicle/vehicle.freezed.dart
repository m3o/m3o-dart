...
class _$LookupResponseData implements LookupResponseData {
  ...
  @override
  String toString() {
    return 'LookupResponse(engine_capacity: $engine_capacity, last_v5_issued: $last_v5_issued, year_of_manufacture: $year_of_manufacture, co2_emissions: $co2_emissions, fuel_type: $fuel_type, month_of_first_registration: $month_of_first_registration, mot_expiry: $mot_expiry, registration: $registration, tax_due_date: $tax_due_date, tax_status: $tax_status, colour: $colour, logo_url: $logo_url, make: $make, mot_status: $mot_status, type_approval: $type_approval, wheelplan: $wheelplan)';
  }
