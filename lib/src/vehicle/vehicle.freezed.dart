...
class _$LookupResponseData implements LookupResponseData {
  ...
  @override
  String toString() {
    return 'LookupResponse(tax_status: $tax_status, mot_status: $mot_status, tax_due_date: $tax_due_date, make: $make, mot_expiry: $mot_expiry, registration: $registration, fuel_type: $fuel_type, last_v5_issued: $last_v5_issued, engine_capacity: $engine_capacity, type_approval: $type_approval, year_of_manufacture: $year_of_manufacture, co2_emissions: $co2_emissions, colour: $colour, wheelplan: $wheelplan, logo_url: $logo_url, month_of_first_registration: $month_of_first_registration)';
  }
