...
class _$LookupResponseData implements LookupResponseData {
  ...
  @override
  String toString() {
    return 'LookupResponse(tax_due_date: $tax_due_date, tax_status: $tax_status, type_approval: $type_approval, co2_emissions: $co2_emissions, fuel_type: $fuel_type, logo_url: $logo_url, mot_status: $mot_status, year_of_manufacture: $year_of_manufacture, engine_capacity: $engine_capacity, month_of_first_registration: $month_of_first_registration, wheelplan: $wheelplan, mot_expiry: $mot_expiry, registration: $registration, colour: $colour, last_v5_issued: $last_v5_issued, make: $make)';
  }
...
abstract class LookupResponseData implements LookupResponse {
  const factory LookupResponseData(
      ...
      final String? colour,
      final String? last_v5_issued,
      final String? make}) = _$LookupResponseData;
