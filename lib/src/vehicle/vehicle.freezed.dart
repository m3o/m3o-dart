...
class _$LookupResponseData implements LookupResponseData {
  ...
  @override
  String toString() {
    return 'LookupResponse(month_of_first_registration: $month_of_first_registration, co2_emissions: $co2_emissions, registration: $registration, year_of_manufacture: $year_of_manufacture, mot_expiry: $mot_expiry, mot_status: $mot_status, tax_status: $tax_status, type_approval: $type_approval, wheelplan: $wheelplan, colour: $colour, engine_capacity: $engine_capacity, make: $make, tax_due_date: $tax_due_date, fuel_type: $fuel_type, last_v5_issued: $last_v5_issued, logo_url: $logo_url)';
  }
