...
class _$LookupResponseData implements LookupResponseData {
  ...
  @override
  String toString() {
    return 'LookupResponse(tax_due_date: $tax_due_date, colour: $colour, engine_capacity: $engine_capacity, make: $make, month_of_first_registration: $month_of_first_registration, mot_status: $mot_status, registration: $registration, co2_emissions: $co2_emissions, tax_status: $tax_status, year_of_manufacture: $year_of_manufacture, fuel_type: $fuel_type, type_approval: $type_approval, wheelplan: $wheelplan, last_v5_issued: $last_v5_issued, logo_url: $logo_url, mot_expiry: $mot_expiry)';
  }
