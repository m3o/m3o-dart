...
class _$LookupResponseData implements LookupResponseData {
  ...
  @override
  String toString() {
    return 'LookupResponse(fuel_type: $fuel_type, registration: $registration, tax_due_date: $tax_due_date, mot_status: $mot_status, co2_emissions: $co2_emissions, last_v5_issued: $last_v5_issued, logo_url: $logo_url, mot_expiry: $mot_expiry, type_approval: $type_approval, year_of_manufacture: $year_of_manufacture, engine_capacity: $engine_capacity, make: $make, month_of_first_registration: $month_of_first_registration, tax_status: $tax_status, colour: $colour, wheelplan: $wheelplan)';
  }
