...
class _$LookupResponseData implements LookupResponseData {
  ...
  @override
  String toString() {
    return 'LookupResponse(co2_emissions: $co2_emissions, engine_capacity: $engine_capacity, logo_url: $logo_url, registration: $registration, tax_due_date: $tax_due_date, colour: $colour, month_of_first_registration: $month_of_first_registration, year_of_manufacture: $year_of_manufacture, fuel_type: $fuel_type, last_v5_issued: $last_v5_issued, make: $make, mot_expiry: $mot_expiry, mot_status: $mot_status, tax_status: $tax_status, type_approval: $type_approval, wheelplan: $wheelplan)';
  }
