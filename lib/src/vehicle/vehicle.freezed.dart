...
class _$LookupResponseData implements LookupResponseData {
  ...
  @override
  String toString() {
    return 'LookupResponse(colour: $colour, last_v5_issued: $last_v5_issued, logo_url: $logo_url, mot_status: $mot_status, type_approval: $type_approval, engine_capacity: $engine_capacity, fuel_type: $fuel_type, mot_expiry: $mot_expiry, wheelplan: $wheelplan, co2_emissions: $co2_emissions, month_of_first_registration: $month_of_first_registration, registration: $registration, tax_due_date: $tax_due_date, tax_status: $tax_status, year_of_manufacture: $year_of_manufacture, make: $make)';
  }
