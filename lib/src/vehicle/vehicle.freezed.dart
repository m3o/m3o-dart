...
class _$LookupResponseData implements LookupResponseData {
  ...
  @override
  String toString() {
    return 'LookupResponse(make: $make, registration: $registration, mot_status: $mot_status, tax_due_date: $tax_due_date, wheelplan: $wheelplan, co2_emissions: $co2_emissions, logo_url: $logo_url, last_v5_issued: $last_v5_issued, month_of_first_registration: $month_of_first_registration, mot_expiry: $mot_expiry, type_approval: $type_approval, year_of_manufacture: $year_of_manufacture, engine_capacity: $engine_capacity, fuel_type: $fuel_type, colour: $colour, tax_status: $tax_status)';
  }
