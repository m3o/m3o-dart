...
class _$LookupResponseData implements LookupResponseData {
  ...
  @override
  String toString() {
    return 'LookupResponse(engine_capacity: $engine_capacity, registration: $registration, year_of_manufacture: $year_of_manufacture, colour: $colour, logo_url: $logo_url, tax_due_date: $tax_due_date, tax_status: $tax_status, month_of_first_registration: $month_of_first_registration, type_approval: $type_approval, co2_emissions: $co2_emissions, fuel_type: $fuel_type, last_v5_issued: $last_v5_issued, make: $make, mot_expiry: $mot_expiry, mot_status: $mot_status, wheelplan: $wheelplan)';
  }
