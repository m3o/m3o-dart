...
class _$LookupResponseData implements LookupResponseData {
  ...
  @override
  String toString() {
    return 'LookupResponse(month_of_first_registration: $month_of_first_registration, wheelplan: $wheelplan, fuel_type: $fuel_type, engine_capacity: $engine_capacity, logo_url: $logo_url, make: $make, mot_expiry: $mot_expiry, registration: $registration, co2_emissions: $co2_emissions, mot_status: $mot_status, tax_due_date: $tax_due_date, type_approval: $type_approval, last_v5_issued: $last_v5_issued, tax_status: $tax_status, year_of_manufacture: $year_of_manufacture, colour: $colour)';
  }
