...
class _$LookupResponseData implements LookupResponseData {
  ...
  @override
  String toString() {
    return 'LookupResponse(mot_status: $mot_status, type_approval: $type_approval, year_of_manufacture: $year_of_manufacture, fuel_type: $fuel_type, month_of_first_registration: $month_of_first_registration, make: $make, registration: $registration, wheelplan: $wheelplan, co2_emissions: $co2_emissions, colour: $colour, logo_url: $logo_url, mot_expiry: $mot_expiry, tax_due_date: $tax_due_date, engine_capacity: $engine_capacity, last_v5_issued: $last_v5_issued, tax_status: $tax_status)';
  }
