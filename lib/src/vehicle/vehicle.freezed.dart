...
class _$LookupResponseData implements LookupResponseData {
  ...
  @override
  String toString() {
    return 'LookupResponse(co2_emissions: $co2_emissions, last_v5_issued: $last_v5_issued, month_of_first_registration: $month_of_first_registration, tax_due_date: $tax_due_date, type_approval: $type_approval, wheelplan: $wheelplan, fuel_type: $fuel_type, logo_url: $logo_url, registration: $registration, year_of_manufacture: $year_of_manufacture, engine_capacity: $engine_capacity, mot_expiry: $mot_expiry, mot_status: $mot_status, tax_status: $tax_status, colour: $colour, make: $make)';
  }
