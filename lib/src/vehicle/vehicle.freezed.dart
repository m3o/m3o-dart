...
class _$LookupResponseData implements LookupResponseData {
  ...
  @override
  String toString() {
    return 'LookupResponse(engine_capacity: $engine_capacity, mot_expiry: $mot_expiry, co2_emissions: $co2_emissions, last_v5_issued: $last_v5_issued, month_of_first_registration: $month_of_first_registration, make: $make, registration: $registration, tax_due_date: $tax_due_date, tax_status: $tax_status, year_of_manufacture: $year_of_manufacture, colour: $colour, fuel_type: $fuel_type, logo_url: $logo_url, mot_status: $mot_status, type_approval: $type_approval, wheelplan: $wheelplan)';
  }
