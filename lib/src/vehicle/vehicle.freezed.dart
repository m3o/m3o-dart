...
class _$LookupResponseData implements LookupResponseData {
  ...
  @override
  String toString() {
    return 'LookupResponse(fuel_type: $fuel_type, logo_url: $logo_url, month_of_first_registration: $month_of_first_registration, tax_status: $tax_status, colour: $colour, engine_capacity: $engine_capacity, registration: $registration, wheelplan: $wheelplan, last_v5_issued: $last_v5_issued, mot_expiry: $mot_expiry, type_approval: $type_approval, year_of_manufacture: $year_of_manufacture, co2_emissions: $co2_emissions, make: $make, mot_status: $mot_status, tax_due_date: $tax_due_date)';
  }
