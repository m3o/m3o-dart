...
class _$LookupResponseData implements LookupResponseData {
  ...
  @override
  String toString() {
    return 'LookupResponse(year_of_manufacture: $year_of_manufacture, co2_emissions: $co2_emissions, colour: $colour, fuel_type: $fuel_type, tax_due_date: $tax_due_date, type_approval: $type_approval, mot_expiry: $mot_expiry, tax_status: $tax_status, engine_capacity: $engine_capacity, logo_url: $logo_url, make: $make, mot_status: $mot_status, registration: $registration, last_v5_issued: $last_v5_issued, month_of_first_registration: $month_of_first_registration, wheelplan: $wheelplan)';
  }
