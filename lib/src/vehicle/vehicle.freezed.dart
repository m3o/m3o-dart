...
class _$LookupResponseData implements LookupResponseData {
  ...
  @override
  String toString() {
    return 'LookupResponse(registration: $registration, co2_emissions: $co2_emissions, colour: $colour, engine_capacity: $engine_capacity, make: $make, last_v5_issued: $last_v5_issued, month_of_first_registration: $month_of_first_registration, mot_status: $mot_status, tax_status: $tax_status, year_of_manufacture: $year_of_manufacture, type_approval: $type_approval, wheelplan: $wheelplan, fuel_type: $fuel_type, logo_url: $logo_url, mot_expiry: $mot_expiry, tax_due_date: $tax_due_date)';
  }
