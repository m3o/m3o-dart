...
class _$LookupResponseData implements LookupResponseData {
  ...
  @override
  String toString() {
    return 'LookupResponse(type_approval: $type_approval, colour: $colour, month_of_first_registration: $month_of_first_registration, mot_status: $mot_status, registration: $registration, logo_url: $logo_url, mot_expiry: $mot_expiry, fuel_type: $fuel_type, make: $make, co2_emissions: $co2_emissions, engine_capacity: $engine_capacity, tax_status: $tax_status, wheelplan: $wheelplan, year_of_manufacture: $year_of_manufacture, last_v5_issued: $last_v5_issued, tax_due_date: $tax_due_date)';
  }
