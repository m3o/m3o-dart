...
class _$LookupResponseData implements LookupResponseData {
  ...
  @override
  String toString() {
    return 'LookupResponse(engine_capacity: $engine_capacity, fuel_type: $fuel_type, make: $make, mot_status: $mot_status, registration: $registration, co2_emissions: $co2_emissions, month_of_first_registration: $month_of_first_registration, tax_status: $tax_status, year_of_manufacture: $year_of_manufacture, last_v5_issued: $last_v5_issued, logo_url: $logo_url, type_approval: $type_approval, wheelplan: $wheelplan, colour: $colour, mot_expiry: $mot_expiry, tax_due_date: $tax_due_date)';
  }
