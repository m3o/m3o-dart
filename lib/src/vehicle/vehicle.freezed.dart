...
class _$LookupResponseData implements LookupResponseData {
  ...
  @override
  String toString() {
    return 'LookupResponse(co2_emissions: $co2_emissions, colour: $colour, engine_capacity: $engine_capacity, registration: $registration, type_approval: $type_approval, fuel_type: $fuel_type, last_v5_issued: $last_v5_issued, month_of_first_registration: $month_of_first_registration, tax_status: $tax_status, make: $make, mot_expiry: $mot_expiry, mot_status: $mot_status, logo_url: $logo_url, tax_due_date: $tax_due_date, wheelplan: $wheelplan, year_of_manufacture: $year_of_manufacture)';
  }
