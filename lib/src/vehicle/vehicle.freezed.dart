...
class _$LookupResponseData implements LookupResponseData {
  ...
  @override
  String toString() {
    return 'LookupResponse(co2_emissions: $co2_emissions, engine_capacity: $engine_capacity, registration: $registration, colour: $colour, logo_url: $logo_url, type_approval: $type_approval, wheelplan: $wheelplan, fuel_type: $fuel_type, mot_expiry: $mot_expiry, tax_due_date: $tax_due_date, tax_status: $tax_status, year_of_manufacture: $year_of_manufacture, last_v5_issued: $last_v5_issued, make: $make, month_of_first_registration: $month_of_first_registration, mot_status: $mot_status)';
  }
