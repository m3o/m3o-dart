...
class _$LookupResponseData implements LookupResponseData {
  ...
  @override
  String toString() {
    return 'LookupResponse(month_of_first_registration: $month_of_first_registration, mot_status: $mot_status, engine_capacity: $engine_capacity, make: $make, type_approval: $type_approval, colour: $colour, fuel_type: $fuel_type, last_v5_issued: $last_v5_issued, tax_due_date: $tax_due_date, tax_status: $tax_status, co2_emissions: $co2_emissions, mot_expiry: $mot_expiry, registration: $registration, wheelplan: $wheelplan, year_of_manufacture: $year_of_manufacture, logo_url: $logo_url)';
  }
