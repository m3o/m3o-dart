...
class _$LookupResponseData implements LookupResponseData {
  ...
  @override
  String toString() {
    return 'LookupResponse(wheelplan: $wheelplan, colour: $colour, logo_url: $logo_url, mot_expiry: $mot_expiry, tax_due_date: $tax_due_date, make: $make, tax_status: $tax_status, year_of_manufacture: $year_of_manufacture, co2_emissions: $co2_emissions, engine_capacity: $engine_capacity, fuel_type: $fuel_type, last_v5_issued: $last_v5_issued, mot_status: $mot_status, registration: $registration, type_approval: $type_approval, month_of_first_registration: $month_of_first_registration)';
  }
