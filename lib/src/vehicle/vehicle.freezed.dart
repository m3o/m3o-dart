...
class _$LookupResponseData implements LookupResponseData {
  ...
  @override
  String toString() {
    return 'LookupResponse(fuel_type: $fuel_type, last_v5_issued: $last_v5_issued, make: $make, month_of_first_registration: $month_of_first_registration, tax_due_date: $tax_due_date, colour: $colour, engine_capacity: $engine_capacity, type_approval: $type_approval, year_of_manufacture: $year_of_manufacture, mot_expiry: $mot_expiry, tax_status: $tax_status, mot_status: $mot_status, registration: $registration, wheelplan: $wheelplan, co2_emissions: $co2_emissions, logo_url: $logo_url)';
  }
