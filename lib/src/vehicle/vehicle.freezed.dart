...
class _$LookupResponseData implements LookupResponseData {
  ...
  @override
  String toString() {
    return 'LookupResponse(mot_expiry: $mot_expiry, tax_due_date: $tax_due_date, tax_status: $tax_status, co2_emissions: $co2_emissions, fuel_type: $fuel_type, logo_url: $logo_url, make: $make, last_v5_issued: $last_v5_issued, wheelplan: $wheelplan, year_of_manufacture: $year_of_manufacture, colour: $colour, registration: $registration, engine_capacity: $engine_capacity, month_of_first_registration: $month_of_first_registration, mot_status: $mot_status, type_approval: $type_approval)';
  }
