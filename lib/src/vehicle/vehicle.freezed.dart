...
class _$LookupResponseData implements LookupResponseData {
  ...
  @override
  String toString() {
    return 'LookupResponse(colour: $colour, logo_url: $logo_url, mot_expiry: $mot_expiry, mot_status: $mot_status, fuel_type: $fuel_type, tax_status: $tax_status, type_approval: $type_approval, co2_emissions: $co2_emissions, engine_capacity: $engine_capacity, last_v5_issued: $last_v5_issued, make: $make, month_of_first_registration: $month_of_first_registration, tax_due_date: $tax_due_date, wheelplan: $wheelplan, year_of_manufacture: $year_of_manufacture, registration: $registration)';
  }
