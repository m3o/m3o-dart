...
class _$LookupResponseData implements LookupResponseData {
  ...
  @override
  String toString() {
    return 'LookupResponse(co2_emissions: $co2_emissions, year_of_manufacture: $year_of_manufacture, tax_due_date: $tax_due_date, tax_status: $tax_status, wheelplan: $wheelplan, engine_capacity: $engine_capacity, month_of_first_registration: $month_of_first_registration, mot_status: $mot_status, make: $make, colour: $colour, fuel_type: $fuel_type, last_v5_issued: $last_v5_issued, type_approval: $type_approval, logo_url: $logo_url, mot_expiry: $mot_expiry, registration: $registration)';
  }
