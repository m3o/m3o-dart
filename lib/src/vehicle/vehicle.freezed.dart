...
class _$LookupResponseData implements LookupResponseData {
  ...
  @override
  String toString() {
    return 'LookupResponse(co2_emissions: $co2_emissions, mot_expiry: $mot_expiry, mot_status: $mot_status, tax_due_date: $tax_due_date, tax_status: $tax_status, colour: $colour, engine_capacity: $engine_capacity, fuel_type: $fuel_type, logo_url: $logo_url, month_of_first_registration: $month_of_first_registration, type_approval: $type_approval, last_v5_issued: $last_v5_issued, make: $make, registration: $registration, wheelplan: $wheelplan, year_of_manufacture: $year_of_manufacture)';
  }
