...
class _$LookupResponseData implements LookupResponseData {
  ...
  @override
  String toString() {
    return 'LookupResponse(engine_capacity: $engine_capacity, mot_expiry: $mot_expiry, registration: $registration, year_of_manufacture: $year_of_manufacture, co2_emissions: $co2_emissions, colour: $colour, logo_url: $logo_url, make: $make, tax_status: $tax_status, last_v5_issued: $last_v5_issued, mot_status: $mot_status, tax_due_date: $tax_due_date, type_approval: $type_approval, wheelplan: $wheelplan, fuel_type: $fuel_type, month_of_first_registration: $month_of_first_registration)';
  }
