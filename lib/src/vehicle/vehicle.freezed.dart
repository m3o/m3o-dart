...
class _$LookupResponseData implements LookupResponseData {
  ...
  @override
  String toString() {
    return 'LookupResponse(engine_capacity: $engine_capacity, last_v5_issued: $last_v5_issued, month_of_first_registration: $month_of_first_registration, mot_expiry: $mot_expiry, co2_emissions: $co2_emissions, fuel_type: $fuel_type, make: $make, mot_status: $mot_status, tax_status: $tax_status, colour: $colour, tax_due_date: $tax_due_date, wheelplan: $wheelplan, year_of_manufacture: $year_of_manufacture, logo_url: $logo_url, registration: $registration, type_approval: $type_approval)';
  }
