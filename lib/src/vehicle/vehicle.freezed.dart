...
class _$LookupResponseData implements LookupResponseData {
  ...
  @override
  String toString() {
    return 'LookupResponse(co2_emissions: $co2_emissions, fuel_type: $fuel_type, make: $make, mot_expiry: $mot_expiry, engine_capacity: $engine_capacity, last_v5_issued: $last_v5_issued, logo_url: $logo_url, registration: $registration, year_of_manufacture: $year_of_manufacture, colour: $colour, month_of_first_registration: $month_of_first_registration, mot_status: $mot_status, tax_due_date: $tax_due_date, tax_status: $tax_status, type_approval: $type_approval, wheelplan: $wheelplan)';
  }
