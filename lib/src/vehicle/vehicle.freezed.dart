...
class _$LookupResponseData implements LookupResponseData {
  ...
  @override
  String toString() {
    return 'LookupResponse(co2_emissions: $co2_emissions, colour: $colour, logo_url: $logo_url, mot_expiry: $mot_expiry, registration: $registration, tax_due_date: $tax_due_date, tax_status: $tax_status, last_v5_issued: $last_v5_issued, month_of_first_registration: $month_of_first_registration, type_approval: $type_approval, fuel_type: $fuel_type, make: $make, engine_capacity: $engine_capacity, mot_status: $mot_status, wheelplan: $wheelplan, year_of_manufacture: $year_of_manufacture)';
  }
