...
class _$LookupResponseData implements LookupResponseData {
  ...
  @override
  String toString() {
    return 'LookupResponse(last_v5_issued: $last_v5_issued, month_of_first_registration: $month_of_first_registration, mot_status: $mot_status, wheelplan: $wheelplan, co2_emissions: $co2_emissions, colour: $colour, tax_status: $tax_status, engine_capacity: $engine_capacity, fuel_type: $fuel_type, mot_expiry: $mot_expiry, tax_due_date: $tax_due_date, type_approval: $type_approval, year_of_manufacture: $year_of_manufacture, logo_url: $logo_url, make: $make, registration: $registration)';
  }
