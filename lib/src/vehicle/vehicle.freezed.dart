...
class _$LookupResponseData implements LookupResponseData {
  ...
  @override
  String toString() {
    return 'LookupResponse(mot_expiry: $mot_expiry, mot_status: $mot_status, tax_status: $tax_status, colour: $colour, engine_capacity: $engine_capacity, fuel_type: $fuel_type, co2_emissions: $co2_emissions, month_of_first_registration: $month_of_first_registration, registration: $registration, tax_due_date: $tax_due_date, type_approval: $type_approval, year_of_manufacture: $year_of_manufacture, wheelplan: $wheelplan, last_v5_issued: $last_v5_issued, logo_url: $logo_url, make: $make)';
  }
