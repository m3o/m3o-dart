...
class _$LookupResponseData implements LookupResponseData {
  ...
  @override
  String toString() {
    return 'LookupResponse(mot_status: $mot_status, registration: $registration, tax_status: $tax_status, co2_emissions: $co2_emissions, logo_url: $logo_url, month_of_first_registration: $month_of_first_registration, mot_expiry: $mot_expiry, fuel_type: $fuel_type, type_approval: $type_approval, engine_capacity: $engine_capacity, last_v5_issued: $last_v5_issued, make: $make, tax_due_date: $tax_due_date, colour: $colour, wheelplan: $wheelplan, year_of_manufacture: $year_of_manufacture)';
  }
