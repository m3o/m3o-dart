...
class _$LookupResponseData implements LookupResponseData {
  ...
  @override
  String toString() {
    return 'LookupResponse(last_v5_issued: $last_v5_issued, logo_url: $logo_url, tax_due_date: $tax_due_date, type_approval: $type_approval, year_of_manufacture: $year_of_manufacture, colour: $colour, fuel_type: $fuel_type, mot_expiry: $mot_expiry, registration: $registration, co2_emissions: $co2_emissions, engine_capacity: $engine_capacity, make: $make, tax_status: $tax_status, month_of_first_registration: $month_of_first_registration, mot_status: $mot_status, wheelplan: $wheelplan)';
  }
