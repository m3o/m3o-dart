...
class _$LookupResponseData implements LookupResponseData {
  ...
  @override
  String toString() {
    return 'LookupResponse(fuel_type: $fuel_type, last_v5_issued: $last_v5_issued, month_of_first_registration: $month_of_first_registration, mot_status: $mot_status, year_of_manufacture: $year_of_manufacture, logo_url: $logo_url, make: $make, registration: $registration, co2_emissions: $co2_emissions, colour: $colour, type_approval: $type_approval, wheelplan: $wheelplan, engine_capacity: $engine_capacity, mot_expiry: $mot_expiry, tax_due_date: $tax_due_date, tax_status: $tax_status)';
  }
