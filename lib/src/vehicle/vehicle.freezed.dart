...
class _$LookupResponseData implements LookupResponseData {
  ...
  @override
  String toString() {
    return 'LookupResponse(colour: $colour, logo_url: $logo_url, tax_due_date: $tax_due_date, year_of_manufacture: $year_of_manufacture, co2_emissions: $co2_emissions, tax_status: $tax_status, type_approval: $type_approval, fuel_type: $fuel_type, mot_expiry: $mot_expiry, wheelplan: $wheelplan, engine_capacity: $engine_capacity, last_v5_issued: $last_v5_issued, make: $make, month_of_first_registration: $month_of_first_registration, mot_status: $mot_status, registration: $registration)';
  }
