...
class _$LookupResponseData implements LookupResponseData {
  ...
  @override
  String toString() {
    return 'LookupResponse(registration: $registration, wheelplan: $wheelplan, year_of_manufacture: $year_of_manufacture, engine_capacity: $engine_capacity, month_of_first_registration: $month_of_first_registration, type_approval: $type_approval, last_v5_issued: $last_v5_issued, logo_url: $logo_url, mot_expiry: $mot_expiry, mot_status: $mot_status, tax_due_date: $tax_due_date, fuel_type: $fuel_type, make: $make, tax_status: $tax_status, co2_emissions: $co2_emissions, colour: $colour)';
  }
