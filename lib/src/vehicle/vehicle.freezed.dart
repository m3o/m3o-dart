...
class _$LookupResponseData implements LookupResponseData {
  ...
  @override
  String toString() {
    return 'LookupResponse(logo_url: $logo_url, make: $make, mot_status: $mot_status, registration: $registration, co2_emissions: $co2_emissions, engine_capacity: $engine_capacity, type_approval: $type_approval, colour: $colour, wheelplan: $wheelplan, last_v5_issued: $last_v5_issued, month_of_first_registration: $month_of_first_registration, mot_expiry: $mot_expiry, tax_due_date: $tax_due_date, tax_status: $tax_status, year_of_manufacture: $year_of_manufacture, fuel_type: $fuel_type)';
  }
...
abstract class LookupResponseData implements LookupResponse {
  const factory LookupResponseData(
      ...
      final String? tax_status,
      final int? year_of_manufacture,
      final String? fuel_type}) = _$LookupResponseData;
