...
class _$LookupResponseData implements LookupResponseData {
  ...
  @override
  String toString() {
    return 'LookupResponse(co2_emissions: $co2_emissions, fuel_type: $fuel_type, logo_url: $logo_url, month_of_first_registration: $month_of_first_registration, registration: $registration, tax_status: $tax_status, last_v5_issued: $last_v5_issued, make: $make, tax_due_date: $tax_due_date, colour: $colour, engine_capacity: $engine_capacity, mot_expiry: $mot_expiry, type_approval: $type_approval, year_of_manufacture: $year_of_manufacture, mot_status: $mot_status, wheelplan: $wheelplan)';
  }
