...
class _$LookupResponseData implements LookupResponseData {
  ...
  @override
  String toString() {
    return 'LookupResponse(co2_emissions: $co2_emissions, colour: $colour, mot_expiry: $mot_expiry, wheelplan: $wheelplan, engine_capacity: $engine_capacity, last_v5_issued: $last_v5_issued, logo_url: $logo_url, mot_status: $mot_status, type_approval: $type_approval, fuel_type: $fuel_type, make: $make, registration: $registration, month_of_first_registration: $month_of_first_registration, tax_due_date: $tax_due_date, tax_status: $tax_status, year_of_manufacture: $year_of_manufacture)';
  }
