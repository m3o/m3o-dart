...
class _$LookupResponseData implements LookupResponseData {
  ...
  @override
  String toString() {
    return 'LookupResponse(make: $make, engine_capacity: $engine_capacity, logo_url: $logo_url, month_of_first_registration: $month_of_first_registration, year_of_manufacture: $year_of_manufacture, fuel_type: $fuel_type, last_v5_issued: $last_v5_issued, registration: $registration, tax_due_date: $tax_due_date, tax_status: $tax_status, type_approval: $type_approval, wheelplan: $wheelplan, co2_emissions: $co2_emissions, mot_expiry: $mot_expiry, mot_status: $mot_status, colour: $colour)';
  }
