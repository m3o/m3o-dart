...
class _$LookupResponseData implements LookupResponseData {
  ...
  @override
  String toString() {
    return 'LookupResponse(fuel_type: $fuel_type, tax_due_date: $tax_due_date, tax_status: $tax_status, mot_status: $mot_status, type_approval: $type_approval, colour: $colour, engine_capacity: $engine_capacity, logo_url: $logo_url, make: $make, registration: $registration, wheelplan: $wheelplan, year_of_manufacture: $year_of_manufacture, co2_emissions: $co2_emissions, last_v5_issued: $last_v5_issued, month_of_first_registration: $month_of_first_registration, mot_expiry: $mot_expiry)';
  }
