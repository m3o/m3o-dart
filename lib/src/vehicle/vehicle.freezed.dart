...
class _$LookupResponseData implements LookupResponseData {
  ...
  @override
  String toString() {
    return 'LookupResponse(month_of_first_registration: $month_of_first_registration, tax_status: $tax_status, engine_capacity: $engine_capacity, fuel_type: $fuel_type, last_v5_issued: $last_v5_issued, mot_status: $mot_status, wheelplan: $wheelplan, year_of_manufacture: $year_of_manufacture, co2_emissions: $co2_emissions, logo_url: $logo_url, registration: $registration, colour: $colour, mot_expiry: $mot_expiry, tax_due_date: $tax_due_date, type_approval: $type_approval, make: $make)';
  }
