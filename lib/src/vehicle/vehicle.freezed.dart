...
class _$LookupResponseData implements LookupResponseData {
  ...
  @override
  String toString() {
    return 'LookupResponse(engine_capacity: $engine_capacity, wheelplan: $wheelplan, co2_emissions: $co2_emissions, last_v5_issued: $last_v5_issued, logo_url: $logo_url, make: $make, mot_expiry: $mot_expiry, month_of_first_registration: $month_of_first_registration, mot_status: $mot_status, type_approval: $type_approval, colour: $colour, fuel_type: $fuel_type, registration: $registration, tax_due_date: $tax_due_date, tax_status: $tax_status, year_of_manufacture: $year_of_manufacture)';
  }
...
abstract class LookupResponseData implements LookupResponse {
  const factory LookupResponseData(
      ...
      final String? tax_due_date,
      final String? tax_status,
      final int? year_of_manufacture}) = _$LookupResponseData;
