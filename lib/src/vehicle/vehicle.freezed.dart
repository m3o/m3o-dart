...
class _$LookupResponseData implements LookupResponseData {
  ...
  @override
  String toString() {
    return 'LookupResponse(month_of_first_registration: $month_of_first_registration, logo_url: $logo_url, make: $make, mot_status: $mot_status, tax_due_date: $tax_due_date, year_of_manufacture: $year_of_manufacture, colour: $colour, fuel_type: $fuel_type, engine_capacity: $engine_capacity, registration: $registration, mot_expiry: $mot_expiry, tax_status: $tax_status, type_approval: $type_approval, wheelplan: $wheelplan, co2_emissions: $co2_emissions, last_v5_issued: $last_v5_issued)';
  }
...
abstract class LookupResponseData implements LookupResponse {
  const factory LookupResponseData(
      ...
      final String? wheelplan,
      final double? co2_emissions,
      final String? last_v5_issued}) = _$LookupResponseData;
