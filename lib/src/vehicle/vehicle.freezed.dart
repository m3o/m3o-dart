...
class _$LookupResponseData implements LookupResponseData {
  ...
  @override
  String toString() {
    return 'LookupResponse(co2_emissions: $co2_emissions, mot_status: $mot_status, tax_due_date: $tax_due_date, year_of_manufacture: $year_of_manufacture, colour: $colour, last_v5_issued: $last_v5_issued, logo_url: $logo_url, make: $make, tax_status: $tax_status, type_approval: $type_approval, engine_capacity: $engine_capacity, fuel_type: $fuel_type, month_of_first_registration: $month_of_first_registration, mot_expiry: $mot_expiry, registration: $registration, wheelplan: $wheelplan)';
  }
