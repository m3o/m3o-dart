...
class _$LookupResponseData implements LookupResponseData {
  ...
  @override
  String toString() {
    return 'LookupResponse(mot_expiry: $mot_expiry, month_of_first_registration: $month_of_first_registration, type_approval: $type_approval, last_v5_issued: $last_v5_issued, registration: $registration, tax_status: $tax_status, wheelplan: $wheelplan, year_of_manufacture: $year_of_manufacture, mot_status: $mot_status, tax_due_date: $tax_due_date, co2_emissions: $co2_emissions, colour: $colour, engine_capacity: $engine_capacity, fuel_type: $fuel_type, logo_url: $logo_url, make: $make)';
  }
