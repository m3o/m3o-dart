...
class _$LookupResponseData implements LookupResponseData {
  ...
  @override
  String toString() {
    return 'LookupResponse(engine_capacity: $engine_capacity, logo_url: $logo_url, mot_expiry: $mot_expiry, mot_status: $mot_status, colour: $colour, month_of_first_registration: $month_of_first_registration, wheelplan: $wheelplan, year_of_manufacture: $year_of_manufacture, make: $make, co2_emissions: $co2_emissions, fuel_type: $fuel_type, last_v5_issued: $last_v5_issued, registration: $registration, tax_due_date: $tax_due_date, tax_status: $tax_status, type_approval: $type_approval)';
  }
