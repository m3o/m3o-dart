...
class _$LookupResponseData implements LookupResponseData {
  ...
  @override
  String toString() {
    return 'LookupResponse(tax_due_date: $tax_due_date, last_v5_issued: $last_v5_issued, type_approval: $type_approval, year_of_manufacture: $year_of_manufacture, engine_capacity: $engine_capacity, colour: $colour, make: $make, month_of_first_registration: $month_of_first_registration, tax_status: $tax_status, wheelplan: $wheelplan, co2_emissions: $co2_emissions, logo_url: $logo_url, mot_expiry: $mot_expiry, mot_status: $mot_status, registration: $registration, fuel_type: $fuel_type)';
  }
