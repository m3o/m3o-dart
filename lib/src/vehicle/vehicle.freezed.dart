...
class _$LookupResponseData implements LookupResponseData {
  ...
  @override
  String toString() {
    return 'LookupResponse(last_v5_issued: $last_v5_issued, year_of_manufacture: $year_of_manufacture, co2_emissions: $co2_emissions, colour: $colour, engine_capacity: $engine_capacity, make: $make, mot_expiry: $mot_expiry, mot_status: $mot_status, registration: $registration, tax_status: $tax_status, month_of_first_registration: $month_of_first_registration, tax_due_date: $tax_due_date, wheelplan: $wheelplan, fuel_type: $fuel_type, logo_url: $logo_url, type_approval: $type_approval)';
  }
