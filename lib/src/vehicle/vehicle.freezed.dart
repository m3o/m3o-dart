...
class _$LookupResponseData implements LookupResponseData {
  ...
  @override
  String toString() {
    return 'LookupResponse(engine_capacity: $engine_capacity, mot_status: $mot_status, mot_expiry: $mot_expiry, registration: $registration, type_approval: $type_approval, logo_url: $logo_url, make: $make, tax_due_date: $tax_due_date, tax_status: $tax_status, year_of_manufacture: $year_of_manufacture, fuel_type: $fuel_type, month_of_first_registration: $month_of_first_registration, last_v5_issued: $last_v5_issued, wheelplan: $wheelplan, co2_emissions: $co2_emissions, colour: $colour)';
  }
