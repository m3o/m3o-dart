...
class _$LookupResponseData implements LookupResponseData {
  ...
  @override
  String toString() {
    return 'LookupResponse(colour: $colour, make: $make, type_approval: $type_approval, year_of_manufacture: $year_of_manufacture, co2_emissions: $co2_emissions, last_v5_issued: $last_v5_issued, mot_expiry: $mot_expiry, tax_due_date: $tax_due_date, tax_status: $tax_status, wheelplan: $wheelplan, engine_capacity: $engine_capacity, fuel_type: $fuel_type, logo_url: $logo_url, registration: $registration, month_of_first_registration: $month_of_first_registration, mot_status: $mot_status)';
  }
