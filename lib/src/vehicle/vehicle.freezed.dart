...
class _$LookupResponseData implements LookupResponseData {
  ...
  @override
  String toString() {
    return 'LookupResponse(last_v5_issued: $last_v5_issued, mot_status: $mot_status, tax_due_date: $tax_due_date, colour: $colour, engine_capacity: $engine_capacity, wheelplan: $wheelplan, logo_url: $logo_url, make: $make, registration: $registration, tax_status: $tax_status, fuel_type: $fuel_type, month_of_first_registration: $month_of_first_registration, type_approval: $type_approval, year_of_manufacture: $year_of_manufacture, co2_emissions: $co2_emissions, mot_expiry: $mot_expiry)';
  }
