...
class _$LookupResponseData implements LookupResponseData {
  ...
  @override
  String toString() {
    return 'LookupResponse(fuel_type: $fuel_type, last_v5_issued: $last_v5_issued, month_of_first_registration: $month_of_first_registration, mot_expiry: $mot_expiry, tax_status: $tax_status, wheelplan: $wheelplan, co2_emissions: $co2_emissions, logo_url: $logo_url, registration: $registration, colour: $colour, make: $make, mot_status: $mot_status, tax_due_date: $tax_due_date, engine_capacity: $engine_capacity, year_of_manufacture: $year_of_manufacture, type_approval: $type_approval)';
  }
