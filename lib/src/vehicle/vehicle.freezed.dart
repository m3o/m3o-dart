...
class _$LookupResponseData implements LookupResponseData {
  ...
  @override
  String toString() {
    return 'LookupResponse(engine_capacity: $engine_capacity, tax_status: $tax_status, type_approval: $type_approval, year_of_manufacture: $year_of_manufacture, colour: $colour, make: $make, month_of_first_registration: $month_of_first_registration, mot_expiry: $mot_expiry, tax_due_date: $tax_due_date, co2_emissions: $co2_emissions, fuel_type: $fuel_type, mot_status: $mot_status, registration: $registration, last_v5_issued: $last_v5_issued, logo_url: $logo_url, wheelplan: $wheelplan)';
  }
