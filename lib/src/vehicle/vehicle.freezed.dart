...
class _$LookupResponseData implements LookupResponseData {
  ...
  @override
  String toString() {
    return 'LookupResponse(mot_status: $mot_status, tax_status: $tax_status, wheelplan: $wheelplan, co2_emissions: $co2_emissions, colour: $colour, last_v5_issued: $last_v5_issued, mot_expiry: $mot_expiry, type_approval: $type_approval, year_of_manufacture: $year_of_manufacture, engine_capacity: $engine_capacity, logo_url: $logo_url, make: $make, registration: $registration, fuel_type: $fuel_type, month_of_first_registration: $month_of_first_registration, tax_due_date: $tax_due_date)';
  }
