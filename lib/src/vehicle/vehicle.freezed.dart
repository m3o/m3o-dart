...
class _$LookupResponseData implements LookupResponseData {
  ...
  @override
  String toString() {
    return 'LookupResponse(fuel_type: $fuel_type, co2_emissions: $co2_emissions, last_v5_issued: $last_v5_issued, logo_url: $logo_url, tax_due_date: $tax_due_date, type_approval: $type_approval, year_of_manufacture: $year_of_manufacture, colour: $colour, engine_capacity: $engine_capacity, make: $make, mot_status: $mot_status, registration: $registration, tax_status: $tax_status, wheelplan: $wheelplan, month_of_first_registration: $month_of_first_registration, mot_expiry: $mot_expiry)';
  }
