...
class _$LookupResponseData implements LookupResponseData {
  ...
  @override
  String toString() {
    return 'LookupResponse(month_of_first_registration: $month_of_first_registration, registration: $registration, fuel_type: $fuel_type, tax_due_date: $tax_due_date, wheelplan: $wheelplan, co2_emissions: $co2_emissions, make: $make, mot_expiry: $mot_expiry, mot_status: $mot_status, tax_status: $tax_status, type_approval: $type_approval, colour: $colour, engine_capacity: $engine_capacity, last_v5_issued: $last_v5_issued, logo_url: $logo_url, year_of_manufacture: $year_of_manufacture)';
  }
