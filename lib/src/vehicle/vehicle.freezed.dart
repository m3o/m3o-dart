...
class _$LookupResponseData implements LookupResponseData {
  ...
  @override
  String toString() {
    return 'LookupResponse(engine_capacity: $engine_capacity, logo_url: $logo_url, month_of_first_registration: $month_of_first_registration, tax_status: $tax_status, fuel_type: $fuel_type, last_v5_issued: $last_v5_issued, mot_expiry: $mot_expiry, mot_status: $mot_status, type_approval: $type_approval, wheelplan: $wheelplan, co2_emissions: $co2_emissions, colour: $colour, year_of_manufacture: $year_of_manufacture, tax_due_date: $tax_due_date, make: $make, registration: $registration)';
  }
