...
class _$LookupResponseData implements LookupResponseData {
  ...
  @override
  String toString() {
    return 'LookupResponse(colour: $colour, registration: $registration, tax_status: $tax_status, wheelplan: $wheelplan, year_of_manufacture: $year_of_manufacture, last_v5_issued: $last_v5_issued, make: $make, mot_status: $mot_status, engine_capacity: $engine_capacity, fuel_type: $fuel_type, month_of_first_registration: $month_of_first_registration, type_approval: $type_approval, co2_emissions: $co2_emissions, logo_url: $logo_url, mot_expiry: $mot_expiry, tax_due_date: $tax_due_date)';
  }
