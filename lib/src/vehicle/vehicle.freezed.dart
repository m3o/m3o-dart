...
class _$LookupResponseData implements LookupResponseData {
  ...
  @override
  String toString() {
    return 'LookupResponse(fuel_type: $fuel_type, tax_due_date: $tax_due_date, logo_url: $logo_url, year_of_manufacture: $year_of_manufacture, colour: $colour, engine_capacity: $engine_capacity, month_of_first_registration: $month_of_first_registration, registration: $registration, type_approval: $type_approval, last_v5_issued: $last_v5_issued, make: $make, mot_status: $mot_status, tax_status: $tax_status, wheelplan: $wheelplan, co2_emissions: $co2_emissions, mot_expiry: $mot_expiry)';
  }
