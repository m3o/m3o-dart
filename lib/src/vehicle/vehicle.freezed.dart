...
class _$LookupResponseData implements LookupResponseData {
  ...
  @override
  String toString() {
    return 'LookupResponse(fuel_type: $fuel_type, month_of_first_registration: $month_of_first_registration, type_approval: $type_approval, year_of_manufacture: $year_of_manufacture, colour: $colour, last_v5_issued: $last_v5_issued, make: $make, tax_due_date: $tax_due_date, wheelplan: $wheelplan, engine_capacity: $engine_capacity, mot_expiry: $mot_expiry, mot_status: $mot_status, tax_status: $tax_status, co2_emissions: $co2_emissions, logo_url: $logo_url, registration: $registration)';
  }
...
abstract class LookupResponseData implements LookupResponse {
  const factory LookupResponseData(
      ...
      final double? co2_emissions,
      final String? logo_url,
      final String? registration}) = _$LookupResponseData;
