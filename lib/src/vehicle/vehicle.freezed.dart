...
class _$LookupResponseData implements LookupResponseData {
  ...
  @override
  String toString() {
    return 'LookupResponse(colour: $colour, fuel_type: $fuel_type, last_v5_issued: $last_v5_issued, logo_url: $logo_url, month_of_first_registration: $month_of_first_registration, type_approval: $type_approval, engine_capacity: $engine_capacity, mot_status: $mot_status, co2_emissions: $co2_emissions, mot_expiry: $mot_expiry, registration: $registration, tax_due_date: $tax_due_date, wheelplan: $wheelplan, year_of_manufacture: $year_of_manufacture, make: $make, tax_status: $tax_status)';
  }
