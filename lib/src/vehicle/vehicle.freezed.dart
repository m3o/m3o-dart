...
class _$LookupResponseData implements LookupResponseData {
  ...
  @override
  String toString() {
    return 'LookupResponse(registration: $registration, year_of_manufacture: $year_of_manufacture, tax_due_date: $tax_due_date, co2_emissions: $co2_emissions, engine_capacity: $engine_capacity, logo_url: $logo_url, mot_status: $mot_status, type_approval: $type_approval, colour: $colour, fuel_type: $fuel_type, month_of_first_registration: $month_of_first_registration, tax_status: $tax_status, last_v5_issued: $last_v5_issued, make: $make, mot_expiry: $mot_expiry, wheelplan: $wheelplan)';
  }
