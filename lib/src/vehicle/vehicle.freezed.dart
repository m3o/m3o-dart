...
class _$LookupResponseData implements LookupResponseData {
  ...
  @override
  String toString() {
    return 'LookupResponse(co2_emissions: $co2_emissions, month_of_first_registration: $month_of_first_registration, registration: $registration, last_v5_issued: $last_v5_issued, mot_expiry: $mot_expiry, type_approval: $type_approval, year_of_manufacture: $year_of_manufacture, colour: $colour, make: $make, mot_status: $mot_status, tax_status: $tax_status, engine_capacity: $engine_capacity, fuel_type: $fuel_type, logo_url: $logo_url, tax_due_date: $tax_due_date, wheelplan: $wheelplan)';
  }
