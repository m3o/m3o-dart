...
class _$LookupResponseData implements LookupResponseData {
  ...
  @override
  String toString() {
    return 'LookupResponse(last_v5_issued: $last_v5_issued, engine_capacity: $engine_capacity, fuel_type: $fuel_type, logo_url: $logo_url, tax_due_date: $tax_due_date, make: $make, tax_status: $tax_status, type_approval: $type_approval, co2_emissions: $co2_emissions, colour: $colour, mot_status: $mot_status, registration: $registration, wheelplan: $wheelplan, year_of_manufacture: $year_of_manufacture, month_of_first_registration: $month_of_first_registration, mot_expiry: $mot_expiry)';
  }
