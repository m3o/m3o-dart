...
class _$LookupResponseData implements LookupResponseData {
  ...
  @override
  String toString() {
    return 'LookupResponse(co2_emissions: $co2_emissions, last_v5_issued: $last_v5_issued, logo_url: $logo_url, mot_expiry: $mot_expiry, type_approval: $type_approval, year_of_manufacture: $year_of_manufacture, engine_capacity: $engine_capacity, fuel_type: $fuel_type, month_of_first_registration: $month_of_first_registration, tax_status: $tax_status, wheelplan: $wheelplan, colour: $colour, make: $make, mot_status: $mot_status, registration: $registration, tax_due_date: $tax_due_date)';
  }
