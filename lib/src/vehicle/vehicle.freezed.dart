...
class _$LookupResponseData implements LookupResponseData {
  ...
  @override
  String toString() {
    return 'LookupResponse(tax_due_date: $tax_due_date, engine_capacity: $engine_capacity, fuel_type: $fuel_type, registration: $registration, month_of_first_registration: $month_of_first_registration, co2_emissions: $co2_emissions, last_v5_issued: $last_v5_issued, logo_url: $logo_url, wheelplan: $wheelplan, year_of_manufacture: $year_of_manufacture, mot_expiry: $mot_expiry, mot_status: $mot_status, type_approval: $type_approval, colour: $colour, make: $make, tax_status: $tax_status)';
  }
