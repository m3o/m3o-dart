...
class _$LookupResponseData implements LookupResponseData {
  ...
  @override
  String toString() {
    return 'LookupResponse(make: $make, month_of_first_registration: $month_of_first_registration, tax_due_date: $tax_due_date, tax_status: $tax_status, wheelplan: $wheelplan, colour: $colour, logo_url: $logo_url, registration: $registration, year_of_manufacture: $year_of_manufacture, co2_emissions: $co2_emissions, fuel_type: $fuel_type, last_v5_issued: $last_v5_issued, mot_expiry: $mot_expiry, mot_status: $mot_status, engine_capacity: $engine_capacity, type_approval: $type_approval)';
  }
