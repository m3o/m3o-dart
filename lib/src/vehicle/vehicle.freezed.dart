...
class _$LookupResponseData implements LookupResponseData {
  ...
  @override
  String toString() {
    return 'LookupResponse(fuel_type: $fuel_type, tax_due_date: $tax_due_date, engine_capacity: $engine_capacity, make: $make, mot_expiry: $mot_expiry, last_v5_issued: $last_v5_issued, logo_url: $logo_url, mot_status: $mot_status, type_approval: $type_approval, wheelplan: $wheelplan, year_of_manufacture: $year_of_manufacture, co2_emissions: $co2_emissions, colour: $colour, month_of_first_registration: $month_of_first_registration, registration: $registration, tax_status: $tax_status)';
  }
