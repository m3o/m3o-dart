...
class _$LookupResponseData implements LookupResponseData {
  ...
  @override
  String toString() {
    return 'LookupResponse(month_of_first_registration: $month_of_first_registration, year_of_manufacture: $year_of_manufacture, logo_url: $logo_url, mot_status: $mot_status, registration: $registration, last_v5_issued: $last_v5_issued, make: $make, mot_expiry: $mot_expiry, tax_due_date: $tax_due_date, wheelplan: $wheelplan, co2_emissions: $co2_emissions, colour: $colour, engine_capacity: $engine_capacity, fuel_type: $fuel_type, tax_status: $tax_status, type_approval: $type_approval)';
  }
