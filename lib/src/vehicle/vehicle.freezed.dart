...
class _$LookupResponseData implements LookupResponseData {
  ...
  @override
  String toString() {
    return 'LookupResponse(wheelplan: $wheelplan, year_of_manufacture: $year_of_manufacture, co2_emissions: $co2_emissions, colour: $colour, mot_expiry: $mot_expiry, tax_due_date: $tax_due_date, make: $make, month_of_first_registration: $month_of_first_registration, mot_status: $mot_status, engine_capacity: $engine_capacity, last_v5_issued: $last_v5_issued, type_approval: $type_approval, tax_status: $tax_status, fuel_type: $fuel_type, logo_url: $logo_url, registration: $registration)';
  }
