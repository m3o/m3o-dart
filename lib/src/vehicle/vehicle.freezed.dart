...
class _$LookupResponseData implements LookupResponseData {
  ...
  @override
  String toString() {
    return 'LookupResponse(fuel_type: $fuel_type, last_v5_issued: $last_v5_issued, mot_expiry: $mot_expiry, mot_status: $mot_status, tax_status: $tax_status, co2_emissions: $co2_emissions, engine_capacity: $engine_capacity, make: $make, type_approval: $type_approval, month_of_first_registration: $month_of_first_registration, tax_due_date: $tax_due_date, wheelplan: $wheelplan, year_of_manufacture: $year_of_manufacture, colour: $colour, logo_url: $logo_url, registration: $registration)';
  }
