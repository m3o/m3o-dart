...
class _$LookupResponseData implements LookupResponseData {
  ...
  @override
  String toString() {
    return 'LookupResponse(co2_emissions: $co2_emissions, colour: $colour, last_v5_issued: $last_v5_issued, make: $make, tax_due_date: $tax_due_date, mot_status: $mot_status, registration: $registration, tax_status: $tax_status, engine_capacity: $engine_capacity, logo_url: $logo_url, type_approval: $type_approval, fuel_type: $fuel_type, month_of_first_registration: $month_of_first_registration, mot_expiry: $mot_expiry, wheelplan: $wheelplan, year_of_manufacture: $year_of_manufacture)';
  }
