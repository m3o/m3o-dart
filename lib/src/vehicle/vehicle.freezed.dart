...
class _$LookupResponseData implements LookupResponseData {
  ...
  @override
  String toString() {
    return 'LookupResponse(colour: $colour, mot_expiry: $mot_expiry, tax_due_date: $tax_due_date, year_of_manufacture: $year_of_manufacture, engine_capacity: $engine_capacity, fuel_type: $fuel_type, last_v5_issued: $last_v5_issued, logo_url: $logo_url, co2_emissions: $co2_emissions, type_approval: $type_approval, make: $make, month_of_first_registration: $month_of_first_registration, mot_status: $mot_status, registration: $registration, tax_status: $tax_status, wheelplan: $wheelplan)';
  }
