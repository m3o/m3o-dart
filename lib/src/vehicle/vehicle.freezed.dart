...
class _$LookupResponseData implements LookupResponseData {
  ...
  @override
  String toString() {
    return 'LookupResponse(colour: $colour, engine_capacity: $engine_capacity, mot_status: $mot_status, tax_status: $tax_status, last_v5_issued: $last_v5_issued, registration: $registration, tax_due_date: $tax_due_date, year_of_manufacture: $year_of_manufacture, mot_expiry: $mot_expiry, type_approval: $type_approval, co2_emissions: $co2_emissions, fuel_type: $fuel_type, logo_url: $logo_url, make: $make, month_of_first_registration: $month_of_first_registration, wheelplan: $wheelplan)';
  }
