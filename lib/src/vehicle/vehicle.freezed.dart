...
class _$LookupResponseData implements LookupResponseData {
  ...
  @override
  String toString() {
    return 'LookupResponse(mot_expiry: $mot_expiry, registration: $registration, fuel_type: $fuel_type, make: $make, month_of_first_registration: $month_of_first_registration, tax_due_date: $tax_due_date, type_approval: $type_approval, year_of_manufacture: $year_of_manufacture, engine_capacity: $engine_capacity, last_v5_issued: $last_v5_issued, mot_status: $mot_status, co2_emissions: $co2_emissions, logo_url: $logo_url, colour: $colour, tax_status: $tax_status, wheelplan: $wheelplan)';
  }
