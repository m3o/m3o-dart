...
class _$LookupResponseData implements LookupResponseData {
  ...
  @override
  String toString() {
    return 'LookupResponse(co2_emissions: $co2_emissions, mot_expiry: $mot_expiry, type_approval: $type_approval, tax_due_date: $tax_due_date, wheelplan: $wheelplan, fuel_type: $fuel_type, last_v5_issued: $last_v5_issued, month_of_first_registration: $month_of_first_registration, registration: $registration, engine_capacity: $engine_capacity, logo_url: $logo_url, make: $make, year_of_manufacture: $year_of_manufacture, colour: $colour, mot_status: $mot_status, tax_status: $tax_status)';
  }
