...
class _$LookupResponseData implements LookupResponseData {
  ...
  @override
  String toString() {
    return 'LookupResponse(co2_emissions: $co2_emissions, fuel_type: $fuel_type, type_approval: $type_approval, colour: $colour, mot_status: $mot_status, tax_status: $tax_status, mot_expiry: $mot_expiry, registration: $registration, engine_capacity: $engine_capacity, last_v5_issued: $last_v5_issued, make: $make, wheelplan: $wheelplan, year_of_manufacture: $year_of_manufacture, logo_url: $logo_url, month_of_first_registration: $month_of_first_registration, tax_due_date: $tax_due_date)';
  }
