...
class _$LookupResponseData implements LookupResponseData {
  ...
  @override
  String toString() {
    return 'LookupResponse(month_of_first_registration: $month_of_first_registration, registration: $registration, wheelplan: $wheelplan, colour: $colour, make: $make, tax_due_date: $tax_due_date, tax_status: $tax_status, type_approval: $type_approval, co2_emissions: $co2_emissions, last_v5_issued: $last_v5_issued, mot_status: $mot_status, fuel_type: $fuel_type, logo_url: $logo_url, year_of_manufacture: $year_of_manufacture, engine_capacity: $engine_capacity, mot_expiry: $mot_expiry)';
  }
