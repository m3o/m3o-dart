...
class _$LookupResponseData implements LookupResponseData {
  ...
  @override
  String toString() {
    return 'LookupResponse(engine_capacity: $engine_capacity, logo_url: $logo_url, make: $make, year_of_manufacture: $year_of_manufacture, co2_emissions: $co2_emissions, colour: $colour, mot_expiry: $mot_expiry, mot_status: $mot_status, tax_status: $tax_status, wheelplan: $wheelplan, fuel_type: $fuel_type, last_v5_issued: $last_v5_issued, type_approval: $type_approval, registration: $registration, tax_due_date: $tax_due_date, month_of_first_registration: $month_of_first_registration)';
  }
