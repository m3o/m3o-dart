...
class _$LookupResponseData implements LookupResponseData {
  ...
  @override
  String toString() {
    return 'LookupResponse(mot_status: $mot_status, tax_status: $tax_status, wheelplan: $wheelplan, fuel_type: $fuel_type, last_v5_issued: $last_v5_issued, make: $make, tax_due_date: $tax_due_date, co2_emissions: $co2_emissions, engine_capacity: $engine_capacity, mot_expiry: $mot_expiry, year_of_manufacture: $year_of_manufacture, colour: $colour, logo_url: $logo_url, registration: $registration, month_of_first_registration: $month_of_first_registration, type_approval: $type_approval)';
  }
