...
class _$LookupResponseData implements LookupResponseData {
  ...
  @override
  String toString() {
    return 'LookupResponse(tax_due_date: $tax_due_date, type_approval: $type_approval, wheelplan: $wheelplan, make: $make, month_of_first_registration: $month_of_first_registration, mot_expiry: $mot_expiry, mot_status: $mot_status, co2_emissions: $co2_emissions, colour: $colour, year_of_manufacture: $year_of_manufacture, engine_capacity: $engine_capacity, logo_url: $logo_url, registration: $registration, fuel_type: $fuel_type, last_v5_issued: $last_v5_issued, tax_status: $tax_status)';
  }
