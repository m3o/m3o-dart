...
class _$LookupResponseData implements LookupResponseData {
  ...
  @override
  String toString() {
    return 'LookupResponse(mot_expiry: $mot_expiry, mot_status: $mot_status, co2_emissions: $co2_emissions, last_v5_issued: $last_v5_issued, registration: $registration, tax_status: $tax_status, type_approval: $type_approval, wheelplan: $wheelplan, engine_capacity: $engine_capacity, month_of_first_registration: $month_of_first_registration, tax_due_date: $tax_due_date, fuel_type: $fuel_type, make: $make, year_of_manufacture: $year_of_manufacture, colour: $colour, logo_url: $logo_url)';
  }
