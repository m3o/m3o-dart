...
class _$LookupResponseData implements LookupResponseData {
  ...
  @override
  String toString() {
    return 'LookupResponse(co2_emissions: $co2_emissions, colour: $colour, wheelplan: $wheelplan, engine_capacity: $engine_capacity, fuel_type: $fuel_type, tax_status: $tax_status, year_of_manufacture: $year_of_manufacture, type_approval: $type_approval, month_of_first_registration: $month_of_first_registration, mot_expiry: $mot_expiry, mot_status: $mot_status, registration: $registration, tax_due_date: $tax_due_date, last_v5_issued: $last_v5_issued, logo_url: $logo_url, make: $make)';
  }
