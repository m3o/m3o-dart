...
class _$LookupResponseData implements LookupResponseData {
  ...
  @override
  String toString() {
    return 'LookupResponse(colour: $colour, engine_capacity: $engine_capacity, mot_expiry: $mot_expiry, registration: $registration, fuel_type: $fuel_type, logo_url: $logo_url, make: $make, mot_status: $mot_status, tax_due_date: $tax_due_date, month_of_first_registration: $month_of_first_registration, type_approval: $type_approval, year_of_manufacture: $year_of_manufacture, co2_emissions: $co2_emissions, last_v5_issued: $last_v5_issued, tax_status: $tax_status, wheelplan: $wheelplan)';
  }
