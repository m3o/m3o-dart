...
class _$LookupResponseData implements LookupResponseData {
  ...
  @override
  String toString() {
    return 'LookupResponse(logo_url: $logo_url, tax_status: $tax_status, last_v5_issued: $last_v5_issued, fuel_type: $fuel_type, registration: $registration, type_approval: $type_approval, year_of_manufacture: $year_of_manufacture, co2_emissions: $co2_emissions, make: $make, month_of_first_registration: $month_of_first_registration, mot_status: $mot_status, tax_due_date: $tax_due_date, wheelplan: $wheelplan, engine_capacity: $engine_capacity, mot_expiry: $mot_expiry, colour: $colour)';
  }
