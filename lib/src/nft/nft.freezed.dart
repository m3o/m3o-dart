...
class _$_Asset implements _Asset {
  ...
  @override
  String toString() {
    return 'Asset(creator: $creator, image_url: $image_url, listing_date: $listing_date, name: $name, owner: $owner, token_id: $token_id, description: $description, id: $id, presale: $presale, collection: $collection, contract: $contract, last_sale: $last_sale, permalink: $permalink, sales: $sales, traits: $traits)';
  }
...
class _$_Collection implements _Collection {
  ...
  @override
  String toString() {
    return 'Collection(banner_image_url: $banner_image_url, created_at: $created_at, seller_fees: $seller_fees, editors: $editors, image_url: $image_url, payment_tokens: $payment_tokens, traits: $traits, description: $description, safelist_request_status: $safelist_request_status, slug: $slug, stats: $stats, external_link: $external_link, name: $name, payout_address: $payout_address, primary_asset_contracts: $primary_asset_contracts)';
  }
...
class _$_Contract implements _Contract {
  ...
  @override
  String toString() {
    return 'Contract(address: $address, created_at: $created_at, description: $description, name: $name, seller_fees: $seller_fees, type: $type, owner: $owner, payout_address: $payout_address, schema: $schema, symbol: $symbol)';
  }
...
class _$_Sale implements _Sale {
  ...
  @override
  String toString() {
    return 'Sale(event_timestamp: $event_timestamp, transaction: $transaction, event_type: $event_type, payment_token: $payment_token, quantity: $quantity, total_price: $total_price, asset_decimals: $asset_decimals, asset_token_id: $asset_token_id, created_at: $created_at)';
  }
