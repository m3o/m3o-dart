...
class _$_Asset implements _Asset {
  ...
  @override
  String toString() {
    return 'Asset(creator: $creator, permalink: $permalink, collection: $collection, contract: $contract, id: $id, image_url: $image_url, last_sale: $last_sale, listing_date: $listing_date, name: $name, owner: $owner, presale: $presale, description: $description, sales: $sales, token_id: $token_id, traits: $traits)';
  }
...
class _$_Collection implements _Collection {
  ...
  @override
  String toString() {
    return 'Collection(seller_fees: $seller_fees, traits: $traits, safelist_request_status: $safelist_request_status, banner_image_url: $banner_image_url, editors: $editors, image_url: $image_url, slug: $slug, stats: $stats, created_at: $created_at, description: $description, name: $name, primary_asset_contracts: $primary_asset_contracts, external_link: $external_link, payment_tokens: $payment_tokens, payout_address: $payout_address)';
  }
...
class _$_Contract implements _Contract {
  ...
  @override
  String toString() {
    return 'Contract(description: $description, name: $name, payout_address: $payout_address, schema: $schema, seller_fees: $seller_fees, symbol: $symbol, type: $type, address: $address, created_at: $created_at, owner: $owner)';
  }
...
class _$_Sale implements _Sale {
  ...
  @override
  String toString() {
    return 'Sale(payment_token: $payment_token, asset_token_id: $asset_token_id, created_at: $created_at, event_timestamp: $event_timestamp, event_type: $event_type, quantity: $quantity, total_price: $total_price, transaction: $transaction, asset_decimals: $asset_decimals)';
  }
