...
class _$_Asset implements _Asset {
  ...
  @override
  String toString() {
    return 'Asset(collection: $collection, contract: $contract, description: $description, image_url: $image_url, listing_date: $listing_date, owner: $owner, id: $id, token_id: $token_id, last_sale: $last_sale, name: $name, permalink: $permalink, presale: $presale, creator: $creator, sales: $sales, traits: $traits)';
  }
...
class _$_Collection implements _Collection {
  ...
  @override
  String toString() {
    return 'Collection(external_link: $external_link, payment_tokens: $payment_tokens, seller_fees: $seller_fees, editors: $editors, name: $name, safelist_request_status: $safelist_request_status, slug: $slug, stats: $stats, traits: $traits, banner_image_url: $banner_image_url, description: $description, image_url: $image_url, payout_address: $payout_address, created_at: $created_at, primary_asset_contracts: $primary_asset_contracts)';
  }
...
class _$_Contract implements _Contract {
  ...
  @override
  String toString() {
    return 'Contract(address: $address, created_at: $created_at, name: $name, type: $type, description: $description, owner: $owner, payout_address: $payout_address, schema: $schema, seller_fees: $seller_fees, symbol: $symbol)';
  }
