...
class _$_Asset implements _Asset {
  ...
  @override
  String toString() {
    return 'Asset(last_sale: $last_sale, presale: $presale, image_url: $image_url, sales: $sales, creator: $creator, id: $id, owner: $owner, token_id: $token_id, listing_date: $listing_date, name: $name, description: $description, permalink: $permalink, traits: $traits, collection: $collection, contract: $contract)';
  }
...
class _$_Collection implements _Collection {
  ...
  @override
  String toString() {
    return 'Collection(payment_tokens: $payment_tokens, seller_fees: $seller_fees, banner_image_url: $banner_image_url, created_at: $created_at, external_link: $external_link, payout_address: $payout_address, primary_asset_contracts: $primary_asset_contracts, description: $description, traits: $traits, editors: $editors, image_url: $image_url, name: $name, safelist_request_status: $safelist_request_status, slug: $slug, stats: $stats)';
  }
...
class _$_Contract implements _Contract {
  ...
  @override
  String toString() {
    return 'Contract(created_at: $created_at, description: $description, name: $name, owner: $owner, type: $type, address: $address, payout_address: $payout_address, schema: $schema, seller_fees: $seller_fees, symbol: $symbol)';
  }
...
class _$_Sale implements _Sale {
  ...
  @override
  String toString() {
    return 'Sale(asset_decimals: $asset_decimals, asset_token_id: $asset_token_id, created_at: $created_at, payment_token: $payment_token, event_timestamp: $event_timestamp, event_type: $event_type, quantity: $quantity, total_price: $total_price, transaction: $transaction)';
  }
