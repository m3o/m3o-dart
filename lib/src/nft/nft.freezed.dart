...
class _$_Asset implements _Asset {
  ...
  @override
  String toString() {
    return 'Asset(owner: $owner, presale: $presale, token_id: $token_id, listing_date: $listing_date, name: $name, collection: $collection, creator: $creator, image_url: $image_url, traits: $traits, contract: $contract, description: $description, permalink: $permalink, sales: $sales, id: $id, last_sale: $last_sale)';
  }
...
class _$_Collection implements _Collection {
  ...
  @override
  String toString() {
    return 'Collection(editors: $editors, traits: $traits, created_at: $created_at, description: $description, payment_tokens: $payment_tokens, stats: $stats, name: $name, primary_asset_contracts: $primary_asset_contracts, slug: $slug, external_link: $external_link, image_url: $image_url, safelist_request_status: $safelist_request_status, seller_fees: $seller_fees, banner_image_url: $banner_image_url, payout_address: $payout_address)';
  }
...
class _$CollectionsRequestTearOff {
  ...
  _CollectionsRequest call({int? offset, String? owner, int? limit}) {
...
abstract class _CollectionsRequest implements CollectionsRequest {
  const factory _CollectionsRequest({int? offset, String? owner, int? limit}) =
...
class _$_Contract implements _Contract {
  ...
  @override
  String toString() {
    return 'Contract(address: $address, created_at: $created_at, owner: $owner, symbol: $symbol, type: $type, description: $description, name: $name, payout_address: $payout_address, schema: $schema, seller_fees: $seller_fees)';
  }
...
class _$_Sale implements _Sale {
  ...
  @override
  String toString() {
    return 'Sale(asset_decimals: $asset_decimals, asset_token_id: $asset_token_id, event_timestamp: $event_timestamp, payment_token: $payment_token, transaction: $transaction, created_at: $created_at, event_type: $event_type, quantity: $quantity, total_price: $total_price)';
  }
