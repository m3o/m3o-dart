...
class _$_Asset implements _Asset {
  ...
  @override
  String toString() {
    return 'Asset(id: $id, owner: $owner, permalink: $permalink, collection: $collection, description: $description, last_sale: $last_sale, name: $name, presale: $presale, sales: $sales, token_id: $token_id, traits: $traits, contract: $contract, creator: $creator, listing_date: $listing_date, image_url: $image_url)';
  }
...
class _$_Collection implements _Collection {
  ...
  @override
  String toString() {
    return 'Collection(banner_image_url: $banner_image_url, image_url: $image_url, seller_fees: $seller_fees, stats: $stats, created_at: $created_at, name: $name, safelist_request_status: $safelist_request_status, editors: $editors, external_link: $external_link, payment_tokens: $payment_tokens, payout_address: $payout_address, primary_asset_contracts: $primary_asset_contracts, slug: $slug, traits: $traits, description: $description)';
  }
...
class _$_Contract implements _Contract {
  ...
  @override
  String toString() {
    return 'Contract(created_at: $created_at, description: $description, owner: $owner, payout_address: $payout_address, symbol: $symbol, address: $address, name: $name, schema: $schema, seller_fees: $seller_fees, type: $type)';
  }
...
class _$_Sale implements _Sale {
  ...
  @override
  String toString() {
    return 'Sale(created_at: $created_at, event_timestamp: $event_timestamp, event_type: $event_type, payment_token: $payment_token, quantity: $quantity, asset_decimals: $asset_decimals, asset_token_id: $asset_token_id, total_price: $total_price, transaction: $transaction)';
  }
