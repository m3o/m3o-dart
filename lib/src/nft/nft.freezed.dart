...
class _$_Asset implements _Asset {
  ...
  @override
  String toString() {
    return 'Asset(owner: $owner, presale: $presale, sales: $sales, name: $name, collection: $collection, contract: $contract, description: $description, last_sale: $last_sale, listing_date: $listing_date, token_id: $token_id, traits: $traits, creator: $creator, id: $id, image_url: $image_url, permalink: $permalink)';
  }
...
class _$_Collection implements _Collection {
  ...
  @override
  String toString() {
    return 'Collection(description: $description, external_link: $external_link, safelist_request_status: $safelist_request_status, slug: $slug, image_url: $image_url, payout_address: $payout_address, primary_asset_contracts: $primary_asset_contracts, stats: $stats, created_at: $created_at, name: $name, payment_tokens: $payment_tokens, traits: $traits, banner_image_url: $banner_image_url, editors: $editors, seller_fees: $seller_fees)';
  }
...
class _$_Contract implements _Contract {
  ...
  @override
  String toString() {
    return 'Contract(type: $type, address: $address, seller_fees: $seller_fees, name: $name, owner: $owner, payout_address: $payout_address, schema: $schema, symbol: $symbol, created_at: $created_at, description: $description)';
  }
...
class _$_Sale implements _Sale {
  ...
  @override
  String toString() {
    return 'Sale(transaction: $transaction, event_timestamp: $event_timestamp, event_type: $event_type, payment_token: $payment_token, quantity: $quantity, total_price: $total_price, asset_decimals: $asset_decimals, asset_token_id: $asset_token_id, created_at: $created_at)';
  }
