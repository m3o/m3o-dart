...
class _$_Asset implements _Asset {
  ...
  @override
  String toString() {
    return 'Asset(creator: $creator, description: $description, id: $id, last_sale: $last_sale, token_id: $token_id, collection: $collection, name: $name, sales: $sales, image_url: $image_url, traits: $traits, contract: $contract, listing_date: $listing_date, owner: $owner, permalink: $permalink, presale: $presale)';
  }
...
class _$_Collection implements _Collection {
  ...
  @override
  String toString() {
    return 'Collection(banner_image_url: $banner_image_url, primary_asset_contracts: $primary_asset_contracts, safelist_request_status: $safelist_request_status, seller_fees: $seller_fees, external_link: $external_link, payout_address: $payout_address, stats: $stats, traits: $traits, description: $description, image_url: $image_url, name: $name, payment_tokens: $payment_tokens, slug: $slug, created_at: $created_at, editors: $editors)';
  }
...
class _$_Contract implements _Contract {
  ...
  @override
  String toString() {
    return 'Contract(description: $description, name: $name, symbol: $symbol, address: $address, created_at: $created_at, schema: $schema, seller_fees: $seller_fees, type: $type, owner: $owner, payout_address: $payout_address)';
  }
