...
class _$_Asset implements _Asset {
  ...
  @override
  String toString() {
    return 'Asset(last_sale: $last_sale, traits: $traits, collection: $collection, sales: $sales, image_url: $image_url, id: $id, listing_date: $listing_date, name: $name, presale: $presale, description: $description, creator: $creator, owner: $owner, permalink: $permalink, token_id: $token_id, contract: $contract)';
  }
...
abstract class _Asset implements Asset {
  const factory _Asset(
      ...
      final String? permalink,
      final String? token_id,
      final Contract? contract}) = _$_Asset;
...
class _$_Collection implements _Collection {
  ...
  @override
  String toString() {
    return 'Collection(banner_image_url: $banner_image_url, external_link: $external_link, name: $name, payout_address: $payout_address, stats: $stats, primary_asset_contracts: $primary_asset_contracts, seller_fees: $seller_fees, slug: $slug, traits: $traits, created_at: $created_at, description: $description, editors: $editors, image_url: $image_url, payment_tokens: $payment_tokens, safelist_request_status: $safelist_request_status)';
  }
...
class _$_Contract implements _Contract {
  ...
  @override
  String toString() {
    return 'Contract(payout_address: $payout_address, schema: $schema, seller_fees: $seller_fees, symbol: $symbol, description: $description, name: $name, owner: $owner, address: $address, created_at: $created_at, type: $type)';
  }
...
class _$_Sale implements _Sale {
  ...
  @override
  String toString() {
    return 'Sale(quantity: $quantity, total_price: $total_price, transaction: $transaction, asset_decimals: $asset_decimals, asset_token_id: $asset_token_id, event_type: $event_type, payment_token: $payment_token, created_at: $created_at, event_timestamp: $event_timestamp)';
  }
