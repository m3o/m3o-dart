...
class _$_Asset implements _Asset {
  ...
  @override
  String toString() {
    return 'Asset(creator: $creator, listing_date: $listing_date, name: $name, token_id: $token_id, traits: $traits, collection: $collection, contract: $contract, description: $description, presale: $presale, owner: $owner, id: $id, image_url: $image_url, last_sale: $last_sale, permalink: $permalink, sales: $sales)';
  }
...
class _$_Collection implements _Collection {
  ...
  @override
  String toString() {
    return 'Collection(seller_fees: $seller_fees, editors: $editors, payment_tokens: $payment_tokens, payout_address: $payout_address, safelist_request_status: $safelist_request_status, slug: $slug, traits: $traits, banner_image_url: $banner_image_url, created_at: $created_at, primary_asset_contracts: $primary_asset_contracts, name: $name, stats: $stats, description: $description, external_link: $external_link, image_url: $image_url)';
  }
...
class _$_Contract implements _Contract {
  ...
  @override
  String toString() {
    return 'Contract(description: $description, symbol: $symbol, type: $type, address: $address, name: $name, owner: $owner, payout_address: $payout_address, schema: $schema, seller_fees: $seller_fees, created_at: $created_at)';
  }
