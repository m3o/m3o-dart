...
class _$_Asset implements _Asset {
  ...
  @override
  String toString() {
    return 'Asset(collection: $collection, listing_date: $listing_date, presale: $presale, sales: $sales, owner: $owner, permalink: $permalink, traits: $traits, id: $id, image_url: $image_url, last_sale: $last_sale, name: $name, token_id: $token_id, contract: $contract, creator: $creator, description: $description)';
  }
...
class _$_Collection implements _Collection {
  ...
  @override
  String toString() {
    return 'Collection(primary_asset_contracts: $primary_asset_contracts, seller_fees: $seller_fees, slug: $slug, stats: $stats, banner_image_url: $banner_image_url, name: $name, image_url: $image_url, description: $description, editors: $editors, traits: $traits, created_at: $created_at, payout_address: $payout_address, safelist_request_status: $safelist_request_status, external_link: $external_link, payment_tokens: $payment_tokens)';
  }
...
class _$_Sale implements _Sale {
  ...
  @override
  String toString() {
    return 'Sale(asset_decimals: $asset_decimals, event_timestamp: $event_timestamp, quantity: $quantity, total_price: $total_price, transaction: $transaction, asset_token_id: $asset_token_id, created_at: $created_at, event_type: $event_type, payment_token: $payment_token)';
  }
