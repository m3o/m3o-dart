...
class _$_Asset implements _Asset {
  ...
  @override
  String toString() {
    return 'Asset(creator: $creator, permalink: $permalink, contract: $contract, description: $description, id: $id, listing_date: $listing_date, sales: $sales, token_id: $token_id, collection: $collection, last_sale: $last_sale, presale: $presale, traits: $traits, image_url: $image_url, name: $name, owner: $owner)';
  }
...
class _$_Collection implements _Collection {
  ...
  @override
  String toString() {
    return 'Collection(banner_image_url: $banner_image_url, image_url: $image_url, payment_tokens: $payment_tokens, safelist_request_status: $safelist_request_status, created_at: $created_at, seller_fees: $seller_fees, description: $description, name: $name, payout_address: $payout_address, stats: $stats, editors: $editors, external_link: $external_link, primary_asset_contracts: $primary_asset_contracts, slug: $slug, traits: $traits)';
  }
...
class _$_Contract implements _Contract {
  ...
  @override
  String toString() {
    return 'Contract(type: $type, description: $description, name: $name, owner: $owner, payout_address: $payout_address, seller_fees: $seller_fees, address: $address, created_at: $created_at, schema: $schema, symbol: $symbol)';
  }
