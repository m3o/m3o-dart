...
class _$_Asset implements _Asset {
  ...
  @override
  String toString() {
    return 'Asset(token_id: $token_id, description: $description, image_url: $image_url, last_sale: $last_sale, owner: $owner, contract: $contract, listing_date: $listing_date, name: $name, permalink: $permalink, presale: $presale, sales: $sales, traits: $traits, collection: $collection, creator: $creator, id: $id)';
  }
...
class _$_Collection implements _Collection {
  ...
  @override
  String toString() {
    return 'Collection(image_url: $image_url, payment_tokens: $payment_tokens, payout_address: $payout_address, primary_asset_contracts: $primary_asset_contracts, banner_image_url: $banner_image_url, description: $description, traits: $traits, created_at: $created_at, safelist_request_status: $safelist_request_status, editors: $editors, name: $name, seller_fees: $seller_fees, slug: $slug, stats: $stats, external_link: $external_link)';
  }
...
class _$_Contract implements _Contract {
  ...
  @override
  String toString() {
    return 'Contract(description: $description, name: $name, owner: $owner, payout_address: $payout_address, schema: $schema, symbol: $symbol, address: $address, seller_fees: $seller_fees, type: $type, created_at: $created_at)';
  }
...
class _$_Sale implements _Sale {
  ...
  @override
  String toString() {
    return 'Sale(asset_decimals: $asset_decimals, asset_token_id: $asset_token_id, event_timestamp: $event_timestamp, quantity: $quantity, created_at: $created_at, event_type: $event_type, payment_token: $payment_token, total_price: $total_price, transaction: $transaction)';
  }
