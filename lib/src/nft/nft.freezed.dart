...
class _$_Asset implements _Asset {
  ...
  @override
  String toString() {
    return 'Asset(owner: $owner, permalink: $permalink, sales: $sales, traits: $traits, contract: $contract, creator: $creator, description: $description, last_sale: $last_sale, presale: $presale, id: $id, image_url: $image_url, name: $name, collection: $collection, listing_date: $listing_date, token_id: $token_id)';
  }
...
class _$_Collection implements _Collection {
  ...
  @override
  String toString() {
    return 'Collection(payment_tokens: $payment_tokens, primary_asset_contracts: $primary_asset_contracts, traits: $traits, editors: $editors, description: $description, image_url: $image_url, safelist_request_status: $safelist_request_status, stats: $stats, created_at: $created_at, seller_fees: $seller_fees, name: $name, external_link: $external_link, payout_address: $payout_address, slug: $slug, banner_image_url: $banner_image_url)';
  }
...
class _$_Contract implements _Contract {
  ...
  @override
  String toString() {
    return 'Contract(description: $description, owner: $owner, seller_fees: $seller_fees, type: $type, address: $address, name: $name, payout_address: $payout_address, schema: $schema, symbol: $symbol, created_at: $created_at)';
  }
...
class _$_Sale implements _Sale {
  ...
  @override
  String toString() {
    return 'Sale(created_at: $created_at, quantity: $quantity, transaction: $transaction, asset_decimals: $asset_decimals, asset_token_id: $asset_token_id, payment_token: $payment_token, total_price: $total_price, event_timestamp: $event_timestamp, event_type: $event_type)';
  }
