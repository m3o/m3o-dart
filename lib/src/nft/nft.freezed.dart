...
class _$_Asset implements _Asset {
  ...
  @override
  String toString() {
    return 'Asset(traits: $traits, creator: $creator, listing_date: $listing_date, name: $name, presale: $presale, sales: $sales, image_url: $image_url, token_id: $token_id, contract: $contract, description: $description, id: $id, owner: $owner, collection: $collection, last_sale: $last_sale, permalink: $permalink)';
  }
...
class _$_Collection implements _Collection {
  ...
  @override
  String toString() {
    return 'Collection(banner_image_url: $banner_image_url, created_at: $created_at, editors: $editors, primary_asset_contracts: $primary_asset_contracts, traits: $traits, name: $name, payout_address: $payout_address, safelist_request_status: $safelist_request_status, seller_fees: $seller_fees, stats: $stats, description: $description, external_link: $external_link, image_url: $image_url, payment_tokens: $payment_tokens, slug: $slug)';
  }
...
class _$_Contract implements _Contract {
  ...
  @override
  String toString() {
    return 'Contract(created_at: $created_at, description: $description, owner: $owner, payout_address: $payout_address, symbol: $symbol, address: $address, schema: $schema, seller_fees: $seller_fees, type: $type, name: $name)';
  }
...
class _$_Sale implements _Sale {
  ...
  @override
  String toString() {
    return 'Sale(created_at: $created_at, event_type: $event_type, payment_token: $payment_token, quantity: $quantity, total_price: $total_price, transaction: $transaction, asset_decimals: $asset_decimals, asset_token_id: $asset_token_id, event_timestamp: $event_timestamp)';
  }
