...
class _$_Asset implements _Asset {
  ...
  @override
  String toString() {
    return 'Asset(sales: $sales, token_id: $token_id, traits: $traits, permalink: $permalink, image_url: $image_url, listing_date: $listing_date, name: $name, owner: $owner, presale: $presale, collection: $collection, description: $description, id: $id, last_sale: $last_sale, contract: $contract, creator: $creator)';
  }
...
class _$_Collection implements _Collection {
  ...
  @override
  String toString() {
    return 'Collection(payout_address: $payout_address, safelist_request_status: $safelist_request_status, slug: $slug, stats: $stats, banner_image_url: $banner_image_url, editors: $editors, name: $name, created_at: $created_at, description: $description, image_url: $image_url, primary_asset_contracts: $primary_asset_contracts, traits: $traits, external_link: $external_link, payment_tokens: $payment_tokens, seller_fees: $seller_fees)';
  }
...
class _$_Contract implements _Contract {
  ...
  @override
  String toString() {
    return 'Contract(symbol: $symbol, address: $address, created_at: $created_at, description: $description, payout_address: $payout_address, type: $type, name: $name, owner: $owner, schema: $schema, seller_fees: $seller_fees)';
  }
...
class _$_Sale implements _Sale {
  ...
  @override
  String toString() {
    return 'Sale(event_timestamp: $event_timestamp, total_price: $total_price, transaction: $transaction, quantity: $quantity, asset_decimals: $asset_decimals, asset_token_id: $asset_token_id, created_at: $created_at, event_type: $event_type, payment_token: $payment_token)';
  }
