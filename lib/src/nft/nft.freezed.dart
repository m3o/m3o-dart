...
class _$_Asset implements _Asset {
  ...
  @override
  String toString() {
    return 'Asset(description: $description, owner: $owner, traits: $traits, contract: $contract, creator: $creator, image_url: $image_url, listing_date: $listing_date, permalink: $permalink, presale: $presale, id: $id, last_sale: $last_sale, sales: $sales, token_id: $token_id, collection: $collection, name: $name)';
  }
...
class _$_Collection implements _Collection {
  ...
  @override
  String toString() {
    return 'Collection(external_link: $external_link, description: $description, seller_fees: $seller_fees, stats: $stats, traits: $traits, editors: $editors, image_url: $image_url, payment_tokens: $payment_tokens, safelist_request_status: $safelist_request_status, banner_image_url: $banner_image_url, created_at: $created_at, name: $name, payout_address: $payout_address, primary_asset_contracts: $primary_asset_contracts, slug: $slug)';
  }
...
class _$_Contract implements _Contract {
  ...
  @override
  String toString() {
    return 'Contract(address: $address, created_at: $created_at, owner: $owner, payout_address: $payout_address, description: $description, name: $name, schema: $schema, seller_fees: $seller_fees, symbol: $symbol, type: $type)';
  }
...
class _$_Sale implements _Sale {
  ...
  @override
  String toString() {
    return 'Sale(asset_token_id: $asset_token_id, created_at: $created_at, event_type: $event_type, total_price: $total_price, asset_decimals: $asset_decimals, event_timestamp: $event_timestamp, payment_token: $payment_token, quantity: $quantity, transaction: $transaction)';
  }
