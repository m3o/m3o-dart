...
class _$_Asset implements _Asset {
  ...
  @override
  String toString() {
    return 'Asset(owner: $owner, collection: $collection, creator: $creator, listing_date: $listing_date, permalink: $permalink, sales: $sales, traits: $traits, id: $id, image_url: $image_url, last_sale: $last_sale, presale: $presale, token_id: $token_id, contract: $contract, description: $description, name: $name)';
  }
...
class _$_Collection implements _Collection {
  ...
  @override
  String toString() {
    return 'Collection(safelist_request_status: $safelist_request_status, seller_fees: $seller_fees, slug: $slug, banner_image_url: $banner_image_url, name: $name, payout_address: $payout_address, stats: $stats, traits: $traits, created_at: $created_at, image_url: $image_url, primary_asset_contracts: $primary_asset_contracts, payment_tokens: $payment_tokens, description: $description, editors: $editors, external_link: $external_link)';
  }
...
class _$_Contract implements _Contract {
  ...
  @override
  String toString() {
    return 'Contract(address: $address, owner: $owner, payout_address: $payout_address, schema: $schema, created_at: $created_at, description: $description, name: $name, seller_fees: $seller_fees, symbol: $symbol, type: $type)';
  }
...
class _$_Sale implements _Sale {
  ...
  @override
  String toString() {
    return 'Sale(quantity: $quantity, asset_decimals: $asset_decimals, created_at: $created_at, event_type: $event_type, payment_token: $payment_token, asset_token_id: $asset_token_id, event_timestamp: $event_timestamp, total_price: $total_price, transaction: $transaction)';
  }
