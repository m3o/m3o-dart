...
class _$_Asset implements _Asset {
  ...
  @override
  String toString() {
    return 'Asset(collection: $collection, id: $id, image_url: $image_url, owner: $owner, token_id: $token_id, description: $description, presale: $presale, sales: $sales, contract: $contract, last_sale: $last_sale, name: $name, permalink: $permalink, traits: $traits, creator: $creator, listing_date: $listing_date)';
  }
...
class _$_Collection implements _Collection {
  ...
  @override
  String toString() {
    return 'Collection(banner_image_url: $banner_image_url, description: $description, external_link: $external_link, image_url: $image_url, seller_fees: $seller_fees, stats: $stats, created_at: $created_at, payment_tokens: $payment_tokens, payout_address: $payout_address, primary_asset_contracts: $primary_asset_contracts, safelist_request_status: $safelist_request_status, traits: $traits, editors: $editors, name: $name, slug: $slug)';
  }
...
class _$_Contract implements _Contract {
  ...
  @override
  String toString() {
    return 'Contract(address: $address, symbol: $symbol, type: $type, created_at: $created_at, description: $description, name: $name, owner: $owner, payout_address: $payout_address, schema: $schema, seller_fees: $seller_fees)';
  }
...
class _$_Sale implements _Sale {
  ...
  @override
  String toString() {
    return 'Sale(quantity: $quantity, asset_decimals: $asset_decimals, asset_token_id: $asset_token_id, event_type: $event_type, total_price: $total_price, transaction: $transaction, created_at: $created_at, event_timestamp: $event_timestamp, payment_token: $payment_token)';
  }
