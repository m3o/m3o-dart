...
class _$_Asset implements _Asset {
  ...
  @override
  String toString() {
    return 'Asset(image_url: $image_url, listing_date: $listing_date, creator: $creator, last_sale: $last_sale, token_id: $token_id, name: $name, owner: $owner, permalink: $permalink, presale: $presale, sales: $sales, traits: $traits, collection: $collection, contract: $contract, description: $description, id: $id)';
  }
...
class _$_Collection implements _Collection {
  ...
  @override
  String toString() {
    return 'Collection(created_at: $created_at, safelist_request_status: $safelist_request_status, slug: $slug, traits: $traits, name: $name, payout_address: $payout_address, description: $description, image_url: $image_url, primary_asset_contracts: $primary_asset_contracts, seller_fees: $seller_fees, stats: $stats, banner_image_url: $banner_image_url, editors: $editors, external_link: $external_link, payment_tokens: $payment_tokens)';
  }
...
class _$_Contract implements _Contract {
  ...
  @override
  String toString() {
    return 'Contract(created_at: $created_at, description: $description, owner: $owner, schema: $schema, seller_fees: $seller_fees, address: $address, payout_address: $payout_address, symbol: $symbol, type: $type, name: $name)';
  }
...
class _$_Sale implements _Sale {
  ...
  @override
  String toString() {
    return 'Sale(asset_decimals: $asset_decimals, created_at: $created_at, event_type: $event_type, quantity: $quantity, transaction: $transaction, asset_token_id: $asset_token_id, event_timestamp: $event_timestamp, payment_token: $payment_token, total_price: $total_price)';
  }
