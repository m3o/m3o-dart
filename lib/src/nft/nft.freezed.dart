...
class _$_Asset implements _Asset {
  ...
  @override
  String toString() {
    return 'Asset(image_url: $image_url, name: $name, creator: $creator, token_id: $token_id, collection: $collection, last_sale: $last_sale, listing_date: $listing_date, owner: $owner, permalink: $permalink, sales: $sales, traits: $traits, description: $description, id: $id, presale: $presale, contract: $contract)';
  }
...
class _$_Collection implements _Collection {
  ...
  @override
  String toString() {
    return 'Collection(primary_asset_contracts: $primary_asset_contracts, safelist_request_status: $safelist_request_status, traits: $traits, created_at: $created_at, seller_fees: $seller_fees, slug: $slug, stats: $stats, banner_image_url: $banner_image_url, editors: $editors, image_url: $image_url, payment_tokens: $payment_tokens, description: $description, external_link: $external_link, name: $name, payout_address: $payout_address)';
  }
...
class _$_Contract implements _Contract {
  ...
  @override
  String toString() {
    return 'Contract(payout_address: $payout_address, seller_fees: $seller_fees, type: $type, description: $description, created_at: $created_at, name: $name, owner: $owner, schema: $schema, symbol: $symbol, address: $address)';
  }
...
class _$_Sale implements _Sale {
  ...
  @override
  String toString() {
    return 'Sale(created_at: $created_at, total_price: $total_price, payment_token: $payment_token, quantity: $quantity, transaction: $transaction, asset_decimals: $asset_decimals, asset_token_id: $asset_token_id, event_timestamp: $event_timestamp, event_type: $event_type)';
  }
