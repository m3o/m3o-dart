...
class _$_Asset implements _Asset {
  ...
  @override
  String toString() {
    return 'Asset(traits: $traits, contract: $contract, image_url: $image_url, last_sale: $last_sale, token_id: $token_id, permalink: $permalink, presale: $presale, sales: $sales, collection: $collection, description: $description, listing_date: $listing_date, name: $name, creator: $creator, id: $id, owner: $owner)';
  }
...
class _$_Collection implements _Collection {
  ...
  @override
  String toString() {
    return 'Collection(primary_asset_contracts: $primary_asset_contracts, seller_fees: $seller_fees, banner_image_url: $banner_image_url, payout_address: $payout_address, image_url: $image_url, name: $name, description: $description, editors: $editors, traits: $traits, safelist_request_status: $safelist_request_status, stats: $stats, payment_tokens: $payment_tokens, slug: $slug, created_at: $created_at, external_link: $external_link)';
  }
...
abstract class _Collection implements Collection {
  const factory _Collection(
      ...
      final String? slug,
      final String? created_at,
      final String? external_link}) = _$_Collection;
...
class _$_Contract implements _Contract {
  ...
  @override
  String toString() {
    return 'Contract(name: $name, owner: $owner, payout_address: $payout_address, schema: $schema, seller_fees: $seller_fees, address: $address, created_at: $created_at, description: $description, symbol: $symbol, type: $type)';
  }
...
class _$_Sale implements _Sale {
  ...
  @override
  String toString() {
    return 'Sale(asset_decimals: $asset_decimals, created_at: $created_at, transaction: $transaction, payment_token: $payment_token, quantity: $quantity, total_price: $total_price, asset_token_id: $asset_token_id, event_timestamp: $event_timestamp, event_type: $event_type)';
  }
