...
class _$_Asset implements _Asset {
  ...
  @override
  String toString() {
    return 'Asset(collection: $collection, image_url: $image_url, presale: $presale, last_sale: $last_sale, listing_date: $listing_date, name: $name, sales: $sales, creator: $creator, description: $description, contract: $contract, id: $id, owner: $owner, permalink: $permalink, token_id: $token_id, traits: $traits)';
  }
...
class _$_Collection implements _Collection {
  ...
  @override
  String toString() {
    return 'Collection(image_url: $image_url, payment_tokens: $payment_tokens, seller_fees: $seller_fees, stats: $stats, traits: $traits, created_at: $created_at, editors: $editors, name: $name, payout_address: $payout_address, slug: $slug, banner_image_url: $banner_image_url, description: $description, primary_asset_contracts: $primary_asset_contracts, external_link: $external_link, safelist_request_status: $safelist_request_status)';
  }
...
class _$_Contract implements _Contract {
  ...
  @override
  String toString() {
    return 'Contract(seller_fees: $seller_fees, symbol: $symbol, address: $address, created_at: $created_at, name: $name, schema: $schema, description: $description, owner: $owner, payout_address: $payout_address, type: $type)';
  }
...
class _$_Sale implements _Sale {
  ...
  @override
  String toString() {
    return 'Sale(asset_token_id: $asset_token_id, quantity: $quantity, total_price: $total_price, transaction: $transaction, asset_decimals: $asset_decimals, created_at: $created_at, event_timestamp: $event_timestamp, event_type: $event_type, payment_token: $payment_token)';
  }
