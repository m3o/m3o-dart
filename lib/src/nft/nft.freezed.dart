...
class _$_Asset implements _Asset {
  ...
  @override
  String toString() {
    return 'Asset(collection: $collection, contract: $contract, token_id: $token_id, description: $description, sales: $sales, id: $id, name: $name, owner: $owner, permalink: $permalink, presale: $presale, creator: $creator, image_url: $image_url, last_sale: $last_sale, listing_date: $listing_date, traits: $traits)';
  }
...
class _$_Collection implements _Collection {
  ...
  @override
  String toString() {
    return 'Collection(stats: $stats, external_link: $external_link, primary_asset_contracts: $primary_asset_contracts, seller_fees: $seller_fees, description: $description, traits: $traits, payout_address: $payout_address, banner_image_url: $banner_image_url, editors: $editors, payment_tokens: $payment_tokens, safelist_request_status: $safelist_request_status, slug: $slug, created_at: $created_at, image_url: $image_url, name: $name)';
  }
...
class _$_Contract implements _Contract {
  ...
  @override
  String toString() {
    return 'Contract(seller_fees: $seller_fees, symbol: $symbol, address: $address, created_at: $created_at, description: $description, name: $name, owner: $owner, payout_address: $payout_address, type: $type, schema: $schema)';
  }
...
class _$_Sale implements _Sale {
  ...
  @override
  String toString() {
    return 'Sale(event_timestamp: $event_timestamp, payment_token: $payment_token, transaction: $transaction, asset_decimals: $asset_decimals, asset_token_id: $asset_token_id, quantity: $quantity, total_price: $total_price, created_at: $created_at, event_type: $event_type)';
  }
