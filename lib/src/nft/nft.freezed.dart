...
class _$_Asset implements _Asset {
  ...
  @override
  String toString() {
    return 'Asset(contract: $contract, token_id: $token_id, traits: $traits, collection: $collection, name: $name, permalink: $permalink, sales: $sales, creator: $creator, image_url: $image_url, listing_date: $listing_date, owner: $owner, presale: $presale, description: $description, last_sale: $last_sale, id: $id)';
  }
...
class _$_Collection implements _Collection {
  ...
  @override
  String toString() {
    return 'Collection(editors: $editors, external_link: $external_link, stats: $stats, description: $description, name: $name, seller_fees: $seller_fees, image_url: $image_url, payment_tokens: $payment_tokens, primary_asset_contracts: $primary_asset_contracts, safelist_request_status: $safelist_request_status, banner_image_url: $banner_image_url, created_at: $created_at, payout_address: $payout_address, slug: $slug, traits: $traits)';
  }
...
class _$_Contract implements _Contract {
  ...
  @override
  String toString() {
    return 'Contract(owner: $owner, payout_address: $payout_address, schema: $schema, seller_fees: $seller_fees, address: $address, created_at: $created_at, description: $description, name: $name, symbol: $symbol, type: $type)';
  }
...
class _$_Sale implements _Sale {
  ...
  @override
  String toString() {
    return 'Sale(payment_token: $payment_token, created_at: $created_at, event_type: $event_type, event_timestamp: $event_timestamp, quantity: $quantity, total_price: $total_price, transaction: $transaction, asset_decimals: $asset_decimals, asset_token_id: $asset_token_id)';
  }
