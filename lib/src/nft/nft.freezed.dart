...
class _$_Asset implements _Asset {
  ...
  @override
  String toString() {
    return 'Asset(image_url: $image_url, last_sale: $last_sale, name: $name, permalink: $permalink, presale: $presale, collection: $collection, creator: $creator, description: $description, contract: $contract, id: $id, token_id: $token_id, traits: $traits, listing_date: $listing_date, owner: $owner, sales: $sales)';
  }
...
class _$_Collection implements _Collection {
  ...
  @override
  String toString() {
    return 'Collection(slug: $slug, traits: $traits, banner_image_url: $banner_image_url, created_at: $created_at, description: $description, primary_asset_contracts: $primary_asset_contracts, payout_address: $payout_address, seller_fees: $seller_fees, stats: $stats, external_link: $external_link, name: $name, payment_tokens: $payment_tokens, editors: $editors, image_url: $image_url, safelist_request_status: $safelist_request_status)';
  }
...
class _$_Contract implements _Contract {
  ...
  @override
  String toString() {
    return 'Contract(owner: $owner, schema: $schema, seller_fees: $seller_fees, symbol: $symbol, created_at: $created_at, name: $name, payout_address: $payout_address, type: $type, address: $address, description: $description)';
  }
...
class _$_Sale implements _Sale {
  ...
  @override
  String toString() {
    return 'Sale(event_timestamp: $event_timestamp, transaction: $transaction, total_price: $total_price, asset_decimals: $asset_decimals, asset_token_id: $asset_token_id, created_at: $created_at, event_type: $event_type, payment_token: $payment_token, quantity: $quantity)';
  }
