...
class _$_Asset implements _Asset {
  ...
  @override
  String toString() {
    return 'Asset(contract: $contract, image_url: $image_url, permalink: $permalink, sales: $sales, traits: $traits, id: $id, collection: $collection, description: $description, last_sale: $last_sale, name: $name, owner: $owner, token_id: $token_id, creator: $creator, listing_date: $listing_date, presale: $presale)';
  }
...
class _$_Contract implements _Contract {
  ...
  @override
  String toString() {
    return 'Contract(schema: $schema, seller_fees: $seller_fees, symbol: $symbol, type: $type, address: $address, description: $description, name: $name, owner: $owner, created_at: $created_at, payout_address: $payout_address)';
  }
...
class _$_Sale implements _Sale {
  ...
  @override
  String toString() {
    return 'Sale(transaction: $transaction, asset_token_id: $asset_token_id, event_timestamp: $event_timestamp, payment_token: $payment_token, quantity: $quantity, asset_decimals: $asset_decimals, created_at: $created_at, event_type: $event_type, total_price: $total_price)';
  }
