...
class _$_Asset implements _Asset {
  ...
  @override
  String toString() {
    return 'Asset(collection: $collection, permalink: $permalink, presale: $presale, sales: $sales, contract: $contract, description: $description, owner: $owner, token_id: $token_id, id: $id, image_url: $image_url, name: $name, creator: $creator, last_sale: $last_sale, listing_date: $listing_date, traits: $traits)';
  }
...
class _$_Collection implements _Collection {
  ...
  @override
  String toString() {
    return 'Collection(created_at: $created_at, description: $description, image_url: $image_url, payout_address: $payout_address, seller_fees: $seller_fees, stats: $stats, external_link: $external_link, safelist_request_status: $safelist_request_status, banner_image_url: $banner_image_url, editors: $editors, name: $name, payment_tokens: $payment_tokens, primary_asset_contracts: $primary_asset_contracts, slug: $slug, traits: $traits)';
  }
...
class _$_Contract implements _Contract {
  ...
  @override
  String toString() {
    return 'Contract(name: $name, payout_address: $payout_address, type: $type, created_at: $created_at, description: $description, owner: $owner, schema: $schema, seller_fees: $seller_fees, symbol: $symbol, address: $address)';
  }
...
class _$_Sale implements _Sale {
  ...
  @override
  String toString() {
    return 'Sale(total_price: $total_price, transaction: $transaction, event_type: $event_type, payment_token: $payment_token, created_at: $created_at, event_timestamp: $event_timestamp, quantity: $quantity, asset_decimals: $asset_decimals, asset_token_id: $asset_token_id)';
  }
