...
class _$_Asset implements _Asset {
  ...
  @override
  String toString() {
    return 'Asset(name: $name, collection: $collection, creator: $creator, id: $id, image_url: $image_url, listing_date: $listing_date, traits: $traits, description: $description, last_sale: $last_sale, owner: $owner, permalink: $permalink, contract: $contract, presale: $presale, sales: $sales, token_id: $token_id)';
  }
...
class _$_Collection implements _Collection {
  ...
  @override
  String toString() {
    return 'Collection(banner_image_url: $banner_image_url, external_link: $external_link, name: $name, payout_address: $payout_address, primary_asset_contracts: $primary_asset_contracts, stats: $stats, seller_fees: $seller_fees, created_at: $created_at, description: $description, slug: $slug, editors: $editors, image_url: $image_url, payment_tokens: $payment_tokens, safelist_request_status: $safelist_request_status, traits: $traits)';
  }
...
class _$_Contract implements _Contract {
  ...
  @override
  String toString() {
    return 'Contract(seller_fees: $seller_fees, name: $name, owner: $owner, payout_address: $payout_address, schema: $schema, symbol: $symbol, type: $type, address: $address, created_at: $created_at, description: $description)';
  }
...
class _$_Sale implements _Sale {
  ...
  @override
  String toString() {
    return 'Sale(asset_decimals: $asset_decimals, event_type: $event_type, payment_token: $payment_token, total_price: $total_price, transaction: $transaction, asset_token_id: $asset_token_id, created_at: $created_at, event_timestamp: $event_timestamp, quantity: $quantity)';
  }
