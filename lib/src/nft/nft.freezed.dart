...
class _$_Asset implements _Asset {
  ...
  @override
  String toString() {
    return 'Asset(image_url: $image_url, presale: $presale, creator: $creator, description: $description, last_sale: $last_sale, token_id: $token_id, contract: $contract, listing_date: $listing_date, owner: $owner, sales: $sales, collection: $collection, id: $id, name: $name, permalink: $permalink, traits: $traits)';
  }
...
class _$_Collection implements _Collection {
  ...
  @override
  String toString() {
    return 'Collection(traits: $traits, external_link: $external_link, image_url: $image_url, primary_asset_contracts: $primary_asset_contracts, seller_fees: $seller_fees, stats: $stats, banner_image_url: $banner_image_url, created_at: $created_at, name: $name, safelist_request_status: $safelist_request_status, description: $description, editors: $editors, payment_tokens: $payment_tokens, payout_address: $payout_address, slug: $slug)';
  }
...
class _$_Contract implements _Contract {
  ...
  @override
  String toString() {
    return 'Contract(created_at: $created_at, name: $name, payout_address: $payout_address, schema: $schema, seller_fees: $seller_fees, address: $address, description: $description, owner: $owner, symbol: $symbol, type: $type)';
  }
...
class _$_Sale implements _Sale {
  ...
  @override
  String toString() {
    return 'Sale(event_timestamp: $event_timestamp, payment_token: $payment_token, asset_decimals: $asset_decimals, created_at: $created_at, quantity: $quantity, total_price: $total_price, transaction: $transaction, asset_token_id: $asset_token_id, event_type: $event_type)';
  }
