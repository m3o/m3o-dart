...
class _$_Asset implements _Asset {
  ...
  @override
  String toString() {
    return 'Asset(token_id: $token_id, traits: $traits, contract: $contract, description: $description, id: $id, name: $name, owner: $owner, permalink: $permalink, creator: $creator, image_url: $image_url, last_sale: $last_sale, presale: $presale, listing_date: $listing_date, collection: $collection, sales: $sales)';
  }
...
class _$_Collection implements _Collection {
  ...
  @override
  String toString() {
    return 'Collection(description: $description, editors: $editors, stats: $stats, created_at: $created_at, traits: $traits, external_link: $external_link, name: $name, payment_tokens: $payment_tokens, primary_asset_contracts: $primary_asset_contracts, safelist_request_status: $safelist_request_status, seller_fees: $seller_fees, banner_image_url: $banner_image_url, image_url: $image_url, payout_address: $payout_address, slug: $slug)';
  }
...
class _$_Contract implements _Contract {
  ...
  @override
  String toString() {
    return 'Contract(address: $address, created_at: $created_at, description: $description, name: $name, schema: $schema, symbol: $symbol, owner: $owner, payout_address: $payout_address, seller_fees: $seller_fees, type: $type)';
  }
...
class _$_Sale implements _Sale {
  ...
  @override
  String toString() {
    return 'Sale(created_at: $created_at, event_timestamp: $event_timestamp, transaction: $transaction, asset_token_id: $asset_token_id, event_type: $event_type, payment_token: $payment_token, quantity: $quantity, total_price: $total_price, asset_decimals: $asset_decimals)';
  }
