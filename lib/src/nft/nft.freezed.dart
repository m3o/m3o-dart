...
class _$_Asset implements _Asset {
  ...
  @override
  String toString() {
    return 'Asset(token_id: $token_id, collection: $collection, creator: $creator, sales: $sales, contract: $contract, description: $description, last_sale: $last_sale, presale: $presale, id: $id, image_url: $image_url, owner: $owner, traits: $traits, listing_date: $listing_date, name: $name, permalink: $permalink)';
  }
...
class _$_Collection implements _Collection {
  ...
  @override
  String toString() {
    return 'Collection(description: $description, external_link: $external_link, name: $name, primary_asset_contracts: $primary_asset_contracts, created_at: $created_at, slug: $slug, seller_fees: $seller_fees, stats: $stats, editors: $editors, image_url: $image_url, payment_tokens: $payment_tokens, payout_address: $payout_address, safelist_request_status: $safelist_request_status, traits: $traits, banner_image_url: $banner_image_url)';
  }
...
class _$_Sale implements _Sale {
  ...
  @override
  String toString() {
    return 'Sale(created_at: $created_at, event_type: $event_type, payment_token: $payment_token, asset_decimals: $asset_decimals, asset_token_id: $asset_token_id, total_price: $total_price, transaction: $transaction, event_timestamp: $event_timestamp, quantity: $quantity)';
  }
