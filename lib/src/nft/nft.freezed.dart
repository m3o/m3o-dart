...
class _$_Asset implements _Asset {
  ...
  @override
  String toString() {
    return 'Asset(collection: $collection, id: $id, traits: $traits, image_url: $image_url, listing_date: $listing_date, name: $name, owner: $owner, permalink: $permalink, sales: $sales, description: $description, last_sale: $last_sale, contract: $contract, creator: $creator, presale: $presale, token_id: $token_id)';
  }
...
class _$_Collection implements _Collection {
  ...
  @override
  String toString() {
    return 'Collection(seller_fees: $seller_fees, traits: $traits, banner_image_url: $banner_image_url, created_at: $created_at, primary_asset_contracts: $primary_asset_contracts, description: $description, external_link: $external_link, name: $name, payout_address: $payout_address, safelist_request_status: $safelist_request_status, slug: $slug, editors: $editors, image_url: $image_url, payment_tokens: $payment_tokens, stats: $stats)';
  }
...
class _$_Contract implements _Contract {
  ...
  @override
  String toString() {
    return 'Contract(schema: $schema, seller_fees: $seller_fees, type: $type, name: $name, owner: $owner, description: $description, payout_address: $payout_address, symbol: $symbol, address: $address, created_at: $created_at)';
  }
