...
class _$_Asset implements _Asset {
  ...
  @override
  String toString() {
    return 'Asset(contract: $contract, creator: $creator, last_sale: $last_sale, permalink: $permalink, traits: $traits, id: $id, image_url: $image_url, description: $description, presale: $presale, sales: $sales, token_id: $token_id, collection: $collection, listing_date: $listing_date, name: $name, owner: $owner)';
  }
...
class _$_Collection implements _Collection {
  ...
  @override
  String toString() {
    return 'Collection(banner_image_url: $banner_image_url, editors: $editors, external_link: $external_link, payment_tokens: $payment_tokens, safelist_request_status: $safelist_request_status, slug: $slug, description: $description, name: $name, traits: $traits, created_at: $created_at, image_url: $image_url, payout_address: $payout_address, primary_asset_contracts: $primary_asset_contracts, seller_fees: $seller_fees, stats: $stats)';
  }
...
class _$_Contract implements _Contract {
  ...
  @override
  String toString() {
    return 'Contract(owner: $owner, seller_fees: $seller_fees, symbol: $symbol, type: $type, address: $address, created_at: $created_at, description: $description, name: $name, payout_address: $payout_address, schema: $schema)';
  }
...
class _$_Sale implements _Sale {
  ...
  @override
  String toString() {
    return 'Sale(transaction: $transaction, asset_token_id: $asset_token_id, payment_token: $payment_token, event_timestamp: $event_timestamp, event_type: $event_type, quantity: $quantity, total_price: $total_price, asset_decimals: $asset_decimals, created_at: $created_at)';
  }
