...
class _$_Asset implements _Asset {
  ...
  @override
  String toString() {
    return 'Asset(creator: $creator, last_sale: $last_sale, presale: $presale, sales: $sales, token_id: $token_id, contract: $contract, description: $description, image_url: $image_url, listing_date: $listing_date, name: $name, traits: $traits, collection: $collection, id: $id, owner: $owner, permalink: $permalink)';
  }
...
class _$_Collection implements _Collection {
  ...
  @override
  String toString() {
    return 'Collection(payment_tokens: $payment_tokens, payout_address: $payout_address, safelist_request_status: $safelist_request_status, banner_image_url: $banner_image_url, editors: $editors, name: $name, image_url: $image_url, seller_fees: $seller_fees, traits: $traits, created_at: $created_at, description: $description, external_link: $external_link, primary_asset_contracts: $primary_asset_contracts, slug: $slug, stats: $stats)';
  }
...
class _$_Contract implements _Contract {
  ...
  @override
  String toString() {
    return 'Contract(type: $type, description: $description, name: $name, payout_address: $payout_address, seller_fees: $seller_fees, symbol: $symbol, address: $address, created_at: $created_at, owner: $owner, schema: $schema)';
  }
...
class _$_Sale implements _Sale {
  ...
  @override
  String toString() {
    return 'Sale(asset_decimals: $asset_decimals, asset_token_id: $asset_token_id, event_type: $event_type, created_at: $created_at, event_timestamp: $event_timestamp, payment_token: $payment_token, quantity: $quantity, total_price: $total_price, transaction: $transaction)';
  }
