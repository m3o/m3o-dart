...
class _$_Asset implements _Asset {
  ...
  @override
  String toString() {
    return 'Asset(permalink: $permalink, presale: $presale, token_id: $token_id, collection: $collection, contract: $contract, description: $description, last_sale: $last_sale, sales: $sales, creator: $creator, id: $id, listing_date: $listing_date, traits: $traits, image_url: $image_url, name: $name, owner: $owner)';
  }
...
class _$_Collection implements _Collection {
  ...
  @override
  String toString() {
    return 'Collection(payment_tokens: $payment_tokens, slug: $slug, traits: $traits, primary_asset_contracts: $primary_asset_contracts, safelist_request_status: $safelist_request_status, stats: $stats, banner_image_url: $banner_image_url, created_at: $created_at, description: $description, editors: $editors, external_link: $external_link, name: $name, payout_address: $payout_address, image_url: $image_url, seller_fees: $seller_fees)';
  }
...
class _$_Contract implements _Contract {
  ...
  @override
  String toString() {
    return 'Contract(payout_address: $payout_address, seller_fees: $seller_fees, type: $type, created_at: $created_at, description: $description, owner: $owner, symbol: $symbol, address: $address, name: $name, schema: $schema)';
  }
...
class _$_Sale implements _Sale {
  ...
  @override
  String toString() {
    return 'Sale(quantity: $quantity, total_price: $total_price, asset_decimals: $asset_decimals, created_at: $created_at, payment_token: $payment_token, transaction: $transaction, asset_token_id: $asset_token_id, event_timestamp: $event_timestamp, event_type: $event_type)';
  }
