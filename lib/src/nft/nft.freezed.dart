...
class _$_Asset implements _Asset {
  ...
  @override
  String toString() {
    return 'Asset(description: $description, last_sale: $last_sale, name: $name, traits: $traits, id: $id, listing_date: $listing_date, presale: $presale, token_id: $token_id, collection: $collection, image_url: $image_url, sales: $sales, contract: $contract, creator: $creator, owner: $owner, permalink: $permalink)';
  }
...
class _$_Collection implements _Collection {
  ...
  @override
  String toString() {
    return 'Collection(slug: $slug, stats: $stats, created_at: $created_at, external_link: $external_link, name: $name, image_url: $image_url, seller_fees: $seller_fees, safelist_request_status: $safelist_request_status, traits: $traits, banner_image_url: $banner_image_url, description: $description, primary_asset_contracts: $primary_asset_contracts, editors: $editors, payment_tokens: $payment_tokens, payout_address: $payout_address)';
  }
...
class _$_Contract implements _Contract {
  ...
  @override
  String toString() {
    return 'Contract(description: $description, owner: $owner, symbol: $symbol, created_at: $created_at, name: $name, payout_address: $payout_address, schema: $schema, seller_fees: $seller_fees, type: $type, address: $address)';
  }
...
class _$_Sale implements _Sale {
  ...
  @override
  String toString() {
    return 'Sale(asset_decimals: $asset_decimals, asset_token_id: $asset_token_id, created_at: $created_at, event_timestamp: $event_timestamp, event_type: $event_type, transaction: $transaction, payment_token: $payment_token, quantity: $quantity, total_price: $total_price)';
  }
