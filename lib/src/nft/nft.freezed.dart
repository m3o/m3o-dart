...
class _$_Asset implements _Asset {
  ...
  @override
  String toString() {
    return 'Asset(id: $id, listing_date: $listing_date, presale: $presale, contract: $contract, image_url: $image_url, last_sale: $last_sale, permalink: $permalink, collection: $collection, sales: $sales, token_id: $token_id, traits: $traits, creator: $creator, description: $description, name: $name, owner: $owner)';
  }
...
class _$_Collection implements _Collection {
  ...
  @override
  String toString() {
    return 'Collection(editors: $editors, external_link: $external_link, image_url: $image_url, seller_fees: $seller_fees, slug: $slug, banner_image_url: $banner_image_url, created_at: $created_at, payment_tokens: $payment_tokens, payout_address: $payout_address, safelist_request_status: $safelist_request_status, description: $description, primary_asset_contracts: $primary_asset_contracts, traits: $traits, name: $name, stats: $stats)';
  }
...
class _$_Contract implements _Contract {
  ...
  @override
  String toString() {
    return 'Contract(symbol: $symbol, type: $type, created_at: $created_at, description: $description, owner: $owner, payout_address: $payout_address, schema: $schema, seller_fees: $seller_fees, address: $address, name: $name)';
  }
...
class _$_Sale implements _Sale {
  ...
  @override
  String toString() {
    return 'Sale(asset_decimals: $asset_decimals, event_timestamp: $event_timestamp, event_type: $event_type, asset_token_id: $asset_token_id, created_at: $created_at, payment_token: $payment_token, quantity: $quantity, total_price: $total_price, transaction: $transaction)';
  }
