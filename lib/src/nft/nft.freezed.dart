...
class _$_Asset implements _Asset {
  ...
  @override
  String toString() {
    return 'Asset(creator: $creator, sales: $sales, token_id: $token_id, id: $id, image_url: $image_url, name: $name, permalink: $permalink, presale: $presale, contract: $contract, description: $description, collection: $collection, last_sale: $last_sale, listing_date: $listing_date, owner: $owner, traits: $traits)';
  }
...
class _$_Collection implements _Collection {
  ...
  @override
  String toString() {
    return 'Collection(banner_image_url: $banner_image_url, description: $description, name: $name, seller_fees: $seller_fees, slug: $slug, traits: $traits, safelist_request_status: $safelist_request_status, stats: $stats, created_at: $created_at, image_url: $image_url, payment_tokens: $payment_tokens, primary_asset_contracts: $primary_asset_contracts, editors: $editors, external_link: $external_link, payout_address: $payout_address)';
  }
...
class _$_Contract implements _Contract {
  ...
  @override
  String toString() {
    return 'Contract(address: $address, created_at: $created_at, name: $name, owner: $owner, payout_address: $payout_address, schema: $schema, type: $type, description: $description, seller_fees: $seller_fees, symbol: $symbol)';
  }
