...
class _$_Asset implements _Asset {
  ...
  @override
  String toString() {
    return 'Asset(contract: $contract, image_url: $image_url, permalink: $permalink, traits: $traits, creator: $creator, owner: $owner, id: $id, last_sale: $last_sale, listing_date: $listing_date, presale: $presale, sales: $sales, collection: $collection, description: $description, name: $name, token_id: $token_id)';
  }
...
class _$_Collection implements _Collection {
  ...
  @override
  String toString() {
    return 'Collection(description: $description, editors: $editors, external_link: $external_link, stats: $stats, banner_image_url: $banner_image_url, payout_address: $payout_address, seller_fees: $seller_fees, slug: $slug, created_at: $created_at, image_url: $image_url, payment_tokens: $payment_tokens, name: $name, primary_asset_contracts: $primary_asset_contracts, safelist_request_status: $safelist_request_status, traits: $traits)';
  }
...
class _$_Contract implements _Contract {
  ...
  @override
  String toString() {
    return 'Contract(payout_address: $payout_address, type: $type, description: $description, name: $name, owner: $owner, seller_fees: $seller_fees, symbol: $symbol, address: $address, created_at: $created_at, schema: $schema)';
  }
