...
class _$_Asset implements _Asset {
  ...
  @override
  String toString() {
    return 'Asset(last_sale: $last_sale, name: $name, owner: $owner, permalink: $permalink, sales: $sales, collection: $collection, creator: $creator, presale: $presale, image_url: $image_url, listing_date: $listing_date, token_id: $token_id, contract: $contract, description: $description, id: $id, traits: $traits)';
  }
...
class _$_Collection implements _Collection {
  ...
  @override
  String toString() {
    return 'Collection(banner_image_url: $banner_image_url, description: $description, payout_address: $payout_address, primary_asset_contracts: $primary_asset_contracts, slug: $slug, stats: $stats, traits: $traits, created_at: $created_at, editors: $editors, external_link: $external_link, image_url: $image_url, seller_fees: $seller_fees, payment_tokens: $payment_tokens, safelist_request_status: $safelist_request_status, name: $name)';
  }
...
class _$_Contract implements _Contract {
  ...
  @override
  String toString() {
    return 'Contract(name: $name, owner: $owner, schema: $schema, seller_fees: $seller_fees, address: $address, created_at: $created_at, description: $description, payout_address: $payout_address, symbol: $symbol, type: $type)';
  }
...
class _$_Sale implements _Sale {
  ...
  @override
  String toString() {
    return 'Sale(event_timestamp: $event_timestamp, event_type: $event_type, payment_token: $payment_token, quantity: $quantity, transaction: $transaction, asset_token_id: $asset_token_id, created_at: $created_at, asset_decimals: $asset_decimals, total_price: $total_price)';
  }
