...
class _$_Asset implements _Asset {
  ...
  @override
  String toString() {
    return 'Asset(description: $description, name: $name, contract: $contract, owner: $owner, sales: $sales, token_id: $token_id, traits: $traits, collection: $collection, id: $id, last_sale: $last_sale, listing_date: $listing_date, presale: $presale, creator: $creator, image_url: $image_url, permalink: $permalink)';
  }
...
class _$_Collection implements _Collection {
  ...
  @override
  String toString() {
    return 'Collection(external_link: $external_link, safelist_request_status: $safelist_request_status, seller_fees: $seller_fees, stats: $stats, created_at: $created_at, name: $name, payout_address: $payout_address, slug: $slug, traits: $traits, image_url: $image_url, payment_tokens: $payment_tokens, primary_asset_contracts: $primary_asset_contracts, banner_image_url: $banner_image_url, description: $description, editors: $editors)';
  }
...
class _$_Contract implements _Contract {
  ...
  @override
  String toString() {
    return 'Contract(description: $description, name: $name, schema: $schema, symbol: $symbol, created_at: $created_at, owner: $owner, payout_address: $payout_address, seller_fees: $seller_fees, type: $type, address: $address)';
  }
...
class _$_Sale implements _Sale {
  ...
  @override
  String toString() {
    return 'Sale(asset_decimals: $asset_decimals, asset_token_id: $asset_token_id, created_at: $created_at, payment_token: $payment_token, total_price: $total_price, event_timestamp: $event_timestamp, event_type: $event_type, quantity: $quantity, transaction: $transaction)';
  }
