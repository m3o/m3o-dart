...
class _$_Asset implements _Asset {
  ...
  @override
  String toString() {
    return 'Asset(permalink: $permalink, id: $id, last_sale: $last_sale, sales: $sales, owner: $owner, presale: $presale, creator: $creator, description: $description, listing_date: $listing_date, name: $name, collection: $collection, contract: $contract, traits: $traits, image_url: $image_url, token_id: $token_id)';
  }
...
class _$_Collection implements _Collection {
  ...
  @override
  String toString() {
    return 'Collection(description: $description, payment_tokens: $payment_tokens, safelist_request_status: $safelist_request_status, slug: $slug, banner_image_url: $banner_image_url, created_at: $created_at, editors: $editors, image_url: $image_url, name: $name, seller_fees: $seller_fees, payout_address: $payout_address, primary_asset_contracts: $primary_asset_contracts, external_link: $external_link, stats: $stats, traits: $traits)';
  }
...
class _$_Contract implements _Contract {
  ...
  @override
  String toString() {
    return 'Contract(name: $name, owner: $owner, payout_address: $payout_address, schema: $schema, seller_fees: $seller_fees, symbol: $symbol, address: $address, created_at: $created_at, description: $description, type: $type)';
  }
...
class _$_Sale implements _Sale {
  ...
  @override
  String toString() {
    return 'Sale(event_type: $event_type, payment_token: $payment_token, quantity: $quantity, transaction: $transaction, asset_token_id: $asset_token_id, created_at: $created_at, total_price: $total_price, asset_decimals: $asset_decimals, event_timestamp: $event_timestamp)';
  }
