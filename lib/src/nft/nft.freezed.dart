...
class _$_Asset implements _Asset {
  ...
  @override
  String toString() {
    return 'Asset(listing_date: $listing_date, sales: $sales, name: $name, token_id: $token_id, traits: $traits, collection: $collection, creator: $creator, id: $id, image_url: $image_url, last_sale: $last_sale, permalink: $permalink, contract: $contract, description: $description, owner: $owner, presale: $presale)';
  }
...
class _$_Collection implements _Collection {
  ...
  @override
  String toString() {
    return 'Collection(editors: $editors, payment_tokens: $payment_tokens, payout_address: $payout_address, stats: $stats, traits: $traits, description: $description, image_url: $image_url, external_link: $external_link, primary_asset_contracts: $primary_asset_contracts, seller_fees: $seller_fees, slug: $slug, banner_image_url: $banner_image_url, created_at: $created_at, name: $name, safelist_request_status: $safelist_request_status)';
  }
...
class _$_Contract implements _Contract {
  ...
  @override
  String toString() {
    return 'Contract(owner: $owner, schema: $schema, seller_fees: $seller_fees, type: $type, address: $address, name: $name, payout_address: $payout_address, symbol: $symbol, created_at: $created_at, description: $description)';
  }
...
class _$_Sale implements _Sale {
  ...
  @override
  String toString() {
    return 'Sale(payment_token: $payment_token, asset_token_id: $asset_token_id, created_at: $created_at, event_type: $event_type, quantity: $quantity, total_price: $total_price, transaction: $transaction, asset_decimals: $asset_decimals, event_timestamp: $event_timestamp)';
  }
