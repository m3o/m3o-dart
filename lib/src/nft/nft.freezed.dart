...
class _$_Asset implements _Asset {
  ...
  @override
  String toString() {
    return 'Asset(collection: $collection, description: $description, permalink: $permalink, contract: $contract, owner: $owner, presale: $presale, traits: $traits, id: $id, listing_date: $listing_date, name: $name, token_id: $token_id, creator: $creator, image_url: $image_url, last_sale: $last_sale, sales: $sales)';
  }
...
class _$_Collection implements _Collection {
  ...
  @override
  String toString() {
    return 'Collection(banner_image_url: $banner_image_url, external_link: $external_link, payout_address: $payout_address, traits: $traits, created_at: $created_at, payment_tokens: $payment_tokens, safelist_request_status: $safelist_request_status, stats: $stats, description: $description, image_url: $image_url, name: $name, primary_asset_contracts: $primary_asset_contracts, seller_fees: $seller_fees, slug: $slug, editors: $editors)';
  }
...
class _$_Contract implements _Contract {
  ...
  @override
  String toString() {
    return 'Contract(seller_fees: $seller_fees, type: $type, description: $description, payout_address: $payout_address, name: $name, owner: $owner, schema: $schema, symbol: $symbol, address: $address, created_at: $created_at)';
  }
...
class _$_Sale implements _Sale {
  ...
  @override
  String toString() {
    return 'Sale(created_at: $created_at, event_type: $event_type, asset_decimals: $asset_decimals, event_timestamp: $event_timestamp, payment_token: $payment_token, quantity: $quantity, total_price: $total_price, transaction: $transaction, asset_token_id: $asset_token_id)';
  }
