...
class _$_Asset implements _Asset {
  ...
  @override
  String toString() {
    return 'Asset(last_sale: $last_sale, presale: $presale, token_id: $token_id, name: $name, permalink: $permalink, collection: $collection, listing_date: $listing_date, id: $id, image_url: $image_url, owner: $owner, sales: $sales, traits: $traits, contract: $contract, creator: $creator, description: $description)';
  }
...
class _$_Collection implements _Collection {
  ...
  @override
  String toString() {
    return 'Collection(payment_tokens: $payment_tokens, primary_asset_contracts: $primary_asset_contracts, safelist_request_status: $safelist_request_status, description: $description, editors: $editors, image_url: $image_url, stats: $stats, traits: $traits, created_at: $created_at, name: $name, payout_address: $payout_address, seller_fees: $seller_fees, slug: $slug, banner_image_url: $banner_image_url, external_link: $external_link)';
  }
...
class _$_Contract implements _Contract {
  ...
  @override
  String toString() {
    return 'Contract(owner: $owner, schema: $schema, seller_fees: $seller_fees, symbol: $symbol, address: $address, name: $name, payout_address: $payout_address, type: $type, created_at: $created_at, description: $description)';
  }
