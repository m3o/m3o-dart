...
class _$_Asset implements _Asset {
  ...
  @override
  String toString() {
    return 'Asset(description: $description, permalink: $permalink, traits: $traits, contract: $contract, sales: $sales, collection: $collection, creator: $creator, image_url: $image_url, last_sale: $last_sale, listing_date: $listing_date, owner: $owner, presale: $presale, token_id: $token_id, id: $id, name: $name)';
  }
...
class _$_Collection implements _Collection {
  ...
  @override
  String toString() {
    return 'Collection(name: $name, safelist_request_status: $safelist_request_status, editors: $editors, external_link: $external_link, payment_tokens: $payment_tokens, seller_fees: $seller_fees, stats: $stats, traits: $traits, description: $description, primary_asset_contracts: $primary_asset_contracts, banner_image_url: $banner_image_url, created_at: $created_at, image_url: $image_url, payout_address: $payout_address, slug: $slug)';
  }
...
class _$_Contract implements _Contract {
  ...
  @override
  String toString() {
    return 'Contract(description: $description, name: $name, owner: $owner, payout_address: $payout_address, seller_fees: $seller_fees, symbol: $symbol, type: $type, address: $address, schema: $schema, created_at: $created_at)';
  }
...
class _$_Sale implements _Sale {
  ...
  @override
  String toString() {
    return 'Sale(asset_decimals: $asset_decimals, asset_token_id: $asset_token_id, event_timestamp: $event_timestamp, payment_token: $payment_token, quantity: $quantity, total_price: $total_price, created_at: $created_at, event_type: $event_type, transaction: $transaction)';
  }
