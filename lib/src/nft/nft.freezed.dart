...
class _$_Asset implements _Asset {
  ...
  @override
  String toString() {
    return 'Asset(collection: $collection, creator: $creator, presale: $presale, token_id: $token_id, traits: $traits, contract: $contract, description: $description, image_url: $image_url, last_sale: $last_sale, owner: $owner, permalink: $permalink, id: $id, listing_date: $listing_date, name: $name, sales: $sales)';
  }
...
class _$_Collection implements _Collection {
  ...
  @override
  String toString() {
    return 'Collection(description: $description, banner_image_url: $banner_image_url, created_at: $created_at, payment_tokens: $payment_tokens, traits: $traits, editors: $editors, external_link: $external_link, image_url: $image_url, name: $name, primary_asset_contracts: $primary_asset_contracts, seller_fees: $seller_fees, payout_address: $payout_address, safelist_request_status: $safelist_request_status, slug: $slug, stats: $stats)';
  }
...
class _$_Contract implements _Contract {
  ...
  @override
  String toString() {
    return 'Contract(address: $address, created_at: $created_at, description: $description, owner: $owner, seller_fees: $seller_fees, symbol: $symbol, name: $name, payout_address: $payout_address, schema: $schema, type: $type)';
  }
...
class _$_Sale implements _Sale {
  ...
  @override
  String toString() {
    return 'Sale(transaction: $transaction, event_timestamp: $event_timestamp, event_type: $event_type, payment_token: $payment_token, total_price: $total_price, asset_decimals: $asset_decimals, asset_token_id: $asset_token_id, created_at: $created_at, quantity: $quantity)';
  }
