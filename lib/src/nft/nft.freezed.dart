...
class _$_Asset implements _Asset {
  ...
  @override
  String toString() {
    return 'Asset(creator: $creator, permalink: $permalink, traits: $traits, image_url: $image_url, name: $name, owner: $owner, token_id: $token_id, id: $id, last_sale: $last_sale, presale: $presale, collection: $collection, contract: $contract, description: $description, listing_date: $listing_date, sales: $sales)';
  }
...
class _$_Collection implements _Collection {
  ...
  @override
  String toString() {
    return 'Collection(created_at: $created_at, editors: $editors, slug: $slug, banner_image_url: $banner_image_url, description: $description, name: $name, payment_tokens: $payment_tokens, payout_address: $payout_address, stats: $stats, seller_fees: $seller_fees, traits: $traits, external_link: $external_link, image_url: $image_url, primary_asset_contracts: $primary_asset_contracts, safelist_request_status: $safelist_request_status)';
  }
...
class _$_Contract implements _Contract {
  ...
  @override
  String toString() {
    return 'Contract(address: $address, created_at: $created_at, symbol: $symbol, type: $type, schema: $schema, seller_fees: $seller_fees, description: $description, name: $name, owner: $owner, payout_address: $payout_address)';
  }
