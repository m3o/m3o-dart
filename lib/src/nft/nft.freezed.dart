...
class _$_Asset implements _Asset {
  ...
  @override
  String toString() {
    return 'Asset(permalink: $permalink, presale: $presale, traits: $traits, id: $id, name: $name, image_url: $image_url, last_sale: $last_sale, creator: $creator, description: $description, listing_date: $listing_date, owner: $owner, sales: $sales, token_id: $token_id, collection: $collection, contract: $contract)';
  }
...
class _$_Collection implements _Collection {
  ...
  @override
  String toString() {
    return 'Collection(name: $name, payout_address: $payout_address, seller_fees: $seller_fees, stats: $stats, traits: $traits, description: $description, primary_asset_contracts: $primary_asset_contracts, safelist_request_status: $safelist_request_status, slug: $slug, banner_image_url: $banner_image_url, external_link: $external_link, editors: $editors, image_url: $image_url, payment_tokens: $payment_tokens, created_at: $created_at)';
  }
...
class _$_Contract implements _Contract {
  ...
  @override
  String toString() {
    return 'Contract(address: $address, owner: $owner, payout_address: $payout_address, schema: $schema, symbol: $symbol, created_at: $created_at, description: $description, name: $name, seller_fees: $seller_fees, type: $type)';
  }
...
class _$_Sale implements _Sale {
  ...
  @override
  String toString() {
    return 'Sale(asset_token_id: $asset_token_id, created_at: $created_at, event_type: $event_type, payment_token: $payment_token, quantity: $quantity, total_price: $total_price, transaction: $transaction, asset_decimals: $asset_decimals, event_timestamp: $event_timestamp)';
  }
