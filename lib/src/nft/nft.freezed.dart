...
class _$_Asset implements _Asset {
  ...
  @override
  String toString() {
    return 'Asset(sales: $sales, token_id: $token_id, creator: $creator, description: $description, id: $id, image_url: $image_url, last_sale: $last_sale, name: $name, contract: $contract, owner: $owner, presale: $presale, traits: $traits, collection: $collection, listing_date: $listing_date, permalink: $permalink)';
  }
...
class _$_Collection implements _Collection {
  ...
  @override
  String toString() {
    return 'Collection(description: $description, external_link: $external_link, traits: $traits, banner_image_url: $banner_image_url, editors: $editors, safelist_request_status: $safelist_request_status, stats: $stats, payout_address: $payout_address, seller_fees: $seller_fees, slug: $slug, primary_asset_contracts: $primary_asset_contracts, created_at: $created_at, image_url: $image_url, name: $name, payment_tokens: $payment_tokens)';
  }
...
class _$_Contract implements _Contract {
  ...
  @override
  String toString() {
    return 'Contract(schema: $schema, seller_fees: $seller_fees, symbol: $symbol, description: $description, payout_address: $payout_address, name: $name, owner: $owner, type: $type, address: $address, created_at: $created_at)';
  }
...
class _$_Sale implements _Sale {
  ...
  @override
  String toString() {
    return 'Sale(created_at: $created_at, total_price: $total_price, transaction: $transaction, asset_decimals: $asset_decimals, asset_token_id: $asset_token_id, event_timestamp: $event_timestamp, event_type: $event_type, payment_token: $payment_token, quantity: $quantity)';
  }
