...
class _$_Asset implements _Asset {
  ...
  @override
  String toString() {
    return 'Asset(name: $name, owner: $owner, presale: $presale, traits: $traits, collection: $collection, contract: $contract, creator: $creator, description: $description, id: $id, last_sale: $last_sale, listing_date: $listing_date, token_id: $token_id, image_url: $image_url, permalink: $permalink, sales: $sales)';
  }
...
class _$_AssetsRequest implements _AssetsRequest {
  ...
  @override
  String toString() {
    return 'AssetsRequest(offset: $offset, order: $order, order_by: $order_by, collection: $collection, cursor: $cursor, limit: $limit)';
  }
...
class _$_Collection implements _Collection {
  ...
  @override
  String toString() {
    return 'Collection(description: $description, payout_address: $payout_address, safelist_request_status: $safelist_request_status, created_at: $created_at, external_link: $external_link, payment_tokens: $payment_tokens, stats: $stats, banner_image_url: $banner_image_url, seller_fees: $seller_fees, slug: $slug, traits: $traits, editors: $editors, name: $name, primary_asset_contracts: $primary_asset_contracts, image_url: $image_url)';
  }
...
abstract class _Collection implements Collection {
  const factory _Collection(
      ...
      String? name,
      Contract? primary_asset_contracts,
      String? image_url}) = _$_Collection;
...
class _$_Contract implements _Contract {
  ...
  @override
  String toString() {
    return 'Contract(name: $name, owner: $owner, seller_fees: $seller_fees, symbol: $symbol, type: $type, address: $address, description: $description, schema: $schema, created_at: $created_at, payout_address: $payout_address)';
  }
...
class _$_Sale implements _Sale {
  ...
  @override
  String toString() {
    return 'Sale(asset_decimals: $asset_decimals, asset_token_id: $asset_token_id, event_timestamp: $event_timestamp, event_type: $event_type, created_at: $created_at, payment_token: $payment_token, quantity: $quantity, total_price: $total_price, transaction: $transaction)';
  }
