...
class _$_Asset implements _Asset {
  ...
  @override
  String toString() {
    return 'Asset(listing_date: $listing_date, sales: $sales, creator: $creator, description: $description, image_url: $image_url, name: $name, permalink: $permalink, traits: $traits, collection: $collection, contract: $contract, token_id: $token_id, owner: $owner, presale: $presale, id: $id, last_sale: $last_sale)';
  }
...
class _$_Collection implements _Collection {
  ...
  @override
  String toString() {
    return 'Collection(name: $name, slug: $slug, created_at: $created_at, description: $description, editors: $editors, payment_tokens: $payment_tokens, primary_asset_contracts: $primary_asset_contracts, banner_image_url: $banner_image_url, external_link: $external_link, image_url: $image_url, payout_address: $payout_address, seller_fees: $seller_fees, safelist_request_status: $safelist_request_status, stats: $stats, traits: $traits)';
  }
...
class _$_Contract implements _Contract {
  ...
  @override
  String toString() {
    return 'Contract(schema: $schema, seller_fees: $seller_fees, created_at: $created_at, description: $description, name: $name, owner: $owner, payout_address: $payout_address, symbol: $symbol, type: $type, address: $address)';
  }
...
class _$_Sale implements _Sale {
  ...
  @override
  String toString() {
    return 'Sale(asset_token_id: $asset_token_id, created_at: $created_at, event_timestamp: $event_timestamp, payment_token: $payment_token, quantity: $quantity, transaction: $transaction, asset_decimals: $asset_decimals, total_price: $total_price, event_type: $event_type)';
  }
