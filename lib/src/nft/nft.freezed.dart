...
class _$_Asset implements _Asset {
  ...
  @override
  String toString() {
    return 'Asset(last_sale: $last_sale, sales: $sales, token_id: $token_id, contract: $contract, creator: $creator, image_url: $image_url, permalink: $permalink, presale: $presale, description: $description, id: $id, name: $name, collection: $collection, traits: $traits, listing_date: $listing_date, owner: $owner)';
  }
...
class _$_Collection implements _Collection {
  ...
  @override
  String toString() {
    return 'Collection(external_link: $external_link, image_url: $image_url, payment_tokens: $payment_tokens, primary_asset_contracts: $primary_asset_contracts, stats: $stats, traits: $traits, created_at: $created_at, description: $description, editors: $editors, safelist_request_status: $safelist_request_status, slug: $slug, banner_image_url: $banner_image_url, name: $name, payout_address: $payout_address, seller_fees: $seller_fees)';
  }
...
class _$_Contract implements _Contract {
  ...
  @override
  String toString() {
    return 'Contract(owner: $owner, schema: $schema, symbol: $symbol, type: $type, address: $address, description: $description, name: $name, payout_address: $payout_address, seller_fees: $seller_fees, created_at: $created_at)';
  }
...
class _$_Sale implements _Sale {
  ...
  @override
  String toString() {
    return 'Sale(event_type: $event_type, payment_token: $payment_token, transaction: $transaction, total_price: $total_price, asset_decimals: $asset_decimals, asset_token_id: $asset_token_id, created_at: $created_at, event_timestamp: $event_timestamp, quantity: $quantity)';
  }
