...
class _$_Asset implements _Asset {
  ...
  @override
  String toString() {
    return 'Asset(contract: $contract, last_sale: $last_sale, owner: $owner, token_id: $token_id, presale: $presale, sales: $sales, name: $name, traits: $traits, image_url: $image_url, listing_date: $listing_date, permalink: $permalink, collection: $collection, creator: $creator, description: $description, id: $id)';
  }
...
class _$_Collection implements _Collection {
  ...
  @override
  String toString() {
    return 'Collection(banner_image_url: $banner_image_url, description: $description, name: $name, safelist_request_status: $safelist_request_status, image_url: $image_url, payment_tokens: $payment_tokens, traits: $traits, payout_address: $payout_address, primary_asset_contracts: $primary_asset_contracts, seller_fees: $seller_fees, created_at: $created_at, editors: $editors, external_link: $external_link, slug: $slug, stats: $stats)';
  }
...
class _$_Contract implements _Contract {
  ...
  @override
  String toString() {
    return 'Contract(name: $name, payout_address: $payout_address, schema: $schema, seller_fees: $seller_fees, symbol: $symbol, address: $address, created_at: $created_at, description: $description, owner: $owner, type: $type)';
  }
...
class _$_Sale implements _Sale {
  ...
  @override
  String toString() {
    return 'Sale(asset_decimals: $asset_decimals, asset_token_id: $asset_token_id, event_type: $event_type, payment_token: $payment_token, quantity: $quantity, created_at: $created_at, event_timestamp: $event_timestamp, total_price: $total_price, transaction: $transaction)';
  }
