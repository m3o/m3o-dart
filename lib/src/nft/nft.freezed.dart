...
class _$_Asset implements _Asset {
  ...
  @override
  String toString() {
    return 'Asset(image_url: $image_url, collection: $collection, creator: $creator, owner: $owner, traits: $traits, contract: $contract, description: $description, last_sale: $last_sale, presale: $presale, sales: $sales, token_id: $token_id, id: $id, listing_date: $listing_date, name: $name, permalink: $permalink)';
  }
...
class _$_Collection implements _Collection {
  ...
  @override
  String toString() {
    return 'Collection(safelist_request_status: $safelist_request_status, stats: $stats, image_url: $image_url, payout_address: $payout_address, seller_fees: $seller_fees, slug: $slug, created_at: $created_at, description: $description, external_link: $external_link, payment_tokens: $payment_tokens, primary_asset_contracts: $primary_asset_contracts, traits: $traits, banner_image_url: $banner_image_url, editors: $editors, name: $name)';
  }
...
class _$_Contract implements _Contract {
  ...
  @override
  String toString() {
    return 'Contract(created_at: $created_at, description: $description, name: $name, symbol: $symbol, address: $address, owner: $owner, payout_address: $payout_address, schema: $schema, seller_fees: $seller_fees, type: $type)';
  }
...
class _$_Sale implements _Sale {
  ...
  @override
  String toString() {
    return 'Sale(quantity: $quantity, asset_token_id: $asset_token_id, created_at: $created_at, event_type: $event_type, total_price: $total_price, transaction: $transaction, asset_decimals: $asset_decimals, event_timestamp: $event_timestamp, payment_token: $payment_token)';
  }
