...
class _$_Asset implements _Asset {
  ...
  @override
  String toString() {
    return 'Asset(id: $id, image_url: $image_url, name: $name, owner: $owner, collection: $collection, creator: $creator, description: $description, permalink: $permalink, contract: $contract, last_sale: $last_sale, listing_date: $listing_date, presale: $presale, sales: $sales, token_id: $token_id, traits: $traits)';
  }
...
class _$_Collection implements _Collection {
  ...
  @override
  String toString() {
    return 'Collection(created_at: $created_at, description: $description, external_link: $external_link, image_url: $image_url, primary_asset_contracts: $primary_asset_contracts, seller_fees: $seller_fees, name: $name, payout_address: $payout_address, slug: $slug, banner_image_url: $banner_image_url, safelist_request_status: $safelist_request_status, traits: $traits, editors: $editors, payment_tokens: $payment_tokens, stats: $stats)';
  }
...
class _$_Contract implements _Contract {
  ...
  @override
  String toString() {
    return 'Contract(created_at: $created_at, name: $name, owner: $owner, seller_fees: $seller_fees, symbol: $symbol, address: $address, description: $description, payout_address: $payout_address, schema: $schema, type: $type)';
  }
...
class _$_Sale implements _Sale {
  ...
  @override
  String toString() {
    return 'Sale(quantity: $quantity, transaction: $transaction, asset_decimals: $asset_decimals, asset_token_id: $asset_token_id, event_type: $event_type, payment_token: $payment_token, total_price: $total_price, created_at: $created_at, event_timestamp: $event_timestamp)';
  }
