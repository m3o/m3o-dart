...
class _$_Asset implements _Asset {
  ...
  @override
  String toString() {
    return 'Asset(description: $description, name: $name, presale: $presale, sales: $sales, collection: $collection, contract: $contract, last_sale: $last_sale, traits: $traits, image_url: $image_url, token_id: $token_id, creator: $creator, id: $id, listing_date: $listing_date, owner: $owner, permalink: $permalink)';
  }
...
class _$_Collection implements _Collection {
  ...
  @override
  String toString() {
    return 'Collection(external_link: $external_link, name: $name, payment_tokens: $payment_tokens, payout_address: $payout_address, traits: $traits, banner_image_url: $banner_image_url, created_at: $created_at, primary_asset_contracts: $primary_asset_contracts, safelist_request_status: $safelist_request_status, image_url: $image_url, seller_fees: $seller_fees, slug: $slug, stats: $stats, description: $description, editors: $editors)';
  }
...
class _$_Contract implements _Contract {
  ...
  @override
  String toString() {
    return 'Contract(address: $address, owner: $owner, payout_address: $payout_address, symbol: $symbol, created_at: $created_at, description: $description, name: $name, schema: $schema, seller_fees: $seller_fees, type: $type)';
  }
...
class _$_Sale implements _Sale {
  ...
  @override
  String toString() {
    return 'Sale(quantity: $quantity, event_timestamp: $event_timestamp, event_type: $event_type, payment_token: $payment_token, total_price: $total_price, transaction: $transaction, asset_decimals: $asset_decimals, asset_token_id: $asset_token_id, created_at: $created_at)';
  }
