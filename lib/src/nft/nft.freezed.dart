...
class _$_Asset implements _Asset {
  ...
  @override
  String toString() {
    return 'Asset(collection: $collection, contract: $contract, creator: $creator, image_url: $image_url, owner: $owner, token_id: $token_id, traits: $traits, last_sale: $last_sale, name: $name, presale: $presale, description: $description, id: $id, permalink: $permalink, sales: $sales, listing_date: $listing_date)';
  }
...
class _$_Collection implements _Collection {
  ...
  @override
  String toString() {
    return 'Collection(description: $description, created_at: $created_at, traits: $traits, editors: $editors, payment_tokens: $payment_tokens, primary_asset_contracts: $primary_asset_contracts, stats: $stats, safelist_request_status: $safelist_request_status, seller_fees: $seller_fees, slug: $slug, banner_image_url: $banner_image_url, external_link: $external_link, image_url: $image_url, name: $name, payout_address: $payout_address)';
  }
...
class _$_Contract implements _Contract {
  ...
  @override
  String toString() {
    return 'Contract(seller_fees: $seller_fees, created_at: $created_at, description: $description, name: $name, owner: $owner, payout_address: $payout_address, address: $address, schema: $schema, symbol: $symbol, type: $type)';
  }
...
class _$_Sale implements _Sale {
  ...
  @override
  String toString() {
    return 'Sale(created_at: $created_at, quantity: $quantity, total_price: $total_price, asset_decimals: $asset_decimals, event_timestamp: $event_timestamp, event_type: $event_type, payment_token: $payment_token, transaction: $transaction, asset_token_id: $asset_token_id)';
  }
