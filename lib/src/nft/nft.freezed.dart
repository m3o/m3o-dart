...
class _$_Asset implements _Asset {
  ...
  @override
  String toString() {
    return 'Asset(owner: $owner, image_url: $image_url, creator: $creator, description: $description, listing_date: $listing_date, permalink: $permalink, traits: $traits, contract: $contract, sales: $sales, token_id: $token_id, last_sale: $last_sale, id: $id, name: $name, presale: $presale, collection: $collection)';
  }
...
class _$_Collection implements _Collection {
  ...
  @override
  String toString() {
    return 'Collection(slug: $slug, image_url: $image_url, payout_address: $payout_address, safelist_request_status: $safelist_request_status, external_link: $external_link, traits: $traits, payment_tokens: $payment_tokens, primary_asset_contracts: $primary_asset_contracts, stats: $stats, banner_image_url: $banner_image_url, editors: $editors, name: $name, created_at: $created_at, description: $description, seller_fees: $seller_fees)';
  }
...
class _$_Contract implements _Contract {
  ...
  @override
  String toString() {
    return 'Contract(seller_fees: $seller_fees, symbol: $symbol, type: $type, created_at: $created_at, name: $name, owner: $owner, schema: $schema, address: $address, description: $description, payout_address: $payout_address)';
  }
