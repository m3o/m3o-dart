...
class _$_Asset implements _Asset {
  ...
  @override
  String toString() {
    return 'Asset(contract: $contract, last_sale: $last_sale, name: $name, token_id: $token_id, image_url: $image_url, description: $description, listing_date: $listing_date, owner: $owner, permalink: $permalink, presale: $presale, traits: $traits, collection: $collection, id: $id, sales: $sales, creator: $creator)';
  }
...
class _$_Collection implements _Collection {
  ...
  @override
  String toString() {
    return 'Collection(description: $description, payout_address: $payout_address, primary_asset_contracts: $primary_asset_contracts, traits: $traits, name: $name, payment_tokens: $payment_tokens, safelist_request_status: $safelist_request_status, slug: $slug, banner_image_url: $banner_image_url, editors: $editors, image_url: $image_url, seller_fees: $seller_fees, created_at: $created_at, external_link: $external_link, stats: $stats)';
  }
...
class _$_Contract implements _Contract {
  ...
  @override
  String toString() {
    return 'Contract(schema: $schema, seller_fees: $seller_fees, description: $description, created_at: $created_at, name: $name, owner: $owner, payout_address: $payout_address, symbol: $symbol, type: $type, address: $address)';
  }
...
class _$_Sale implements _Sale {
  ...
  @override
  String toString() {
    return 'Sale(event_type: $event_type, payment_token: $payment_token, total_price: $total_price, asset_decimals: $asset_decimals, asset_token_id: $asset_token_id, created_at: $created_at, event_timestamp: $event_timestamp, quantity: $quantity, transaction: $transaction)';
  }
