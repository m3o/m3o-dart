...
class _$_Asset implements _Asset {
  ...
  @override
  String toString() {
    return 'Asset(contract: $contract, owner: $owner, permalink: $permalink, traits: $traits, description: $description, image_url: $image_url, token_id: $token_id, collection: $collection, last_sale: $last_sale, presale: $presale, sales: $sales, creator: $creator, id: $id, listing_date: $listing_date, name: $name)';
  }
...
class _$_Collection implements _Collection {
  ...
  @override
  String toString() {
    return 'Collection(description: $description, external_link: $external_link, payout_address: $payout_address, stats: $stats, traits: $traits, created_at: $created_at, editors: $editors, name: $name, primary_asset_contracts: $primary_asset_contracts, seller_fees: $seller_fees, image_url: $image_url, payment_tokens: $payment_tokens, slug: $slug, banner_image_url: $banner_image_url, safelist_request_status: $safelist_request_status)';
  }
...
class _$_Contract implements _Contract {
  ...
  @override
  String toString() {
    return 'Contract(address: $address, created_at: $created_at, description: $description, payout_address: $payout_address, type: $type, name: $name, owner: $owner, schema: $schema, seller_fees: $seller_fees, symbol: $symbol)';
  }
...
class _$_Sale implements _Sale {
  ...
  @override
  String toString() {
    return 'Sale(asset_decimals: $asset_decimals, created_at: $created_at, event_timestamp: $event_timestamp, total_price: $total_price, transaction: $transaction, asset_token_id: $asset_token_id, event_type: $event_type, payment_token: $payment_token, quantity: $quantity)';
  }
