...
class _$_Asset implements _Asset {
  ...
  @override
  String toString() {
    return 'Asset(listing_date: $listing_date, owner: $owner, permalink: $permalink, presale: $presale, collection: $collection, contract: $contract, id: $id, creator: $creator, image_url: $image_url, sales: $sales, traits: $traits, description: $description, last_sale: $last_sale, name: $name, token_id: $token_id)';
  }
...
class _$_Collection implements _Collection {
  ...
  @override
  String toString() {
    return 'Collection(created_at: $created_at, external_link: $external_link, description: $description, image_url: $image_url, primary_asset_contracts: $primary_asset_contracts, slug: $slug, traits: $traits, payout_address: $payout_address, seller_fees: $seller_fees, stats: $stats, banner_image_url: $banner_image_url, editors: $editors, name: $name, payment_tokens: $payment_tokens, safelist_request_status: $safelist_request_status)';
  }
...
class _$_Contract implements _Contract {
  ...
  @override
  String toString() {
    return 'Contract(seller_fees: $seller_fees, address: $address, created_at: $created_at, description: $description, name: $name, payout_address: $payout_address, schema: $schema, owner: $owner, symbol: $symbol, type: $type)';
  }
...
class _$_Sale implements _Sale {
  ...
  @override
  String toString() {
    return 'Sale(payment_token: $payment_token, quantity: $quantity, asset_decimals: $asset_decimals, asset_token_id: $asset_token_id, event_timestamp: $event_timestamp, event_type: $event_type, created_at: $created_at, total_price: $total_price, transaction: $transaction)';
  }
