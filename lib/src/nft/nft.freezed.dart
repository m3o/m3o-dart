...
class _$_Asset implements _Asset {
  ...
  @override
  String toString() {
    return 'Asset(contract: $contract, sales: $sales, token_id: $token_id, traits: $traits, image_url: $image_url, last_sale: $last_sale, listing_date: $listing_date, permalink: $permalink, description: $description, id: $id, owner: $owner, collection: $collection, creator: $creator, name: $name, presale: $presale)';
  }
...
class _$_Collection implements _Collection {
  ...
  @override
  String toString() {
    return 'Collection(description: $description, primary_asset_contracts: $primary_asset_contracts, safelist_request_status: $safelist_request_status, seller_fees: $seller_fees, created_at: $created_at, external_link: $external_link, image_url: $image_url, slug: $slug, editors: $editors, traits: $traits, banner_image_url: $banner_image_url, name: $name, payment_tokens: $payment_tokens, payout_address: $payout_address, stats: $stats)';
  }
...
class _$_Contract implements _Contract {
  ...
  @override
  String toString() {
    return 'Contract(owner: $owner, payout_address: $payout_address, schema: $schema, symbol: $symbol, type: $type, created_at: $created_at, description: $description, name: $name, seller_fees: $seller_fees, address: $address)';
  }
...
class _$_Sale implements _Sale {
  ...
  @override
  String toString() {
    return 'Sale(event_type: $event_type, payment_token: $payment_token, quantity: $quantity, transaction: $transaction, asset_decimals: $asset_decimals, created_at: $created_at, total_price: $total_price, asset_token_id: $asset_token_id, event_timestamp: $event_timestamp)';
  }
