...
class _$_Asset implements _Asset {
  ...
  @override
  String toString() {
    return 'Asset(image_url: $image_url, creator: $creator, name: $name, sales: $sales, traits: $traits, collection: $collection, contract: $contract, description: $description, listing_date: $listing_date, owner: $owner, token_id: $token_id, id: $id, last_sale: $last_sale, permalink: $permalink, presale: $presale)';
  }
...
class _$_Collection implements _Collection {
  ...
  @override
  String toString() {
    return 'Collection(external_link: $external_link, name: $name, description: $description, editors: $editors, slug: $slug, stats: $stats, traits: $traits, image_url: $image_url, primary_asset_contracts: $primary_asset_contracts, payout_address: $payout_address, safelist_request_status: $safelist_request_status, created_at: $created_at, payment_tokens: $payment_tokens, banner_image_url: $banner_image_url, seller_fees: $seller_fees)';
  }
...
class _$_Contract implements _Contract {
  ...
  @override
  String toString() {
    return 'Contract(address: $address, created_at: $created_at, description: $description, owner: $owner, payout_address: $payout_address, schema: $schema, seller_fees: $seller_fees, symbol: $symbol, type: $type, name: $name)';
  }
...
class _$_Sale implements _Sale {
  ...
  @override
  String toString() {
    return 'Sale(asset_decimals: $asset_decimals, created_at: $created_at, event_timestamp: $event_timestamp, quantity: $quantity, asset_token_id: $asset_token_id, event_type: $event_type, payment_token: $payment_token, total_price: $total_price, transaction: $transaction)';
  }
