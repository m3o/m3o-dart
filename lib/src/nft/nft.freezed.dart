...
class _$_Asset implements _Asset {
  ...
  @override
  String toString() {
    return 'Asset(traits: $traits, listing_date: $listing_date, name: $name, last_sale: $last_sale, permalink: $permalink, contract: $contract, image_url: $image_url, sales: $sales, token_id: $token_id, description: $description, id: $id, owner: $owner, presale: $presale, collection: $collection, creator: $creator)';
  }
...
class _$_Collection implements _Collection {
  ...
  @override
  String toString() {
    return 'Collection(name: $name, payment_tokens: $payment_tokens, safelist_request_status: $safelist_request_status, stats: $stats, description: $description, external_link: $external_link, primary_asset_contracts: $primary_asset_contracts, created_at: $created_at, editors: $editors, banner_image_url: $banner_image_url, payout_address: $payout_address, slug: $slug, traits: $traits, image_url: $image_url, seller_fees: $seller_fees)';
  }
...
class _$_Contract implements _Contract {
  ...
  @override
  String toString() {
    return 'Contract(owner: $owner, payout_address: $payout_address, symbol: $symbol, type: $type, address: $address, created_at: $created_at, description: $description, name: $name, schema: $schema, seller_fees: $seller_fees)';
  }
...
class _$_Sale implements _Sale {
  ...
  @override
  String toString() {
    return 'Sale(transaction: $transaction, created_at: $created_at, event_timestamp: $event_timestamp, quantity: $quantity, payment_token: $payment_token, total_price: $total_price, asset_decimals: $asset_decimals, asset_token_id: $asset_token_id, event_type: $event_type)';
  }
