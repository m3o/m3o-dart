...
class _$_Asset implements _Asset {
  ...
  @override
  String toString() {
    return 'Asset(collection: $collection, contract: $contract, presale: $presale, sales: $sales, token_id: $token_id, traits: $traits, creator: $creator, last_sale: $last_sale, listing_date: $listing_date, permalink: $permalink, description: $description, id: $id, image_url: $image_url, name: $name, owner: $owner)';
  }
...
class _$_Collection implements _Collection {
  ...
  @override
  String toString() {
    return 'Collection(editors: $editors, payout_address: $payout_address, seller_fees: $seller_fees, slug: $slug, created_at: $created_at, external_link: $external_link, name: $name, stats: $stats, image_url: $image_url, traits: $traits, banner_image_url: $banner_image_url, description: $description, payment_tokens: $payment_tokens, primary_asset_contracts: $primary_asset_contracts, safelist_request_status: $safelist_request_status)';
  }
...
class _$_Contract implements _Contract {
  ...
  @override
  String toString() {
    return 'Contract(description: $description, name: $name, owner: $owner, schema: $schema, type: $type, address: $address, created_at: $created_at, symbol: $symbol, payout_address: $payout_address, seller_fees: $seller_fees)';
  }
...
class _$_Sale implements _Sale {
  ...
  @override
  String toString() {
    return 'Sale(quantity: $quantity, asset_token_id: $asset_token_id, event_type: $event_type, payment_token: $payment_token, total_price: $total_price, transaction: $transaction, asset_decimals: $asset_decimals, created_at: $created_at, event_timestamp: $event_timestamp)';
  }
