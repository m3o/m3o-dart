...
class _$_Asset implements _Asset {
  ...
  @override
  String toString() {
    return 'Asset(id: $id, last_sale: $last_sale, owner: $owner, traits: $traits, contract: $contract, presale: $presale, sales: $sales, name: $name, creator: $creator, description: $description, image_url: $image_url, permalink: $permalink, collection: $collection, token_id: $token_id, listing_date: $listing_date)';
  }
...
class _$_Collection implements _Collection {
  ...
  @override
  String toString() {
    return 'Collection(editors: $editors, name: $name, slug: $slug, traits: $traits, banner_image_url: $banner_image_url, image_url: $image_url, seller_fees: $seller_fees, stats: $stats, external_link: $external_link, payment_tokens: $payment_tokens, payout_address: $payout_address, safelist_request_status: $safelist_request_status, created_at: $created_at, description: $description, primary_asset_contracts: $primary_asset_contracts)';
  }
...
class _$_Contract implements _Contract {
  ...
  @override
  String toString() {
    return 'Contract(address: $address, description: $description, payout_address: $payout_address, seller_fees: $seller_fees, type: $type, created_at: $created_at, name: $name, owner: $owner, schema: $schema, symbol: $symbol)';
  }
...
class _$_Sale implements _Sale {
  ...
  @override
  String toString() {
    return 'Sale(total_price: $total_price, transaction: $transaction, asset_decimals: $asset_decimals, asset_token_id: $asset_token_id, event_timestamp: $event_timestamp, event_type: $event_type, payment_token: $payment_token, quantity: $quantity, created_at: $created_at)';
  }
