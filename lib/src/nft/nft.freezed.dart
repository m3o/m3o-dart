...
class _$_Asset implements _Asset {
  ...
  @override
  String toString() {
    return 'Asset(presale: $presale, image_url: $image_url, last_sale: $last_sale, permalink: $permalink, token_id: $token_id, contract: $contract, creator: $creator, sales: $sales, traits: $traits, description: $description, name: $name, listing_date: $listing_date, owner: $owner, collection: $collection, id: $id)';
  }
...
class _$_Collection implements _Collection {
  ...
  @override
  String toString() {
    return 'Collection(payout_address: $payout_address, seller_fees: $seller_fees, stats: $stats, created_at: $created_at, description: $description, external_link: $external_link, payment_tokens: $payment_tokens, primary_asset_contracts: $primary_asset_contracts, banner_image_url: $banner_image_url, editors: $editors, image_url: $image_url, slug: $slug, traits: $traits, name: $name, safelist_request_status: $safelist_request_status)';
  }
...
class _$_Contract implements _Contract {
  ...
  @override
  String toString() {
    return 'Contract(symbol: $symbol, type: $type, description: $description, payout_address: $payout_address, schema: $schema, owner: $owner, seller_fees: $seller_fees, address: $address, created_at: $created_at, name: $name)';
  }
...
class _$_Sale implements _Sale {
  ...
  @override
  String toString() {
    return 'Sale(quantity: $quantity, transaction: $transaction, asset_decimals: $asset_decimals, created_at: $created_at, event_type: $event_type, payment_token: $payment_token, asset_token_id: $asset_token_id, event_timestamp: $event_timestamp, total_price: $total_price)';
  }
