...
class _$_Asset implements _Asset {
  ...
  @override
  String toString() {
    return 'Asset(collection: $collection, creator: $creator, token_id: $token_id, contract: $contract, image_url: $image_url, sales: $sales, description: $description, id: $id, last_sale: $last_sale, name: $name, owner: $owner, listing_date: $listing_date, permalink: $permalink, presale: $presale, traits: $traits)';
  }
...
class _$_Collection implements _Collection {
  ...
  @override
  String toString() {
    return 'Collection(created_at: $created_at, editors: $editors, primary_asset_contracts: $primary_asset_contracts, safelist_request_status: $safelist_request_status, stats: $stats, image_url: $image_url, name: $name, seller_fees: $seller_fees, banner_image_url: $banner_image_url, traits: $traits, description: $description, external_link: $external_link, payment_tokens: $payment_tokens, payout_address: $payout_address, slug: $slug)';
  }
...
class _$_Contract implements _Contract {
  ...
  @override
  String toString() {
    return 'Contract(owner: $owner, schema: $schema, seller_fees: $seller_fees, type: $type, address: $address, description: $description, name: $name, created_at: $created_at, payout_address: $payout_address, symbol: $symbol)';
  }
...
class _$_Sale implements _Sale {
  ...
  @override
  String toString() {
    return 'Sale(asset_decimals: $asset_decimals, asset_token_id: $asset_token_id, created_at: $created_at, event_timestamp: $event_timestamp, transaction: $transaction, event_type: $event_type, payment_token: $payment_token, quantity: $quantity, total_price: $total_price)';
  }
