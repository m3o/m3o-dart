...
class _$_Asset implements _Asset {
  ...
  @override
  String toString() {
    return 'Asset(contract: $contract, id: $id, listing_date: $listing_date, image_url: $image_url, collection: $collection, description: $description, name: $name, owner: $owner, permalink: $permalink, presale: $presale, token_id: $token_id, traits: $traits, creator: $creator, last_sale: $last_sale, sales: $sales)';
  }
...
class _$_Collection implements _Collection {
  ...
  @override
  String toString() {
    return 'Collection(description: $description, image_url: $image_url, slug: $slug, primary_asset_contracts: $primary_asset_contracts, safelist_request_status: $safelist_request_status, editors: $editors, external_link: $external_link, payout_address: $payout_address, seller_fees: $seller_fees, stats: $stats, traits: $traits, banner_image_url: $banner_image_url, created_at: $created_at, name: $name, payment_tokens: $payment_tokens)';
  }
...
class _$_Sale implements _Sale {
  ...
  @override
  String toString() {
    return 'Sale(asset_token_id: $asset_token_id, payment_token: $payment_token, transaction: $transaction, asset_decimals: $asset_decimals, created_at: $created_at, event_timestamp: $event_timestamp, event_type: $event_type, quantity: $quantity, total_price: $total_price)';
  }
