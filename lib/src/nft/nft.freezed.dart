...
class _$_Asset implements _Asset {
  ...
  @override
  String toString() {
    return 'Asset(creator: $creator, id: $id, image_url: $image_url, listing_date: $listing_date, owner: $owner, collection: $collection, name: $name, permalink: $permalink, sales: $sales, contract: $contract, last_sale: $last_sale, presale: $presale, token_id: $token_id, traits: $traits, description: $description)';
  }
...
class _$_Collection implements _Collection {
  ...
  @override
  String toString() {
    return 'Collection(payout_address: $payout_address, primary_asset_contracts: $primary_asset_contracts, banner_image_url: $banner_image_url, created_at: $created_at, external_link: $external_link, editors: $editors, image_url: $image_url, name: $name, slug: $slug, stats: $stats, seller_fees: $seller_fees, traits: $traits, description: $description, payment_tokens: $payment_tokens, safelist_request_status: $safelist_request_status)';
  }
...
class _$_Contract implements _Contract {
  ...
  @override
  String toString() {
    return 'Contract(name: $name, owner: $owner, payout_address: $payout_address, schema: $schema, type: $type, address: $address, created_at: $created_at, description: $description, seller_fees: $seller_fees, symbol: $symbol)';
  }
...
class _$_Sale implements _Sale {
  ...
  @override
  String toString() {
    return 'Sale(asset_token_id: $asset_token_id, created_at: $created_at, event_timestamp: $event_timestamp, event_type: $event_type, quantity: $quantity, asset_decimals: $asset_decimals, total_price: $total_price, transaction: $transaction, payment_token: $payment_token)';
  }
