...
class _$_Asset implements _Asset {
  ...
  @override
  String toString() {
    return 'Asset(name: $name, contract: $contract, creator: $creator, description: $description, image_url: $image_url, permalink: $permalink, collection: $collection, id: $id, presale: $presale, sales: $sales, token_id: $token_id, traits: $traits, last_sale: $last_sale, listing_date: $listing_date, owner: $owner)';
  }
...
class _$_Collection implements _Collection {
  ...
  @override
  String toString() {
    return 'Collection(seller_fees: $seller_fees, created_at: $created_at, external_link: $external_link, name: $name, payout_address: $payout_address, safelist_request_status: $safelist_request_status, banner_image_url: $banner_image_url, description: $description, image_url: $image_url, editors: $editors, primary_asset_contracts: $primary_asset_contracts, stats: $stats, traits: $traits, payment_tokens: $payment_tokens, slug: $slug)';
  }
...
class _$_Contract implements _Contract {
  ...
  @override
  String toString() {
    return 'Contract(description: $description, payout_address: $payout_address, seller_fees: $seller_fees, symbol: $symbol, type: $type, address: $address, created_at: $created_at, name: $name, owner: $owner, schema: $schema)';
  }
...
class _$_Sale implements _Sale {
  ...
  @override
  String toString() {
    return 'Sale(event_timestamp: $event_timestamp, event_type: $event_type, total_price: $total_price, asset_token_id: $asset_token_id, created_at: $created_at, payment_token: $payment_token, quantity: $quantity, transaction: $transaction, asset_decimals: $asset_decimals)';
  }
