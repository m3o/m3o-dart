...
class _$_Asset implements _Asset {
  ...
  @override
  String toString() {
    return 'Asset(creator: $creator, id: $id, name: $name, owner: $owner, sales: $sales, last_sale: $last_sale, listing_date: $listing_date, token_id: $token_id, traits: $traits, collection: $collection, contract: $contract, permalink: $permalink, presale: $presale, description: $description, image_url: $image_url)';
  }
...
class _$_Collection implements _Collection {
  ...
  @override
  String toString() {
    return 'Collection(stats: $stats, traits: $traits, description: $description, editors: $editors, payout_address: $payout_address, slug: $slug, seller_fees: $seller_fees, created_at: $created_at, name: $name, payment_tokens: $payment_tokens, primary_asset_contracts: $primary_asset_contracts, banner_image_url: $banner_image_url, external_link: $external_link, image_url: $image_url, safelist_request_status: $safelist_request_status)';
  }
...
class _$_Contract implements _Contract {
  ...
  @override
  String toString() {
    return 'Contract(seller_fees: $seller_fees, type: $type, created_at: $created_at, description: $description, name: $name, payout_address: $payout_address, address: $address, owner: $owner, schema: $schema, symbol: $symbol)';
  }
...
class _$_Sale implements _Sale {
  ...
  @override
  String toString() {
    return 'Sale(asset_decimals: $asset_decimals, event_type: $event_type, quantity: $quantity, total_price: $total_price, transaction: $transaction, asset_token_id: $asset_token_id, created_at: $created_at, event_timestamp: $event_timestamp, payment_token: $payment_token)';
  }
