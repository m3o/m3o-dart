...
class _$_Asset implements _Asset {
  ...
  @override
  String toString() {
    return 'Asset(listing_date: $listing_date, name: $name, last_sale: $last_sale, id: $id, sales: $sales, contract: $contract, image_url: $image_url, presale: $presale, token_id: $token_id, traits: $traits, collection: $collection, description: $description, owner: $owner, permalink: $permalink, creator: $creator)';
  }
...
class _$_Collection implements _Collection {
  ...
  @override
  String toString() {
    return 'Collection(payout_address: $payout_address, editors: $editors, image_url: $image_url, name: $name, payment_tokens: $payment_tokens, external_link: $external_link, primary_asset_contracts: $primary_asset_contracts, stats: $stats, banner_image_url: $banner_image_url, description: $description, traits: $traits, created_at: $created_at, safelist_request_status: $safelist_request_status, seller_fees: $seller_fees, slug: $slug)';
  }
...
class _$_Contract implements _Contract {
  ...
  @override
  String toString() {
    return 'Contract(symbol: $symbol, type: $type, address: $address, name: $name, schema: $schema, seller_fees: $seller_fees, created_at: $created_at, description: $description, owner: $owner, payout_address: $payout_address)';
  }
...
class _$_Sale implements _Sale {
  ...
  @override
  String toString() {
    return 'Sale(asset_decimals: $asset_decimals, event_timestamp: $event_timestamp, event_type: $event_type, quantity: $quantity, transaction: $transaction, asset_token_id: $asset_token_id, created_at: $created_at, payment_token: $payment_token, total_price: $total_price)';
  }
