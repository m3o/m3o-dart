...
class _$_Asset implements _Asset {
  ...
  @override
  String toString() {
    return 'Asset(last_sale: $last_sale, name: $name, owner: $owner, token_id: $token_id, traits: $traits, creator: $creator, description: $description, permalink: $permalink, presale: $presale, sales: $sales, collection: $collection, id: $id, image_url: $image_url, contract: $contract, listing_date: $listing_date)';
  }
...
class _$_Collection implements _Collection {
  ...
  @override
  String toString() {
    return 'Collection(editors: $editors, external_link: $external_link, primary_asset_contracts: $primary_asset_contracts, banner_image_url: $banner_image_url, created_at: $created_at, image_url: $image_url, payout_address: $payout_address, seller_fees: $seller_fees, slug: $slug, description: $description, payment_tokens: $payment_tokens, name: $name, safelist_request_status: $safelist_request_status, stats: $stats, traits: $traits)';
  }
...
class _$_Contract implements _Contract {
  ...
  @override
  String toString() {
    return 'Contract(type: $type, address: $address, created_at: $created_at, name: $name, payout_address: $payout_address, schema: $schema, seller_fees: $seller_fees, description: $description, owner: $owner, symbol: $symbol)';
  }
