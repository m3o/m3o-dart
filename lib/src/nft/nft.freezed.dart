...
class _$_Asset implements _Asset {
  ...
  @override
  String toString() {
    return 'Asset(last_sale: $last_sale, sales: $sales, collection: $collection, image_url: $image_url, owner: $owner, presale: $presale, traits: $traits, creator: $creator, description: $description, listing_date: $listing_date, permalink: $permalink, token_id: $token_id, contract: $contract, id: $id, name: $name)';
  }
...
class _$_Collection implements _Collection {
  ...
  @override
  String toString() {
    return 'Collection(safelist_request_status: $safelist_request_status, slug: $slug, stats: $stats, created_at: $created_at, image_url: $image_url, primary_asset_contracts: $primary_asset_contracts, name: $name, seller_fees: $seller_fees, traits: $traits, description: $description, editors: $editors, external_link: $external_link, payout_address: $payout_address, banner_image_url: $banner_image_url, payment_tokens: $payment_tokens)';
  }
...
class _$_Contract implements _Contract {
  ...
  @override
  String toString() {
    return 'Contract(description: $description, payout_address: $payout_address, schema: $schema, seller_fees: $seller_fees, created_at: $created_at, name: $name, owner: $owner, symbol: $symbol, type: $type, address: $address)';
  }
...
class _$_Sale implements _Sale {
  ...
  @override
  String toString() {
    return 'Sale(event_type: $event_type, payment_token: $payment_token, quantity: $quantity, total_price: $total_price, transaction: $transaction, asset_decimals: $asset_decimals, asset_token_id: $asset_token_id, created_at: $created_at, event_timestamp: $event_timestamp)';
  }
