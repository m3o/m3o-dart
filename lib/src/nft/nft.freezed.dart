...
class _$_Asset implements _Asset {
  ...
  @override
  String toString() {
    return 'Asset(token_id: $token_id, permalink: $permalink, name: $name, image_url: $image_url, contract: $contract, id: $id, collection: $collection, description: $description, last_sale: $last_sale, listing_date: $listing_date, owner: $owner, presale: $presale, sales: $sales, traits: $traits, creator: $creator)';
  }
...
class _$_Collection implements _Collection {
  ...
  @override
  String toString() {
    return 'Collection(description: $description, editors: $editors, external_link: $external_link, payout_address: $payout_address, safelist_request_status: $safelist_request_status, banner_image_url: $banner_image_url, created_at: $created_at, stats: $stats, traits: $traits, name: $name, seller_fees: $seller_fees, slug: $slug, image_url: $image_url, payment_tokens: $payment_tokens, primary_asset_contracts: $primary_asset_contracts)';
  }
...
class _$_Contract implements _Contract {
  ...
  @override
  String toString() {
    return 'Contract(name: $name, schema: $schema, address: $address, created_at: $created_at, description: $description, symbol: $symbol, type: $type, owner: $owner, payout_address: $payout_address, seller_fees: $seller_fees)';
  }
...
class _$_Sale implements _Sale {
  ...
  @override
  String toString() {
    return 'Sale(event_type: $event_type, payment_token: $payment_token, total_price: $total_price, transaction: $transaction, asset_decimals: $asset_decimals, event_timestamp: $event_timestamp, quantity: $quantity, asset_token_id: $asset_token_id, created_at: $created_at)';
  }
