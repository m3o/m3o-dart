...
class _$_Asset implements _Asset {
  ...
  @override
  String toString() {
    return 'Asset(permalink: $permalink, presale: $presale, listing_date: $listing_date, name: $name, owner: $owner, contract: $contract, sales: $sales, token_id: $token_id, image_url: $image_url, traits: $traits, collection: $collection, creator: $creator, description: $description, id: $id, last_sale: $last_sale)';
  }
...
class _$_Collection implements _Collection {
  ...
  @override
  String toString() {
    return 'Collection(payment_tokens: $payment_tokens, slug: $slug, traits: $traits, created_at: $created_at, editors: $editors, image_url: $image_url, description: $description, stats: $stats, safelist_request_status: $safelist_request_status, banner_image_url: $banner_image_url, payout_address: $payout_address, primary_asset_contracts: $primary_asset_contracts, external_link: $external_link, name: $name, seller_fees: $seller_fees)';
  }
...
class _$_Sale implements _Sale {
  ...
  @override
  String toString() {
    return 'Sale(asset_token_id: $asset_token_id, event_type: $event_type, payment_token: $payment_token, quantity: $quantity, total_price: $total_price, asset_decimals: $asset_decimals, created_at: $created_at, event_timestamp: $event_timestamp, transaction: $transaction)';
  }
