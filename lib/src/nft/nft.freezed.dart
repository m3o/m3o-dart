...
class _$_Asset implements _Asset {
  ...
  @override
  String toString() {
    return 'Asset(collection: $collection, name: $name, owner: $owner, last_sale: $last_sale, contract: $contract, creator: $creator, id: $id, description: $description, presale: $presale, traits: $traits, sales: $sales, token_id: $token_id, image_url: $image_url, listing_date: $listing_date, permalink: $permalink)';
  }
...
class _$_Collection implements _Collection {
  ...
  @override
  String toString() {
    return 'Collection(editors: $editors, created_at: $created_at, slug: $slug, stats: $stats, traits: $traits, banner_image_url: $banner_image_url, description: $description, name: $name, payment_tokens: $payment_tokens, payout_address: $payout_address, safelist_request_status: $safelist_request_status, seller_fees: $seller_fees, external_link: $external_link, image_url: $image_url, primary_asset_contracts: $primary_asset_contracts)';
  }
...
class _$_Contract implements _Contract {
  ...
  @override
  String toString() {
    return 'Contract(address: $address, created_at: $created_at, description: $description, name: $name, schema: $schema, symbol: $symbol, type: $type, owner: $owner, payout_address: $payout_address, seller_fees: $seller_fees)';
  }
...
class _$_Sale implements _Sale {
  ...
  @override
  String toString() {
    return 'Sale(transaction: $transaction, asset_token_id: $asset_token_id, total_price: $total_price, event_timestamp: $event_timestamp, event_type: $event_type, payment_token: $payment_token, quantity: $quantity, asset_decimals: $asset_decimals, created_at: $created_at)';
  }
