...
class _$_Asset implements _Asset {
  ...
  @override
  String toString() {
    return 'Asset(description: $description, id: $id, owner: $owner, sales: $sales, traits: $traits, creator: $creator, listing_date: $listing_date, name: $name, collection: $collection, permalink: $permalink, presale: $presale, token_id: $token_id, contract: $contract, image_url: $image_url, last_sale: $last_sale)';
  }
...
class _$_Collection implements _Collection {
  ...
  @override
  String toString() {
    return 'Collection(safelist_request_status: $safelist_request_status, seller_fees: $seller_fees, slug: $slug, stats: $stats, editors: $editors, created_at: $created_at, description: $description, image_url: $image_url, traits: $traits, banner_image_url: $banner_image_url, name: $name, payment_tokens: $payment_tokens, payout_address: $payout_address, primary_asset_contracts: $primary_asset_contracts, external_link: $external_link)';
  }
...
class _$_Contract implements _Contract {
  ...
  @override
  String toString() {
    return 'Contract(payout_address: $payout_address, symbol: $symbol, type: $type, description: $description, created_at: $created_at, name: $name, owner: $owner, schema: $schema, seller_fees: $seller_fees, address: $address)';
  }
