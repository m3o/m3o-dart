...
class _$_Asset implements _Asset {
  ...
  @override
  String toString() {
    return 'Asset(traits: $traits, image_url: $image_url, name: $name, creator: $creator, last_sale: $last_sale, listing_date: $listing_date, owner: $owner, presale: $presale, sales: $sales, token_id: $token_id, description: $description, contract: $contract, id: $id, permalink: $permalink, collection: $collection)';
  }
...
class _$_Collection implements _Collection {
  ...
  @override
  String toString() {
    return 'Collection(name: $name, payment_tokens: $payment_tokens, payout_address: $payout_address, slug: $slug, stats: $stats, traits: $traits, created_at: $created_at, external_link: $external_link, primary_asset_contracts: $primary_asset_contracts, safelist_request_status: $safelist_request_status, banner_image_url: $banner_image_url, editors: $editors, image_url: $image_url, seller_fees: $seller_fees, description: $description)';
  }
...
class _$_Contract implements _Contract {
  ...
  @override
  String toString() {
    return 'Contract(seller_fees: $seller_fees, type: $type, name: $name, owner: $owner, payout_address: $payout_address, schema: $schema, symbol: $symbol, address: $address, created_at: $created_at, description: $description)';
  }
...
class _$_Sale implements _Sale {
  ...
  @override
  String toString() {
    return 'Sale(asset_decimals: $asset_decimals, created_at: $created_at, quantity: $quantity, total_price: $total_price, transaction: $transaction, asset_token_id: $asset_token_id, event_timestamp: $event_timestamp, event_type: $event_type, payment_token: $payment_token)';
  }
