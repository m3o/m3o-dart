...
class _$_Asset implements _Asset {
  ...
  @override
  String toString() {
    return 'Asset(creator: $creator, owner: $owner, sales: $sales, token_id: $token_id, collection: $collection, image_url: $image_url, last_sale: $last_sale, name: $name, description: $description, id: $id, listing_date: $listing_date, permalink: $permalink, presale: $presale, traits: $traits, contract: $contract)';
  }
...
class _$_Collection implements _Collection {
  ...
  @override
  String toString() {
    return 'Collection(traits: $traits, banner_image_url: $banner_image_url, image_url: $image_url, name: $name, payment_tokens: $payment_tokens, safelist_request_status: $safelist_request_status, stats: $stats, description: $description, external_link: $external_link, created_at: $created_at, editors: $editors, payout_address: $payout_address, primary_asset_contracts: $primary_asset_contracts, seller_fees: $seller_fees, slug: $slug)';
  }
...
class _$_Contract implements _Contract {
  ...
  @override
  String toString() {
    return 'Contract(created_at: $created_at, payout_address: $payout_address, type: $type, seller_fees: $seller_fees, symbol: $symbol, address: $address, description: $description, name: $name, owner: $owner, schema: $schema)';
  }
...
class _$_Sale implements _Sale {
  ...
  @override
  String toString() {
    return 'Sale(total_price: $total_price, asset_decimals: $asset_decimals, quantity: $quantity, event_timestamp: $event_timestamp, event_type: $event_type, payment_token: $payment_token, transaction: $transaction, asset_token_id: $asset_token_id, created_at: $created_at)';
  }
