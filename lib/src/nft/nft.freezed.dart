...
class _$_Asset implements _Asset {
  ...
  @override
  String toString() {
    return 'Asset(creator: $creator, image_url: $image_url, permalink: $permalink, sales: $sales, token_id: $token_id, collection: $collection, contract: $contract, presale: $presale, name: $name, description: $description, listing_date: $listing_date, owner: $owner, traits: $traits, id: $id, last_sale: $last_sale)';
  }
...
class _$_Collection implements _Collection {
  ...
  @override
  String toString() {
    return 'Collection(editors: $editors, image_url: $image_url, payout_address: $payout_address, description: $description, safelist_request_status: $safelist_request_status, slug: $slug, stats: $stats, external_link: $external_link, seller_fees: $seller_fees, traits: $traits, banner_image_url: $banner_image_url, created_at: $created_at, name: $name, payment_tokens: $payment_tokens, primary_asset_contracts: $primary_asset_contracts)';
  }
...
class _$_Contract implements _Contract {
  ...
  @override
  String toString() {
    return 'Contract(schema: $schema, seller_fees: $seller_fees, type: $type, address: $address, name: $name, owner: $owner, payout_address: $payout_address, symbol: $symbol, created_at: $created_at, description: $description)';
  }
...
class _$_Sale implements _Sale {
  ...
  @override
  String toString() {
    return 'Sale(asset_token_id: $asset_token_id, event_type: $event_type, payment_token: $payment_token, total_price: $total_price, transaction: $transaction, asset_decimals: $asset_decimals, event_timestamp: $event_timestamp, quantity: $quantity, created_at: $created_at)';
  }
