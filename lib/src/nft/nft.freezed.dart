...
class _$_Asset implements _Asset {
  ...
  @override
  String toString() {
    return 'Asset(contract: $contract, id: $id, last_sale: $last_sale, owner: $owner, permalink: $permalink, name: $name, sales: $sales, token_id: $token_id, traits: $traits, collection: $collection, description: $description, image_url: $image_url, presale: $presale, creator: $creator, listing_date: $listing_date)';
  }
...
class _$_Collection implements _Collection {
  ...
  @override
  String toString() {
    return 'Collection(description: $description, editors: $editors, primary_asset_contracts: $primary_asset_contracts, seller_fees: $seller_fees, stats: $stats, image_url: $image_url, slug: $slug, traits: $traits, created_at: $created_at, payout_address: $payout_address, banner_image_url: $banner_image_url, external_link: $external_link, name: $name, payment_tokens: $payment_tokens, safelist_request_status: $safelist_request_status)';
  }
...
class _$CollectionsRequestTearOff {
  ...
  _CollectionsRequest call({String? owner, int? limit, int? offset}) {
...
abstract class _CollectionsRequest implements CollectionsRequest {
  const factory _CollectionsRequest({String? owner, int? limit, int? offset}) =
...
class _$_Contract implements _Contract {
  ...
  @override
  String toString() {
    return 'Contract(symbol: $symbol, type: $type, owner: $owner, payout_address: $payout_address, seller_fees: $seller_fees, name: $name, schema: $schema, address: $address, created_at: $created_at, description: $description)';
  }
...
class _$_Sale implements _Sale {
  ...
  @override
  String toString() {
    return 'Sale(created_at: $created_at, event_type: $event_type, total_price: $total_price, asset_token_id: $asset_token_id, event_timestamp: $event_timestamp, payment_token: $payment_token, quantity: $quantity, transaction: $transaction, asset_decimals: $asset_decimals)';
  }
