...
class _$_Asset implements _Asset {
  ...
  @override
  String toString() {
    return 'Asset(creator: $creator, id: $id, owner: $owner, collection: $collection, image_url: $image_url, last_sale: $last_sale, token_id: $token_id, description: $description, presale: $presale, sales: $sales, traits: $traits, permalink: $permalink, listing_date: $listing_date, name: $name, contract: $contract)';
  }
...
class _$_Collection implements _Collection {
  ...
  @override
  String toString() {
    return 'Collection(payout_address: $payout_address, banner_image_url: $banner_image_url, description: $description, primary_asset_contracts: $primary_asset_contracts, slug: $slug, created_at: $created_at, external_link: $external_link, safelist_request_status: $safelist_request_status, seller_fees: $seller_fees, traits: $traits, name: $name, payment_tokens: $payment_tokens, stats: $stats, editors: $editors, image_url: $image_url)';
  }
...
class _$_Contract implements _Contract {
  ...
  @override
  String toString() {
    return 'Contract(address: $address, created_at: $created_at, description: $description, name: $name, payout_address: $payout_address, type: $type, owner: $owner, schema: $schema, seller_fees: $seller_fees, symbol: $symbol)';
  }
...
class _$_Sale implements _Sale {
  ...
  @override
  String toString() {
    return 'Sale(event_timestamp: $event_timestamp, event_type: $event_type, quantity: $quantity, total_price: $total_price, transaction: $transaction, asset_decimals: $asset_decimals, created_at: $created_at, asset_token_id: $asset_token_id, payment_token: $payment_token)';
  }
