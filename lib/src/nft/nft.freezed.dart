...
class _$_Asset implements _Asset {
  ...
  @override
  String toString() {
    return 'Asset(description: $description, image_url: $image_url, traits: $traits, collection: $collection, name: $name, owner: $owner, contract: $contract, creator: $creator, last_sale: $last_sale, permalink: $permalink, sales: $sales, token_id: $token_id, id: $id, listing_date: $listing_date, presale: $presale)';
  }
...
class _$_Collection implements _Collection {
  ...
  @override
  String toString() {
    return 'Collection(payment_tokens: $payment_tokens, payout_address: $payout_address, primary_asset_contracts: $primary_asset_contracts, seller_fees: $seller_fees, slug: $slug, editors: $editors, created_at: $created_at, traits: $traits, banner_image_url: $banner_image_url, image_url: $image_url, safelist_request_status: $safelist_request_status, stats: $stats, external_link: $external_link, name: $name, description: $description)';
  }
...
class _$_Contract implements _Contract {
  ...
  @override
  String toString() {
    return 'Contract(schema: $schema, symbol: $symbol, name: $name, owner: $owner, payout_address: $payout_address, seller_fees: $seller_fees, type: $type, address: $address, created_at: $created_at, description: $description)';
  }
...
class _$_Sale implements _Sale {
  ...
  @override
  String toString() {
    return 'Sale(asset_decimals: $asset_decimals, event_timestamp: $event_timestamp, payment_token: $payment_token, quantity: $quantity, asset_token_id: $asset_token_id, created_at: $created_at, event_type: $event_type, total_price: $total_price, transaction: $transaction)';
  }
