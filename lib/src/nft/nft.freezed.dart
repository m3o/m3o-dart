...
class _$_Asset implements _Asset {
  ...
  @override
  String toString() {
    return 'Asset(description: $description, last_sale: $last_sale, name: $name, presale: $presale, traits: $traits, collection: $collection, listing_date: $listing_date, owner: $owner, sales: $sales, token_id: $token_id, image_url: $image_url, creator: $creator, id: $id, permalink: $permalink, contract: $contract)';
  }
...
class _$_Collection implements _Collection {
  ...
  @override
  String toString() {
    return 'Collection(name: $name, payment_tokens: $payment_tokens, created_at: $created_at, description: $description, editors: $editors, external_link: $external_link, slug: $slug, payout_address: $payout_address, safelist_request_status: $safelist_request_status, stats: $stats, traits: $traits, banner_image_url: $banner_image_url, image_url: $image_url, primary_asset_contracts: $primary_asset_contracts, seller_fees: $seller_fees)';
  }
...
class _$_Contract implements _Contract {
  ...
  @override
  String toString() {
    return 'Contract(address: $address, description: $description, type: $type, created_at: $created_at, name: $name, owner: $owner, payout_address: $payout_address, schema: $schema, seller_fees: $seller_fees, symbol: $symbol)';
  }
...
class _$_Sale implements _Sale {
  ...
  @override
  String toString() {
    return 'Sale(asset_token_id: $asset_token_id, created_at: $created_at, event_timestamp: $event_timestamp, event_type: $event_type, total_price: $total_price, asset_decimals: $asset_decimals, payment_token: $payment_token, quantity: $quantity, transaction: $transaction)';
  }
