...
class _$_Asset implements _Asset {
  ...
  @override
  String toString() {
    return 'Asset(contract: $contract, id: $id, last_sale: $last_sale, permalink: $permalink, presale: $presale, traits: $traits, creator: $creator, description: $description, image_url: $image_url, listing_date: $listing_date, name: $name, owner: $owner, collection: $collection, sales: $sales, token_id: $token_id)';
  }
...
class _$_Collection implements _Collection {
  ...
  @override
  String toString() {
    return 'Collection(safelist_request_status: $safelist_request_status, traits: $traits, banner_image_url: $banner_image_url, created_at: $created_at, stats: $stats, image_url: $image_url, slug: $slug, seller_fees: $seller_fees, description: $description, payment_tokens: $payment_tokens, name: $name, payout_address: $payout_address, primary_asset_contracts: $primary_asset_contracts, editors: $editors, external_link: $external_link)';
  }
...
class _$_Contract implements _Contract {
  ...
  @override
  String toString() {
    return 'Contract(address: $address, created_at: $created_at, payout_address: $payout_address, symbol: $symbol, description: $description, name: $name, owner: $owner, schema: $schema, seller_fees: $seller_fees, type: $type)';
  }
...
class _$_Sale implements _Sale {
  ...
  @override
  String toString() {
    return 'Sale(asset_decimals: $asset_decimals, asset_token_id: $asset_token_id, created_at: $created_at, event_timestamp: $event_timestamp, payment_token: $payment_token, event_type: $event_type, quantity: $quantity, total_price: $total_price, transaction: $transaction)';
  }
