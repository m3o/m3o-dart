...
class _$_Asset implements _Asset {
  ...
  @override
  String toString() {
    return 'Asset(id: $id, name: $name, sales: $sales, contract: $contract, creator: $creator, listing_date: $listing_date, owner: $owner, collection: $collection, image_url: $image_url, last_sale: $last_sale, token_id: $token_id, description: $description, permalink: $permalink, presale: $presale, traits: $traits)';
  }
...
class _$_Collection implements _Collection {
  ...
  @override
  String toString() {
    return 'Collection(image_url: $image_url, name: $name, safelist_request_status: $safelist_request_status, seller_fees: $seller_fees, traits: $traits, external_link: $external_link, slug: $slug, payout_address: $payout_address, primary_asset_contracts: $primary_asset_contracts, stats: $stats, banner_image_url: $banner_image_url, description: $description, editors: $editors, payment_tokens: $payment_tokens, created_at: $created_at)';
  }
...
class _$_Contract implements _Contract {
  ...
  @override
  String toString() {
    return 'Contract(address: $address, created_at: $created_at, payout_address: $payout_address, seller_fees: $seller_fees, type: $type, description: $description, name: $name, owner: $owner, schema: $schema, symbol: $symbol)';
  }
...
class _$_Sale implements _Sale {
  ...
  @override
  String toString() {
    return 'Sale(total_price: $total_price, transaction: $transaction, asset_token_id: $asset_token_id, created_at: $created_at, payment_token: $payment_token, quantity: $quantity, asset_decimals: $asset_decimals, event_timestamp: $event_timestamp, event_type: $event_type)';
  }
