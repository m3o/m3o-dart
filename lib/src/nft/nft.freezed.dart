...
class _$_Asset implements _Asset {
  ...
  @override
  String toString() {
    return 'Asset(permalink: $permalink, presale: $presale, traits: $traits, description: $description, id: $id, name: $name, creator: $creator, image_url: $image_url, contract: $contract, last_sale: $last_sale, owner: $owner, token_id: $token_id, collection: $collection, listing_date: $listing_date, sales: $sales)';
  }
...
class _$_Collection implements _Collection {
  ...
  @override
  String toString() {
    return 'Collection(external_link: $external_link, editors: $editors, image_url: $image_url, safelist_request_status: $safelist_request_status, slug: $slug, stats: $stats, description: $description, name: $name, payment_tokens: $payment_tokens, payout_address: $payout_address, primary_asset_contracts: $primary_asset_contracts, created_at: $created_at, seller_fees: $seller_fees, traits: $traits, banner_image_url: $banner_image_url)';
  }
...
class _$_Contract implements _Contract {
  ...
  @override
  String toString() {
    return 'Contract(name: $name, owner: $owner, payout_address: $payout_address, seller_fees: $seller_fees, type: $type, address: $address, created_at: $created_at, description: $description, schema: $schema, symbol: $symbol)';
  }
