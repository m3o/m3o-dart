...
class _$_Asset implements _Asset {
  ...
  @override
  String toString() {
    return 'Asset(owner: $owner, token_id: $token_id, creator: $creator, id: $id, image_url: $image_url, listing_date: $listing_date, name: $name, collection: $collection, contract: $contract, description: $description, last_sale: $last_sale, permalink: $permalink, presale: $presale, sales: $sales, traits: $traits)';
  }
...
class _$_Collection implements _Collection {
  ...
  @override
  String toString() {
    return 'Collection(name: $name, created_at: $created_at, image_url: $image_url, payout_address: $payout_address, traits: $traits, primary_asset_contracts: $primary_asset_contracts, slug: $slug, editors: $editors, external_link: $external_link, payment_tokens: $payment_tokens, safelist_request_status: $safelist_request_status, seller_fees: $seller_fees, stats: $stats, banner_image_url: $banner_image_url, description: $description)';
  }
...
class _$_Contract implements _Contract {
  ...
  @override
  String toString() {
    return 'Contract(type: $type, created_at: $created_at, description: $description, name: $name, owner: $owner, symbol: $symbol, address: $address, payout_address: $payout_address, schema: $schema, seller_fees: $seller_fees)';
  }
...
class _$_Sale implements _Sale {
  ...
  @override
  String toString() {
    return 'Sale(asset_decimals: $asset_decimals, asset_token_id: $asset_token_id, created_at: $created_at, payment_token: $payment_token, quantity: $quantity, event_timestamp: $event_timestamp, event_type: $event_type, total_price: $total_price, transaction: $transaction)';
  }
