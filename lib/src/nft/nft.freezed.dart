...
class _$_Asset implements _Asset {
  ...
  @override
  String toString() {
    return 'Asset(contract: $contract, creator: $creator, id: $id, permalink: $permalink, presale: $presale, traits: $traits, last_sale: $last_sale, collection: $collection, name: $name, owner: $owner, sales: $sales, description: $description, image_url: $image_url, listing_date: $listing_date, token_id: $token_id)';
  }
...
class _$_Collection implements _Collection {
  ...
  @override
  String toString() {
    return 'Collection(created_at: $created_at, payout_address: $payout_address, safelist_request_status: $safelist_request_status, banner_image_url: $banner_image_url, slug: $slug, description: $description, image_url: $image_url, name: $name, primary_asset_contracts: $primary_asset_contracts, seller_fees: $seller_fees, editors: $editors, external_link: $external_link, payment_tokens: $payment_tokens, stats: $stats, traits: $traits)';
  }
...
class _$_Sale implements _Sale {
  ...
  @override
  String toString() {
    return 'Sale(asset_token_id: $asset_token_id, event_type: $event_type, total_price: $total_price, payment_token: $payment_token, quantity: $quantity, transaction: $transaction, asset_decimals: $asset_decimals, created_at: $created_at, event_timestamp: $event_timestamp)';
  }
