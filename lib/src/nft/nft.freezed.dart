...
class _$_Asset implements _Asset {
  ...
  @override
  String toString() {
    return 'Asset(image_url: $image_url, token_id: $token_id, traits: $traits, owner: $owner, contract: $contract, creator: $creator, description: $description, name: $name, listing_date: $listing_date, permalink: $permalink, presale: $presale, sales: $sales, collection: $collection, id: $id, last_sale: $last_sale)';
  }
...
class _$_Collection implements _Collection {
  ...
  @override
  String toString() {
    return 'Collection(name: $name, primary_asset_contracts: $primary_asset_contracts, seller_fees: $seller_fees, slug: $slug, created_at: $created_at, external_link: $external_link, safelist_request_status: $safelist_request_status, payout_address: $payout_address, description: $description, editors: $editors, payment_tokens: $payment_tokens, stats: $stats, traits: $traits, banner_image_url: $banner_image_url, image_url: $image_url)';
  }
...
class _$_Contract implements _Contract {
  ...
  @override
  String toString() {
    return 'Contract(address: $address, description: $description, payout_address: $payout_address, schema: $schema, seller_fees: $seller_fees, symbol: $symbol, type: $type, created_at: $created_at, name: $name, owner: $owner)';
  }
...
class _$_Sale implements _Sale {
  ...
  @override
  String toString() {
    return 'Sale(transaction: $transaction, asset_decimals: $asset_decimals, asset_token_id: $asset_token_id, created_at: $created_at, payment_token: $payment_token, total_price: $total_price, event_timestamp: $event_timestamp, event_type: $event_type, quantity: $quantity)';
  }
