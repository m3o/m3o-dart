...
class _$_Asset implements _Asset {
  ...
  @override
  String toString() {
    return 'Asset(contract: $contract, image_url: $image_url, sales: $sales, token_id: $token_id, last_sale: $last_sale, name: $name, permalink: $permalink, creator: $creator, id: $id, presale: $presale, traits: $traits, collection: $collection, description: $description, listing_date: $listing_date, owner: $owner)';
  }
...
class _$_Collection implements _Collection {
  ...
  @override
  String toString() {
    return 'Collection(banner_image_url: $banner_image_url, created_at: $created_at, editors: $editors, name: $name, payment_tokens: $payment_tokens, image_url: $image_url, traits: $traits, primary_asset_contracts: $primary_asset_contracts, safelist_request_status: $safelist_request_status, slug: $slug, stats: $stats, description: $description, external_link: $external_link, payout_address: $payout_address, seller_fees: $seller_fees)';
  }
...
class _$_Sale implements _Sale {
  ...
  @override
  String toString() {
    return 'Sale(event_type: $event_type, payment_token: $payment_token, asset_token_id: $asset_token_id, created_at: $created_at, event_timestamp: $event_timestamp, quantity: $quantity, total_price: $total_price, transaction: $transaction, asset_decimals: $asset_decimals)';
  }
