...
class _$_Asset implements _Asset {
  ...
  @override
  String toString() {
    return 'Asset(collection: $collection, description: $description, permalink: $permalink, traits: $traits, id: $id, presale: $presale, sales: $sales, token_id: $token_id, creator: $creator, last_sale: $last_sale, owner: $owner, contract: $contract, image_url: $image_url, listing_date: $listing_date, name: $name)';
  }
...
class _$_Collection implements _Collection {
  ...
  @override
  String toString() {
    return 'Collection(banner_image_url: $banner_image_url, primary_asset_contracts: $primary_asset_contracts, safelist_request_status: $safelist_request_status, slug: $slug, traits: $traits, created_at: $created_at, editors: $editors, image_url: $image_url, name: $name, description: $description, stats: $stats, external_link: $external_link, payment_tokens: $payment_tokens, payout_address: $payout_address, seller_fees: $seller_fees)';
  }
...
class _$_Contract implements _Contract {
  ...
  @override
  String toString() {
    return 'Contract(address: $address, created_at: $created_at, description: $description, name: $name, symbol: $symbol, type: $type, owner: $owner, payout_address: $payout_address, schema: $schema, seller_fees: $seller_fees)';
  }
