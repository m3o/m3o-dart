...
class _$_Asset implements _Asset {
  ...
  @override
  String toString() {
    return 'Asset(traits: $traits, contract: $contract, description: $description, last_sale: $last_sale, presale: $presale, sales: $sales, permalink: $permalink, collection: $collection, creator: $creator, image_url: $image_url, listing_date: $listing_date, name: $name, id: $id, owner: $owner, token_id: $token_id)';
  }
...
class _$_Collection implements _Collection {
  ...
  @override
  String toString() {
    return 'Collection(banner_image_url: $banner_image_url, external_link: $external_link, primary_asset_contracts: $primary_asset_contracts, safelist_request_status: $safelist_request_status, name: $name, traits: $traits, editors: $editors, image_url: $image_url, payment_tokens: $payment_tokens, seller_fees: $seller_fees, created_at: $created_at, description: $description, payout_address: $payout_address, slug: $slug, stats: $stats)';
  }
...
class _$_Contract implements _Contract {
  ...
  @override
  String toString() {
    return 'Contract(name: $name, payout_address: $payout_address, schema: $schema, seller_fees: $seller_fees, address: $address, created_at: $created_at, symbol: $symbol, type: $type, description: $description, owner: $owner)';
  }
...
class _$_Sale implements _Sale {
  ...
  @override
  String toString() {
    return 'Sale(asset_decimals: $asset_decimals, quantity: $quantity, transaction: $transaction, asset_token_id: $asset_token_id, created_at: $created_at, event_timestamp: $event_timestamp, event_type: $event_type, payment_token: $payment_token, total_price: $total_price)';
  }
