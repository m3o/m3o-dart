...
class _$_Asset implements _Asset {
  ...
  @override
  String toString() {
    return 'Asset(creator: $creator, description: $description, id: $id, traits: $traits, collection: $collection, contract: $contract, image_url: $image_url, listing_date: $listing_date, owner: $owner, presale: $presale, token_id: $token_id, last_sale: $last_sale, name: $name, permalink: $permalink, sales: $sales)';
  }
...
class _$_Collection implements _Collection {
  ...
  @override
  String toString() {
    return 'Collection(seller_fees: $seller_fees, slug: $slug, editors: $editors, created_at: $created_at, external_link: $external_link, payment_tokens: $payment_tokens, safelist_request_status: $safelist_request_status, stats: $stats, banner_image_url: $banner_image_url, image_url: $image_url, name: $name, payout_address: $payout_address, primary_asset_contracts: $primary_asset_contracts, traits: $traits, description: $description)';
  }
...
class _$_Contract implements _Contract {
  ...
  @override
  String toString() {
    return 'Contract(address: $address, symbol: $symbol, type: $type, payout_address: $payout_address, schema: $schema, seller_fees: $seller_fees, created_at: $created_at, description: $description, name: $name, owner: $owner)';
  }
...
class _$_Sale implements _Sale {
  ...
  @override
  String toString() {
    return 'Sale(asset_token_id: $asset_token_id, created_at: $created_at, event_type: $event_type, payment_token: $payment_token, quantity: $quantity, transaction: $transaction, asset_decimals: $asset_decimals, total_price: $total_price, event_timestamp: $event_timestamp)';
  }
