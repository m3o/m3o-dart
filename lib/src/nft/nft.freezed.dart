...
class _$_Asset implements _Asset {
  ...
  @override
  String toString() {
    return 'Asset(contract: $contract, description: $description, id: $id, sales: $sales, last_sale: $last_sale, listing_date: $listing_date, owner: $owner, permalink: $permalink, presale: $presale, collection: $collection, creator: $creator, image_url: $image_url, token_id: $token_id, name: $name, traits: $traits)';
  }
...
class _$_Collection implements _Collection {
  ...
  @override
  String toString() {
    return 'Collection(description: $description, editors: $editors, stats: $stats, traits: $traits, safelist_request_status: $safelist_request_status, seller_fees: $seller_fees, image_url: $image_url, name: $name, primary_asset_contracts: $primary_asset_contracts, slug: $slug, banner_image_url: $banner_image_url, created_at: $created_at, external_link: $external_link, payment_tokens: $payment_tokens, payout_address: $payout_address)';
  }
...
class _$_Contract implements _Contract {
  ...
  @override
  String toString() {
    return 'Contract(address: $address, description: $description, name: $name, owner: $owner, symbol: $symbol, type: $type, created_at: $created_at, payout_address: $payout_address, schema: $schema, seller_fees: $seller_fees)';
  }
...
class _$_Sale implements _Sale {
  ...
  @override
  String toString() {
    return 'Sale(payment_token: $payment_token, asset_token_id: $asset_token_id, created_at: $created_at, event_type: $event_type, total_price: $total_price, transaction: $transaction, asset_decimals: $asset_decimals, event_timestamp: $event_timestamp, quantity: $quantity)';
  }
