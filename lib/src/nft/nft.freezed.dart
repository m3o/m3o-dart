...
class _$_Asset implements _Asset {
  ...
  @override
  String toString() {
    return 'Asset(sales: $sales, description: $description, id: $id, listing_date: $listing_date, creator: $creator, name: $name, permalink: $permalink, presale: $presale, last_sale: $last_sale, owner: $owner, token_id: $token_id, traits: $traits, collection: $collection, contract: $contract, image_url: $image_url)';
  }
...
class _$_Collection implements _Collection {
  ...
  @override
  String toString() {
    return 'Collection(editors: $editors, payment_tokens: $payment_tokens, payout_address: $payout_address, banner_image_url: $banner_image_url, created_at: $created_at, description: $description, image_url: $image_url, stats: $stats, external_link: $external_link, safelist_request_status: $safelist_request_status, seller_fees: $seller_fees, slug: $slug, name: $name, primary_asset_contracts: $primary_asset_contracts, traits: $traits)';
  }
...
class _$_Contract implements _Contract {
  ...
  @override
  String toString() {
    return 'Contract(schema: $schema, symbol: $symbol, description: $description, owner: $owner, payout_address: $payout_address, seller_fees: $seller_fees, type: $type, address: $address, created_at: $created_at, name: $name)';
  }
...
class _$_Sale implements _Sale {
  ...
  @override
  String toString() {
    return 'Sale(created_at: $created_at, payment_token: $payment_token, total_price: $total_price, transaction: $transaction, asset_decimals: $asset_decimals, asset_token_id: $asset_token_id, event_timestamp: $event_timestamp, event_type: $event_type, quantity: $quantity)';
  }
