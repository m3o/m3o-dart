...
class _$_Asset implements _Asset {
  ...
  @override
  String toString() {
    return 'Asset(name: $name, owner: $owner, description: $description, image_url: $image_url, token_id: $token_id, collection: $collection, creator: $creator, last_sale: $last_sale, traits: $traits, contract: $contract, id: $id, listing_date: $listing_date, permalink: $permalink, presale: $presale, sales: $sales)';
  }
...
class _$_Collection implements _Collection {
  ...
  @override
  String toString() {
    return 'Collection(payout_address: $payout_address, seller_fees: $seller_fees, banner_image_url: $banner_image_url, created_at: $created_at, external_link: $external_link, primary_asset_contracts: $primary_asset_contracts, description: $description, name: $name, payment_tokens: $payment_tokens, stats: $stats, traits: $traits, editors: $editors, safelist_request_status: $safelist_request_status, slug: $slug, image_url: $image_url)';
  }
...
class _$_Sale implements _Sale {
  ...
  @override
  String toString() {
    return 'Sale(asset_token_id: $asset_token_id, created_at: $created_at, payment_token: $payment_token, quantity: $quantity, asset_decimals: $asset_decimals, event_timestamp: $event_timestamp, event_type: $event_type, total_price: $total_price, transaction: $transaction)';
  }
