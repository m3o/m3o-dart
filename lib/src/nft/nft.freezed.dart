...
class _$_Asset implements _Asset {
  ...
  @override
  String toString() {
    return 'Asset(contract: $contract, description: $description, traits: $traits, image_url: $image_url, last_sale: $last_sale, listing_date: $listing_date, presale: $presale, token_id: $token_id, collection: $collection, owner: $owner, permalink: $permalink, creator: $creator, id: $id, name: $name, sales: $sales)';
  }
...
class _$_Collection implements _Collection {
  ...
  @override
  String toString() {
    return 'Collection(name: $name, slug: $slug, created_at: $created_at, description: $description, image_url: $image_url, payout_address: $payout_address, editors: $editors, primary_asset_contracts: $primary_asset_contracts, stats: $stats, traits: $traits, banner_image_url: $banner_image_url, external_link: $external_link, payment_tokens: $payment_tokens, safelist_request_status: $safelist_request_status, seller_fees: $seller_fees)';
  }
...
class _$_Contract implements _Contract {
  ...
  @override
  String toString() {
    return 'Contract(address: $address, name: $name, owner: $owner, schema: $schema, symbol: $symbol, created_at: $created_at, description: $description, payout_address: $payout_address, seller_fees: $seller_fees, type: $type)';
  }
...
class _$_Sale implements _Sale {
  ...
  @override
  String toString() {
    return 'Sale(payment_token: $payment_token, asset_decimals: $asset_decimals, asset_token_id: $asset_token_id, event_type: $event_type, quantity: $quantity, total_price: $total_price, transaction: $transaction, created_at: $created_at, event_timestamp: $event_timestamp)';
  }
