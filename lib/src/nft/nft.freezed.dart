...
class _$_Asset implements _Asset {
  ...
  @override
  String toString() {
    return 'Asset(traits: $traits, contract: $contract, id: $id, owner: $owner, sales: $sales, description: $description, listing_date: $listing_date, token_id: $token_id, image_url: $image_url, name: $name, permalink: $permalink, presale: $presale, collection: $collection, creator: $creator, last_sale: $last_sale)';
  }
...
class _$_Collection implements _Collection {
  ...
  @override
  String toString() {
    return 'Collection(banner_image_url: $banner_image_url, seller_fees: $seller_fees, safelist_request_status: $safelist_request_status, payment_tokens: $payment_tokens, primary_asset_contracts: $primary_asset_contracts, name: $name, payout_address: $payout_address, created_at: $created_at, external_link: $external_link, image_url: $image_url, slug: $slug, stats: $stats, traits: $traits, description: $description, editors: $editors)';
  }
...
class _$_Contract implements _Contract {
  ...
  @override
  String toString() {
    return 'Contract(address: $address, created_at: $created_at, name: $name, owner: $owner, payout_address: $payout_address, schema: $schema, seller_fees: $seller_fees, symbol: $symbol, type: $type, description: $description)';
  }
...
class _$_Sale implements _Sale {
  ...
  @override
  String toString() {
    return 'Sale(quantity: $quantity, asset_decimals: $asset_decimals, event_timestamp: $event_timestamp, event_type: $event_type, payment_token: $payment_token, total_price: $total_price, transaction: $transaction, asset_token_id: $asset_token_id, created_at: $created_at)';
  }
