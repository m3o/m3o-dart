...
class _$_Asset implements _Asset {
  ...
  @override
  String toString() {
    return 'Asset(contract: $contract, name: $name, owner: $owner, presale: $presale, sales: $sales, collection: $collection, token_id: $token_id, creator: $creator, id: $id, image_url: $image_url, last_sale: $last_sale, description: $description, permalink: $permalink, traits: $traits, listing_date: $listing_date)';
  }
...
class _$_Collection implements _Collection {
  ...
  @override
  String toString() {
    return 'Collection(payout_address: $payout_address, description: $description, image_url: $image_url, safelist_request_status: $safelist_request_status, seller_fees: $seller_fees, stats: $stats, banner_image_url: $banner_image_url, payment_tokens: $payment_tokens, created_at: $created_at, editors: $editors, primary_asset_contracts: $primary_asset_contracts, slug: $slug, traits: $traits, external_link: $external_link, name: $name)';
  }
...
class _$_Contract implements _Contract {
  ...
  @override
  String toString() {
    return 'Contract(address: $address, description: $description, name: $name, owner: $owner, payout_address: $payout_address, schema: $schema, seller_fees: $seller_fees, created_at: $created_at, symbol: $symbol, type: $type)';
  }
...
class _$_Sale implements _Sale {
  ...
  @override
  String toString() {
    return 'Sale(asset_token_id: $asset_token_id, event_timestamp: $event_timestamp, payment_token: $payment_token, asset_decimals: $asset_decimals, created_at: $created_at, event_type: $event_type, quantity: $quantity, total_price: $total_price, transaction: $transaction)';
  }
