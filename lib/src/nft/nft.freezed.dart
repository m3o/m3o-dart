...
class _$_Asset implements _Asset {
  ...
  @override
  String toString() {
    return 'Asset(sales: $sales, traits: $traits, contract: $contract, id: $id, image_url: $image_url, name: $name, last_sale: $last_sale, presale: $presale, collection: $collection, creator: $creator, listing_date: $listing_date, permalink: $permalink, description: $description, owner: $owner, token_id: $token_id)';
  }
...
class _$_Collection implements _Collection {
  ...
  @override
  String toString() {
    return 'Collection(created_at: $created_at, external_link: $external_link, primary_asset_contracts: $primary_asset_contracts, seller_fees: $seller_fees, slug: $slug, stats: $stats, image_url: $image_url, payment_tokens: $payment_tokens, payout_address: $payout_address, name: $name, safelist_request_status: $safelist_request_status, banner_image_url: $banner_image_url, description: $description, editors: $editors, traits: $traits)';
  }
...
class _$_Contract implements _Contract {
  ...
  @override
  String toString() {
    return 'Contract(symbol: $symbol, type: $type, address: $address, owner: $owner, payout_address: $payout_address, seller_fees: $seller_fees, created_at: $created_at, description: $description, name: $name, schema: $schema)';
  }
...
class _$_Sale implements _Sale {
  ...
  @override
  String toString() {
    return 'Sale(asset_decimals: $asset_decimals, event_timestamp: $event_timestamp, payment_token: $payment_token, total_price: $total_price, transaction: $transaction, asset_token_id: $asset_token_id, created_at: $created_at, event_type: $event_type, quantity: $quantity)';
  }
