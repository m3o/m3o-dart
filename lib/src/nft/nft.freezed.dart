...
class _$_Asset implements _Asset {
  ...
  @override
  String toString() {
    return 'Asset(image_url: $image_url, last_sale: $last_sale, name: $name, presale: $presale, sales: $sales, id: $id, traits: $traits, creator: $creator, contract: $contract, description: $description, owner: $owner, token_id: $token_id, collection: $collection, permalink: $permalink, listing_date: $listing_date)';
  }
...
class _$_Collection implements _Collection {
  ...
  @override
  String toString() {
    return 'Collection(payment_tokens: $payment_tokens, description: $description, editors: $editors, external_link: $external_link, image_url: $image_url, name: $name, primary_asset_contracts: $primary_asset_contracts, seller_fees: $seller_fees, traits: $traits, banner_image_url: $banner_image_url, safelist_request_status: $safelist_request_status, slug: $slug, stats: $stats, created_at: $created_at, payout_address: $payout_address)';
  }
...
class _$_Contract implements _Contract {
  ...
  @override
  String toString() {
    return 'Contract(address: $address, owner: $owner, payout_address: $payout_address, schema: $schema, seller_fees: $seller_fees, created_at: $created_at, description: $description, name: $name, symbol: $symbol, type: $type)';
  }
...
class _$_Sale implements _Sale {
  ...
  @override
  String toString() {
    return 'Sale(event_type: $event_type, payment_token: $payment_token, asset_decimals: $asset_decimals, event_timestamp: $event_timestamp, quantity: $quantity, total_price: $total_price, transaction: $transaction, asset_token_id: $asset_token_id, created_at: $created_at)';
  }
