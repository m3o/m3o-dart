...
class _$_Asset implements _Asset {
  ...
  @override
  String toString() {
    return 'Asset(permalink: $permalink, presale: $presale, token_id: $token_id, collection: $collection, contract: $contract, creator: $creator, id: $id, owner: $owner, sales: $sales, traits: $traits, last_sale: $last_sale, description: $description, image_url: $image_url, listing_date: $listing_date, name: $name)';
  }
...
class _$_Collection implements _Collection {
  ...
  @override
  String toString() {
    return 'Collection(seller_fees: $seller_fees, banner_image_url: $banner_image_url, name: $name, payout_address: $payout_address, description: $description, payment_tokens: $payment_tokens, primary_asset_contracts: $primary_asset_contracts, safelist_request_status: $safelist_request_status, slug: $slug, stats: $stats, external_link: $external_link, image_url: $image_url, traits: $traits, created_at: $created_at, editors: $editors)';
  }
...
class _$_Contract implements _Contract {
  ...
  @override
  String toString() {
    return 'Contract(address: $address, created_at: $created_at, name: $name, owner: $owner, payout_address: $payout_address, seller_fees: $seller_fees, type: $type, description: $description, schema: $schema, symbol: $symbol)';
  }
...
class _$_Sale implements _Sale {
  ...
  @override
  String toString() {
    return 'Sale(event_timestamp: $event_timestamp, event_type: $event_type, created_at: $created_at, asset_token_id: $asset_token_id, payment_token: $payment_token, quantity: $quantity, total_price: $total_price, transaction: $transaction, asset_decimals: $asset_decimals)';
  }
