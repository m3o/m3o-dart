...
class _$_Asset implements _Asset {
  ...
  @override
  String toString() {
    return 'Asset(description: $description, image_url: $image_url, name: $name, presale: $presale, token_id: $token_id, collection: $collection, contract: $contract, id: $id, last_sale: $last_sale, owner: $owner, permalink: $permalink, traits: $traits, creator: $creator, listing_date: $listing_date, sales: $sales)';
  }
...
class _$_Collection implements _Collection {
  ...
  @override
  String toString() {
    return 'Collection(external_link: $external_link, payment_tokens: $payment_tokens, primary_asset_contracts: $primary_asset_contracts, safelist_request_status: $safelist_request_status, banner_image_url: $banner_image_url, created_at: $created_at, description: $description, image_url: $image_url, payout_address: $payout_address, traits: $traits, editors: $editors, name: $name, seller_fees: $seller_fees, slug: $slug, stats: $stats)';
  }
...
class _$_Contract implements _Contract {
  ...
  @override
  String toString() {
    return 'Contract(address: $address, created_at: $created_at, name: $name, seller_fees: $seller_fees, type: $type, description: $description, owner: $owner, payout_address: $payout_address, schema: $schema, symbol: $symbol)';
  }
...
class _$_Sale implements _Sale {
  ...
  @override
  String toString() {
    return 'Sale(payment_token: $payment_token, quantity: $quantity, total_price: $total_price, asset_token_id: $asset_token_id, created_at: $created_at, event_timestamp: $event_timestamp, event_type: $event_type, transaction: $transaction, asset_decimals: $asset_decimals)';
  }
