...
class _$_Asset implements _Asset {
  ...
  @override
  String toString() {
    return 'Asset(last_sale: $last_sale, listing_date: $listing_date, name: $name, collection: $collection, image_url: $image_url, token_id: $token_id, presale: $presale, sales: $sales, id: $id, permalink: $permalink, traits: $traits, contract: $contract, creator: $creator, description: $description, owner: $owner)';
  }
...
class _$_Collection implements _Collection {
  ...
  @override
  String toString() {
    return 'Collection(created_at: $created_at, external_link: $external_link, name: $name, payment_tokens: $payment_tokens, safelist_request_status: $safelist_request_status, traits: $traits, seller_fees: $seller_fees, description: $description, image_url: $image_url, payout_address: $payout_address, slug: $slug, stats: $stats, banner_image_url: $banner_image_url, editors: $editors, primary_asset_contracts: $primary_asset_contracts)';
  }
...
class _$_Contract implements _Contract {
  ...
  @override
  String toString() {
    return 'Contract(created_at: $created_at, name: $name, owner: $owner, schema: $schema, seller_fees: $seller_fees, address: $address, payout_address: $payout_address, symbol: $symbol, type: $type, description: $description)';
  }
...
class _$_Sale implements _Sale {
  ...
  @override
  String toString() {
    return 'Sale(created_at: $created_at, event_timestamp: $event_timestamp, total_price: $total_price, asset_decimals: $asset_decimals, asset_token_id: $asset_token_id, quantity: $quantity, transaction: $transaction, event_type: $event_type, payment_token: $payment_token)';
  }
