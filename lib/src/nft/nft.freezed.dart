...
class _$_Asset implements _Asset {
  ...
  @override
  String toString() {
    return 'Asset(collection: $collection, description: $description, last_sale: $last_sale, owner: $owner, permalink: $permalink, creator: $creator, image_url: $image_url, name: $name, traits: $traits, contract: $contract, presale: $presale, sales: $sales, token_id: $token_id, id: $id, listing_date: $listing_date)';
  }
...
abstract class _Asset implements Asset {
  const factory _Asset(
      ...
      final String? token_id,
      final int? id,
      final String? listing_date}) = _$_Asset;
...
class _$_Collection implements _Collection {
  ...
  @override
  String toString() {
    return 'Collection(payout_address: $payout_address, seller_fees: $seller_fees, stats: $stats, traits: $traits, created_at: $created_at, editors: $editors, name: $name, banner_image_url: $banner_image_url, safelist_request_status: $safelist_request_status, slug: $slug, external_link: $external_link, image_url: $image_url, payment_tokens: $payment_tokens, description: $description, primary_asset_contracts: $primary_asset_contracts)';
  }
...
class _$_Contract implements _Contract {
  ...
  @override
  String toString() {
    return 'Contract(name: $name, owner: $owner, payout_address: $payout_address, schema: $schema, symbol: $symbol, type: $type, created_at: $created_at, description: $description, seller_fees: $seller_fees, address: $address)';
  }
...
class _$_Sale implements _Sale {
  ...
  @override
  String toString() {
    return 'Sale(asset_token_id: $asset_token_id, event_type: $event_type, quantity: $quantity, total_price: $total_price, asset_decimals: $asset_decimals, event_timestamp: $event_timestamp, payment_token: $payment_token, transaction: $transaction, created_at: $created_at)';
  }
