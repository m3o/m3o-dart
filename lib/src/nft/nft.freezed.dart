...
class _$_Asset implements _Asset {
  ...
  @override
  String toString() {
    return 'Asset(presale: $presale, traits: $traits, token_id: $token_id, contract: $contract, creator: $creator, name: $name, sales: $sales, owner: $owner, permalink: $permalink, collection: $collection, id: $id, last_sale: $last_sale, listing_date: $listing_date, description: $description, image_url: $image_url)';
  }
...
class _$_Collection implements _Collection {
  ...
  @override
  String toString() {
    return 'Collection(banner_image_url: $banner_image_url, description: $description, traits: $traits, created_at: $created_at, editors: $editors, external_link: $external_link, image_url: $image_url, slug: $slug, name: $name, payout_address: $payout_address, primary_asset_contracts: $primary_asset_contracts, safelist_request_status: $safelist_request_status, stats: $stats, payment_tokens: $payment_tokens, seller_fees: $seller_fees)';
  }
...
class _$_Contract implements _Contract {
  ...
  @override
  String toString() {
    return 'Contract(description: $description, owner: $owner, schema: $schema, type: $type, seller_fees: $seller_fees, symbol: $symbol, address: $address, created_at: $created_at, name: $name, payout_address: $payout_address)';
  }
