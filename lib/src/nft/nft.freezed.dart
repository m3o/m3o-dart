...
class _$_Asset implements _Asset {
  ...
  @override
  String toString() {
    return 'Asset(contract: $contract, sales: $sales, collection: $collection, listing_date: $listing_date, token_id: $token_id, traits: $traits, image_url: $image_url, owner: $owner, id: $id, last_sale: $last_sale, name: $name, permalink: $permalink, presale: $presale, creator: $creator, description: $description)';
  }
...
class _$_Collection implements _Collection {
  ...
  @override
  String toString() {
    return 'Collection(external_link: $external_link, safelist_request_status: $safelist_request_status, primary_asset_contracts: $primary_asset_contracts, slug: $slug, traits: $traits, description: $description, payment_tokens: $payment_tokens, payout_address: $payout_address, editors: $editors, name: $name, seller_fees: $seller_fees, stats: $stats, banner_image_url: $banner_image_url, created_at: $created_at, image_url: $image_url)';
  }
...
class _$_Contract implements _Contract {
  ...
  @override
  String toString() {
    return 'Contract(created_at: $created_at, description: $description, name: $name, owner: $owner, seller_fees: $seller_fees, address: $address, payout_address: $payout_address, schema: $schema, symbol: $symbol, type: $type)';
  }
...
class _$_Sale implements _Sale {
  ...
  @override
  String toString() {
    return 'Sale(transaction: $transaction, event_type: $event_type, quantity: $quantity, total_price: $total_price, event_timestamp: $event_timestamp, payment_token: $payment_token, asset_decimals: $asset_decimals, asset_token_id: $asset_token_id, created_at: $created_at)';
  }
