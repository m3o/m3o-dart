...
class _$_Asset implements _Asset {
  ...
  @override
  String toString() {
    return 'Asset(id: $id, owner: $owner, sales: $sales, description: $description, last_sale: $last_sale, presale: $presale, token_id: $token_id, collection: $collection, listing_date: $listing_date, image_url: $image_url, name: $name, permalink: $permalink, traits: $traits, contract: $contract, creator: $creator)';
  }
...
class _$_Collection implements _Collection {
  ...
  @override
  String toString() {
    return 'Collection(editors: $editors, primary_asset_contracts: $primary_asset_contracts, traits: $traits, banner_image_url: $banner_image_url, image_url: $image_url, name: $name, stats: $stats, created_at: $created_at, description: $description, payment_tokens: $payment_tokens, payout_address: $payout_address, slug: $slug, external_link: $external_link, safelist_request_status: $safelist_request_status, seller_fees: $seller_fees)';
  }
...
class _$_Contract implements _Contract {
  ...
  @override
  String toString() {
    return 'Contract(address: $address, name: $name, owner: $owner, payout_address: $payout_address, schema: $schema, seller_fees: $seller_fees, symbol: $symbol, created_at: $created_at, description: $description, type: $type)';
  }
...
class _$_Sale implements _Sale {
  ...
  @override
  String toString() {
    return 'Sale(asset_token_id: $asset_token_id, created_at: $created_at, event_timestamp: $event_timestamp, payment_token: $payment_token, transaction: $transaction, asset_decimals: $asset_decimals, event_type: $event_type, quantity: $quantity, total_price: $total_price)';
  }
