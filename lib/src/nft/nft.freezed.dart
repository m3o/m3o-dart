...
class _$_Asset implements _Asset {
  ...
  @override
  String toString() {
    return 'Asset(last_sale: $last_sale, name: $name, owner: $owner, permalink: $permalink, presale: $presale, contract: $contract, creator: $creator, token_id: $token_id, traits: $traits, description: $description, id: $id, image_url: $image_url, listing_date: $listing_date, collection: $collection, sales: $sales)';
  }
...
class _$_Collection implements _Collection {
  ...
  @override
  String toString() {
    return 'Collection(traits: $traits, created_at: $created_at, stats: $stats, payout_address: $payout_address, seller_fees: $seller_fees, description: $description, image_url: $image_url, safelist_request_status: $safelist_request_status, slug: $slug, banner_image_url: $banner_image_url, payment_tokens: $payment_tokens, name: $name, primary_asset_contracts: $primary_asset_contracts, editors: $editors, external_link: $external_link)';
  }
...
class _$_Contract implements _Contract {
  ...
  @override
  String toString() {
    return 'Contract(address: $address, name: $name, seller_fees: $seller_fees, created_at: $created_at, description: $description, owner: $owner, payout_address: $payout_address, schema: $schema, symbol: $symbol, type: $type)';
  }
...
class _$_Sale implements _Sale {
  ...
  @override
  String toString() {
    return 'Sale(quantity: $quantity, transaction: $transaction, created_at: $created_at, event_type: $event_type, payment_token: $payment_token, total_price: $total_price, asset_decimals: $asset_decimals, asset_token_id: $asset_token_id, event_timestamp: $event_timestamp)';
  }
