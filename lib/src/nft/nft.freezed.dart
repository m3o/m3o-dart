...
class _$_Asset implements _Asset {
  ...
  @override
  String toString() {
    return 'Asset(id: $id, listing_date: $listing_date, token_id: $token_id, name: $name, description: $description, traits: $traits, last_sale: $last_sale, owner: $owner, permalink: $permalink, presale: $presale, collection: $collection, contract: $contract, creator: $creator, image_url: $image_url, sales: $sales)';
  }
...
class _$_Collection implements _Collection {
  ...
  @override
  String toString() {
    return 'Collection(image_url: $image_url, payment_tokens: $payment_tokens, primary_asset_contracts: $primary_asset_contracts, external_link: $external_link, payout_address: $payout_address, seller_fees: $seller_fees, slug: $slug, stats: $stats, name: $name, created_at: $created_at, description: $description, traits: $traits, banner_image_url: $banner_image_url, safelist_request_status: $safelist_request_status, editors: $editors)';
  }
...
class _$_Contract implements _Contract {
  ...
  @override
  String toString() {
    return 'Contract(address: $address, created_at: $created_at, description: $description, name: $name, owner: $owner, payout_address: $payout_address, type: $type, schema: $schema, seller_fees: $seller_fees, symbol: $symbol)';
  }
...
class _$_Sale implements _Sale {
  ...
  @override
  String toString() {
    return 'Sale(asset_decimals: $asset_decimals, asset_token_id: $asset_token_id, created_at: $created_at, quantity: $quantity, total_price: $total_price, transaction: $transaction, event_timestamp: $event_timestamp, event_type: $event_type, payment_token: $payment_token)';
  }
