...
class _$_Asset implements _Asset {
  ...
  @override
  String toString() {
    return 'Asset(collection: $collection, id: $id, last_sale: $last_sale, permalink: $permalink, presale: $presale, token_id: $token_id, traits: $traits, contract: $contract, creator: $creator, image_url: $image_url, listing_date: $listing_date, name: $name, sales: $sales, description: $description, owner: $owner)';
  }
...
class _$_Collection implements _Collection {
  ...
  @override
  String toString() {
    return 'Collection(stats: $stats, created_at: $created_at, payment_tokens: $payment_tokens, safelist_request_status: $safelist_request_status, slug: $slug, banner_image_url: $banner_image_url, image_url: $image_url, name: $name, payout_address: $payout_address, seller_fees: $seller_fees, editors: $editors, external_link: $external_link, primary_asset_contracts: $primary_asset_contracts, traits: $traits, description: $description)';
  }
...
class _$_Contract implements _Contract {
  ...
  @override
  String toString() {
    return 'Contract(symbol: $symbol, type: $type, address: $address, description: $description, name: $name, owner: $owner, created_at: $created_at, payout_address: $payout_address, schema: $schema, seller_fees: $seller_fees)';
  }
...
class _$_Sale implements _Sale {
  ...
  @override
  String toString() {
    return 'Sale(transaction: $transaction, asset_decimals: $asset_decimals, asset_token_id: $asset_token_id, created_at: $created_at, event_timestamp: $event_timestamp, event_type: $event_type, payment_token: $payment_token, quantity: $quantity, total_price: $total_price)';
  }
