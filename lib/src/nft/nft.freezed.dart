...
class _$_Asset implements _Asset {
  ...
  @override
  String toString() {
    return 'Asset(description: $description, image_url: $image_url, listing_date: $listing_date, name: $name, id: $id, owner: $owner, permalink: $permalink, sales: $sales, presale: $presale, token_id: $token_id, traits: $traits, collection: $collection, contract: $contract, creator: $creator, last_sale: $last_sale)';
  }
...
class _$_Collection implements _Collection {
  ...
  @override
  String toString() {
    return 'Collection(stats: $stats, traits: $traits, external_link: $external_link, seller_fees: $seller_fees, slug: $slug, safelist_request_status: $safelist_request_status, editors: $editors, name: $name, primary_asset_contracts: $primary_asset_contracts, banner_image_url: $banner_image_url, description: $description, payment_tokens: $payment_tokens, created_at: $created_at, image_url: $image_url, payout_address: $payout_address)';
  }
...
class _$_Contract implements _Contract {
  ...
  @override
  String toString() {
    return 'Contract(schema: $schema, seller_fees: $seller_fees, address: $address, description: $description, name: $name, symbol: $symbol, type: $type, created_at: $created_at, owner: $owner, payout_address: $payout_address)';
  }
...
class _$_Sale implements _Sale {
  ...
  @override
  String toString() {
    return 'Sale(created_at: $created_at, event_type: $event_type, quantity: $quantity, transaction: $transaction, asset_decimals: $asset_decimals, asset_token_id: $asset_token_id, event_timestamp: $event_timestamp, payment_token: $payment_token, total_price: $total_price)';
  }
