...
class _$_Asset implements _Asset {
  ...
  @override
  String toString() {
    return 'Asset(collection: $collection, name: $name, creator: $creator, description: $description, token_id: $token_id, contract: $contract, image_url: $image_url, last_sale: $last_sale, permalink: $permalink, id: $id, listing_date: $listing_date, owner: $owner, presale: $presale, sales: $sales, traits: $traits)';
  }
...
class _$_Collection implements _Collection {
  ...
  @override
  String toString() {
    return 'Collection(editors: $editors, external_link: $external_link, safelist_request_status: $safelist_request_status, seller_fees: $seller_fees, traits: $traits, description: $description, image_url: $image_url, payout_address: $payout_address, primary_asset_contracts: $primary_asset_contracts, banner_image_url: $banner_image_url, created_at: $created_at, slug: $slug, name: $name, payment_tokens: $payment_tokens, stats: $stats)';
  }
...
class _$_Contract implements _Contract {
  ...
  @override
  String toString() {
    return 'Contract(name: $name, payout_address: $payout_address, symbol: $symbol, address: $address, description: $description, schema: $schema, seller_fees: $seller_fees, type: $type, created_at: $created_at, owner: $owner)';
  }
...
class _$_Sale implements _Sale {
  ...
  @override
  String toString() {
    return 'Sale(event_type: $event_type, asset_token_id: $asset_token_id, created_at: $created_at, event_timestamp: $event_timestamp, payment_token: $payment_token, quantity: $quantity, total_price: $total_price, transaction: $transaction, asset_decimals: $asset_decimals)';
  }
