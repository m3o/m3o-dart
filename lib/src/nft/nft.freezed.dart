...
class _$_Asset implements _Asset {
  ...
  @override
  String toString() {
    return 'Asset(collection: $collection, image_url: $image_url, listing_date: $listing_date, sales: $sales, contract: $contract, last_sale: $last_sale, permalink: $permalink, traits: $traits, presale: $presale, creator: $creator, description: $description, name: $name, owner: $owner, id: $id, token_id: $token_id)';
  }
...
class _$_Collection implements _Collection {
  ...
  @override
  String toString() {
    return 'Collection(created_at: $created_at, external_link: $external_link, slug: $slug, traits: $traits, editors: $editors, payment_tokens: $payment_tokens, seller_fees: $seller_fees, payout_address: $payout_address, primary_asset_contracts: $primary_asset_contracts, name: $name, safelist_request_status: $safelist_request_status, stats: $stats, banner_image_url: $banner_image_url, description: $description, image_url: $image_url)';
  }
...
class _$_Contract implements _Contract {
  ...
  @override
  String toString() {
    return 'Contract(type: $type, address: $address, description: $description, owner: $owner, schema: $schema, seller_fees: $seller_fees, created_at: $created_at, name: $name, payout_address: $payout_address, symbol: $symbol)';
  }
...
class _$_Sale implements _Sale {
  ...
  @override
  String toString() {
    return 'Sale(quantity: $quantity, transaction: $transaction, asset_decimals: $asset_decimals, event_timestamp: $event_timestamp, event_type: $event_type, total_price: $total_price, asset_token_id: $asset_token_id, created_at: $created_at, payment_token: $payment_token)';
  }
