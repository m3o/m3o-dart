...
class _$_Asset implements _Asset {
  ...
  @override
  String toString() {
    return 'Asset(owner: $owner, collection: $collection, creator: $creator, token_id: $token_id, traits: $traits, contract: $contract, image_url: $image_url, presale: $presale, sales: $sales, last_sale: $last_sale, permalink: $permalink, listing_date: $listing_date, name: $name, description: $description, id: $id)';
  }
...
class _$_Collection implements _Collection {
  ...
  @override
  String toString() {
    return 'Collection(external_link: $external_link, name: $name, payout_address: $payout_address, primary_asset_contracts: $primary_asset_contracts, slug: $slug, created_at: $created_at, payment_tokens: $payment_tokens, seller_fees: $seller_fees, editors: $editors, image_url: $image_url, stats: $stats, banner_image_url: $banner_image_url, safelist_request_status: $safelist_request_status, traits: $traits, description: $description)';
  }
...
class _$_Contract implements _Contract {
  ...
  @override
  String toString() {
    return 'Contract(schema: $schema, type: $type, address: $address, created_at: $created_at, owner: $owner, payout_address: $payout_address, description: $description, name: $name, seller_fees: $seller_fees, symbol: $symbol)';
  }
...
class _$_Sale implements _Sale {
  ...
  @override
  String toString() {
    return 'Sale(event_timestamp: $event_timestamp, event_type: $event_type, payment_token: $payment_token, asset_decimals: $asset_decimals, created_at: $created_at, total_price: $total_price, transaction: $transaction, asset_token_id: $asset_token_id, quantity: $quantity)';
  }
