...
class _$_Asset implements _Asset {
  ...
  @override
  String toString() {
    return 'Asset(image_url: $image_url, name: $name, presale: $presale, sales: $sales, token_id: $token_id, description: $description, id: $id, owner: $owner, collection: $collection, creator: $creator, last_sale: $last_sale, permalink: $permalink, contract: $contract, listing_date: $listing_date, traits: $traits)';
  }
...
class _$_Collection implements _Collection {
  ...
  @override
  String toString() {
    return 'Collection(description: $description, external_link: $external_link, name: $name, primary_asset_contracts: $primary_asset_contracts, banner_image_url: $banner_image_url, created_at: $created_at, editors: $editors, safelist_request_status: $safelist_request_status, seller_fees: $seller_fees, traits: $traits, image_url: $image_url, slug: $slug, payment_tokens: $payment_tokens, payout_address: $payout_address, stats: $stats)';
  }
...
class _$_Contract implements _Contract {
  ...
  @override
  String toString() {
    return 'Contract(name: $name, owner: $owner, payout_address: $payout_address, symbol: $symbol, address: $address, created_at: $created_at, description: $description, schema: $schema, seller_fees: $seller_fees, type: $type)';
  }
...
class _$_Sale implements _Sale {
  ...
  @override
  String toString() {
    return 'Sale(transaction: $transaction, asset_decimals: $asset_decimals, asset_token_id: $asset_token_id, quantity: $quantity, total_price: $total_price, created_at: $created_at, event_timestamp: $event_timestamp, event_type: $event_type, payment_token: $payment_token)';
  }
