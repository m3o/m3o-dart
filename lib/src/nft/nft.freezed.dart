...
class _$_Asset implements _Asset {
  ...
  @override
  String toString() {
    return 'Asset(description: $description, presale: $presale, token_id: $token_id, sales: $sales, traits: $traits, id: $id, last_sale: $last_sale, owner: $owner, image_url: $image_url, listing_date: $listing_date, name: $name, permalink: $permalink, collection: $collection, contract: $contract, creator: $creator)';
  }
...
class _$_Collection implements _Collection {
  ...
  @override
  String toString() {
    return 'Collection(payment_tokens: $payment_tokens, payout_address: $payout_address, seller_fees: $seller_fees, image_url: $image_url, safelist_request_status: $safelist_request_status, traits: $traits, banner_image_url: $banner_image_url, created_at: $created_at, description: $description, editors: $editors, stats: $stats, external_link: $external_link, name: $name, primary_asset_contracts: $primary_asset_contracts, slug: $slug)';
  }
...
class _$_Contract implements _Contract {
  ...
  @override
  String toString() {
    return 'Contract(payout_address: $payout_address, symbol: $symbol, type: $type, address: $address, description: $description, owner: $owner, seller_fees: $seller_fees, created_at: $created_at, name: $name, schema: $schema)';
  }
...
class _$_Sale implements _Sale {
  ...
  @override
  String toString() {
    return 'Sale(total_price: $total_price, asset_token_id: $asset_token_id, event_type: $event_type, payment_token: $payment_token, quantity: $quantity, asset_decimals: $asset_decimals, created_at: $created_at, event_timestamp: $event_timestamp, transaction: $transaction)';
  }
