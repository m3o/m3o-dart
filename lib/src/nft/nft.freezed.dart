...
class _$_Asset implements _Asset {
  ...
  @override
  String toString() {
    return 'Asset(presale: $presale, listing_date: $listing_date, last_sale: $last_sale, name: $name, token_id: $token_id, description: $description, creator: $creator, id: $id, traits: $traits, contract: $contract, image_url: $image_url, owner: $owner, permalink: $permalink, sales: $sales, collection: $collection)';
  }
...
class _$_Collection implements _Collection {
  ...
  @override
  String toString() {
    return 'Collection(external_link: $external_link, seller_fees: $seller_fees, name: $name, payment_tokens: $payment_tokens, banner_image_url: $banner_image_url, editors: $editors, payout_address: $payout_address, primary_asset_contracts: $primary_asset_contracts, safelist_request_status: $safelist_request_status, slug: $slug, stats: $stats, traits: $traits, created_at: $created_at, image_url: $image_url, description: $description)';
  }
...
class _$_Contract implements _Contract {
  ...
  @override
  String toString() {
    return 'Contract(address: $address, description: $description, name: $name, payout_address: $payout_address, schema: $schema, created_at: $created_at, owner: $owner, seller_fees: $seller_fees, symbol: $symbol, type: $type)';
  }
...
class _$_Sale implements _Sale {
  ...
  @override
  String toString() {
    return 'Sale(asset_token_id: $asset_token_id, created_at: $created_at, event_timestamp: $event_timestamp, quantity: $quantity, total_price: $total_price, transaction: $transaction, asset_decimals: $asset_decimals, event_type: $event_type, payment_token: $payment_token)';
  }
