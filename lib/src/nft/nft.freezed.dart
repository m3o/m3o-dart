...
class _$_Asset implements _Asset {
  ...
  @override
  String toString() {
    return 'Asset(sales: $sales, traits: $traits, collection: $collection, creator: $creator, name: $name, owner: $owner, permalink: $permalink, token_id: $token_id, contract: $contract, image_url: $image_url, last_sale: $last_sale, listing_date: $listing_date, description: $description, id: $id, presale: $presale)';
  }
...
class _$_Collection implements _Collection {
  ...
  @override
  String toString() {
    return 'Collection(external_link: $external_link, banner_image_url: $banner_image_url, editors: $editors, payment_tokens: $payment_tokens, slug: $slug, image_url: $image_url, name: $name, primary_asset_contracts: $primary_asset_contracts, safelist_request_status: $safelist_request_status, traits: $traits, description: $description, payout_address: $payout_address, stats: $stats, created_at: $created_at, seller_fees: $seller_fees)';
  }
...
class _$_Contract implements _Contract {
  ...
  @override
  String toString() {
    return 'Contract(address: $address, created_at: $created_at, payout_address: $payout_address, type: $type, description: $description, name: $name, owner: $owner, schema: $schema, seller_fees: $seller_fees, symbol: $symbol)';
  }
...
class _$_Sale implements _Sale {
  ...
  @override
  String toString() {
    return 'Sale(asset_token_id: $asset_token_id, created_at: $created_at, total_price: $total_price, transaction: $transaction, quantity: $quantity, asset_decimals: $asset_decimals, event_timestamp: $event_timestamp, event_type: $event_type, payment_token: $payment_token)';
  }
