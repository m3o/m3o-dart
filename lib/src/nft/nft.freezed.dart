...
class _$_Asset implements _Asset {
  ...
  @override
  String toString() {
    return 'Asset(listing_date: $listing_date, permalink: $permalink, traits: $traits, creator: $creator, description: $description, id: $id, last_sale: $last_sale, contract: $contract, name: $name, image_url: $image_url, presale: $presale, sales: $sales, token_id: $token_id, collection: $collection, owner: $owner)';
  }
...
class _$_Collection implements _Collection {
  ...
  @override
  String toString() {
    return 'Collection(primary_asset_contracts: $primary_asset_contracts, safelist_request_status: $safelist_request_status, stats: $stats, created_at: $created_at, editors: $editors, payout_address: $payout_address, traits: $traits, banner_image_url: $banner_image_url, image_url: $image_url, payment_tokens: $payment_tokens, name: $name, slug: $slug, description: $description, external_link: $external_link, seller_fees: $seller_fees)';
  }
...
class _$_Contract implements _Contract {
  ...
  @override
  String toString() {
    return 'Contract(address: $address, owner: $owner, type: $type, payout_address: $payout_address, schema: $schema, seller_fees: $seller_fees, symbol: $symbol, created_at: $created_at, description: $description, name: $name)';
  }
...
class _$_Sale implements _Sale {
  ...
  @override
  String toString() {
    return 'Sale(asset_token_id: $asset_token_id, event_timestamp: $event_timestamp, event_type: $event_type, quantity: $quantity, asset_decimals: $asset_decimals, payment_token: $payment_token, total_price: $total_price, transaction: $transaction, created_at: $created_at)';
  }
