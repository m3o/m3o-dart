...
class _$_Asset implements _Asset {
  ...
  @override
  String toString() {
    return 'Asset(image_url: $image_url, listing_date: $listing_date, token_id: $token_id, traits: $traits, collection: $collection, contract: $contract, presale: $presale, name: $name, owner: $owner, sales: $sales, creator: $creator, description: $description, id: $id, last_sale: $last_sale, permalink: $permalink)';
  }
...
class _$_Collection implements _Collection {
  ...
  @override
  String toString() {
    return 'Collection(banner_image_url: $banner_image_url, name: $name, traits: $traits, external_link: $external_link, payment_tokens: $payment_tokens, primary_asset_contracts: $primary_asset_contracts, slug: $slug, stats: $stats, description: $description, seller_fees: $seller_fees, created_at: $created_at, editors: $editors, image_url: $image_url, payout_address: $payout_address, safelist_request_status: $safelist_request_status)';
  }
...
class _$_Contract implements _Contract {
  ...
  @override
  String toString() {
    return 'Contract(created_at: $created_at, owner: $owner, payout_address: $payout_address, schema: $schema, type: $type, address: $address, description: $description, name: $name, seller_fees: $seller_fees, symbol: $symbol)';
  }
...
class _$_Sale implements _Sale {
  ...
  @override
  String toString() {
    return 'Sale(asset_token_id: $asset_token_id, payment_token: $payment_token, total_price: $total_price, asset_decimals: $asset_decimals, event_timestamp: $event_timestamp, event_type: $event_type, quantity: $quantity, transaction: $transaction, created_at: $created_at)';
  }
