...
class _$_Asset implements _Asset {
  ...
  @override
  String toString() {
    return 'Asset(contract: $contract, creator: $creator, description: $description, owner: $owner, presale: $presale, traits: $traits, last_sale: $last_sale, name: $name, permalink: $permalink, token_id: $token_id, collection: $collection, id: $id, image_url: $image_url, listing_date: $listing_date, sales: $sales)';
  }
...
class _$_Collection implements _Collection {
  ...
  @override
  String toString() {
    return 'Collection(external_link: $external_link, slug: $slug, safelist_request_status: $safelist_request_status, seller_fees: $seller_fees, banner_image_url: $banner_image_url, editors: $editors, image_url: $image_url, name: $name, payment_tokens: $payment_tokens, primary_asset_contracts: $primary_asset_contracts, created_at: $created_at, traits: $traits, description: $description, payout_address: $payout_address, stats: $stats)';
  }
...
class _$_Contract implements _Contract {
  ...
  @override
  String toString() {
    return 'Contract(name: $name, payout_address: $payout_address, symbol: $symbol, address: $address, created_at: $created_at, description: $description, type: $type, owner: $owner, schema: $schema, seller_fees: $seller_fees)';
  }
...
class _$_Sale implements _Sale {
  ...
  @override
  String toString() {
    return 'Sale(asset_decimals: $asset_decimals, asset_token_id: $asset_token_id, event_timestamp: $event_timestamp, payment_token: $payment_token, quantity: $quantity, created_at: $created_at, event_type: $event_type, total_price: $total_price, transaction: $transaction)';
  }
