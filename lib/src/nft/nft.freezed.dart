...
class _$_Asset implements _Asset {
  ...
  @override
  String toString() {
    return 'Asset(listing_date: $listing_date, permalink: $permalink, token_id: $token_id, contract: $contract, id: $id, image_url: $image_url, owner: $owner, presale: $presale, collection: $collection, description: $description, traits: $traits, creator: $creator, name: $name, last_sale: $last_sale, sales: $sales)';
  }
...
class _$_Collection implements _Collection {
  ...
  @override
  String toString() {
    return 'Collection(seller_fees: $seller_fees, traits: $traits, image_url: $image_url, primary_asset_contracts: $primary_asset_contracts, safelist_request_status: $safelist_request_status, slug: $slug, editors: $editors, external_link: $external_link, payout_address: $payout_address, stats: $stats, banner_image_url: $banner_image_url, name: $name, payment_tokens: $payment_tokens, created_at: $created_at, description: $description)';
  }
...
class _$_Contract implements _Contract {
  ...
  @override
  String toString() {
    return 'Contract(address: $address, created_at: $created_at, description: $description, schema: $schema, seller_fees: $seller_fees, name: $name, owner: $owner, payout_address: $payout_address, symbol: $symbol, type: $type)';
  }
...
class _$_Sale implements _Sale {
  ...
  @override
  String toString() {
    return 'Sale(event_timestamp: $event_timestamp, event_type: $event_type, quantity: $quantity, asset_decimals: $asset_decimals, created_at: $created_at, payment_token: $payment_token, total_price: $total_price, transaction: $transaction, asset_token_id: $asset_token_id)';
  }
