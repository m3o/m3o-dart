...
class _$_Asset implements _Asset {
  ...
  @override
  String toString() {
    return 'Asset(contract: $contract, listing_date: $listing_date, name: $name, owner: $owner, sales: $sales, creator: $creator, id: $id, image_url: $image_url, last_sale: $last_sale, token_id: $token_id, traits: $traits, collection: $collection, description: $description, permalink: $permalink, presale: $presale)';
  }
...
class _$_Collection implements _Collection {
  ...
  @override
  String toString() {
    return 'Collection(created_at: $created_at, image_url: $image_url, payout_address: $payout_address, primary_asset_contracts: $primary_asset_contracts, safelist_request_status: $safelist_request_status, description: $description, name: $name, traits: $traits, banner_image_url: $banner_image_url, external_link: $external_link, payment_tokens: $payment_tokens, editors: $editors, seller_fees: $seller_fees, slug: $slug, stats: $stats)';
  }
...
class _$_Contract implements _Contract {
  ...
  @override
  String toString() {
    return 'Contract(symbol: $symbol, address: $address, created_at: $created_at, seller_fees: $seller_fees, payout_address: $payout_address, schema: $schema, type: $type, description: $description, name: $name, owner: $owner)';
  }
...
class _$_Sale implements _Sale {
  ...
  @override
  String toString() {
    return 'Sale(created_at: $created_at, event_timestamp: $event_timestamp, payment_token: $payment_token, transaction: $transaction, asset_decimals: $asset_decimals, asset_token_id: $asset_token_id, event_type: $event_type, quantity: $quantity, total_price: $total_price)';
  }
