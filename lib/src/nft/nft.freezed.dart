...
class _$_Asset implements _Asset {
  ...
  @override
  String toString() {
    return 'Asset(creator: $creator, description: $description, permalink: $permalink, presale: $presale, sales: $sales, contract: $contract, owner: $owner, traits: $traits, id: $id, image_url: $image_url, token_id: $token_id, collection: $collection, listing_date: $listing_date, name: $name, last_sale: $last_sale)';
  }
...
class _$_Collection implements _Collection {
  ...
  @override
  String toString() {
    return 'Collection(image_url: $image_url, safelist_request_status: $safelist_request_status, external_link: $external_link, editors: $editors, name: $name, primary_asset_contracts: $primary_asset_contracts, traits: $traits, description: $description, payout_address: $payout_address, payment_tokens: $payment_tokens, created_at: $created_at, seller_fees: $seller_fees, slug: $slug, stats: $stats, banner_image_url: $banner_image_url)';
  }
...
class _$_Contract implements _Contract {
  ...
  @override
  String toString() {
    return 'Contract(created_at: $created_at, owner: $owner, schema: $schema, seller_fees: $seller_fees, symbol: $symbol, address: $address, description: $description, name: $name, payout_address: $payout_address, type: $type)';
  }
...
class _$_Sale implements _Sale {
  ...
  @override
  String toString() {
    return 'Sale(asset_decimals: $asset_decimals, asset_token_id: $asset_token_id, created_at: $created_at, payment_token: $payment_token, quantity: $quantity, transaction: $transaction, event_timestamp: $event_timestamp, event_type: $event_type, total_price: $total_price)';
  }
