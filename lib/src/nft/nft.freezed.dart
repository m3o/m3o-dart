...
class _$_Asset implements _Asset {
  ...
  @override
  String toString() {
    return 'Asset(token_id: $token_id, contract: $contract, listing_date: $listing_date, sales: $sales, collection: $collection, owner: $owner, permalink: $permalink, traits: $traits, description: $description, name: $name, image_url: $image_url, last_sale: $last_sale, presale: $presale, creator: $creator, id: $id)';
  }
...
class _$_Collection implements _Collection {
  ...
  @override
  String toString() {
    return 'Collection(editors: $editors, primary_asset_contracts: $primary_asset_contracts, banner_image_url: $banner_image_url, created_at: $created_at, payout_address: $payout_address, traits: $traits, description: $description, external_link: $external_link, image_url: $image_url, payment_tokens: $payment_tokens, seller_fees: $seller_fees, stats: $stats, name: $name, safelist_request_status: $safelist_request_status, slug: $slug)';
  }
...
class _$_Contract implements _Contract {
  ...
  @override
  String toString() {
    return 'Contract(schema: $schema, type: $type, address: $address, created_at: $created_at, name: $name, payout_address: $payout_address, description: $description, owner: $owner, seller_fees: $seller_fees, symbol: $symbol)';
  }
...
class _$_Sale implements _Sale {
  ...
  @override
  String toString() {
    return 'Sale(asset_decimals: $asset_decimals, asset_token_id: $asset_token_id, created_at: $created_at, event_timestamp: $event_timestamp, total_price: $total_price, transaction: $transaction, event_type: $event_type, payment_token: $payment_token, quantity: $quantity)';
  }
