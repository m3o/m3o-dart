...
class _$_Asset implements _Asset {
  ...
  @override
  String toString() {
    return 'Asset(id: $id, name: $name, owner: $owner, contract: $contract, creator: $creator, description: $description, permalink: $permalink, sales: $sales, last_sale: $last_sale, presale: $presale, traits: $traits, collection: $collection, image_url: $image_url, listing_date: $listing_date, token_id: $token_id)';
  }
...
class _$_Contract implements _Contract {
  ...
  @override
  String toString() {
    return 'Contract(address: $address, description: $description, name: $name, owner: $owner, type: $type, created_at: $created_at, payout_address: $payout_address, schema: $schema, seller_fees: $seller_fees, symbol: $symbol)';
  }
