...
class _$_Asset implements _Asset {
  ...
  @override
  String toString() {
    return 'Asset(description: $description, image_url: $image_url, name: $name, owner: $owner, contract: $contract, creator: $creator, presale: $presale, collection: $collection, token_id: $token_id, id: $id, listing_date: $listing_date, permalink: $permalink, sales: $sales, traits: $traits, last_sale: $last_sale)';
  }
...
class _$_Collection implements _Collection {
  ...
  @override
  String toString() {
    return 'Collection(description: $description, primary_asset_contracts: $primary_asset_contracts, banner_image_url: $banner_image_url, name: $name, safelist_request_status: $safelist_request_status, created_at: $created_at, payment_tokens: $payment_tokens, stats: $stats, image_url: $image_url, external_link: $external_link, payout_address: $payout_address, seller_fees: $seller_fees, slug: $slug, traits: $traits, editors: $editors)';
  }
...
class _$_Contract implements _Contract {
  ...
  @override
  String toString() {
    return 'Contract(address: $address, created_at: $created_at, symbol: $symbol, payout_address: $payout_address, schema: $schema, seller_fees: $seller_fees, type: $type, description: $description, name: $name, owner: $owner)';
  }
...
class _$_Sale implements _Sale {
  ...
  @override
  String toString() {
    return 'Sale(quantity: $quantity, payment_token: $payment_token, asset_token_id: $asset_token_id, created_at: $created_at, event_timestamp: $event_timestamp, event_type: $event_type, total_price: $total_price, transaction: $transaction, asset_decimals: $asset_decimals)';
  }
