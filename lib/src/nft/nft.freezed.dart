...
class _$_Asset implements _Asset {
  ...
  @override
  String toString() {
    return 'Asset(contract: $contract, description: $description, permalink: $permalink, presale: $presale, token_id: $token_id, collection: $collection, creator: $creator, id: $id, last_sale: $last_sale, listing_date: $listing_date, name: $name, owner: $owner, sales: $sales, image_url: $image_url, traits: $traits)';
  }
...
class _$_Collection implements _Collection {
  ...
  @override
  String toString() {
    return 'Collection(description: $description, image_url: $image_url, primary_asset_contracts: $primary_asset_contracts, traits: $traits, banner_image_url: $banner_image_url, external_link: $external_link, payment_tokens: $payment_tokens, slug: $slug, editors: $editors, name: $name, payout_address: $payout_address, safelist_request_status: $safelist_request_status, seller_fees: $seller_fees, stats: $stats, created_at: $created_at)';
  }
...
class _$_Contract implements _Contract {
  ...
  @override
  String toString() {
    return 'Contract(created_at: $created_at, name: $name, owner: $owner, payout_address: $payout_address, schema: $schema, symbol: $symbol, type: $type, address: $address, seller_fees: $seller_fees, description: $description)';
  }
...
class _$_Sale implements _Sale {
  ...
  @override
  String toString() {
    return 'Sale(event_type: $event_type, asset_decimals: $asset_decimals, event_timestamp: $event_timestamp, payment_token: $payment_token, quantity: $quantity, total_price: $total_price, transaction: $transaction, asset_token_id: $asset_token_id, created_at: $created_at)';
  }
