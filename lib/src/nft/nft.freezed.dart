...
class _$_Asset implements _Asset {
  ...
  @override
  String toString() {
    return 'Asset(last_sale: $last_sale, owner: $owner, token_id: $token_id, collection: $collection, contract: $contract, image_url: $image_url, permalink: $permalink, presale: $presale, traits: $traits, creator: $creator, id: $id, name: $name, sales: $sales, description: $description, listing_date: $listing_date)';
  }
...
class _$_Collection implements _Collection {
  ...
  @override
  String toString() {
    return 'Collection(description: $description, name: $name, primary_asset_contracts: $primary_asset_contracts, traits: $traits, banner_image_url: $banner_image_url, created_at: $created_at, editors: $editors, payout_address: $payout_address, seller_fees: $seller_fees, slug: $slug, external_link: $external_link, image_url: $image_url, payment_tokens: $payment_tokens, safelist_request_status: $safelist_request_status, stats: $stats)';
  }
...
class _$_Contract implements _Contract {
  ...
  @override
  String toString() {
    return 'Contract(address: $address, schema: $schema, payout_address: $payout_address, seller_fees: $seller_fees, symbol: $symbol, type: $type, created_at: $created_at, description: $description, name: $name, owner: $owner)';
  }
...
class _$_Sale implements _Sale {
  ...
  @override
  String toString() {
    return 'Sale(asset_token_id: $asset_token_id, created_at: $created_at, event_timestamp: $event_timestamp, event_type: $event_type, payment_token: $payment_token, quantity: $quantity, asset_decimals: $asset_decimals, transaction: $transaction, total_price: $total_price)';
  }
