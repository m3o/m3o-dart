...
class _$_Asset implements _Asset {
  ...
  @override
  String toString() {
    return 'Asset(listing_date: $listing_date, name: $name, permalink: $permalink, presale: $presale, token_id: $token_id, image_url: $image_url, last_sale: $last_sale, traits: $traits, contract: $contract, creator: $creator, collection: $collection, description: $description, id: $id, owner: $owner, sales: $sales)';
  }
...
class _$_Collection implements _Collection {
  ...
  @override
  String toString() {
    return 'Collection(description: $description, editors: $editors, safelist_request_status: $safelist_request_status, banner_image_url: $banner_image_url, payment_tokens: $payment_tokens, primary_asset_contracts: $primary_asset_contracts, traits: $traits, created_at: $created_at, external_link: $external_link, name: $name, payout_address: $payout_address, seller_fees: $seller_fees, image_url: $image_url, slug: $slug, stats: $stats)';
  }
...
class _$_Contract implements _Contract {
  ...
  @override
  String toString() {
    return 'Contract(address: $address, created_at: $created_at, description: $description, name: $name, owner: $owner, symbol: $symbol, type: $type, payout_address: $payout_address, schema: $schema, seller_fees: $seller_fees)';
  }
...
class _$_Sale implements _Sale {
  ...
  @override
  String toString() {
    return 'Sale(asset_token_id: $asset_token_id, created_at: $created_at, event_timestamp: $event_timestamp, event_type: $event_type, quantity: $quantity, total_price: $total_price, asset_decimals: $asset_decimals, transaction: $transaction, payment_token: $payment_token)';
  }
