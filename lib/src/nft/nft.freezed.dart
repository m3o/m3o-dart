...
class _$_Asset implements _Asset {
  ...
  @override
  String toString() {
    return 'Asset(permalink: $permalink, sales: $sales, token_id: $token_id, traits: $traits, description: $description, owner: $owner, presale: $presale, image_url: $image_url, last_sale: $last_sale, listing_date: $listing_date, creator: $creator, id: $id, name: $name, collection: $collection, contract: $contract)';
  }
...
class _$_Collection implements _Collection {
  ...
  @override
  String toString() {
    return 'Collection(payout_address: $payout_address, safelist_request_status: $safelist_request_status, traits: $traits, external_link: $external_link, name: $name, payment_tokens: $payment_tokens, image_url: $image_url, primary_asset_contracts: $primary_asset_contracts, stats: $stats, created_at: $created_at, seller_fees: $seller_fees, slug: $slug, banner_image_url: $banner_image_url, description: $description, editors: $editors)';
  }
...
class _$_Contract implements _Contract {
  ...
  @override
  String toString() {
    return 'Contract(seller_fees: $seller_fees, symbol: $symbol, address: $address, created_at: $created_at, description: $description, schema: $schema, name: $name, owner: $owner, payout_address: $payout_address, type: $type)';
  }
...
class _$_Sale implements _Sale {
  ...
  @override
  String toString() {
    return 'Sale(asset_decimals: $asset_decimals, asset_token_id: $asset_token_id, event_timestamp: $event_timestamp, quantity: $quantity, total_price: $total_price, transaction: $transaction, created_at: $created_at, event_type: $event_type, payment_token: $payment_token)';
  }
