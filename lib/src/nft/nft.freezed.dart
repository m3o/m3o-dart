...
class _$_Asset implements _Asset {
  ...
  @override
  String toString() {
    return 'Asset(collection: $collection, contract: $contract, description: $description, last_sale: $last_sale, traits: $traits, image_url: $image_url, listing_date: $listing_date, name: $name, permalink: $permalink, presale: $presale, creator: $creator, id: $id, token_id: $token_id, owner: $owner, sales: $sales)';
  }
...
class _$_Collection implements _Collection {
  ...
  @override
  String toString() {
    return 'Collection(traits: $traits, description: $description, image_url: $image_url, primary_asset_contracts: $primary_asset_contracts, created_at: $created_at, payment_tokens: $payment_tokens, safelist_request_status: $safelist_request_status, slug: $slug, stats: $stats, banner_image_url: $banner_image_url, external_link: $external_link, payout_address: $payout_address, editors: $editors, name: $name, seller_fees: $seller_fees)';
  }
...
class _$_Contract implements _Contract {
  ...
  @override
  String toString() {
    return 'Contract(address: $address, name: $name, schema: $schema, seller_fees: $seller_fees, symbol: $symbol, created_at: $created_at, description: $description, owner: $owner, payout_address: $payout_address, type: $type)';
  }
...
class _$_Sale implements _Sale {
  ...
  @override
  String toString() {
    return 'Sale(created_at: $created_at, event_timestamp: $event_timestamp, event_type: $event_type, total_price: $total_price, transaction: $transaction, asset_decimals: $asset_decimals, asset_token_id: $asset_token_id, payment_token: $payment_token, quantity: $quantity)';
  }
