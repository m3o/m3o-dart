...
class _$_Asset implements _Asset {
  ...
  @override
  String toString() {
    return 'Asset(traits: $traits, collection: $collection, id: $id, permalink: $permalink, presale: $presale, description: $description, image_url: $image_url, last_sale: $last_sale, token_id: $token_id, contract: $contract, creator: $creator, owner: $owner, sales: $sales, listing_date: $listing_date, name: $name)';
  }
...
class _$_Collection implements _Collection {
  ...
  @override
  String toString() {
    return 'Collection(created_at: $created_at, description: $description, external_link: $external_link, name: $name, slug: $slug, banner_image_url: $banner_image_url, payment_tokens: $payment_tokens, safelist_request_status: $safelist_request_status, seller_fees: $seller_fees, traits: $traits, editors: $editors, image_url: $image_url, payout_address: $payout_address, primary_asset_contracts: $primary_asset_contracts, stats: $stats)';
  }
...
class _$_Contract implements _Contract {
  ...
  @override
  String toString() {
    return 'Contract(seller_fees: $seller_fees, description: $description, payout_address: $payout_address, name: $name, owner: $owner, schema: $schema, symbol: $symbol, type: $type, address: $address, created_at: $created_at)';
  }
...
class _$_Sale implements _Sale {
  ...
  @override
  String toString() {
    return 'Sale(quantity: $quantity, total_price: $total_price, event_type: $event_type, payment_token: $payment_token, transaction: $transaction, asset_decimals: $asset_decimals, asset_token_id: $asset_token_id, created_at: $created_at, event_timestamp: $event_timestamp)';
  }
