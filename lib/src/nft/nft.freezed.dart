...
class _$_Asset implements _Asset {
  ...
  @override
  String toString() {
    return 'Asset(contract: $contract, image_url: $image_url, collection: $collection, listing_date: $listing_date, description: $description, last_sale: $last_sale, permalink: $permalink, presale: $presale, sales: $sales, token_id: $token_id, traits: $traits, id: $id, name: $name, owner: $owner, creator: $creator)';
  }
...
class _$_Collection implements _Collection {
  ...
  @override
  String toString() {
    return 'Collection(image_url: $image_url, name: $name, seller_fees: $seller_fees, stats: $stats, external_link: $external_link, primary_asset_contracts: $primary_asset_contracts, traits: $traits, description: $description, created_at: $created_at, payment_tokens: $payment_tokens, safelist_request_status: $safelist_request_status, banner_image_url: $banner_image_url, payout_address: $payout_address, slug: $slug, editors: $editors)';
  }
...
class _$_Contract implements _Contract {
  ...
  @override
  String toString() {
    return 'Contract(description: $description, name: $name, owner: $owner, seller_fees: $seller_fees, symbol: $symbol, type: $type, address: $address, created_at: $created_at, payout_address: $payout_address, schema: $schema)';
  }
...
class _$_Sale implements _Sale {
  ...
  @override
  String toString() {
    return 'Sale(event_timestamp: $event_timestamp, payment_token: $payment_token, total_price: $total_price, created_at: $created_at, asset_token_id: $asset_token_id, event_type: $event_type, quantity: $quantity, transaction: $transaction, asset_decimals: $asset_decimals)';
  }
