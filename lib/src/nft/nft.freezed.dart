...
class _$_Asset implements _Asset {
  ...
  @override
  String toString() {
    return 'Asset(traits: $traits, image_url: $image_url, presale: $presale, token_id: $token_id, owner: $owner, permalink: $permalink, name: $name, sales: $sales, contract: $contract, creator: $creator, id: $id, listing_date: $listing_date, collection: $collection, description: $description, last_sale: $last_sale)';
  }
...
class _$_Collection implements _Collection {
  ...
  @override
  String toString() {
    return 'Collection(traits: $traits, created_at: $created_at, name: $name, editors: $editors, banner_image_url: $banner_image_url, description: $description, primary_asset_contracts: $primary_asset_contracts, seller_fees: $seller_fees, slug: $slug, image_url: $image_url, payout_address: $payout_address, safelist_request_status: $safelist_request_status, stats: $stats, external_link: $external_link, payment_tokens: $payment_tokens)';
  }
...
class _$_Contract implements _Contract {
  ...
  @override
  String toString() {
    return 'Contract(address: $address, created_at: $created_at, type: $type, symbol: $symbol, description: $description, name: $name, owner: $owner, payout_address: $payout_address, schema: $schema, seller_fees: $seller_fees)';
  }
