...
class _$_Asset implements _Asset {
  ...
  @override
  String toString() {
    return 'Asset(last_sale: $last_sale, name: $name, owner: $owner, permalink: $permalink, creator: $creator, description: $description, listing_date: $listing_date, sales: $sales, presale: $presale, traits: $traits, id: $id, image_url: $image_url, token_id: $token_id, collection: $collection, contract: $contract)';
  }
...
class _$_Collection implements _Collection {
  ...
  @override
  String toString() {
    return 'Collection(created_at: $created_at, image_url: $image_url, payment_tokens: $payment_tokens, safelist_request_status: $safelist_request_status, editors: $editors, name: $name, traits: $traits, description: $description, payout_address: $payout_address, primary_asset_contracts: $primary_asset_contracts, seller_fees: $seller_fees, stats: $stats, banner_image_url: $banner_image_url, external_link: $external_link, slug: $slug)';
  }
...
class _$_Sale implements _Sale {
  ...
  @override
  String toString() {
    return 'Sale(asset_decimals: $asset_decimals, event_type: $event_type, quantity: $quantity, asset_token_id: $asset_token_id, created_at: $created_at, event_timestamp: $event_timestamp, payment_token: $payment_token, total_price: $total_price, transaction: $transaction)';
  }
