...
class _$_Asset implements _Asset {
  ...
  @override
  String toString() {
    return 'Asset(collection: $collection, token_id: $token_id, contract: $contract, image_url: $image_url, owner: $owner, permalink: $permalink, presale: $presale, traits: $traits, id: $id, last_sale: $last_sale, name: $name, sales: $sales, creator: $creator, description: $description, listing_date: $listing_date)';
  }
...
class _$_Collection implements _Collection {
  ...
  @override
  String toString() {
    return 'Collection(primary_asset_contracts: $primary_asset_contracts, stats: $stats, seller_fees: $seller_fees, slug: $slug, created_at: $created_at, name: $name, payout_address: $payout_address, safelist_request_status: $safelist_request_status, payment_tokens: $payment_tokens, banner_image_url: $banner_image_url, editors: $editors, external_link: $external_link, image_url: $image_url, description: $description, traits: $traits)';
  }
...
class _$_Contract implements _Contract {
  ...
  @override
  String toString() {
    return 'Contract(type: $type, owner: $owner, payout_address: $payout_address, schema: $schema, symbol: $symbol, seller_fees: $seller_fees, address: $address, created_at: $created_at, description: $description, name: $name)';
  }
...
class _$_Sale implements _Sale {
  ...
  @override
  String toString() {
    return 'Sale(created_at: $created_at, quantity: $quantity, asset_decimals: $asset_decimals, asset_token_id: $asset_token_id, event_timestamp: $event_timestamp, event_type: $event_type, payment_token: $payment_token, total_price: $total_price, transaction: $transaction)';
  }
