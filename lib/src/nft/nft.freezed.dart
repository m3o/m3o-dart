...
class _$_Asset implements _Asset {
  ...
  @override
  String toString() {
    return 'Asset(creator: $creator, id: $id, name: $name, owner: $owner, presale: $presale, collection: $collection, image_url: $image_url, traits: $traits, contract: $contract, description: $description, permalink: $permalink, sales: $sales, token_id: $token_id, last_sale: $last_sale, listing_date: $listing_date)';
  }
...
class _$_Collection implements _Collection {
  ...
  @override
  String toString() {
    return 'Collection(payment_tokens: $payment_tokens, seller_fees: $seller_fees, stats: $stats, image_url: $image_url, editors: $editors, external_link: $external_link, name: $name, payout_address: $payout_address, banner_image_url: $banner_image_url, safelist_request_status: $safelist_request_status, slug: $slug, traits: $traits, created_at: $created_at, primary_asset_contracts: $primary_asset_contracts, description: $description)';
  }
...
class _$_Contract implements _Contract {
  ...
  @override
  String toString() {
    return 'Contract(address: $address, created_at: $created_at, seller_fees: $seller_fees, symbol: $symbol, description: $description, name: $name, owner: $owner, payout_address: $payout_address, schema: $schema, type: $type)';
  }
...
class _$_Sale implements _Sale {
  ...
  @override
  String toString() {
    return 'Sale(payment_token: $payment_token, quantity: $quantity, total_price: $total_price, transaction: $transaction, event_type: $event_type, asset_decimals: $asset_decimals, asset_token_id: $asset_token_id, created_at: $created_at, event_timestamp: $event_timestamp)';
  }
