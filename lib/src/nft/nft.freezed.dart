...
class _$_Asset implements _Asset {
  ...
  @override
  String toString() {
    return 'Asset(id: $id, image_url: $image_url, collection: $collection, description: $description, permalink: $permalink, token_id: $token_id, traits: $traits, contract: $contract, last_sale: $last_sale, name: $name, presale: $presale, creator: $creator, listing_date: $listing_date, owner: $owner, sales: $sales)';
  }
...
class _$_Collection implements _Collection {
  ...
  @override
  String toString() {
    return 'Collection(created_at: $created_at, description: $description, image_url: $image_url, primary_asset_contracts: $primary_asset_contracts, seller_fees: $seller_fees, banner_image_url: $banner_image_url, external_link: $external_link, name: $name, payment_tokens: $payment_tokens, payout_address: $payout_address, slug: $slug, stats: $stats, editors: $editors, safelist_request_status: $safelist_request_status, traits: $traits)';
  }
...
class _$_Contract implements _Contract {
  ...
  @override
  String toString() {
    return 'Contract(schema: $schema, seller_fees: $seller_fees, address: $address, description: $description, name: $name, payout_address: $payout_address, created_at: $created_at, owner: $owner, symbol: $symbol, type: $type)';
  }
...
class _$_Sale implements _Sale {
  ...
  @override
  String toString() {
    return 'Sale(asset_token_id: $asset_token_id, created_at: $created_at, event_type: $event_type, payment_token: $payment_token, quantity: $quantity, total_price: $total_price, asset_decimals: $asset_decimals, event_timestamp: $event_timestamp, transaction: $transaction)';
  }
