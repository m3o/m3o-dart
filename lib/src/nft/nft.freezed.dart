...
class _$_Asset implements _Asset {
  ...
  @override
  String toString() {
    return 'Asset(id: $id, last_sale: $last_sale, permalink: $permalink, sales: $sales, token_id: $token_id, traits: $traits, collection: $collection, contract: $contract, name: $name, presale: $presale, listing_date: $listing_date, creator: $creator, description: $description, image_url: $image_url, owner: $owner)';
  }
...
class _$_Collection implements _Collection {
  ...
  @override
  String toString() {
    return 'Collection(traits: $traits, created_at: $created_at, image_url: $image_url, payment_tokens: $payment_tokens, stats: $stats, primary_asset_contracts: $primary_asset_contracts, slug: $slug, description: $description, external_link: $external_link, safelist_request_status: $safelist_request_status, seller_fees: $seller_fees, banner_image_url: $banner_image_url, editors: $editors, name: $name, payout_address: $payout_address)';
  }
...
class _$_Contract implements _Contract {
  ...
  @override
  String toString() {
    return 'Contract(created_at: $created_at, description: $description, owner: $owner, seller_fees: $seller_fees, symbol: $symbol, type: $type, address: $address, name: $name, payout_address: $payout_address, schema: $schema)';
  }
...
class _$_Sale implements _Sale {
  ...
  @override
  String toString() {
    return 'Sale(created_at: $created_at, event_timestamp: $event_timestamp, quantity: $quantity, total_price: $total_price, asset_decimals: $asset_decimals, asset_token_id: $asset_token_id, transaction: $transaction, event_type: $event_type, payment_token: $payment_token)';
  }
