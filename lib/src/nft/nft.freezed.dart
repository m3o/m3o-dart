...
class _$_Asset implements _Asset {
  ...
  @override
  String toString() {
    return 'Asset(description: $description, listing_date: $listing_date, presale: $presale, traits: $traits, last_sale: $last_sale, sales: $sales, collection: $collection, id: $id, permalink: $permalink, token_id: $token_id, contract: $contract, creator: $creator, image_url: $image_url, name: $name, owner: $owner)';
  }
...
class _$_Collection implements _Collection {
  ...
  @override
  String toString() {
    return 'Collection(seller_fees: $seller_fees, created_at: $created_at, external_link: $external_link, name: $name, payout_address: $payout_address, safelist_request_status: $safelist_request_status, stats: $stats, traits: $traits, image_url: $image_url, primary_asset_contracts: $primary_asset_contracts, slug: $slug, payment_tokens: $payment_tokens, banner_image_url: $banner_image_url, description: $description, editors: $editors)';
  }
...
abstract class _Collection implements Collection {
  const factory _Collection(
      ...
      final String? banner_image_url,
      final String? description,
      final List<String>? editors}) = _$_Collection;
...
class _$_Contract implements _Contract {
  ...
  @override
  String toString() {
    return 'Contract(type: $type, address: $address, owner: $owner, payout_address: $payout_address, schema: $schema, seller_fees: $seller_fees, symbol: $symbol, created_at: $created_at, description: $description, name: $name)';
  }
...
class _$_Sale implements _Sale {
  ...
  @override
  String toString() {
    return 'Sale(event_timestamp: $event_timestamp, event_type: $event_type, payment_token: $payment_token, quantity: $quantity, total_price: $total_price, asset_decimals: $asset_decimals, asset_token_id: $asset_token_id, created_at: $created_at, transaction: $transaction)';
  }
