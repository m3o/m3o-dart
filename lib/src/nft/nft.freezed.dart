...
class _$_Asset implements _Asset {
  ...
  @override
  String toString() {
    return 'Asset(listing_date: $listing_date, sales: $sales, id: $id, image_url: $image_url, presale: $presale, collection: $collection, contract: $contract, name: $name, permalink: $permalink, token_id: $token_id, creator: $creator, description: $description, last_sale: $last_sale, owner: $owner, traits: $traits)';
  }
...
class _$_Collection implements _Collection {
  ...
  @override
  String toString() {
    return 'Collection(payment_tokens: $payment_tokens, payout_address: $payout_address, primary_asset_contracts: $primary_asset_contracts, safelist_request_status: $safelist_request_status, seller_fees: $seller_fees, name: $name, banner_image_url: $banner_image_url, created_at: $created_at, description: $description, external_link: $external_link, image_url: $image_url, editors: $editors, slug: $slug, stats: $stats, traits: $traits)';
  }
...
class _$_Contract implements _Contract {
  ...
  @override
  String toString() {
    return 'Contract(schema: $schema, symbol: $symbol, type: $type, created_at: $created_at, name: $name, payout_address: $payout_address, seller_fees: $seller_fees, address: $address, description: $description, owner: $owner)';
  }
