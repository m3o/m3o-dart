...
class _$_Asset implements _Asset {
  ...
  @override
  String toString() {
    return 'Asset(token_id: $token_id, contract: $contract, permalink: $permalink, presale: $presale, traits: $traits, collection: $collection, description: $description, image_url: $image_url, creator: $creator, owner: $owner, sales: $sales, name: $name, id: $id, last_sale: $last_sale, listing_date: $listing_date)';
  }
...
class _$_Collection implements _Collection {
  ...
  @override
  String toString() {
    return 'Collection(banner_image_url: $banner_image_url, editors: $editors, payment_tokens: $payment_tokens, payout_address: $payout_address, primary_asset_contracts: $primary_asset_contracts, traits: $traits, image_url: $image_url, name: $name, created_at: $created_at, description: $description, safelist_request_status: $safelist_request_status, external_link: $external_link, seller_fees: $seller_fees, slug: $slug, stats: $stats)';
  }
...
class _$_Contract implements _Contract {
  ...
  @override
  String toString() {
    return 'Contract(created_at: $created_at, description: $description, seller_fees: $seller_fees, type: $type, schema: $schema, symbol: $symbol, address: $address, name: $name, owner: $owner, payout_address: $payout_address)';
  }
...
class _$_Sale implements _Sale {
  ...
  @override
  String toString() {
    return 'Sale(payment_token: $payment_token, quantity: $quantity, total_price: $total_price, created_at: $created_at, event_type: $event_type, event_timestamp: $event_timestamp, transaction: $transaction, asset_decimals: $asset_decimals, asset_token_id: $asset_token_id)';
  }
