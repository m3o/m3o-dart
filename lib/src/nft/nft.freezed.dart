...
class _$_Asset implements _Asset {
  ...
  @override
  String toString() {
    return 'Asset(contract: $contract, creator: $creator, permalink: $permalink, traits: $traits, collection: $collection, description: $description, listing_date: $listing_date, owner: $owner, sales: $sales, id: $id, last_sale: $last_sale, presale: $presale, image_url: $image_url, name: $name, token_id: $token_id)';
  }
...
class _$_Collection implements _Collection {
  ...
  @override
  String toString() {
    return 'Collection(external_link: $external_link, name: $name, created_at: $created_at, description: $description, editors: $editors, image_url: $image_url, payment_tokens: $payment_tokens, slug: $slug, primary_asset_contracts: $primary_asset_contracts, safelist_request_status: $safelist_request_status, banner_image_url: $banner_image_url, payout_address: $payout_address, seller_fees: $seller_fees, stats: $stats, traits: $traits)';
  }
...
class _$_Contract implements _Contract {
  ...
  @override
  String toString() {
    return 'Contract(address: $address, name: $name, payout_address: $payout_address, schema: $schema, seller_fees: $seller_fees, type: $type, created_at: $created_at, description: $description, owner: $owner, symbol: $symbol)';
  }
...
class _$_Sale implements _Sale {
  ...
  @override
  String toString() {
    return 'Sale(asset_decimals: $asset_decimals, asset_token_id: $asset_token_id, payment_token: $payment_token, created_at: $created_at, event_timestamp: $event_timestamp, event_type: $event_type, quantity: $quantity, total_price: $total_price, transaction: $transaction)';
  }
