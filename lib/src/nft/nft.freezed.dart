...
class _$_Asset implements _Asset {
  ...
  @override
  String toString() {
    return 'Asset(collection: $collection, description: $description, image_url: $image_url, last_sale: $last_sale, presale: $presale, creator: $creator, listing_date: $listing_date, owner: $owner, sales: $sales, token_id: $token_id, traits: $traits, contract: $contract, id: $id, name: $name, permalink: $permalink)';
  }
...
class _$_Collection implements _Collection {
  ...
  @override
  String toString() {
    return 'Collection(external_link: $external_link, name: $name, created_at: $created_at, slug: $slug, description: $description, seller_fees: $seller_fees, stats: $stats, traits: $traits, primary_asset_contracts: $primary_asset_contracts, safelist_request_status: $safelist_request_status, banner_image_url: $banner_image_url, editors: $editors, image_url: $image_url, payment_tokens: $payment_tokens, payout_address: $payout_address)';
  }
...
class _$_Contract implements _Contract {
  ...
  @override
  String toString() {
    return 'Contract(type: $type, address: $address, description: $description, payout_address: $payout_address, seller_fees: $seller_fees, symbol: $symbol, created_at: $created_at, name: $name, owner: $owner, schema: $schema)';
  }
...
class _$_Sale implements _Sale {
  ...
  @override
  String toString() {
    return 'Sale(event_timestamp: $event_timestamp, total_price: $total_price, asset_token_id: $asset_token_id, created_at: $created_at, payment_token: $payment_token, quantity: $quantity, transaction: $transaction, asset_decimals: $asset_decimals, event_type: $event_type)';
  }
