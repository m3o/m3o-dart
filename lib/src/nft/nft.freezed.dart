...
class _$_Asset implements _Asset {
  ...
  @override
  String toString() {
    return 'Asset(creator: $creator, last_sale: $last_sale, listing_date: $listing_date, permalink: $permalink, contract: $contract, name: $name, collection: $collection, token_id: $token_id, traits: $traits, id: $id, image_url: $image_url, owner: $owner, presale: $presale, sales: $sales, description: $description)';
  }
...
class _$_Collection implements _Collection {
  ...
  @override
  String toString() {
    return 'Collection(payout_address: $payout_address, banner_image_url: $banner_image_url, description: $description, external_link: $external_link, image_url: $image_url, seller_fees: $seller_fees, name: $name, slug: $slug, stats: $stats, safelist_request_status: $safelist_request_status, traits: $traits, created_at: $created_at, editors: $editors, payment_tokens: $payment_tokens, primary_asset_contracts: $primary_asset_contracts)';
  }
...
class _$_Contract implements _Contract {
  ...
  @override
  String toString() {
    return 'Contract(address: $address, created_at: $created_at, owner: $owner, payout_address: $payout_address, type: $type, description: $description, name: $name, schema: $schema, seller_fees: $seller_fees, symbol: $symbol)';
  }
...
class _$_Sale implements _Sale {
  ...
  @override
  String toString() {
    return 'Sale(asset_decimals: $asset_decimals, event_timestamp: $event_timestamp, payment_token: $payment_token, quantity: $quantity, total_price: $total_price, asset_token_id: $asset_token_id, created_at: $created_at, event_type: $event_type, transaction: $transaction)';
  }
