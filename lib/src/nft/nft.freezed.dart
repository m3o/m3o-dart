...
class _$_Asset implements _Asset {
  ...
  @override
  String toString() {
    return 'Asset(presale: $presale, token_id: $token_id, collection: $collection, contract: $contract, listing_date: $listing_date, creator: $creator, name: $name, owner: $owner, permalink: $permalink, sales: $sales, traits: $traits, description: $description, id: $id, image_url: $image_url, last_sale: $last_sale)';
  }
...
class _$_Collection implements _Collection {
  ...
  @override
  String toString() {
    return 'Collection(primary_asset_contracts: $primary_asset_contracts, editors: $editors, external_link: $external_link, seller_fees: $seller_fees, stats: $stats, created_at: $created_at, safelist_request_status: $safelist_request_status, payout_address: $payout_address, traits: $traits, description: $description, name: $name, payment_tokens: $payment_tokens, slug: $slug, banner_image_url: $banner_image_url, image_url: $image_url)';
  }
...
class _$_Contract implements _Contract {
  ...
  @override
  String toString() {
    return 'Contract(address: $address, owner: $owner, payout_address: $payout_address, seller_fees: $seller_fees, type: $type, created_at: $created_at, description: $description, name: $name, schema: $schema, symbol: $symbol)';
  }
...
class _$_Sale implements _Sale {
  ...
  @override
  String toString() {
    return 'Sale(event_timestamp: $event_timestamp, payment_token: $payment_token, total_price: $total_price, asset_decimals: $asset_decimals, asset_token_id: $asset_token_id, created_at: $created_at, event_type: $event_type, quantity: $quantity, transaction: $transaction)';
  }
