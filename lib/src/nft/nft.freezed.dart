...
class _$_Asset implements _Asset {
  ...
  @override
  String toString() {
    return 'Asset(image_url: $image_url, permalink: $permalink, sales: $sales, contract: $contract, creator: $creator, description: $description, last_sale: $last_sale, token_id: $token_id, collection: $collection, presale: $presale, id: $id, listing_date: $listing_date, name: $name, owner: $owner, traits: $traits)';
  }
...
class _$_Collection implements _Collection {
  ...
  @override
  String toString() {
    return 'Collection(description: $description, traits: $traits, safelist_request_status: $safelist_request_status, seller_fees: $seller_fees, slug: $slug, banner_image_url: $banner_image_url, external_link: $external_link, image_url: $image_url, payout_address: $payout_address, editors: $editors, payment_tokens: $payment_tokens, primary_asset_contracts: $primary_asset_contracts, stats: $stats, created_at: $created_at, name: $name)';
  }
...
class _$_Contract implements _Contract {
  ...
  @override
  String toString() {
    return 'Contract(created_at: $created_at, name: $name, owner: $owner, symbol: $symbol, address: $address, payout_address: $payout_address, schema: $schema, seller_fees: $seller_fees, type: $type, description: $description)';
  }
...
class _$_Sale implements _Sale {
  ...
  @override
  String toString() {
    return 'Sale(created_at: $created_at, event_type: $event_type, payment_token: $payment_token, quantity: $quantity, transaction: $transaction, asset_decimals: $asset_decimals, asset_token_id: $asset_token_id, event_timestamp: $event_timestamp, total_price: $total_price)';
  }
