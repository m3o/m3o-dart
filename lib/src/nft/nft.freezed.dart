...
class _$_Asset implements _Asset {
  ...
  @override
  String toString() {
    return 'Asset(token_id: $token_id, collection: $collection, last_sale: $last_sale, permalink: $permalink, presale: $presale, description: $description, listing_date: $listing_date, name: $name, traits: $traits, contract: $contract, creator: $creator, id: $id, owner: $owner, image_url: $image_url, sales: $sales)';
  }
...
class _$_Collection implements _Collection {
  ...
  @override
  String toString() {
    return 'Collection(created_at: $created_at, name: $name, payout_address: $payout_address, safelist_request_status: $safelist_request_status, traits: $traits, banner_image_url: $banner_image_url, description: $description, image_url: $image_url, payment_tokens: $payment_tokens, seller_fees: $seller_fees, editors: $editors, external_link: $external_link, primary_asset_contracts: $primary_asset_contracts, slug: $slug, stats: $stats)';
  }
...
class _$_Contract implements _Contract {
  ...
  @override
  String toString() {
    return 'Contract(symbol: $symbol, type: $type, address: $address, description: $description, name: $name, seller_fees: $seller_fees, created_at: $created_at, owner: $owner, payout_address: $payout_address, schema: $schema)';
  }
...
class _$_Sale implements _Sale {
  ...
  @override
  String toString() {
    return 'Sale(total_price: $total_price, transaction: $transaction, asset_token_id: $asset_token_id, event_type: $event_type, event_timestamp: $event_timestamp, payment_token: $payment_token, quantity: $quantity, asset_decimals: $asset_decimals, created_at: $created_at)';
  }
