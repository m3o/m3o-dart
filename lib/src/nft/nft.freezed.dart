...
class _$_Asset implements _Asset {
  ...
  @override
  String toString() {
    return 'Asset(owner: $owner, presale: $presale, sales: $sales, id: $id, image_url: $image_url, permalink: $permalink, last_sale: $last_sale, listing_date: $listing_date, name: $name, traits: $traits, contract: $contract, creator: $creator, description: $description, collection: $collection, token_id: $token_id)';
  }
...
class _$_Collection implements _Collection {
  ...
  @override
  String toString() {
    return 'Collection(name: $name, payout_address: $payout_address, seller_fees: $seller_fees, stats: $stats, description: $description, external_link: $external_link, payment_tokens: $payment_tokens, primary_asset_contracts: $primary_asset_contracts, slug: $slug, traits: $traits, editors: $editors, image_url: $image_url, safelist_request_status: $safelist_request_status, banner_image_url: $banner_image_url, created_at: $created_at)';
  }
...
class _$_Contract implements _Contract {
  ...
  @override
  String toString() {
    return 'Contract(seller_fees: $seller_fees, symbol: $symbol, description: $description, name: $name, schema: $schema, payout_address: $payout_address, type: $type, address: $address, created_at: $created_at, owner: $owner)';
  }
...
class _$_Sale implements _Sale {
  ...
  @override
  String toString() {
    return 'Sale(asset_decimals: $asset_decimals, asset_token_id: $asset_token_id, quantity: $quantity, transaction: $transaction, total_price: $total_price, created_at: $created_at, event_timestamp: $event_timestamp, event_type: $event_type, payment_token: $payment_token)';
  }
