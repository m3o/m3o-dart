...
class _$_Asset implements _Asset {
  ...
  @override
  String toString() {
    return 'Asset(presale: $presale, traits: $traits, collection: $collection, image_url: $image_url, owner: $owner, permalink: $permalink, token_id: $token_id, name: $name, contract: $contract, creator: $creator, listing_date: $listing_date, sales: $sales, description: $description, id: $id, last_sale: $last_sale)';
  }
...
class _$_Collection implements _Collection {
  ...
  @override
  String toString() {
    return 'Collection(safelist_request_status: $safelist_request_status, slug: $slug, banner_image_url: $banner_image_url, editors: $editors, stats: $stats, primary_asset_contracts: $primary_asset_contracts, seller_fees: $seller_fees, created_at: $created_at, description: $description, external_link: $external_link, image_url: $image_url, name: $name, payment_tokens: $payment_tokens, payout_address: $payout_address, traits: $traits)';
  }
...
class _$_Contract implements _Contract {
  ...
  @override
  String toString() {
    return 'Contract(payout_address: $payout_address, seller_fees: $seller_fees, address: $address, created_at: $created_at, description: $description, symbol: $symbol, type: $type, name: $name, owner: $owner, schema: $schema)';
  }
...
class _$_Sale implements _Sale {
  ...
  @override
  String toString() {
    return 'Sale(asset_decimals: $asset_decimals, total_price: $total_price, asset_token_id: $asset_token_id, created_at: $created_at, event_timestamp: $event_timestamp, event_type: $event_type, payment_token: $payment_token, quantity: $quantity, transaction: $transaction)';
  }
