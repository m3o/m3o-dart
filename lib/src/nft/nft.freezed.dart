...
class _$_Asset implements _Asset {
  ...
  @override
  String toString() {
    return 'Asset(presale: $presale, traits: $traits, creator: $creator, name: $name, token_id: $token_id, contract: $contract, sales: $sales, id: $id, image_url: $image_url, last_sale: $last_sale, permalink: $permalink, collection: $collection, description: $description, listing_date: $listing_date, owner: $owner)';
  }
...
class _$_Collection implements _Collection {
  ...
  @override
  String toString() {
    return 'Collection(created_at: $created_at, description: $description, payout_address: $payout_address, safelist_request_status: $safelist_request_status, seller_fees: $seller_fees, stats: $stats, editors: $editors, name: $name, primary_asset_contracts: $primary_asset_contracts, traits: $traits, banner_image_url: $banner_image_url, external_link: $external_link, image_url: $image_url, payment_tokens: $payment_tokens, slug: $slug)';
  }
...
class _$_Contract implements _Contract {
  ...
  @override
  String toString() {
    return 'Contract(type: $type, address: $address, description: $description, name: $name, schema: $schema, seller_fees: $seller_fees, symbol: $symbol, created_at: $created_at, owner: $owner, payout_address: $payout_address)';
  }
...
class _$_Sale implements _Sale {
  ...
  @override
  String toString() {
    return 'Sale(total_price: $total_price, asset_decimals: $asset_decimals, asset_token_id: $asset_token_id, event_type: $event_type, quantity: $quantity, transaction: $transaction, created_at: $created_at, event_timestamp: $event_timestamp, payment_token: $payment_token)';
  }
