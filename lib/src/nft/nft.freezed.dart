...
class _$_Asset implements _Asset {
  ...
  @override
  String toString() {
    return 'Asset(permalink: $permalink, token_id: $token_id, contract: $contract, creator: $creator, presale: $presale, collection: $collection, last_sale: $last_sale, owner: $owner, listing_date: $listing_date, name: $name, sales: $sales, traits: $traits, description: $description, id: $id, image_url: $image_url)';
  }
...
class _$_Collection implements _Collection {
  ...
  @override
  String toString() {
    return 'Collection(payout_address: $payout_address, banner_image_url: $banner_image_url, description: $description, editors: $editors, payment_tokens: $payment_tokens, created_at: $created_at, safelist_request_status: $safelist_request_status, image_url: $image_url, primary_asset_contracts: $primary_asset_contracts, stats: $stats, traits: $traits, external_link: $external_link, name: $name, seller_fees: $seller_fees, slug: $slug)';
  }
...
class _$_Contract implements _Contract {
  ...
  @override
  String toString() {
    return 'Contract(name: $name, owner: $owner, payout_address: $payout_address, schema: $schema, seller_fees: $seller_fees, created_at: $created_at, description: $description, type: $type, address: $address, symbol: $symbol)';
  }
...
class _$_Sale implements _Sale {
  ...
  @override
  String toString() {
    return 'Sale(event_timestamp: $event_timestamp, payment_token: $payment_token, quantity: $quantity, transaction: $transaction, asset_decimals: $asset_decimals, asset_token_id: $asset_token_id, total_price: $total_price, created_at: $created_at, event_type: $event_type)';
  }
