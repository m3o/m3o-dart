...
class _$_Asset implements _Asset {
  ...
  @override
  String toString() {
    return 'Asset(sales: $sales, description: $description, image_url: $image_url, listing_date: $listing_date, name: $name, collection: $collection, id: $id, contract: $contract, creator: $creator, traits: $traits, token_id: $token_id, last_sale: $last_sale, owner: $owner, permalink: $permalink, presale: $presale)';
  }
...
class _$_Collection implements _Collection {
  ...
  @override
  String toString() {
    return 'Collection(image_url: $image_url, payment_tokens: $payment_tokens, payout_address: $payout_address, seller_fees: $seller_fees, stats: $stats, created_at: $created_at, external_link: $external_link, slug: $slug, editors: $editors, name: $name, safelist_request_status: $safelist_request_status, traits: $traits, banner_image_url: $banner_image_url, primary_asset_contracts: $primary_asset_contracts, description: $description)';
  }
...
abstract class _Collection implements Collection {
  const factory _Collection(
      ...
      final String? banner_image_url,
      final List<Contract>? primary_asset_contracts,
      final String? description}) = _$_Collection;
...
class _$_Contract implements _Contract {
  ...
  @override
  String toString() {
    return 'Contract(owner: $owner, schema: $schema, seller_fees: $seller_fees, type: $type, address: $address, description: $description, payout_address: $payout_address, symbol: $symbol, created_at: $created_at, name: $name)';
  }
...
class _$_Sale implements _Sale {
  ...
  @override
  String toString() {
    return 'Sale(created_at: $created_at, event_timestamp: $event_timestamp, quantity: $quantity, payment_token: $payment_token, total_price: $total_price, transaction: $transaction, asset_decimals: $asset_decimals, asset_token_id: $asset_token_id, event_type: $event_type)';
  }
