...
class _$_Asset implements _Asset {
  ...
  @override
  String toString() {
    return 'Asset(last_sale: $last_sale, sales: $sales, traits: $traits, contract: $contract, permalink: $permalink, presale: $presale, collection: $collection, owner: $owner, image_url: $image_url, listing_date: $listing_date, name: $name, token_id: $token_id, creator: $creator, description: $description, id: $id)';
  }
...
class _$_Collection implements _Collection {
  ...
  @override
  String toString() {
    return 'Collection(external_link: $external_link, image_url: $image_url, payout_address: $payout_address, traits: $traits, banner_image_url: $banner_image_url, created_at: $created_at, description: $description, editors: $editors, name: $name, payment_tokens: $payment_tokens, primary_asset_contracts: $primary_asset_contracts, slug: $slug, safelist_request_status: $safelist_request_status, seller_fees: $seller_fees, stats: $stats)';
  }
...
class _$_Contract implements _Contract {
  ...
  @override
  String toString() {
    return 'Contract(address: $address, name: $name, owner: $owner, created_at: $created_at, description: $description, payout_address: $payout_address, schema: $schema, seller_fees: $seller_fees, symbol: $symbol, type: $type)';
  }
...
class _$_Sale implements _Sale {
  ...
  @override
  String toString() {
    return 'Sale(asset_token_id: $asset_token_id, created_at: $created_at, event_timestamp: $event_timestamp, event_type: $event_type, payment_token: $payment_token, asset_decimals: $asset_decimals, quantity: $quantity, total_price: $total_price, transaction: $transaction)';
  }
