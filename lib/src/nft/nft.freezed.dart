...
class _$_Asset implements _Asset {
  ...
  @override
  String toString() {
    return 'Asset(description: $description, id: $id, presale: $presale, traits: $traits, listing_date: $listing_date, name: $name, token_id: $token_id, image_url: $image_url, last_sale: $last_sale, owner: $owner, permalink: $permalink, collection: $collection, contract: $contract, creator: $creator, sales: $sales)';
  }
...
class _$_Collection implements _Collection {
  ...
  @override
  String toString() {
    return 'Collection(banner_image_url: $banner_image_url, description: $description, editors: $editors, payment_tokens: $payment_tokens, stats: $stats, name: $name, payout_address: $payout_address, seller_fees: $seller_fees, created_at: $created_at, primary_asset_contracts: $primary_asset_contracts, safelist_request_status: $safelist_request_status, slug: $slug, external_link: $external_link, image_url: $image_url, traits: $traits)';
  }
...
class _$_Contract implements _Contract {
  ...
  @override
  String toString() {
    return 'Contract(address: $address, payout_address: $payout_address, symbol: $symbol, type: $type, created_at: $created_at, description: $description, name: $name, owner: $owner, schema: $schema, seller_fees: $seller_fees)';
  }
...
class _$_Sale implements _Sale {
  ...
  @override
  String toString() {
    return 'Sale(quantity: $quantity, total_price: $total_price, asset_decimals: $asset_decimals, asset_token_id: $asset_token_id, event_timestamp: $event_timestamp, transaction: $transaction, created_at: $created_at, event_type: $event_type, payment_token: $payment_token)';
  }
