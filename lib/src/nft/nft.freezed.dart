...
class _$_Asset implements _Asset {
  ...
  @override
  String toString() {
    return 'Asset(contract: $contract, id: $id, token_id: $token_id, collection: $collection, traits: $traits, description: $description, image_url: $image_url, last_sale: $last_sale, listing_date: $listing_date, name: $name, owner: $owner, presale: $presale, creator: $creator, sales: $sales, permalink: $permalink)';
  }
...
class _$_Collection implements _Collection {
  ...
  @override
  String toString() {
    return 'Collection(name: $name, seller_fees: $seller_fees, traits: $traits, created_at: $created_at, primary_asset_contracts: $primary_asset_contracts, description: $description, safelist_request_status: $safelist_request_status, stats: $stats, banner_image_url: $banner_image_url, external_link: $external_link, image_url: $image_url, payment_tokens: $payment_tokens, payout_address: $payout_address, slug: $slug, editors: $editors)';
  }
...
class _$_Contract implements _Contract {
  ...
  @override
  String toString() {
    return 'Contract(address: $address, payout_address: $payout_address, schema: $schema, symbol: $symbol, type: $type, created_at: $created_at, description: $description, name: $name, owner: $owner, seller_fees: $seller_fees)';
  }
