...
class _$_Asset implements _Asset {
  ...
  @override
  String toString() {
    return 'Asset(creator: $creator, sales: $sales, owner: $owner, permalink: $permalink, presale: $presale, listing_date: $listing_date, name: $name, traits: $traits, collection: $collection, contract: $contract, id: $id, last_sale: $last_sale, description: $description, image_url: $image_url, token_id: $token_id)';
  }
...
class _$_Collection implements _Collection {
  ...
  @override
  String toString() {
    return 'Collection(name: $name, payment_tokens: $payment_tokens, payout_address: $payout_address, description: $description, external_link: $external_link, seller_fees: $seller_fees, slug: $slug, traits: $traits, banner_image_url: $banner_image_url, primary_asset_contracts: $primary_asset_contracts, created_at: $created_at, editors: $editors, image_url: $image_url, safelist_request_status: $safelist_request_status, stats: $stats)';
  }
...
class _$_Contract implements _Contract {
  ...
  @override
  String toString() {
    return 'Contract(created_at: $created_at, name: $name, schema: $schema, address: $address, description: $description, owner: $owner, payout_address: $payout_address, seller_fees: $seller_fees, symbol: $symbol, type: $type)';
  }
...
class _$_Sale implements _Sale {
  ...
  @override
  String toString() {
    return 'Sale(total_price: $total_price, transaction: $transaction, asset_decimals: $asset_decimals, asset_token_id: $asset_token_id, created_at: $created_at, event_timestamp: $event_timestamp, payment_token: $payment_token, event_type: $event_type, quantity: $quantity)';
  }
