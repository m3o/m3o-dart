...
class _$TransactionResponseData implements TransactionResponseData {
  ...
  @override
  String toString() {
    return 'TransactionResponse(chain_id: $chain_id, from_address: $from_address, gas_price: $gas_price, max_priority_fee_per_gas: $max_priority_fee_per_gas, nonce: $nonce, r: $r, type: $type, block_number: $block_number, hash: $hash, tx_index: $tx_index, v: $v, value: $value, block_hash: $block_hash, gas: $gas, input: $input, max_fee_per_gas: $max_fee_per_gas, s: $s, to_address: $to_address)';
  }
