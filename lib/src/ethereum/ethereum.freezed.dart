...
class _$TransactionResponseData implements TransactionResponseData {
  ...
  @override
  String toString() {
    return 'TransactionResponse(gas_price: $gas_price, max_fee_per_gas: $max_fee_per_gas, s: $s, v: $v, value: $value, r: $r, tx_index: $tx_index, block_hash: $block_hash, block_number: $block_number, chain_id: $chain_id, from_address: $from_address, input: $input, gas: $gas, max_priority_fee_per_gas: $max_priority_fee_per_gas, nonce: $nonce, to_address: $to_address, type: $type, hash: $hash)';
  }
