...
class _$TransactionResponseData implements TransactionResponseData {
  ...
  @override
  String toString() {
    return 'TransactionResponse(hash: $hash, input: $input, nonce: $nonce, block_number: $block_number, chain_id: $chain_id, gas: $gas, max_fee_per_gas: $max_fee_per_gas, value: $value, type: $type, v: $v, block_hash: $block_hash, gas_price: $gas_price, max_priority_fee_per_gas: $max_priority_fee_per_gas, r: $r, s: $s, to_address: $to_address, from_address: $from_address, tx_index: $tx_index)';
  }
