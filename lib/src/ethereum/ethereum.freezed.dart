...
class _$TransactionResponseData implements TransactionResponseData {
  ...
  @override
  String toString() {
    return 'TransactionResponse(chain_id: $chain_id, hash: $hash, nonce: $nonce, r: $r, tx_index: $tx_index, gas: $gas, max_priority_fee_per_gas: $max_priority_fee_per_gas, from_address: $from_address, input: $input, max_fee_per_gas: $max_fee_per_gas, v: $v, block_hash: $block_hash, block_number: $block_number, gas_price: $gas_price, s: $s, to_address: $to_address, type: $type, value: $value)';
  }
