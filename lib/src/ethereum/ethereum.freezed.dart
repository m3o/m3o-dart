...
class _$TransactionResponseData implements TransactionResponseData {
  ...
  @override
  String toString() {
    return 'TransactionResponse(block_number: $block_number, hash: $hash, max_fee_per_gas: $max_fee_per_gas, tx_index: $tx_index, v: $v, value: $value, from_address: $from_address, gas_price: $gas_price, max_priority_fee_per_gas: $max_priority_fee_per_gas, s: $s, block_hash: $block_hash, gas: $gas, nonce: $nonce, type: $type, chain_id: $chain_id, input: $input, r: $r, to_address: $to_address)';
  }
