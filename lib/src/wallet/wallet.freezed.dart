...
class _$_Account implements _Account {
  ...
  @override
  String toString() {
    return 'Account(id: $id, name: $name, balance: $balance, currency: $currency, description: $description)';
  }
...
class _$CreateRequestTearOff {
  ...
  _CreateRequest call(
      {String? currency, String? description, String? id, String? name}) {
...
abstract class $CreateRequestCopyWith<$Res> {
  ...
  $Res call({String? currency, String? description, String? id, String? name});
}
...
class _$_CreateRequest implements _CreateRequest {
  const _$_CreateRequest({this.currency, this.description, this.id, this.name});
  ...
  @override
  String toString() {
    return 'CreateRequest(currency: $currency, description: $description, id: $id, name: $name)';
  }
...
abstract class _TransferRequest implements TransferRequest {
  const factory _TransferRequest(
      ...
      bool? visible,
      @JsonKey(fromJson: int64FromString, toJson: int64ToString) int? amount,
      String? from_id}) = _$_TransferRequest;
