...
class _$_Address implements _Address {
  ...
  @override
  String toString() {
    return 'Address(title: $title, country_id: $country_id, lat_lng: $lat_lng, location: $location, postcode: $postcode, state_or_province: $state_or_province, town: $town, access_comments: $access_comments, address_line_1: $address_line_1, address_line_2: $address_line_2, country: $country)';
  }
...
class _$_Connection implements _Connection {
  ...
  @override
  String toString() {
    return 'Connection(connection_type_id: $connection_type_id, current: $current, level: $level, reference: $reference, voltage: $voltage, amps: $amps, connection_type: $connection_type, level_id: $level_id, power: $power)';
  }
...
class _$_Operator implements _Operator {
  ...
  @override
  String toString() {
    return 'Operator(fault_report_email: $fault_report_email, phone_secondary: $phone_secondary, title: $title, website: $website, comments: $comments, contact_email: $contact_email, id: $id, is_private_individual: $is_private_individual, phone_primary: $phone_primary)';
  }
...
class _$_Poi implements _Poi {
  ...
  @override
  String toString() {
    return 'Poi(operator: $operator, cost: $cost, data_provider_id: $data_provider_id, num_points: $num_points, operator_id: $operator_id, usage_type: $usage_type, usage_type_id: $usage_type_id, address: $address, connections: $connections, id: $id)';
  }
...
class _$ReferenceDataResponseData implements ReferenceDataResponseData {
  ...
  @override
  String toString() {
    return 'ReferenceDataResponse(connection_types: $connection_types, countries: $countries, current_types: $current_types, data_providers: $data_providers, operators: $operators, usage_types: $usage_types, charger_types: $charger_types, checkin_status_types: $checkin_status_types, user_comment_types: $user_comment_types, status_types: $status_types, submission_status_types: $submission_status_types)';
  }
...
class _$_SearchRequest implements _SearchRequest {
  ...
  @override
  String toString() {
    return 'SearchRequest(country_id: $country_id, max_results: $max_results, min_power: $min_power, box: $box, connection_types: $connection_types, location: $location, operators: $operators, usage_types: $usage_types, distance: $distance, levels: $levels)';
  }
