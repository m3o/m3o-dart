...
class _$_Address implements _Address {
  ...
  @override
  String toString() {
    return 'Address(access_comments: $access_comments, location: $location, country_id: $country_id, lat_lng: $lat_lng, postcode: $postcode, state_or_province: $state_or_province, title: $title, address_line_1: $address_line_1, address_line_2: $address_line_2, country: $country, town: $town)';
  }
...
class _$_Connection implements _Connection {
  ...
  @override
  String toString() {
    return 'Connection(connection_type: $connection_type, level: $level, level_id: $level_id, power: $power, reference: $reference, amps: $amps, current: $current, voltage: $voltage, connection_type_id: $connection_type_id)';
  }
...
class _$_Operator implements _Operator {
  ...
  @override
  String toString() {
    return 'Operator(comments: $comments, fault_report_email: $fault_report_email, phone_primary: $phone_primary, title: $title, website: $website, contact_email: $contact_email, id: $id, is_private_individual: $is_private_individual, phone_secondary: $phone_secondary)';
  }
...
class _$_Poi implements _Poi {
  ...
  @override
  String toString() {
    return 'Poi(data_provider_id: $data_provider_id, num_points: $num_points, operator: $operator, operator_id: $operator_id, usage_type_id: $usage_type_id, cost: $cost, connections: $connections, id: $id, usage_type: $usage_type, address: $address)';
  }
...
class _$ReferenceDataResponseData implements ReferenceDataResponseData {
  ...
  @override
  String toString() {
    return 'ReferenceDataResponse(operators: $operators, status_types: $status_types, countries: $countries, current_types: $current_types, connection_types: $connection_types, data_providers: $data_providers, submission_status_types: $submission_status_types, usage_types: $usage_types, user_comment_types: $user_comment_types, charger_types: $charger_types, checkin_status_types: $checkin_status_types)';
  }
