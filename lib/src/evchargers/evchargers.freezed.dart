...
class _$_Connection implements _Connection {
  ...
  @override
  String toString() {
    return 'Connection(reference: $reference, voltage: $voltage, connection_type: $connection_type, level: $level, power: $power, level_id: $level_id, amps: $amps, connection_type_id: $connection_type_id, current: $current)';
  }
...
class _$_Operator implements _Operator {
  ...
  @override
  String toString() {
    return 'Operator(comments: $comments, id: $id, phone_primary: $phone_primary, contact_email: $contact_email, fault_report_email: $fault_report_email, is_private_individual: $is_private_individual, phone_secondary: $phone_secondary, title: $title, website: $website)';
  }
...
class _$_Poi implements _Poi {
  ...
  @override
  String toString() {
    return 'Poi(usage_type_id: $usage_type_id, connections: $connections, data_provider_id: $data_provider_id, operator: $operator, operator_id: $operator_id, usage_type: $usage_type, address: $address, cost: $cost, id: $id, num_points: $num_points)';
  }
...
class _$_SearchRequest implements _SearchRequest {
  ...
  @override
  String toString() {
    return 'SearchRequest(box: $box, country_id: $country_id, operators: $operators, usage_types: $usage_types, connection_types: $connection_types, distance: $distance, levels: $levels, location: $location, max_results: $max_results, min_power: $min_power)';
  }
