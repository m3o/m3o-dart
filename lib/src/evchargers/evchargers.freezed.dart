...
class _$_Address implements _Address {
  ...
  @override
  String toString() {
    return 'Address(town: $town, country: $country, postcode: $postcode, title: $title, country_id: $country_id, lat_lng: $lat_lng, location: $location, state_or_province: $state_or_province, access_comments: $access_comments, address_line_1: $address_line_1, address_line_2: $address_line_2)';
  }
...
class _$_Connection implements _Connection {
  ...
  @override
  String toString() {
    return 'Connection(amps: $amps, current: $current, level: $level, level_id: $level_id, power: $power, connection_type: $connection_type, connection_type_id: $connection_type_id, reference: $reference, voltage: $voltage)';
  }
...
class _$_Operator implements _Operator {
  ...
  @override
  String toString() {
    return 'Operator(contact_email: $contact_email, fault_report_email: $fault_report_email, id: $id, phone_secondary: $phone_secondary, title: $title, website: $website, comments: $comments, is_private_individual: $is_private_individual, phone_primary: $phone_primary)';
  }
...
class _$_Poi implements _Poi {
  ...
  @override
  String toString() {
    return 'Poi(num_points: $num_points, operator_id: $operator_id, usage_type_id: $usage_type_id, address: $address, connections: $connections, data_provider_id: $data_provider_id, usage_type: $usage_type, cost: $cost, id: $id, operator: $operator)';
  }
...
class _$ReferenceDataResponseData implements ReferenceDataResponseData {
  ...
  @override
  String toString() {
    return 'ReferenceDataResponse(charger_types: $charger_types, checkin_status_types: $checkin_status_types, connection_types: $connection_types, countries: $countries, data_providers: $data_providers, usage_types: $usage_types, current_types: $current_types, operators: $operators, status_types: $status_types, submission_status_types: $submission_status_types, user_comment_types: $user_comment_types)';
  }
...
class _$_SearchRequest implements _SearchRequest {
  ...
  @override
  String toString() {
    return 'SearchRequest(box: $box, country_id: $country_id, distance: $distance, min_power: $min_power, operators: $operators, connection_types: $connection_types, levels: $levels, location: $location, max_results: $max_results, usage_types: $usage_types)';
  }
