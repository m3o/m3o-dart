...
class _$_Address implements _Address {
  ...
  @override
  String toString() {
    return 'Address(country_id: $country_id, postcode: $postcode, title: $title, town: $town, access_comments: $access_comments, address_line_2: $address_line_2, lat_lng: $lat_lng, location: $location, state_or_province: $state_or_province, address_line_1: $address_line_1, country: $country)';
  }
...
class _$_Connection implements _Connection {
  ...
  @override
  String toString() {
    return 'Connection(connection_type: $connection_type, current: $current, power: $power, reference: $reference, voltage: $voltage, amps: $amps, connection_type_id: $connection_type_id, level: $level, level_id: $level_id)';
  }
...
class _$_Poi implements _Poi {
  ...
  @override
  String toString() {
    return 'Poi(address: $address, data_provider_id: $data_provider_id, usage_type_id: $usage_type_id, num_points: $num_points, operator: $operator, operator_id: $operator_id, usage_type: $usage_type, connections: $connections, cost: $cost, id: $id)';
  }
...
class _$ReferenceDataResponseData implements ReferenceDataResponseData {
  ...
  @override
  String toString() {
    return 'ReferenceDataResponse(user_comment_types: $user_comment_types, charger_types: $charger_types, connection_types: $connection_types, countries: $countries, operators: $operators, submission_status_types: $submission_status_types, usage_types: $usage_types, checkin_status_types: $checkin_status_types, current_types: $current_types, data_providers: $data_providers, status_types: $status_types)';
  }
...
class _$_SearchRequest implements _SearchRequest {
  ...
  @override
  String toString() {
    return 'SearchRequest(country_id: $country_id, max_results: $max_results, operators: $operators, usage_types: $usage_types, box: $box, connection_types: $connection_types, distance: $distance, levels: $levels, location: $location, min_power: $min_power)';
  }
