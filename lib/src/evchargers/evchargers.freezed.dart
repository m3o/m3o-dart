...
class _$_Address implements _Address {
  ...
  @override
  String toString() {
    return 'Address(address_line_2: $address_line_2, country: $country, lat_lng: $lat_lng, location: $location, title: $title, address_line_1: $address_line_1, country_id: $country_id, postcode: $postcode, state_or_province: $state_or_province, town: $town, access_comments: $access_comments)';
  }
...
class _$_BoundingBox implements _BoundingBox {
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, bottom_left, top_right);
...
class _$_ChargerType implements _ChargerType {
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, comments, id, is_fast_charge_capable, title);
...
class _$_Connection implements _Connection {
  ...
  @override
  String toString() {
    return 'Connection(reference: $reference, voltage: $voltage, connection_type_id: $connection_type_id, level: $level, power: $power, level_id: $level_id, status: $status, amps: $amps, connection_type: $connection_type, current: $current)';
  }
...
class _$_ConnectionType implements _ConnectionType {
  ...
  @override
  int get hashCode => Object.hash(
      runtimeType, title, formal_name, id, is_discontinued, is_obsolete);
...
class _$_CurrentType implements _CurrentType {
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, description, id, title);
...
class _$_DataProvider implements _DataProvider {
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, title, website, comments,
      data_provider_status_type, id, license);
...
abstract class _DataProvider implements DataProvider {
  const factory _DataProvider(
      ...
      final DataProviderStatusType? data_provider_status_type,
      final String? id,
      final String? license}) = _$_DataProvider;
...
class _$_Operator implements _Operator {
  ...
  @override
  String toString() {
    return 'Operator(fault_report_email: $fault_report_email, phone_primary: $phone_primary, title: $title, website: $website, phone_secondary: $phone_secondary, comments: $comments, contact_email: $contact_email, id: $id, is_private_individual: $is_private_individual)';
  }
...
abstract class _Operator implements Operator {
  const factory _Operator(
      ...
      final String? contact_email,
      final String? id,
      final bool? is_private_individual}) = _$_Operator;
...
class _$_Poi implements _Poi {
  ...
  @override
  String toString() {
    return 'Poi(usage_type: $usage_type, usage_type_id: $usage_type_id, cost: $cost, id: $id, num_points: $num_points, operator: $operator, operator_id: $operator_id, address: $address, connections: $connections, data_provider_id: $data_provider_id)';
  }
...
abstract class _Poi implements Poi {
  const factory _Poi(
      ...
      final Address? address,
      final List<Connection>? connections,
      final String? data_provider_id}) = _$_Poi;
...
class _$ReferenceDataResponseData implements ReferenceDataResponseData {
  ...
  @override
  String toString() {
    return 'ReferenceDataResponse(status_types: $status_types, submission_status_types: $submission_status_types, usage_types: $usage_types, user_comment_types: $user_comment_types, data_providers: $data_providers, operators: $operators, connection_types: $connection_types, countries: $countries, current_types: $current_types, charger_types: $charger_types, checkin_status_types: $checkin_status_types)';
  }
...
class _$_SearchRequest implements _SearchRequest {
  ...
  @override
  String toString() {
    return 'SearchRequest(box: $box, distance: $distance, max_results: $max_results, operators: $operators, connection_types: $connection_types, country_id: $country_id, levels: $levels, location: $location, min_power: $min_power, usage_types: $usage_types)';
  }
