...
class _$_Address implements _Address {
  ...
  @override
  String toString() {
    return 'Address(address_line_1: $address_line_1, address_line_2: $address_line_2, postcode: $postcode, title: $title, location: $location, state_or_province: $state_or_province, town: $town, access_comments: $access_comments, country: $country, country_id: $country_id, lat_lng: $lat_lng)';
  }
...
class _$_Connection implements _Connection {
  ...
  @override
  String toString() {
    return 'Connection(level_id: $level_id, power: $power, reference: $reference, amps: $amps, connection_type: $connection_type, connection_type_id: $connection_type_id, current: $current, level: $level, voltage: $voltage)';
  }
...
class _$_Operator implements _Operator {
  ...
  @override
  String toString() {
    return 'Operator(comments: $comments, contact_email: $contact_email, id: $id, phone_primary: $phone_primary, title: $title, fault_report_email: $fault_report_email, is_private_individual: $is_private_individual, phone_secondary: $phone_secondary, website: $website)';
  }
...
class _$_Poi implements _Poi {
  ...
  @override
  String toString() {
    return 'Poi(address: $address, data_provider_id: $data_provider_id, id: $id, num_points: $num_points, usage_type: $usage_type, usage_type_id: $usage_type_id, connections: $connections, cost: $cost, operator: $operator, operator_id: $operator_id)';
  }
...
class _$ReferenceDataResponseData implements ReferenceDataResponseData {
  ...
  @override
  String toString() {
    return 'ReferenceDataResponse(operators: $operators, checkin_status_types: $checkin_status_types, countries: $countries, data_providers: $data_providers, status_types: $status_types, submission_status_types: $submission_status_types, usage_types: $usage_types, user_comment_types: $user_comment_types, charger_types: $charger_types, connection_types: $connection_types, current_types: $current_types)';
  }
...
class _$_SearchRequest implements _SearchRequest {
  ...
  @override
  String toString() {
    return 'SearchRequest(box: $box, connection_types: $connection_types, country_id: $country_id, location: $location, min_power: $min_power, operators: $operators, distance: $distance, levels: $levels, max_results: $max_results, usage_types: $usage_types)';
  }
