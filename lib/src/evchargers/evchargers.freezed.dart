...
class _$_Address implements _Address {
  ...
  @override
  String toString() {
    return 'Address(access_comments: $access_comments, address_line_2: $address_line_2, country_id: $country_id, lat_lng: $lat_lng, state_or_province: $state_or_province, address_line_1: $address_line_1, country: $country, location: $location, postcode: $postcode, title: $title, town: $town)';
  }
...
class _$_Connection implements _Connection {
  ...
  @override
  String toString() {
    return 'Connection(level: $level, level_id: $level_id, reference: $reference, current: $current, connection_type: $connection_type, connection_type_id: $connection_type_id, power: $power, voltage: $voltage, amps: $amps)';
  }
...
class _$_Poi implements _Poi {
  ...
  @override
  String toString() {
    return 'Poi(usage_type: $usage_type, connections: $connections, cost: $cost, data_provider_id: $data_provider_id, id: $id, operator: $operator, address: $address, num_points: $num_points, operator_id: $operator_id, usage_type_id: $usage_type_id)';
  }
...
class _$ReferenceDataResponseData implements ReferenceDataResponseData {
  ...
  @override
  String toString() {
    return 'ReferenceDataResponse(charger_types: $charger_types, current_types: $current_types, operators: $operators, status_types: $status_types, user_comment_types: $user_comment_types, checkin_status_types: $checkin_status_types, connection_types: $connection_types, countries: $countries, data_providers: $data_providers, submission_status_types: $submission_status_types, usage_types: $usage_types)';
  }
...
class _$_SearchRequest implements _SearchRequest {
  ...
  @override
  String toString() {
    return 'SearchRequest(min_power: $min_power, operators: $operators, usage_types: $usage_types, distance: $distance, levels: $levels, location: $location, max_results: $max_results, box: $box, connection_types: $connection_types, country_id: $country_id)';
  }
