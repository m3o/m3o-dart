...
class _$_Address implements _Address {
  ...
  @override
  String toString() {
    return 'Address(state_or_province: $state_or_province, title: $title, address_line_1: $address_line_1, country_id: $country_id, country: $country, lat_lng: $lat_lng, location: $location, postcode: $postcode, town: $town, access_comments: $access_comments, address_line_2: $address_line_2)';
  }
...
class _$_Connection implements _Connection {
  ...
  @override
  String toString() {
    return 'Connection(current: $current, level: $level, level_id: $level_id, voltage: $voltage, amps: $amps, connection_type: $connection_type, connection_type_id: $connection_type_id, power: $power, reference: $reference)';
  }
...
class _$_Operator implements _Operator {
  ...
  @override
  String toString() {
    return 'Operator(contact_email: $contact_email, fault_report_email: $fault_report_email, phone_primary: $phone_primary, phone_secondary: $phone_secondary, title: $title, comments: $comments, is_private_individual: $is_private_individual, website: $website, id: $id)';
  }
...
class _$_Poi implements _Poi {
  ...
  @override
  String toString() {
    return 'Poi(num_points: $num_points, operator_id: $operator_id, usage_type: $usage_type, usage_type_id: $usage_type_id, connections: $connections, cost: $cost, data_provider_id: $data_provider_id, id: $id, operator: $operator, address: $address)';
  }
...
class _$_SearchRequest implements _SearchRequest {
  ...
  @override
  String toString() {
    return 'SearchRequest(country_id: $country_id, distance: $distance, max_results: $max_results, operators: $operators, box: $box, levels: $levels, location: $location, min_power: $min_power, usage_types: $usage_types, connection_types: $connection_types)';
  }
