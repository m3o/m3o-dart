...
class _$_Connection implements _Connection {
  ...
  @override
  String toString() {
    return 'Connection(connection_type_id: $connection_type_id, current: $current, level_id: $level_id, reference: $reference, voltage: $voltage, amps: $amps, connection_type: $connection_type, level: $level, power: $power)';
  }
...
class _$_Operator implements _Operator {
  ...
  @override
  String toString() {
    return 'Operator(title: $title, contact_email: $contact_email, fault_report_email: $fault_report_email, id: $id, is_private_individual: $is_private_individual, comments: $comments, phone_primary: $phone_primary, phone_secondary: $phone_secondary, website: $website)';
  }
...
class _$_Poi implements _Poi {
  ...
  @override
  String toString() {
    return 'Poi(operator: $operator, usage_type: $usage_type, usage_type_id: $usage_type_id, address: $address, connections: $connections, num_points: $num_points, operator_id: $operator_id, cost: $cost, data_provider_id: $data_provider_id, id: $id)';
  }
...
class _$_SearchRequest implements _SearchRequest {
  ...
  @override
  String toString() {
    return 'SearchRequest(max_results: $max_results, operators: $operators, usage_types: $usage_types, distance: $distance, levels: $levels, location: $location, min_power: $min_power, box: $box, connection_types: $connection_types, country_id: $country_id)';
  }
