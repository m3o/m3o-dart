...
class _$_Address implements _Address {
  ...
  @override
  String toString() {
    return 'Address(lat_lng: $lat_lng, location: $location, postcode: $postcode, state_or_province: $state_or_province, town: $town, access_comments: $access_comments, country_id: $country_id, country: $country, title: $title, address_line_1: $address_line_1, address_line_2: $address_line_2)';
  }
...
class _$_Connection implements _Connection {
  ...
  @override
  String toString() {
    return 'Connection(connection_type: $connection_type, level: $level, reference: $reference, amps: $amps, connection_type_id: $connection_type_id, current: $current, level_id: $level_id, power: $power, voltage: $voltage)';
  }
...
class _$_Operator implements _Operator {
  ...
  @override
  String toString() {
    return 'Operator(comments: $comments, contact_email: $contact_email, fault_report_email: $fault_report_email, id: $id, is_private_individual: $is_private_individual, phone_primary: $phone_primary, title: $title, website: $website, phone_secondary: $phone_secondary)';
  }
...
class _$_Poi implements _Poi {
  ...
  @override
  String toString() {
    return 'Poi(data_provider_id: $data_provider_id, id: $id, num_points: $num_points, usage_type: $usage_type, address: $address, connections: $connections, cost: $cost, operator: $operator, operator_id: $operator_id, usage_type_id: $usage_type_id)';
  }
...
class _$ReferenceDataResponseData implements ReferenceDataResponseData {
  ...
  @override
  String toString() {
    return 'ReferenceDataResponse(charger_types: $charger_types, checkin_status_types: $checkin_status_types, submission_status_types: $submission_status_types, usage_types: $usage_types, user_comment_types: $user_comment_types, connection_types: $connection_types, countries: $countries, current_types: $current_types, data_providers: $data_providers, operators: $operators, status_types: $status_types)';
  }
...
class _$_SearchRequest implements _SearchRequest {
  ...
  @override
  String toString() {
    return 'SearchRequest(box: $box, connection_types: $connection_types, distance: $distance, location: $location, max_results: $max_results, country_id: $country_id, levels: $levels, min_power: $min_power, operators: $operators, usage_types: $usage_types)';
  }
