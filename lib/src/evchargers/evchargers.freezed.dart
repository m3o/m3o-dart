...
class _$_Address implements _Address {
  ...
  @override
  String toString() {
    return 'Address(title: $title, access_comments: $access_comments, address_line_2: $address_line_2, country_id: $country_id, lat_lng: $lat_lng, location: $location, postcode: $postcode, address_line_1: $address_line_1, country: $country, state_or_province: $state_or_province, town: $town)';
  }
...
class _$_Connection implements _Connection {
  ...
  @override
  String toString() {
    return 'Connection(connection_type_id: $connection_type_id, power: $power, voltage: $voltage, amps: $amps, current: $current, level: $level, level_id: $level_id, reference: $reference, status: $status, connection_type: $connection_type)';
  }
...
abstract class _Connection implements Connection {
  const factory _Connection(
      ...
      final String? reference,
      final StatusType? status,
      final ConnectionType? connection_type}) = _$_Connection;
...
class _$_Operator implements _Operator {
  ...
  @override
  String toString() {
    return 'Operator(website: $website, contact_email: $contact_email, fault_report_email: $fault_report_email, phone_primary: $phone_primary, phone_secondary: $phone_secondary, comments: $comments, id: $id, is_private_individual: $is_private_individual, title: $title)';
  }
...
class _$_Poi implements _Poi {
  ...
  @override
  String toString() {
    return 'Poi(operator_id: $operator_id, usage_type: $usage_type, address: $address, connections: $connections, id: $id, num_points: $num_points, operator: $operator, cost: $cost, data_provider_id: $data_provider_id, usage_type_id: $usage_type_id)';
  }
...
class _$ReferenceDataResponseData implements ReferenceDataResponseData {
  ...
  @override
  String toString() {
    return 'ReferenceDataResponse(charger_types: $charger_types, countries: $countries, user_comment_types: $user_comment_types, usage_types: $usage_types, checkin_status_types: $checkin_status_types, connection_types: $connection_types, current_types: $current_types, data_providers: $data_providers, operators: $operators, status_types: $status_types, submission_status_types: $submission_status_types)';
  }
...
class _$_SearchRequest implements _SearchRequest {
  ...
  @override
  String toString() {
    return 'SearchRequest(distance: $distance, min_power: $min_power, operators: $operators, usage_types: $usage_types, max_results: $max_results, box: $box, connection_types: $connection_types, country_id: $country_id, levels: $levels, location: $location)';
  }
