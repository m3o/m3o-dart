...
class _$_Address implements _Address {
  ...
  @override
  String toString() {
    return 'Address(access_comments: $access_comments, address_line_1: $address_line_1, address_line_2: $address_line_2, country: $country, country_id: $country_id, lat_lng: $lat_lng, location: $location, state_or_province: $state_or_province, title: $title, town: $town, postcode: $postcode)';
  }
...
class _$_Operator implements _Operator {
  ...
  @override
  String toString() {
    return 'Operator(phone_secondary: $phone_secondary, fault_report_email: $fault_report_email, id: $id, phone_primary: $phone_primary, title: $title, website: $website, comments: $comments, contact_email: $contact_email, is_private_individual: $is_private_individual)';
  }
...
class _$_Poi implements _Poi {
  ...
  @override
  String toString() {
    return 'Poi(cost: $cost, data_provider_id: $data_provider_id, num_points: $num_points, operator: $operator, address: $address, connections: $connections, id: $id, operator_id: $operator_id, usage_type: $usage_type, usage_type_id: $usage_type_id)';
  }
...
class _$_SearchRequest implements _SearchRequest {
  ...
  @override
  String toString() {
    return 'SearchRequest(distance: $distance, usage_types: $usage_types, box: $box, country_id: $country_id, levels: $levels, location: $location, max_results: $max_results, min_power: $min_power, operators: $operators, connection_types: $connection_types)';
  }
