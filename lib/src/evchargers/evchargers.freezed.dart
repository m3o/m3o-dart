...
class _$_Address implements _Address {
  ...
  @override
  String toString() {
    return 'Address(country: $country, country_id: $country_id, location: $location, state_or_province: $state_or_province, town: $town, title: $title, access_comments: $access_comments, address_line_1: $address_line_1, address_line_2: $address_line_2, lat_lng: $lat_lng, postcode: $postcode)';
  }
...
class _$_Operator implements _Operator {
  ...
  @override
  String toString() {
    return 'Operator(comments: $comments, fault_report_email: $fault_report_email, id: $id, is_private_individual: $is_private_individual, phone_secondary: $phone_secondary, contact_email: $contact_email, phone_primary: $phone_primary, title: $title, website: $website)';
  }
...
class _$_Poi implements _Poi {
  ...
  @override
  String toString() {
    return 'Poi(connections: $connections, cost: $cost, data_provider_id: $data_provider_id, id: $id, operator_id: $operator_id, address: $address, num_points: $num_points, operator: $operator, usage_type: $usage_type, usage_type_id: $usage_type_id)';
  }
...
class _$ReferenceDataResponseData implements ReferenceDataResponseData {
  ...
  @override
  String toString() {
    return 'ReferenceDataResponse(data_providers: $data_providers, submission_status_types: $submission_status_types, usage_types: $usage_types, user_comment_types: $user_comment_types, charger_types: $charger_types, current_types: $current_types, countries: $countries, operators: $operators, status_types: $status_types, checkin_status_types: $checkin_status_types, connection_types: $connection_types)';
  }
...
class _$_SearchRequest implements _SearchRequest {
  ...
  @override
  String toString() {
    return 'SearchRequest(connection_types: $connection_types, country_id: $country_id, location: $location, usage_types: $usage_types, min_power: $min_power, operators: $operators, box: $box, distance: $distance, levels: $levels, max_results: $max_results)';
  }
