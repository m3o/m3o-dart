...
class _$_Address implements _Address {
  ...
  @override
  String toString() {
    return 'Address(address_line_1: $address_line_1, address_line_2: $address_line_2, country: $country, country_id: $country_id, postcode: $postcode, state_or_province: $state_or_province, access_comments: $access_comments, location: $location, title: $title, town: $town, lat_lng: $lat_lng)';
  }
...
class _$_Connection implements _Connection {
  ...
  @override
  String toString() {
    return 'Connection(level_id: $level_id, reference: $reference, amps: $amps, connection_type: $connection_type, connection_type_id: $connection_type_id, current: $current, level: $level, power: $power, voltage: $voltage)';
  }
...
class _$_Operator implements _Operator {
  ...
  @override
  String toString() {
    return 'Operator(comments: $comments, contact_email: $contact_email, title: $title, website: $website, fault_report_email: $fault_report_email, id: $id, is_private_individual: $is_private_individual, phone_primary: $phone_primary, phone_secondary: $phone_secondary)';
  }
...
class _$_Poi implements _Poi {
  ...
  @override
  String toString() {
    return 'Poi(num_points: $num_points, connections: $connections, data_provider_id: $data_provider_id, id: $id, operator: $operator, operator_id: $operator_id, usage_type: $usage_type, usage_type_id: $usage_type_id, address: $address, cost: $cost)';
  }
...
class _$_SearchRequest implements _SearchRequest {
  ...
  @override
  String toString() {
    return 'SearchRequest(location: $location, levels: $levels, connection_types: $connection_types, country_id: $country_id, distance: $distance, max_results: $max_results, min_power: $min_power, operators: $operators, usage_types: $usage_types, box: $box)';
  }
