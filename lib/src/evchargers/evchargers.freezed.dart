...
class _$_Address implements _Address {
  ...
  @override
  String toString() {
    return 'Address(address_line_2: $address_line_2, country: $country, country_id: $country_id, state_or_province: $state_or_province, town: $town, access_comments: $access_comments, address_line_1: $address_line_1, postcode: $postcode, title: $title, lat_lng: $lat_lng, location: $location)';
  }
...
abstract class _Address implements Address {
  const factory _Address(
      ...
      final String? title,
      final String? lat_lng,
      final Coordinates? location}) = _$_Address;
...
class _$_Connection implements _Connection {
  ...
  @override
  String toString() {
    return 'Connection(connection_type: $connection_type, connection_type_id: $connection_type_id, current: $current, level: $level, power: $power, status: $status, amps: $amps, level_id: $level_id, reference: $reference, voltage: $voltage)';
  }
...
class _$_Operator implements _Operator {
  ...
  @override
  String toString() {
    return 'Operator(fault_report_email: $fault_report_email, website: $website, comments: $comments, contact_email: $contact_email, phone_primary: $phone_primary, phone_secondary: $phone_secondary, title: $title, id: $id, is_private_individual: $is_private_individual)';
  }
...
class _$_Poi implements _Poi {
  ...
  @override
  String toString() {
    return 'Poi(cost: $cost, data_provider_id: $data_provider_id, id: $id, num_points: $num_points, operator_id: $operator_id, usage_type: $usage_type, usage_type_id: $usage_type_id, address: $address, connections: $connections, operator: $operator)';
  }
...
abstract class _Poi implements Poi {
  const factory _Poi(
      ...
      final Address? address,
      final List<Connection>? connections,
      final Operator? operator}) = _$_Poi;
...
class _$ReferenceDataResponseData implements ReferenceDataResponseData {
  ...
  @override
  String toString() {
    return 'ReferenceDataResponse(connection_types: $connection_types, current_types: $current_types, operators: $operators, status_types: $status_types, user_comment_types: $user_comment_types, checkin_status_types: $checkin_status_types, countries: $countries, data_providers: $data_providers, submission_status_types: $submission_status_types, usage_types: $usage_types, charger_types: $charger_types)';
  }
...
abstract class ReferenceDataResponseData implements ReferenceDataResponse {
  const factory ReferenceDataResponseData(
      ...
      final List<SubmissionStatusType>? submission_status_types,
      final List<UsageType>? usage_types,
      final List<ChargerType>? charger_types}) = _$ReferenceDataResponseData;
...
class _$_SearchRequest implements _SearchRequest {
  ...
  @override
  String toString() {
    return 'SearchRequest(distance: $distance, location: $location, operators: $operators, box: $box, connection_types: $connection_types, country_id: $country_id, usage_types: $usage_types, levels: $levels, max_results: $max_results, min_power: $min_power)';
  }
