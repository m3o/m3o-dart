...
class _$_Address implements _Address {
  ...
  @override
  String toString() {
    return 'Address(country: $country, country_id: $country_id, lat_lng: $lat_lng, title: $title, state_or_province: $state_or_province, town: $town, access_comments: $access_comments, address_line_1: $address_line_1, address_line_2: $address_line_2, location: $location, postcode: $postcode)';
  }
...
class _$_Connection implements _Connection {
  ...
  @override
  String toString() {
    return 'Connection(level_id: $level_id, power: $power, voltage: $voltage, connection_type: $connection_type, connection_type_id: $connection_type_id, current: $current, amps: $amps, level: $level, reference: $reference)';
  }
...
class _$_Operator implements _Operator {
  ...
  @override
  String toString() {
    return 'Operator(fault_report_email: $fault_report_email, phone_primary: $phone_primary, website: $website, is_private_individual: $is_private_individual, phone_secondary: $phone_secondary, title: $title, comments: $comments, contact_email: $contact_email, id: $id)';
  }
...
class _$_Poi implements _Poi {
  ...
  @override
  String toString() {
    return 'Poi(usage_type: $usage_type, address: $address, cost: $cost, id: $id, num_points: $num_points, operator: $operator, operator_id: $operator_id, connections: $connections, data_provider_id: $data_provider_id, usage_type_id: $usage_type_id)';
  }
...
class _$ReferenceDataResponseData implements ReferenceDataResponseData {
  ...
  @override
  String toString() {
    return 'ReferenceDataResponse(countries: $countries, data_providers: $data_providers, submission_status_types: $submission_status_types, connection_types: $connection_types, checkin_status_types: $checkin_status_types, current_types: $current_types, operators: $operators, status_types: $status_types, usage_types: $usage_types, user_comment_types: $user_comment_types, charger_types: $charger_types)';
  }
...
class _$_SearchRequest implements _SearchRequest {
  ...
  @override
  String toString() {
    return 'SearchRequest(connection_types: $connection_types, distance: $distance, levels: $levels, max_results: $max_results, box: $box, country_id: $country_id, location: $location, min_power: $min_power, operators: $operators, usage_types: $usage_types)';
  }
