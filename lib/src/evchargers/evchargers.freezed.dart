...
class _$_Address implements _Address {
  ...
  @override
  String toString() {
    return 'Address(location: $location, postcode: $postcode, state_or_province: $state_or_province, title: $title, access_comments: $access_comments, address_line_1: $address_line_1, address_line_2: $address_line_2, country_id: $country_id, country: $country, lat_lng: $lat_lng, town: $town)';
  }
...
class _$_Connection implements _Connection {
  ...
  @override
  String toString() {
    return 'Connection(level: $level, power: $power, reference: $reference, connection_type: $connection_type, connection_type_id: $connection_type_id, current: $current, amps: $amps, level_id: $level_id, voltage: $voltage)';
  }
...
class _$_Operator implements _Operator {
  ...
  @override
  String toString() {
    return 'Operator(contact_email: $contact_email, phone_primary: $phone_primary, phone_secondary: $phone_secondary, comments: $comments, id: $id, is_private_individual: $is_private_individual, title: $title, website: $website, fault_report_email: $fault_report_email)';
  }
...
class _$_Poi implements _Poi {
  ...
  @override
  String toString() {
    return 'Poi(operator: $operator, usage_type: $usage_type, usage_type_id: $usage_type_id, connections: $connections, cost: $cost, data_provider_id: $data_provider_id, operator_id: $operator_id, address: $address, id: $id, num_points: $num_points)';
  }
...
class _$ReferenceDataResponseData implements ReferenceDataResponseData {
  ...
  @override
  String toString() {
    return 'ReferenceDataResponse(countries: $countries, operators: $operators, status_types: $status_types, user_comment_types: $user_comment_types, charger_types: $charger_types, checkin_status_types: $checkin_status_types, connection_types: $connection_types, current_types: $current_types, data_providers: $data_providers, submission_status_types: $submission_status_types, usage_types: $usage_types)';
  }
...
class _$_SearchRequest implements _SearchRequest {
  ...
  @override
  String toString() {
    return 'SearchRequest(connection_types: $connection_types, distance: $distance, operators: $operators, location: $location, max_results: $max_results, min_power: $min_power, usage_types: $usage_types, box: $box, country_id: $country_id, levels: $levels)';
  }
...
abstract class _SearchRequest implements SearchRequest {
  const factory _SearchRequest(
      ...
      final BoundingBox? box,
      final String? country_id,
      final List<String>? levels}) = _$_SearchRequest;
