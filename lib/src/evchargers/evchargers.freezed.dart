...
class _$_Address implements _Address {
  ...
  @override
  String toString() {
    return 'Address(country: $country, country_id: $country_id, postcode: $postcode, access_comments: $access_comments, address_line_1: $address_line_1, address_line_2: $address_line_2, title: $title, town: $town, lat_lng: $lat_lng, location: $location, state_or_province: $state_or_province)';
  }
...
class _$_Connection implements _Connection {
  ...
  @override
  String toString() {
    return 'Connection(connection_type_id: $connection_type_id, current: $current, reference: $reference, level_id: $level_id, power: $power, voltage: $voltage, amps: $amps, connection_type: $connection_type, level: $level)';
  }
...
class _$_Operator implements _Operator {
  ...
  @override
  String toString() {
    return 'Operator(phone_primary: $phone_primary, phone_secondary: $phone_secondary, title: $title, website: $website, comments: $comments, contact_email: $contact_email, fault_report_email: $fault_report_email, id: $id, is_private_individual: $is_private_individual)';
  }
...
class _$_Poi implements _Poi {
  ...
  @override
  String toString() {
    return 'Poi(cost: $cost, id: $id, num_points: $num_points, operator: $operator, operator_id: $operator_id, usage_type_id: $usage_type_id, address: $address, connections: $connections, data_provider_id: $data_provider_id, usage_type: $usage_type)';
  }
...
class _$ReferenceDataResponseData implements ReferenceDataResponseData {
  ...
  @override
  String toString() {
    return 'ReferenceDataResponse(status_types: $status_types, user_comment_types: $user_comment_types, charger_types: $charger_types, data_providers: $data_providers, countries: $countries, current_types: $current_types, operators: $operators, submission_status_types: $submission_status_types, usage_types: $usage_types, checkin_status_types: $checkin_status_types, connection_types: $connection_types)';
  }
...
class _$_SearchRequest implements _SearchRequest {
  ...
  @override
  String toString() {
    return 'SearchRequest(connection_types: $connection_types, location: $location, operators: $operators, usage_types: $usage_types, box: $box, country_id: $country_id, distance: $distance, levels: $levels, max_results: $max_results, min_power: $min_power)';
  }
