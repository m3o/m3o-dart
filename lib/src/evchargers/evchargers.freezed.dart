...
class _$_Address implements _Address {
  ...
  @override
  String toString() {
    return 'Address(lat_lng: $lat_lng, postcode: $postcode, access_comments: $access_comments, address_line_1: $address_line_1, address_line_2: $address_line_2, state_or_province: $state_or_province, title: $title, town: $town, country: $country, country_id: $country_id, location: $location)';
  }
...
class _$_Operator implements _Operator {
  ...
  @override
  String toString() {
    return 'Operator(comments: $comments, phone_secondary: $phone_secondary, title: $title, contact_email: $contact_email, fault_report_email: $fault_report_email, id: $id, is_private_individual: $is_private_individual, phone_primary: $phone_primary, website: $website)';
  }
...
class _$_Poi implements _Poi {
  ...
  @override
  String toString() {
    return 'Poi(address: $address, connections: $connections, id: $id, operator: $operator, operator_id: $operator_id, cost: $cost, data_provider_id: $data_provider_id, num_points: $num_points, usage_type: $usage_type, usage_type_id: $usage_type_id)';
  }
...
class _$ReferenceDataResponseData implements ReferenceDataResponseData {
  ...
  @override
  String toString() {
    return 'ReferenceDataResponse(submission_status_types: $submission_status_types, charger_types: $charger_types, current_types: $current_types, operators: $operators, status_types: $status_types, usage_types: $usage_types, user_comment_types: $user_comment_types, checkin_status_types: $checkin_status_types, connection_types: $connection_types, countries: $countries, data_providers: $data_providers)';
  }
...
class _$_SearchRequest implements _SearchRequest {
  ...
  @override
  String toString() {
    return 'SearchRequest(box: $box, connection_types: $connection_types, country_id: $country_id, distance: $distance, levels: $levels, min_power: $min_power, operators: $operators, location: $location, max_results: $max_results, usage_types: $usage_types)';
  }
