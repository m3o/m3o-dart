...
class _$_Address implements _Address {
  ...
  @override
  String toString() {
    return 'Address(country_id: $country_id, lat_lng: $lat_lng, state_or_province: $state_or_province, town: $town, address_line_1: $address_line_1, address_line_2: $address_line_2, country: $country, title: $title, access_comments: $access_comments, location: $location, postcode: $postcode)';
  }
...
class _$_Operator implements _Operator {
  ...
  @override
  String toString() {
    return 'Operator(fault_report_email: $fault_report_email, id: $id, is_private_individual: $is_private_individual, website: $website, comments: $comments, contact_email: $contact_email, phone_primary: $phone_primary, phone_secondary: $phone_secondary, title: $title)';
  }
...
class _$_Poi implements _Poi {
  ...
  @override
  String toString() {
    return 'Poi(address: $address, data_provider_id: $data_provider_id, operator: $operator, usage_type_id: $usage_type_id, usage_type: $usage_type, connections: $connections, cost: $cost, id: $id, num_points: $num_points, operator_id: $operator_id)';
  }
...
class _$_SearchRequest implements _SearchRequest {
  ...
  @override
  String toString() {
    return 'SearchRequest(min_power: $min_power, usage_types: $usage_types, country_id: $country_id, location: $location, distance: $distance, levels: $levels, max_results: $max_results, operators: $operators, box: $box, connection_types: $connection_types)';
  }
