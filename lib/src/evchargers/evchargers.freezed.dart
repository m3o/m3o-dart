...
class _$_Address implements _Address {
  ...
  @override
  String toString() {
    return 'Address(address_line_1: $address_line_1, country_id: $country_id, state_or_province: $state_or_province, town: $town, access_comments: $access_comments, address_line_2: $address_line_2, country: $country, lat_lng: $lat_lng, location: $location, postcode: $postcode, title: $title)';
  }
...
class _$_Connection implements _Connection {
  ...
  @override
  String toString() {
    return 'Connection(connection_type_id: $connection_type_id, current: $current, level_id: $level_id, power: $power, reference: $reference, amps: $amps, connection_type: $connection_type, level: $level, voltage: $voltage)';
  }
...
class _$_Operator implements _Operator {
  ...
  @override
  String toString() {
    return 'Operator(is_private_individual: $is_private_individual, phone_secondary: $phone_secondary, fault_report_email: $fault_report_email, id: $id, phone_primary: $phone_primary, title: $title, website: $website, comments: $comments, contact_email: $contact_email)';
  }
...
class _$_Poi implements _Poi {
  ...
  @override
  String toString() {
    return 'Poi(usage_type: $usage_type, address: $address, connections: $connections, data_provider_id: $data_provider_id, id: $id, num_points: $num_points, cost: $cost, operator: $operator, operator_id: $operator_id, usage_type_id: $usage_type_id)';
  }
...
class _$_SearchRequest implements _SearchRequest {
  ...
  @override
  String toString() {
    return 'SearchRequest(usage_types: $usage_types, box: $box, connection_types: $connection_types, country_id: $country_id, location: $location, max_results: $max_results, min_power: $min_power, distance: $distance, levels: $levels, operators: $operators)';
  }
