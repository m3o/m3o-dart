...
class _$_Gif implements _Gif {
  ...
  @override
  String toString() {
    return 'Gif(rating: $rating, slug: $slug, title: $title, url: $url, embed_url: $embed_url, id: $id, images: $images, short_url: $short_url, source: $source)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, rating, slug, title, url,
      embed_url, id, images, short_url, source);
...
class _$_ImageFormats implements _ImageFormats {
  ...
  @override
  String toString() {
    return 'ImageFormats(fixed_height_still: $fixed_height_still, original: $original, fixed_height_downsampled: $fixed_height_downsampled, fixed_height_small: $fixed_height_small, fixed_height: $fixed_height, fixed_width_small: $fixed_width_small, fixed_width_small_still: $fixed_width_small_still, looping: $looping, downsized_large: $downsized_large, downsized_medium: $downsized_medium, fixed_width: $fixed_width, fixed_width_still: $fixed_width_still, preview_gif: $preview_gif, downsized: $downsized, fixed_height_small_still: $fixed_height_small_still, fixed_width_downsampled: $fixed_width_downsampled, original_still: $original_still, preview: $preview, downsized_small: $downsized_small, downsized_still: $downsized_still)';
  }
...
abstract class _ImageFormats implements ImageFormats {
  const factory _ImageFormats(
      ...
      final ImageFormat? preview,
      final ImageFormat? downsized_small,
      final ImageFormat? downsized_still}) = _$_ImageFormats;
