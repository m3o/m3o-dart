...
class _$_Gif implements _Gif {
  ...
  @override
  String toString() {
    return 'Gif(rating: $rating, slug: $slug, source: $source, title: $title, url: $url, images: $images, id: $id, short_url: $short_url, embed_url: $embed_url)';
  }
...
class _$_ImageFormats implements _ImageFormats {
  ...
  @override
  String toString() {
    return 'ImageFormats(preview: $preview, fixed_height_small: $fixed_height_small, original_still: $original_still, downsized_small: $downsized_small, fixed_height_downsampled: $fixed_height_downsampled, fixed_width_downsampled: $fixed_width_downsampled, fixed_width_small: $fixed_width_small, fixed_width_still: $fixed_width_still, looping: $looping, downsized_large: $downsized_large, downsized_medium: $downsized_medium, original: $original, fixed_width_small_still: $fixed_width_small_still, downsized_still: $downsized_still, fixed_width: $fixed_width, fixed_height_small_still: $fixed_height_small_still, fixed_height_still: $fixed_height_still, preview_gif: $preview_gif, downsized: $downsized, fixed_height: $fixed_height)';
  }
