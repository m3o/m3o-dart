...
class _$_Gif implements _Gif {
  ...
  @override
  String toString() {
    return 'Gif(slug: $slug, url: $url, embed_url: $embed_url, id: $id, short_url: $short_url, source: $source, title: $title, images: $images, rating: $rating)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, slug, url, embed_url, id,
      short_url, source, title, images, rating);
...
class _$_ImageFormats implements _ImageFormats {
  ...
  @override
  String toString() {
    return 'ImageFormats(fixed_height_small_still: $fixed_height_small_still, fixed_width: $fixed_width, fixed_width_small: $fixed_width_small, original: $original, fixed_height_small: $fixed_height_small, fixed_width_downsampled: $fixed_width_downsampled, fixed_width_small_still: $fixed_width_small_still, preview: $preview, downsized: $downsized, downsized_large: $downsized_large, fixed_height: $fixed_height, fixed_height_downsampled: $fixed_height_downsampled, fixed_height_still: $fixed_height_still, preview_gif: $preview_gif, downsized_medium: $downsized_medium, downsized_small: $downsized_small, downsized_still: $downsized_still, fixed_width_still: $fixed_width_still, looping: $looping, original_still: $original_still)';
  }
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.fixed_width_downsampled, fixed_width_downsampled) ||
...
abstract class _ImageFormats implements ImageFormats {
  const factory _ImageFormats(
      ...
      final ImageFormat? fixed_width_still,
      final ImageFormat? looping,
      final ImageFormat? original_still}) = _$_ImageFormats;
...
class _$_SearchRequest implements _SearchRequest {
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, offset, query, rating, lang, limit);
