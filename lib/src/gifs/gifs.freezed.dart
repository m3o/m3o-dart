...
class _$_ImageFormats implements _ImageFormats {
  ...
  @override
  String toString() {
    return 'ImageFormats(downsized_large: $downsized_large, fixed_width_downsampled: $fixed_width_downsampled, original: $original, downsized: $downsized, fixed_height_small_still: $fixed_height_small_still, fixed_width_small_still: $fixed_width_small_still, preview_gif: $preview_gif, downsized_medium: $downsized_medium, fixed_height_still: $fixed_height_still, fixed_width: $fixed_width, fixed_width_still: $fixed_width_still, original_still: $original_still, fixed_height: $fixed_height, downsized_still: $downsized_still, fixed_height_downsampled: $fixed_height_downsampled, fixed_height_small: $fixed_height_small, fixed_width_small: $fixed_width_small, looping: $looping, preview: $preview, downsized_small: $downsized_small)';
  }
