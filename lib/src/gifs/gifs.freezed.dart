...
class _$_Gif implements _Gif {
  ...
  @override
  String toString() {
    return 'Gif(images: $images, slug: $slug, embed_url: $embed_url, id: $id, source: $source, title: $title, url: $url, rating: $rating, short_url: $short_url)';
  }
...
class _$_ImageFormats implements _ImageFormats {
  ...
  @override
  String toString() {
    return 'ImageFormats(fixed_height_still: $fixed_height_still, fixed_width: $fixed_width, fixed_width_small_still: $fixed_width_small_still, looping: $looping, preview_gif: $preview_gif, downsized_large: $downsized_large, downsized_small: $downsized_small, downsized_still: $downsized_still, downsized: $downsized, fixed_height_small_still: $fixed_height_small_still, fixed_width_still: $fixed_width_still, original: $original, original_still: $original_still, preview: $preview, fixed_height: $fixed_height, fixed_height_small: $fixed_height_small, fixed_width_small: $fixed_width_small, downsized_medium: $downsized_medium, fixed_height_downsampled: $fixed_height_downsampled, fixed_width_downsampled: $fixed_width_downsampled)';
  }
