...
class _$_Gif implements _Gif {
  ...
  @override
  String toString() {
    return 'Gif(id: $id, slug: $slug, source: $source, url: $url, title: $title, embed_url: $embed_url, images: $images, rating: $rating, short_url: $short_url)';
  }
...
class _$_ImageFormats implements _ImageFormats {
  ...
  @override
  String toString() {
    return 'ImageFormats(fixed_height_downsampled: $fixed_height_downsampled, fixed_height_still: $fixed_height_still, fixed_width_small: $fixed_width_small, fixed_width_still: $fixed_width_still, preview: $preview, downsized_medium: $downsized_medium, downsized_small: $downsized_small, downsized_still: $downsized_still, original: $original, downsized_large: $downsized_large, fixed_height: $fixed_height, fixed_height_small_still: $fixed_height_small_still, preview_gif: $preview_gif, fixed_width_small_still: $fixed_width_small_still, looping: $looping, original_still: $original_still, downsized: $downsized, fixed_height_small: $fixed_height_small, fixed_width: $fixed_width, fixed_width_downsampled: $fixed_width_downsampled)';
  }
