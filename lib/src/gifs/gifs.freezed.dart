...
class _$_Gif implements _Gif {
  ...
  @override
  String toString() {
    return 'Gif(slug: $slug, source: $source, rating: $rating, short_url: $short_url, images: $images, title: $title, url: $url, embed_url: $embed_url, id: $id)';
  }
...
class _$_ImageFormats implements _ImageFormats {
  ...
  @override
  String toString() {
    return 'ImageFormats(fixed_height_small: $fixed_height_small, fixed_width_small: $fixed_width_small, looping: $looping, preview_gif: $preview_gif, downsized_medium: $downsized_medium, fixed_height: $fixed_height, fixed_height_downsampled: $fixed_height_downsampled, original_still: $original_still, downsized: $downsized, downsized_small: $downsized_small, original: $original, downsized_large: $downsized_large, downsized_still: $downsized_still, fixed_height_still: $fixed_height_still, fixed_width_small_still: $fixed_width_small_still, fixed_width_still: $fixed_width_still, preview: $preview, fixed_height_small_still: $fixed_height_small_still, fixed_width: $fixed_width, fixed_width_downsampled: $fixed_width_downsampled)';
  }
