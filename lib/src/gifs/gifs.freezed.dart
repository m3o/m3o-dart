...
class _$_Gif implements _Gif {
  ...
  @override
  String toString() {
    return 'Gif(rating: $rating, slug: $slug, title: $title, images: $images, id: $id, short_url: $short_url, source: $source, url: $url, embed_url: $embed_url)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, rating, slug, title, images, id,
      short_url, source, url, embed_url);
...
class _$_ImageFormats implements _ImageFormats {
  ...
  @override
  String toString() {
    return 'ImageFormats(fixed_width_downsampled: $fixed_width_downsampled, fixed_width_still: $fixed_width_still, downsized: $downsized, downsized_large: $downsized_large, downsized_medium: $downsized_medium, fixed_height_downsampled: $fixed_height_downsampled, fixed_height_small: $fixed_height_small, fixed_width: $fixed_width, looping: $looping, original_still: $original_still, downsized_still: $downsized_still, preview_gif: $preview_gif, fixed_height: $fixed_height, fixed_height_small_still: $fixed_height_small_still, fixed_width_small: $fixed_width_small, fixed_width_small_still: $fixed_width_small_still, original: $original, downsized_small: $downsized_small, fixed_height_still: $fixed_height_still, preview: $preview)';
  }
