...
class _$_ImageFormats implements _ImageFormats {
  ...
  @override
  String toString() {
    return 'ImageFormats(original_still: $original_still, preview_gif: $preview_gif, fixed_height_small: $fixed_height_small, fixed_height_still: $fixed_height_still, fixed_width_downsampled: $fixed_width_downsampled, fixed_width_still: $fixed_width_still, looping: $looping, downsized_small: $downsized_small, fixed_height_downsampled: $fixed_height_downsampled, fixed_height: $fixed_height, fixed_height_small_still: $fixed_height_small_still, fixed_width: $fixed_width, fixed_width_small_still: $fixed_width_small_still, downsized: $downsized, downsized_large: $downsized_large, fixed_width_small: $fixed_width_small, original: $original, preview: $preview, downsized_medium: $downsized_medium, downsized_still: $downsized_still)';
  }
