...
class _$_Gif implements _Gif {
  ...
  @override
  String toString() {
    return 'Gif(id: $id, rating: $rating, short_url: $short_url, slug: $slug, source: $source, embed_url: $embed_url, images: $images, title: $title, url: $url)';
  }
...
class _$_ImageFormats implements _ImageFormats {
  ...
  @override
  String toString() {
    return 'ImageFormats(fixed_height_downsampled: $fixed_height_downsampled, fixed_height_small: $fixed_height_small, fixed_width_small_still: $fixed_width_small_still, fixed_width_still: $fixed_width_still, original: $original, preview_gif: $preview_gif, downsized_large: $downsized_large, fixed_height: $fixed_height, downsized_medium: $downsized_medium, fixed_height_still: $fixed_height_still, original_still: $original_still, preview: $preview, downsized_small: $downsized_small, fixed_width: $fixed_width, fixed_height_small_still: $fixed_height_small_still, fixed_width_downsampled: $fixed_width_downsampled, fixed_width_small: $fixed_width_small, looping: $looping, downsized: $downsized, downsized_still: $downsized_still)';
  }
