...
class _$_Gif implements _Gif {
  ...
  @override
  String toString() {
    return 'Gif(url: $url, embed_url: $embed_url, rating: $rating, short_url: $short_url, slug: $slug, id: $id, images: $images, source: $source, title: $title)';
  }
...
class _$_ImageFormats implements _ImageFormats {
  ...
  @override
  String toString() {
    return 'ImageFormats(downsized: $downsized, fixed_height_small_still: $fixed_height_small_still, fixed_height_still: $fixed_height_still, fixed_width_downsampled: $fixed_width_downsampled, fixed_width_small_still: $fixed_width_small_still, fixed_width_still: $fixed_width_still, downsized_still: $downsized_still, fixed_height: $fixed_height, original_still: $original_still, downsized_medium: $downsized_medium, fixed_height_downsampled: $fixed_height_downsampled, fixed_height_small: $fixed_height_small, fixed_width: $fixed_width, looping: $looping, original: $original, downsized_large: $downsized_large, downsized_small: $downsized_small, fixed_width_small: $fixed_width_small, preview: $preview, preview_gif: $preview_gif)';
  }
