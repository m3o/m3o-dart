...
class _$_Gif implements _Gif {
  ...
  @override
  String toString() {
    return 'Gif(url: $url, embed_url: $embed_url, images: $images, slug: $slug, title: $title, id: $id, rating: $rating, short_url: $short_url, source: $source)';
  }
...
class _$_ImageFormats implements _ImageFormats {
  ...
  @override
  String toString() {
    return 'ImageFormats(fixed_width_still: $fixed_width_still, downsized_medium: $downsized_medium, downsized_small: $downsized_small, fixed_height_still: $fixed_height_still, fixed_width_small_still: $fixed_width_small_still, looping: $looping, downsized: $downsized, downsized_large: $downsized_large, fixed_width_small: $fixed_width_small, original_still: $original_still, preview: $preview, fixed_height_small_still: $fixed_height_small_still, fixed_width_downsampled: $fixed_width_downsampled, original: $original, fixed_height_small: $fixed_height_small, fixed_width: $fixed_width, preview_gif: $preview_gif, downsized_still: $downsized_still, fixed_height: $fixed_height, fixed_height_downsampled: $fixed_height_downsampled)';
  }
