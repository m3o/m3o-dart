...
class _$_Gif implements _Gif {
  ...
  @override
  String toString() {
    return 'Gif(images: $images, source: $source, title: $title, embed_url: $embed_url, id: $id, rating: $rating, short_url: $short_url, slug: $slug, url: $url)';
  }
...
class _$_ImageFormats implements _ImageFormats {
  ...
  @override
  String toString() {
    return 'ImageFormats(fixed_height_small: $fixed_height_small, fixed_height_still: $fixed_height_still, fixed_width: $fixed_width, original: $original, downsized_large: $downsized_large, downsized_medium: $downsized_medium, fixed_height_downsampled: $fixed_height_downsampled, fixed_height_small_still: $fixed_height_small_still, original_still: $original_still, downsized_small: $downsized_small, fixed_width_downsampled: $fixed_width_downsampled, looping: $looping, fixed_width_small: $fixed_width_small, fixed_width_small_still: $fixed_width_small_still, fixed_width_still: $fixed_width_still, preview: $preview, preview_gif: $preview_gif, downsized: $downsized, downsized_still: $downsized_still, fixed_height: $fixed_height)';
  }
...
abstract class _ImageFormats implements ImageFormats {
  const factory _ImageFormats(
      ...
      final ImageFormat? downsized,
      final ImageFormat? downsized_still,
      final ImageFormat? fixed_height}) = _$_ImageFormats;
