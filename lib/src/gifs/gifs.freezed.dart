...
class _$_Gif implements _Gif {
  ...
  @override
  String toString() {
    return 'Gif(slug: $slug, title: $title, embed_url: $embed_url, id: $id, short_url: $short_url, source: $source, url: $url, images: $images, rating: $rating)';
  }
...
class _$_ImageFormats implements _ImageFormats {
  ...
  @override
  String toString() {
    return 'ImageFormats(fixed_width_small_still: $fixed_width_small_still, fixed_width_still: $fixed_width_still, original: $original, preview: $preview, downsized: $downsized, fixed_height_small_still: $fixed_height_small_still, fixed_height_small: $fixed_height_small, fixed_height_still: $fixed_height_still, fixed_width: $fixed_width, fixed_width_downsampled: $fixed_width_downsampled, looping: $looping, preview_gif: $preview_gif, downsized_large: $downsized_large, downsized_still: $downsized_still, fixed_height: $fixed_height, fixed_height_downsampled: $fixed_height_downsampled, fixed_width_small: $fixed_width_small, original_still: $original_still, downsized_medium: $downsized_medium, downsized_small: $downsized_small)';
  }
