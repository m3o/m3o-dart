...
class _$_Gif implements _Gif {
  ...
  @override
  String toString() {
    return 'Gif(embed_url: $embed_url, short_url: $short_url, slug: $slug, title: $title, url: $url, id: $id, images: $images, rating: $rating, source: $source)';
  }
...
class _$_ImageFormats implements _ImageFormats {
  ...
  @override
  String toString() {
    return 'ImageFormats(looping: $looping, original: $original, fixed_height: $fixed_height, fixed_height_small: $fixed_height_small, fixed_height_small_still: $fixed_height_small_still, fixed_height_still: $fixed_height_still, fixed_width_still: $fixed_width_still, downsized_large: $downsized_large, downsized_small: $downsized_small, fixed_width_small: $fixed_width_small, fixed_width_small_still: $fixed_width_small_still, original_still: $original_still, downsized: $downsized, downsized_still: $downsized_still, fixed_height_downsampled: $fixed_height_downsampled, preview: $preview, downsized_medium: $downsized_medium, fixed_width: $fixed_width, fixed_width_downsampled: $fixed_width_downsampled, preview_gif: $preview_gif)';
  }
...
abstract class _ImageFormats implements ImageFormats {
  const factory _ImageFormats(
      ...
      final ImageFormat? fixed_width,
      final ImageFormat? fixed_width_downsampled,
      final ImageFormat? preview_gif}) = _$_ImageFormats;
