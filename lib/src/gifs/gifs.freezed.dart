...
class _$_Gif implements _Gif {
  ...
  @override
  String toString() {
    return 'Gif(rating: $rating, source: $source, url: $url, embed_url: $embed_url, id: $id, slug: $slug, title: $title, images: $images, short_url: $short_url)';
  }
...
class _$_ImageFormats implements _ImageFormats {
  ...
  @override
  String toString() {
    return 'ImageFormats(fixed_height_still: $fixed_height_still, fixed_width: $fixed_width, looping: $looping, downsized_still: $downsized_still, downsized_small: $downsized_small, fixed_height_small: $fixed_height_small, fixed_height_small_still: $fixed_height_small_still, fixed_width_still: $fixed_width_still, preview_gif: $preview_gif, downsized: $downsized, fixed_height: $fixed_height, fixed_width_small_still: $fixed_width_small_still, preview: $preview, downsized_medium: $downsized_medium, fixed_height_downsampled: $fixed_height_downsampled, fixed_width_downsampled: $fixed_width_downsampled, fixed_width_small: $fixed_width_small, original: $original, original_still: $original_still, downsized_large: $downsized_large)';
  }
