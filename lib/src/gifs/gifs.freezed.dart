...
class _$_Gif implements _Gif {
  ...
  @override
  String toString() {
    return 'Gif(short_url: $short_url, title: $title, url: $url, embed_url: $embed_url, images: $images, rating: $rating, slug: $slug, source: $source, id: $id)';
  }
...
class _$_ImageFormats implements _ImageFormats {
  ...
  @override
  String toString() {
    return 'ImageFormats(fixed_height_still: $fixed_height_still, fixed_width_downsampled: $fixed_width_downsampled, preview_gif: $preview_gif, downsized: $downsized, fixed_height_downsampled: $fixed_height_downsampled, fixed_width_small: $fixed_width_small, original: $original, downsized_still: $downsized_still, fixed_height: $fixed_height, fixed_height_small: $fixed_height_small, fixed_height_small_still: $fixed_height_small_still, fixed_width: $fixed_width, fixed_width_small_still: $fixed_width_small_still, downsized_medium: $downsized_medium, downsized_small: $downsized_small, preview: $preview, looping: $looping, original_still: $original_still, downsized_large: $downsized_large, fixed_width_still: $fixed_width_still)';
  }
