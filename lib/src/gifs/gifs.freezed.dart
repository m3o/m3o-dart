...
class _$_Gif implements _Gif {
  ...
  @override
  String toString() {
    return 'Gif(images: $images, rating: $rating, source: $source, title: $title, url: $url, embed_url: $embed_url, id: $id, short_url: $short_url, slug: $slug)';
  }
...
class _$_ImageFormats implements _ImageFormats {
  ...
  @override
  String toString() {
    return 'ImageFormats(looping: $looping, original: $original, original_still: $original_still, preview_gif: $preview_gif, fixed_height_small: $fixed_height_small, fixed_width_small_still: $fixed_width_small_still, fixed_width_still: $fixed_width_still, downsized_medium: $downsized_medium, downsized_still: $downsized_still, preview: $preview, downsized: $downsized, fixed_height_still: $fixed_height_still, fixed_width_downsampled: $fixed_width_downsampled, fixed_height_downsampled: $fixed_height_downsampled, fixed_height_small_still: $fixed_height_small_still, fixed_width: $fixed_width, fixed_width_small: $fixed_width_small, downsized_large: $downsized_large, downsized_small: $downsized_small, fixed_height: $fixed_height)';
  }
