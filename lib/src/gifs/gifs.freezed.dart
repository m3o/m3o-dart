...
class _$_Gif implements _Gif {
  ...
  @override
  String toString() {
    return 'Gif(url: $url, images: $images, short_url: $short_url, slug: $slug, source: $source, title: $title, embed_url: $embed_url, id: $id, rating: $rating)';
  }
...
class _$_ImageFormats implements _ImageFormats {
  ...
  @override
  String toString() {
    return 'ImageFormats(downsized_medium: $downsized_medium, fixed_height: $fixed_height, preview_gif: $preview_gif, original_still: $original_still, preview: $preview, fixed_height_still: $fixed_height_still, fixed_width_still: $fixed_width_still, original: $original, fixed_width_downsampled: $fixed_width_downsampled, fixed_width_small: $fixed_width_small, fixed_width_small_still: $fixed_width_small_still, downsized_large: $downsized_large, downsized_still: $downsized_still, fixed_width: $fixed_width, fixed_height_small: $fixed_height_small, fixed_height_small_still: $fixed_height_small_still, looping: $looping, downsized: $downsized, downsized_small: $downsized_small, fixed_height_downsampled: $fixed_height_downsampled)';
  }
