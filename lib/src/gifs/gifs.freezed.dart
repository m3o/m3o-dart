...
class _$_Gif implements _Gif {
  ...
  @override
  String toString() {
    return 'Gif(short_url: $short_url, slug: $slug, source: $source, title: $title, url: $url, embed_url: $embed_url, images: $images, id: $id, rating: $rating)';
  }
...
class _$_ImageFormats implements _ImageFormats {
  ...
  @override
  String toString() {
    return 'ImageFormats(original: $original, original_still: $original_still, fixed_height_downsampled: $fixed_height_downsampled, fixed_height_still: $fixed_height_still, fixed_width_small_still: $fixed_width_small_still, fixed_width: $fixed_width, fixed_width_still: $fixed_width_still, preview: $preview, preview_gif: $preview_gif, downsized_medium: $downsized_medium, downsized_still: $downsized_still, fixed_height: $fixed_height, fixed_height_small: $fixed_height_small, fixed_height_small_still: $fixed_height_small_still, fixed_width_small: $fixed_width_small, looping: $looping, downsized: $downsized, downsized_large: $downsized_large, downsized_small: $downsized_small, fixed_width_downsampled: $fixed_width_downsampled)';
  }
