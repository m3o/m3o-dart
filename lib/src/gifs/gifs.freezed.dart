...
class _$_Gif implements _Gif {
  ...
  @override
  String toString() {
    return 'Gif(embed_url: $embed_url, rating: $rating, short_url: $short_url, slug: $slug, title: $title, id: $id, images: $images, source: $source, url: $url)';
  }
...
class _$_ImageFormats implements _ImageFormats {
  ...
  @override
  String toString() {
    return 'ImageFormats(fixed_height_small: $fixed_height_small, fixed_width_small: $fixed_width_small, original_still: $original_still, preview_gif: $preview_gif, downsized_large: $downsized_large, downsized_still: $downsized_still, fixed_height_still: $fixed_height_still, looping: $looping, original: $original, downsized_medium: $downsized_medium, fixed_height_downsampled: $fixed_height_downsampled, fixed_height: $fixed_height, fixed_height_small_still: $fixed_height_small_still, fixed_width: $fixed_width, fixed_width_downsampled: $fixed_width_downsampled, fixed_width_small_still: $fixed_width_small_still, fixed_width_still: $fixed_width_still, downsized: $downsized, downsized_small: $downsized_small, preview: $preview)';
  }
