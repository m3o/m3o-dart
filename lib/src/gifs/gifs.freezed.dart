...
class _$_Gif implements _Gif {
  ...
  @override
  String toString() {
    return 'Gif(source: $source, title: $title, short_url: $short_url, slug: $slug, url: $url, embed_url: $embed_url, id: $id, images: $images, rating: $rating)';
  }
...
class _$_ImageFormats implements _ImageFormats {
  ...
  @override
  String toString() {
    return 'ImageFormats(fixed_height_still: $fixed_height_still, fixed_width: $fixed_width, looping: $looping, original: $original, preview_gif: $preview_gif, downsized_still: $downsized_still, fixed_height_small_still: $fixed_height_small_still, fixed_width_small: $fixed_width_small, fixed_width_small_still: $fixed_width_small_still, fixed_width_still: $fixed_width_still, fixed_height_small: $fixed_height_small, fixed_width_downsampled: $fixed_width_downsampled, fixed_height: $fixed_height, original_still: $original_still, downsized: $downsized, downsized_small: $downsized_small, fixed_height_downsampled: $fixed_height_downsampled, preview: $preview, downsized_large: $downsized_large, downsized_medium: $downsized_medium)';
  }
