...
class _$_Gif implements _Gif {
  ...
  @override
  String toString() {
    return 'Gif(rating: $rating, source: $source, title: $title, url: $url, embed_url: $embed_url, id: $id, images: $images, short_url: $short_url, slug: $slug)';
  }
...
class _$_ImageFormats implements _ImageFormats {
  ...
  @override
  String toString() {
    return 'ImageFormats(fixed_width_still: $fixed_width_still, looping: $looping, downsized_small: $downsized_small, downsized_still: $downsized_still, fixed_height_still: $fixed_height_still, fixed_width_small: $fixed_width_small, downsized_large: $downsized_large, fixed_height_small: $fixed_height_small, preview: $preview, fixed_width_downsampled: $fixed_width_downsampled, fixed_width_small_still: $fixed_width_small_still, fixed_height: $fixed_height, fixed_height_downsampled: $fixed_height_downsampled, fixed_height_small_still: $fixed_height_small_still, fixed_width: $fixed_width, preview_gif: $preview_gif, downsized: $downsized, downsized_medium: $downsized_medium, original: $original, original_still: $original_still)';
  }
