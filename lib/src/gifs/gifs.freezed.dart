...
class _$_Gif implements _Gif {
  ...
  @override
  String toString() {
    return 'Gif(embed_url: $embed_url, id: $id, short_url: $short_url, slug: $slug, source: $source, url: $url, images: $images, rating: $rating, title: $title)';
  }
...
class _$_ImageFormats implements _ImageFormats {
  ...
  @override
  String toString() {
    return 'ImageFormats(downsized_still: $downsized_still, fixed_width: $fixed_width, fixed_width_small_still: $fixed_width_small_still, looping: $looping, downsized_small: $downsized_small, fixed_height_still: $fixed_height_still, fixed_width_downsampled: $fixed_width_downsampled, fixed_width_still: $fixed_width_still, original_still: $original_still, preview: $preview, fixed_height: $fixed_height, fixed_height_downsampled: $fixed_height_downsampled, fixed_height_small: $fixed_height_small, original: $original, downsized: $downsized, downsized_large: $downsized_large, downsized_medium: $downsized_medium, fixed_height_small_still: $fixed_height_small_still, fixed_width_small: $fixed_width_small, preview_gif: $preview_gif)';
  }
