...
class _$_Gif implements _Gif {
  ...
  @override
  String toString() {
    return 'Gif(id: $id, rating: $rating, short_url: $short_url, embed_url: $embed_url, slug: $slug, source: $source, title: $title, url: $url, images: $images)';
  }
...
class _$_ImageFormats implements _ImageFormats {
  ...
  @override
  String toString() {
    return 'ImageFormats(downsized_medium: $downsized_medium, fixed_width_small: $fixed_width_small, preview: $preview, downsized_large: $downsized_large, fixed_height_small: $fixed_height_small, preview_gif: $preview_gif, downsized: $downsized, fixed_height_small_still: $fixed_height_small_still, fixed_height_still: $fixed_height_still, fixed_width_small_still: $fixed_width_small_still, fixed_width_still: $fixed_width_still, looping: $looping, original_still: $original_still, fixed_height: $fixed_height, downsized_still: $downsized_still, fixed_height_downsampled: $fixed_height_downsampled, fixed_width: $fixed_width, fixed_width_downsampled: $fixed_width_downsampled, original: $original, downsized_small: $downsized_small)';
  }
