...
class _$_Gif implements _Gif {
  ...
  @override
  String toString() {
    return 'Gif(title: $title, embed_url: $embed_url, rating: $rating, short_url: $short_url, slug: $slug, source: $source, url: $url, id: $id, images: $images)';
  }
...
class _$_ImageFormats implements _ImageFormats {
  ...
  @override
  String toString() {
    return 'ImageFormats(original: $original, downsized_small: $downsized_small, downsized_still: $downsized_still, fixed_height: $fixed_height, fixed_width: $fixed_width, fixed_width_small_still: $fixed_width_small_still, downsized_large: $downsized_large, downsized_medium: $downsized_medium, fixed_height_still: $fixed_height_still, fixed_width_downsampled: $fixed_width_downsampled, looping: $looping, fixed_height_small: $fixed_height_small, fixed_width_small: $fixed_width_small, preview_gif: $preview_gif, preview: $preview, downsized: $downsized, fixed_height_downsampled: $fixed_height_downsampled, fixed_height_small_still: $fixed_height_small_still, fixed_width_still: $fixed_width_still, original_still: $original_still)';
  }
