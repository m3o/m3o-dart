...
class _$_Gif implements _Gif {
  ...
  @override
  String toString() {
    return 'Gif(source: $source, title: $title, images: $images, rating: $rating, slug: $slug, url: $url, embed_url: $embed_url, id: $id, short_url: $short_url)';
  }
...
class _$_ImageFormats implements _ImageFormats {
  ...
  @override
  String toString() {
    return 'ImageFormats(downsized_small: $downsized_small, fixed_height_downsampled: $fixed_height_downsampled, fixed_width_small: $fixed_width_small, fixed_width_still: $fixed_width_still, original_still: $original_still, preview_gif: $preview_gif, downsized_large: $downsized_large, downsized_medium: $downsized_medium, fixed_width_downsampled: $fixed_width_downsampled, downsized: $downsized, fixed_height: $fixed_height, fixed_height_small: $fixed_height_small, fixed_height_still: $fixed_height_still, preview: $preview, downsized_still: $downsized_still, fixed_height_small_still: $fixed_height_small_still, fixed_width: $fixed_width, fixed_width_small_still: $fixed_width_small_still, looping: $looping, original: $original)';
  }
