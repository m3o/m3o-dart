...
class _$_Gif implements _Gif {
  ...
  @override
  String toString() {
    return 'Gif(id: $id, images: $images, rating: $rating, slug: $slug, embed_url: $embed_url, source: $source, title: $title, url: $url, short_url: $short_url)';
  }
...
class _$_ImageFormats implements _ImageFormats {
  ...
  @override
  String toString() {
    return 'ImageFormats(original_still: $original_still, preview: $preview, preview_gif: $preview_gif, downsized_still: $downsized_still, fixed_width_small: $fixed_width_small, fixed_width_small_still: $fixed_width_small_still, fixed_width_downsampled: $fixed_width_downsampled, original: $original, downsized: $downsized, downsized_large: $downsized_large, fixed_height_downsampled: $fixed_height_downsampled, downsized_medium: $downsized_medium, fixed_height: $fixed_height, looping: $looping, fixed_height_still: $fixed_height_still, fixed_width: $fixed_width, fixed_width_still: $fixed_width_still, downsized_small: $downsized_small, fixed_height_small: $fixed_height_small, fixed_height_small_still: $fixed_height_small_still)';
  }
