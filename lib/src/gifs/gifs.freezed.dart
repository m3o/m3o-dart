...
class _$_Gif implements _Gif {
  ...
  @override
  String toString() {
    return 'Gif(source: $source, embed_url: $embed_url, id: $id, rating: $rating, title: $title, url: $url, images: $images, short_url: $short_url, slug: $slug)';
  }
...
class _$_ImageFormats implements _ImageFormats {
  ...
  @override
  String toString() {
    return 'ImageFormats(fixed_width_small: $fixed_width_small, looping: $looping, original: $original, fixed_height: $fixed_height, fixed_width_downsampled: $fixed_width_downsampled, fixed_height_small_still: $fixed_height_small_still, fixed_width: $fixed_width, preview_gif: $preview_gif, downsized_large: $downsized_large, downsized_still: $downsized_still, downsized_small: $downsized_small, fixed_height_downsampled: $fixed_height_downsampled, fixed_height_small: $fixed_height_small, fixed_height_still: $fixed_height_still, fixed_width_small_still: $fixed_width_small_still, downsized: $downsized, downsized_medium: $downsized_medium, preview: $preview, fixed_width_still: $fixed_width_still, original_still: $original_still)';
  }
