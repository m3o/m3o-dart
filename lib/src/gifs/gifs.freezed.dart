...
class _$_Gif implements _Gif {
  ...
  @override
  String toString() {
    return 'Gif(title: $title, images: $images, short_url: $short_url, slug: $slug, source: $source, embed_url: $embed_url, id: $id, rating: $rating, url: $url)';
  }
...
class _$_ImageFormats implements _ImageFormats {
  ...
  @override
  String toString() {
    return 'ImageFormats(fixed_width_downsampled: $fixed_width_downsampled, looping: $looping, preview: $preview, downsized_large: $downsized_large, fixed_height: $fixed_height, fixed_height_small: $fixed_height_small, fixed_height_small_still: $fixed_height_small_still, fixed_height_still: $fixed_height_still, downsized: $downsized, downsized_medium: $downsized_medium, downsized_still: $downsized_still, original: $original, original_still: $original_still, downsized_small: $downsized_small, fixed_height_downsampled: $fixed_height_downsampled, fixed_width_small: $fixed_width_small, preview_gif: $preview_gif, fixed_width: $fixed_width, fixed_width_small_still: $fixed_width_small_still, fixed_width_still: $fixed_width_still)';
  }
