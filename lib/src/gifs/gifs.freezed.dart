...
class _$_Gif implements _Gif {
  ...
  @override
  String toString() {
    return 'Gif(short_url: $short_url, slug: $slug, title: $title, url: $url, rating: $rating, id: $id, images: $images, source: $source, embed_url: $embed_url)';
  }
...
class _$_ImageFormats implements _ImageFormats {
  ...
  @override
  String toString() {
    return 'ImageFormats(downsized_small: $downsized_small, fixed_height_small: $fixed_height_small, fixed_width: $fixed_width, fixed_width_small: $fixed_width_small, original: $original, preview_gif: $preview_gif, downsized_medium: $downsized_medium, fixed_width_downsampled: $fixed_width_downsampled, fixed_width_small_still: $fixed_width_small_still, original_still: $original_still, preview: $preview, fixed_height: $fixed_height, downsized_still: $downsized_still, fixed_height_downsampled: $fixed_height_downsampled, fixed_height_small_still: $fixed_height_small_still, looping: $looping, downsized: $downsized, fixed_height_still: $fixed_height_still, fixed_width_still: $fixed_width_still, downsized_large: $downsized_large)';
  }
