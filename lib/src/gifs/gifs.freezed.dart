...
class _$_Gif implements _Gif {
  ...
  @override
  String toString() {
    return 'Gif(id: $id, short_url: $short_url, source: $source, title: $title, embed_url: $embed_url, rating: $rating, slug: $slug, url: $url, images: $images)';
  }
...
class _$_ImageFormats implements _ImageFormats {
  ...
  @override
  String toString() {
    return 'ImageFormats(preview: $preview, downsized_still: $downsized_still, fixed_height: $fixed_height, fixed_width: $fixed_width, fixed_width_small_still: $fixed_width_small_still, fixed_width_still: $fixed_width_still, downsized_medium: $downsized_medium, fixed_height_still: $fixed_height_still, original_still: $original_still, looping: $looping, downsized: $downsized, downsized_large: $downsized_large, downsized_small: $downsized_small, fixed_height_downsampled: $fixed_height_downsampled, fixed_width_small: $fixed_width_small, fixed_height_small: $fixed_height_small, fixed_height_small_still: $fixed_height_small_still, fixed_width_downsampled: $fixed_width_downsampled, original: $original, preview_gif: $preview_gif)';
  }
