...
class _$_Gif implements _Gif {
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, id, rating, source, url,
      embed_url, images, short_url, slug, title);
...
class _$_ImageFormats implements _ImageFormats {
  ...
  @override
  String toString() {
    return 'ImageFormats(downsized_medium: $downsized_medium, fixed_width: $fixed_width, original_still: $original_still, fixed_height: $fixed_height, fixed_height_small_still: $fixed_height_small_still, fixed_width_small: $fixed_width_small, looping: $looping, preview: $preview, downsized_large: $downsized_large, downsized_still: $downsized_still, fixed_height_still: $fixed_height_still, fixed_width_small_still: $fixed_width_small_still, preview_gif: $preview_gif, original: $original, downsized: $downsized, downsized_small: $downsized_small, fixed_height_downsampled: $fixed_height_downsampled, fixed_height_small: $fixed_height_small, fixed_width_downsampled: $fixed_width_downsampled, fixed_width_still: $fixed_width_still)';
  }
