...
class _$_Gif implements _Gif {
  ...
  @override
  String toString() {
    return 'Gif(short_url: $short_url, source: $source, url: $url, embed_url: $embed_url, images: $images, slug: $slug, title: $title, id: $id, rating: $rating)';
  }
...
class _$_ImageFormats implements _ImageFormats {
  ...
  @override
  String toString() {
    return 'ImageFormats(fixed_height_still: $fixed_height_still, downsized: $downsized, fixed_height: $fixed_height, fixed_height_small: $fixed_height_small, fixed_height_small_still: $fixed_height_small_still, fixed_width_small_still: $fixed_width_small_still, looping: $looping, downsized_medium: $downsized_medium, fixed_width: $fixed_width, fixed_width_small: $fixed_width_small, preview: $preview, preview_gif: $preview_gif, fixed_height_downsampled: $fixed_height_downsampled, downsized_small: $downsized_small, downsized_still: $downsized_still, fixed_width_downsampled: $fixed_width_downsampled, fixed_width_still: $fixed_width_still, original: $original, original_still: $original_still, downsized_large: $downsized_large)';
  }
...
abstract class _ImageFormats implements ImageFormats {
  const factory _ImageFormats(
      ...
      final ImageFormat? original,
      final ImageFormat? original_still,
      final ImageFormat? downsized_large}) = _$_ImageFormats;
