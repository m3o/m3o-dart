...
class _$_Gif implements _Gif {
  ...
  @override
  String toString() {
    return 'Gif(rating: $rating, short_url: $short_url, slug: $slug, embed_url: $embed_url, id: $id, images: $images, source: $source, title: $title, url: $url)';
  }
...
class _$_ImageFormats implements _ImageFormats {
  ...
  @override
  String toString() {
    return 'ImageFormats(fixed_width: $fixed_width, fixed_width_small: $fixed_width_small, preview: $preview, fixed_height_small_still: $fixed_height_small_still, fixed_width_still: $fixed_width_still, original: $original, downsized: $downsized, downsized_large: $downsized_large, downsized_still: $downsized_still, fixed_height_downsampled: $fixed_height_downsampled, fixed_height_small: $fixed_height_small, downsized_medium: $downsized_medium, looping: $looping, original_still: $original_still, preview_gif: $preview_gif, downsized_small: $downsized_small, fixed_height: $fixed_height, fixed_height_still: $fixed_height_still, fixed_width_downsampled: $fixed_width_downsampled, fixed_width_small_still: $fixed_width_small_still)';
  }
