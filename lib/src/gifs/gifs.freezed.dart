...
class _$_Gif implements _Gif {
  ...
  @override
  String toString() {
    return 'Gif(short_url: $short_url, title: $title, url: $url, embed_url: $embed_url, images: $images, rating: $rating, id: $id, slug: $slug, source: $source)';
  }
...
class _$_ImageFormats implements _ImageFormats {
  ...
  @override
  String toString() {
    return 'ImageFormats(downsized_large: $downsized_large, downsized_small: $downsized_small, downsized_still: $downsized_still, fixed_height: $fixed_height, fixed_width: $fixed_width, original: $original, preview_gif: $preview_gif, downsized_medium: $downsized_medium, fixed_height_downsampled: $fixed_height_downsampled, fixed_height_small: $fixed_height_small, fixed_height_small_still: $fixed_height_small_still, fixed_height_still: $fixed_height_still, fixed_width_downsampled: $fixed_width_downsampled, preview: $preview, fixed_width_small: $fixed_width_small, fixed_width_still: $fixed_width_still, looping: $looping, downsized: $downsized, fixed_width_small_still: $fixed_width_small_still, original_still: $original_still)';
  }
