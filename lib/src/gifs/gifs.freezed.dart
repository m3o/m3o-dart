...
class _$_Gif implements _Gif {
  ...
  @override
  String toString() {
    return 'Gif(images: $images, url: $url, title: $title, embed_url: $embed_url, id: $id, rating: $rating, short_url: $short_url, slug: $slug, source: $source)';
  }
...
class _$_ImageFormats implements _ImageFormats {
  ...
  @override
  String toString() {
    return 'ImageFormats(fixed_width: $fixed_width, fixed_width_still: $fixed_width_still, preview: $preview, downsized_medium: $downsized_medium, fixed_height: $fixed_height, fixed_height_small_still: $fixed_height_small_still, fixed_height_still: $fixed_height_still, original_still: $original_still, preview_gif: $preview_gif, downsized_small: $downsized_small, downsized_large: $downsized_large, downsized_still: $downsized_still, fixed_height_downsampled: $fixed_height_downsampled, fixed_height_small: $fixed_height_small, fixed_width_small_still: $fixed_width_small_still, downsized: $downsized, fixed_width_small: $fixed_width_small, looping: $looping, original: $original, fixed_width_downsampled: $fixed_width_downsampled)';
  }
