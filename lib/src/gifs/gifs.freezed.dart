...
class _$_ImageFormats implements _ImageFormats {
  ...
  @override
  String toString() {
    return 'ImageFormats(original_still: $original_still, preview_gif: $preview_gif, downsized_large: $downsized_large, fixed_width_downsampled: $fixed_width_downsampled, fixed_width_still: $fixed_width_still, fixed_width_small: $fixed_width_small, fixed_width_small_still: $fixed_width_small_still, original: $original, downsized: $downsized, fixed_height_small: $fixed_height_small, fixed_width: $fixed_width, downsized_still: $downsized_still, fixed_height: $fixed_height, looping: $looping, fixed_height_small_still: $fixed_height_small_still, fixed_height_still: $fixed_height_still, preview: $preview, downsized_medium: $downsized_medium, downsized_small: $downsized_small, fixed_height_downsampled: $fixed_height_downsampled)';
  }
