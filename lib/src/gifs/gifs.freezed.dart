...
class _$_Gif implements _Gif {
  ...
  @override
  String toString() {
    return 'Gif(embed_url: $embed_url, id: $id, rating: $rating, short_url: $short_url, images: $images, slug: $slug, source: $source, title: $title, url: $url)';
  }
