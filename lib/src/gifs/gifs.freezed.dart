...
class _$_Gif implements _Gif {
  ...
  @override
  String toString() {
    return 'Gif(short_url: $short_url, source: $source, embed_url: $embed_url, id: $id, images: $images, url: $url, rating: $rating, slug: $slug, title: $title)';
  }
...
class _$_ImageFormats implements _ImageFormats {
  ...
  @override
  String toString() {
    return 'ImageFormats(fixed_height: $fixed_height, fixed_height_downsampled: $fixed_height_downsampled, fixed_height_small: $fixed_height_small, fixed_height_small_still: $fixed_height_small_still, fixed_height_still: $fixed_height_still, downsized: $downsized, original: $original, fixed_width_downsampled: $fixed_width_downsampled, fixed_width_still: $fixed_width_still, looping: $looping, preview_gif: $preview_gif, fixed_width_small_still: $fixed_width_small_still, downsized_medium: $downsized_medium, downsized_small: $downsized_small, downsized_still: $downsized_still, fixed_width: $fixed_width, fixed_width_small: $fixed_width_small, original_still: $original_still, preview: $preview, downsized_large: $downsized_large)';
  }
