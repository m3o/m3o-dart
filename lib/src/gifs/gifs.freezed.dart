...
class _$_Gif implements _Gif {
  ...
  @override
  String toString() {
    return 'Gif(images: $images, short_url: $short_url, title: $title, url: $url, embed_url: $embed_url, id: $id, rating: $rating, slug: $slug, source: $source)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, images, short_url, title, url,
      embed_url, id, rating, slug, source);
...
class _$_ImageFormat implements _ImageFormat {
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, mp4_url, size, url, webp_size,
      webp_url, width, height, mp4_size);
...
class _$_ImageFormats implements _ImageFormats {
  ...
  @override
  String toString() {
    return 'ImageFormats(downsized: $downsized, downsized_large: $downsized_large, downsized_medium: $downsized_medium, downsized_small: $downsized_small, original_still: $original_still, preview: $preview, downsized_still: $downsized_still, fixed_height_small_still: $fixed_height_small_still, fixed_width_small_still: $fixed_width_small_still, preview_gif: $preview_gif, fixed_height: $fixed_height, fixed_height_downsampled: $fixed_height_downsampled, fixed_height_still: $fixed_height_still, fixed_width_downsampled: $fixed_width_downsampled, fixed_width_still: $fixed_width_still, original: $original, fixed_height_small: $fixed_height_small, fixed_width: $fixed_width, fixed_width_small: $fixed_width_small, looping: $looping)';
  }
