...
class _$_Gif implements _Gif {
  ...
  @override
  String toString() {
    return 'Gif(short_url: $short_url, title: $title, url: $url, id: $id, images: $images, rating: $rating, slug: $slug, source: $source, embed_url: $embed_url)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, short_url, title, url, id,
      images, rating, slug, source, embed_url);
...
class _$_ImageFormat implements _ImageFormat {
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, height, mp4_size, mp4_url, size,
      url, webp_size, webp_url, width);
...
abstract class _ImageFormat implements ImageFormat {
  const factory _ImageFormat(
      ...
      final int? webp_size,
      final String? webp_url,
      final int? width}) = _$_ImageFormat;
...
class _$_ImageFormats implements _ImageFormats {
  ...
  @override
  String toString() {
    return 'ImageFormats(downsized_medium: $downsized_medium, fixed_width_small: $fixed_width_small, fixed_width_still: $fixed_width_still, original: $original, downsized_large: $downsized_large, fixed_height: $fixed_height, fixed_height_small: $fixed_height_small, fixed_height_small_still: $fixed_height_small_still, fixed_width_small_still: $fixed_width_small_still, downsized: $downsized, fixed_width: $fixed_width, fixed_width_downsampled: $fixed_width_downsampled, preview: $preview, preview_gif: $preview_gif, fixed_height_still: $fixed_height_still, downsized_still: $downsized_still, fixed_height_downsampled: $fixed_height_downsampled, looping: $looping, original_still: $original_still, downsized_small: $downsized_small)';
  }
