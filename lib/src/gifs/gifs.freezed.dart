...
class _$_Gif implements _Gif {
  ...
  @override
  String toString() {
    return 'Gif(url: $url, images: $images, short_url: $short_url, rating: $rating, slug: $slug, source: $source, title: $title, embed_url: $embed_url, id: $id)';
  }
...
class _$_ImageFormats implements _ImageFormats {
  ...
  @override
  String toString() {
    return 'ImageFormats(downsized_small: $downsized_small, looping: $looping, fixed_width_small: $fixed_width_small, fixed_height: $fixed_height, fixed_width: $fixed_width, fixed_width_downsampled: $fixed_width_downsampled, fixed_height_small: $fixed_height_small, fixed_height_still: $fixed_height_still, original: $original, original_still: $original_still, preview_gif: $preview_gif, downsized: $downsized, downsized_large: $downsized_large, downsized_still: $downsized_still, fixed_width_small_still: $fixed_width_small_still, fixed_width_still: $fixed_width_still, preview: $preview, downsized_medium: $downsized_medium, fixed_height_downsampled: $fixed_height_downsampled, fixed_height_small_still: $fixed_height_small_still)';
  }
