...
class _$_Gif implements _Gif {
  ...
  @override
  String toString() {
    return 'Gif(id: $id, rating: $rating, source: $source, embed_url: $embed_url, images: $images, short_url: $short_url, slug: $slug, title: $title, url: $url)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, id, rating, source, embed_url,
      images, short_url, slug, title, url);
...
class _$_ImageFormats implements _ImageFormats {
  ...
  @override
  String toString() {
    return 'ImageFormats(fixed_width_small: $fixed_width_small, fixed_width_small_still: $fixed_width_small_still, preview: $preview, preview_gif: $preview_gif, downsized_large: $downsized_large, downsized_medium: $downsized_medium, fixed_height_downsampled: $fixed_height_downsampled, fixed_height_small: $fixed_height_small, fixed_width_downsampled: $fixed_width_downsampled, fixed_width_still: $fixed_width_still, looping: $looping, downsized: $downsized, fixed_width: $fixed_width, original: $original, original_still: $original_still, fixed_height_small_still: $fixed_height_small_still, downsized_still: $downsized_still, fixed_height: $fixed_height, fixed_height_still: $fixed_height_still, downsized_small: $downsized_small)';
  }
