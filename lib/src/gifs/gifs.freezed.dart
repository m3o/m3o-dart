...
class _$_Gif implements _Gif {
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, id, images, rating, short_url,
      slug, source, embed_url, title, url);
...
class _$_ImageFormats implements _ImageFormats {
  ...
  @override
  String toString() {
    return 'ImageFormats(original_still: $original_still, downsized: $downsized, fixed_width_small_still: $fixed_width_small_still, fixed_width_still: $fixed_width_still, looping: $looping, preview: $preview, fixed_height_small: $fixed_height_small, fixed_height_small_still: $fixed_height_small_still, fixed_width: $fixed_width, original: $original, fixed_width_downsampled: $fixed_width_downsampled, downsized_large: $downsized_large, downsized_medium: $downsized_medium, downsized_small: $downsized_small, fixed_height_downsampled: $fixed_height_downsampled, preview_gif: $preview_gif, downsized_still: $downsized_still, fixed_height: $fixed_height, fixed_height_still: $fixed_height_still, fixed_width_small: $fixed_width_small)';
  }
...
abstract class _ImageFormats implements ImageFormats {
  const factory _ImageFormats(
      ...
      final ImageFormat? fixed_height,
      final ImageFormat? fixed_height_still,
      final ImageFormat? fixed_width_small}) = _$_ImageFormats;
