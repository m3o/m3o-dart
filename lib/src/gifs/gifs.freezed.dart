...
class _$_Gif implements _Gif {
  ...
  @override
  String toString() {
    return 'Gif(embed_url: $embed_url, images: $images, slug: $slug, title: $title, url: $url, id: $id, rating: $rating, short_url: $short_url, source: $source)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, embed_url, images, slug, title,
      url, id, rating, short_url, source);
...
class _$_ImageFormats implements _ImageFormats {
  ...
  @override
  String toString() {
    return 'ImageFormats(fixed_width_downsampled: $fixed_width_downsampled, original: $original, preview: $preview, fixed_height_small_still: $fixed_height_small_still, fixed_width: $fixed_width, fixed_height_downsampled: $fixed_height_downsampled, preview_gif: $preview_gif, downsized_large: $downsized_large, fixed_height: $fixed_height, downsized_small: $downsized_small, fixed_width_small: $fixed_width_small, fixed_width_small_still: $fixed_width_small_still, fixed_width_still: $fixed_width_still, downsized: $downsized, downsized_medium: $downsized_medium, fixed_height_still: $fixed_height_still, looping: $looping, original_still: $original_still, downsized_still: $downsized_still, fixed_height_small: $fixed_height_small)';
  }
