...
class _$_Gif implements _Gif {
  ...
  @override
  String toString() {
    return 'Gif(embed_url: $embed_url, short_url: $short_url, source: $source, id: $id, images: $images, rating: $rating, slug: $slug, title: $title, url: $url)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, embed_url, short_url, source, id,
      images, rating, slug, title, url);
...
class _$_ImageFormats implements _ImageFormats {
  ...
  @override
  String toString() {
    return 'ImageFormats(downsized_medium: $downsized_medium, fixed_height_small: $fixed_height_small, fixed_width: $fixed_width, fixed_width_still: $fixed_width_still, preview_gif: $preview_gif, original_still: $original_still, downsized: $downsized, downsized_large: $downsized_large, fixed_height_downsampled: $fixed_height_downsampled, fixed_height_small_still: $fixed_height_small_still, fixed_height_still: $fixed_height_still, original: $original, fixed_height: $fixed_height, fixed_width_small: $fixed_width_small, looping: $looping, downsized_small: $downsized_small, downsized_still: $downsized_still, fixed_width_downsampled: $fixed_width_downsampled, fixed_width_small_still: $fixed_width_small_still, preview: $preview)';
  }
...
abstract class _ImageFormats implements ImageFormats {
  const factory _ImageFormats(
      ...
      final ImageFormat? fixed_width_downsampled,
      final ImageFormat? fixed_width_small_still,
      final ImageFormat? preview}) = _$_ImageFormats;
