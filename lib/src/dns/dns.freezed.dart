...
class _$QueryResponseData implements QueryResponseData {
  ...
  @override
  String toString() {
    return 'QueryResponse(TC: $TC, provider: $provider, question: $question, status: $status, RA: $RA, CD: $CD, RD: $RD, answer: $answer, AD: $AD)';
  }
  ...
  TResult when<TResult extends Object?>(
    ...
    return $default(TC, provider, question, status, RA, CD, RD, answer, AD);
  }
  ...
  TResult? whenOrNull<TResult extends Object?>(
    ...
    return $default?.call(
        TC, provider, question, status, RA, CD, RD, answer, AD);
  }
