...
class _$QueryResponseData implements QueryResponseData {
  ...
  @override
  String toString() {
    return 'QueryResponse(AD: $AD, CD: $CD, RD: $RD, TC: $TC, provider: $provider, question: $question, RA: $RA, answer: $answer, status: $status)';
  }
  ...
  TResult when<TResult extends Object?>(
    ...
    return $default(AD, CD, RD, TC, provider, question, RA, answer, status);
  }
  ...
  TResult? whenOrNull<TResult extends Object?>(
    ...
    return $default?.call(
        AD, CD, RD, TC, provider, question, RA, answer, status);
  }
