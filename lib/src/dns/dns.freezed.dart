...
class _$QueryResponseData implements QueryResponseData {
  ...
  @override
  String toString() {
    return 'QueryResponse(provider: $provider, question: $question, AD: $AD, RA: $RA, RD: $RD, answer: $answer, CD: $CD, TC: $TC, status: $status)';
  }
  ...
  TResult when<TResult extends Object?>(
    ...
    return $default(provider, question, AD, RA, RD, answer, CD, TC, status);
  }
  ...
  TResult? whenOrNull<TResult extends Object?>(
    ...
    return $default?.call(
        provider, question, AD, RA, RD, answer, CD, TC, status);
  }
