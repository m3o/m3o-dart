...
class _$QueryResponseData implements QueryResponseData {
  ...
  @override
  String toString() {
    return 'QueryResponse(AD: $AD, TC: $TC, provider: $provider, question: $question, status: $status, CD: $CD, RA: $RA, RD: $RD, answer: $answer)';
  }
  ...
  TResult when<TResult extends Object?>(
    ...
    return $default(AD, TC, provider, question, status, CD, RA, RD, answer);
  }
  ...
  TResult? whenOrNull<TResult extends Object?>(
    ...
    return $default?.call(
        AD, TC, provider, question, status, CD, RA, RD, answer);
  }
