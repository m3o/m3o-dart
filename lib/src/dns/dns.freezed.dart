...
class _$QueryResponseData implements QueryResponseData {
  ...
  @override
  String toString() {
    return 'QueryResponse(AD: $AD, RA: $RA, RD: $RD, answer: $answer, status: $status, CD: $CD, TC: $TC, provider: $provider, question: $question)';
  }
  ...
  TResult when<TResult extends Object?>(
    ...
    return $default(AD, RA, RD, answer, status, CD, TC, provider, question);
  }
  ...
  TResult? whenOrNull<TResult extends Object?>(
    ...
    return $default?.call(
        AD, RA, RD, answer, status, CD, TC, provider, question);
  }
