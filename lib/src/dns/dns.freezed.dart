...
class _$QueryResponseData implements QueryResponseData {
  ...
  @override
  String toString() {
    return 'QueryResponse(RD: $RD, answer: $answer, status: $status, AD: $AD, CD: $CD, RA: $RA, TC: $TC, provider: $provider, question: $question)';
  }
  ...
  TResult when<TResult extends Object?>(
    ...
    return $default(RD, answer, status, AD, CD, RA, TC, provider, question);
  }
  ...
  TResult? whenOrNull<TResult extends Object?>(
    ...
    return $default?.call(
        RD, answer, status, AD, CD, RA, TC, provider, question);
  }
