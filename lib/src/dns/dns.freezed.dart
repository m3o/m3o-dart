...
class _$QueryResponseData implements QueryResponseData {
  ...
  @override
  String toString() {
    return 'QueryResponse(answer: $answer, question: $question, CD: $CD, TC: $TC, RD: $RD, provider: $provider, status: $status, AD: $AD, RA: $RA)';
  }
  ...
  TResult when<TResult extends Object?>(
    ...
    return $default(answer, question, CD, TC, RD, provider, status, AD, RA);
  }
  ...
  TResult? whenOrNull<TResult extends Object?>(
    ...
    return $default?.call(
        answer, question, CD, TC, RD, provider, status, AD, RA);
  }
