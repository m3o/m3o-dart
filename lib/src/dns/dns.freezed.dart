...
class _$QueryResponseData implements QueryResponseData {
  ...
  @override
  String toString() {
    return 'QueryResponse(answer: $answer, status: $status, RA: $RA, RD: $RD, TC: $TC, provider: $provider, question: $question, AD: $AD, CD: $CD)';
  }
  ...
  TResult when<TResult extends Object?>(
    ...
    return $default(answer, status, RA, RD, TC, provider, question, AD, CD);
  }
  ...
  TResult? whenOrNull<TResult extends Object?>(
    ...
    return $default?.call(
        answer, status, RA, RD, TC, provider, question, AD, CD);
  }
