...
class _$QueryResponseData implements QueryResponseData {
  ...
  @override
  String toString() {
    return 'QueryResponse(question: $question, RA: $RA, RD: $RD, TC: $TC, answer: $answer, provider: $provider, AD: $AD, CD: $CD, status: $status)';
  }
  ...
  TResult when<TResult extends Object?>(
    ...
    return $default(question, RA, RD, TC, answer, provider, AD, CD, status);
  }
  ...
  TResult? whenOrNull<TResult extends Object?>(
    ...
    return $default?.call(
        question, RA, RD, TC, answer, provider, AD, CD, status);
  }
