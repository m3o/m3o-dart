...
class _$QueryResponseData implements QueryResponseData {
  ...
  @override
  String toString() {
    return 'QueryResponse(CD: $CD, RD: $RD, AD: $AD, RA: $RA, TC: $TC, answer: $answer, provider: $provider, question: $question, status: $status)';
  }
  ...
  TResult when<TResult extends Object?>(
    ...
    return $default(CD, RD, AD, RA, TC, answer, provider, question, status);
  }
  ...
  TResult? whenOrNull<TResult extends Object?>(
    ...
    return $default?.call(
        CD, RD, AD, RA, TC, answer, provider, question, status);
  }
