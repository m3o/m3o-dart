...
class _$QueryResponseData implements QueryResponseData {
  ...
  @override
  String toString() {
    return 'QueryResponse(question: $question, AD: $AD, CD: $CD, RA: $RA, RD: $RD, TC: $TC, answer: $answer, provider: $provider, status: $status)';
  }
  ...
  TResult when<TResult extends Object?>(
    ...
    return $default(question, AD, CD, RA, RD, TC, answer, provider, status);
  }
  ...
  TResult? whenOrNull<TResult extends Object?>(
    ...
    return $default?.call(
        question, AD, CD, RA, RD, TC, answer, provider, status);
  }
