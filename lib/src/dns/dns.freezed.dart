...
class _$QueryResponseData implements QueryResponseData {
  ...
  @override
  String toString() {
    return 'QueryResponse(RD: $RD, answer: $answer, provider: $provider, question: $question, AD: $AD, CD: $CD, RA: $RA, TC: $TC, status: $status)';
  }
  ...
  TResult when<TResult extends Object?>(
    ...
    return $default(RD, answer, provider, question, AD, CD, RA, TC, status);
  }
  ...
  TResult? whenOrNull<TResult extends Object?>(
    ...
    return $default?.call(
        RD, answer, provider, question, AD, CD, RA, TC, status);
  }
