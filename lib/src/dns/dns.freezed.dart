...
class _$QueryResponseData implements QueryResponseData {
  ...
  @override
  String toString() {
    return 'QueryResponse(question: $question, AD: $AD, CD: $CD, TC: $TC, provider: $provider, RA: $RA, RD: $RD, answer: $answer, status: $status)';
  }
  ...
  TResult when<TResult extends Object?>(
    ...
    return $default(question, AD, CD, TC, provider, RA, RD, answer, status);
  }
  ...
  TResult? whenOrNull<TResult extends Object?>(
    ...
    return $default?.call(
        question, AD, CD, TC, provider, RA, RD, answer, status);
  }
