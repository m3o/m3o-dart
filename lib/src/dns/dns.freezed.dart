...
class _$QueryResponseData implements QueryResponseData {
  ...
  @override
  String toString() {
    return 'QueryResponse(answer: $answer, provider: $provider, question: $question, AD: $AD, RA: $RA, TC: $TC, CD: $CD, RD: $RD, status: $status)';
  }
  ...
  TResult when<TResult extends Object?>(
    ...
    return $default(answer, provider, question, AD, RA, TC, CD, RD, status);
  }
  ...
  TResult? whenOrNull<TResult extends Object?>(
    ...
    return $default?.call(
        answer, provider, question, AD, RA, TC, CD, RD, status);
  }
