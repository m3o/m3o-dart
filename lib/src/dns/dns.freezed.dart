...
class _$QueryResponseData implements QueryResponseData {
  ...
  @override
  String toString() {
    return 'QueryResponse(answer: $answer, status: $status, AD: $AD, CD: $CD, RA: $RA, RD: $RD, TC: $TC, provider: $provider, question: $question)';
  }
  ...
  TResult when<TResult extends Object?>(
    ...
    return $default(answer, status, AD, CD, RA, RD, TC, provider, question);
  }
  ...
  TResult? whenOrNull<TResult extends Object?>(
    ...
    return $default?.call(
        answer, status, AD, CD, RA, RD, TC, provider, question);
  }
