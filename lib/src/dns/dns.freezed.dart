...
class _$QueryResponseData implements QueryResponseData {
  ...
  @override
  String toString() {
    return 'QueryResponse(question: $question, status: $status, AD: $AD, CD: $CD, RA: $RA, TC: $TC, provider: $provider, RD: $RD, answer: $answer)';
  }
  ...
  TResult when<TResult extends Object?>(
    ...
    return $default(question, status, AD, CD, RA, TC, provider, RD, answer);
  }
  ...
  TResult? whenOrNull<TResult extends Object?>(
    ...
    return $default?.call(
        question, status, AD, CD, RA, TC, provider, RD, answer);
  }
