...
class _$QueryResponseData implements QueryResponseData {
  ...
  @override
  String toString() {
    return 'QueryResponse(status: $status, AD: $AD, RD: $RD, TC: $TC, provider: $provider, question: $question, CD: $CD, RA: $RA, answer: $answer)';
  }
  ...
  TResult when<TResult extends Object?>(
    ...
    return $default(status, AD, RD, TC, provider, question, CD, RA, answer);
  }
  ...
  TResult? whenOrNull<TResult extends Object?>(
    ...
    return $default?.call(
        status, AD, RD, TC, provider, question, CD, RA, answer);
  }
