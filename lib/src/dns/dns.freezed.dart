...
class _$QueryResponseData implements QueryResponseData {
  ...
  @override
  String toString() {
    return 'QueryResponse(answer: $answer, provider: $provider, question: $question, CD: $CD, RA: $RA, RD: $RD, TC: $TC, status: $status, AD: $AD)';
  }
  ...
  TResult when<TResult extends Object?>(
    ...
    return $default(answer, provider, question, CD, RA, RD, TC, status, AD);
  }
  ...
  TResult? whenOrNull<TResult extends Object?>(
    ...
    return $default?.call(
        answer, provider, question, CD, RA, RD, TC, status, AD);
  }
