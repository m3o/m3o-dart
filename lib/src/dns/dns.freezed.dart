...
class _$QueryResponseData implements QueryResponseData {
  ...
  @override
  String toString() {
    return 'QueryResponse(AD: $AD, RA: $RA, RD: $RD, answer: $answer, question: $question, CD: $CD, TC: $TC, provider: $provider, status: $status)';
  }
  ...
  TResult when<TResult extends Object?>(
    ...
    return $default(AD, RA, RD, answer, question, CD, TC, provider, status);
  }
  ...
  TResult? whenOrNull<TResult extends Object?>(
    ...
    return $default?.call(
        AD, RA, RD, answer, question, CD, TC, provider, status);
  }
