...
class _$QueryResponseData implements QueryResponseData {
  ...
  @override
  String toString() {
    return 'QueryResponse(provider: $provider, status: $status, RD: $RD, TC: $TC, answer: $answer, question: $question, AD: $AD, CD: $CD, RA: $RA)';
  }
  ...
  TResult when<TResult extends Object?>(
    ...
    return $default(provider, status, RD, TC, answer, question, AD, CD, RA);
  }
  ...
  TResult? whenOrNull<TResult extends Object?>(
    ...
    return $default?.call(
        provider, status, RD, TC, answer, question, AD, CD, RA);
  }
