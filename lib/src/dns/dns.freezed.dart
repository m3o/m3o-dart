...
class _$QueryResponseData implements QueryResponseData {
  ...
  @override
  String toString() {
    return 'QueryResponse(provider: $provider, question: $question, status: $status, AD: $AD, CD: $CD, RA: $RA, TC: $TC, RD: $RD, answer: $answer)';
  }
  ...
  TResult when<TResult extends Object?>(
    ...
    return $default(provider, question, status, AD, CD, RA, TC, RD, answer);
  }
  ...
  TResult? whenOrNull<TResult extends Object?>(
    ...
    return $default?.call(
        provider, question, status, AD, CD, RA, TC, RD, answer);
  }
