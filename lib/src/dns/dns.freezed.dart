...
class _$QueryResponseData implements QueryResponseData {
  ...
  @override
  String toString() {
    return 'QueryResponse(CD: $CD, answer: $answer, provider: $provider, question: $question, status: $status, AD: $AD, RA: $RA, RD: $RD, TC: $TC)';
  }
  ...
  TResult when<TResult extends Object?>(
    ...
    return $default(CD, answer, provider, question, status, AD, RA, RD, TC);
  }
  ...
  TResult? whenOrNull<TResult extends Object?>(
    ...
    return $default?.call(
        CD, answer, provider, question, status, AD, RA, RD, TC);
  }
