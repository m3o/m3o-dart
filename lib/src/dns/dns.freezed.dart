...
class _$QueryResponseData implements QueryResponseData {
  ...
  @override
  String toString() {
    return 'QueryResponse(provider: $provider, CD: $CD, TC: $TC, RD: $RD, answer: $answer, question: $question, status: $status, AD: $AD, RA: $RA)';
  }
  ...
  TResult when<TResult extends Object?>(
    ...
    return $default(provider, CD, TC, RD, answer, question, status, AD, RA);
  }
  ...
  TResult? whenOrNull<TResult extends Object?>(
    ...
    return $default?.call(
        provider, CD, TC, RD, answer, question, status, AD, RA);
  }
