...
class _$_Output implements _Output {
  ...
  @override
  String toString() {
    return 'Output(spent: $spent, tx_index: $tx_index, value: $value, address: $address, hash: $hash, script: $script)';
  }
...
class _$_Transaction implements _Transaction {
  ...
  @override
  String toString() {
    return 'Transaction(block_index: $block_index, double_spend: $double_spend, hash: $hash, lock_time: $lock_time, fee: $fee, inputs: $inputs, relay: $relay, result: $result, vin_sz: $vin_sz, weight: $weight, size: $size, vout_sz: $vout_sz, balance: $balance, block_height: $block_height, outputs: $outputs, tx_index: $tx_index, version: $version)';
  }
...
class _$TransactionResponseData implements TransactionResponseData {
  ...
  @override
  String toString() {
    return 'TransactionResponse(block_index: $block_index, relay: $relay, double_spend: $double_spend, fee: $fee, inputs: $inputs, vin_sz: $vin_sz, vout_sz: $vout_sz, weight: $weight, block_height: $block_height, lock_time: $lock_time, outputs: $outputs, size: $size, tx_index: $tx_index, hash: $hash, version: $version)';
  }
...
abstract class TransactionResponseData implements TransactionResponse {
  const factory TransactionResponseData(
      ...
      final String? hash,
      @JsonKey(fromJson: int64FromString, toJson: int64ToString)
          final int? version}) = _$TransactionResponseData;
