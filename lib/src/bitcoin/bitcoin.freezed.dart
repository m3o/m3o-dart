...
class _$_Prev implements _Prev {
  ...
  @override
  String toString() {
    return 'Prev(tx_index: $tx_index, value: $value, address: $address, n: $n, script: $script, spent: $spent)';
  }
...
class _$_Transaction implements _Transaction {
  ...
  @override
  String toString() {
    return 'Transaction(balance: $balance, vin_sz: $vin_sz, inputs: $inputs, size: $size, weight: $weight, block_height: $block_height, block_index: $block_index, hash: $hash, result: $result, vout_sz: $vout_sz, double_spend: $double_spend, fee: $fee, relay: $relay, version: $version, lock_time: $lock_time, outputs: $outputs, tx_index: $tx_index)';
  }
...
abstract class _Transaction implements Transaction {
  const factory _Transaction(
      ...
      final List<Output>? outputs,
      @JsonKey(fromJson: int64FromString, toJson: int64ToString)
          final int? tx_index}) = _$_Transaction;
...
class _$TransactionResponseData implements TransactionResponseData {
  ...
  @override
  String toString() {
    return 'TransactionResponse(vin_sz: $vin_sz, fee: $fee, inputs: $inputs, lock_time: $lock_time, size: $size, block_height: $block_height, relay: $relay, tx_index: $tx_index, weight: $weight, vout_sz: $vout_sz, block_index: $block_index, double_spend: $double_spend, hash: $hash, outputs: $outputs, version: $version)';
  }
