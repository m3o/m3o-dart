...
class _$_Transaction implements _Transaction {
  ...
  @override
  String toString() {
    return 'Transaction(lock_time: $lock_time, result: $result, weight: $weight, block_height: $block_height, block_index: $block_index, hash: $hash, inputs: $inputs, fee: $fee, relay: $relay, size: $size, version: $version, vout_sz: $vout_sz, vin_sz: $vin_sz, balance: $balance, double_spend: $double_spend, outputs: $outputs, tx_index: $tx_index)';
  }
...
class _$TransactionResponseData implements TransactionResponseData {
  ...
  @override
  String toString() {
    return 'TransactionResponse(vout_sz: $vout_sz, weight: $weight, block_height: $block_height, outputs: $outputs, tx_index: $tx_index, double_spend: $double_spend, hash: $hash, inputs: $inputs, lock_time: $lock_time, relay: $relay, version: $version, block_index: $block_index, fee: $fee, size: $size, vin_sz: $vin_sz)';
  }
