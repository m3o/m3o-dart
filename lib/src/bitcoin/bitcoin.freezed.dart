...
class _$_Transaction implements _Transaction {
  ...
  @override
  String toString() {
    return 'Transaction(block_height: $block_height, hash: $hash, lock_time: $lock_time, size: $size, fee: $fee, relay: $relay, tx_index: $tx_index, vout_sz: $vout_sz, weight: $weight, balance: $balance, inputs: $inputs, outputs: $outputs, result: $result, version: $version, block_index: $block_index, double_spend: $double_spend, vin_sz: $vin_sz)';
  }
...
class _$TransactionResponseData implements TransactionResponseData {
  ...
  @override
  String toString() {
    return 'TransactionResponse(block_index: $block_index, double_spend: $double_spend, hash: $hash, relay: $relay, fee: $fee, vout_sz: $vout_sz, weight: $weight, block_height: $block_height, lock_time: $lock_time, tx_index: $tx_index, vin_sz: $vin_sz, inputs: $inputs, outputs: $outputs, size: $size, version: $version)';
  }
