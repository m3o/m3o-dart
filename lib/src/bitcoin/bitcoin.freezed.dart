...
class _$TransactionResponseData implements TransactionResponseData {
  ...
  @override
  String toString() {
    return 'TransactionResponse(fee: $fee, hash: $hash, vout_sz: $vout_sz, weight: $weight, block_index: $block_index, inputs: $inputs, outputs: $outputs, version: $version, vin_sz: $vin_sz, double_spend: $double_spend, lock_time: $lock_time, relay: $relay, tx_index: $tx_index, block_height: $block_height, size: $size)';
  }
