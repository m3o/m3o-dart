...
class _$_Transaction implements _Transaction {
  ...
  @override
  String toString() {
    return 'Transaction(inputs: $inputs, tx_index: $tx_index, vin_sz: $vin_sz, weight: $weight, balance: $balance, block_height: $block_height, fee: $fee, result: $result, double_spend: $double_spend, lock_time: $lock_time, outputs: $outputs, relay: $relay, size: $size, version: $version, block_index: $block_index, hash: $hash, vout_sz: $vout_sz)';
  }
...
class _$TransactionResponseData implements TransactionResponseData {
  ...
  @override
  String toString() {
    return 'TransactionResponse(hash: $hash, inputs: $inputs, tx_index: $tx_index, fee: $fee, block_index: $block_index, double_spend: $double_spend, relay: $relay, size: $size, block_height: $block_height, version: $version, outputs: $outputs, vin_sz: $vin_sz, vout_sz: $vout_sz, weight: $weight, lock_time: $lock_time)';
  }
