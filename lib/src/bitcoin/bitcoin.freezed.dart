...
class _$_Transaction implements _Transaction {
  ...
  @override
  String toString() {
    return 'Transaction(double_spend: $double_spend, fee: $fee, inputs: $inputs, relay: $relay, lock_time: $lock_time, tx_index: $tx_index, version: $version, block_index: $block_index, hash: $hash, result: $result, size: $size, vout_sz: $vout_sz, balance: $balance, block_height: $block_height, outputs: $outputs, vin_sz: $vin_sz, weight: $weight)';
  }
...
class _$TransactionResponseData implements TransactionResponseData {
  ...
  @override
  String toString() {
    return 'TransactionResponse(block_index: $block_index, fee: $fee, inputs: $inputs, version: $version, hash: $hash, size: $size, tx_index: $tx_index, vout_sz: $vout_sz, block_height: $block_height, double_spend: $double_spend, lock_time: $lock_time, weight: $weight, outputs: $outputs, relay: $relay, vin_sz: $vin_sz)';
  }
