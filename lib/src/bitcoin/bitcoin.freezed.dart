...
class _$TransactionResponseData implements TransactionResponseData {
  ...
  @override
  String toString() {
    return 'TransactionResponse(fee: $fee, lock_time: $lock_time, version: $version, vin_sz: $vin_sz, weight: $weight, block_height: $block_height, block_index: $block_index, hash: $hash, relay: $relay, inputs: $inputs, double_spend: $double_spend, outputs: $outputs, size: $size, tx_index: $tx_index, vout_sz: $vout_sz)';
  }
