...
class _$_Chapter implements _Chapter {
  ...
  @override
  String toString() {
    return 'Chapter(arabic_name: $arabic_name, complex_name: $complex_name, pages: $pages, revelation_order: $revelation_order, revelation_place: $revelation_place, id: $id, name: $name, prefix_bismillah: $prefix_bismillah, translated_name: $translated_name, verses: $verses)';
  }
...
class _$_Verse implements _Verse {
  ...
  @override
  String toString() {
    return 'Verse(words: $words, id: $id, key: $key, number: $number, text: $text, translations: $translations, interpretations: $interpretations, page: $page, translated_text: $translated_text, transliteration: $transliteration)';
  }
...
class _$_Word implements _Word {
  ...
  @override
  String toString() {
    return 'Word(code: $code, id: $id, line: $line, page: $page, text: $text, translation: $translation, char_type: $char_type, position: $position, transliteration: $transliteration)';
  }
