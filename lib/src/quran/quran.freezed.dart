...
class _$_Chapter implements _Chapter {
  ...
  @override
  String toString() {
    return 'Chapter(arabic_name: $arabic_name, name: $name, prefix_bismillah: $prefix_bismillah, revelation_place: $revelation_place, complex_name: $complex_name, id: $id, pages: $pages, revelation_order: $revelation_order, translated_name: $translated_name, verses: $verses)';
  }
...
class _$_Verse implements _Verse {
  ...
  @override
  String toString() {
    return 'Verse(id: $id, interpretations: $interpretations, key: $key, number: $number, page: $page, translations: $translations, words: $words, text: $text, translated_text: $translated_text, transliteration: $transliteration)';
  }
...
class _$_Word implements _Word {
  ...
  @override
  String toString() {
    return 'Word(id: $id, line: $line, page: $page, text: $text, char_type: $char_type, code: $code, position: $position, translation: $translation, transliteration: $transliteration)';
  }
