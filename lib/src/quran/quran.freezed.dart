...
class _$_Chapter implements _Chapter {
  ...
  @override
  String toString() {
    return 'Chapter(arabic_name: $arabic_name, name: $name, pages: $pages, revelation_order: $revelation_order, verses: $verses, complex_name: $complex_name, id: $id, prefix_bismillah: $prefix_bismillah, revelation_place: $revelation_place, translated_name: $translated_name)';
  }
...
class _$_Verse implements _Verse {
  ...
  @override
  String toString() {
    return 'Verse(words: $words, id: $id, interpretations: $interpretations, key: $key, translated_text: $translated_text, translations: $translations, number: $number, page: $page, text: $text, transliteration: $transliteration)';
  }
...
class _$_Word implements _Word {
  ...
  @override
  String toString() {
    return 'Word(position: $position, text: $text, translation: $translation, char_type: $char_type, id: $id, page: $page, code: $code, line: $line, transliteration: $transliteration)';
  }
