...
class _$_Chapter implements _Chapter {
  ...
  @override
  String toString() {
    return 'Chapter(id: $id, name: $name, pages: $pages, revelation_place: $revelation_place, verses: $verses, complex_name: $complex_name, prefix_bismillah: $prefix_bismillah, revelation_order: $revelation_order, translated_name: $translated_name, arabic_name: $arabic_name)';
  }
...
class _$_Verse implements _Verse {
  ...
  @override
  String toString() {
    return 'Verse(id: $id, key: $key, text: $text, translated_text: $translated_text, translations: $translations, interpretations: $interpretations, number: $number, page: $page, transliteration: $transliteration, words: $words)';
  }
...
class _$_Word implements _Word {
  ...
  @override
  String toString() {
    return 'Word(char_type: $char_type, id: $id, page: $page, translation: $translation, transliteration: $transliteration, code: $code, line: $line, position: $position, text: $text)';
  }
