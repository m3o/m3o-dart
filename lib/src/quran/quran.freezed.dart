...
class _$_Chapter implements _Chapter {
  ...
  @override
  String toString() {
    return 'Chapter(translated_name: $translated_name, verses: $verses, arabic_name: $arabic_name, complex_name: $complex_name, revelation_order: $revelation_order, prefix_bismillah: $prefix_bismillah, revelation_place: $revelation_place, id: $id, name: $name, pages: $pages)';
  }
...
class _$_Verse implements _Verse {
  ...
  @override
  String toString() {
    return 'Verse(translated_text: $translated_text, id: $id, number: $number, page: $page, text: $text, words: $words, interpretations: $interpretations, key: $key, translations: $translations, transliteration: $transliteration)';
  }
...
class _$_Word implements _Word {
  ...
  @override
  String toString() {
    return 'Word(code: $code, text: $text, translation: $translation, char_type: $char_type, line: $line, page: $page, position: $position, transliteration: $transliteration, id: $id)';
  }
