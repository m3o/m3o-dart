...
class _$_Chapter implements _Chapter {
  ...
  @override
  String toString() {
    return 'Chapter(name: $name, pages: $pages, revelation_order: $revelation_order, verses: $verses, arabic_name: $arabic_name, complex_name: $complex_name, id: $id, prefix_bismillah: $prefix_bismillah, revelation_place: $revelation_place, translated_name: $translated_name)';
  }
...
class _$_Verse implements _Verse {
  ...
  @override
  String toString() {
    return 'Verse(transliteration: $transliteration, words: $words, number: $number, page: $page, text: $text, translated_text: $translated_text, translations: $translations, id: $id, interpretations: $interpretations, key: $key)';
  }
...
class _$_Word implements _Word {
  ...
  @override
  String toString() {
    return 'Word(char_type: $char_type, page: $page, transliteration: $transliteration, position: $position, text: $text, translation: $translation, code: $code, id: $id, line: $line)';
  }
