...
class _$_Chapter implements _Chapter {
  ...
  @override
  String toString() {
    return 'Chapter(revelation_order: $revelation_order, verses: $verses, arabic_name: $arabic_name, complex_name: $complex_name, id: $id, pages: $pages, prefix_bismillah: $prefix_bismillah, name: $name, revelation_place: $revelation_place, translated_name: $translated_name)';
  }
...
class _$_Verse implements _Verse {
  ...
  @override
  String toString() {
    return 'Verse(translated_text: $translated_text, translations: $translations, number: $number, page: $page, text: $text, transliteration: $transliteration, words: $words, id: $id, interpretations: $interpretations, key: $key)';
  }
...
class _$_Word implements _Word {
  ...
  @override
  String toString() {
    return 'Word(id: $id, line: $line, page: $page, position: $position, transliteration: $transliteration, char_type: $char_type, code: $code, text: $text, translation: $translation)';
  }
