...
class _$_Chapter implements _Chapter {
  ...
  @override
  String toString() {
    return 'Chapter(arabic_name: $arabic_name, pages: $pages, revelation_place: $revelation_place, verses: $verses, revelation_order: $revelation_order, translated_name: $translated_name, complex_name: $complex_name, id: $id, name: $name, prefix_bismillah: $prefix_bismillah)';
  }
...
class _$_Verse implements _Verse {
  ...
  @override
  String toString() {
    return 'Verse(translations: $translations, transliteration: $transliteration, words: $words, key: $key, number: $number, page: $page, translated_text: $translated_text, id: $id, interpretations: $interpretations, text: $text)';
  }
...
class _$_Word implements _Word {
  ...
  @override
  String toString() {
    return 'Word(char_type: $char_type, code: $code, line: $line, translation: $translation, transliteration: $transliteration, id: $id, page: $page, position: $position, text: $text)';
  }
