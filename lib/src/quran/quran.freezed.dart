...
class _$_Chapter implements _Chapter {
  ...
  @override
  String toString() {
    return 'Chapter(pages: $pages, prefix_bismillah: $prefix_bismillah, revelation_order: $revelation_order, revelation_place: $revelation_place, translated_name: $translated_name, id: $id, name: $name, verses: $verses, arabic_name: $arabic_name, complex_name: $complex_name)';
  }
...
class _$_Verse implements _Verse {
  ...
  @override
  String toString() {
    return 'Verse(id: $id, key: $key, number: $number, page: $page, text: $text, translated_text: $translated_text, words: $words, interpretations: $interpretations, translations: $translations, transliteration: $transliteration)';
  }
...
class _$_Word implements _Word {
  ...
  @override
  String toString() {
    return 'Word(code: $code, line: $line, page: $page, text: $text, transliteration: $transliteration, char_type: $char_type, id: $id, position: $position, translation: $translation)';
  }
