...
class _$_Chapter implements _Chapter {
  ...
  @override
  String toString() {
    return 'Chapter(complex_name: $complex_name, id: $id, pages: $pages, revelation_order: $revelation_order, revelation_place: $revelation_place, verses: $verses, arabic_name: $arabic_name, prefix_bismillah: $prefix_bismillah, translated_name: $translated_name, name: $name)';
  }
...
class _$_Word implements _Word {
  ...
  @override
  String toString() {
    return 'Word(text: $text, char_type: $char_type, line: $line, page: $page, position: $position, translation: $translation, transliteration: $transliteration, code: $code, id: $id)';
  }
