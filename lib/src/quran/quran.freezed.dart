...
class _$_Chapter implements _Chapter {
  ...
  @override
  String toString() {
    return 'Chapter(verses: $verses, arabic_name: $arabic_name, complex_name: $complex_name, pages: $pages, prefix_bismillah: $prefix_bismillah, revelation_place: $revelation_place, translated_name: $translated_name, id: $id, name: $name, revelation_order: $revelation_order)';
  }
...
class _$_Verse implements _Verse {
  ...
  @override
  String toString() {
    return 'Verse(page: $page, translations: $translations, words: $words, id: $id, interpretations: $interpretations, key: $key, number: $number, text: $text, translated_text: $translated_text, transliteration: $transliteration)';
  }
...
class _$_Word implements _Word {
  ...
  @override
  String toString() {
    return 'Word(code: $code, id: $id, line: $line, page: $page, transliteration: $transliteration, char_type: $char_type, text: $text, translation: $translation, position: $position)';
  }
