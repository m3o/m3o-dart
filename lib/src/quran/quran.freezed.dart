...
class _$_Chapter implements _Chapter {
  ...
  @override
  String toString() {
    return 'Chapter(revelation_place: $revelation_place, translated_name: $translated_name, arabic_name: $arabic_name, complex_name: $complex_name, pages: $pages, prefix_bismillah: $prefix_bismillah, revelation_order: $revelation_order, id: $id, name: $name, verses: $verses)';
  }
...
class _$_Verse implements _Verse {
  ...
  @override
  String toString() {
    return 'Verse(transliteration: $transliteration, words: $words, text: $text, interpretations: $interpretations, key: $key, number: $number, page: $page, translated_text: $translated_text, translations: $translations, id: $id)';
  }
...
class _$_Word implements _Word {
  ...
  @override
  String toString() {
    return 'Word(translation: $translation, transliteration: $transliteration, id: $id, line: $line, position: $position, text: $text, char_type: $char_type, code: $code, page: $page)';
  }
