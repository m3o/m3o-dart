...
class _$_Chapter implements _Chapter {
  ...
  @override
  String toString() {
    return 'Chapter(translated_name: $translated_name, verses: $verses, name: $name, pages: $pages, prefix_bismillah: $prefix_bismillah, revelation_place: $revelation_place, arabic_name: $arabic_name, complex_name: $complex_name, id: $id, revelation_order: $revelation_order)';
  }
...
class _$_Verse implements _Verse {
  ...
  @override
  String toString() {
    return 'Verse(translations: $translations, transliteration: $transliteration, words: $words, id: $id, page: $page, text: $text, translated_text: $translated_text, interpretations: $interpretations, key: $key, number: $number)';
  }
