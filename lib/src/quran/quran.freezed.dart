...
class _$_Chapter implements _Chapter {
  ...
  @override
  String toString() {
    return 'Chapter(revelation_place: $revelation_place, translated_name: $translated_name, verses: $verses, prefix_bismillah: $prefix_bismillah, revelation_order: $revelation_order, id: $id, name: $name, pages: $pages, arabic_name: $arabic_name, complex_name: $complex_name)';
  }
...
class _$_Verse implements _Verse {
  ...
  @override
  String toString() {
    return 'Verse(interpretations: $interpretations, key: $key, number: $number, page: $page, transliteration: $transliteration, id: $id, translated_text: $translated_text, translations: $translations, words: $words, text: $text)';
  }
...
class _$_Word implements _Word {
  ...
  @override
  String toString() {
    return 'Word(transliteration: $transliteration, line: $line, position: $position, id: $id, page: $page, text: $text, translation: $translation, char_type: $char_type, code: $code)';
  }
