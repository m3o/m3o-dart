...
class _$_Chapter implements _Chapter {
  ...
  @override
  String toString() {
    return 'Chapter(revelation_place: $revelation_place, verses: $verses, arabic_name: $arabic_name, complex_name: $complex_name, id: $id, name: $name, prefix_bismillah: $prefix_bismillah, pages: $pages, revelation_order: $revelation_order, translated_name: $translated_name)';
  }
...
class _$_Verse implements _Verse {
  ...
  @override
  String toString() {
    return 'Verse(id: $id, interpretations: $interpretations, key: $key, number: $number, text: $text, translated_text: $translated_text, translations: $translations, words: $words, page: $page, transliteration: $transliteration)';
  }
...
class _$_Word implements _Word {
  ...
  @override
  String toString() {
    return 'Word(code: $code, page: $page, position: $position, text: $text, char_type: $char_type, id: $id, line: $line, translation: $translation, transliteration: $transliteration)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, code, page, position, text,
      char_type, id, line, translation, transliteration);
