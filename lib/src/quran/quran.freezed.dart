...
class _$_Chapter implements _Chapter {
  ...
  @override
  String toString() {
    return 'Chapter(id: $id, name: $name, prefix_bismillah: $prefix_bismillah, revelation_order: $revelation_order, revelation_place: $revelation_place, translated_name: $translated_name, arabic_name: $arabic_name, complex_name: $complex_name, pages: $pages, verses: $verses)';
  }
...
class _$_Verse implements _Verse {
  ...
  @override
  String toString() {
    return 'Verse(transliteration: $transliteration, interpretations: $interpretations, key: $key, number: $number, page: $page, text: $text, translations: $translations, id: $id, translated_text: $translated_text, words: $words)';
  }
...
class _$_Word implements _Word {
  ...
  @override
  String toString() {
    return 'Word(id: $id, text: $text, transliteration: $transliteration, translation: $translation, char_type: $char_type, code: $code, line: $line, page: $page, position: $position)';
  }
