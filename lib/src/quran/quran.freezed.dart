...
class _$_Chapter implements _Chapter {
  ...
  @override
  String toString() {
    return 'Chapter(arabic_name: $arabic_name, complex_name: $complex_name, translated_name: $translated_name, revelation_place: $revelation_place, verses: $verses, id: $id, name: $name, pages: $pages, prefix_bismillah: $prefix_bismillah, revelation_order: $revelation_order)';
  }
...
class _$SummaryResponseData implements SummaryResponseData {
  const _$SummaryResponseData(
      {this.text, this.chapter, this.source, this.summary, final String? $type})
      : $type = $type ?? 'default';
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, text, chapter, source, summary);
...
abstract class SummaryResponseData implements SummaryResponse {
  const factory SummaryResponseData(
      ...
      final int? chapter,
      final String? source,
      final String? summary}) = _$SummaryResponseData;
...
class _$_Verse implements _Verse {
  ...
  @override
  String toString() {
    return 'Verse(words: $words, id: $id, interpretations: $interpretations, number: $number, page: $page, translations: $translations, transliteration: $transliteration, key: $key, text: $text, translated_text: $translated_text)';
  }
...
abstract class _Verse implements Verse {
  const factory _Verse(
      ...
      final String? key,
      final String? text,
      final String? translated_text}) = _$_Verse;
...
class _$_Word implements _Word {
  ...
  @override
  String toString() {
    return 'Word(position: $position, transliteration: $transliteration, line: $line, page: $page, id: $id, text: $text, translation: $translation, char_type: $char_type, code: $code)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, position, transliteration, line,
      page, id, text, translation, char_type, code);
