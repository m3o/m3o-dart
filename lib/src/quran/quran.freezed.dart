...
class _$_Chapter implements _Chapter {
  ...
  @override
  String toString() {
    return 'Chapter(complex_name: $complex_name, prefix_bismillah: $prefix_bismillah, revelation_order: $revelation_order, revelation_place: $revelation_place, translated_name: $translated_name, verses: $verses, arabic_name: $arabic_name, id: $id, name: $name, pages: $pages)';
  }
...
class _$_Verse implements _Verse {
  ...
  @override
  String toString() {
    return 'Verse(interpretations: $interpretations, key: $key, transliteration: $transliteration, words: $words, translations: $translations, id: $id, number: $number, page: $page, text: $text, translated_text: $translated_text)';
  }
...
class _$_Word implements _Word {
  ...
  @override
  String toString() {
    return 'Word(page: $page, position: $position, text: $text, translation: $translation, transliteration: $transliteration, id: $id, code: $code, line: $line, char_type: $char_type)';
  }
