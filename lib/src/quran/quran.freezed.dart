...
class _$_Verse implements _Verse {
  ...
  @override
  String toString() {
    return 'Verse(text: $text, translated_text: $translated_text, transliteration: $transliteration, translations: $translations, words: $words, id: $id, interpretations: $interpretations, key: $key, number: $number, page: $page)';
  }
...
class _$_Word implements _Word {
  ...
  @override
  String toString() {
    return 'Word(translation: $translation, transliteration: $transliteration, code: $code, id: $id, line: $line, page: $page, text: $text, char_type: $char_type, position: $position)';
  }
