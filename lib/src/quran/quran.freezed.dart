...
class _$_Chapter implements _Chapter {
  ...
  @override
  String toString() {
    return 'Chapter(verses: $verses, arabic_name: $arabic_name, pages: $pages, revelation_order: $revelation_order, revelation_place: $revelation_place, translated_name: $translated_name, complex_name: $complex_name, id: $id, name: $name, prefix_bismillah: $prefix_bismillah)';
  }
...
class _$_Verse implements _Verse {
  ...
  @override
  String toString() {
    return 'Verse(id: $id, key: $key, page: $page, translated_text: $translated_text, words: $words, interpretations: $interpretations, number: $number, text: $text, translations: $translations, transliteration: $transliteration)';
  }
...
class _$_Word implements _Word {
  ...
  @override
  String toString() {
    return 'Word(line: $line, position: $position, text: $text, char_type: $char_type, code: $code, id: $id, page: $page, translation: $translation, transliteration: $transliteration)';
  }
