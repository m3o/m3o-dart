...
class _$_Chapter implements _Chapter {
  ...
  @override
  String toString() {
    return 'Chapter(verses: $verses, arabic_name: $arabic_name, name: $name, prefix_bismillah: $prefix_bismillah, translated_name: $translated_name, revelation_place: $revelation_place, complex_name: $complex_name, id: $id, pages: $pages, revelation_order: $revelation_order)';
  }
...
class _$_Verse implements _Verse {
  ...
  @override
  String toString() {
    return 'Verse(text: $text, translations: $translations, transliteration: $transliteration, page: $page, translated_text: $translated_text, words: $words, id: $id, interpretations: $interpretations, key: $key, number: $number)';
  }
...
class _$_Word implements _Word {
  ...
  @override
  String toString() {
    return 'Word(char_type: $char_type, code: $code, id: $id, position: $position, translation: $translation, line: $line, page: $page, text: $text, transliteration: $transliteration)';
  }
