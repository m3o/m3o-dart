...
class _$_Chapter implements _Chapter {
  ...
  @override
  String toString() {
    return 'Chapter(id: $id, prefix_bismillah: $prefix_bismillah, revelation_order: $revelation_order, revelation_place: $revelation_place, translated_name: $translated_name, verses: $verses, arabic_name: $arabic_name, complex_name: $complex_name, name: $name, pages: $pages)';
  }
...
class _$_Verse implements _Verse {
  ...
  @override
  String toString() {
    return 'Verse(page: $page, translated_text: $translated_text, translations: $translations, words: $words, id: $id, key: $key, number: $number, text: $text, transliteration: $transliteration, interpretations: $interpretations)';
  }
...
class _$_Word implements _Word {
  ...
  @override
  String toString() {
    return 'Word(page: $page, position: $position, text: $text, translation: $translation, transliteration: $transliteration, code: $code, id: $id, line: $line, char_type: $char_type)';
  }
