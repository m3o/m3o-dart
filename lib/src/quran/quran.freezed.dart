...
class _$_Chapter implements _Chapter {
  ...
  @override
  String toString() {
    return 'Chapter(id: $id, pages: $pages, revelation_order: $revelation_order, revelation_place: $revelation_place, translated_name: $translated_name, arabic_name: $arabic_name, complex_name: $complex_name, verses: $verses, name: $name, prefix_bismillah: $prefix_bismillah)';
  }
...
class _$_Verse implements _Verse {
  ...
  @override
  String toString() {
    return 'Verse(translations: $translations, transliteration: $transliteration, number: $number, translated_text: $translated_text, key: $key, page: $page, text: $text, words: $words, id: $id, interpretations: $interpretations)';
  }
...
class _$_Word implements _Word {
  ...
  @override
  String toString() {
    return 'Word(char_type: $char_type, id: $id, line: $line, page: $page, position: $position, text: $text, translation: $translation, transliteration: $transliteration, code: $code)';
  }
