...
class _$_Verse implements _Verse {
  ...
  @override
  String toString() {
    return 'Verse(key: $key, number: $number, translated_text: $translated_text, transliteration: $transliteration, words: $words, interpretations: $interpretations, page: $page, text: $text, translations: $translations, id: $id)';
  }
...
class _$_Word implements _Word {
  ...
  @override
  String toString() {
    return 'Word(id: $id, text: $text, transliteration: $transliteration, char_type: $char_type, code: $code, line: $line, page: $page, position: $position, translation: $translation)';
  }
