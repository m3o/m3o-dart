...
class _$_Verse implements _Verse {
  ...
  @override
  String toString() {
    return 'Verse(interpretations: $interpretations, page: $page, words: $words, translations: $translations, transliteration: $transliteration, id: $id, key: $key, number: $number, text: $text, translated_text: $translated_text)';
  }
...
class _$_Word implements _Word {
  ...
  @override
  String toString() {
    return 'Word(line: $line, transliteration: $transliteration, char_type: $char_type, code: $code, id: $id, page: $page, position: $position, text: $text, translation: $translation)';
  }
