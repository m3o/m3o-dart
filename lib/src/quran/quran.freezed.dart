...
class _$_Chapter implements _Chapter {
  ...
  @override
  String toString() {
    return 'Chapter(name: $name, pages: $pages, prefix_bismillah: $prefix_bismillah, revelation_place: $revelation_place, translated_name: $translated_name, verses: $verses, complex_name: $complex_name, id: $id, revelation_order: $revelation_order, arabic_name: $arabic_name)';
  }
...
class _$_Verse implements _Verse {
  ...
  @override
  String toString() {
    return 'Verse(id: $id, interpretations: $interpretations, key: $key, page: $page, text: $text, translations: $translations, number: $number, translated_text: $translated_text, transliteration: $transliteration, words: $words)';
  }
...
class _$_Word implements _Word {
  ...
  @override
  String toString() {
    return 'Word(line: $line, page: $page, transliteration: $transliteration, char_type: $char_type, code: $code, id: $id, position: $position, text: $text, translation: $translation)';
  }
