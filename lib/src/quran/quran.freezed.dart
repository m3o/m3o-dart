...
class _$_Chapter implements _Chapter {
  ...
  @override
  String toString() {
    return 'Chapter(prefix_bismillah: $prefix_bismillah, revelation_order: $revelation_order, verses: $verses, arabic_name: $arabic_name, complex_name: $complex_name, id: $id, name: $name, pages: $pages, revelation_place: $revelation_place, translated_name: $translated_name)';
  }
...
class _$_Verse implements _Verse {
  ...
  @override
  String toString() {
    return 'Verse(translated_text: $translated_text, transliteration: $transliteration, id: $id, key: $key, number: $number, page: $page, text: $text, interpretations: $interpretations, translations: $translations, words: $words)';
  }
...
class _$_Word implements _Word {
  ...
  @override
  String toString() {
    return 'Word(code: $code, id: $id, text: $text, transliteration: $transliteration, char_type: $char_type, line: $line, page: $page, position: $position, translation: $translation)';
  }
