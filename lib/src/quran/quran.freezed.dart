...
class _$_Chapter implements _Chapter {
  ...
  @override
  String toString() {
    return 'Chapter(arabic_name: $arabic_name, prefix_bismillah: $prefix_bismillah, translated_name: $translated_name, pages: $pages, revelation_order: $revelation_order, revelation_place: $revelation_place, verses: $verses, complex_name: $complex_name, id: $id, name: $name)';
  }
...
class _$_Verse implements _Verse {
  ...
  @override
  String toString() {
    return 'Verse(key: $key, text: $text, translated_text: $translated_text, interpretations: $interpretations, number: $number, page: $page, translations: $translations, transliteration: $transliteration, words: $words, id: $id)';
  }
...
class _$_Word implements _Word {
  ...
  @override
  String toString() {
    return 'Word(page: $page, text: $text, char_type: $char_type, code: $code, id: $id, transliteration: $transliteration, line: $line, position: $position, translation: $translation)';
  }
