...
class _$_Chapter implements _Chapter {
  ...
  @override
  String toString() {
    return 'Chapter(name: $name, pages: $pages, prefix_bismillah: $prefix_bismillah, revelation_place: $revelation_place, translated_name: $translated_name, arabic_name: $arabic_name, complex_name: $complex_name, id: $id, revelation_order: $revelation_order, verses: $verses)';
  }
...
class _$_Verse implements _Verse {
  ...
  @override
  String toString() {
    return 'Verse(text: $text, transliteration: $transliteration, words: $words, interpretations: $interpretations, number: $number, page: $page, translated_text: $translated_text, translations: $translations, id: $id, key: $key)';
  }
...
class _$_Word implements _Word {
  ...
  @override
  String toString() {
    return 'Word(char_type: $char_type, position: $position, code: $code, id: $id, line: $line, page: $page, text: $text, translation: $translation, transliteration: $transliteration)';
  }
