...
class _$_Chapter implements _Chapter {
  ...
  @override
  String toString() {
    return 'Chapter(pages: $pages, prefix_bismillah: $prefix_bismillah, revelation_place: $revelation_place, arabic_name: $arabic_name, complex_name: $complex_name, name: $name, verses: $verses, id: $id, revelation_order: $revelation_order, translated_name: $translated_name)';
  }
...
class _$_Word implements _Word {
  ...
  @override
  String toString() {
    return 'Word(text: $text, char_type: $char_type, position: $position, line: $line, page: $page, translation: $translation, transliteration: $transliteration, code: $code, id: $id)';
  }
