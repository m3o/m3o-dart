...
class _$_Verse implements _Verse {
  ...
  @override
  String toString() {
    return 'Verse(translated_text: $translated_text, translations: $translations, interpretations: $interpretations, text: $text, number: $number, page: $page, transliteration: $transliteration, words: $words, id: $id, key: $key)';
  }
