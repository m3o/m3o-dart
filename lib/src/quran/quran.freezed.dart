...
class _$_Chapter implements _Chapter {
  ...
  @override
  String toString() {
    return 'Chapter(complex_name: $complex_name, prefix_bismillah: $prefix_bismillah, translated_name: $translated_name, arabic_name: $arabic_name, name: $name, pages: $pages, revelation_order: $revelation_order, revelation_place: $revelation_place, verses: $verses, id: $id)';
  }
...
class _$_Verse implements _Verse {
  ...
  @override
  String toString() {
    return 'Verse(id: $id, interpretations: $interpretations, number: $number, translated_text: $translated_text, translations: $translations, words: $words, key: $key, page: $page, text: $text, transliteration: $transliteration)';
  }
...
class _$_Word implements _Word {
  ...
  @override
  String toString() {
    return 'Word(char_type: $char_type, code: $code, line: $line, position: $position, translation: $translation, transliteration: $transliteration, id: $id, page: $page, text: $text)';
  }
