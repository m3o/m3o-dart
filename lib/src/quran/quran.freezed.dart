...
class _$_Chapter implements _Chapter {
  ...
  @override
  String toString() {
    return 'Chapter(arabic_name: $arabic_name, complex_name: $complex_name, id: $id, verses: $verses, revelation_place: $revelation_place, translated_name: $translated_name, name: $name, pages: $pages, prefix_bismillah: $prefix_bismillah, revelation_order: $revelation_order)';
  }
...
class _$_Verse implements _Verse {
  ...
  @override
  String toString() {
    return 'Verse(words: $words, id: $id, interpretations: $interpretations, page: $page, text: $text, transliteration: $transliteration, key: $key, number: $number, translated_text: $translated_text, translations: $translations)';
  }
...
class _$_Word implements _Word {
  ...
  @override
  String toString() {
    return 'Word(char_type: $char_type, line: $line, page: $page, text: $text, code: $code, id: $id, position: $position, translation: $translation, transliteration: $transliteration)';
  }
