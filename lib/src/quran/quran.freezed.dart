...
class _$_Chapter implements _Chapter {
  ...
  @override
  String toString() {
    return 'Chapter(translated_name: $translated_name, arabic_name: $arabic_name, complex_name: $complex_name, name: $name, prefix_bismillah: $prefix_bismillah, verses: $verses, id: $id, pages: $pages, revelation_order: $revelation_order, revelation_place: $revelation_place)';
  }
...
abstract class _Chapter implements Chapter {
  const factory _Chapter(
      ...
      final List<int>? pages,
      final int? revelation_order,
      final String? revelation_place}) = _$_Chapter;
...
class _$_Verse implements _Verse {
  ...
  @override
  String toString() {
    return 'Verse(transliteration: $transliteration, words: $words, id: $id, interpretations: $interpretations, key: $key, number: $number, text: $text, translations: $translations, page: $page, translated_text: $translated_text)';
  }
...
class _$_Word implements _Word {
  ...
  @override
  String toString() {
    return 'Word(char_type: $char_type, code: $code, page: $page, transliteration: $transliteration, translation: $translation, id: $id, line: $line, position: $position, text: $text)';
  }
