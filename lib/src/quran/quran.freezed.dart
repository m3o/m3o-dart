...
class _$_Chapter implements _Chapter {
  ...
  @override
  String toString() {
    return 'Chapter(revelation_place: $revelation_place, verses: $verses, arabic_name: $arabic_name, name: $name, pages: $pages, revelation_order: $revelation_order, translated_name: $translated_name, complex_name: $complex_name, id: $id, prefix_bismillah: $prefix_bismillah)';
  }
...
class _$_Verse implements _Verse {
  ...
  @override
  String toString() {
    return 'Verse(key: $key, number: $number, page: $page, translations: $translations, words: $words, id: $id, interpretations: $interpretations, text: $text, translated_text: $translated_text, transliteration: $transliteration)';
  }
...
class _$_Word implements _Word {
  ...
  @override
  String toString() {
    return 'Word(page: $page, translation: $translation, id: $id, line: $line, position: $position, text: $text, transliteration: $transliteration, char_type: $char_type, code: $code)';
  }
