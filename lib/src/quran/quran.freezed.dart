...
class _$_Verse implements _Verse {
  ...
  @override
  String toString() {
    return 'Verse(number: $number, page: $page, text: $text, translated_text: $translated_text, translations: $translations, interpretations: $interpretations, key: $key, transliteration: $transliteration, words: $words, id: $id)';
  }
...
class _$_Word implements _Word {
  ...
  @override
  String toString() {
    return 'Word(line: $line, page: $page, text: $text, translation: $translation, code: $code, id: $id, position: $position, transliteration: $transliteration, char_type: $char_type)';
  }
