...
class _$_Chapter implements _Chapter {
  ...
  @override
  String toString() {
    return 'Chapter(complex_name: $complex_name, id: $id, name: $name, revelation_order: $revelation_order, translated_name: $translated_name, arabic_name: $arabic_name, pages: $pages, prefix_bismillah: $prefix_bismillah, revelation_place: $revelation_place, verses: $verses)';
  }
...
class _$_Verse implements _Verse {
  ...
  @override
  String toString() {
    return 'Verse(page: $page, translations: $translations, id: $id, number: $number, text: $text, translated_text: $translated_text, transliteration: $transliteration, words: $words, interpretations: $interpretations, key: $key)';
  }
...
class _$_Word implements _Word {
  ...
  @override
  String toString() {
    return 'Word(id: $id, text: $text, translation: $translation, char_type: $char_type, code: $code, line: $line, page: $page, position: $position, transliteration: $transliteration)';
  }
