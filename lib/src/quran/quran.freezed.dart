...
class _$_Chapter implements _Chapter {
  ...
  @override
  String toString() {
    return 'Chapter(complex_name: $complex_name, id: $id, revelation_order: $revelation_order, revelation_place: $revelation_place, verses: $verses, arabic_name: $arabic_name, name: $name, pages: $pages, prefix_bismillah: $prefix_bismillah, translated_name: $translated_name)';
  }
...
class _$_Verse implements _Verse {
  ...
  @override
  String toString() {
    return 'Verse(translated_text: $translated_text, translations: $translations, transliteration: $transliteration, id: $id, interpretations: $interpretations, key: $key, number: $number, page: $page, text: $text, words: $words)';
  }
...
class _$_Word implements _Word {
  ...
  @override
  String toString() {
    return 'Word(id: $id, line: $line, position: $position, text: $text, char_type: $char_type, code: $code, page: $page, translation: $translation, transliteration: $transliteration)';
  }
