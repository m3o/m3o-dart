...
class _$_Chapter implements _Chapter {
  ...
  @override
  String toString() {
    return 'Chapter(name: $name, prefix_bismillah: $prefix_bismillah, revelation_place: $revelation_place, translated_name: $translated_name, verses: $verses, arabic_name: $arabic_name, complex_name: $complex_name, revelation_order: $revelation_order, id: $id, pages: $pages)';
  }
...
abstract class _Chapter implements Chapter {
  const factory _Chapter(
      ...
      final int? revelation_order,
      final int? id,
      final List<int>? pages}) = _$_Chapter;
...
class _$_Verse implements _Verse {
  ...
  @override
  String toString() {
    return 'Verse(id: $id, interpretations: $interpretations, text: $text, translations: $translations, transliteration: $transliteration, key: $key, number: $number, page: $page, translated_text: $translated_text, words: $words)';
  }
...
class _$_Word implements _Word {
  ...
  @override
  String toString() {
    return 'Word(line: $line, page: $page, position: $position, transliteration: $transliteration, char_type: $char_type, code: $code, translation: $translation, id: $id, text: $text)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, line, page, position,
      transliteration, char_type, code, translation, id, text);
