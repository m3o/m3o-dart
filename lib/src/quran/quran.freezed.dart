...
class _$_Chapter implements _Chapter {
  ...
  @override
  String toString() {
    return 'Chapter(complex_name: $complex_name, id: $id, name: $name, pages: $pages, arabic_name: $arabic_name, prefix_bismillah: $prefix_bismillah, revelation_order: $revelation_order, revelation_place: $revelation_place, translated_name: $translated_name, verses: $verses)';
  }
...
abstract class _Interpretation implements Interpretation {
  const factory _Interpretation(
      {final String? source,
      final String? text,
      final int? id}) = _$_Interpretation;
...
class _$_SearchRequest implements _SearchRequest {
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, limit, page, query, language);
...
abstract class _SearchRequest implements SearchRequest {
  const factory _SearchRequest(
      ...
      final int? page,
      final String? query,
      final String? language}) = _$_SearchRequest;
...
class _$SearchResponseData implements SearchResponseData {
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, total_results, page, query,
      const DeepCollectionEquality().hash(_results), total_pages);
...
abstract class SearchResponseData implements SearchResponse {
  const factory SearchResponseData(
      ...
      final String? query,
      final List<Result>? results,
      final int? total_pages}) = _$SearchResponseData;
...
class _$_Verse implements _Verse {
  ...
  @override
  String toString() {
    return 'Verse(translated_text: $translated_text, translations: $translations, transliteration: $transliteration, id: $id, key: $key, number: $number, words: $words, interpretations: $interpretations, page: $page, text: $text)';
  }
...
class _$_VersesRequest implements _VersesRequest {
  ...
  @override
  int get hashCode => Object.hash(
      runtimeType, limit, page, translate, words, chapter, interpret, language);
...
abstract class _VersesRequest implements VersesRequest {
  const factory _VersesRequest(
      ...
      final int? chapter,
      final bool? interpret,
      final String? language}) = _$_VersesRequest;
...
class _$VersesResponseData implements VersesResponseData {
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, total_pages,
      const DeepCollectionEquality().hash(_verses), chapter, page);
...
abstract class VersesResponseData implements VersesResponse {
  const factory VersesResponseData(
      ...
      final List<Verse>? verses,
      final int? chapter,
      final int? page}) = _$VersesResponseData;
...
class _$_Word implements _Word {
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, char_type, code, id, line, page,
      position, text, translation, transliteration);
