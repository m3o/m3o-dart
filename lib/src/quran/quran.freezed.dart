...
class _$_Chapter implements _Chapter {
  ...
  @override
  String toString() {
    return 'Chapter(translated_name: $translated_name, verses: $verses, arabic_name: $arabic_name, complex_name: $complex_name, id: $id, prefix_bismillah: $prefix_bismillah, name: $name, pages: $pages, revelation_order: $revelation_order, revelation_place: $revelation_place)';
  }
...
class _$_Verse implements _Verse {
  ...
  @override
  String toString() {
    return 'Verse(interpretations: $interpretations, translated_text: $translated_text, id: $id, key: $key, number: $number, page: $page, text: $text, translations: $translations, transliteration: $transliteration, words: $words)';
  }
