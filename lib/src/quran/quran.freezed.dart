...
class _$_Chapter implements _Chapter {
  ...
  @override
  String toString() {
    return 'Chapter(revelation_order: $revelation_order, translated_name: $translated_name, arabic_name: $arabic_name, complex_name: $complex_name, id: $id, prefix_bismillah: $prefix_bismillah, name: $name, pages: $pages, revelation_place: $revelation_place, verses: $verses)';
  }
...
class _$_Verse implements _Verse {
  ...
  @override
  String toString() {
    return 'Verse(page: $page, translations: $translations, interpretations: $interpretations, key: $key, number: $number, text: $text, translated_text: $translated_text, transliteration: $transliteration, words: $words, id: $id)';
  }
...
class _$_Word implements _Word {
  ...
  @override
  String toString() {
    return 'Word(code: $code, id: $id, line: $line, text: $text, char_type: $char_type, position: $position, translation: $translation, transliteration: $transliteration, page: $page)';
  }
