...
class _$_Chapter implements _Chapter {
  ...
  @override
  String toString() {
    return 'Chapter(pages: $pages, prefix_bismillah: $prefix_bismillah, revelation_place: $revelation_place, translated_name: $translated_name, arabic_name: $arabic_name, complex_name: $complex_name, id: $id, name: $name, revelation_order: $revelation_order, verses: $verses)';
  }
...
class _$_Verse implements _Verse {
  ...
  @override
  String toString() {
    return 'Verse(translations: $translations, transliteration: $transliteration, translated_text: $translated_text, words: $words, id: $id, interpretations: $interpretations, key: $key, number: $number, page: $page, text: $text)';
  }
...
class _$_Word implements _Word {
  ...
  @override
  String toString() {
    return 'Word(position: $position, text: $text, translation: $translation, char_type: $char_type, code: $code, id: $id, line: $line, page: $page, transliteration: $transliteration)';
  }
