...
class _$_Chapter implements _Chapter {
  ...
  @override
  String toString() {
    return 'Chapter(name: $name, prefix_bismillah: $prefix_bismillah, revelation_place: $revelation_place, complex_name: $complex_name, id: $id, pages: $pages, revelation_order: $revelation_order, translated_name: $translated_name, verses: $verses, arabic_name: $arabic_name)';
  }
...
class _$_Verse implements _Verse {
  ...
  @override
  String toString() {
    return 'Verse(id: $id, interpretations: $interpretations, key: $key, translated_text: $translated_text, transliteration: $transliteration, words: $words, number: $number, page: $page, text: $text, translations: $translations)';
  }
...
class _$_Word implements _Word {
  ...
  @override
  String toString() {
    return 'Word(line: $line, page: $page, translation: $translation, char_type: $char_type, id: $id, position: $position, text: $text, transliteration: $transliteration, code: $code)';
  }
