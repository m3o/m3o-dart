...
class _$_Verse implements _Verse {
  ...
  @override
  String toString() {
    return 'Verse(id: $id, translations: $translations, words: $words, text: $text, translated_text: $translated_text, transliteration: $transliteration, interpretations: $interpretations, key: $key, number: $number, page: $page)';
  }
...
class _$_Word implements _Word {
  ...
  @override
  String toString() {
    return 'Word(transliteration: $transliteration, code: $code, page: $page, line: $line, position: $position, text: $text, translation: $translation, char_type: $char_type, id: $id)';
  }
