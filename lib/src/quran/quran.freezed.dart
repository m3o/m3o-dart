...
class _$_Chapter implements _Chapter {
  ...
  @override
  String toString() {
    return 'Chapter(translated_name: $translated_name, arabic_name: $arabic_name, name: $name, revelation_place: $revelation_place, prefix_bismillah: $prefix_bismillah, revelation_order: $revelation_order, verses: $verses, complex_name: $complex_name, id: $id, pages: $pages)';
  }
...
class _$_Verse implements _Verse {
  ...
  @override
  String toString() {
    return 'Verse(key: $key, text: $text, translations: $translations, words: $words, id: $id, number: $number, page: $page, translated_text: $translated_text, transliteration: $transliteration, interpretations: $interpretations)';
  }
...
class _$_Word implements _Word {
  ...
  @override
  String toString() {
    return 'Word(char_type: $char_type, code: $code, page: $page, text: $text, transliteration: $transliteration, id: $id, line: $line, position: $position, translation: $translation)';
  }
