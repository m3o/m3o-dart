...
class _$_Chapter implements _Chapter {
  ...
  @override
  String toString() {
    return 'Chapter(revelation_order: $revelation_order, revelation_place: $revelation_place, translated_name: $translated_name, verses: $verses, pages: $pages, complex_name: $complex_name, id: $id, name: $name, prefix_bismillah: $prefix_bismillah, arabic_name: $arabic_name)';
  }
...
class _$_Verse implements _Verse {
  ...
  @override
  String toString() {
    return 'Verse(interpretations: $interpretations, key: $key, translated_text: $translated_text, translations: $translations, id: $id, number: $number, page: $page, text: $text, transliteration: $transliteration, words: $words)';
  }
...
class _$_Word implements _Word {
  ...
  @override
  String toString() {
    return 'Word(transliteration: $transliteration, char_type: $char_type, line: $line, position: $position, translation: $translation, code: $code, id: $id, page: $page, text: $text)';
  }
