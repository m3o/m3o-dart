...
class _$_Chapter implements _Chapter {
  ...
  @override
  String toString() {
    return 'Chapter(arabic_name: $arabic_name, complex_name: $complex_name, pages: $pages, prefix_bismillah: $prefix_bismillah, translated_name: $translated_name, verses: $verses, id: $id, name: $name, revelation_order: $revelation_order, revelation_place: $revelation_place)';
  }
...
class _$_Verse implements _Verse {
  ...
  @override
  String toString() {
    return 'Verse(id: $id, page: $page, translations: $translations, words: $words, transliteration: $transliteration, interpretations: $interpretations, key: $key, number: $number, text: $text, translated_text: $translated_text)';
  }
...
class _$_Word implements _Word {
  ...
  @override
  String toString() {
    return 'Word(transliteration: $transliteration, translation: $translation, char_type: $char_type, code: $code, id: $id, line: $line, page: $page, position: $position, text: $text)';
  }
