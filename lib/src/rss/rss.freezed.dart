...
class _$_AddRequest implements _AddRequest {
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, url, category, name);
...
class _$_Entry implements _Entry {
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, date, feed, id, link, summary, title, content);
