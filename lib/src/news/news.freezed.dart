...
class _$_Article implements _Article {
  ...
  @override
  String toString() {
    return 'Article(id: $id, image_url: $image_url, language: $language, locale: $locale, snippet: $snippet, source: $source, categories: $categories, description: $description, title: $title, url: $url, keywords: $keywords, published_at: $published_at)';
  }
