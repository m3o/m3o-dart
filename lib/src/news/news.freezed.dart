...
class _$_Article implements _Article {
  ...
  @override
  String toString() {
    return 'Article(language: $language, snippet: $snippet, source: $source, title: $title, url: $url, image_url: $image_url, description: $description, id: $id, keywords: $keywords, locale: $locale, published_at: $published_at, categories: $categories)';
  }
