...
class _$_Article implements _Article {
  ...
  @override
  String toString() {
    return 'Article(id: $id, image_url: $image_url, keywords: $keywords, published_at: $published_at, url: $url, source: $source, title: $title, categories: $categories, description: $description, language: $language, locale: $locale, snippet: $snippet)';
  }
