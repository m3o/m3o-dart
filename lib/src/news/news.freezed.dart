...
class _$_Article implements _Article {
  ...
  @override
  String toString() {
    return 'Article(image_url: $image_url, snippet: $snippet, language: $language, locale: $locale, published_at: $published_at, source: $source, categories: $categories, description: $description, id: $id, keywords: $keywords, title: $title, url: $url)';
  }
