...
class _$_Article implements _Article {
  ...
  @override
  String toString() {
    return 'Article(locale: $locale, snippet: $snippet, url: $url, description: $description, id: $id, image_url: $image_url, keywords: $keywords, title: $title, categories: $categories, language: $language, published_at: $published_at, source: $source)';
  }
