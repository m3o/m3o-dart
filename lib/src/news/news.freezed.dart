...
class _$_Article implements _Article {
  ...
  @override
  String toString() {
    return 'Article(language: $language, locale: $locale, published_at: $published_at, url: $url, categories: $categories, id: $id, image_url: $image_url, keywords: $keywords, snippet: $snippet, source: $source, title: $title, description: $description)';
  }
