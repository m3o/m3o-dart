...
class _$_Article implements _Article {
  ...
  @override
  String toString() {
    return 'Article(keywords: $keywords, published_at: $published_at, url: $url, language: $language, locale: $locale, snippet: $snippet, source: $source, categories: $categories, description: $description, id: $id, image_url: $image_url, title: $title)';
  }
