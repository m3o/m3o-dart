...
class _$_Article implements _Article {
  ...
  @override
  String toString() {
    return 'Article(id: $id, source: $source, title: $title, published_at: $published_at, snippet: $snippet, categories: $categories, description: $description, image_url: $image_url, keywords: $keywords, language: $language, locale: $locale, url: $url)';
  }
