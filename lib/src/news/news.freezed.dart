...
class _$_Article implements _Article {
  ...
  @override
  String toString() {
    return 'Article(id: $id, image_url: $image_url, locale: $locale, published_at: $published_at, source: $source, title: $title, description: $description, keywords: $keywords, language: $language, snippet: $snippet, url: $url, categories: $categories)';
  }
