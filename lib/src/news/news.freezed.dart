...
class _$_Article implements _Article {
  ...
  @override
  String toString() {
    return 'Article(url: $url, description: $description, image_url: $image_url, language: $language, locale: $locale, published_at: $published_at, source: $source, title: $title, categories: $categories, id: $id, keywords: $keywords, snippet: $snippet)';
  }
