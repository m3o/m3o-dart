...
class _$_Article implements _Article {
  ...
  @override
  String toString() {
    return 'Article(snippet: $snippet, source: $source, title: $title, url: $url, categories: $categories, id: $id, image_url: $image_url, locale: $locale, description: $description, keywords: $keywords, language: $language, published_at: $published_at)';
  }
