...
class _$_Article implements _Article {
  ...
  @override
  String toString() {
    return 'Article(snippet: $snippet, source: $source, url: $url, image_url: $image_url, keywords: $keywords, language: $language, locale: $locale, title: $title, categories: $categories, description: $description, id: $id, published_at: $published_at)';
  }
