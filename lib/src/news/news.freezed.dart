...
class _$_Article implements _Article {
  ...
  @override
  String toString() {
    return 'Article(title: $title, description: $description, language: $language, locale: $locale, snippet: $snippet, published_at: $published_at, source: $source, url: $url, categories: $categories, id: $id, image_url: $image_url, keywords: $keywords)';
  }
