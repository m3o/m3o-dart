...
class _$_Article implements _Article {
  ...
  @override
  String toString() {
    return 'Article(published_at: $published_at, source: $source, title: $title, id: $id, language: $language, image_url: $image_url, keywords: $keywords, locale: $locale, snippet: $snippet, url: $url, categories: $categories, description: $description)';
  }
