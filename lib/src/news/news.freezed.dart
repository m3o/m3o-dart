...
class _$_Article implements _Article {
  ...
  @override
  String toString() {
    return 'Article(keywords: $keywords, language: $language, locale: $locale, snippet: $snippet, source: $source, title: $title, description: $description, image_url: $image_url, published_at: $published_at, url: $url, categories: $categories, id: $id)';
  }
