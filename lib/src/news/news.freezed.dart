...
class _$_Article implements _Article {
  ...
  @override
  String toString() {
    return 'Article(categories: $categories, description: $description, image_url: $image_url, keywords: $keywords, published_at: $published_at, source: $source, title: $title, url: $url, id: $id, language: $language, locale: $locale, snippet: $snippet)';
  }
...
abstract class _Article implements Article {
  const factory _Article(
      ...
      final String? language,
      final String? locale,
      final String? snippet}) = _$_Article;
