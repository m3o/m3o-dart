...
class _$_Article implements _Article {
  ...
  @override
  String toString() {
    return 'Article(categories: $categories, id: $id, keywords: $keywords, published_at: $published_at, title: $title, url: $url, description: $description, image_url: $image_url, language: $language, locale: $locale, snippet: $snippet, source: $source)';
  }
