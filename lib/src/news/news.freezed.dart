...
class _$_Article implements _Article {
  ...
  @override
  String toString() {
    return 'Article(categories: $categories, id: $id, keywords: $keywords, language: $language, published_at: $published_at, snippet: $snippet, description: $description, image_url: $image_url, locale: $locale, source: $source, title: $title, url: $url)';
  }
