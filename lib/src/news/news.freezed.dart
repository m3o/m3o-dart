...
class _$_Article implements _Article {
  ...
  @override
  String toString() {
    return 'Article(locale: $locale, snippet: $snippet, source: $source, url: $url, id: $id, description: $description, image_url: $image_url, keywords: $keywords, language: $language, published_at: $published_at, title: $title, categories: $categories)';
  }
