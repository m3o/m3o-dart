...
class _$_Article implements _Article {
  ...
  @override
  String toString() {
    return 'Article(categories: $categories, image_url: $image_url, locale: $locale, published_at: $published_at, snippet: $snippet, title: $title, description: $description, id: $id, keywords: $keywords, language: $language, source: $source, url: $url)';
  }
