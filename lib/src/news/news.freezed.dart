...
class _$_Article implements _Article {
  ...
  @override
  String toString() {
    return 'Article(language: $language, locale: $locale, source: $source, categories: $categories, description: $description, id: $id, image_url: $image_url, url: $url, keywords: $keywords, published_at: $published_at, snippet: $snippet, title: $title)';
  }
