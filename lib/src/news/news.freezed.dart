...
class _$_Article implements _Article {
  ...
  @override
  String toString() {
    return 'Article(title: $title, categories: $categories, image_url: $image_url, keywords: $keywords, locale: $locale, published_at: $published_at, snippet: $snippet, source: $source, url: $url, description: $description, id: $id, language: $language)';
  }
...
abstract class _Article implements Article {
  const factory _Article(
      ...
      final String? description,
      final String? id,
      final String? language}) = _$_Article;
