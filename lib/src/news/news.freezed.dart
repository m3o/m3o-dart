...
class _$_Article implements _Article {
  ...
  @override
  String toString() {
    return 'Article(categories: $categories, image_url: $image_url, language: $language, url: $url, title: $title, description: $description, id: $id, keywords: $keywords, locale: $locale, published_at: $published_at, snippet: $snippet, source: $source)';
  }
