...
class _$_Article implements _Article {
  ...
  @override
  String toString() {
    return 'Article(locale: $locale, snippet: $snippet, title: $title, description: $description, keywords: $keywords, image_url: $image_url, language: $language, published_at: $published_at, source: $source, url: $url, categories: $categories, id: $id)';
  }
