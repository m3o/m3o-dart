...
class _$_Article implements _Article {
  ...
  @override
  String toString() {
    return 'Article(id: $id, keywords: $keywords, source: $source, locale: $locale, published_at: $published_at, snippet: $snippet, title: $title, categories: $categories, description: $description, image_url: $image_url, language: $language, url: $url)';
  }
