...
class _$_Article implements _Article {
  ...
  @override
  String toString() {
    return 'Article(image_url: $image_url, keywords: $keywords, locale: $locale, published_at: $published_at, snippet: $snippet, url: $url, categories: $categories, description: $description, id: $id, language: $language, source: $source, title: $title)';
  }
