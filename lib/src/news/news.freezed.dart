...
class _$_Article implements _Article {
  ...
  @override
  String toString() {
    return 'Article(categories: $categories, locale: $locale, snippet: $snippet, title: $title, url: $url, description: $description, id: $id, image_url: $image_url, keywords: $keywords, language: $language, published_at: $published_at, source: $source)';
  }
