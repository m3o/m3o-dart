...
class _$_Article implements _Article {
  ...
  @override
  String toString() {
    return 'Article(id: $id, image_url: $image_url, keywords: $keywords, language: $language, locale: $locale, snippet: $snippet, source: $source, description: $description, url: $url, published_at: $published_at, title: $title, categories: $categories)';
  }
