...
class _$_Article implements _Article {
  ...
  @override
  String toString() {
    return 'Article(published_at: $published_at, snippet: $snippet, url: $url, categories: $categories, image_url: $image_url, keywords: $keywords, language: $language, locale: $locale, description: $description, id: $id, source: $source, title: $title)';
  }
