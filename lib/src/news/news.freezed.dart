...
class _$_Article implements _Article {
  ...
  @override
  String toString() {
    return 'Article(categories: $categories, id: $id, language: $language, locale: $locale, title: $title, url: $url, description: $description, image_url: $image_url, keywords: $keywords, published_at: $published_at, snippet: $snippet, source: $source)';
  }
