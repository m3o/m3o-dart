...
class _$_Article implements _Article {
  ...
  @override
  String toString() {
    return 'Article(description: $description, id: $id, image_url: $image_url, keywords: $keywords, language: $language, locale: $locale, snippet: $snippet, categories: $categories, source: $source, title: $title, url: $url, published_at: $published_at)';
  }
