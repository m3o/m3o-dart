...
class _$_Article implements _Article {
  ...
  @override
  String toString() {
    return 'Article(categories: $categories, description: $description, id: $id, locale: $locale, published_at: $published_at, snippet: $snippet, title: $title, image_url: $image_url, keywords: $keywords, language: $language, source: $source, url: $url)';
  }
