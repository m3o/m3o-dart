...
class _$_Article implements _Article {
  ...
  @override
  String toString() {
    return 'Article(description: $description, id: $id, published_at: $published_at, snippet: $snippet, source: $source, url: $url, categories: $categories, keywords: $keywords, language: $language, locale: $locale, title: $title, image_url: $image_url)';
  }
