...
class _$_Article implements _Article {
  ...
  @override
  String toString() {
    return 'Article(image_url: $image_url, keywords: $keywords, source: $source, url: $url, snippet: $snippet, title: $title, categories: $categories, description: $description, id: $id, language: $language, locale: $locale, published_at: $published_at)';
  }
