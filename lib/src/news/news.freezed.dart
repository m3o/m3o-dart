...
class _$_Article implements _Article {
  ...
  @override
  String toString() {
    return 'Article(language: $language, categories: $categories, image_url: $image_url, keywords: $keywords, published_at: $published_at, snippet: $snippet, source: $source, title: $title, url: $url, description: $description, id: $id, locale: $locale)';
  }
