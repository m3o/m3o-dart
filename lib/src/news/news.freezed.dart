...
class _$_Article implements _Article {
  ...
  @override
  String toString() {
    return 'Article(language: $language, locale: $locale, published_at: $published_at, snippet: $snippet, categories: $categories, id: $id, image_url: $image_url, keywords: $keywords, source: $source, description: $description, title: $title, url: $url)';
  }
