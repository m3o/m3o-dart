...
class _$_Article implements _Article {
  ...
  @override
  String toString() {
    return 'Article(language: $language, locale: $locale, published_at: $published_at, source: $source, keywords: $keywords, snippet: $snippet, title: $title, url: $url, categories: $categories, description: $description, id: $id, image_url: $image_url)';
  }
