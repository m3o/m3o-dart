...
class _$_Article implements _Article {
  ...
  @override
  String toString() {
    return 'Article(image_url: $image_url, keywords: $keywords, locale: $locale, published_at: $published_at, title: $title, url: $url, categories: $categories, id: $id, snippet: $snippet, source: $source, description: $description, language: $language)';
  }
