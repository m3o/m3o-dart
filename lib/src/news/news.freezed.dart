...
class _$_Article implements _Article {
  ...
  @override
  String toString() {
    return 'Article(url: $url, categories: $categories, image_url: $image_url, language: $language, locale: $locale, snippet: $snippet, source: $source, title: $title, description: $description, id: $id, keywords: $keywords, published_at: $published_at)';
  }
