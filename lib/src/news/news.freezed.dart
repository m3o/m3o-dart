...
class _$_Article implements _Article {
  ...
  @override
  String toString() {
    return 'Article(locale: $locale, published_at: $published_at, source: $source, title: $title, categories: $categories, description: $description, id: $id, image_url: $image_url, keywords: $keywords, language: $language, snippet: $snippet, url: $url)';
  }
