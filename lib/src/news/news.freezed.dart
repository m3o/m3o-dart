...
class _$_Article implements _Article {
  ...
  @override
  String toString() {
    return 'Article(description: $description, image_url: $image_url, locale: $locale, snippet: $snippet, url: $url, categories: $categories, id: $id, keywords: $keywords, language: $language, published_at: $published_at, source: $source, title: $title)';
  }
