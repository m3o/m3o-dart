...
class _$_Article implements _Article {
  ...
  @override
  String toString() {
    return 'Article(snippet: $snippet, url: $url, image_url: $image_url, keywords: $keywords, language: $language, locale: $locale, published_at: $published_at, categories: $categories, description: $description, id: $id, source: $source, title: $title)';
  }
