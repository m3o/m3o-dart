...
class _$_Article implements _Article {
  ...
  @override
  String toString() {
    return 'Article(image_url: $image_url, keywords: $keywords, locale: $locale, published_at: $published_at, url: $url, categories: $categories, description: $description, snippet: $snippet, source: $source, title: $title, id: $id, language: $language)';
  }
