...
class _$_Article implements _Article {
  ...
  @override
  String toString() {
    return 'Article(keywords: $keywords, language: $language, locale: $locale, published_at: $published_at, snippet: $snippet, categories: $categories, id: $id, image_url: $image_url, source: $source, url: $url, description: $description, title: $title)';
  }
