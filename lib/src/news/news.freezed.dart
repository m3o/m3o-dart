...
class _$_Article implements _Article {
  ...
  @override
  String toString() {
    return 'Article(locale: $locale, categories: $categories, id: $id, image_url: $image_url, keywords: $keywords, language: $language, url: $url, description: $description, published_at: $published_at, snippet: $snippet, source: $source, title: $title)';
  }
