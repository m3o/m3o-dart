...
class _$_Article implements _Article {
  ...
  @override
  String toString() {
    return 'Article(id: $id, language: $language, locale: $locale, snippet: $snippet, source: $source, title: $title, description: $description, image_url: $image_url, keywords: $keywords, published_at: $published_at, url: $url, categories: $categories)';
  }
