...
class _$_Article implements _Article {
  ...
  @override
  String toString() {
    return 'Article(source: $source, title: $title, url: $url, description: $description, id: $id, image_url: $image_url, language: $language, published_at: $published_at, categories: $categories, keywords: $keywords, locale: $locale, snippet: $snippet)';
  }
