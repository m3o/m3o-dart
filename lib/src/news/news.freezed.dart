...
class _$_Article implements _Article {
  ...
  @override
  String toString() {
    return 'Article(snippet: $snippet, title: $title, url: $url, categories: $categories, id: $id, image_url: $image_url, keywords: $keywords, source: $source, description: $description, language: $language, locale: $locale, published_at: $published_at)';
  }
