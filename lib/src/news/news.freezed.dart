...
class _$_Article implements _Article {
  ...
  @override
  String toString() {
    return 'Article(id: $id, image_url: $image_url, keywords: $keywords, published_at: $published_at, snippet: $snippet, description: $description, language: $language, locale: $locale, source: $source, title: $title, url: $url, categories: $categories)';
  }
