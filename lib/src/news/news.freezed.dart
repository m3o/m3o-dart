...
class _$_Article implements _Article {
  ...
  @override
  String toString() {
    return 'Article(source: $source, url: $url, categories: $categories, description: $description, keywords: $keywords, language: $language, locale: $locale, published_at: $published_at, id: $id, image_url: $image_url, snippet: $snippet, title: $title)';
  }
