...
class _$_Article implements _Article {
  ...
  @override
  String toString() {
    return 'Article(id: $id, image_url: $image_url, language: $language, published_at: $published_at, snippet: $snippet, url: $url, categories: $categories, description: $description, keywords: $keywords, locale: $locale, source: $source, title: $title)';
  }
