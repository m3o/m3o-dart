...
class _$_Article implements _Article {
  ...
  @override
  String toString() {
    return 'Article(published_at: $published_at, snippet: $snippet, source: $source, url: $url, categories: $categories, description: $description, keywords: $keywords, language: $language, locale: $locale, title: $title, id: $id, image_url: $image_url)';
  }
