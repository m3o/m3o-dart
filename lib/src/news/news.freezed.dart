...
class _$_Article implements _Article {
  ...
  @override
  String toString() {
    return 'Article(published_at: $published_at, title: $title, url: $url, description: $description, image_url: $image_url, keywords: $keywords, language: $language, source: $source, categories: $categories, id: $id, locale: $locale, snippet: $snippet)';
  }
