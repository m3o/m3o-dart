...
class _$_Article implements _Article {
  ...
  @override
  String toString() {
    return 'Article(categories: $categories, id: $id, language: $language, locale: $locale, published_at: $published_at, title: $title, url: $url, description: $description, image_url: $image_url, keywords: $keywords, snippet: $snippet, source: $source)';
  }
