...
class _$_Article implements _Article {
  ...
  @override
  String toString() {
    return 'Article(url: $url, categories: $categories, description: $description, id: $id, language: $language, locale: $locale, source: $source, title: $title, image_url: $image_url, keywords: $keywords, published_at: $published_at, snippet: $snippet)';
  }
