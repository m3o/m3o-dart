...
class _$_Article implements _Article {
  ...
  @override
  String toString() {
    return 'Article(source: $source, url: $url, categories: $categories, description: $description, id: $id, keywords: $keywords, published_at: $published_at, snippet: $snippet, image_url: $image_url, language: $language, locale: $locale, title: $title)';
  }
