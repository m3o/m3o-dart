...
class _$_Article implements _Article {
  ...
  @override
  String toString() {
    return 'Article(keywords: $keywords, locale: $locale, published_at: $published_at, categories: $categories, id: $id, language: $language, snippet: $snippet, source: $source, title: $title, url: $url, description: $description, image_url: $image_url)';
  }
