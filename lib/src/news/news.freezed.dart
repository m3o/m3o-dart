...
class _$_Article implements _Article {
  ...
  @override
  String toString() {
    return 'Article(source: $source, title: $title, categories: $categories, description: $description, keywords: $keywords, locale: $locale, snippet: $snippet, url: $url, id: $id, image_url: $image_url, language: $language, published_at: $published_at)';
  }
