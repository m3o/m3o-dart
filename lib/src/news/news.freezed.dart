...
class _$_Article implements _Article {
  ...
  @override
  String toString() {
    return 'Article(snippet: $snippet, title: $title, url: $url, keywords: $keywords, locale: $locale, id: $id, image_url: $image_url, language: $language, published_at: $published_at, source: $source, categories: $categories, description: $description)';
  }
