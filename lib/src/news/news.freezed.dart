...
class _$_Article implements _Article {
  ...
  @override
  String toString() {
    return 'Article(url: $url, language: $language, locale: $locale, snippet: $snippet, title: $title, keywords: $keywords, published_at: $published_at, source: $source, categories: $categories, description: $description, id: $id, image_url: $image_url)';
  }
