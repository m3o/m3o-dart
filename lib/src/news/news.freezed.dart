...
class _$_Article implements _Article {
  ...
  @override
  String toString() {
    return 'Article(url: $url, description: $description, id: $id, published_at: $published_at, source: $source, locale: $locale, snippet: $snippet, title: $title, categories: $categories, image_url: $image_url, keywords: $keywords, language: $language)';
  }
