...
class _$_Article implements _Article {
  ...
  @override
  String toString() {
    return 'Article(title: $title, url: $url, keywords: $keywords, locale: $locale, published_at: $published_at, image_url: $image_url, language: $language, snippet: $snippet, source: $source, categories: $categories, description: $description, id: $id)';
  }
