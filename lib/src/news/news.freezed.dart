...
class _$_Article implements _Article {
  ...
  @override
  String toString() {
    return 'Article(url: $url, categories: $categories, description: $description, id: $id, language: $language, snippet: $snippet, title: $title, image_url: $image_url, keywords: $keywords, locale: $locale, published_at: $published_at, source: $source)';
  }
