...
class _$_Article implements _Article {
  ...
  @override
  String toString() {
    return 'Article(published_at: $published_at, source: $source, categories: $categories, description: $description, id: $id, image_url: $image_url, locale: $locale, keywords: $keywords, language: $language, snippet: $snippet, title: $title, url: $url)';
  }
