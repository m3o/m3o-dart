...
class _$_Article implements _Article {
  ...
  @override
  String toString() {
    return 'Article(description: $description, keywords: $keywords, snippet: $snippet, source: $source, url: $url, title: $title, categories: $categories, id: $id, image_url: $image_url, language: $language, locale: $locale, published_at: $published_at)';
  }
