...
class _$_Article implements _Article {
  ...
  @override
  String toString() {
    return 'Article(image_url: $image_url, language: $language, locale: $locale, published_at: $published_at, snippet: $snippet, url: $url, categories: $categories, id: $id, keywords: $keywords, source: $source, title: $title, description: $description)';
  }
