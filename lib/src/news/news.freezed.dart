...
class _$_Article implements _Article {
  ...
  @override
  String toString() {
    return 'Article(title: $title, id: $id, image_url: $image_url, language: $language, locale: $locale, snippet: $snippet, source: $source, url: $url, categories: $categories, description: $description, keywords: $keywords, published_at: $published_at)';
  }
