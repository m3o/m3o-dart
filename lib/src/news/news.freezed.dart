...
class _$_Article implements _Article {
  ...
  @override
  String toString() {
    return 'Article(description: $description, id: $id, image_url: $image_url, source: $source, title: $title, categories: $categories, keywords: $keywords, language: $language, locale: $locale, published_at: $published_at, snippet: $snippet, url: $url)';
  }
