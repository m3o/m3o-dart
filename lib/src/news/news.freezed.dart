...
class _$_Article implements _Article {
  ...
  @override
  String toString() {
    return 'Article(image_url: $image_url, keywords: $keywords, language: $language, locale: $locale, snippet: $snippet, source: $source, title: $title, id: $id, description: $description, published_at: $published_at, url: $url, categories: $categories)';
  }
