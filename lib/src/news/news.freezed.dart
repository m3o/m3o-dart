...
class _$_Article implements _Article {
  ...
  @override
  String toString() {
    return 'Article(categories: $categories, keywords: $keywords, language: $language, snippet: $snippet, title: $title, description: $description, id: $id, image_url: $image_url, locale: $locale, published_at: $published_at, source: $source, url: $url)';
  }
