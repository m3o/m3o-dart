...
class _$_Article implements _Article {
  ...
  @override
  String toString() {
    return 'Article(categories: $categories, description: $description, id: $id, language: $language, locale: $locale, published_at: $published_at, image_url: $image_url, keywords: $keywords, snippet: $snippet, source: $source, title: $title, url: $url)';
  }
