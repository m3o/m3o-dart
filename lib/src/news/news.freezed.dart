...
class _$_Article implements _Article {
  ...
  @override
  String toString() {
    return 'Article(url: $url, categories: $categories, description: $description, image_url: $image_url, source: $source, title: $title, snippet: $snippet, id: $id, keywords: $keywords, language: $language, locale: $locale, published_at: $published_at)';
  }
