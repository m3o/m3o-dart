...
class _$_Article implements _Article {
  ...
  @override
  String toString() {
    return 'Article(id: $id, keywords: $keywords, locale: $locale, published_at: $published_at, snippet: $snippet, source: $source, categories: $categories, description: $description, title: $title, url: $url, image_url: $image_url, language: $language)';
  }
