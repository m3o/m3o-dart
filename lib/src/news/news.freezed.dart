...
class _$_Article implements _Article {
  ...
  @override
  String toString() {
    return 'Article(description: $description, id: $id, keywords: $keywords, published_at: $published_at, source: $source, categories: $categories, image_url: $image_url, language: $language, locale: $locale, snippet: $snippet, title: $title, url: $url)';
  }
