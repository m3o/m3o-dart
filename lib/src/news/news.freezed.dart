...
class _$_Article implements _Article {
  ...
  @override
  String toString() {
    return 'Article(source: $source, id: $id, keywords: $keywords, language: $language, snippet: $snippet, published_at: $published_at, title: $title, url: $url, categories: $categories, description: $description, image_url: $image_url, locale: $locale)';
  }
