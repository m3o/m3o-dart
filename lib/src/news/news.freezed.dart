...
class _$_Article implements _Article {
  ...
  @override
  String toString() {
    return 'Article(categories: $categories, description: $description, locale: $locale, published_at: $published_at, title: $title, url: $url, id: $id, image_url: $image_url, keywords: $keywords, language: $language, snippet: $snippet, source: $source)';
  }
