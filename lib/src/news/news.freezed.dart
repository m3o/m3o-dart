...
class _$_Article implements _Article {
  ...
  @override
  String toString() {
    return 'Article(url: $url, categories: $categories, image_url: $image_url, keywords: $keywords, locale: $locale, source: $source, title: $title, description: $description, id: $id, language: $language, published_at: $published_at, snippet: $snippet)';
  }
