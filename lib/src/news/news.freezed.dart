...
class _$_Article implements _Article {
  ...
  @override
  String toString() {
    return 'Article(source: $source, image_url: $image_url, keywords: $keywords, snippet: $snippet, language: $language, locale: $locale, published_at: $published_at, title: $title, url: $url, categories: $categories, description: $description, id: $id)';
  }
