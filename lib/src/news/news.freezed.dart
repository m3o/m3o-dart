...
class _$_Article implements _Article {
  ...
  @override
  String toString() {
    return 'Article(categories: $categories, description: $description, id: $id, keywords: $keywords, locale: $locale, url: $url, image_url: $image_url, language: $language, published_at: $published_at, snippet: $snippet, source: $source, title: $title)';
  }
