...
class _$_Article implements _Article {
  ...
  @override
  String toString() {
    return 'Article(description: $description, language: $language, published_at: $published_at, snippet: $snippet, url: $url, categories: $categories, id: $id, image_url: $image_url, keywords: $keywords, locale: $locale, source: $source, title: $title)';
  }
