...
class _$_Article implements _Article {
  ...
  @override
  String toString() {
    return 'Article(keywords: $keywords, published_at: $published_at, categories: $categories, description: $description, image_url: $image_url, snippet: $snippet, source: $source, title: $title, url: $url, id: $id, language: $language, locale: $locale)';
  }
