...
class _$_Article implements _Article {
  ...
  @override
  String toString() {
    return 'Article(keywords: $keywords, language: $language, published_at: $published_at, title: $title, categories: $categories, description: $description, id: $id, image_url: $image_url, locale: $locale, snippet: $snippet, source: $source, url: $url)';
  }
