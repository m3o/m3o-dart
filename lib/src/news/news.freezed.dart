...
class _$_Article implements _Article {
  ...
  @override
  String toString() {
    return 'Article(title: $title, description: $description, keywords: $keywords, locale: $locale, source: $source, published_at: $published_at, snippet: $snippet, url: $url, categories: $categories, id: $id, image_url: $image_url, language: $language)';
  }
