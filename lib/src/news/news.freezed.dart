...
class _$_Article implements _Article {
  ...
  @override
  String toString() {
    return 'Article(description: $description, image_url: $image_url, language: $language, locale: $locale, title: $title, url: $url, categories: $categories, id: $id, keywords: $keywords, published_at: $published_at, snippet: $snippet, source: $source)';
  }
