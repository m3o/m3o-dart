...
class _$_Article implements _Article {
  ...
  @override
  String toString() {
    return 'Article(snippet: $snippet, source: $source, url: $url, image_url: $image_url, keywords: $keywords, locale: $locale, published_at: $published_at, title: $title, categories: $categories, description: $description, id: $id, language: $language)';
  }
