...
class _$_Article implements _Article {
  ...
  @override
  String toString() {
    return 'Article(keywords: $keywords, language: $language, published_at: $published_at, snippet: $snippet, source: $source, description: $description, id: $id, locale: $locale, title: $title, url: $url, categories: $categories, image_url: $image_url)';
  }
