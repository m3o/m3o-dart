...
class _$_Article implements _Article {
  ...
  @override
  String toString() {
    return 'Article(description: $description, image_url: $image_url, language: $language, snippet: $snippet, source: $source, title: $title, url: $url, categories: $categories, keywords: $keywords, locale: $locale, published_at: $published_at, id: $id)';
  }
