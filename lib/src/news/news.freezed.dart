...
class _$_Article implements _Article {
  ...
  @override
  String toString() {
    return 'Article(categories: $categories, description: $description, keywords: $keywords, locale: $locale, snippet: $snippet, title: $title, id: $id, image_url: $image_url, language: $language, published_at: $published_at, source: $source, url: $url)';
  }
