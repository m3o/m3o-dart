...
class _$_Article implements _Article {
  ...
  @override
  String toString() {
    return 'Article(url: $url, id: $id, language: $language, snippet: $snippet, source: $source, title: $title, published_at: $published_at, categories: $categories, description: $description, image_url: $image_url, keywords: $keywords, locale: $locale)';
  }
