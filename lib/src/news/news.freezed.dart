...
class _$_Article implements _Article {
  ...
  @override
  String toString() {
    return 'Article(language: $language, published_at: $published_at, url: $url, image_url: $image_url, keywords: $keywords, id: $id, locale: $locale, snippet: $snippet, source: $source, title: $title, categories: $categories, description: $description)';
  }
