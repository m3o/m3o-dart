...
class _$_Article implements _Article {
  ...
  @override
  String toString() {
    return 'Article(description: $description, id: $id, language: $language, locale: $locale, snippet: $snippet, title: $title, url: $url, categories: $categories, keywords: $keywords, published_at: $published_at, source: $source, image_url: $image_url)';
  }
