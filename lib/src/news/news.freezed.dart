...
class _$_Article implements _Article {
  ...
  @override
  String toString() {
    return 'Article(locale: $locale, published_at: $published_at, source: $source, title: $title, description: $description, id: $id, image_url: $image_url, keywords: $keywords, url: $url, categories: $categories, language: $language, snippet: $snippet)';
  }
