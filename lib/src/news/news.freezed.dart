...
class _$_Article implements _Article {
  ...
  @override
  String toString() {
    return 'Article(language: $language, published_at: $published_at, snippet: $snippet, url: $url, keywords: $keywords, locale: $locale, source: $source, title: $title, categories: $categories, description: $description, id: $id, image_url: $image_url)';
  }
