...
class _$_Article implements _Article {
  ...
  @override
  String toString() {
    return 'Article(keywords: $keywords, published_at: $published_at, source: $source, categories: $categories, id: $id, image_url: $image_url, snippet: $snippet, title: $title, url: $url, description: $description, language: $language, locale: $locale)';
  }
