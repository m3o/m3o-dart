...
class _$_Article implements _Article {
  ...
  @override
  String toString() {
    return 'Article(description: $description, id: $id, image_url: $image_url, keywords: $keywords, locale: $locale, published_at: $published_at, title: $title, categories: $categories, url: $url, snippet: $snippet, source: $source, language: $language)';
  }
