...
class _$_Article implements _Article {
  ...
  @override
  String toString() {
    return 'Article(description: $description, id: $id, language: $language, locale: $locale, published_at: $published_at, snippet: $snippet, categories: $categories, image_url: $image_url, keywords: $keywords, source: $source, title: $title, url: $url)';
  }
