...
class _$_Article implements _Article {
  ...
  @override
  String toString() {
    return 'Article(language: $language, locale: $locale, published_at: $published_at, categories: $categories, id: $id, image_url: $image_url, keywords: $keywords, url: $url, description: $description, snippet: $snippet, source: $source, title: $title)';
  }
