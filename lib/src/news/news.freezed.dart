...
class _$_Article implements _Article {
  ...
  @override
  String toString() {
    return 'Article(locale: $locale, snippet: $snippet, title: $title, url: $url, categories: $categories, keywords: $keywords, image_url: $image_url, language: $language, published_at: $published_at, source: $source, description: $description, id: $id)';
  }
