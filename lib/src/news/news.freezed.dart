...
class _$_Article implements _Article {
  ...
  @override
  String toString() {
    return 'Article(description: $description, snippet: $snippet, title: $title, url: $url, locale: $locale, published_at: $published_at, source: $source, categories: $categories, id: $id, image_url: $image_url, keywords: $keywords, language: $language)';
  }
