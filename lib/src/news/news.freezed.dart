...
class _$_Article implements _Article {
  ...
  @override
  String toString() {
    return 'Article(url: $url, categories: $categories, image_url: $image_url, snippet: $snippet, source: $source, locale: $locale, published_at: $published_at, title: $title, description: $description, id: $id, keywords: $keywords, language: $language)';
  }
