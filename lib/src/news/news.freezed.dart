...
class _$_Article implements _Article {
  ...
  @override
  String toString() {
    return 'Article(url: $url, published_at: $published_at, title: $title, id: $id, image_url: $image_url, keywords: $keywords, language: $language, locale: $locale, snippet: $snippet, categories: $categories, description: $description, source: $source)';
  }
