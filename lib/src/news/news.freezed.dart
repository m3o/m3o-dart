...
class _$_Article implements _Article {
  ...
  @override
  String toString() {
    return 'Article(language: $language, published_at: $published_at, title: $title, url: $url, image_url: $image_url, description: $description, id: $id, keywords: $keywords, locale: $locale, snippet: $snippet, source: $source, categories: $categories)';
  }
