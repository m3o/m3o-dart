...
class _$_Article implements _Article {
  ...
  @override
  String toString() {
    return 'Article(keywords: $keywords, published_at: $published_at, source: $source, title: $title, url: $url, locale: $locale, snippet: $snippet, categories: $categories, description: $description, id: $id, image_url: $image_url, language: $language)';
  }
