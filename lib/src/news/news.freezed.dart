...
class _$_Article implements _Article {
  ...
  @override
  String toString() {
    return 'Article(title: $title, url: $url, image_url: $image_url, locale: $locale, snippet: $snippet, keywords: $keywords, language: $language, published_at: $published_at, source: $source, categories: $categories, description: $description, id: $id)';
  }
