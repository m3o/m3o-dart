...
class _$_Article implements _Article {
  ...
  @override
  String toString() {
    return 'Article(categories: $categories, description: $description, image_url: $image_url, language: $language, locale: $locale, published_at: $published_at, snippet: $snippet, id: $id, keywords: $keywords, source: $source, title: $title, url: $url)';
  }
