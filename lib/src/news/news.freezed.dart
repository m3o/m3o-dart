...
class _$_Article implements _Article {
  ...
  @override
  String toString() {
    return 'Article(snippet: $snippet, description: $description, id: $id, language: $language, published_at: $published_at, source: $source, title: $title, url: $url, categories: $categories, image_url: $image_url, keywords: $keywords, locale: $locale)';
  }
