...
class _$_Article implements _Article {
  ...
  @override
  String toString() {
    return 'Article(language: $language, snippet: $snippet, id: $id, image_url: $image_url, keywords: $keywords, published_at: $published_at, source: $source, title: $title, url: $url, categories: $categories, description: $description, locale: $locale)';
  }
