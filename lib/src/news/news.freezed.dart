...
class _$_Article implements _Article {
  ...
  @override
  String toString() {
    return 'Article(title: $title, categories: $categories, description: $description, keywords: $keywords, snippet: $snippet, source: $source, url: $url, id: $id, image_url: $image_url, language: $language, locale: $locale, published_at: $published_at)';
  }
