...
class _$_Article implements _Article {
  ...
  @override
  String toString() {
    return 'Article(categories: $categories, keywords: $keywords, locale: $locale, snippet: $snippet, source: $source, url: $url, description: $description, id: $id, image_url: $image_url, language: $language, published_at: $published_at, title: $title)';
  }
