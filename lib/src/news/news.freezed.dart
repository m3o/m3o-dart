...
class _$_Article implements _Article {
  ...
  @override
  String toString() {
    return 'Article(categories: $categories, description: $description, locale: $locale, snippet: $snippet, url: $url, id: $id, image_url: $image_url, keywords: $keywords, language: $language, published_at: $published_at, source: $source, title: $title)';
  }
