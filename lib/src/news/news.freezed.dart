...
class _$_Article implements _Article {
  ...
  @override
  String toString() {
    return 'Article(language: $language, published_at: $published_at, description: $description, image_url: $image_url, keywords: $keywords, locale: $locale, snippet: $snippet, source: $source, title: $title, url: $url, categories: $categories, id: $id)';
  }
