...
class _$_Article implements _Article {
  ...
  @override
  String toString() {
    return 'Article(snippet: $snippet, source: $source, title: $title, categories: $categories, id: $id, keywords: $keywords, language: $language, published_at: $published_at, description: $description, image_url: $image_url, locale: $locale, url: $url)';
  }
