...
class _$_Article implements _Article {
  ...
  @override
  String toString() {
    return 'Article(keywords: $keywords, locale: $locale, published_at: $published_at, source: $source, url: $url, categories: $categories, id: $id, image_url: $image_url, title: $title, description: $description, language: $language, snippet: $snippet)';
  }
