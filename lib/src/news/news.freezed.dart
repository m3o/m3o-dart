...
class _$_Article implements _Article {
  ...
  @override
  String toString() {
    return 'Article(image_url: $image_url, language: $language, locale: $locale, published_at: $published_at, source: $source, description: $description, id: $id, keywords: $keywords, snippet: $snippet, title: $title, url: $url, categories: $categories)';
  }
