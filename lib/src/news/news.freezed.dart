...
class _$_Article implements _Article {
  ...
  @override
  String toString() {
    return 'Article(image_url: $image_url, language: $language, snippet: $snippet, url: $url, description: $description, id: $id, locale: $locale, published_at: $published_at, source: $source, title: $title, categories: $categories, keywords: $keywords)';
  }
