...
class _$_Article implements _Article {
  ...
  @override
  String toString() {
    return 'Article(description: $description, image_url: $image_url, language: $language, published_at: $published_at, snippet: $snippet, source: $source, title: $title, categories: $categories, id: $id, keywords: $keywords, locale: $locale, url: $url)';
  }
