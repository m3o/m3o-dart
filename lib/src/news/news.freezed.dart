...
class _$_Article implements _Article {
  ...
  @override
  String toString() {
    return 'Article(id: $id, locale: $locale, snippet: $snippet, keywords: $keywords, language: $language, published_at: $published_at, source: $source, title: $title, categories: $categories, description: $description, image_url: $image_url, url: $url)';
  }
