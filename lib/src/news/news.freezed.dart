...
class _$_Article implements _Article {
  ...
  @override
  String toString() {
    return 'Article(categories: $categories, description: $description, id: $id, published_at: $published_at, snippet: $snippet, title: $title, image_url: $image_url, keywords: $keywords, language: $language, locale: $locale, source: $source, url: $url)';
  }
