...
class _$_Article implements _Article {
  ...
  @override
  String toString() {
    return 'Article(url: $url, categories: $categories, image_url: $image_url, language: $language, published_at: $published_at, source: $source, title: $title, description: $description, id: $id, keywords: $keywords, locale: $locale, snippet: $snippet)';
  }
