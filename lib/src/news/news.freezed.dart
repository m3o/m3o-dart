...
class _$_Article implements _Article {
  ...
  @override
  String toString() {
    return 'Article(language: $language, locale: $locale, published_at: $published_at, snippet: $snippet, source: $source, url: $url, categories: $categories, id: $id, keywords: $keywords, title: $title, description: $description, image_url: $image_url)';
  }
