...
class _$_Article implements _Article {
  ...
  @override
  String toString() {
    return 'Article(id: $id, image_url: $image_url, language: $language, locale: $locale, published_at: $published_at, title: $title, url: $url, categories: $categories, description: $description, keywords: $keywords, snippet: $snippet, source: $source)';
  }
