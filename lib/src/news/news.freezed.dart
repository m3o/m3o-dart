...
class _$_Article implements _Article {
  ...
  @override
  String toString() {
    return 'Article(source: $source, title: $title, language: $language, locale: $locale, published_at: $published_at, image_url: $image_url, keywords: $keywords, snippet: $snippet, url: $url, categories: $categories, description: $description, id: $id)';
  }
