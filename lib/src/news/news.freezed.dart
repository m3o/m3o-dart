...
class _$_Article implements _Article {
  ...
  @override
  String toString() {
    return 'Article(categories: $categories, image_url: $image_url, keywords: $keywords, language: $language, locale: $locale, title: $title, url: $url, description: $description, id: $id, published_at: $published_at, snippet: $snippet, source: $source)';
  }
