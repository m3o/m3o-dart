...
class _$_Article implements _Article {
  ...
  @override
  String toString() {
    return 'Article(language: $language, published_at: $published_at, snippet: $snippet, title: $title, id: $id, description: $description, image_url: $image_url, keywords: $keywords, locale: $locale, source: $source, url: $url, categories: $categories)';
  }
