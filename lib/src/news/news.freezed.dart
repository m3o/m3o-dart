...
class _$_Article implements _Article {
  ...
  @override
  String toString() {
    return 'Article(source: $source, categories: $categories, image_url: $image_url, language: $language, locale: $locale, published_at: $published_at, snippet: $snippet, description: $description, id: $id, keywords: $keywords, title: $title, url: $url)';
  }
