...
class _$_Article implements _Article {
  ...
  @override
  String toString() {
    return 'Article(source: $source, description: $description, keywords: $keywords, language: $language, published_at: $published_at, snippet: $snippet, url: $url, categories: $categories, id: $id, image_url: $image_url, locale: $locale, title: $title)';
  }
