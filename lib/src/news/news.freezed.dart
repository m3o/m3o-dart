...
class _$_Article implements _Article {
  ...
  @override
  String toString() {
    return 'Article(categories: $categories, description: $description, image_url: $image_url, keywords: $keywords, id: $id, language: $language, locale: $locale, published_at: $published_at, snippet: $snippet, source: $source, title: $title, url: $url)';
  }
