...
class _$_Article implements _Article {
  ...
  @override
  String toString() {
    return 'Article(id: $id, published_at: $published_at, snippet: $snippet, source: $source, title: $title, locale: $locale, url: $url, categories: $categories, description: $description, image_url: $image_url, keywords: $keywords, language: $language)';
  }
