...
class _$_Article implements _Article {
  ...
  @override
  String toString() {
    return 'Article(keywords: $keywords, locale: $locale, published_at: $published_at, source: $source, categories: $categories, description: $description, id: $id, image_url: $image_url, language: $language, snippet: $snippet, title: $title, url: $url)';
  }
