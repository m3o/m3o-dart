...
class _$_Article implements _Article {
  ...
  @override
  String toString() {
    return 'Article(title: $title, description: $description, id: $id, keywords: $keywords, language: $language, locale: $locale, url: $url, categories: $categories, image_url: $image_url, published_at: $published_at, snippet: $snippet, source: $source)';
  }
