...
class _$_Article implements _Article {
  ...
  @override
  String toString() {
    return 'Article(image_url: $image_url, language: $language, locale: $locale, source: $source, title: $title, url: $url, categories: $categories, description: $description, id: $id, keywords: $keywords, published_at: $published_at, snippet: $snippet)';
  }
