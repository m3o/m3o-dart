...
class _$_Article implements _Article {
  ...
  @override
  String toString() {
    return 'Article(title: $title, categories: $categories, description: $description, image_url: $image_url, keywords: $keywords, language: $language, snippet: $snippet, source: $source, id: $id, locale: $locale, published_at: $published_at, url: $url)';
  }
