...
class _$_Article implements _Article {
  ...
  @override
  String toString() {
    return 'Article(snippet: $snippet, categories: $categories, description: $description, image_url: $image_url, language: $language, locale: $locale, url: $url, id: $id, keywords: $keywords, published_at: $published_at, source: $source, title: $title)';
  }
