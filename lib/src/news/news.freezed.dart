...
class _$_Article implements _Article {
  ...
  @override
  String toString() {
    return 'Article(title: $title, url: $url, language: $language, published_at: $published_at, source: $source, image_url: $image_url, keywords: $keywords, locale: $locale, snippet: $snippet, categories: $categories, description: $description, id: $id)';
  }
