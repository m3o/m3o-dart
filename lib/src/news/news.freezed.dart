...
class _$_Article implements _Article {
  ...
  @override
  String toString() {
    return 'Article(id: $id, image_url: $image_url, published_at: $published_at, locale: $locale, snippet: $snippet, source: $source, title: $title, categories: $categories, description: $description, keywords: $keywords, language: $language, url: $url)';
  }
