...
class _$_Article implements _Article {
  ...
  @override
  String toString() {
    return 'Article(id: $id, snippet: $snippet, source: $source, title: $title, url: $url, categories: $categories, description: $description, language: $language, locale: $locale, published_at: $published_at, image_url: $image_url, keywords: $keywords)';
  }
