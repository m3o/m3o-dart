...
class _$_Article implements _Article {
  ...
  @override
  String toString() {
    return 'Article(title: $title, categories: $categories, description: $description, id: $id, language: $language, snippet: $snippet, source: $source, image_url: $image_url, keywords: $keywords, locale: $locale, published_at: $published_at, url: $url)';
  }
