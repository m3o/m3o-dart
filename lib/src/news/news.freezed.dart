...
class _$_Article implements _Article {
  ...
  @override
  String toString() {
    return 'Article(language: $language, locale: $locale, published_at: $published_at, source: $source, url: $url, id: $id, description: $description, image_url: $image_url, keywords: $keywords, snippet: $snippet, title: $title, categories: $categories)';
  }
