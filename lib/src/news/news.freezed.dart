...
class _$_Article implements _Article {
  ...
  @override
  String toString() {
    return 'Article(keywords: $keywords, language: $language, published_at: $published_at, snippet: $snippet, source: $source, title: $title, id: $id, description: $description, image_url: $image_url, locale: $locale, url: $url, categories: $categories)';
  }
