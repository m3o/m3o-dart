...
class _$_Article implements _Article {
  ...
  @override
  String toString() {
    return 'Article(id: $id, keywords: $keywords, locale: $locale, snippet: $snippet, url: $url, categories: $categories, description: $description, image_url: $image_url, language: $language, published_at: $published_at, source: $source, title: $title)';
  }
