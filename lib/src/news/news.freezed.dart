...
class _$_Article implements _Article {
  ...
  @override
  String toString() {
    return 'Article(categories: $categories, image_url: $image_url, locale: $locale, snippet: $snippet, title: $title, url: $url, description: $description, id: $id, keywords: $keywords, language: $language, published_at: $published_at, source: $source)';
  }
