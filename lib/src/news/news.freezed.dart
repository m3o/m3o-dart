...
class _$_Article implements _Article {
  ...
  @override
  String toString() {
    return 'Article(snippet: $snippet, title: $title, url: $url, categories: $categories, keywords: $keywords, image_url: $image_url, language: $language, locale: $locale, published_at: $published_at, source: $source, description: $description, id: $id)';
  }
