...
class _$_Forecast implements _Forecast {
  ...
  @override
  String toString() {
    return 'Forecast(sunset: $sunset, avg_temp_c: $avg_temp_c, date: $date, max_wind_mph: $max_wind_mph, sunrise: $sunrise, max_wind_kph: $max_wind_kph, min_temp_f: $min_temp_f, avg_temp_f: $avg_temp_f, condition: $condition, max_temp_c: $max_temp_c, min_temp_c: $min_temp_c, will_it_rain: $will_it_rain, chance_of_rain: $chance_of_rain, icon_url: $icon_url, max_temp_f: $max_temp_f)';
  }
...
class _$NowResponseData implements NowResponseData {
  ...
  @override
  String toString() {
    return 'NowResponse(cloud: $cloud, condition: $condition, country: $country, temp_c: $temp_c, wind_mph: $wind_mph, daytime: $daytime, region: $region, wind_direction: $wind_direction, wind_kph: $wind_kph, temp_f: $temp_f, feels_like_f: $feels_like_f, icon_url: $icon_url, latitude: $latitude, local_time: $local_time, longitude: $longitude, feels_like_c: $feels_like_c, humidity: $humidity, location: $location, timezone: $timezone, wind_degree: $wind_degree)';
  }
