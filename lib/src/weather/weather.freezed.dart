...
class _$_Forecast implements _Forecast {
  ...
  @override
  String toString() {
    return 'Forecast(date: $date, chance_of_rain: $chance_of_rain, icon_url: $icon_url, max_temp_f: $max_temp_f, max_wind_mph: $max_wind_mph, sunset: $sunset, avg_temp_f: $avg_temp_f, max_temp_c: $max_temp_c, min_temp_c: $min_temp_c, min_temp_f: $min_temp_f, will_it_rain: $will_it_rain, avg_temp_c: $avg_temp_c, condition: $condition, max_wind_kph: $max_wind_kph, sunrise: $sunrise)';
  }
...
class _$NowResponseData implements NowResponseData {
  ...
  @override
  String toString() {
    return 'NowResponse(local_time: $local_time, location: $location, cloud: $cloud, daytime: $daytime, feels_like_c: $feels_like_c, region: $region, feels_like_f: $feels_like_f, humidity: $humidity, icon_url: $icon_url, timezone: $timezone, wind_kph: $wind_kph, country: $country, latitude: $latitude, temp_c: $temp_c, wind_degree: $wind_degree, wind_direction: $wind_direction, wind_mph: $wind_mph, condition: $condition, longitude: $longitude, temp_f: $temp_f)';
  }
