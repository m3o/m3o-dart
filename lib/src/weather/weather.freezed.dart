...
class _$_Forecast implements _Forecast {
  ...
  @override
  String toString() {
    return 'Forecast(min_temp_c: $min_temp_c, min_temp_f: $min_temp_f, avg_temp_c: $avg_temp_c, avg_temp_f: $avg_temp_f, date: $date, max_wind_kph: $max_wind_kph, condition: $condition, icon_url: $icon_url, max_temp_f: $max_temp_f, max_wind_mph: $max_wind_mph, sunrise: $sunrise, sunset: $sunset, will_it_rain: $will_it_rain, chance_of_rain: $chance_of_rain, max_temp_c: $max_temp_c)';
  }
...
class _$NowResponseData implements NowResponseData {
  ...
  @override
  String toString() {
    return 'NowResponse(longitude: $longitude, temp_c: $temp_c, timezone: $timezone, wind_degree: $wind_degree, country: $country, daytime: $daytime, feels_like_c: $feels_like_c, humidity: $humidity, temp_f: $temp_f, condition: $condition, icon_url: $icon_url, location: $location, region: $region, wind_direction: $wind_direction, wind_kph: $wind_kph, wind_mph: $wind_mph, cloud: $cloud, feels_like_f: $feels_like_f, latitude: $latitude, local_time: $local_time)';
  }
