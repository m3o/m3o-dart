...
class _$_Forecast implements _Forecast {
  ...
  @override
  String toString() {
    return 'Forecast(condition: $condition, max_temp_c: $max_temp_c, avg_temp_c: $avg_temp_c, chance_of_rain: $chance_of_rain, min_temp_f: $min_temp_f, will_it_rain: $will_it_rain, min_temp_c: $min_temp_c, sunset: $sunset, icon_url: $icon_url, max_wind_kph: $max_wind_kph, max_temp_f: $max_temp_f, max_wind_mph: $max_wind_mph, sunrise: $sunrise, avg_temp_f: $avg_temp_f, date: $date)';
  }
...
class _$NowResponseData implements NowResponseData {
  ...
  @override
  String toString() {
    return 'NowResponse(temp_c: $temp_c, timezone: $timezone, cloud: $cloud, icon_url: $icon_url, latitude: $latitude, local_time: $local_time, location: $location, region: $region, country: $country, daytime: $daytime, longitude: $longitude, wind_degree: $wind_degree, wind_direction: $wind_direction, condition: $condition, feels_like_c: $feels_like_c, feels_like_f: $feels_like_f, humidity: $humidity, temp_f: $temp_f, wind_kph: $wind_kph, wind_mph: $wind_mph)';
  }
