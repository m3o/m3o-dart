...
class _$_Forecast implements _Forecast {
  ...
  @override
  String toString() {
    return 'Forecast(max_wind_kph: $max_wind_kph, max_wind_mph: $max_wind_mph, min_temp_f: $min_temp_f, max_temp_f: $max_temp_f, sunset: $sunset, will_it_rain: $will_it_rain, avg_temp_c: $avg_temp_c, avg_temp_f: $avg_temp_f, condition: $condition, chance_of_rain: $chance_of_rain, min_temp_c: $min_temp_c, sunrise: $sunrise, date: $date, icon_url: $icon_url, max_temp_c: $max_temp_c)';
  }
...
class _$NowResponseData implements NowResponseData {
  ...
  @override
  String toString() {
    return 'NowResponse(icon_url: $icon_url, wind_mph: $wind_mph, condition: $condition, country: $country, local_time: $local_time, longitude: $longitude, wind_degree: $wind_degree, wind_kph: $wind_kph, cloud: $cloud, daytime: $daytime, region: $region, temp_c: $temp_c, temp_f: $temp_f, wind_direction: $wind_direction, feels_like_c: $feels_like_c, location: $location, latitude: $latitude, timezone: $timezone, feels_like_f: $feels_like_f, humidity: $humidity)';
  }
