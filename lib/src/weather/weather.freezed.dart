...
class _$_Forecast implements _Forecast {
  ...
  @override
  String toString() {
    return 'Forecast(condition: $condition, max_wind_mph: $max_wind_mph, min_temp_c: $min_temp_c, sunset: $sunset, chance_of_rain: $chance_of_rain, min_temp_f: $min_temp_f, max_wind_kph: $max_wind_kph, avg_temp_c: $avg_temp_c, avg_temp_f: $avg_temp_f, date: $date, icon_url: $icon_url, max_temp_f: $max_temp_f, max_temp_c: $max_temp_c, sunrise: $sunrise, will_it_rain: $will_it_rain)';
  }
...
class _$NowResponseData implements NowResponseData {
  ...
  @override
  String toString() {
    return 'NowResponse(humidity: $humidity, icon_url: $icon_url, latitude: $latitude, local_time: $local_time, longitude: $longitude, temp_c: $temp_c, feels_like_c: $feels_like_c, daytime: $daytime, feels_like_f: $feels_like_f, region: $region, wind_mph: $wind_mph, country: $country, condition: $condition, timezone: $timezone, cloud: $cloud, temp_f: $temp_f, wind_degree: $wind_degree, wind_direction: $wind_direction, wind_kph: $wind_kph, location: $location)';
  }
