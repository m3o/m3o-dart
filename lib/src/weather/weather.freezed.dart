...
class _$_Forecast implements _Forecast {
  ...
  @override
  String toString() {
    return 'Forecast(chance_of_rain: $chance_of_rain, icon_url: $icon_url, max_wind_mph: $max_wind_mph, min_temp_c: $min_temp_c, max_temp_f: $max_temp_f, min_temp_f: $min_temp_f, sunrise: $sunrise, will_it_rain: $will_it_rain, avg_temp_c: $avg_temp_c, avg_temp_f: $avg_temp_f, condition: $condition, date: $date, max_temp_c: $max_temp_c, sunset: $sunset, max_wind_kph: $max_wind_kph)';
  }
...
class _$NowResponseData implements NowResponseData {
  ...
  @override
  String toString() {
    return 'NowResponse(country: $country, latitude: $latitude, location: $location, temp_f: $temp_f, feels_like_f: $feels_like_f, longitude: $longitude, region: $region, temp_c: $temp_c, wind_direction: $wind_direction, daytime: $daytime, feels_like_c: $feels_like_c, humidity: $humidity, icon_url: $icon_url, local_time: $local_time, timezone: $timezone, wind_degree: $wind_degree, wind_mph: $wind_mph, cloud: $cloud, condition: $condition, wind_kph: $wind_kph)';
  }
