...
class _$_Forecast implements _Forecast {
  ...
  @override
  String toString() {
    return 'Forecast(avg_temp_f: $avg_temp_f, icon_url: $icon_url, max_temp_f: $max_temp_f, max_wind_kph: $max_wind_kph, max_wind_mph: $max_wind_mph, min_temp_f: $min_temp_f, sunrise: $sunrise, avg_temp_c: $avg_temp_c, condition: $condition, sunset: $sunset, date: $date, max_temp_c: $max_temp_c, will_it_rain: $will_it_rain, chance_of_rain: $chance_of_rain, min_temp_c: $min_temp_c)';
  }
...
class _$NowResponseData implements NowResponseData {
  ...
  @override
  String toString() {
    return 'NowResponse(longitude: $longitude, temp_c: $temp_c, temp_f: $temp_f, wind_kph: $wind_kph, cloud: $cloud, condition: $condition, daytime: $daytime, icon_url: $icon_url, location: $location, wind_degree: $wind_degree, country: $country, feels_like_c: $feels_like_c, feels_like_f: $feels_like_f, humidity: $humidity, latitude: $latitude, local_time: $local_time, region: $region, timezone: $timezone, wind_direction: $wind_direction, wind_mph: $wind_mph)';
  }
