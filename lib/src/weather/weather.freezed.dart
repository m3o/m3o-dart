...
class _$_Forecast implements _Forecast {
  ...
  @override
  String toString() {
    return 'Forecast(avg_temp_f: $avg_temp_f, date: $date, max_wind_kph: $max_wind_kph, sunset: $sunset, avg_temp_c: $avg_temp_c, chance_of_rain: $chance_of_rain, max_temp_c: $max_temp_c, max_wind_mph: $max_wind_mph, min_temp_c: $min_temp_c, sunrise: $sunrise, min_temp_f: $min_temp_f, will_it_rain: $will_it_rain, condition: $condition, icon_url: $icon_url, max_temp_f: $max_temp_f)';
  }
...
class _$NowResponseData implements NowResponseData {
  ...
  @override
  String toString() {
    return 'NowResponse(cloud: $cloud, temp_f: $temp_f, wind_mph: $wind_mph, region: $region, timezone: $timezone, wind_direction: $wind_direction, feels_like_f: $feels_like_f, latitude: $latitude, temp_c: $temp_c, wind_degree: $wind_degree, condition: $condition, country: $country, daytime: $daytime, local_time: $local_time, location: $location, longitude: $longitude, wind_kph: $wind_kph, feels_like_c: $feels_like_c, humidity: $humidity, icon_url: $icon_url)';
  }
