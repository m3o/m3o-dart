...
class _$_Forecast implements _Forecast {
  ...
  @override
  String toString() {
    return 'Forecast(avg_temp_f: $avg_temp_f, chance_of_rain: $chance_of_rain, condition: $condition, max_temp_c: $max_temp_c, max_wind_kph: $max_wind_kph, min_temp_f: $min_temp_f, sunrise: $sunrise, sunset: $sunset, avg_temp_c: $avg_temp_c, max_wind_mph: $max_wind_mph, min_temp_c: $min_temp_c, date: $date, icon_url: $icon_url, max_temp_f: $max_temp_f, will_it_rain: $will_it_rain)';
  }
...
class _$NowResponseData implements NowResponseData {
  ...
  @override
  String toString() {
    return 'NowResponse(wind_kph: $wind_kph, feels_like_f: $feels_like_f, humidity: $humidity, icon_url: $icon_url, wind_degree: $wind_degree, wind_direction: $wind_direction, wind_mph: $wind_mph, condition: $condition, latitude: $latitude, longitude: $longitude, temp_f: $temp_f, timezone: $timezone, temp_c: $temp_c, cloud: $cloud, country: $country, daytime: $daytime, local_time: $local_time, location: $location, feels_like_c: $feels_like_c, region: $region)';
  }
