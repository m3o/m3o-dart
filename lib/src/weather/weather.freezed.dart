...
class _$_Forecast implements _Forecast {
  ...
  @override
  String toString() {
    return 'Forecast(icon_url: $icon_url, avg_temp_c: $avg_temp_c, avg_temp_f: $avg_temp_f, sunset: $sunset, will_it_rain: $will_it_rain, max_wind_kph: $max_wind_kph, min_temp_f: $min_temp_f, min_temp_c: $min_temp_c, sunrise: $sunrise, max_temp_c: $max_temp_c, max_temp_f: $max_temp_f, date: $date, max_wind_mph: $max_wind_mph, chance_of_rain: $chance_of_rain, condition: $condition)';
  }
...
class _$NowResponseData implements NowResponseData {
  ...
  @override
  String toString() {
    return 'NowResponse(latitude: $latitude, local_time: $local_time, timezone: $timezone, feels_like_c: $feels_like_c, humidity: $humidity, longitude: $longitude, region: $region, wind_degree: $wind_degree, wind_kph: $wind_kph, cloud: $cloud, temp_f: $temp_f, wind_direction: $wind_direction, wind_mph: $wind_mph, condition: $condition, country: $country, daytime: $daytime, feels_like_f: $feels_like_f, icon_url: $icon_url, location: $location, temp_c: $temp_c)';
  }
