...
class _$_Forecast implements _Forecast {
  ...
  @override
  String toString() {
    return 'Forecast(avg_temp_c: $avg_temp_c, date: $date, max_temp_c: $max_temp_c, sunset: $sunset, avg_temp_f: $avg_temp_f, chance_of_rain: $chance_of_rain, condition: $condition, max_wind_mph: $max_wind_mph, icon_url: $icon_url, max_temp_f: $max_temp_f, max_wind_kph: $max_wind_kph, min_temp_c: $min_temp_c, min_temp_f: $min_temp_f, sunrise: $sunrise, will_it_rain: $will_it_rain)';
  }
...
class _$NowResponseData implements NowResponseData {
  ...
  @override
  String toString() {
    return 'NowResponse(feels_like_c: $feels_like_c, latitude: $latitude, longitude: $longitude, timezone: $timezone, condition: $condition, daytime: $daytime, feels_like_f: $feels_like_f, local_time: $local_time, location: $location, temp_f: $temp_f, wind_kph: $wind_kph, cloud: $cloud, country: $country, humidity: $humidity, icon_url: $icon_url, region: $region, temp_c: $temp_c, wind_mph: $wind_mph, wind_degree: $wind_degree, wind_direction: $wind_direction)';
  }
