...
class _$_Forecast implements _Forecast {
  ...
  @override
  String toString() {
    return 'Forecast(chance_of_rain: $chance_of_rain, date: $date, icon_url: $icon_url, min_temp_f: $min_temp_f, sunset: $sunset, condition: $condition, max_temp_f: $max_temp_f, will_it_rain: $will_it_rain, avg_temp_f: $avg_temp_f, max_temp_c: $max_temp_c, max_wind_kph: $max_wind_kph, min_temp_c: $min_temp_c, sunrise: $sunrise, avg_temp_c: $avg_temp_c, max_wind_mph: $max_wind_mph)';
  }
...
class _$NowResponseData implements NowResponseData {
  ...
  @override
  String toString() {
    return 'NowResponse(wind_mph: $wind_mph, country: $country, temp_c: $temp_c, wind_kph: $wind_kph, humidity: $humidity, icon_url: $icon_url, local_time: $local_time, longitude: $longitude, temp_f: $temp_f, condition: $condition, feels_like_c: $feels_like_c, feels_like_f: $feels_like_f, wind_degree: $wind_degree, daytime: $daytime, location: $location, timezone: $timezone, wind_direction: $wind_direction, cloud: $cloud, latitude: $latitude, region: $region)';
  }
