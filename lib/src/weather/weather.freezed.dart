...
class _$_Forecast implements _Forecast {
  ...
  @override
  String toString() {
    return 'Forecast(max_wind_kph: $max_wind_kph, min_temp_f: $min_temp_f, will_it_rain: $will_it_rain, condition: $condition, icon_url: $icon_url, date: $date, max_temp_c: $max_temp_c, sunrise: $sunrise, sunset: $sunset, avg_temp_c: $avg_temp_c, chance_of_rain: $chance_of_rain, max_wind_mph: $max_wind_mph, min_temp_c: $min_temp_c, avg_temp_f: $avg_temp_f, max_temp_f: $max_temp_f)';
  }
...
class _$NowResponseData implements NowResponseData {
  ...
  @override
  String toString() {
    return 'NowResponse(timezone: $timezone, wind_mph: $wind_mph, cloud: $cloud, country: $country, feels_like_c: $feels_like_c, icon_url: $icon_url, wind_direction: $wind_direction, daytime: $daytime, latitude: $latitude, local_time: $local_time, temp_c: $temp_c, region: $region, temp_f: $temp_f, condition: $condition, humidity: $humidity, location: $location, longitude: $longitude, feels_like_f: $feels_like_f, wind_degree: $wind_degree, wind_kph: $wind_kph)';
  }
