...
class _$_Forecast implements _Forecast {
  ...
  @override
  String toString() {
    return 'Forecast(sunrise: $sunrise, avg_temp_f: $avg_temp_f, max_temp_f: $max_temp_f, max_wind_kph: $max_wind_kph, min_temp_f: $min_temp_f, avg_temp_c: $avg_temp_c, min_temp_c: $min_temp_c, will_it_rain: $will_it_rain, max_wind_mph: $max_wind_mph, condition: $condition, date: $date, icon_url: $icon_url, max_temp_c: $max_temp_c, sunset: $sunset, chance_of_rain: $chance_of_rain)';
  }
...
class _$NowResponseData implements NowResponseData {
  ...
  @override
  String toString() {
    return 'NowResponse(wind_kph: $wind_kph, cloud: $cloud, feels_like_c: $feels_like_c, latitude: $latitude, location: $location, timezone: $timezone, wind_degree: $wind_degree, wind_direction: $wind_direction, daytime: $daytime, icon_url: $icon_url, region: $region, temp_f: $temp_f, condition: $condition, temp_c: $temp_c, wind_mph: $wind_mph, longitude: $longitude, country: $country, feels_like_f: $feels_like_f, humidity: $humidity, local_time: $local_time)';
  }
