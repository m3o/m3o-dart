...
class _$_Forecast implements _Forecast {
  ...
  @override
  String toString() {
    return 'Forecast(condition: $condition, max_temp_f: $max_temp_f, will_it_rain: $will_it_rain, min_temp_f: $min_temp_f, sunset: $sunset, icon_url: $icon_url, max_wind_mph: $max_wind_mph, min_temp_c: $min_temp_c, sunrise: $sunrise, avg_temp_c: $avg_temp_c, chance_of_rain: $chance_of_rain, max_temp_c: $max_temp_c, avg_temp_f: $avg_temp_f, date: $date, max_wind_kph: $max_wind_kph)';
  }
...
class _$NowResponseData implements NowResponseData {
  ...
  @override
  String toString() {
    return 'NowResponse(country: $country, feels_like_c: $feels_like_c, latitude: $latitude, timezone: $timezone, wind_degree: $wind_degree, wind_direction: $wind_direction, cloud: $cloud, condition: $condition, local_time: $local_time, location: $location, wind_kph: $wind_kph, feels_like_f: $feels_like_f, icon_url: $icon_url, longitude: $longitude, region: $region, wind_mph: $wind_mph, daytime: $daytime, humidity: $humidity, temp_c: $temp_c, temp_f: $temp_f)';
  }
