...
class _$_Forecast implements _Forecast {
  ...
  @override
  String toString() {
    return 'Forecast(max_temp_c: $max_temp_c, avg_temp_c: $avg_temp_c, avg_temp_f: $avg_temp_f, min_temp_c: $min_temp_c, min_temp_f: $min_temp_f, sunrise: $sunrise, will_it_rain: $will_it_rain, condition: $condition, icon_url: $icon_url, max_wind_mph: $max_wind_mph, max_temp_f: $max_temp_f, max_wind_kph: $max_wind_kph, sunset: $sunset, chance_of_rain: $chance_of_rain, date: $date)';
  }
...
class _$NowResponseData implements NowResponseData {
  ...
  @override
  String toString() {
    return 'NowResponse(location: $location, temp_f: $temp_f, wind_degree: $wind_degree, cloud: $cloud, feels_like_f: $feels_like_f, icon_url: $icon_url, latitude: $latitude, local_time: $local_time, wind_kph: $wind_kph, country: $country, daytime: $daytime, timezone: $timezone, condition: $condition, humidity: $humidity, temp_c: $temp_c, feels_like_c: $feels_like_c, longitude: $longitude, region: $region, wind_direction: $wind_direction, wind_mph: $wind_mph)';
  }
