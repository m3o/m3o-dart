...
class _$_Forecast implements _Forecast {
  ...
  @override
  String toString() {
    return 'Forecast(sunrise: $sunrise, avg_temp_f: $avg_temp_f, min_temp_c: $min_temp_c, min_temp_f: $min_temp_f, chance_of_rain: $chance_of_rain, max_wind_mph: $max_wind_mph, sunset: $sunset, max_temp_f: $max_temp_f, max_wind_kph: $max_wind_kph, avg_temp_c: $avg_temp_c, condition: $condition, icon_url: $icon_url, date: $date, max_temp_c: $max_temp_c, will_it_rain: $will_it_rain)';
  }
...
class _$NowResponseData implements NowResponseData {
  ...
  @override
  String toString() {
    return 'NowResponse(condition: $condition, feels_like_f: $feels_like_f, humidity: $humidity, daytime: $daytime, latitude: $latitude, temp_c: $temp_c, timezone: $timezone, wind_kph: $wind_kph, cloud: $cloud, local_time: $local_time, longitude: $longitude, wind_degree: $wind_degree, wind_mph: $wind_mph, country: $country, feels_like_c: $feels_like_c, icon_url: $icon_url, location: $location, region: $region, temp_f: $temp_f, wind_direction: $wind_direction)';
  }
