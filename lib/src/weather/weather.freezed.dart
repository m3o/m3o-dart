...
class _$_Forecast implements _Forecast {
  ...
  @override
  String toString() {
    return 'Forecast(chance_of_rain: $chance_of_rain, condition: $condition, sunset: $sunset, will_it_rain: $will_it_rain, avg_temp_f: $avg_temp_f, max_temp_f: $max_temp_f, max_wind_kph: $max_wind_kph, min_temp_f: $min_temp_f, sunrise: $sunrise, avg_temp_c: $avg_temp_c, date: $date, icon_url: $icon_url, max_temp_c: $max_temp_c, max_wind_mph: $max_wind_mph, min_temp_c: $min_temp_c)';
  }
...
class _$NowResponseData implements NowResponseData {
  ...
  @override
  String toString() {
    return 'NowResponse(wind_mph: $wind_mph, cloud: $cloud, icon_url: $icon_url, local_time: $local_time, temp_c: $temp_c, wind_direction: $wind_direction, wind_kph: $wind_kph, timezone: $timezone, wind_degree: $wind_degree, country: $country, feels_like_c: $feels_like_c, feels_like_f: $feels_like_f, latitude: $latitude, location: $location, region: $region, daytime: $daytime, humidity: $humidity, condition: $condition, longitude: $longitude, temp_f: $temp_f)';
  }
