...
class _$_Forecast implements _Forecast {
  ...
  @override
  String toString() {
    return 'Forecast(min_temp_c: $min_temp_c, chance_of_rain: $chance_of_rain, condition: $condition, max_temp_c: $max_temp_c, max_temp_f: $max_temp_f, max_wind_mph: $max_wind_mph, date: $date, icon_url: $icon_url, sunset: $sunset, avg_temp_c: $avg_temp_c, max_wind_kph: $max_wind_kph, sunrise: $sunrise, will_it_rain: $will_it_rain, avg_temp_f: $avg_temp_f, min_temp_f: $min_temp_f)';
  }
...
class _$NowResponseData implements NowResponseData {
  ...
  @override
  String toString() {
    return 'NowResponse(humidity: $humidity, icon_url: $icon_url, region: $region, temp_f: $temp_f, timezone: $timezone, wind_mph: $wind_mph, cloud: $cloud, country: $country, temp_c: $temp_c, wind_direction: $wind_direction, daytime: $daytime, feels_like_c: $feels_like_c, condition: $condition, latitude: $latitude, location: $location, longitude: $longitude, wind_degree: $wind_degree, wind_kph: $wind_kph, feels_like_f: $feels_like_f, local_time: $local_time)';
  }
