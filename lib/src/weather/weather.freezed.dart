...
class _$_Forecast implements _Forecast {
  ...
  @override
  String toString() {
    return 'Forecast(avg_temp_f: $avg_temp_f, condition: $condition, date: $date, icon_url: $icon_url, max_temp_c: $max_temp_c, avg_temp_c: $avg_temp_c, chance_of_rain: $chance_of_rain, max_wind_kph: $max_wind_kph, max_wind_mph: $max_wind_mph, min_temp_c: $min_temp_c, sunrise: $sunrise, sunset: $sunset, max_temp_f: $max_temp_f, min_temp_f: $min_temp_f, will_it_rain: $will_it_rain)';
  }
...
class _$NowResponseData implements NowResponseData {
  ...
  @override
  String toString() {
    return 'NowResponse(location: $location, longitude: $longitude, region: $region, temp_f: $temp_f, wind_kph: $wind_kph, cloud: $cloud, humidity: $humidity, icon_url: $icon_url, temp_c: $temp_c, local_time: $local_time, wind_direction: $wind_direction, condition: $condition, country: $country, daytime: $daytime, feels_like_c: $feels_like_c, feels_like_f: $feels_like_f, latitude: $latitude, wind_mph: $wind_mph, timezone: $timezone, wind_degree: $wind_degree)';
  }
