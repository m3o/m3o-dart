...
class _$_Forecast implements _Forecast {
  ...
  @override
  String toString() {
    return 'Forecast(max_wind_kph: $max_wind_kph, will_it_rain: $will_it_rain, avg_temp_c: $avg_temp_c, avg_temp_f: $avg_temp_f, condition: $condition, date: $date, max_temp_c: $max_temp_c, max_temp_f: $max_temp_f, min_temp_c: $min_temp_c, sunrise: $sunrise, sunset: $sunset, chance_of_rain: $chance_of_rain, icon_url: $icon_url, max_wind_mph: $max_wind_mph, min_temp_f: $min_temp_f)';
  }
...
class _$NowResponseData implements NowResponseData {
  ...
  @override
  String toString() {
    return 'NowResponse(latitude: $latitude, temp_f: $temp_f, wind_degree: $wind_degree, wind_mph: $wind_mph, condition: $condition, country: $country, local_time: $local_time, feels_like_f: $feels_like_f, longitude: $longitude, wind_direction: $wind_direction, wind_kph: $wind_kph, cloud: $cloud, daytime: $daytime, feels_like_c: $feels_like_c, region: $region, temp_c: $temp_c, timezone: $timezone, humidity: $humidity, icon_url: $icon_url, location: $location)';
  }
