...
class _$_Forecast implements _Forecast {
  ...
  @override
  String toString() {
    return 'Forecast(avg_temp_c: $avg_temp_c, sunrise: $sunrise, will_it_rain: $will_it_rain, icon_url: $icon_url, max_temp_c: $max_temp_c, max_wind_kph: $max_wind_kph, min_temp_c: $min_temp_c, chance_of_rain: $chance_of_rain, condition: $condition, max_wind_mph: $max_wind_mph, min_temp_f: $min_temp_f, sunset: $sunset, avg_temp_f: $avg_temp_f, date: $date, max_temp_f: $max_temp_f)';
  }
...
class _$NowResponseData implements NowResponseData {
  ...
  @override
  String toString() {
    return 'NowResponse(feels_like_f: $feels_like_f, longitude: $longitude, wind_degree: $wind_degree, wind_mph: $wind_mph, cloud: $cloud, country: $country, daytime: $daytime, timezone: $timezone, wind_direction: $wind_direction, wind_kph: $wind_kph, feels_like_c: $feels_like_c, local_time: $local_time, temp_c: $temp_c, location: $location, temp_f: $temp_f, humidity: $humidity, icon_url: $icon_url, latitude: $latitude, condition: $condition, region: $region)';
  }
