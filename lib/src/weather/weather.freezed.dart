...
class _$_Forecast implements _Forecast {
  ...
  @override
  String toString() {
    return 'Forecast(max_temp_f: $max_temp_f, min_temp_c: $min_temp_c, sunrise: $sunrise, icon_url: $icon_url, min_temp_f: $min_temp_f, max_wind_kph: $max_wind_kph, date: $date, max_temp_c: $max_temp_c, sunset: $sunset, avg_temp_f: $avg_temp_f, chance_of_rain: $chance_of_rain, condition: $condition, max_wind_mph: $max_wind_mph, will_it_rain: $will_it_rain, avg_temp_c: $avg_temp_c)';
  }
...
class _$NowResponseData implements NowResponseData {
  ...
  @override
  String toString() {
    return 'NowResponse(temp_c: $temp_c, temp_f: $temp_f, timezone: $timezone, country: $country, local_time: $local_time, longitude: $longitude, wind_direction: $wind_direction, wind_kph: $wind_kph, region: $region, daytime: $daytime, feels_like_c: $feels_like_c, feels_like_f: $feels_like_f, humidity: $humidity, location: $location, wind_mph: $wind_mph, cloud: $cloud, condition: $condition, icon_url: $icon_url, latitude: $latitude, wind_degree: $wind_degree)';
  }
