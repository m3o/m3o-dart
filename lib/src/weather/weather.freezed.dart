...
class _$_Forecast implements _Forecast {
  ...
  @override
  String toString() {
    return 'Forecast(min_temp_c: $min_temp_c, chance_of_rain: $chance_of_rain, will_it_rain: $will_it_rain, avg_temp_c: $avg_temp_c, avg_temp_f: $avg_temp_f, condition: $condition, min_temp_f: $min_temp_f, sunset: $sunset, sunrise: $sunrise, date: $date, icon_url: $icon_url, max_temp_c: $max_temp_c, max_temp_f: $max_temp_f, max_wind_kph: $max_wind_kph, max_wind_mph: $max_wind_mph)';
  }
...
class _$NowResponseData implements NowResponseData {
  ...
  @override
  String toString() {
    return 'NowResponse(temp_c: $temp_c, timezone: $timezone, condition: $condition, country: $country, daytime: $daytime, feels_like_c: $feels_like_c, feels_like_f: $feels_like_f, icon_url: $icon_url, wind_direction: $wind_direction, wind_kph: $wind_kph, cloud: $cloud, wind_mph: $wind_mph, latitude: $latitude, local_time: $local_time, location: $location, longitude: $longitude, region: $region, temp_f: $temp_f, wind_degree: $wind_degree, humidity: $humidity)';
  }
