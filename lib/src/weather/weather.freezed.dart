...
class _$_Forecast implements _Forecast {
  ...
  @override
  String toString() {
    return 'Forecast(max_temp_f: $max_temp_f, max_wind_mph: $max_wind_mph, condition: $condition, max_temp_c: $max_temp_c, min_temp_c: $min_temp_c, min_temp_f: $min_temp_f, sunrise: $sunrise, sunset: $sunset, avg_temp_c: $avg_temp_c, chance_of_rain: $chance_of_rain, date: $date, max_wind_kph: $max_wind_kph, will_it_rain: $will_it_rain, avg_temp_f: $avg_temp_f, icon_url: $icon_url)';
  }
...
class _$NowResponseData implements NowResponseData {
  ...
  @override
  String toString() {
    return 'NowResponse(feels_like_c: $feels_like_c, icon_url: $icon_url, wind_kph: $wind_kph, region: $region, temp_f: $temp_f, timezone: $timezone, cloud: $cloud, daytime: $daytime, humidity: $humidity, latitude: $latitude, longitude: $longitude, wind_degree: $wind_degree, wind_direction: $wind_direction, local_time: $local_time, temp_c: $temp_c, condition: $condition, country: $country, feels_like_f: $feels_like_f, location: $location, wind_mph: $wind_mph)';
  }
