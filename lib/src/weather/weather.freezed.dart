...
class _$_Forecast implements _Forecast {
  ...
  @override
  String toString() {
    return 'Forecast(avg_temp_c: $avg_temp_c, condition: $condition, min_temp_c: $min_temp_c, icon_url: $icon_url, max_temp_f: $max_temp_f, sunrise: $sunrise, min_temp_f: $min_temp_f, sunset: $sunset, max_temp_c: $max_temp_c, max_wind_kph: $max_wind_kph, max_wind_mph: $max_wind_mph, will_it_rain: $will_it_rain, avg_temp_f: $avg_temp_f, chance_of_rain: $chance_of_rain, date: $date)';
  }
...
class _$NowResponseData implements NowResponseData {
  ...
  @override
  String toString() {
    return 'NowResponse(daytime: $daytime, feels_like_f: $feels_like_f, region: $region, wind_kph: $wind_kph, wind_mph: $wind_mph, longitude: $longitude, wind_direction: $wind_direction, temp_c: $temp_c, condition: $condition, country: $country, feels_like_c: $feels_like_c, humidity: $humidity, icon_url: $icon_url, latitude: $latitude, local_time: $local_time, temp_f: $temp_f, timezone: $timezone, wind_degree: $wind_degree, cloud: $cloud, location: $location)';
  }
