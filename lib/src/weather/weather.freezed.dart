...
class _$_Forecast implements _Forecast {
  ...
  @override
  String toString() {
    return 'Forecast(max_temp_c: $max_temp_c, sunrise: $sunrise, sunset: $sunset, avg_temp_c: $avg_temp_c, chance_of_rain: $chance_of_rain, max_wind_mph: $max_wind_mph, max_wind_kph: $max_wind_kph, min_temp_c: $min_temp_c, date: $date, icon_url: $icon_url, max_temp_f: $max_temp_f, min_temp_f: $min_temp_f, will_it_rain: $will_it_rain, avg_temp_f: $avg_temp_f, condition: $condition)';
  }
...
class _$NowResponseData implements NowResponseData {
  ...
  @override
  String toString() {
    return 'NowResponse(feels_like_c: $feels_like_c, feels_like_f: $feels_like_f, humidity: $humidity, cloud: $cloud, daytime: $daytime, wind_degree: $wind_degree, wind_kph: $wind_kph, country: $country, location: $location, temp_f: $temp_f, wind_mph: $wind_mph, icon_url: $icon_url, longitude: $longitude, local_time: $local_time, region: $region, temp_c: $temp_c, timezone: $timezone, wind_direction: $wind_direction, condition: $condition, latitude: $latitude)';
  }
