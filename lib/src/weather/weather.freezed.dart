...
class _$_Forecast implements _Forecast {
  ...
  @override
  String toString() {
    return 'Forecast(max_wind_mph: $max_wind_mph, min_temp_f: $min_temp_f, sunset: $sunset, sunrise: $sunrise, chance_of_rain: $chance_of_rain, condition: $condition, date: $date, max_temp_f: $max_temp_f, min_temp_c: $min_temp_c, will_it_rain: $will_it_rain, avg_temp_c: $avg_temp_c, icon_url: $icon_url, max_temp_c: $max_temp_c, max_wind_kph: $max_wind_kph, avg_temp_f: $avg_temp_f)';
  }
...
abstract class _Forecast implements Forecast {
  const factory _Forecast(
      ...
      final double? max_temp_c,
      final double? max_wind_kph,
      final double? avg_temp_f}) = _$_Forecast;
...
class _$NowResponseData implements NowResponseData {
  ...
  @override
  String toString() {
    return 'NowResponse(wind_kph: $wind_kph, wind_mph: $wind_mph, country: $country, feels_like_f: $feels_like_f, local_time: $local_time, region: $region, temp_c: $temp_c, cloud: $cloud, feels_like_c: $feels_like_c, humidity: $humidity, icon_url: $icon_url, latitude: $latitude, longitude: $longitude, temp_f: $temp_f, timezone: $timezone, wind_degree: $wind_degree, condition: $condition, daytime: $daytime, location: $location, wind_direction: $wind_direction)';
  }
...
abstract class NowResponseData implements NowResponse {
  const factory NowResponseData(
      ...
      final bool? daytime,
      final String? location,
      final String? wind_direction}) = _$NowResponseData;
