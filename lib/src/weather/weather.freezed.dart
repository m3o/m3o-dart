...
class _$_Forecast implements _Forecast {
  ...
  @override
  String toString() {
    return 'Forecast(max_temp_c: $max_temp_c, sunrise: $sunrise, avg_temp_c: $avg_temp_c, max_temp_f: $max_temp_f, max_wind_kph: $max_wind_kph, min_temp_c: $min_temp_c, avg_temp_f: $avg_temp_f, chance_of_rain: $chance_of_rain, date: $date, icon_url: $icon_url, min_temp_f: $min_temp_f, will_it_rain: $will_it_rain, condition: $condition, max_wind_mph: $max_wind_mph, sunset: $sunset)';
  }
...
class _$NowResponseData implements NowResponseData {
  ...
  @override
  String toString() {
    return 'NowResponse(daytime: $daytime, feels_like_f: $feels_like_f, wind_degree: $wind_degree, wind_mph: $wind_mph, cloud: $cloud, condition: $condition, local_time: $local_time, country: $country, feels_like_c: $feels_like_c, location: $location, longitude: $longitude, temp_c: $temp_c, timezone: $timezone, wind_direction: $wind_direction, wind_kph: $wind_kph, humidity: $humidity, icon_url: $icon_url, latitude: $latitude, region: $region, temp_f: $temp_f)';
  }
