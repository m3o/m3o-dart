...
class _$_Forecast implements _Forecast {
  ...
  @override
  String toString() {
    return 'Forecast(date: $date, icon_url: $icon_url, max_temp_c: $max_temp_c, max_wind_mph: $max_wind_mph, will_it_rain: $will_it_rain, avg_temp_c: $avg_temp_c, condition: $condition, min_temp_c: $min_temp_c, sunrise: $sunrise, sunset: $sunset, max_temp_f: $max_temp_f, max_wind_kph: $max_wind_kph, avg_temp_f: $avg_temp_f, min_temp_f: $min_temp_f, chance_of_rain: $chance_of_rain)';
  }
...
class _$NowResponseData implements NowResponseData {
  ...
  @override
  String toString() {
    return 'NowResponse(humidity: $humidity, local_time: $local_time, temp_c: $temp_c, timezone: $timezone, wind_degree: $wind_degree, country: $country, feels_like_c: $feels_like_c, latitude: $latitude, region: $region, temp_f: $temp_f, wind_direction: $wind_direction, wind_kph: $wind_kph, wind_mph: $wind_mph, cloud: $cloud, daytime: $daytime, longitude: $longitude, location: $location, condition: $condition, feels_like_f: $feels_like_f, icon_url: $icon_url)';
  }
