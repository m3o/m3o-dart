...
class _$_Forecast implements _Forecast {
  ...
  @override
  String toString() {
    return 'Forecast(max_temp_c: $max_temp_c, max_temp_f: $max_temp_f, max_wind_mph: $max_wind_mph, chance_of_rain: $chance_of_rain, min_temp_c: $min_temp_c, icon_url: $icon_url, sunrise: $sunrise, avg_temp_c: $avg_temp_c, avg_temp_f: $avg_temp_f, date: $date, sunset: $sunset, will_it_rain: $will_it_rain, condition: $condition, max_wind_kph: $max_wind_kph, min_temp_f: $min_temp_f)';
  }
...
class _$NowResponseData implements NowResponseData {
  ...
  @override
  String toString() {
    return 'NowResponse(cloud: $cloud, location: $location, wind_degree: $wind_degree, wind_direction: $wind_direction, daytime: $daytime, feels_like_f: $feels_like_f, humidity: $humidity, latitude: $latitude, longitude: $longitude, region: $region, temp_f: $temp_f, condition: $condition, country: $country, temp_c: $temp_c, timezone: $timezone, feels_like_c: $feels_like_c, icon_url: $icon_url, local_time: $local_time, wind_kph: $wind_kph, wind_mph: $wind_mph)';
  }
