...
class _$_Forecast implements _Forecast {
  ...
  @override
  String toString() {
    return 'Forecast(chance_of_rain: $chance_of_rain, max_temp_f: $max_temp_f, max_wind_mph: $max_wind_mph, avg_temp_f: $avg_temp_f, min_temp_c: $min_temp_c, will_it_rain: $will_it_rain, max_temp_c: $max_temp_c, max_wind_kph: $max_wind_kph, avg_temp_c: $avg_temp_c, date: $date, icon_url: $icon_url, min_temp_f: $min_temp_f, sunrise: $sunrise, sunset: $sunset, condition: $condition)';
  }
...
class _$NowResponseData implements NowResponseData {
  ...
  @override
  String toString() {
    return 'NowResponse(condition: $condition, country: $country, location: $location, longitude: $longitude, timezone: $timezone, wind_degree: $wind_degree, wind_direction: $wind_direction, wind_kph: $wind_kph, daytime: $daytime, feels_like_c: $feels_like_c, humidity: $humidity, latitude: $latitude, temp_f: $temp_f, feels_like_f: $feels_like_f, icon_url: $icon_url, temp_c: $temp_c, cloud: $cloud, local_time: $local_time, region: $region, wind_mph: $wind_mph)';
  }
