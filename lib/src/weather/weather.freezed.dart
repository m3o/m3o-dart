...
class _$_Forecast implements _Forecast {
  ...
  @override
  String toString() {
    return 'Forecast(avg_temp_c: $avg_temp_c, max_temp_c: $max_temp_c, max_temp_f: $max_temp_f, max_wind_kph: $max_wind_kph, max_wind_mph: $max_wind_mph, min_temp_c: $min_temp_c, will_it_rain: $will_it_rain, avg_temp_f: $avg_temp_f, condition: $condition, icon_url: $icon_url, min_temp_f: $min_temp_f, chance_of_rain: $chance_of_rain, date: $date, sunrise: $sunrise, sunset: $sunset)';
  }
...
class _$NowResponseData implements NowResponseData {
  ...
  @override
  String toString() {
    return 'NowResponse(wind_mph: $wind_mph, condition: $condition, icon_url: $icon_url, local_time: $local_time, longitude: $longitude, latitude: $latitude, location: $location, timezone: $timezone, wind_degree: $wind_degree, cloud: $cloud, country: $country, daytime: $daytime, temp_c: $temp_c, temp_f: $temp_f, wind_direction: $wind_direction, wind_kph: $wind_kph, feels_like_c: $feels_like_c, feels_like_f: $feels_like_f, humidity: $humidity, region: $region)';
  }
