...
class _$_Forecast implements _Forecast {
  ...
  @override
  String toString() {
    return 'Forecast(condition: $condition, max_temp_c: $max_temp_c, sunset: $sunset, will_it_rain: $will_it_rain, avg_temp_f: $avg_temp_f, max_wind_mph: $max_wind_mph, min_temp_c: $min_temp_c, min_temp_f: $min_temp_f, max_wind_kph: $max_wind_kph, chance_of_rain: $chance_of_rain, avg_temp_c: $avg_temp_c, icon_url: $icon_url, max_temp_f: $max_temp_f, sunrise: $sunrise, date: $date)';
  }
...
class _$NowResponseData implements NowResponseData {
  ...
  @override
  String toString() {
    return 'NowResponse(country: $country, feels_like_c: $feels_like_c, feels_like_f: $feels_like_f, temp_f: $temp_f, wind_direction: $wind_direction, condition: $condition, humidity: $humidity, local_time: $local_time, location: $location, region: $region, cloud: $cloud, daytime: $daytime, icon_url: $icon_url, wind_kph: $wind_kph, wind_mph: $wind_mph, latitude: $latitude, longitude: $longitude, temp_c: $temp_c, timezone: $timezone, wind_degree: $wind_degree)';
  }
