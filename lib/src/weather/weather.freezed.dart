...
class _$_Forecast implements _Forecast {
  ...
  @override
  String toString() {
    return 'Forecast(icon_url: $icon_url, avg_temp_c: $avg_temp_c, avg_temp_f: $avg_temp_f, chance_of_rain: $chance_of_rain, date: $date, max_temp_f: $max_temp_f, max_wind_kph: $max_wind_kph, min_temp_c: $min_temp_c, condition: $condition, min_temp_f: $min_temp_f, sunrise: $sunrise, will_it_rain: $will_it_rain, max_temp_c: $max_temp_c, max_wind_mph: $max_wind_mph, sunset: $sunset)';
  }
...
class _$NowResponseData implements NowResponseData {
  ...
  @override
  String toString() {
    return 'NowResponse(timezone: $timezone, wind_degree: $wind_degree, condition: $condition, country: $country, temp_f: $temp_f, location: $location, region: $region, wind_mph: $wind_mph, longitude: $longitude, temp_c: $temp_c, wind_direction: $wind_direction, feels_like_c: $feels_like_c, humidity: $humidity, local_time: $local_time, icon_url: $icon_url, latitude: $latitude, wind_kph: $wind_kph, cloud: $cloud, daytime: $daytime, feels_like_f: $feels_like_f)';
  }
