...
class _$_Forecast implements _Forecast {
  ...
  @override
  String toString() {
    return 'Forecast(min_temp_c: $min_temp_c, sunrise: $sunrise, avg_temp_f: $avg_temp_f, date: $date, max_temp_c: $max_temp_c, max_wind_mph: $max_wind_mph, avg_temp_c: $avg_temp_c, icon_url: $icon_url, sunset: $sunset, will_it_rain: $will_it_rain, max_wind_kph: $max_wind_kph, chance_of_rain: $chance_of_rain, condition: $condition, max_temp_f: $max_temp_f, min_temp_f: $min_temp_f)';
  }
...
class _$NowResponseData implements NowResponseData {
  ...
  @override
  String toString() {
    return 'NowResponse(humidity: $humidity, country: $country, location: $location, longitude: $longitude, temp_f: $temp_f, wind_mph: $wind_mph, wind_degree: $wind_degree, condition: $condition, daytime: $daytime, feels_like_f: $feels_like_f, icon_url: $icon_url, latitude: $latitude, temp_c: $temp_c, timezone: $timezone, wind_direction: $wind_direction, cloud: $cloud, feels_like_c: $feels_like_c, local_time: $local_time, region: $region, wind_kph: $wind_kph)';
  }
