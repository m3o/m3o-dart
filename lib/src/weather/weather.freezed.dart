...
class _$_Forecast implements _Forecast {
  ...
  @override
  String toString() {
    return 'Forecast(avg_temp_f: $avg_temp_f, condition: $condition, max_temp_f: $max_temp_f, max_wind_mph: $max_wind_mph, min_temp_f: $min_temp_f, avg_temp_c: $avg_temp_c, date: $date, icon_url: $icon_url, max_temp_c: $max_temp_c, max_wind_kph: $max_wind_kph, will_it_rain: $will_it_rain, chance_of_rain: $chance_of_rain, sunset: $sunset, min_temp_c: $min_temp_c, sunrise: $sunrise)';
  }
...
class _$NowResponseData implements NowResponseData {
  ...
  @override
  String toString() {
    return 'NowResponse(country: $country, humidity: $humidity, local_time: $local_time, wind_direction: $wind_direction, cloud: $cloud, feels_like_f: $feels_like_f, longitude: $longitude, region: $region, temp_c: $temp_c, temp_f: $temp_f, wind_kph: $wind_kph, daytime: $daytime, icon_url: $icon_url, latitude: $latitude, location: $location, timezone: $timezone, condition: $condition, wind_degree: $wind_degree, wind_mph: $wind_mph, feels_like_c: $feels_like_c)';
  }
