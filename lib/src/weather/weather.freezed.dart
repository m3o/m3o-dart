...
class _$_Forecast implements _Forecast {
  ...
  @override
  String toString() {
    return 'Forecast(chance_of_rain: $chance_of_rain, max_wind_mph: $max_wind_mph, min_temp_f: $min_temp_f, avg_temp_f: $avg_temp_f, max_temp_c: $max_temp_c, min_temp_c: $min_temp_c, sunset: $sunset, will_it_rain: $will_it_rain, avg_temp_c: $avg_temp_c, date: $date, icon_url: $icon_url, max_temp_f: $max_temp_f, sunrise: $sunrise, condition: $condition, max_wind_kph: $max_wind_kph)';
  }
...
class _$NowResponseData implements NowResponseData {
  ...
  @override
  String toString() {
    return 'NowResponse(humidity: $humidity, icon_url: $icon_url, wind_mph: $wind_mph, cloud: $cloud, feels_like_f: $feels_like_f, latitude: $latitude, longitude: $longitude, temp_c: $temp_c, wind_degree: $wind_degree, daytime: $daytime, feels_like_c: $feels_like_c, region: $region, wind_direction: $wind_direction, wind_kph: $wind_kph, condition: $condition, country: $country, local_time: $local_time, location: $location, temp_f: $temp_f, timezone: $timezone)';
  }
