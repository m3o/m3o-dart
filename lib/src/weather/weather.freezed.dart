...
class _$_Forecast implements _Forecast {
  ...
  @override
  String toString() {
    return 'Forecast(max_wind_kph: $max_wind_kph, max_wind_mph: $max_wind_mph, will_it_rain: $will_it_rain, avg_temp_c: $avg_temp_c, chance_of_rain: $chance_of_rain, sunset: $sunset, min_temp_f: $min_temp_f, date: $date, max_temp_f: $max_temp_f, min_temp_c: $min_temp_c, max_temp_c: $max_temp_c, sunrise: $sunrise, avg_temp_f: $avg_temp_f, condition: $condition, icon_url: $icon_url)';
  }
...
class _$NowResponseData implements NowResponseData {
  ...
  @override
  String toString() {
    return 'NowResponse(feels_like_c: $feels_like_c, icon_url: $icon_url, local_time: $local_time, temp_f: $temp_f, timezone: $timezone, country: $country, latitude: $latitude, wind_degree: $wind_degree, wind_direction: $wind_direction, wind_kph: $wind_kph, feels_like_f: $feels_like_f, humidity: $humidity, longitude: $longitude, cloud: $cloud, condition: $condition, daytime: $daytime, location: $location, region: $region, temp_c: $temp_c, wind_mph: $wind_mph)';
  }
