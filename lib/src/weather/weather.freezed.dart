...
class _$_Forecast implements _Forecast {
  ...
  @override
  String toString() {
    return 'Forecast(avg_temp_f: $avg_temp_f, max_temp_f: $max_temp_f, max_wind_kph: $max_wind_kph, max_wind_mph: $max_wind_mph, sunrise: $sunrise, sunset: $sunset, avg_temp_c: $avg_temp_c, max_temp_c: $max_temp_c, min_temp_f: $min_temp_f, chance_of_rain: $chance_of_rain, min_temp_c: $min_temp_c, condition: $condition, date: $date, icon_url: $icon_url, will_it_rain: $will_it_rain)';
  }
...
class _$NowResponseData implements NowResponseData {
  ...
  @override
  String toString() {
    return 'NowResponse(condition: $condition, feels_like_c: $feels_like_c, longitude: $longitude, temp_c: $temp_c, wind_direction: $wind_direction, cloud: $cloud, region: $region, temp_f: $temp_f, wind_degree: $wind_degree, country: $country, feels_like_f: $feels_like_f, humidity: $humidity, latitude: $latitude, wind_kph: $wind_kph, daytime: $daytime, local_time: $local_time, location: $location, timezone: $timezone, wind_mph: $wind_mph, icon_url: $icon_url)';
  }
