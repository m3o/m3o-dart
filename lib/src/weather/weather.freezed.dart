...
class _$_Forecast implements _Forecast {
  ...
  @override
  String toString() {
    return 'Forecast(avg_temp_f: $avg_temp_f, condition: $condition, max_wind_kph: $max_wind_kph, min_temp_c: $min_temp_c, chance_of_rain: $chance_of_rain, date: $date, icon_url: $icon_url, max_temp_f: $max_temp_f, max_wind_mph: $max_wind_mph, min_temp_f: $min_temp_f, sunrise: $sunrise, avg_temp_c: $avg_temp_c, sunset: $sunset, max_temp_c: $max_temp_c, will_it_rain: $will_it_rain)';
  }
...
class _$NowResponseData implements NowResponseData {
  ...
  @override
  String toString() {
    return 'NowResponse(country: $country, feels_like_c: $feels_like_c, local_time: $local_time, wind_mph: $wind_mph, daytime: $daytime, feels_like_f: $feels_like_f, wind_direction: $wind_direction, wind_kph: $wind_kph, condition: $condition, icon_url: $icon_url, latitude: $latitude, temp_c: $temp_c, timezone: $timezone, wind_degree: $wind_degree, cloud: $cloud, humidity: $humidity, location: $location, longitude: $longitude, region: $region, temp_f: $temp_f)';
  }
