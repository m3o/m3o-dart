...
class _$_Forecast implements _Forecast {
  ...
  @override
  String toString() {
    return 'Forecast(avg_temp_c: $avg_temp_c, avg_temp_f: $avg_temp_f, date: $date, min_temp_f: $min_temp_f, will_it_rain: $will_it_rain, chance_of_rain: $chance_of_rain, icon_url: $icon_url, max_wind_kph: $max_wind_kph, max_wind_mph: $max_wind_mph, sunset: $sunset, condition: $condition, max_temp_c: $max_temp_c, max_temp_f: $max_temp_f, min_temp_c: $min_temp_c, sunrise: $sunrise)';
  }
...
class _$NowResponseData implements NowResponseData {
  ...
  @override
  String toString() {
    return 'NowResponse(cloud: $cloud, humidity: $humidity, timezone: $timezone, local_time: $local_time, longitude: $longitude, region: $region, temp_f: $temp_f, condition: $condition, country: $country, feels_like_f: $feels_like_f, icon_url: $icon_url, wind_degree: $wind_degree, wind_kph: $wind_kph, wind_mph: $wind_mph, daytime: $daytime, feels_like_c: $feels_like_c, location: $location, temp_c: $temp_c, latitude: $latitude, wind_direction: $wind_direction)';
  }
