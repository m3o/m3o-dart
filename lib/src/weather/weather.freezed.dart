...
class _$_Forecast implements _Forecast {
  ...
  @override
  String toString() {
    return 'Forecast(condition: $condition, min_temp_c: $min_temp_c, sunrise: $sunrise, will_it_rain: $will_it_rain, avg_temp_c: $avg_temp_c, chance_of_rain: $chance_of_rain, icon_url: $icon_url, max_wind_kph: $max_wind_kph, max_temp_c: $max_temp_c, max_temp_f: $max_temp_f, sunset: $sunset, avg_temp_f: $avg_temp_f, date: $date, max_wind_mph: $max_wind_mph, min_temp_f: $min_temp_f)';
  }
...
class _$NowResponseData implements NowResponseData {
  ...
  @override
  String toString() {
    return 'NowResponse(wind_direction: $wind_direction, wind_mph: $wind_mph, country: $country, feels_like_c: $feels_like_c, longitude: $longitude, region: $region, temp_f: $temp_f, temp_c: $temp_c, timezone: $timezone, daytime: $daytime, humidity: $humidity, latitude: $latitude, local_time: $local_time, location: $location, wind_kph: $wind_kph, cloud: $cloud, condition: $condition, feels_like_f: $feels_like_f, icon_url: $icon_url, wind_degree: $wind_degree)';
  }
