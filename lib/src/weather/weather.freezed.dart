...
class _$_Forecast implements _Forecast {
  ...
  @override
  String toString() {
    return 'Forecast(icon_url: $icon_url, will_it_rain: $will_it_rain, condition: $condition, avg_temp_c: $avg_temp_c, avg_temp_f: $avg_temp_f, max_temp_f: $max_temp_f, min_temp_f: $min_temp_f, sunrise: $sunrise, date: $date, max_temp_c: $max_temp_c, max_wind_mph: $max_wind_mph, min_temp_c: $min_temp_c, sunset: $sunset, chance_of_rain: $chance_of_rain, max_wind_kph: $max_wind_kph)';
  }
...
class _$NowResponseData implements NowResponseData {
  ...
  @override
  String toString() {
    return 'NowResponse(country: $country, temp_f: $temp_f, timezone: $timezone, wind_degree: $wind_degree, cloud: $cloud, icon_url: $icon_url, latitude: $latitude, temp_c: $temp_c, wind_mph: $wind_mph, longitude: $longitude, region: $region, condition: $condition, daytime: $daytime, feels_like_c: $feels_like_c, humidity: $humidity, local_time: $local_time, feels_like_f: $feels_like_f, location: $location, wind_direction: $wind_direction, wind_kph: $wind_kph)';
  }
