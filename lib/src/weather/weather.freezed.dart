...
class _$_Forecast implements _Forecast {
  ...
  @override
  String toString() {
    return 'Forecast(date: $date, condition: $condition, max_temp_c: $max_temp_c, max_wind_kph: $max_wind_kph, max_wind_mph: $max_wind_mph, min_temp_f: $min_temp_f, sunrise: $sunrise, sunset: $sunset, will_it_rain: $will_it_rain, icon_url: $icon_url, chance_of_rain: $chance_of_rain, min_temp_c: $min_temp_c, avg_temp_c: $avg_temp_c, max_temp_f: $max_temp_f, avg_temp_f: $avg_temp_f)';
  }
...
class _$NowResponseData implements NowResponseData {
  ...
  @override
  String toString() {
    return 'NowResponse(temp_c: $temp_c, timezone: $timezone, wind_degree: $wind_degree, condition: $condition, feels_like_c: $feels_like_c, feels_like_f: $feels_like_f, location: $location, cloud: $cloud, icon_url: $icon_url, latitude: $latitude, longitude: $longitude, country: $country, daytime: $daytime, humidity: $humidity, wind_kph: $wind_kph, wind_mph: $wind_mph, local_time: $local_time, region: $region, temp_f: $temp_f, wind_direction: $wind_direction)';
  }
