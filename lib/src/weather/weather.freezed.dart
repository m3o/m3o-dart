...
class _$_Forecast implements _Forecast {
  ...
  @override
  String toString() {
    return 'Forecast(max_temp_c: $max_temp_c, avg_temp_f: $avg_temp_f, condition: $condition, icon_url: $icon_url, max_wind_kph: $max_wind_kph, max_wind_mph: $max_wind_mph, max_temp_f: $max_temp_f, min_temp_c: $min_temp_c, min_temp_f: $min_temp_f, sunrise: $sunrise, avg_temp_c: $avg_temp_c, chance_of_rain: $chance_of_rain, date: $date, sunset: $sunset, will_it_rain: $will_it_rain)';
  }
...
class _$NowResponseData implements NowResponseData {
  ...
  @override
  String toString() {
    return 'NowResponse(cloud: $cloud, condition: $condition, feels_like_c: $feels_like_c, local_time: $local_time, timezone: $timezone, wind_kph: $wind_kph, wind_mph: $wind_mph, country: $country, feels_like_f: $feels_like_f, humidity: $humidity, location: $location, longitude: $longitude, region: $region, temp_f: $temp_f, wind_direction: $wind_direction, icon_url: $icon_url, latitude: $latitude, wind_degree: $wind_degree, daytime: $daytime, temp_c: $temp_c)';
  }
