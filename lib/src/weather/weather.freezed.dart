...
class _$_Forecast implements _Forecast {
  ...
  @override
  String toString() {
    return 'Forecast(avg_temp_c: $avg_temp_c, chance_of_rain: $chance_of_rain, max_temp_c: $max_temp_c, sunrise: $sunrise, avg_temp_f: $avg_temp_f, max_wind_mph: $max_wind_mph, min_temp_c: $min_temp_c, condition: $condition, icon_url: $icon_url, max_temp_f: $max_temp_f, min_temp_f: $min_temp_f, sunset: $sunset, date: $date, max_wind_kph: $max_wind_kph, will_it_rain: $will_it_rain)';
  }
...
class _$NowResponseData implements NowResponseData {
  ...
  @override
  String toString() {
    return 'NowResponse(feels_like_f: $feels_like_f, latitude: $latitude, location: $location, temp_f: $temp_f, timezone: $timezone, country: $country, local_time: $local_time, temp_c: $temp_c, wind_kph: $wind_kph, wind_mph: $wind_mph, icon_url: $icon_url, daytime: $daytime, feels_like_c: $feels_like_c, humidity: $humidity, longitude: $longitude, region: $region, wind_direction: $wind_direction, cloud: $cloud, wind_degree: $wind_degree, condition: $condition)';
  }
