...
class _$_Forecast implements _Forecast {
  ...
  @override
  String toString() {
    return 'Forecast(chance_of_rain: $chance_of_rain, min_temp_c: $min_temp_c, condition: $condition, icon_url: $icon_url, max_wind_kph: $max_wind_kph, max_temp_c: $max_temp_c, max_temp_f: $max_temp_f, min_temp_f: $min_temp_f, will_it_rain: $will_it_rain, avg_temp_c: $avg_temp_c, avg_temp_f: $avg_temp_f, date: $date, max_wind_mph: $max_wind_mph, sunrise: $sunrise, sunset: $sunset)';
  }
...
class _$NowResponseData implements NowResponseData {
  ...
  @override
  String toString() {
    return 'NowResponse(country: $country, icon_url: $icon_url, latitude: $latitude, longitude: $longitude, wind_degree: $wind_degree, wind_mph: $wind_mph, cloud: $cloud, local_time: $local_time, location: $location, temp_c: $temp_c, wind_kph: $wind_kph, condition: $condition, daytime: $daytime, region: $region, temp_f: $temp_f, wind_direction: $wind_direction, feels_like_c: $feels_like_c, feels_like_f: $feels_like_f, humidity: $humidity, timezone: $timezone)';
  }
