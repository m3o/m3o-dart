...
class _$_Forecast implements _Forecast {
  ...
  @override
  String toString() {
    return 'Forecast(chance_of_rain: $chance_of_rain, max_temp_c: $max_temp_c, condition: $condition, max_wind_kph: $max_wind_kph, sunset: $sunset, min_temp_f: $min_temp_f, avg_temp_c: $avg_temp_c, icon_url: $icon_url, max_wind_mph: $max_wind_mph, min_temp_c: $min_temp_c, will_it_rain: $will_it_rain, avg_temp_f: $avg_temp_f, date: $date, max_temp_f: $max_temp_f, sunrise: $sunrise)';
  }
...
class _$NowResponseData implements NowResponseData {
  ...
  @override
  String toString() {
    return 'NowResponse(cloud: $cloud, region: $region, temp_f: $temp_f, feels_like_c: $feels_like_c, feels_like_f: $feels_like_f, local_time: $local_time, location: $location, timezone: $timezone, wind_kph: $wind_kph, condition: $condition, humidity: $humidity, icon_url: $icon_url, latitude: $latitude, longitude: $longitude, wind_degree: $wind_degree, country: $country, daytime: $daytime, temp_c: $temp_c, wind_direction: $wind_direction, wind_mph: $wind_mph)';
  }
