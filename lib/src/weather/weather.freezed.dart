...
class _$_Forecast implements _Forecast {
  ...
  @override
  String toString() {
    return 'Forecast(max_temp_f: $max_temp_f, sunset: $sunset, chance_of_rain: $chance_of_rain, condition: $condition, icon_url: $icon_url, max_wind_mph: $max_wind_mph, min_temp_f: $min_temp_f, date: $date, max_wind_kph: $max_wind_kph, min_temp_c: $min_temp_c, sunrise: $sunrise, will_it_rain: $will_it_rain, avg_temp_c: $avg_temp_c, avg_temp_f: $avg_temp_f, max_temp_c: $max_temp_c)';
  }
...
class _$NowResponseData implements NowResponseData {
  ...
  @override
  String toString() {
    return 'NowResponse(condition: $condition, country: $country, wind_mph: $wind_mph, cloud: $cloud, daytime: $daytime, feels_like_c: $feels_like_c, humidity: $humidity, icon_url: $icon_url, local_time: $local_time, timezone: $timezone, latitude: $latitude, location: $location, longitude: $longitude, wind_kph: $wind_kph, feels_like_f: $feels_like_f, region: $region, temp_c: $temp_c, temp_f: $temp_f, wind_degree: $wind_degree, wind_direction: $wind_direction)';
  }
