...
class _$_Forecast implements _Forecast {
  ...
  @override
  String toString() {
    return 'Forecast(avg_temp_f: $avg_temp_f, chance_of_rain: $chance_of_rain, icon_url: $icon_url, max_temp_c: $max_temp_c, sunset: $sunset, condition: $condition, max_wind_kph: $max_wind_kph, max_wind_mph: $max_wind_mph, min_temp_f: $min_temp_f, avg_temp_c: $avg_temp_c, date: $date, max_temp_f: $max_temp_f, will_it_rain: $will_it_rain, min_temp_c: $min_temp_c, sunrise: $sunrise)';
  }
...
class _$NowResponseData implements NowResponseData {
  ...
  @override
  String toString() {
    return 'NowResponse(cloud: $cloud, condition: $condition, local_time: $local_time, region: $region, temp_c: $temp_c, wind_mph: $wind_mph, wind_kph: $wind_kph, feels_like_c: $feels_like_c, humidity: $humidity, icon_url: $icon_url, location: $location, longitude: $longitude, wind_degree: $wind_degree, country: $country, latitude: $latitude, temp_f: $temp_f, timezone: $timezone, daytime: $daytime, feels_like_f: $feels_like_f, wind_direction: $wind_direction)';
  }
