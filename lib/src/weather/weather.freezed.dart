...
class _$_Forecast implements _Forecast {
  ...
  @override
  String toString() {
    return 'Forecast(avg_temp_c: $avg_temp_c, avg_temp_f: $avg_temp_f, icon_url: $icon_url, max_temp_f: $max_temp_f, max_wind_kph: $max_wind_kph, sunrise: $sunrise, condition: $condition, max_wind_mph: $max_wind_mph, sunset: $sunset, chance_of_rain: $chance_of_rain, min_temp_c: $min_temp_c, will_it_rain: $will_it_rain, date: $date, max_temp_c: $max_temp_c, min_temp_f: $min_temp_f)';
  }
...
class _$NowResponseData implements NowResponseData {
  ...
  @override
  String toString() {
    return 'NowResponse(condition: $condition, feels_like_f: $feels_like_f, wind_direction: $wind_direction, timezone: $timezone, wind_degree: $wind_degree, wind_mph: $wind_mph, cloud: $cloud, country: $country, humidity: $humidity, longitude: $longitude, region: $region, latitude: $latitude, local_time: $local_time, temp_c: $temp_c, temp_f: $temp_f, daytime: $daytime, feels_like_c: $feels_like_c, icon_url: $icon_url, location: $location, wind_kph: $wind_kph)';
  }
