...
class _$_Forecast implements _Forecast {
  ...
  @override
  String toString() {
    return 'Forecast(avg_temp_c: $avg_temp_c, avg_temp_f: $avg_temp_f, icon_url: $icon_url, max_temp_f: $max_temp_f, max_wind_kph: $max_wind_kph, max_wind_mph: $max_wind_mph, max_temp_c: $max_temp_c, will_it_rain: $will_it_rain, condition: $condition, date: $date, min_temp_f: $min_temp_f, sunset: $sunset, chance_of_rain: $chance_of_rain, min_temp_c: $min_temp_c, sunrise: $sunrise)';
  }
...
class _$NowResponseData implements NowResponseData {
  ...
  @override
  String toString() {
    return 'NowResponse(wind_degree: $wind_degree, cloud: $cloud, condition: $condition, humidity: $humidity, latitude: $latitude, location: $location, temp_f: $temp_f, timezone: $timezone, feels_like_f: $feels_like_f, region: $region, wind_mph: $wind_mph, country: $country, daytime: $daytime, feels_like_c: $feels_like_c, wind_direction: $wind_direction, wind_kph: $wind_kph, icon_url: $icon_url, local_time: $local_time, longitude: $longitude, temp_c: $temp_c)';
  }
