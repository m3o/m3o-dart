...
class _$_Forecast implements _Forecast {
  ...
  @override
  String toString() {
    return 'Forecast(avg_temp_c: $avg_temp_c, chance_of_rain: $chance_of_rain, max_temp_f: $max_temp_f, condition: $condition, date: $date, min_temp_f: $min_temp_f, sunset: $sunset, will_it_rain: $will_it_rain, max_wind_mph: $max_wind_mph, min_temp_c: $min_temp_c, avg_temp_f: $avg_temp_f, icon_url: $icon_url, max_temp_c: $max_temp_c, max_wind_kph: $max_wind_kph, sunrise: $sunrise)';
  }
...
class _$NowResponseData implements NowResponseData {
  ...
  @override
  String toString() {
    return 'NowResponse(cloud: $cloud, location: $location, timezone: $timezone, feels_like_c: $feels_like_c, region: $region, temp_c: $temp_c, temp_f: $temp_f, humidity: $humidity, icon_url: $icon_url, local_time: $local_time, wind_degree: $wind_degree, wind_mph: $wind_mph, wind_direction: $wind_direction, wind_kph: $wind_kph, condition: $condition, country: $country, daytime: $daytime, feels_like_f: $feels_like_f, latitude: $latitude, longitude: $longitude)';
  }
