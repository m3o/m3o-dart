...
class _$_Forecast implements _Forecast {
  ...
  @override
  String toString() {
    return 'Forecast(min_temp_f: $min_temp_f, sunset: $sunset, date: $date, icon_url: $icon_url, max_wind_kph: $max_wind_kph, will_it_rain: $will_it_rain, condition: $condition, max_temp_c: $max_temp_c, sunrise: $sunrise, max_temp_f: $max_temp_f, avg_temp_c: $avg_temp_c, avg_temp_f: $avg_temp_f, chance_of_rain: $chance_of_rain, max_wind_mph: $max_wind_mph, min_temp_c: $min_temp_c)';
  }
...
class _$NowResponseData implements NowResponseData {
  ...
  @override
  String toString() {
    return 'NowResponse(temp_f: $temp_f, wind_kph: $wind_kph, cloud: $cloud, country: $country, daytime: $daytime, feels_like_c: $feels_like_c, region: $region, wind_direction: $wind_direction, wind_mph: $wind_mph, feels_like_f: $feels_like_f, latitude: $latitude, local_time: $local_time, location: $location, timezone: $timezone, condition: $condition, humidity: $humidity, icon_url: $icon_url, longitude: $longitude, temp_c: $temp_c, wind_degree: $wind_degree)';
  }
