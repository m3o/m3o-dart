...
class _$_Forecast implements _Forecast {
  ...
  @override
  String toString() {
    return 'Forecast(chance_of_rain: $chance_of_rain, max_temp_c: $max_temp_c, sunrise: $sunrise, max_wind_mph: $max_wind_mph, min_temp_c: $min_temp_c, min_temp_f: $min_temp_f, avg_temp_f: $avg_temp_f, date: $date, icon_url: $icon_url, sunset: $sunset, avg_temp_c: $avg_temp_c, condition: $condition, max_temp_f: $max_temp_f, max_wind_kph: $max_wind_kph, will_it_rain: $will_it_rain)';
  }
...
class _$NowResponseData implements NowResponseData {
  ...
  @override
  String toString() {
    return 'NowResponse(region: $region, temp_f: $temp_f, wind_degree: $wind_degree, wind_direction: $wind_direction, wind_mph: $wind_mph, cloud: $cloud, condition: $condition, location: $location, feels_like_c: $feels_like_c, feels_like_f: $feels_like_f, wind_kph: $wind_kph, country: $country, latitude: $latitude, temp_c: $temp_c, local_time: $local_time, longitude: $longitude, timezone: $timezone, daytime: $daytime, humidity: $humidity, icon_url: $icon_url)';
  }
