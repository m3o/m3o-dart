...
class _$_Forecast implements _Forecast {
  ...
  @override
  String toString() {
    return 'Forecast(sunset: $sunset, max_temp_c: $max_temp_c, max_wind_kph: $max_wind_kph, will_it_rain: $will_it_rain, min_temp_f: $min_temp_f, sunrise: $sunrise, chance_of_rain: $chance_of_rain, condition: $condition, date: $date, icon_url: $icon_url, max_temp_f: $max_temp_f, min_temp_c: $min_temp_c, avg_temp_c: $avg_temp_c, avg_temp_f: $avg_temp_f, max_wind_mph: $max_wind_mph)';
  }
...
class _$NowResponseData implements NowResponseData {
  ...
  @override
  String toString() {
    return 'NowResponse(temp_f: $temp_f, wind_kph: $wind_kph, wind_mph: $wind_mph, cloud: $cloud, icon_url: $icon_url, latitude: $latitude, local_time: $local_time, location: $location, daytime: $daytime, humidity: $humidity, longitude: $longitude, timezone: $timezone, region: $region, temp_c: $temp_c, wind_direction: $wind_direction, condition: $condition, country: $country, feels_like_c: $feels_like_c, feels_like_f: $feels_like_f, wind_degree: $wind_degree)';
  }
