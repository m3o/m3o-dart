...
class _$_Forecast implements _Forecast {
  ...
  @override
  String toString() {
    return 'Forecast(condition: $condition, max_temp_c: $max_temp_c, max_temp_f: $max_temp_f, max_wind_mph: $max_wind_mph, min_temp_f: $min_temp_f, will_it_rain: $will_it_rain, chance_of_rain: $chance_of_rain, date: $date, sunrise: $sunrise, avg_temp_c: $avg_temp_c, avg_temp_f: $avg_temp_f, icon_url: $icon_url, max_wind_kph: $max_wind_kph, min_temp_c: $min_temp_c, sunset: $sunset)';
  }
...
class _$NowResponseData implements NowResponseData {
  ...
  @override
  String toString() {
    return 'NowResponse(wind_degree: $wind_degree, country: $country, feels_like_c: $feels_like_c, temp_c: $temp_c, condition: $condition, daytime: $daytime, region: $region, icon_url: $icon_url, local_time: $local_time, longitude: $longitude, temp_f: $temp_f, wind_mph: $wind_mph, cloud: $cloud, feels_like_f: $feels_like_f, humidity: $humidity, wind_direction: $wind_direction, wind_kph: $wind_kph, latitude: $latitude, location: $location, timezone: $timezone)';
  }
