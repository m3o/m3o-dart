...
class _$_Forecast implements _Forecast {
  ...
  @override
  String toString() {
    return 'Forecast(max_temp_f: $max_temp_f, max_wind_mph: $max_wind_mph, min_temp_c: $min_temp_c, sunset: $sunset, will_it_rain: $will_it_rain, icon_url: $icon_url, max_temp_c: $max_temp_c, date: $date, max_wind_kph: $max_wind_kph, sunrise: $sunrise, avg_temp_c: $avg_temp_c, avg_temp_f: $avg_temp_f, chance_of_rain: $chance_of_rain, condition: $condition, min_temp_f: $min_temp_f)';
  }
...
class _$NowResponseData implements NowResponseData {
  ...
  @override
  String toString() {
    return 'NowResponse(country: $country, icon_url: $icon_url, longitude: $longitude, region: $region, condition: $condition, feels_like_c: $feels_like_c, humidity: $humidity, latitude: $latitude, location: $location, wind_degree: $wind_degree, wind_direction: $wind_direction, cloud: $cloud, daytime: $daytime, wind_mph: $wind_mph, feels_like_f: $feels_like_f, local_time: $local_time, temp_c: $temp_c, temp_f: $temp_f, timezone: $timezone, wind_kph: $wind_kph)';
  }
