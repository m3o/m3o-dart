...
class _$_Forecast implements _Forecast {
  ...
  @override
  String toString() {
    return 'Forecast(date: $date, max_wind_kph: $max_wind_kph, min_temp_c: $min_temp_c, min_temp_f: $min_temp_f, avg_temp_c: $avg_temp_c, avg_temp_f: $avg_temp_f, icon_url: $icon_url, max_temp_c: $max_temp_c, sunrise: $sunrise, sunset: $sunset, will_it_rain: $will_it_rain, chance_of_rain: $chance_of_rain, condition: $condition, max_temp_f: $max_temp_f, max_wind_mph: $max_wind_mph)';
  }
...
class _$NowResponseData implements NowResponseData {
  ...
  @override
  String toString() {
    return 'NowResponse(wind_degree: $wind_degree, cloud: $cloud, feels_like_f: $feels_like_f, region: $region, daytime: $daytime, local_time: $local_time, wind_kph: $wind_kph, longitude: $longitude, temp_f: $temp_f, feels_like_c: $feels_like_c, humidity: $humidity, icon_url: $icon_url, location: $location, temp_c: $temp_c, timezone: $timezone, wind_direction: $wind_direction, wind_mph: $wind_mph, condition: $condition, country: $country, latitude: $latitude)';
  }
