...
class _$_Forecast implements _Forecast {
  ...
  @override
  String toString() {
    return 'Forecast(avg_temp_c: $avg_temp_c, avg_temp_f: $avg_temp_f, max_wind_kph: $max_wind_kph, sunset: $sunset, min_temp_f: $min_temp_f, condition: $condition, icon_url: $icon_url, max_temp_f: $max_temp_f, max_wind_mph: $max_wind_mph, min_temp_c: $min_temp_c, chance_of_rain: $chance_of_rain, date: $date, max_temp_c: $max_temp_c, sunrise: $sunrise, will_it_rain: $will_it_rain)';
  }
...
class _$NowResponseData implements NowResponseData {
  ...
  @override
  String toString() {
    return 'NowResponse(longitude: $longitude, region: $region, temp_f: $temp_f, timezone: $timezone, wind_direction: $wind_direction, daytime: $daytime, humidity: $humidity, icon_url: $icon_url, local_time: $local_time, temp_c: $temp_c, wind_degree: $wind_degree, feels_like_f: $feels_like_f, latitude: $latitude, location: $location, cloud: $cloud, condition: $condition, feels_like_c: $feels_like_c, country: $country, wind_kph: $wind_kph, wind_mph: $wind_mph)';
  }
