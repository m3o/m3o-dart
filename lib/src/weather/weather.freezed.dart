...
class _$_Forecast implements _Forecast {
  ...
  @override
  String toString() {
    return 'Forecast(sunrise: $sunrise, max_temp_c: $max_temp_c, max_wind_kph: $max_wind_kph, max_wind_mph: $max_wind_mph, avg_temp_f: $avg_temp_f, chance_of_rain: $chance_of_rain, date: $date, icon_url: $icon_url, min_temp_f: $min_temp_f, sunset: $sunset, will_it_rain: $will_it_rain, avg_temp_c: $avg_temp_c, condition: $condition, max_temp_f: $max_temp_f, min_temp_c: $min_temp_c)';
  }
...
class _$NowResponseData implements NowResponseData {
  ...
  @override
  String toString() {
    return 'NowResponse(condition: $condition, daytime: $daytime, location: $location, temp_c: $temp_c, wind_degree: $wind_degree, wind_kph: $wind_kph, cloud: $cloud, feels_like_f: $feels_like_f, humidity: $humidity, icon_url: $icon_url, latitude: $latitude, region: $region, timezone: $timezone, feels_like_c: $feels_like_c, temp_f: $temp_f, wind_mph: $wind_mph, country: $country, local_time: $local_time, longitude: $longitude, wind_direction: $wind_direction)';
  }
