...
class _$_Forecast implements _Forecast {
  ...
  @override
  String toString() {
    return 'Forecast(max_temp_f: $max_temp_f, max_wind_kph: $max_wind_kph, max_wind_mph: $max_wind_mph, sunrise: $sunrise, icon_url: $icon_url, date: $date, min_temp_c: $min_temp_c, sunset: $sunset, will_it_rain: $will_it_rain, avg_temp_f: $avg_temp_f, condition: $condition, max_temp_c: $max_temp_c, chance_of_rain: $chance_of_rain, min_temp_f: $min_temp_f, avg_temp_c: $avg_temp_c)';
  }
...
class _$NowResponseData implements NowResponseData {
  ...
  @override
  String toString() {
    return 'NowResponse(longitude: $longitude, temp_c: $temp_c, wind_kph: $wind_kph, country: $country, latitude: $latitude, daytime: $daytime, humidity: $humidity, location: $location, region: $region, timezone: $timezone, cloud: $cloud, condition: $condition, local_time: $local_time, temp_f: $temp_f, wind_mph: $wind_mph, feels_like_f: $feels_like_f, icon_url: $icon_url, wind_direction: $wind_direction, feels_like_c: $feels_like_c, wind_degree: $wind_degree)';
  }
