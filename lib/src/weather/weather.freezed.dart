...
class _$_Forecast implements _Forecast {
  ...
  @override
  String toString() {
    return 'Forecast(min_temp_f: $min_temp_f, chance_of_rain: $chance_of_rain, date: $date, max_wind_kph: $max_wind_kph, min_temp_c: $min_temp_c, will_it_rain: $will_it_rain, avg_temp_f: $avg_temp_f, condition: $condition, max_temp_f: $max_temp_f, max_wind_mph: $max_wind_mph, sunset: $sunset, avg_temp_c: $avg_temp_c, icon_url: $icon_url, max_temp_c: $max_temp_c, sunrise: $sunrise)';
  }
...
class _$NowResponseData implements NowResponseData {
  ...
  @override
  String toString() {
    return 'NowResponse(cloud: $cloud, feels_like_f: $feels_like_f, humidity: $humidity, latitude: $latitude, region: $region, wind_kph: $wind_kph, country: $country, daytime: $daytime, icon_url: $icon_url, location: $location, temp_f: $temp_f, timezone: $timezone, wind_degree: $wind_degree, wind_direction: $wind_direction, wind_mph: $wind_mph, local_time: $local_time, longitude: $longitude, condition: $condition, feels_like_c: $feels_like_c, temp_c: $temp_c)';
  }
