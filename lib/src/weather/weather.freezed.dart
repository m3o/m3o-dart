...
class _$_Forecast implements _Forecast {
  ...
  @override
  String toString() {
    return 'Forecast(max_temp_f: $max_temp_f, max_wind_mph: $max_wind_mph, sunset: $sunset, avg_temp_c: $avg_temp_c, avg_temp_f: $avg_temp_f, max_temp_c: $max_temp_c, condition: $condition, max_wind_kph: $max_wind_kph, sunrise: $sunrise, will_it_rain: $will_it_rain, chance_of_rain: $chance_of_rain, date: $date, icon_url: $icon_url, min_temp_c: $min_temp_c, min_temp_f: $min_temp_f)';
  }
...
class _$NowResponseData implements NowResponseData {
  ...
  @override
  String toString() {
    return 'NowResponse(feels_like_f: $feels_like_f, humidity: $humidity, icon_url: $icon_url, location: $location, longitude: $longitude, temp_f: $temp_f, timezone: $timezone, cloud: $cloud, condition: $condition, wind_kph: $wind_kph, country: $country, region: $region, wind_mph: $wind_mph, daytime: $daytime, feels_like_c: $feels_like_c, latitude: $latitude, local_time: $local_time, temp_c: $temp_c, wind_degree: $wind_degree, wind_direction: $wind_direction)';
  }
