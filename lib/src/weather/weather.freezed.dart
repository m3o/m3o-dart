...
class _$_Forecast implements _Forecast {
  ...
  @override
  String toString() {
    return 'Forecast(chance_of_rain: $chance_of_rain, date: $date, max_wind_mph: $max_wind_mph, avg_temp_f: $avg_temp_f, min_temp_c: $min_temp_c, min_temp_f: $min_temp_f, sunrise: $sunrise, icon_url: $icon_url, max_temp_c: $max_temp_c, max_wind_kph: $max_wind_kph, will_it_rain: $will_it_rain, avg_temp_c: $avg_temp_c, max_temp_f: $max_temp_f, sunset: $sunset, condition: $condition)';
  }
...
class _$NowResponseData implements NowResponseData {
  ...
  @override
  String toString() {
    return 'NowResponse(longitude: $longitude, region: $region, timezone: $timezone, wind_degree: $wind_degree, wind_kph: $wind_kph, condition: $condition, feels_like_c: $feels_like_c, icon_url: $icon_url, latitude: $latitude, location: $location, temp_c: $temp_c, country: $country, daytime: $daytime, feels_like_f: $feels_like_f, humidity: $humidity, temp_f: $temp_f, wind_mph: $wind_mph, cloud: $cloud, wind_direction: $wind_direction, local_time: $local_time)';
  }
