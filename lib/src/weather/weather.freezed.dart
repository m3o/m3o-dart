...
class _$_Forecast implements _Forecast {
  ...
  @override
  String toString() {
    return 'Forecast(max_wind_kph: $max_wind_kph, min_temp_f: $min_temp_f, condition: $condition, date: $date, max_wind_mph: $max_wind_mph, avg_temp_f: $avg_temp_f, max_temp_c: $max_temp_c, icon_url: $icon_url, max_temp_f: $max_temp_f, min_temp_c: $min_temp_c, sunset: $sunset, avg_temp_c: $avg_temp_c, chance_of_rain: $chance_of_rain, sunrise: $sunrise, will_it_rain: $will_it_rain)';
  }
...
class _$NowResponseData implements NowResponseData {
  ...
  @override
  String toString() {
    return 'NowResponse(region: $region, temp_c: $temp_c, wind_direction: $wind_direction, wind_mph: $wind_mph, local_time: $local_time, feels_like_f: $feels_like_f, longitude: $longitude, timezone: $timezone, feels_like_c: $feels_like_c, country: $country, latitude: $latitude, temp_f: $temp_f, wind_degree: $wind_degree, wind_kph: $wind_kph, condition: $condition, daytime: $daytime, humidity: $humidity, icon_url: $icon_url, location: $location, cloud: $cloud)';
  }
