...
class _$_Forecast implements _Forecast {
  ...
  @override
  String toString() {
    return 'Forecast(avg_temp_f: $avg_temp_f, chance_of_rain: $chance_of_rain, max_temp_f: $max_temp_f, sunrise: $sunrise, sunset: $sunset, will_it_rain: $will_it_rain, avg_temp_c: $avg_temp_c, condition: $condition, min_temp_c: $min_temp_c, min_temp_f: $min_temp_f, max_temp_c: $max_temp_c, max_wind_kph: $max_wind_kph, date: $date, icon_url: $icon_url, max_wind_mph: $max_wind_mph)';
  }
...
class _$NowResponseData implements NowResponseData {
  ...
  @override
  String toString() {
    return 'NowResponse(country: $country, feels_like_c: $feels_like_c, humidity: $humidity, wind_kph: $wind_kph, region: $region, daytime: $daytime, feels_like_f: $feels_like_f, latitude: $latitude, longitude: $longitude, timezone: $timezone, wind_degree: $wind_degree, cloud: $cloud, local_time: $local_time, temp_c: $temp_c, temp_f: $temp_f, wind_mph: $wind_mph, condition: $condition, icon_url: $icon_url, location: $location, wind_direction: $wind_direction)';
  }
