...
class _$_Forecast implements _Forecast {
  ...
  @override
  String toString() {
    return 'Forecast(chance_of_rain: $chance_of_rain, condition: $condition, max_wind_mph: $max_wind_mph, sunrise: $sunrise, avg_temp_f: $avg_temp_f, max_temp_c: $max_temp_c, max_wind_kph: $max_wind_kph, avg_temp_c: $avg_temp_c, icon_url: $icon_url, min_temp_c: $min_temp_c, sunset: $sunset, will_it_rain: $will_it_rain, date: $date, max_temp_f: $max_temp_f, min_temp_f: $min_temp_f)';
  }
...
class _$NowResponseData implements NowResponseData {
  ...
  @override
  String toString() {
    return 'NowResponse(feels_like_f: $feels_like_f, region: $region, temp_f: $temp_f, wind_direction: $wind_direction, wind_kph: $wind_kph, daytime: $daytime, wind_mph: $wind_mph, humidity: $humidity, local_time: $local_time, longitude: $longitude, country: $country, condition: $condition, feels_like_c: $feels_like_c, icon_url: $icon_url, latitude: $latitude, location: $location, temp_c: $temp_c, timezone: $timezone, cloud: $cloud, wind_degree: $wind_degree)';
  }
