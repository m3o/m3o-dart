...
class _$_Forecast implements _Forecast {
  ...
  @override
  String toString() {
    return 'Forecast(min_temp_c: $min_temp_c, min_temp_f: $min_temp_f, sunrise: $sunrise, sunset: $sunset, will_it_rain: $will_it_rain, condition: $condition, date: $date, max_temp_f: $max_temp_f, icon_url: $icon_url, max_wind_kph: $max_wind_kph, max_wind_mph: $max_wind_mph, avg_temp_c: $avg_temp_c, avg_temp_f: $avg_temp_f, max_temp_c: $max_temp_c, chance_of_rain: $chance_of_rain)';
  }
...
class _$NowResponseData implements NowResponseData {
  ...
  @override
  String toString() {
    return 'NowResponse(daytime: $daytime, feels_like_f: $feels_like_f, timezone: $timezone, wind_direction: $wind_direction, cloud: $cloud, local_time: $local_time, longitude: $longitude, region: $region, wind_degree: $wind_degree, condition: $condition, country: $country, temp_c: $temp_c, temp_f: $temp_f, wind_kph: $wind_kph, feels_like_c: $feels_like_c, humidity: $humidity, icon_url: $icon_url, latitude: $latitude, location: $location, wind_mph: $wind_mph)';
  }
