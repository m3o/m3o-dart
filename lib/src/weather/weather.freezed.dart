...
class _$_Forecast implements _Forecast {
  ...
  @override
  String toString() {
    return 'Forecast(chance_of_rain: $chance_of_rain, max_temp_c: $max_temp_c, condition: $condition, date: $date, sunrise: $sunrise, avg_temp_c: $avg_temp_c, avg_temp_f: $avg_temp_f, icon_url: $icon_url, max_temp_f: $max_temp_f, max_wind_mph: $max_wind_mph, sunset: $sunset, max_wind_kph: $max_wind_kph, min_temp_c: $min_temp_c, min_temp_f: $min_temp_f, will_it_rain: $will_it_rain)';
  }
...
class _$NowResponseData implements NowResponseData {
  ...
  @override
  String toString() {
    return 'NowResponse(wind_direction: $wind_direction, condition: $condition, location: $location, temp_f: $temp_f, timezone: $timezone, feels_like_f: $feels_like_f, region: $region, temp_c: $temp_c, wind_degree: $wind_degree, country: $country, daytime: $daytime, humidity: $humidity, wind_kph: $wind_kph, local_time: $local_time, longitude: $longitude, wind_mph: $wind_mph, cloud: $cloud, feels_like_c: $feels_like_c, icon_url: $icon_url, latitude: $latitude)';
  }
