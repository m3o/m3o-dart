...
class _$_Forecast implements _Forecast {
  ...
  @override
  String toString() {
    return 'Forecast(chance_of_rain: $chance_of_rain, condition: $condition, max_temp_f: $max_temp_f, min_temp_c: $min_temp_c, min_temp_f: $min_temp_f, sunset: $sunset, avg_temp_f: $avg_temp_f, max_temp_c: $max_temp_c, max_wind_mph: $max_wind_mph, sunrise: $sunrise, avg_temp_c: $avg_temp_c, icon_url: $icon_url, max_wind_kph: $max_wind_kph, date: $date, will_it_rain: $will_it_rain)';
  }
...
class _$NowResponseData implements NowResponseData {
  ...
  @override
  String toString() {
    return 'NowResponse(latitude: $latitude, location: $location, longitude: $longitude, temp_c: $temp_c, country: $country, daytime: $daytime, feels_like_c: $feels_like_c, feels_like_f: $feels_like_f, humidity: $humidity, cloud: $cloud, condition: $condition, temp_f: $temp_f, timezone: $timezone, wind_degree: $wind_degree, wind_mph: $wind_mph, icon_url: $icon_url, local_time: $local_time, region: $region, wind_direction: $wind_direction, wind_kph: $wind_kph)';
  }
