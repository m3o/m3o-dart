...
class _$_Forecast implements _Forecast {
  ...
  @override
  String toString() {
    return 'Forecast(chance_of_rain: $chance_of_rain, avg_temp_f: $avg_temp_f, max_temp_f: $max_temp_f, min_temp_c: $min_temp_c, condition: $condition, date: $date, max_wind_mph: $max_wind_mph, sunrise: $sunrise, sunset: $sunset, will_it_rain: $will_it_rain, avg_temp_c: $avg_temp_c, icon_url: $icon_url, max_temp_c: $max_temp_c, max_wind_kph: $max_wind_kph, min_temp_f: $min_temp_f)';
  }
...
class _$NowResponseData implements NowResponseData {
  ...
  @override
  String toString() {
    return 'NowResponse(condition: $condition, feels_like_f: $feels_like_f, humidity: $humidity, latitude: $latitude, longitude: $longitude, wind_mph: $wind_mph, daytime: $daytime, icon_url: $icon_url, region: $region, temp_c: $temp_c, wind_direction: $wind_direction, wind_kph: $wind_kph, cloud: $cloud, feels_like_c: $feels_like_c, timezone: $timezone, wind_degree: $wind_degree, country: $country, local_time: $local_time, location: $location, temp_f: $temp_f)';
  }
