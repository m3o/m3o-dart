...
class _$_Forecast implements _Forecast {
  ...
  @override
  String toString() {
    return 'Forecast(sunset: $sunset, avg_temp_f: $avg_temp_f, condition: $condition, date: $date, max_wind_mph: $max_wind_mph, avg_temp_c: $avg_temp_c, chance_of_rain: $chance_of_rain, icon_url: $icon_url, min_temp_f: $min_temp_f, sunrise: $sunrise, will_it_rain: $will_it_rain, max_temp_c: $max_temp_c, max_temp_f: $max_temp_f, max_wind_kph: $max_wind_kph, min_temp_c: $min_temp_c)';
  }
...
class _$NowResponseData implements NowResponseData {
  ...
  @override
  String toString() {
    return 'NowResponse(cloud: $cloud, country: $country, daytime: $daytime, wind_direction: $wind_direction, condition: $condition, latitude: $latitude, local_time: $local_time, temp_c: $temp_c, wind_kph: $wind_kph, feels_like_c: $feels_like_c, icon_url: $icon_url, region: $region, temp_f: $temp_f, timezone: $timezone, wind_degree: $wind_degree, wind_mph: $wind_mph, feels_like_f: $feels_like_f, humidity: $humidity, location: $location, longitude: $longitude)';
  }
