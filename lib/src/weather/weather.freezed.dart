...
class _$_Forecast implements _Forecast {
  ...
  @override
  String toString() {
    return 'Forecast(max_wind_mph: $max_wind_mph, sunset: $sunset, max_temp_c: $max_temp_c, max_temp_f: $max_temp_f, icon_url: $icon_url, max_wind_kph: $max_wind_kph, min_temp_c: $min_temp_c, min_temp_f: $min_temp_f, sunrise: $sunrise, chance_of_rain: $chance_of_rain, date: $date, condition: $condition, will_it_rain: $will_it_rain, avg_temp_c: $avg_temp_c, avg_temp_f: $avg_temp_f)';
  }
...
class _$NowResponseData implements NowResponseData {
  ...
  @override
  String toString() {
    return 'NowResponse(temp_f: $temp_f, wind_degree: $wind_degree, wind_direction: $wind_direction, cloud: $cloud, country: $country, feels_like_c: $feels_like_c, feels_like_f: $feels_like_f, humidity: $humidity, icon_url: $icon_url, wind_kph: $wind_kph, wind_mph: $wind_mph, condition: $condition, daytime: $daytime, longitude: $longitude, region: $region, latitude: $latitude, location: $location, timezone: $timezone, local_time: $local_time, temp_c: $temp_c)';
  }
