...
class _$_Forecast implements _Forecast {
  ...
  @override
  String toString() {
    return 'Forecast(avg_temp_f: $avg_temp_f, max_wind_kph: $max_wind_kph, min_temp_f: $min_temp_f, date: $date, max_wind_mph: $max_wind_mph, will_it_rain: $will_it_rain, sunset: $sunset, avg_temp_c: $avg_temp_c, chance_of_rain: $chance_of_rain, condition: $condition, icon_url: $icon_url, max_temp_c: $max_temp_c, sunrise: $sunrise, max_temp_f: $max_temp_f, min_temp_c: $min_temp_c)';
  }
...
class _$NowResponseData implements NowResponseData {
  ...
  @override
  String toString() {
    return 'NowResponse(latitude: $latitude, longitude: $longitude, wind_kph: $wind_kph, cloud: $cloud, country: $country, daytime: $daytime, region: $region, temp_c: $temp_c, timezone: $timezone, feels_like_f: $feels_like_f, local_time: $local_time, wind_degree: $wind_degree, wind_direction: $wind_direction, wind_mph: $wind_mph, condition: $condition, feels_like_c: $feels_like_c, humidity: $humidity, icon_url: $icon_url, location: $location, temp_f: $temp_f)';
  }
