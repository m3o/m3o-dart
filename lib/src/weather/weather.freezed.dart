...
class _$_Forecast implements _Forecast {
  ...
  @override
  String toString() {
    return 'Forecast(condition: $condition, max_temp_f: $max_temp_f, max_wind_kph: $max_wind_kph, max_temp_c: $max_temp_c, max_wind_mph: $max_wind_mph, min_temp_f: $min_temp_f, sunset: $sunset, date: $date, icon_url: $icon_url, min_temp_c: $min_temp_c, sunrise: $sunrise, avg_temp_c: $avg_temp_c, avg_temp_f: $avg_temp_f, chance_of_rain: $chance_of_rain, will_it_rain: $will_it_rain)';
  }
...
class _$NowResponseData implements NowResponseData {
  ...
  @override
  String toString() {
    return 'NowResponse(condition: $condition, daytime: $daytime, feels_like_f: $feels_like_f, local_time: $local_time, temp_f: $temp_f, wind_mph: $wind_mph, latitude: $latitude, location: $location, longitude: $longitude, temp_c: $temp_c, wind_degree: $wind_degree, wind_direction: $wind_direction, wind_kph: $wind_kph, country: $country, feels_like_c: $feels_like_c, humidity: $humidity, icon_url: $icon_url, region: $region, timezone: $timezone, cloud: $cloud)';
  }
