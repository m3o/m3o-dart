...
class _$_Forecast implements _Forecast {
  ...
  @override
  String toString() {
    return 'Forecast(avg_temp_c: $avg_temp_c, date: $date, max_temp_c: $max_temp_c, max_wind_kph: $max_wind_kph, min_temp_f: $min_temp_f, will_it_rain: $will_it_rain, avg_temp_f: $avg_temp_f, chance_of_rain: $chance_of_rain, condition: $condition, max_wind_mph: $max_wind_mph, icon_url: $icon_url, max_temp_f: $max_temp_f, min_temp_c: $min_temp_c, sunrise: $sunrise, sunset: $sunset)';
  }
...
class _$NowResponseData implements NowResponseData {
  ...
  @override
  String toString() {
    return 'NowResponse(condition: $condition, country: $country, feels_like_c: $feels_like_c, humidity: $humidity, wind_degree: $wind_degree, feels_like_f: $feels_like_f, latitude: $latitude, location: $location, region: $region, temp_c: $temp_c, wind_mph: $wind_mph, cloud: $cloud, local_time: $local_time, longitude: $longitude, timezone: $timezone, wind_kph: $wind_kph, daytime: $daytime, icon_url: $icon_url, temp_f: $temp_f, wind_direction: $wind_direction)';
  }
