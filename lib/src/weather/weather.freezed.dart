...
class _$_Forecast implements _Forecast {
  ...
  @override
  String toString() {
    return 'Forecast(min_temp_f: $min_temp_f, sunrise: $sunrise, will_it_rain: $will_it_rain, icon_url: $icon_url, avg_temp_c: $avg_temp_c, date: $date, max_temp_f: $max_temp_f, max_wind_mph: $max_wind_mph, min_temp_c: $min_temp_c, avg_temp_f: $avg_temp_f, chance_of_rain: $chance_of_rain, condition: $condition, max_temp_c: $max_temp_c, max_wind_kph: $max_wind_kph, sunset: $sunset)';
  }
...
class _$NowResponseData implements NowResponseData {
  ...
  @override
  String toString() {
    return 'NowResponse(feels_like_c: $feels_like_c, latitude: $latitude, local_time: $local_time, longitude: $longitude, temp_c: $temp_c, wind_mph: $wind_mph, condition: $condition, region: $region, temp_f: $temp_f, timezone: $timezone, wind_kph: $wind_kph, daytime: $daytime, country: $country, humidity: $humidity, location: $location, wind_degree: $wind_degree, cloud: $cloud, icon_url: $icon_url, wind_direction: $wind_direction, feels_like_f: $feels_like_f)';
  }
