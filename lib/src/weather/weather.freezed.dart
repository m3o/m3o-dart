...
class _$_Forecast implements _Forecast {
  ...
  @override
  String toString() {
    return 'Forecast(date: $date, max_temp_c: $max_temp_c, avg_temp_f: $avg_temp_f, max_wind_kph: $max_wind_kph, max_wind_mph: $max_wind_mph, min_temp_f: $min_temp_f, will_it_rain: $will_it_rain, min_temp_c: $min_temp_c, sunset: $sunset, avg_temp_c: $avg_temp_c, chance_of_rain: $chance_of_rain, condition: $condition, icon_url: $icon_url, max_temp_f: $max_temp_f, sunrise: $sunrise)';
  }
...
class _$NowResponseData implements NowResponseData {
  ...
  @override
  String toString() {
    return 'NowResponse(wind_kph: $wind_kph, longitude: $longitude, temp_f: $temp_f, wind_direction: $wind_direction, region: $region, temp_c: $temp_c, cloud: $cloud, condition: $condition, icon_url: $icon_url, location: $location, wind_mph: $wind_mph, feels_like_c: $feels_like_c, feels_like_f: $feels_like_f, humidity: $humidity, local_time: $local_time, timezone: $timezone, wind_degree: $wind_degree, country: $country, daytime: $daytime, latitude: $latitude)';
  }
...
abstract class NowResponseData implements NowResponse {
  const factory NowResponseData(
      ...
      final String? country,
      final bool? daytime,
      final double? latitude}) = _$NowResponseData;
