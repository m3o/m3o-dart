...
class _$_Forecast implements _Forecast {
  ...
  @override
  String toString() {
    return 'Forecast(date: $date, icon_url: $icon_url, condition: $condition, max_temp_c: $max_temp_c, max_temp_f: $max_temp_f, max_wind_kph: $max_wind_kph, max_wind_mph: $max_wind_mph, avg_temp_c: $avg_temp_c, avg_temp_f: $avg_temp_f, sunrise: $sunrise, chance_of_rain: $chance_of_rain, min_temp_c: $min_temp_c, min_temp_f: $min_temp_f, sunset: $sunset, will_it_rain: $will_it_rain)';
  }
...
class _$NowResponseData implements NowResponseData {
  ...
  @override
  String toString() {
    return 'NowResponse(cloud: $cloud, temp_f: $temp_f, wind_direction: $wind_direction, wind_mph: $wind_mph, country: $country, humidity: $humidity, icon_url: $icon_url, region: $region, latitude: $latitude, local_time: $local_time, timezone: $timezone, wind_degree: $wind_degree, longitude: $longitude, temp_c: $temp_c, wind_kph: $wind_kph, condition: $condition, daytime: $daytime, feels_like_c: $feels_like_c, feels_like_f: $feels_like_f, location: $location)';
  }
