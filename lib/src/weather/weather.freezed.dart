...
class _$_Forecast implements _Forecast {
  ...
  @override
  String toString() {
    return 'Forecast(icon_url: $icon_url, max_wind_kph: $max_wind_kph, min_temp_c: $min_temp_c, avg_temp_c: $avg_temp_c, max_temp_f: $max_temp_f, max_wind_mph: $max_wind_mph, max_temp_c: $max_temp_c, chance_of_rain: $chance_of_rain, condition: $condition, date: $date, min_temp_f: $min_temp_f, sunrise: $sunrise, sunset: $sunset, will_it_rain: $will_it_rain, avg_temp_f: $avg_temp_f)';
  }
...
class _$NowResponseData implements NowResponseData {
  ...
  @override
  String toString() {
    return 'NowResponse(temp_f: $temp_f, country: $country, daytime: $daytime, feels_like_c: $feels_like_c, location: $location, longitude: $longitude, temp_c: $temp_c, wind_degree: $wind_degree, condition: $condition, feels_like_f: $feels_like_f, icon_url: $icon_url, latitude: $latitude, wind_mph: $wind_mph, cloud: $cloud, local_time: $local_time, region: $region, wind_kph: $wind_kph, humidity: $humidity, timezone: $timezone, wind_direction: $wind_direction)';
  }
