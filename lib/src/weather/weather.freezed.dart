...
class _$_Forecast implements _Forecast {
  ...
  @override
  String toString() {
    return 'Forecast(avg_temp_c: $avg_temp_c, avg_temp_f: $avg_temp_f, chance_of_rain: $chance_of_rain, icon_url: $icon_url, sunrise: $sunrise, will_it_rain: $will_it_rain, max_temp_f: $max_temp_f, max_wind_kph: $max_wind_kph, max_wind_mph: $max_wind_mph, sunset: $sunset, condition: $condition, max_temp_c: $max_temp_c, min_temp_f: $min_temp_f, date: $date, min_temp_c: $min_temp_c)';
  }
...
class _$NowResponseData implements NowResponseData {
  ...
  @override
  String toString() {
    return 'NowResponse(icon_url: $icon_url, temp_f: $temp_f, wind_direction: $wind_direction, wind_kph: $wind_kph, feels_like_c: $feels_like_c, feels_like_f: $feels_like_f, wind_mph: $wind_mph, location: $location, timezone: $timezone, local_time: $local_time, longitude: $longitude, temp_c: $temp_c, wind_degree: $wind_degree, condition: $condition, latitude: $latitude, daytime: $daytime, humidity: $humidity, region: $region, cloud: $cloud, country: $country)';
  }
