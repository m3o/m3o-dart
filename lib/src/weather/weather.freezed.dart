...
class _$_Forecast implements _Forecast {
  ...
  @override
  String toString() {
    return 'Forecast(avg_temp_c: $avg_temp_c, max_temp_f: $max_temp_f, min_temp_c: $min_temp_c, condition: $condition, date: $date, icon_url: $icon_url, min_temp_f: $min_temp_f, will_it_rain: $will_it_rain, chance_of_rain: $chance_of_rain, sunrise: $sunrise, sunset: $sunset, avg_temp_f: $avg_temp_f, max_temp_c: $max_temp_c, max_wind_kph: $max_wind_kph, max_wind_mph: $max_wind_mph)';
  }
...
class _$NowResponseData implements NowResponseData {
  ...
  @override
  String toString() {
    return 'NowResponse(icon_url: $icon_url, temp_c: $temp_c, country: $country, feels_like_c: $feels_like_c, latitude: $latitude, local_time: $local_time, location: $location, wind_mph: $wind_mph, cloud: $cloud, region: $region, timezone: $timezone, wind_direction: $wind_direction, daytime: $daytime, feels_like_f: $feels_like_f, humidity: $humidity, longitude: $longitude, temp_f: $temp_f, wind_degree: $wind_degree, wind_kph: $wind_kph, condition: $condition)';
  }
