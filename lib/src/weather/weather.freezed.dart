...
class _$_Forecast implements _Forecast {
  ...
  @override
  String toString() {
    return 'Forecast(min_temp_f: $min_temp_f, sunset: $sunset, date: $date, max_wind_kph: $max_wind_kph, max_wind_mph: $max_wind_mph, avg_temp_f: $avg_temp_f, min_temp_c: $min_temp_c, will_it_rain: $will_it_rain, condition: $condition, max_temp_c: $max_temp_c, sunrise: $sunrise, max_temp_f: $max_temp_f, avg_temp_c: $avg_temp_c, chance_of_rain: $chance_of_rain, icon_url: $icon_url)';
  }
...
class _$NowResponseData implements NowResponseData {
  ...
  @override
  String toString() {
    return 'NowResponse(country: $country, feels_like_f: $feels_like_f, local_time: $local_time, region: $region, temp_f: $temp_f, cloud: $cloud, condition: $condition, location: $location, timezone: $timezone, wind_direction: $wind_direction, wind_kph: $wind_kph, wind_mph: $wind_mph, daytime: $daytime, humidity: $humidity, wind_degree: $wind_degree, feels_like_c: $feels_like_c, temp_c: $temp_c, longitude: $longitude, icon_url: $icon_url, latitude: $latitude)';
  }
