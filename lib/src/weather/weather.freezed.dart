...
class _$_Forecast implements _Forecast {
  ...
  @override
  String toString() {
    return 'Forecast(max_temp_f: $max_temp_f, min_temp_f: $min_temp_f, avg_temp_c: $avg_temp_c, avg_temp_f: $avg_temp_f, chance_of_rain: $chance_of_rain, date: $date, max_wind_kph: $max_wind_kph, sunrise: $sunrise, will_it_rain: $will_it_rain, condition: $condition, icon_url: $icon_url, max_temp_c: $max_temp_c, max_wind_mph: $max_wind_mph, min_temp_c: $min_temp_c, sunset: $sunset)';
  }
...
class _$NowResponseData implements NowResponseData {
  ...
  @override
  String toString() {
    return 'NowResponse(condition: $condition, country: $country, daytime: $daytime, temp_c: $temp_c, wind_kph: $wind_kph, feels_like_c: $feels_like_c, icon_url: $icon_url, location: $location, longitude: $longitude, wind_direction: $wind_direction, cloud: $cloud, humidity: $humidity, latitude: $latitude, region: $region, temp_f: $temp_f, timezone: $timezone, wind_degree: $wind_degree, wind_mph: $wind_mph, feels_like_f: $feels_like_f, local_time: $local_time)';
  }
