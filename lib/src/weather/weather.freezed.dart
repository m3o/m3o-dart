...
class _$_Forecast implements _Forecast {
  ...
  @override
  String toString() {
    return 'Forecast(min_temp_f: $min_temp_f, chance_of_rain: $chance_of_rain, condition: $condition, max_wind_kph: $max_wind_kph, sunrise: $sunrise, sunset: $sunset, avg_temp_c: $avg_temp_c, date: $date, max_wind_mph: $max_wind_mph, min_temp_c: $min_temp_c, max_temp_c: $max_temp_c, max_temp_f: $max_temp_f, will_it_rain: $will_it_rain, avg_temp_f: $avg_temp_f, icon_url: $icon_url)';
  }
...
class _$NowResponseData implements NowResponseData {
  ...
  @override
  String toString() {
    return 'NowResponse(cloud: $cloud, daytime: $daytime, feels_like_f: $feels_like_f, humidity: $humidity, longitude: $longitude, condition: $condition, icon_url: $icon_url, region: $region, timezone: $timezone, wind_direction: $wind_direction, wind_mph: $wind_mph, country: $country, local_time: $local_time, temp_c: $temp_c, wind_kph: $wind_kph, feels_like_c: $feels_like_c, latitude: $latitude, location: $location, temp_f: $temp_f, wind_degree: $wind_degree)';
  }
