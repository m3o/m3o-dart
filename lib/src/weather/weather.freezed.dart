...
class _$_Forecast implements _Forecast {
  ...
  @override
  String toString() {
    return 'Forecast(avg_temp_f: $avg_temp_f, sunrise: $sunrise, sunset: $sunset, will_it_rain: $will_it_rain, icon_url: $icon_url, max_temp_f: $max_temp_f, max_wind_mph: $max_wind_mph, avg_temp_c: $avg_temp_c, date: $date, min_temp_c: $min_temp_c, min_temp_f: $min_temp_f, chance_of_rain: $chance_of_rain, condition: $condition, max_temp_c: $max_temp_c, max_wind_kph: $max_wind_kph)';
  }
...
class _$NowResponseData implements NowResponseData {
  ...
  @override
  String toString() {
    return 'NowResponse(feels_like_c: $feels_like_c, icon_url: $icon_url, longitude: $longitude, wind_direction: $wind_direction, wind_kph: $wind_kph, wind_mph: $wind_mph, country: $country, wind_degree: $wind_degree, daytime: $daytime, feels_like_f: $feels_like_f, latitude: $latitude, local_time: $local_time, location: $location, region: $region, temp_c: $temp_c, temp_f: $temp_f, timezone: $timezone, cloud: $cloud, condition: $condition, humidity: $humidity)';
  }
