...
class _$_Forecast implements _Forecast {
  ...
  @override
  String toString() {
    return 'Forecast(date: $date, max_wind_mph: $max_wind_mph, avg_temp_c: $avg_temp_c, max_temp_f: $max_temp_f, icon_url: $icon_url, sunrise: $sunrise, sunset: $sunset, max_wind_kph: $max_wind_kph, min_temp_c: $min_temp_c, min_temp_f: $min_temp_f, will_it_rain: $will_it_rain, avg_temp_f: $avg_temp_f, chance_of_rain: $chance_of_rain, condition: $condition, max_temp_c: $max_temp_c)';
  }
...
class _$NowResponseData implements NowResponseData {
  ...
  @override
  String toString() {
    return 'NowResponse(condition: $condition, feels_like_c: $feels_like_c, location: $location, timezone: $timezone, wind_degree: $wind_degree, wind_kph: $wind_kph, wind_mph: $wind_mph, country: $country, humidity: $humidity, icon_url: $icon_url, latitude: $latitude, temp_c: $temp_c, cloud: $cloud, feels_like_f: $feels_like_f, local_time: $local_time, longitude: $longitude, region: $region, wind_direction: $wind_direction, daytime: $daytime, temp_f: $temp_f)';
  }
