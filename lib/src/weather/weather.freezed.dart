...
class _$_Forecast implements _Forecast {
  ...
  @override
  String toString() {
    return 'Forecast(condition: $condition, min_temp_f: $min_temp_f, sunrise: $sunrise, sunset: $sunset, avg_temp_c: $avg_temp_c, avg_temp_f: $avg_temp_f, max_temp_c: $max_temp_c, chance_of_rain: $chance_of_rain, date: $date, icon_url: $icon_url, max_wind_mph: $max_wind_mph, max_temp_f: $max_temp_f, max_wind_kph: $max_wind_kph, min_temp_c: $min_temp_c, will_it_rain: $will_it_rain)';
  }
...
class _$NowResponseData implements NowResponseData {
  ...
  @override
  String toString() {
    return 'NowResponse(condition: $condition, location: $location, temp_c: $temp_c, timezone: $timezone, wind_direction: $wind_direction, wind_mph: $wind_mph, cloud: $cloud, daytime: $daytime, feels_like_f: $feels_like_f, icon_url: $icon_url, region: $region, country: $country, local_time: $local_time, wind_degree: $wind_degree, feels_like_c: $feels_like_c, humidity: $humidity, latitude: $latitude, longitude: $longitude, temp_f: $temp_f, wind_kph: $wind_kph)';
  }
