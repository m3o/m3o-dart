...
class _$_Forecast implements _Forecast {
  ...
  @override
  String toString() {
    return 'Forecast(avg_temp_c: $avg_temp_c, avg_temp_f: $avg_temp_f, max_wind_mph: $max_wind_mph, min_temp_c: $min_temp_c, min_temp_f: $min_temp_f, sunset: $sunset, condition: $condition, max_temp_c: $max_temp_c, chance_of_rain: $chance_of_rain, date: $date, icon_url: $icon_url, max_temp_f: $max_temp_f, will_it_rain: $will_it_rain, max_wind_kph: $max_wind_kph, sunrise: $sunrise)';
  }
...
class _$NowResponseData implements NowResponseData {
  ...
  @override
  String toString() {
    return 'NowResponse(daytime: $daytime, wind_degree: $wind_degree, feels_like_f: $feels_like_f, humidity: $humidity, icon_url: $icon_url, timezone: $timezone, wind_mph: $wind_mph, feels_like_c: $feels_like_c, local_time: $local_time, longitude: $longitude, region: $region, wind_direction: $wind_direction, temp_c: $temp_c, temp_f: $temp_f, wind_kph: $wind_kph, cloud: $cloud, condition: $condition, country: $country, latitude: $latitude, location: $location)';
  }
