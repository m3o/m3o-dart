...
class _$_Forecast implements _Forecast {
  ...
  @override
  String toString() {
    return 'Forecast(sunrise: $sunrise, condition: $condition, max_wind_kph: $max_wind_kph, max_temp_f: $max_temp_f, max_wind_mph: $max_wind_mph, min_temp_f: $min_temp_f, will_it_rain: $will_it_rain, chance_of_rain: $chance_of_rain, date: $date, min_temp_c: $min_temp_c, sunset: $sunset, avg_temp_f: $avg_temp_f, max_temp_c: $max_temp_c, avg_temp_c: $avg_temp_c, icon_url: $icon_url)';
  }
...
class _$NowResponseData implements NowResponseData {
  ...
  @override
  String toString() {
    return 'NowResponse(latitude: $latitude, local_time: $local_time, location: $location, timezone: $timezone, cloud: $cloud, country: $country, daytime: $daytime, feels_like_c: $feels_like_c, icon_url: $icon_url, region: $region, wind_degree: $wind_degree, wind_direction: $wind_direction, longitude: $longitude, temp_c: $temp_c, temp_f: $temp_f, condition: $condition, feels_like_f: $feels_like_f, humidity: $humidity, wind_kph: $wind_kph, wind_mph: $wind_mph)';
  }
