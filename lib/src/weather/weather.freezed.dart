...
class _$_Forecast implements _Forecast {
  ...
  @override
  String toString() {
    return 'Forecast(condition: $condition, max_wind_mph: $max_wind_mph, sunrise: $sunrise, avg_temp_c: $avg_temp_c, avg_temp_f: $avg_temp_f, max_temp_f: $max_temp_f, min_temp_c: $min_temp_c, min_temp_f: $min_temp_f, chance_of_rain: $chance_of_rain, icon_url: $icon_url, max_wind_kph: $max_wind_kph, will_it_rain: $will_it_rain, date: $date, max_temp_c: $max_temp_c, sunset: $sunset)';
  }
...
class _$NowResponseData implements NowResponseData {
  ...
  @override
  String toString() {
    return 'NowResponse(local_time: $local_time, longitude: $longitude, feels_like_f: $feels_like_f, location: $location, region: $region, wind_kph: $wind_kph, cloud: $cloud, condition: $condition, daytime: $daytime, timezone: $timezone, country: $country, feels_like_c: $feels_like_c, temp_c: $temp_c, temp_f: $temp_f, wind_degree: $wind_degree, wind_direction: $wind_direction, wind_mph: $wind_mph, humidity: $humidity, icon_url: $icon_url, latitude: $latitude)';
  }
