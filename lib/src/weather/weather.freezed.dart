...
class _$_Forecast implements _Forecast {
  ...
  @override
  String toString() {
    return 'Forecast(avg_temp_f: $avg_temp_f, condition: $condition, max_wind_mph: $max_wind_mph, will_it_rain: $will_it_rain, max_temp_c: $max_temp_c, min_temp_c: $min_temp_c, sunrise: $sunrise, avg_temp_c: $avg_temp_c, chance_of_rain: $chance_of_rain, sunset: $sunset, date: $date, icon_url: $icon_url, max_temp_f: $max_temp_f, max_wind_kph: $max_wind_kph, min_temp_f: $min_temp_f)';
  }
...
class _$NowResponseData implements NowResponseData {
  ...
  @override
  String toString() {
    return 'NowResponse(wind_mph: $wind_mph, condition: $condition, latitude: $latitude, wind_direction: $wind_direction, local_time: $local_time, location: $location, temp_c: $temp_c, feels_like_f: $feels_like_f, humidity: $humidity, icon_url: $icon_url, longitude: $longitude, wind_degree: $wind_degree, wind_kph: $wind_kph, country: $country, daytime: $daytime, feels_like_c: $feels_like_c, timezone: $timezone, cloud: $cloud, region: $region, temp_f: $temp_f)';
  }
...
abstract class NowResponseData implements NowResponse {
  const factory NowResponseData(
      ...
      final int? cloud,
      final String? region,
      final double? temp_f}) = _$NowResponseData;
