...
class _$_Forecast implements _Forecast {
  ...
  @override
  String toString() {
    return 'Forecast(max_temp_f: $max_temp_f, max_wind_mph: $max_wind_mph, sunset: $sunset, will_it_rain: $will_it_rain, condition: $condition, icon_url: $icon_url, max_temp_c: $max_temp_c, max_wind_kph: $max_wind_kph, min_temp_c: $min_temp_c, min_temp_f: $min_temp_f, avg_temp_c: $avg_temp_c, chance_of_rain: $chance_of_rain, date: $date, sunrise: $sunrise, avg_temp_f: $avg_temp_f)';
  }
...
class _$NowResponseData implements NowResponseData {
  ...
  @override
  String toString() {
    return 'NowResponse(temp_c: $temp_c, feels_like_c: $feels_like_c, humidity: $humidity, local_time: $local_time, longitude: $longitude, region: $region, wind_mph: $wind_mph, cloud: $cloud, condition: $condition, feels_like_f: $feels_like_f, temp_f: $temp_f, wind_direction: $wind_direction, daytime: $daytime, icon_url: $icon_url, location: $location, country: $country, latitude: $latitude, timezone: $timezone, wind_degree: $wind_degree, wind_kph: $wind_kph)';
  }
