...
class _$_Forecast implements _Forecast {
  ...
  @override
  String toString() {
    return 'Forecast(sunset: $sunset, will_it_rain: $will_it_rain, chance_of_rain: $chance_of_rain, max_temp_f: $max_temp_f, max_wind_kph: $max_wind_kph, max_wind_mph: $max_wind_mph, sunrise: $sunrise, condition: $condition, date: $date, icon_url: $icon_url, min_temp_f: $min_temp_f, avg_temp_c: $avg_temp_c, avg_temp_f: $avg_temp_f, max_temp_c: $max_temp_c, min_temp_c: $min_temp_c)';
  }
...
class _$NowResponseData implements NowResponseData {
  ...
  @override
  String toString() {
    return 'NowResponse(daytime: $daytime, feels_like_c: $feels_like_c, feels_like_f: $feels_like_f, longitude: $longitude, wind_kph: $wind_kph, cloud: $cloud, humidity: $humidity, region: $region, temp_f: $temp_f, timezone: $timezone, wind_direction: $wind_direction, country: $country, icon_url: $icon_url, latitude: $latitude, local_time: $local_time, location: $location, temp_c: $temp_c, condition: $condition, wind_degree: $wind_degree, wind_mph: $wind_mph)';
  }
