...
class _$_Forecast implements _Forecast {
  ...
  @override
  String toString() {
    return 'Forecast(chance_of_rain: $chance_of_rain, condition: $condition, sunrise: $sunrise, max_temp_c: $max_temp_c, max_temp_f: $max_temp_f, max_wind_kph: $max_wind_kph, sunset: $sunset, min_temp_c: $min_temp_c, will_it_rain: $will_it_rain, avg_temp_c: $avg_temp_c, avg_temp_f: $avg_temp_f, date: $date, max_wind_mph: $max_wind_mph, icon_url: $icon_url, min_temp_f: $min_temp_f)';
  }
...
class _$NowResponseData implements NowResponseData {
  ...
  @override
  String toString() {
    return 'NowResponse(longitude: $longitude, region: $region, temp_f: $temp_f, wind_direction: $wind_direction, daytime: $daytime, feels_like_f: $feels_like_f, icon_url: $icon_url, location: $location, timezone: $timezone, wind_kph: $wind_kph, wind_mph: $wind_mph, cloud: $cloud, country: $country, local_time: $local_time, latitude: $latitude, temp_c: $temp_c, wind_degree: $wind_degree, condition: $condition, feels_like_c: $feels_like_c, humidity: $humidity)';
  }
