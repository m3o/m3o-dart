...
class _$_Forecast implements _Forecast {
  ...
  @override
  String toString() {
    return 'Forecast(avg_temp_f: $avg_temp_f, max_wind_kph: $max_wind_kph, min_temp_c: $min_temp_c, sunrise: $sunrise, date: $date, icon_url: $icon_url, max_temp_c: $max_temp_c, condition: $condition, sunset: $sunset, max_wind_mph: $max_wind_mph, min_temp_f: $min_temp_f, will_it_rain: $will_it_rain, avg_temp_c: $avg_temp_c, chance_of_rain: $chance_of_rain, max_temp_f: $max_temp_f)';
  }
...
class _$NowResponseData implements NowResponseData {
  ...
  @override
  String toString() {
    return 'NowResponse(humidity: $humidity, local_time: $local_time, wind_kph: $wind_kph, condition: $condition, country: $country, daytime: $daytime, longitude: $longitude, temp_c: $temp_c, cloud: $cloud, feels_like_c: $feels_like_c, latitude: $latitude, location: $location, temp_f: $temp_f, wind_direction: $wind_direction, wind_mph: $wind_mph, feels_like_f: $feels_like_f, icon_url: $icon_url, region: $region, timezone: $timezone, wind_degree: $wind_degree)';
  }
