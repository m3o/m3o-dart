...
class _$_Forecast implements _Forecast {
  ...
  @override
  String toString() {
    return 'Forecast(sunrise: $sunrise, icon_url: $icon_url, max_temp_f: $max_temp_f, max_wind_kph: $max_wind_kph, min_temp_f: $min_temp_f, max_wind_mph: $max_wind_mph, min_temp_c: $min_temp_c, sunset: $sunset, will_it_rain: $will_it_rain, chance_of_rain: $chance_of_rain, condition: $condition, date: $date, max_temp_c: $max_temp_c, avg_temp_c: $avg_temp_c, avg_temp_f: $avg_temp_f)';
  }
...
class _$NowResponseData implements NowResponseData {
  ...
  @override
  String toString() {
    return 'NowResponse(feels_like_f: $feels_like_f, icon_url: $icon_url, local_time: $local_time, location: $location, longitude: $longitude, temp_f: $temp_f, timezone: $timezone, cloud: $cloud, wind_degree: $wind_degree, region: $region, wind_direction: $wind_direction, wind_kph: $wind_kph, wind_mph: $wind_mph, latitude: $latitude, feels_like_c: $feels_like_c, country: $country, daytime: $daytime, humidity: $humidity, temp_c: $temp_c, condition: $condition)';
  }
