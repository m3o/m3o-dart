...
class _$_Forecast implements _Forecast {
  ...
  @override
  String toString() {
    return 'Forecast(avg_temp_c: $avg_temp_c, date: $date, max_temp_c: $max_temp_c, max_wind_mph: $max_wind_mph, condition: $condition, min_temp_c: $min_temp_c, sunset: $sunset, avg_temp_f: $avg_temp_f, icon_url: $icon_url, will_it_rain: $will_it_rain, chance_of_rain: $chance_of_rain, max_temp_f: $max_temp_f, max_wind_kph: $max_wind_kph, min_temp_f: $min_temp_f, sunrise: $sunrise)';
  }
...
class _$NowResponseData implements NowResponseData {
  ...
  @override
  String toString() {
    return 'NowResponse(cloud: $cloud, region: $region, wind_direction: $wind_direction, wind_mph: $wind_mph, daytime: $daytime, latitude: $latitude, longitude: $longitude, timezone: $timezone, wind_degree: $wind_degree, wind_kph: $wind_kph, country: $country, humidity: $humidity, icon_url: $icon_url, location: $location, temp_f: $temp_f, condition: $condition, feels_like_c: $feels_like_c, feels_like_f: $feels_like_f, local_time: $local_time, temp_c: $temp_c)';
  }
