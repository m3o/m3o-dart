...
class _$_Forecast implements _Forecast {
  ...
  @override
  String toString() {
    return 'Forecast(max_wind_mph: $max_wind_mph, min_temp_f: $min_temp_f, sunset: $sunset, max_wind_kph: $max_wind_kph, max_temp_c: $max_temp_c, condition: $condition, icon_url: $icon_url, sunrise: $sunrise, will_it_rain: $will_it_rain, avg_temp_c: $avg_temp_c, chance_of_rain: $chance_of_rain, date: $date, max_temp_f: $max_temp_f, min_temp_c: $min_temp_c, avg_temp_f: $avg_temp_f)';
  }
...
class _$NowResponseData implements NowResponseData {
  ...
  @override
  String toString() {
    return 'NowResponse(cloud: $cloud, daytime: $daytime, local_time: $local_time, temp_f: $temp_f, wind_direction: $wind_direction, feels_like_c: $feels_like_c, feels_like_f: $feels_like_f, latitude: $latitude, temp_c: $temp_c, region: $region, wind_degree: $wind_degree, wind_kph: $wind_kph, condition: $condition, country: $country, humidity: $humidity, location: $location, longitude: $longitude, wind_mph: $wind_mph, icon_url: $icon_url, timezone: $timezone)';
  }
