...
class _$_Forecast implements _Forecast {
  ...
  @override
  String toString() {
    return 'Forecast(avg_temp_f: $avg_temp_f, condition: $condition, max_wind_kph: $max_wind_kph, avg_temp_c: $avg_temp_c, date: $date, max_temp_f: $max_temp_f, max_wind_mph: $max_wind_mph, min_temp_c: $min_temp_c, sunrise: $sunrise, sunset: $sunset, will_it_rain: $will_it_rain, chance_of_rain: $chance_of_rain, icon_url: $icon_url, max_temp_c: $max_temp_c, min_temp_f: $min_temp_f)';
  }
...
class _$NowResponseData implements NowResponseData {
  ...
  @override
  String toString() {
    return 'NowResponse(cloud: $cloud, country: $country, humidity: $humidity, longitude: $longitude, timezone: $timezone, wind_mph: $wind_mph, condition: $condition, feels_like_f: $feels_like_f, region: $region, temp_f: $temp_f, wind_direction: $wind_direction, latitude: $latitude, wind_degree: $wind_degree, wind_kph: $wind_kph, daytime: $daytime, feels_like_c: $feels_like_c, icon_url: $icon_url, local_time: $local_time, location: $location, temp_c: $temp_c)';
  }
