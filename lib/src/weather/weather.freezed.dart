...
class _$_Forecast implements _Forecast {
  ...
  @override
  String toString() {
    return 'Forecast(avg_temp_c: $avg_temp_c, max_temp_f: $max_temp_f, max_wind_mph: $max_wind_mph, min_temp_c: $min_temp_c, chance_of_rain: $chance_of_rain, icon_url: $icon_url, max_temp_c: $max_temp_c, condition: $condition, max_wind_kph: $max_wind_kph, min_temp_f: $min_temp_f, sunrise: $sunrise, avg_temp_f: $avg_temp_f, date: $date, sunset: $sunset, will_it_rain: $will_it_rain)';
  }
...
class _$NowResponseData implements NowResponseData {
  ...
  @override
  String toString() {
    return 'NowResponse(feels_like_c: $feels_like_c, feels_like_f: $feels_like_f, humidity: $humidity, icon_url: $icon_url, temp_f: $temp_f, wind_kph: $wind_kph, condition: $condition, country: $country, temp_c: $temp_c, wind_direction: $wind_direction, wind_mph: $wind_mph, daytime: $daytime, longitude: $longitude, timezone: $timezone, local_time: $local_time, region: $region, location: $location, wind_degree: $wind_degree, cloud: $cloud, latitude: $latitude)';
  }
