...
class _$_Forecast implements _Forecast {
  ...
  @override
  String toString() {
    return 'Forecast(chance_of_rain: $chance_of_rain, sunrise: $sunrise, max_wind_mph: $max_wind_mph, min_temp_c: $min_temp_c, icon_url: $icon_url, max_temp_c: $max_temp_c, max_temp_f: $max_temp_f, min_temp_f: $min_temp_f, will_it_rain: $will_it_rain, avg_temp_f: $avg_temp_f, condition: $condition, max_wind_kph: $max_wind_kph, avg_temp_c: $avg_temp_c, date: $date, sunset: $sunset)';
  }
...
class _$NowResponseData implements NowResponseData {
  ...
  @override
  String toString() {
    return 'NowResponse(feels_like_c: $feels_like_c, humidity: $humidity, location: $location, region: $region, timezone: $timezone, wind_mph: $wind_mph, condition: $condition, longitude: $longitude, temp_c: $temp_c, temp_f: $temp_f, wind_degree: $wind_degree, wind_direction: $wind_direction, wind_kph: $wind_kph, cloud: $cloud, country: $country, daytime: $daytime, icon_url: $icon_url, latitude: $latitude, local_time: $local_time, feels_like_f: $feels_like_f)';
  }
