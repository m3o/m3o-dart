...
class _$_Forecast implements _Forecast {
  ...
  @override
  String toString() {
    return 'Forecast(max_temp_c: $max_temp_c, min_temp_f: $min_temp_f, condition: $condition, icon_url: $icon_url, max_wind_mph: $max_wind_mph, min_temp_c: $min_temp_c, avg_temp_c: $avg_temp_c, avg_temp_f: $avg_temp_f, sunset: $sunset, chance_of_rain: $chance_of_rain, date: $date, max_temp_f: $max_temp_f, max_wind_kph: $max_wind_kph, sunrise: $sunrise, will_it_rain: $will_it_rain)';
  }
...
class _$NowResponseData implements NowResponseData {
  ...
  @override
  String toString() {
    return 'NowResponse(daytime: $daytime, feels_like_f: $feels_like_f, icon_url: $icon_url, longitude: $longitude, region: $region, cloud: $cloud, condition: $condition, humidity: $humidity, latitude: $latitude, timezone: $timezone, feels_like_c: $feels_like_c, temp_f: $temp_f, wind_mph: $wind_mph, country: $country, local_time: $local_time, location: $location, temp_c: $temp_c, wind_degree: $wind_degree, wind_direction: $wind_direction, wind_kph: $wind_kph)';
  }
