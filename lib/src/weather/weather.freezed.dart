...
class _$_Forecast implements _Forecast {
  ...
  @override
  String toString() {
    return 'Forecast(icon_url: $icon_url, max_wind_mph: $max_wind_mph, min_temp_c: $min_temp_c, condition: $condition, max_wind_kph: $max_wind_kph, min_temp_f: $min_temp_f, avg_temp_f: $avg_temp_f, chance_of_rain: $chance_of_rain, date: $date, max_temp_c: $max_temp_c, max_temp_f: $max_temp_f, sunset: $sunset, avg_temp_c: $avg_temp_c, sunrise: $sunrise, will_it_rain: $will_it_rain)';
  }
...
class _$NowResponseData implements NowResponseData {
  ...
  @override
  String toString() {
    return 'NowResponse(country: $country, daytime: $daytime, local_time: $local_time, longitude: $longitude, temp_f: $temp_f, feels_like_f: $feels_like_f, icon_url: $icon_url, region: $region, wind_mph: $wind_mph, cloud: $cloud, condition: $condition, feels_like_c: $feels_like_c, latitude: $latitude, wind_degree: $wind_degree, humidity: $humidity, location: $location, temp_c: $temp_c, timezone: $timezone, wind_direction: $wind_direction, wind_kph: $wind_kph)';
  }
