...
class _$_Forecast implements _Forecast {
  ...
  @override
  String toString() {
    return 'Forecast(max_wind_mph: $max_wind_mph, min_temp_c: $min_temp_c, sunset: $sunset, condition: $condition, sunrise: $sunrise, icon_url: $icon_url, date: $date, max_temp_f: $max_temp_f, min_temp_f: $min_temp_f, will_it_rain: $will_it_rain, avg_temp_c: $avg_temp_c, chance_of_rain: $chance_of_rain, max_temp_c: $max_temp_c, max_wind_kph: $max_wind_kph, avg_temp_f: $avg_temp_f)';
  }
...
class _$NowResponseData implements NowResponseData {
  ...
  @override
  String toString() {
    return 'NowResponse(wind_kph: $wind_kph, daytime: $daytime, feels_like_f: $feels_like_f, humidity: $humidity, local_time: $local_time, temp_f: $temp_f, timezone: $timezone, latitude: $latitude, location: $location, longitude: $longitude, region: $region, condition: $condition, feels_like_c: $feels_like_c, icon_url: $icon_url, wind_direction: $wind_direction, cloud: $cloud, country: $country, temp_c: $temp_c, wind_degree: $wind_degree, wind_mph: $wind_mph)';
  }
