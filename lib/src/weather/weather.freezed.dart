...
class _$_Forecast implements _Forecast {
  ...
  @override
  String toString() {
    return 'Forecast(min_temp_f: $min_temp_f, sunset: $sunset, max_temp_c: $max_temp_c, max_wind_kph: $max_wind_kph, icon_url: $icon_url, max_wind_mph: $max_wind_mph, will_it_rain: $will_it_rain, avg_temp_f: $avg_temp_f, chance_of_rain: $chance_of_rain, sunrise: $sunrise, date: $date, max_temp_f: $max_temp_f, min_temp_c: $min_temp_c, avg_temp_c: $avg_temp_c, condition: $condition)';
  }
...
class _$NowResponseData implements NowResponseData {
  ...
  @override
  String toString() {
    return 'NowResponse(humidity: $humidity, location: $location, wind_kph: $wind_kph, cloud: $cloud, icon_url: $icon_url, latitude: $latitude, wind_degree: $wind_degree, wind_mph: $wind_mph, condition: $condition, daytime: $daytime, feels_like_c: $feels_like_c, feels_like_f: $feels_like_f, local_time: $local_time, timezone: $timezone, country: $country, longitude: $longitude, region: $region, temp_c: $temp_c, temp_f: $temp_f, wind_direction: $wind_direction)';
  }
