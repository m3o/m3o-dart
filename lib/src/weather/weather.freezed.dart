...
class _$_Forecast implements _Forecast {
  ...
  @override
  String toString() {
    return 'Forecast(avg_temp_f: $avg_temp_f, condition: $condition, max_wind_mph: $max_wind_mph, min_temp_c: $min_temp_c, min_temp_f: $min_temp_f, sunrise: $sunrise, will_it_rain: $will_it_rain, chance_of_rain: $chance_of_rain, max_temp_c: $max_temp_c, max_temp_f: $max_temp_f, icon_url: $icon_url, sunset: $sunset, avg_temp_c: $avg_temp_c, date: $date, max_wind_kph: $max_wind_kph)';
  }
...
class _$NowResponseData implements NowResponseData {
  ...
  @override
  String toString() {
    return 'NowResponse(condition: $condition, latitude: $latitude, local_time: $local_time, longitude: $longitude, temp_f: $temp_f, wind_mph: $wind_mph, humidity: $humidity, icon_url: $icon_url, wind_kph: $wind_kph, country: $country, daytime: $daytime, feels_like_c: $feels_like_c, feels_like_f: $feels_like_f, region: $region, timezone: $timezone, cloud: $cloud, location: $location, temp_c: $temp_c, wind_degree: $wind_degree, wind_direction: $wind_direction)';
  }
