...
class _$_Forecast implements _Forecast {
  ...
  @override
  String toString() {
    return 'Forecast(max_temp_f: $max_temp_f, max_wind_mph: $max_wind_mph, will_it_rain: $will_it_rain, avg_temp_c: $avg_temp_c, icon_url: $icon_url, sunrise: $sunrise, sunset: $sunset, date: $date, max_temp_c: $max_temp_c, max_wind_kph: $max_wind_kph, min_temp_c: $min_temp_c, min_temp_f: $min_temp_f, avg_temp_f: $avg_temp_f, chance_of_rain: $chance_of_rain, condition: $condition)';
  }
...
class _$NowResponseData implements NowResponseData {
  ...
  @override
  String toString() {
    return 'NowResponse(longitude: $longitude, wind_direction: $wind_direction, wind_mph: $wind_mph, icon_url: $icon_url, location: $location, region: $region, temp_c: $temp_c, condition: $condition, daytime: $daytime, feels_like_f: $feels_like_f, humidity: $humidity, temp_f: $temp_f, wind_kph: $wind_kph, feels_like_c: $feels_like_c, latitude: $latitude, local_time: $local_time, cloud: $cloud, country: $country, timezone: $timezone, wind_degree: $wind_degree)';
  }
