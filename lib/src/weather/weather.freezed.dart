...
class _$_Forecast implements _Forecast {
  ...
  @override
  String toString() {
    return 'Forecast(max_temp_c: $max_temp_c, min_temp_f: $min_temp_f, will_it_rain: $will_it_rain, sunrise: $sunrise, avg_temp_c: $avg_temp_c, condition: $condition, max_temp_f: $max_temp_f, sunset: $sunset, chance_of_rain: $chance_of_rain, date: $date, max_wind_kph: $max_wind_kph, min_temp_c: $min_temp_c, avg_temp_f: $avg_temp_f, icon_url: $icon_url, max_wind_mph: $max_wind_mph)';
  }
...
class _$NowResponseData implements NowResponseData {
  ...
  @override
  String toString() {
    return 'NowResponse(wind_degree: $wind_degree, wind_mph: $wind_mph, condition: $condition, daytime: $daytime, humidity: $humidity, local_time: $local_time, location: $location, timezone: $timezone, icon_url: $icon_url, longitude: $longitude, region: $region, cloud: $cloud, country: $country, feels_like_c: $feels_like_c, temp_c: $temp_c, temp_f: $temp_f, feels_like_f: $feels_like_f, latitude: $latitude, wind_direction: $wind_direction, wind_kph: $wind_kph)';
  }
