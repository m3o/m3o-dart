...
class _$_Forecast implements _Forecast {
  ...
  @override
  String toString() {
    return 'Forecast(icon_url: $icon_url, max_wind_mph: $max_wind_mph, condition: $condition, min_temp_c: $min_temp_c, sunset: $sunset, date: $date, max_temp_c: $max_temp_c, max_wind_kph: $max_wind_kph, avg_temp_c: $avg_temp_c, avg_temp_f: $avg_temp_f, chance_of_rain: $chance_of_rain, will_it_rain: $will_it_rain, max_temp_f: $max_temp_f, min_temp_f: $min_temp_f, sunrise: $sunrise)';
  }
...
class _$NowResponseData implements NowResponseData {
  ...
  @override
  String toString() {
    return 'NowResponse(cloud: $cloud, daytime: $daytime, icon_url: $icon_url, temp_c: $temp_c, wind_kph: $wind_kph, feels_like_c: $feels_like_c, humidity: $humidity, longitude: $longitude, region: $region, wind_direction: $wind_direction, wind_mph: $wind_mph, condition: $condition, feels_like_f: $feels_like_f, timezone: $timezone, country: $country, latitude: $latitude, local_time: $local_time, location: $location, temp_f: $temp_f, wind_degree: $wind_degree)';
  }
