...
class _$_Forecast implements _Forecast {
  ...
  @override
  String toString() {
    return 'Forecast(avg_temp_c: $avg_temp_c, chance_of_rain: $chance_of_rain, max_temp_f: $max_temp_f, min_temp_c: $min_temp_c, sunrise: $sunrise, max_temp_c: $max_temp_c, will_it_rain: $will_it_rain, condition: $condition, date: $date, icon_url: $icon_url, max_wind_kph: $max_wind_kph, max_wind_mph: $max_wind_mph, sunset: $sunset, avg_temp_f: $avg_temp_f, min_temp_f: $min_temp_f)';
  }
...
class _$NowResponseData implements NowResponseData {
  ...
  @override
  String toString() {
    return 'NowResponse(icon_url: $icon_url, latitude: $latitude, wind_degree: $wind_degree, wind_kph: $wind_kph, region: $region, temp_c: $temp_c, wind_direction: $wind_direction, cloud: $cloud, country: $country, humidity: $humidity, location: $location, feels_like_f: $feels_like_f, local_time: $local_time, longitude: $longitude, timezone: $timezone, wind_mph: $wind_mph, condition: $condition, daytime: $daytime, feels_like_c: $feels_like_c, temp_f: $temp_f)';
  }
