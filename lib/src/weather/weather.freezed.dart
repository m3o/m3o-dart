...
class _$_Forecast implements _Forecast {
  ...
  @override
  String toString() {
    return 'Forecast(icon_url: $icon_url, chance_of_rain: $chance_of_rain, avg_temp_c: $avg_temp_c, max_temp_c: $max_temp_c, max_temp_f: $max_temp_f, max_wind_mph: $max_wind_mph, min_temp_f: $min_temp_f, sunset: $sunset, will_it_rain: $will_it_rain, condition: $condition, date: $date, max_wind_kph: $max_wind_kph, min_temp_c: $min_temp_c, sunrise: $sunrise, avg_temp_f: $avg_temp_f)';
  }
...
class _$NowResponseData implements NowResponseData {
  ...
  @override
  String toString() {
    return 'NowResponse(wind_kph: $wind_kph, country: $country, local_time: $local_time, region: $region, temp_c: $temp_c, wind_degree: $wind_degree, daytime: $daytime, feels_like_c: $feels_like_c, icon_url: $icon_url, timezone: $timezone, temp_f: $temp_f, wind_direction: $wind_direction, cloud: $cloud, humidity: $humidity, latitude: $latitude, location: $location, condition: $condition, feels_like_f: $feels_like_f, longitude: $longitude, wind_mph: $wind_mph)';
  }
