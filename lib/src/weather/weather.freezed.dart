...
class _$_Forecast implements _Forecast {
  ...
  @override
  String toString() {
    return 'Forecast(will_it_rain: $will_it_rain, condition: $condition, date: $date, max_temp_f: $max_temp_f, max_wind_kph: $max_wind_kph, min_temp_f: $min_temp_f, sunrise: $sunrise, avg_temp_c: $avg_temp_c, chance_of_rain: $chance_of_rain, icon_url: $icon_url, max_temp_c: $max_temp_c, min_temp_c: $min_temp_c, sunset: $sunset, avg_temp_f: $avg_temp_f, max_wind_mph: $max_wind_mph)';
  }
...
class _$NowResponseData implements NowResponseData {
  ...
  @override
  String toString() {
    return 'NowResponse(temp_f: $temp_f, icon_url: $icon_url, temp_c: $temp_c, wind_mph: $wind_mph, humidity: $humidity, region: $region, feels_like_c: $feels_like_c, location: $location, wind_degree: $wind_degree, wind_kph: $wind_kph, cloud: $cloud, country: $country, feels_like_f: $feels_like_f, latitude: $latitude, local_time: $local_time, longitude: $longitude, timezone: $timezone, wind_direction: $wind_direction, condition: $condition, daytime: $daytime)';
  }
