...
class _$_Forecast implements _Forecast {
  ...
  @override
  String toString() {
    return 'Forecast(date: $date, min_temp_c: $min_temp_c, min_temp_f: $min_temp_f, sunrise: $sunrise, sunset: $sunset, will_it_rain: $will_it_rain, avg_temp_c: $avg_temp_c, avg_temp_f: $avg_temp_f, condition: $condition, icon_url: $icon_url, max_temp_f: $max_temp_f, max_wind_kph: $max_wind_kph, chance_of_rain: $chance_of_rain, max_temp_c: $max_temp_c, max_wind_mph: $max_wind_mph)';
  }
...
class _$NowResponseData implements NowResponseData {
  ...
  @override
  String toString() {
    return 'NowResponse(wind_direction: $wind_direction, country: $country, icon_url: $icon_url, feels_like_f: $feels_like_f, humidity: $humidity, latitude: $latitude, longitude: $longitude, region: $region, temp_c: $temp_c, condition: $condition, daytime: $daytime, wind_degree: $wind_degree, location: $location, timezone: $timezone, cloud: $cloud, local_time: $local_time, wind_kph: $wind_kph, wind_mph: $wind_mph, feels_like_c: $feels_like_c, temp_f: $temp_f)';
  }
