...
class _$_Forecast implements _Forecast {
  ...
  @override
  String toString() {
    return 'Forecast(will_it_rain: $will_it_rain, condition: $condition, date: $date, icon_url: $icon_url, max_temp_c: $max_temp_c, max_wind_mph: $max_wind_mph, min_temp_f: $min_temp_f, sunrise: $sunrise, avg_temp_f: $avg_temp_f, max_temp_f: $max_temp_f, max_wind_kph: $max_wind_kph, avg_temp_c: $avg_temp_c, min_temp_c: $min_temp_c, sunset: $sunset, chance_of_rain: $chance_of_rain)';
  }
...
class _$NowResponseData implements NowResponseData {
  ...
  @override
  String toString() {
    return 'NowResponse(longitude: $longitude, temp_f: $temp_f, timezone: $timezone, condition: $condition, country: $country, feels_like_f: $feels_like_f, humidity: $humidity, icon_url: $icon_url, cloud: $cloud, daytime: $daytime, latitude: $latitude, location: $location, wind_degree: $wind_degree, local_time: $local_time, region: $region, wind_direction: $wind_direction, wind_mph: $wind_mph, feels_like_c: $feels_like_c, temp_c: $temp_c, wind_kph: $wind_kph)';
  }
