...
class _$_Forecast implements _Forecast {
  ...
  @override
  String toString() {
    return 'Forecast(condition: $condition, date: $date, icon_url: $icon_url, max_temp_f: $max_temp_f, sunset: $sunset, avg_temp_c: $avg_temp_c, min_temp_c: $min_temp_c, min_temp_f: $min_temp_f, sunrise: $sunrise, max_wind_mph: $max_wind_mph, chance_of_rain: $chance_of_rain, max_wind_kph: $max_wind_kph, will_it_rain: $will_it_rain, avg_temp_f: $avg_temp_f, max_temp_c: $max_temp_c)';
  }
...
class _$NowResponseData implements NowResponseData {
  ...
  @override
  String toString() {
    return 'NowResponse(cloud: $cloud, temp_c: $temp_c, timezone: $timezone, feels_like_c: $feels_like_c, location: $location, wind_kph: $wind_kph, humidity: $humidity, longitude: $longitude, region: $region, wind_degree: $wind_degree, icon_url: $icon_url, latitude: $latitude, local_time: $local_time, temp_f: $temp_f, condition: $condition, country: $country, daytime: $daytime, feels_like_f: $feels_like_f, wind_direction: $wind_direction, wind_mph: $wind_mph)';
  }
