...
class _$_Forecast implements _Forecast {
  ...
  @override
  String toString() {
    return 'Forecast(chance_of_rain: $chance_of_rain, date: $date, icon_url: $icon_url, max_wind_kph: $max_wind_kph, sunset: $sunset, avg_temp_f: $avg_temp_f, min_temp_c: $min_temp_c, condition: $condition, max_wind_mph: $max_wind_mph, sunrise: $sunrise, will_it_rain: $will_it_rain, avg_temp_c: $avg_temp_c, max_temp_c: $max_temp_c, max_temp_f: $max_temp_f, min_temp_f: $min_temp_f)';
  }
...
class _$NowResponseData implements NowResponseData {
  ...
  @override
  String toString() {
    return 'NowResponse(country: $country, latitude: $latitude, location: $location, longitude: $longitude, feels_like_f: $feels_like_f, humidity: $humidity, icon_url: $icon_url, temp_c: $temp_c, wind_kph: $wind_kph, cloud: $cloud, local_time: $local_time, region: $region, timezone: $timezone, wind_mph: $wind_mph, condition: $condition, daytime: $daytime, feels_like_c: $feels_like_c, temp_f: $temp_f, wind_degree: $wind_degree, wind_direction: $wind_direction)';
  }
