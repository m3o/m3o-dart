...
class _$_Forecast implements _Forecast {
  ...
  @override
  String toString() {
    return 'Forecast(chance_of_rain: $chance_of_rain, condition: $condition, max_temp_c: $max_temp_c, avg_temp_c: $avg_temp_c, will_it_rain: $will_it_rain, avg_temp_f: $avg_temp_f, date: $date, max_temp_f: $max_temp_f, max_wind_kph: $max_wind_kph, max_wind_mph: $max_wind_mph, min_temp_f: $min_temp_f, sunrise: $sunrise, sunset: $sunset, icon_url: $icon_url, min_temp_c: $min_temp_c)';
  }
...
class _$NowResponseData implements NowResponseData {
  ...
  @override
  String toString() {
    return 'NowResponse(condition: $condition, feels_like_c: $feels_like_c, longitude: $longitude, wind_degree: $wind_degree, icon_url: $icon_url, temp_c: $temp_c, temp_f: $temp_f, timezone: $timezone, wind_kph: $wind_kph, region: $region, wind_mph: $wind_mph, daytime: $daytime, feels_like_f: $feels_like_f, humidity: $humidity, latitude: $latitude, local_time: $local_time, cloud: $cloud, country: $country, location: $location, wind_direction: $wind_direction)';
  }
