...
class _$_Forecast implements _Forecast {
  ...
  @override
  String toString() {
    return 'Forecast(max_temp_f: $max_temp_f, sunset: $sunset, icon_url: $icon_url, avg_temp_f: $avg_temp_f, condition: $condition, sunrise: $sunrise, will_it_rain: $will_it_rain, avg_temp_c: $avg_temp_c, max_temp_c: $max_temp_c, max_wind_mph: $max_wind_mph, min_temp_c: $min_temp_c, date: $date, max_wind_kph: $max_wind_kph, min_temp_f: $min_temp_f, chance_of_rain: $chance_of_rain)';
  }
...
class _$NowResponseData implements NowResponseData {
  ...
  @override
  String toString() {
    return 'NowResponse(timezone: $timezone, wind_kph: $wind_kph, icon_url: $icon_url, local_time: $local_time, temp_c: $temp_c, wind_direction: $wind_direction, feels_like_c: $feels_like_c, longitude: $longitude, region: $region, wind_degree: $wind_degree, cloud: $cloud, daytime: $daytime, feels_like_f: $feels_like_f, humidity: $humidity, latitude: $latitude, location: $location, temp_f: $temp_f, wind_mph: $wind_mph, condition: $condition, country: $country)';
  }
