...
class _$_Forecast implements _Forecast {
  ...
  @override
  String toString() {
    return 'Forecast(max_wind_mph: $max_wind_mph, will_it_rain: $will_it_rain, avg_temp_f: $avg_temp_f, chance_of_rain: $chance_of_rain, condition: $condition, min_temp_f: $min_temp_f, sunrise: $sunrise, max_temp_c: $max_temp_c, max_temp_f: $max_temp_f, max_wind_kph: $max_wind_kph, avg_temp_c: $avg_temp_c, date: $date, icon_url: $icon_url, min_temp_c: $min_temp_c, sunset: $sunset)';
  }
...
class _$NowResponseData implements NowResponseData {
  ...
  @override
  String toString() {
    return 'NowResponse(location: $location, region: $region, timezone: $timezone, wind_kph: $wind_kph, wind_mph: $wind_mph, daytime: $daytime, icon_url: $icon_url, longitude: $longitude, humidity: $humidity, temp_c: $temp_c, wind_direction: $wind_direction, cloud: $cloud, country: $country, feels_like_c: $feels_like_c, local_time: $local_time, temp_f: $temp_f, wind_degree: $wind_degree, condition: $condition, feels_like_f: $feels_like_f, latitude: $latitude)';
  }
