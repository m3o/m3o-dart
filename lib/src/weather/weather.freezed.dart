...
class _$_Forecast implements _Forecast {
  ...
  @override
  String toString() {
    return 'Forecast(avg_temp_c: $avg_temp_c, avg_temp_f: $avg_temp_f, icon_url: $icon_url, chance_of_rain: $chance_of_rain, sunset: $sunset, condition: $condition, date: $date, max_temp_c: $max_temp_c, max_wind_kph: $max_wind_kph, sunrise: $sunrise, will_it_rain: $will_it_rain, max_temp_f: $max_temp_f, max_wind_mph: $max_wind_mph, min_temp_c: $min_temp_c, min_temp_f: $min_temp_f)';
  }
...
class _$NowResponseData implements NowResponseData {
  ...
  @override
  String toString() {
    return 'NowResponse(country: $country, daytime: $daytime, wind_degree: $wind_degree, wind_kph: $wind_kph, wind_mph: $wind_mph, feels_like_c: $feels_like_c, humidity: $humidity, local_time: $local_time, timezone: $timezone, wind_direction: $wind_direction, icon_url: $icon_url, temp_c: $temp_c, longitude: $longitude, region: $region, temp_f: $temp_f, cloud: $cloud, condition: $condition, feels_like_f: $feels_like_f, latitude: $latitude, location: $location)';
  }
