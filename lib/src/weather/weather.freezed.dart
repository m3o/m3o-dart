...
class _$_Forecast implements _Forecast {
  ...
  @override
  String toString() {
    return 'Forecast(chance_of_rain: $chance_of_rain, icon_url: $icon_url, max_wind_mph: $max_wind_mph, min_temp_f: $min_temp_f, date: $date, min_temp_c: $min_temp_c, avg_temp_c: $avg_temp_c, avg_temp_f: $avg_temp_f, max_temp_c: $max_temp_c, sunrise: $sunrise, will_it_rain: $will_it_rain, condition: $condition, max_temp_f: $max_temp_f, max_wind_kph: $max_wind_kph, sunset: $sunset)';
  }
...
class _$NowResponseData implements NowResponseData {
  ...
  @override
  String toString() {
    return 'NowResponse(country: $country, feels_like_f: $feels_like_f, region: $region, temp_c: $temp_c, wind_degree: $wind_degree, wind_kph: $wind_kph, condition: $condition, daytime: $daytime, feels_like_c: $feels_like_c, humidity: $humidity, longitude: $longitude, cloud: $cloud, latitude: $latitude, location: $location, wind_mph: $wind_mph, icon_url: $icon_url, local_time: $local_time, temp_f: $temp_f, timezone: $timezone, wind_direction: $wind_direction)';
  }
