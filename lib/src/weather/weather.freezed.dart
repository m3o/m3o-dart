...
class _$_Forecast implements _Forecast {
  ...
  @override
  String toString() {
    return 'Forecast(max_wind_kph: $max_wind_kph, will_it_rain: $will_it_rain, avg_temp_c: $avg_temp_c, date: $date, sunset: $sunset, sunrise: $sunrise, avg_temp_f: $avg_temp_f, chance_of_rain: $chance_of_rain, condition: $condition, icon_url: $icon_url, max_temp_c: $max_temp_c, min_temp_c: $min_temp_c, min_temp_f: $min_temp_f, max_temp_f: $max_temp_f, max_wind_mph: $max_wind_mph)';
  }
...
class _$NowResponseData implements NowResponseData {
  ...
  @override
  String toString() {
    return 'NowResponse(temp_f: $temp_f, wind_direction: $wind_direction, wind_kph: $wind_kph, location: $location, temp_c: $temp_c, region: $region, timezone: $timezone, wind_mph: $wind_mph, feels_like_c: $feels_like_c, feels_like_f: $feels_like_f, local_time: $local_time, humidity: $humidity, icon_url: $icon_url, country: $country, daytime: $daytime, latitude: $latitude, longitude: $longitude, wind_degree: $wind_degree, cloud: $cloud, condition: $condition)';
  }
