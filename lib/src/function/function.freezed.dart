...
class _$_DeployRequest implements _DeployRequest {
  ...
  @override
  String toString() {
    return 'DeployRequest(region: $region, repo: $repo, runtime: $runtime, source: $source, subfolder: $subfolder, branch: $branch, entrypoint: $entrypoint, env_vars: $env_vars, name: $name)';
  }
...
abstract class _DeployRequest implements DeployRequest {
  const factory _DeployRequest(
      ...
      final String? entrypoint,
      final Map<String, String>? env_vars,
      final String? name}) = _$_DeployRequest;
...
class _$_Func implements _Func {
  ...
  @override
  String toString() {
    return 'Func(region: $region, source: $source, url: $url, updated: $updated, created: $created, id: $id, repo: $repo, subfolder: $subfolder, entrypoint: $entrypoint, name: $name, runtime: $runtime, branch: $branch, env_vars: $env_vars, status: $status)';
  }
