...
class _$_DeployRequest implements _DeployRequest {
  ...
  @override
  String toString() {
    return 'DeployRequest(env_vars: $env_vars, region: $region, repo: $repo, runtime: $runtime, branch: $branch, entrypoint: $entrypoint, subfolder: $subfolder, name: $name, source: $source)';
  }
...
class _$_Func implements _Func {
  ...
  @override
  String toString() {
    return 'Func(created: $created, region: $region, repo: $repo, source: $source, updated: $updated, branch: $branch, entrypoint: $entrypoint, env_vars: $env_vars, runtime: $runtime, subfolder: $subfolder, url: $url, id: $id, name: $name, status: $status)';
  }
