...
class _$_DeployRequest implements _DeployRequest {
  ...
  @override
  String toString() {
    return 'DeployRequest(runtime: $runtime, source: $source, name: $name, region: $region, repo: $repo, subfolder: $subfolder, branch: $branch, entrypoint: $entrypoint, env_vars: $env_vars)';
  }
...
class _$_Func implements _Func {
  ...
  @override
  String toString() {
    return 'Func(subfolder: $subfolder, url: $url, entrypoint: $entrypoint, env_vars: $env_vars, name: $name, runtime: $runtime, status: $status, updated: $updated, branch: $branch, created: $created, id: $id, region: $region, repo: $repo, source: $source)';
  }
