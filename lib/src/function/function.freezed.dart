...
class _$_DeployRequest implements _DeployRequest {
  ...
  @override
  String toString() {
    return 'DeployRequest(repo: $repo, runtime: $runtime, subfolder: $subfolder, branch: $branch, entrypoint: $entrypoint, region: $region, env_vars: $env_vars, name: $name, source: $source)';
  }
...
class _$_Func implements _Func {
  ...
  @override
  String toString() {
    return 'Func(runtime: $runtime, source: $source, updated: $updated, branch: $branch, created: $created, id: $id, name: $name, entrypoint: $entrypoint, env_vars: $env_vars, region: $region, status: $status, subfolder: $subfolder, url: $url, repo: $repo)';
  }
