...
class _$_Func implements _Func {
  ...
  @override
  String toString() {
    return 'Func(branch: $branch, runtime: $runtime, source: $source, id: $id, region: $region, updated: $updated, url: $url, created: $created, status: $status, subfolder: $subfolder, entrypoint: $entrypoint, env_vars: $env_vars, name: $name, repo: $repo)';
  }
