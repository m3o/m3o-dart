...
class _$_DeployRequest implements _DeployRequest {
  ...
  @override
  String toString() {
    return 'DeployRequest(entrypoint: $entrypoint, repo: $repo, runtime: $runtime, branch: $branch, env_vars: $env_vars, name: $name, region: $region, source: $source, subfolder: $subfolder)';
  }
...
class _$_Func implements _Func {
  ...
  @override
  String toString() {
    return 'Func(env_vars: $env_vars, name: $name, region: $region, status: $status, subfolder: $subfolder, updated: $updated, url: $url, branch: $branch, entrypoint: $entrypoint, source: $source, created: $created, id: $id, repo: $repo, runtime: $runtime)';
  }
