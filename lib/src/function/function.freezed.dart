...
class _$_DeployRequest implements _DeployRequest {
  ...
  @override
  String toString() {
    return 'DeployRequest(runtime: $runtime, env_vars: $env_vars, entrypoint: $entrypoint, name: $name, region: $region, repo: $repo, source: $source, subfolder: $subfolder, branch: $branch)';
  }
...
class _$_Func implements _Func {
  ...
  @override
  String toString() {
    return 'Func(id: $id, name: $name, updated: $updated, url: $url, branch: $branch, created: $created, env_vars: $env_vars, runtime: $runtime, source: $source, subfolder: $subfolder, repo: $repo, status: $status, entrypoint: $entrypoint, region: $region)';
  }
