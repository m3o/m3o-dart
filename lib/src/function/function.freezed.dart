...
class _$_Func implements _Func {
  ...
  @override
  String toString() {
    return 'Func(branch: $branch, entrypoint: $entrypoint, env_vars: $env_vars, runtime: $runtime, status: $status, created: $created, name: $name, repo: $repo, source: $source, id: $id, subfolder: $subfolder, url: $url, region: $region, updated: $updated)';
  }
