...
class _$_DeployRequest implements _DeployRequest {
  ...
  @override
  String toString() {
    return 'DeployRequest(region: $region, repo: $repo, runtime: $runtime, source: $source, env_vars: $env_vars, entrypoint: $entrypoint, name: $name, subfolder: $subfolder, branch: $branch)';
  }
...
class _$_Func implements _Func {
  ...
  @override
  String toString() {
    return 'Func(source: $source, name: $name, runtime: $runtime, entrypoint: $entrypoint, id: $id, subfolder: $subfolder, url: $url, branch: $branch, created: $created, repo: $repo, status: $status, updated: $updated, env_vars: $env_vars, region: $region)';
  }
