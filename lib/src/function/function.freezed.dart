...
class _$_DeployRequest implements _DeployRequest {
  ...
  @override
  String toString() {
    return 'DeployRequest(subfolder: $subfolder, branch: $branch, repo: $repo, runtime: $runtime, source: $source, entrypoint: $entrypoint, env_vars: $env_vars, name: $name, region: $region)';
  }
...
class _$_Func implements _Func {
  ...
  @override
  String toString() {
    return 'Func(branch: $branch, env_vars: $env_vars, repo: $repo, subfolder: $subfolder, url: $url, name: $name, region: $region, runtime: $runtime, source: $source, created: $created, status: $status, updated: $updated, entrypoint: $entrypoint, id: $id)';
  }
