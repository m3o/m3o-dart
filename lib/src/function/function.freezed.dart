...
class _$_DeployRequest implements _DeployRequest {
  ...
  @override
  String toString() {
    return 'DeployRequest(entrypoint: $entrypoint, env_vars: $env_vars, name: $name, repo: $repo, runtime: $runtime, branch: $branch, region: $region, source: $source, subfolder: $subfolder)';
  }
...
class _$_Func implements _Func {
  ...
  @override
  String toString() {
    return 'Func(id: $id, updated: $updated, url: $url, branch: $branch, env_vars: $env_vars, name: $name, region: $region, runtime: $runtime, subfolder: $subfolder, created: $created, source: $source, status: $status, entrypoint: $entrypoint, repo: $repo)';
  }
