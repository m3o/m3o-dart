...
class _$_DeployRequest implements _DeployRequest {
  ...
  @override
  String toString() {
    return 'DeployRequest(source: $source, entrypoint: $entrypoint, env_vars: $env_vars, region: $region, runtime: $runtime, subfolder: $subfolder, branch: $branch, name: $name, repo: $repo)';
  }
...
class _$_Func implements _Func {
  ...
  @override
  String toString() {
    return 'Func(runtime: $runtime, status: $status, subfolder: $subfolder, branch: $branch, env_vars: $env_vars, source: $source, url: $url, id: $id, name: $name, region: $region, updated: $updated, created: $created, entrypoint: $entrypoint, repo: $repo)';
  }
