...
class _$_DeployRequest implements _DeployRequest {
  ...
  @override
  String toString() {
    return 'DeployRequest(source: $source, branch: $branch, entrypoint: $entrypoint, repo: $repo, runtime: $runtime, env_vars: $env_vars, name: $name, region: $region, subfolder: $subfolder)';
  }
...
class _$_Func implements _Func {
  ...
  @override
  String toString() {
    return 'Func(created: $created, entrypoint: $entrypoint, repo: $repo, status: $status, subfolder: $subfolder, updated: $updated, url: $url, branch: $branch, name: $name, id: $id, runtime: $runtime, env_vars: $env_vars, region: $region, source: $source)';
  }
