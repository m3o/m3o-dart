...
class _$_DeployRequest implements _DeployRequest {
  ...
  @override
  String toString() {
    return 'DeployRequest(repo: $repo, runtime: $runtime, name: $name, region: $region, env_vars: $env_vars, source: $source, subfolder: $subfolder, branch: $branch, entrypoint: $entrypoint)';
  }
...
class _$_Func implements _Func {
  ...
  @override
  String toString() {
    return 'Func(entrypoint: $entrypoint, status: $status, env_vars: $env_vars, name: $name, region: $region, repo: $repo, subfolder: $subfolder, created: $created, updated: $updated, branch: $branch, id: $id, runtime: $runtime, source: $source, url: $url)';
  }
