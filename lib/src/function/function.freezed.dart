...
class _$_DeployRequest implements _DeployRequest {
  ...
  @override
  String toString() {
    return 'DeployRequest(branch: $branch, env_vars: $env_vars, runtime: $runtime, entrypoint: $entrypoint, name: $name, region: $region, repo: $repo, source: $source, subfolder: $subfolder)';
  }
...
class _$_Func implements _Func {
  ...
  @override
  String toString() {
    return 'Func(url: $url, branch: $branch, name: $name, runtime: $runtime, updated: $updated, env_vars: $env_vars, id: $id, status: $status, entrypoint: $entrypoint, source: $source, created: $created, region: $region, repo: $repo, subfolder: $subfolder)';
  }
