...
class _$_DeployRequest implements _DeployRequest {
  ...
  @override
  String toString() {
    return 'DeployRequest(name: $name, region: $region, runtime: $runtime, source: $source, branch: $branch, entrypoint: $entrypoint, env_vars: $env_vars, repo: $repo, subfolder: $subfolder)';
  }
...
class _$_Func implements _Func {
  ...
  @override
  String toString() {
    return 'Func(url: $url, entrypoint: $entrypoint, runtime: $runtime, source: $source, status: $status, subfolder: $subfolder, created: $created, env_vars: $env_vars, name: $name, updated: $updated, branch: $branch, region: $region, repo: $repo, id: $id)';
  }
