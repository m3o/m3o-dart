...
class _$_DeployRequest implements _DeployRequest {
  ...
  @override
  String toString() {
    return 'DeployRequest(region: $region, repo: $repo, source: $source, branch: $branch, env_vars: $env_vars, name: $name, entrypoint: $entrypoint, runtime: $runtime, subfolder: $subfolder)';
  }
...
class _$_Func implements _Func {
  ...
  @override
  String toString() {
    return 'Func(branch: $branch, env_vars: $env_vars, updated: $updated, repo: $repo, runtime: $runtime, url: $url, created: $created, entrypoint: $entrypoint, id: $id, name: $name, status: $status, subfolder: $subfolder, region: $region, source: $source)';
  }
