...
class _$_DeployRequest implements _DeployRequest {
  ...
  @override
  String toString() {
    return 'DeployRequest(source: $source, subfolder: $subfolder, region: $region, repo: $repo, runtime: $runtime, name: $name, branch: $branch, entrypoint: $entrypoint, env_vars: $env_vars)';
  }
...
class _$_Func implements _Func {
  ...
  @override
  String toString() {
    return 'Func(created: $created, entrypoint: $entrypoint, env_vars: $env_vars, region: $region, source: $source, subfolder: $subfolder, branch: $branch, status: $status, url: $url, name: $name, repo: $repo, runtime: $runtime, updated: $updated, id: $id)';
  }
