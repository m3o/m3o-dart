...
class _$_DeployRequest implements _DeployRequest {
  ...
  @override
  String toString() {
    return 'DeployRequest(subfolder: $subfolder, entrypoint: $entrypoint, region: $region, name: $name, repo: $repo, runtime: $runtime, source: $source, branch: $branch, env_vars: $env_vars)';
  }
...
class _$_Func implements _Func {
  ...
  @override
  String toString() {
    return 'Func(env_vars: $env_vars, source: $source, branch: $branch, entrypoint: $entrypoint, status: $status, url: $url, created: $created, name: $name, region: $region, subfolder: $subfolder, id: $id, repo: $repo, runtime: $runtime, updated: $updated)';
  }
