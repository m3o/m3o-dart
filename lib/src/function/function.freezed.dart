...
class _$_DeployRequest implements _DeployRequest {
  ...
  @override
  String toString() {
    return 'DeployRequest(runtime: $runtime, source: $source, subfolder: $subfolder, name: $name, region: $region, env_vars: $env_vars, repo: $repo, branch: $branch, entrypoint: $entrypoint)';
  }
...
class _$_Func implements _Func {
  ...
  @override
  String toString() {
    return 'Func(repo: $repo, source: $source, region: $region, runtime: $runtime, status: $status, branch: $branch, created: $created, env_vars: $env_vars, name: $name, entrypoint: $entrypoint, id: $id, subfolder: $subfolder, url: $url, updated: $updated)';
  }
