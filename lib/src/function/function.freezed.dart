...
class _$_DeployRequest implements _DeployRequest {
  ...
  @override
  String toString() {
    return 'DeployRequest(branch: $branch, entrypoint: $entrypoint, env_vars: $env_vars, name: $name, runtime: $runtime, source: $source, subfolder: $subfolder, region: $region, repo: $repo)';
  }
...
class _$_Func implements _Func {
  ...
  @override
  String toString() {
    return 'Func(status: $status, updated: $updated, created: $created, name: $name, repo: $repo, source: $source, id: $id, entrypoint: $entrypoint, env_vars: $env_vars, subfolder: $subfolder, branch: $branch, runtime: $runtime, url: $url, region: $region)';
  }
