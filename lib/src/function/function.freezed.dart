...
class _$_Func implements _Func {
  ...
  @override
  String toString() {
    return 'Func(entrypoint: $entrypoint, env_vars: $env_vars, runtime: $runtime, name: $name, region: $region, source: $source, status: $status, subfolder: $subfolder, id: $id, updated: $updated, branch: $branch, created: $created, repo: $repo, url: $url)';
  }
