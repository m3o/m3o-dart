...
class _$_DeployRequest implements _DeployRequest {
  ...
  @override
  String toString() {
    return 'DeployRequest(env_vars: $env_vars, region: $region, repo: $repo, runtime: $runtime, subfolder: $subfolder, branch: $branch, entrypoint: $entrypoint, name: $name, source: $source)';
  }
...
class _$_Func implements _Func {
  ...
  @override
  String toString() {
    return 'Func(region: $region, env_vars: $env_vars, repo: $repo, runtime: $runtime, updated: $updated, status: $status, url: $url, branch: $branch, created: $created, entrypoint: $entrypoint, id: $id, name: $name, source: $source, subfolder: $subfolder)';
  }
