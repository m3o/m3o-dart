...
class _$_DeployRequest implements _DeployRequest {
  ...
  @override
  String toString() {
    return 'DeployRequest(region: $region, repo: $repo, source: $source, subfolder: $subfolder, entrypoint: $entrypoint, env_vars: $env_vars, name: $name, branch: $branch, runtime: $runtime)';
  }
...
class _$_Func implements _Func {
  ...
  @override
  String toString() {
    return 'Func(id: $id, region: $region, source: $source, branch: $branch, subfolder: $subfolder, status: $status, updated: $updated, created: $created, name: $name, runtime: $runtime, url: $url, entrypoint: $entrypoint, env_vars: $env_vars, repo: $repo)';
  }
