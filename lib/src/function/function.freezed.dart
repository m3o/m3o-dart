...
class _$_DeployRequest implements _DeployRequest {
  ...
  @override
  String toString() {
    return 'DeployRequest(branch: $branch, entrypoint: $entrypoint, runtime: $runtime, subfolder: $subfolder, env_vars: $env_vars, name: $name, region: $region, repo: $repo, source: $source)';
  }
...
class _$_Func implements _Func {
  ...
  @override
  String toString() {
    return 'Func(status: $status, url: $url, created: $created, id: $id, repo: $repo, subfolder: $subfolder, updated: $updated, branch: $branch, entrypoint: $entrypoint, name: $name, region: $region, source: $source, env_vars: $env_vars, runtime: $runtime)';
  }
