...
class _$_Func implements _Func {
  ...
  @override
  String toString() {
    return 'Func(runtime: $runtime, entrypoint: $entrypoint, env_vars: $env_vars, status: $status, subfolder: $subfolder, branch: $branch, id: $id, updated: $updated, created: $created, source: $source, repo: $repo, url: $url, name: $name, region: $region)';
  }
