...
class _$_DeployRequest implements _DeployRequest {
  ...
  @override
  String toString() {
    return 'DeployRequest(entrypoint: $entrypoint, env_vars: $env_vars, name: $name, repo: $repo, source: $source, branch: $branch, region: $region, runtime: $runtime, subfolder: $subfolder)';
  }
...
class _$_Func implements _Func {
  ...
  @override
  String toString() {
    return 'Func(branch: $branch, runtime: $runtime, id: $id, status: $status, updated: $updated, created: $created, name: $name, region: $region, repo: $repo, subfolder: $subfolder, url: $url, entrypoint: $entrypoint, env_vars: $env_vars, source: $source)';
  }
