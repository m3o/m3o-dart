...
class _$_DeployRequest implements _DeployRequest {
  ...
  @override
  String toString() {
    return 'DeployRequest(entrypoint: $entrypoint, env_vars: $env_vars, region: $region, repo: $repo, branch: $branch, runtime: $runtime, source: $source, subfolder: $subfolder, name: $name)';
  }
...
class _$_Func implements _Func {
  ...
  @override
  String toString() {
    return 'Func(branch: $branch, name: $name, subfolder: $subfolder, created: $created, env_vars: $env_vars, updated: $updated, region: $region, entrypoint: $entrypoint, id: $id, repo: $repo, runtime: $runtime, source: $source, status: $status, url: $url)';
  }
