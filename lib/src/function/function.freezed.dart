...
class _$_DeployRequest implements _DeployRequest {
  ...
  @override
  String toString() {
    return 'DeployRequest(env_vars: $env_vars, runtime: $runtime, entrypoint: $entrypoint, name: $name, region: $region, repo: $repo, source: $source, subfolder: $subfolder, branch: $branch)';
  }
...
class _$_Func implements _Func {
  ...
  @override
  String toString() {
    return 'Func(repo: $repo, branch: $branch, id: $id, source: $source, entrypoint: $entrypoint, env_vars: $env_vars, status: $status, subfolder: $subfolder, updated: $updated, url: $url, created: $created, region: $region, name: $name, runtime: $runtime)';
  }
