...
class _$_DeployRequest implements _DeployRequest {
  ...
  @override
  String toString() {
    return 'DeployRequest(source: $source, branch: $branch, entrypoint: $entrypoint, env_vars: $env_vars, runtime: $runtime, subfolder: $subfolder, name: $name, region: $region, repo: $repo)';
  }
...
class _$_Func implements _Func {
  ...
  @override
  String toString() {
    return 'Func(env_vars: $env_vars, name: $name, source: $source, status: $status, subfolder: $subfolder, region: $region, repo: $repo, url: $url, branch: $branch, created: $created, entrypoint: $entrypoint, id: $id, runtime: $runtime, updated: $updated)';
  }
