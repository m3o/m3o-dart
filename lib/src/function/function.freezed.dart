...
class _$_DeployRequest implements _DeployRequest {
  ...
  @override
  String toString() {
    return 'DeployRequest(runtime: $runtime, source: $source, subfolder: $subfolder, branch: $branch, entrypoint: $entrypoint, env_vars: $env_vars, name: $name, repo: $repo, region: $region)';
  }
...
class _$_Func implements _Func {
  ...
  @override
  String toString() {
    return 'Func(runtime: $runtime, url: $url, created: $created, id: $id, name: $name, repo: $repo, source: $source, subfolder: $subfolder, status: $status, updated: $updated, branch: $branch, entrypoint: $entrypoint, env_vars: $env_vars, region: $region)';
  }
