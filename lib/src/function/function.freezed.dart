...
class _$_DeployRequest implements _DeployRequest {
  ...
  @override
  String toString() {
    return 'DeployRequest(branch: $branch, entrypoint: $entrypoint, env_vars: $env_vars, name: $name, runtime: $runtime, source: $source, region: $region, repo: $repo, subfolder: $subfolder)';
  }
...
class _$_Func implements _Func {
  ...
  @override
  String toString() {
    return 'Func(updated: $updated, url: $url, created: $created, source: $source, id: $id, name: $name, region: $region, repo: $repo, runtime: $runtime, branch: $branch, env_vars: $env_vars, subfolder: $subfolder, entrypoint: $entrypoint, status: $status)';
  }
