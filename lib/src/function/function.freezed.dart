...
class _$_DeployRequest implements _DeployRequest {
  ...
  @override
  String toString() {
    return 'DeployRequest(entrypoint: $entrypoint, source: $source, subfolder: $subfolder, branch: $branch, name: $name, region: $region, repo: $repo, runtime: $runtime, env_vars: $env_vars)';
  }
...
class _$_Func implements _Func {
  ...
  @override
  String toString() {
    return 'Func(branch: $branch, name: $name, region: $region, updated: $updated, id: $id, subfolder: $subfolder, url: $url, created: $created, env_vars: $env_vars, repo: $repo, runtime: $runtime, source: $source, entrypoint: $entrypoint, status: $status)';
  }
