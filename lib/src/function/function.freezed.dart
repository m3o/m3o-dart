...
class _$_DeployRequest implements _DeployRequest {
  ...
  @override
  String toString() {
    return 'DeployRequest(runtime: $runtime, source: $source, subfolder: $subfolder, env_vars: $env_vars, region: $region, name: $name, repo: $repo, branch: $branch, entrypoint: $entrypoint)';
  }
...
class _$_Func implements _Func {
  ...
  @override
  String toString() {
    return 'Func(url: $url, created: $created, status: $status, subfolder: $subfolder, repo: $repo, runtime: $runtime, branch: $branch, name: $name, region: $region, updated: $updated, entrypoint: $entrypoint, id: $id, source: $source, env_vars: $env_vars)';
  }
