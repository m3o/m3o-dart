...
class _$_DeployRequest implements _DeployRequest {
  ...
  @override
  String toString() {
    return 'DeployRequest(branch: $branch, name: $name, region: $region, runtime: $runtime, source: $source, subfolder: $subfolder, entrypoint: $entrypoint, env_vars: $env_vars, repo: $repo)';
  }
...
class _$_Func implements _Func {
  ...
  @override
  String toString() {
    return 'Func(runtime: $runtime, updated: $updated, url: $url, created: $created, repo: $repo, id: $id, region: $region, subfolder: $subfolder, branch: $branch, source: $source, name: $name, status: $status, entrypoint: $entrypoint, env_vars: $env_vars)';
  }
