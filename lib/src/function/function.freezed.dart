...
class _$_DeployRequest implements _DeployRequest {
  ...
  @override
  String toString() {
    return 'DeployRequest(repo: $repo, runtime: $runtime, branch: $branch, entrypoint: $entrypoint, env_vars: $env_vars, name: $name, region: $region, source: $source, subfolder: $subfolder)';
  }
...
class _$_Func implements _Func {
  ...
  @override
  String toString() {
    return 'Func(source: $source, status: $status, subfolder: $subfolder, url: $url, name: $name, runtime: $runtime, updated: $updated, env_vars: $env_vars, created: $created, entrypoint: $entrypoint, id: $id, region: $region, repo: $repo, branch: $branch)';
  }
