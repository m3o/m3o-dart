...
class _$_DeployRequest implements _DeployRequest {
  ...
  @override
  String toString() {
    return 'DeployRequest(entrypoint: $entrypoint, name: $name, runtime: $runtime, source: $source, branch: $branch, env_vars: $env_vars, region: $region, repo: $repo, subfolder: $subfolder)';
  }
...
class _$_Func implements _Func {
  ...
  @override
  String toString() {
    return 'Func(runtime: $runtime, status: $status, subfolder: $subfolder, entrypoint: $entrypoint, url: $url, branch: $branch, created: $created, region: $region, env_vars: $env_vars, id: $id, name: $name, repo: $repo, source: $source, updated: $updated)';
  }
