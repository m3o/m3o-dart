...
class _$_DeployRequest implements _DeployRequest {
  ...
  @override
  String toString() {
    return 'DeployRequest(entrypoint: $entrypoint, name: $name, repo: $repo, subfolder: $subfolder, branch: $branch, env_vars: $env_vars, region: $region, runtime: $runtime, source: $source)';
  }
...
class _$_Func implements _Func {
  ...
  @override
  String toString() {
    return 'Func(entrypoint: $entrypoint, id: $id, runtime: $runtime, source: $source, created: $created, env_vars: $env_vars, updated: $updated, branch: $branch, name: $name, region: $region, repo: $repo, subfolder: $subfolder, status: $status, url: $url)';
  }
