...
class _$_DeployRequest implements _DeployRequest {
  ...
  @override
  String toString() {
    return 'DeployRequest(region: $region, repo: $repo, runtime: $runtime, source: $source, subfolder: $subfolder, env_vars: $env_vars, entrypoint: $entrypoint, name: $name, branch: $branch)';
  }
...
class _$_Func implements _Func {
  ...
  @override
  String toString() {
    return 'Func(env_vars: $env_vars, entrypoint: $entrypoint, name: $name, source: $source, status: $status, branch: $branch, created: $created, runtime: $runtime, subfolder: $subfolder, updated: $updated, url: $url, id: $id, region: $region, repo: $repo)';
  }
