...
class _$_DeployRequest implements _DeployRequest {
  ...
  @override
  String toString() {
    return 'DeployRequest(repo: $repo, runtime: $runtime, source: $source, subfolder: $subfolder, branch: $branch, entrypoint: $entrypoint, region: $region, env_vars: $env_vars, name: $name)';
  }
...
class _$_Func implements _Func {
  ...
  @override
  String toString() {
    return 'Func(source: $source, env_vars: $env_vars, region: $region, url: $url, created: $created, entrypoint: $entrypoint, id: $id, subfolder: $subfolder, repo: $repo, runtime: $runtime, status: $status, updated: $updated, branch: $branch, name: $name)';
  }
