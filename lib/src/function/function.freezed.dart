...
class _$_DeployRequest implements _DeployRequest {
  ...
  @override
  String toString() {
    return 'DeployRequest(branch: $branch, entrypoint: $entrypoint, env_vars: $env_vars, region: $region, repo: $repo, source: $source, name: $name, runtime: $runtime, subfolder: $subfolder)';
  }
...
class _$_Func implements _Func {
  ...
  @override
  String toString() {
    return 'Func(id: $id, branch: $branch, created: $created, entrypoint: $entrypoint, runtime: $runtime, source: $source, url: $url, status: $status, subfolder: $subfolder, env_vars: $env_vars, region: $region, repo: $repo, name: $name, updated: $updated)';
  }
