...
class _$_DeployRequest implements _DeployRequest {
  ...
  @override
  String toString() {
    return 'DeployRequest(entrypoint: $entrypoint, name: $name, repo: $repo, runtime: $runtime, source: $source, branch: $branch, env_vars: $env_vars, region: $region, subfolder: $subfolder)';
  }
...
class _$_Func implements _Func {
  ...
  @override
  String toString() {
    return 'Func(branch: $branch, id: $id, name: $name, runtime: $runtime, updated: $updated, created: $created, entrypoint: $entrypoint, status: $status, url: $url, env_vars: $env_vars, source: $source, region: $region, repo: $repo, subfolder: $subfolder)';
  }
