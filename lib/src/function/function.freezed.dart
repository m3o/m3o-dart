...
class _$_DeployRequest implements _DeployRequest {
  ...
  @override
  String toString() {
    return 'DeployRequest(source: $source, entrypoint: $entrypoint, env_vars: $env_vars, name: $name, repo: $repo, runtime: $runtime, branch: $branch, region: $region, subfolder: $subfolder)';
  }
...
class _$_Func implements _Func {
  ...
  @override
  String toString() {
    return 'Func(entrypoint: $entrypoint, region: $region, repo: $repo, source: $source, status: $status, branch: $branch, subfolder: $subfolder, name: $name, url: $url, created: $created, id: $id, runtime: $runtime, updated: $updated, env_vars: $env_vars)';
  }
