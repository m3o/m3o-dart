...
class _$_DeployRequest implements _DeployRequest {
  ...
  @override
  String toString() {
    return 'DeployRequest(name: $name, repo: $repo, subfolder: $subfolder, branch: $branch, env_vars: $env_vars, region: $region, runtime: $runtime, source: $source, entrypoint: $entrypoint)';
  }
...
class _$_Func implements _Func {
  ...
  @override
  String toString() {
    return 'Func(url: $url, env_vars: $env_vars, name: $name, status: $status, branch: $branch, subfolder: $subfolder, updated: $updated, runtime: $runtime, source: $source, entrypoint: $entrypoint, id: $id, region: $region, created: $created, repo: $repo)';
  }
