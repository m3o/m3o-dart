...
class _$_DeployRequest implements _DeployRequest {
  ...
  @override
  String toString() {
    return 'DeployRequest(entrypoint: $entrypoint, name: $name, region: $region, repo: $repo, source: $source, branch: $branch, env_vars: $env_vars, runtime: $runtime, subfolder: $subfolder)';
  }
...
class _$_Func implements _Func {
  ...
  @override
  String toString() {
    return 'Func(subfolder: $subfolder, created: $created, entrypoint: $entrypoint, repo: $repo, source: $source, status: $status, env_vars: $env_vars, id: $id, name: $name, branch: $branch, runtime: $runtime, url: $url, region: $region, updated: $updated)';
  }
