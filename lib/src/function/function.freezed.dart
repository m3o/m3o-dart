...
class _$_DeployRequest implements _DeployRequest {
  ...
  @override
  String toString() {
    return 'DeployRequest(region: $region, repo: $repo, subfolder: $subfolder, source: $source, branch: $branch, entrypoint: $entrypoint, env_vars: $env_vars, name: $name, runtime: $runtime)';
  }
...
class _$_Func implements _Func {
  ...
  @override
  String toString() {
    return 'Func(entrypoint: $entrypoint, runtime: $runtime, source: $source, status: $status, url: $url, branch: $branch, env_vars: $env_vars, repo: $repo, updated: $updated, id: $id, region: $region, subfolder: $subfolder, created: $created, name: $name)';
  }
