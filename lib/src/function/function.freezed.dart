...
class _$_DeployRequest implements _DeployRequest {
  ...
  @override
  String toString() {
    return 'DeployRequest(entrypoint: $entrypoint, name: $name, runtime: $runtime, subfolder: $subfolder, branch: $branch, env_vars: $env_vars, region: $region, repo: $repo, source: $source)';
  }
...
class _$_Func implements _Func {
  ...
  @override
  String toString() {
    return 'Func(runtime: $runtime, created: $created, env_vars: $env_vars, id: $id, name: $name, source: $source, entrypoint: $entrypoint, status: $status, url: $url, branch: $branch, region: $region, repo: $repo, subfolder: $subfolder, updated: $updated)';
  }
