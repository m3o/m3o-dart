...
class _$_DeployRequest implements _DeployRequest {
  ...
  @override
  String toString() {
    return 'DeployRequest(repo: $repo, source: $source, branch: $branch, entrypoint: $entrypoint, region: $region, runtime: $runtime, subfolder: $subfolder, env_vars: $env_vars, name: $name)';
  }
...
class _$_Func implements _Func {
  ...
  @override
  String toString() {
    return 'Func(branch: $branch, id: $id, region: $region, entrypoint: $entrypoint, name: $name, subfolder: $subfolder, url: $url, runtime: $runtime, created: $created, env_vars: $env_vars, repo: $repo, source: $source, status: $status, updated: $updated)';
  }
