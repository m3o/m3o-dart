...
class _$_DeployRequest implements _DeployRequest {
  ...
  @override
  String toString() {
    return 'DeployRequest(branch: $branch, env_vars: $env_vars, region: $region, repo: $repo, source: $source, entrypoint: $entrypoint, name: $name, runtime: $runtime, subfolder: $subfolder)';
  }
...
class _$_Func implements _Func {
  ...
  @override
  String toString() {
    return 'Func(env_vars: $env_vars, repo: $repo, branch: $branch, name: $name, region: $region, created: $created, id: $id, updated: $updated, status: $status, subfolder: $subfolder, url: $url, entrypoint: $entrypoint, runtime: $runtime, source: $source)';
  }
