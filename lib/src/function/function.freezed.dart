...
class _$_DeployRequest implements _DeployRequest {
  ...
  @override
  String toString() {
    return 'DeployRequest(region: $region, env_vars: $env_vars, entrypoint: $entrypoint, name: $name, repo: $repo, runtime: $runtime, source: $source, subfolder: $subfolder, branch: $branch)';
  }
...
class _$_Func implements _Func {
  ...
  @override
  String toString() {
    return 'Func(source: $source, branch: $branch, created: $created, id: $id, region: $region, repo: $repo, runtime: $runtime, subfolder: $subfolder, url: $url, entrypoint: $entrypoint, env_vars: $env_vars, status: $status, name: $name, updated: $updated)';
  }
