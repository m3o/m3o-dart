...
class _$_Func implements _Func {
  ...
  @override
  String toString() {
    return 'Func(created: $created, id: $id, repo: $repo, updated: $updated, name: $name, region: $region, entrypoint: $entrypoint, env_vars: $env_vars, source: $source, branch: $branch, runtime: $runtime, status: $status, subfolder: $subfolder, url: $url)';
  }
