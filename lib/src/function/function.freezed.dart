...
class _$_DeployRequest implements _DeployRequest {
  ...
  @override
  String toString() {
    return 'DeployRequest(env_vars: $env_vars, subfolder: $subfolder, branch: $branch, entrypoint: $entrypoint, name: $name, region: $region, repo: $repo, runtime: $runtime, source: $source)';
  }
...
class _$_Func implements _Func {
  ...
  @override
  String toString() {
    return 'Func(updated: $updated, env_vars: $env_vars, region: $region, runtime: $runtime, subfolder: $subfolder, id: $id, name: $name, url: $url, branch: $branch, source: $source, repo: $repo, status: $status, created: $created, entrypoint: $entrypoint)';
  }
