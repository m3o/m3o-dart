...
class _$_DeployRequest implements _DeployRequest {
  ...
  @override
  String toString() {
    return 'DeployRequest(name: $name, runtime: $runtime, source: $source, branch: $branch, entrypoint: $entrypoint, env_vars: $env_vars, region: $region, repo: $repo, subfolder: $subfolder)';
  }
...
class _$_Func implements _Func {
  ...
  @override
  String toString() {
    return 'Func(subfolder: $subfolder, entrypoint: $entrypoint, source: $source, status: $status, branch: $branch, runtime: $runtime, url: $url, created: $created, name: $name, region: $region, updated: $updated, env_vars: $env_vars, id: $id, repo: $repo)';
  }
