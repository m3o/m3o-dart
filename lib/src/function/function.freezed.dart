...
class _$_DeployRequest implements _DeployRequest {
  ...
  @override
  String toString() {
    return 'DeployRequest(entrypoint: $entrypoint, env_vars: $env_vars, name: $name, region: $region, subfolder: $subfolder, branch: $branch, repo: $repo, runtime: $runtime, source: $source)';
  }
...
class _$_Func implements _Func {
  ...
  @override
  String toString() {
    return 'Func(created: $created, entrypoint: $entrypoint, url: $url, env_vars: $env_vars, id: $id, repo: $repo, updated: $updated, name: $name, subfolder: $subfolder, branch: $branch, region: $region, runtime: $runtime, source: $source, status: $status)';
  }
