...
class _$_DeployRequest implements _DeployRequest {
  ...
  @override
  String toString() {
    return 'DeployRequest(branch: $branch, region: $region, repo: $repo, runtime: $runtime, entrypoint: $entrypoint, env_vars: $env_vars, name: $name, source: $source, subfolder: $subfolder)';
  }
...
class _$_Func implements _Func {
  ...
  @override
  String toString() {
    return 'Func(name: $name, subfolder: $subfolder, entrypoint: $entrypoint, env_vars: $env_vars, source: $source, url: $url, branch: $branch, created: $created, repo: $repo, runtime: $runtime, status: $status, updated: $updated, id: $id, region: $region)';
  }
