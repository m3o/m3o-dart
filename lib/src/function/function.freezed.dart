...
class _$_DeployRequest implements _DeployRequest {
  ...
  @override
  String toString() {
    return 'DeployRequest(branch: $branch, repo: $repo, runtime: $runtime, source: $source, subfolder: $subfolder, entrypoint: $entrypoint, env_vars: $env_vars, name: $name, region: $region)';
  }
...
class _$_Func implements _Func {
  ...
  @override
  String toString() {
    return 'Func(id: $id, repo: $repo, status: $status, url: $url, source: $source, created: $created, entrypoint: $entrypoint, name: $name, region: $region, updated: $updated, branch: $branch, env_vars: $env_vars, runtime: $runtime, subfolder: $subfolder)';
  }
