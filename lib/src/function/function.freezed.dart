...
class _$_DeployRequest implements _DeployRequest {
  ...
  @override
  String toString() {
    return 'DeployRequest(source: $source, subfolder: $subfolder, branch: $branch, name: $name, repo: $repo, runtime: $runtime, entrypoint: $entrypoint, env_vars: $env_vars, region: $region)';
  }
...
class _$_Func implements _Func {
  ...
  @override
  String toString() {
    return 'Func(id: $id, region: $region, repo: $repo, runtime: $runtime, status: $status, env_vars: $env_vars, updated: $updated, branch: $branch, created: $created, name: $name, source: $source, entrypoint: $entrypoint, subfolder: $subfolder, url: $url)';
  }
