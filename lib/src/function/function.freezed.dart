...
class _$_DeployRequest implements _DeployRequest {
  ...
  @override
  String toString() {
    return 'DeployRequest(env_vars: $env_vars, name: $name, repo: $repo, runtime: $runtime, source: $source, subfolder: $subfolder, branch: $branch, entrypoint: $entrypoint, region: $region)';
  }
...
class _$_Func implements _Func {
  ...
  @override
  String toString() {
    return 'Func(id: $id, env_vars: $env_vars, runtime: $runtime, subfolder: $subfolder, updated: $updated, url: $url, status: $status, branch: $branch, created: $created, region: $region, repo: $repo, source: $source, entrypoint: $entrypoint, name: $name)';
  }
