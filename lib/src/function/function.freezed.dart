...
class _$_DeployRequest implements _DeployRequest {
  ...
  @override
  String toString() {
    return 'DeployRequest(source: $source, entrypoint: $entrypoint, name: $name, region: $region, repo: $repo, branch: $branch, env_vars: $env_vars, runtime: $runtime, subfolder: $subfolder)';
  }
...
class _$_Func implements _Func {
  ...
  @override
  String toString() {
    return 'Func(env_vars: $env_vars, name: $name, region: $region, subfolder: $subfolder, updated: $updated, branch: $branch, id: $id, created: $created, runtime: $runtime, repo: $repo, source: $source, status: $status, url: $url, entrypoint: $entrypoint)';
  }
