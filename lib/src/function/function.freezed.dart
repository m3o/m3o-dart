...
class _$_DeployRequest implements _DeployRequest {
  ...
  @override
  String toString() {
    return 'DeployRequest(entrypoint: $entrypoint, env_vars: $env_vars, region: $region, source: $source, branch: $branch, name: $name, repo: $repo, runtime: $runtime, subfolder: $subfolder)';
  }
...
class _$_Func implements _Func {
  ...
  @override
  String toString() {
    return 'Func(region: $region, updated: $updated, name: $name, runtime: $runtime, subfolder: $subfolder, created: $created, entrypoint: $entrypoint, env_vars: $env_vars, repo: $repo, source: $source, url: $url, branch: $branch, id: $id, status: $status)';
  }
