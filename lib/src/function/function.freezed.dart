...
class _$_DeployRequest implements _DeployRequest {
  ...
  @override
  String toString() {
    return 'DeployRequest(runtime: $runtime, subfolder: $subfolder, branch: $branch, entrypoint: $entrypoint, env_vars: $env_vars, region: $region, repo: $repo, name: $name, source: $source)';
  }
...
class _$_Func implements _Func {
  ...
  @override
  String toString() {
    return 'Func(entrypoint: $entrypoint, url: $url, branch: $branch, env_vars: $env_vars, id: $id, name: $name, region: $region, runtime: $runtime, status: $status, updated: $updated, created: $created, source: $source, subfolder: $subfolder, repo: $repo)';
  }
