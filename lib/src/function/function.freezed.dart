...
class _$_DeployRequest implements _DeployRequest {
  ...
  @override
  String toString() {
    return 'DeployRequest(branch: $branch, entrypoint: $entrypoint, env_vars: $env_vars, name: $name, region: $region, repo: $repo, runtime: $runtime, source: $source, subfolder: $subfolder)';
  }
...
abstract class _DeployRequest implements DeployRequest {
  const factory _DeployRequest(
      ...
      final String? runtime,
      final String? source,
      final String? subfolder}) = _$_DeployRequest;
...
class _$_Func implements _Func {
  ...
  @override
  String toString() {
    return 'Func(env_vars: $env_vars, name: $name, updated: $updated, region: $region, repo: $repo, source: $source, status: $status, subfolder: $subfolder, branch: $branch, created: $created, entrypoint: $entrypoint, id: $id, runtime: $runtime, url: $url)';
  }
...
class _$_LogsRequest implements _LogsRequest {
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, name, logs_type);
...
abstract class _LogsRequest implements LogsRequest {
  const factory _LogsRequest({final String? name, final String? logs_type}) =
      _$_LogsRequest;
