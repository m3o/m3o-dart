...
class _$_DeployRequest implements _DeployRequest {
  ...
  @override
  String toString() {
    return 'DeployRequest(branch: $branch, runtime: $runtime, source: $source, entrypoint: $entrypoint, env_vars: $env_vars, name: $name, region: $region, repo: $repo, subfolder: $subfolder)';
  }
...
class _$_Func implements _Func {
  ...
  @override
  String toString() {
    return 'Func(env_vars: $env_vars, id: $id, region: $region, repo: $repo, runtime: $runtime, subfolder: $subfolder, created: $created, source: $source, status: $status, updated: $updated, branch: $branch, entrypoint: $entrypoint, name: $name, url: $url)';
  }
