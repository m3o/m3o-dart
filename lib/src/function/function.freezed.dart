...
class _$_DeployRequest implements _DeployRequest {
  ...
  @override
  String toString() {
    return 'DeployRequest(entrypoint: $entrypoint, env_vars: $env_vars, name: $name, region: $region, runtime: $runtime, branch: $branch, source: $source, subfolder: $subfolder, repo: $repo)';
  }
...
class _$_Func implements _Func {
  ...
  @override
  String toString() {
    return 'Func(env_vars: $env_vars, subfolder: $subfolder, repo: $repo, url: $url, created: $created, entrypoint: $entrypoint, id: $id, name: $name, runtime: $runtime, status: $status, updated: $updated, branch: $branch, region: $region, source: $source)';
  }
