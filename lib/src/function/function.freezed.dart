...
class _$_DeployRequest implements _DeployRequest {
  ...
  @override
  String toString() {
    return 'DeployRequest(branch: $branch, subfolder: $subfolder, repo: $repo, runtime: $runtime, source: $source, entrypoint: $entrypoint, env_vars: $env_vars, name: $name, region: $region)';
  }
...
class _$_Func implements _Func {
  ...
  @override
  String toString() {
    return 'Func(env_vars: $env_vars, id: $id, repo: $repo, status: $status, subfolder: $subfolder, updated: $updated, branch: $branch, url: $url, source: $source, region: $region, entrypoint: $entrypoint, name: $name, runtime: $runtime, created: $created)';
  }
