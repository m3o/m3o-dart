...
class _$_Func implements _Func {
  ...
  @override
  String toString() {
    return 'Func(env_vars: $env_vars, name: $name, updated: $updated, branch: $branch, repo: $repo, id: $id, source: $source, status: $status, url: $url, created: $created, entrypoint: $entrypoint, region: $region, runtime: $runtime, subfolder: $subfolder)';
  }
