...
class _$_DeployRequest implements _DeployRequest {
  ...
  @override
  String toString() {
    return 'DeployRequest(region: $region, runtime: $runtime, repo: $repo, source: $source, subfolder: $subfolder, branch: $branch, entrypoint: $entrypoint, env_vars: $env_vars, name: $name)';
  }
...
class _$_Func implements _Func {
  ...
  @override
  String toString() {
    return 'Func(name: $name, updated: $updated, id: $id, region: $region, subfolder: $subfolder, url: $url, created: $created, env_vars: $env_vars, status: $status, branch: $branch, entrypoint: $entrypoint, repo: $repo, runtime: $runtime, source: $source)';
  }
