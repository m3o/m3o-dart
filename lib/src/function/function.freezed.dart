...
class _$_DeployRequest implements _DeployRequest {
  ...
  @override
  String toString() {
    return 'DeployRequest(subfolder: $subfolder, env_vars: $env_vars, runtime: $runtime, source: $source, region: $region, repo: $repo, branch: $branch, entrypoint: $entrypoint, name: $name)';
  }
...
class _$_Func implements _Func {
  ...
  @override
  String toString() {
    return 'Func(branch: $branch, created: $created, url: $url, region: $region, source: $source, repo: $repo, subfolder: $subfolder, runtime: $runtime, status: $status, updated: $updated, entrypoint: $entrypoint, env_vars: $env_vars, id: $id, name: $name)';
  }
