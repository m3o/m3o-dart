...
class _$_DeployRequest implements _DeployRequest {
  ...
  @override
  String toString() {
    return 'DeployRequest(name: $name, branch: $branch, entrypoint: $entrypoint, repo: $repo, runtime: $runtime, source: $source, subfolder: $subfolder, env_vars: $env_vars, region: $region)';
  }
...
class _$_Func implements _Func {
  ...
  @override
  String toString() {
    return 'Func(region: $region, repo: $repo, branch: $branch, created: $created, subfolder: $subfolder, updated: $updated, status: $status, url: $url, entrypoint: $entrypoint, env_vars: $env_vars, runtime: $runtime, source: $source, id: $id, name: $name)';
  }
