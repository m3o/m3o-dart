...
class _$_DeployRequest implements _DeployRequest {
  ...
  @override
  String toString() {
    return 'DeployRequest(branch: $branch, env_vars: $env_vars, name: $name, region: $region, repo: $repo, runtime: $runtime, source: $source, subfolder: $subfolder, entrypoint: $entrypoint)';
  }
...
class _$_Func implements _Func {
  ...
  @override
  String toString() {
    return 'Func(repo: $repo, name: $name, url: $url, env_vars: $env_vars, region: $region, runtime: $runtime, source: $source, subfolder: $subfolder, branch: $branch, created: $created, entrypoint: $entrypoint, id: $id, status: $status, updated: $updated)';
  }
