...
class _$_DeployRequest implements _DeployRequest {
  ...
  @override
  String toString() {
    return 'DeployRequest(region: $region, entrypoint: $entrypoint, env_vars: $env_vars, name: $name, repo: $repo, runtime: $runtime, source: $source, subfolder: $subfolder, branch: $branch)';
  }
...
class _$_Func implements _Func {
  ...
  @override
  String toString() {
    return 'Func(branch: $branch, region: $region, repo: $repo, source: $source, name: $name, runtime: $runtime, url: $url, entrypoint: $entrypoint, status: $status, updated: $updated, created: $created, env_vars: $env_vars, id: $id, subfolder: $subfolder)';
  }
