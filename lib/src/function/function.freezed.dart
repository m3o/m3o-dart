...
class _$_DeployRequest implements _DeployRequest {
  ...
  @override
  String toString() {
    return 'DeployRequest(region: $region, repo: $repo, runtime: $runtime, env_vars: $env_vars, entrypoint: $entrypoint, name: $name, source: $source, subfolder: $subfolder, branch: $branch)';
  }
...
class _$_Func implements _Func {
  ...
  @override
  String toString() {
    return 'Func(source: $source, updated: $updated, branch: $branch, status: $status, subfolder: $subfolder, id: $id, env_vars: $env_vars, region: $region, repo: $repo, runtime: $runtime, url: $url, entrypoint: $entrypoint, name: $name, created: $created)';
  }
