...
class _$_DeployRequest implements _DeployRequest {
  ...
  @override
  String toString() {
    return 'DeployRequest(subfolder: $subfolder, branch: $branch, region: $region, repo: $repo, source: $source, entrypoint: $entrypoint, env_vars: $env_vars, name: $name, runtime: $runtime)';
  }
...
class _$_Func implements _Func {
  ...
  @override
  String toString() {
    return 'Func(name: $name, runtime: $runtime, source: $source, entrypoint: $entrypoint, branch: $branch, created: $created, region: $region, status: $status, url: $url, env_vars: $env_vars, id: $id, repo: $repo, subfolder: $subfolder, updated: $updated)';
  }
