...
class _$_Func implements _Func {
  ...
  @override
  String toString() {
    return 'Func(source: $source, status: $status, branch: $branch, url: $url, repo: $repo, entrypoint: $entrypoint, env_vars: $env_vars, region: $region, subfolder: $subfolder, created: $created, name: $name, runtime: $runtime, updated: $updated, id: $id)';
  }
