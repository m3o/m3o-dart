...
class _$_Func implements _Func {
  ...
  @override
  String toString() {
    return 'Func(repo: $repo, source: $source, updated: $updated, runtime: $runtime, url: $url, branch: $branch, created: $created, name: $name, status: $status, subfolder: $subfolder, entrypoint: $entrypoint, env_vars: $env_vars, id: $id, region: $region)';
  }
