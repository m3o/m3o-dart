...
class _$_DeployRequest implements _DeployRequest {
  ...
  @override
  String toString() {
    return 'DeployRequest(entrypoint: $entrypoint, name: $name, region: $region, subfolder: $subfolder, source: $source, branch: $branch, env_vars: $env_vars, repo: $repo, runtime: $runtime)';
  }
...
class _$_Func implements _Func {
  ...
  @override
  String toString() {
    return 'Func(repo: $repo, source: $source, env_vars: $env_vars, name: $name, created: $created, entrypoint: $entrypoint, runtime: $runtime, status: $status, subfolder: $subfolder, url: $url, branch: $branch, region: $region, updated: $updated, id: $id)';
  }
