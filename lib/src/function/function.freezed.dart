...
class _$_DeployRequest implements _DeployRequest {
  ...
  @override
  String toString() {
    return 'DeployRequest(branch: $branch, name: $name, source: $source, runtime: $runtime, subfolder: $subfolder, entrypoint: $entrypoint, env_vars: $env_vars, region: $region, repo: $repo)';
  }
...
class _$_Func implements _Func {
  ...
  @override
  String toString() {
    return 'Func(env_vars: $env_vars, runtime: $runtime, source: $source, name: $name, status: $status, subfolder: $subfolder, updated: $updated, url: $url, created: $created, entrypoint: $entrypoint, region: $region, branch: $branch, id: $id, repo: $repo)';
  }
