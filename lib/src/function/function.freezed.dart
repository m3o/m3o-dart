...
class _$_DeployRequest implements _DeployRequest {
  ...
  @override
  String toString() {
    return 'DeployRequest(branch: $branch, entrypoint: $entrypoint, subfolder: $subfolder, runtime: $runtime, source: $source, env_vars: $env_vars, name: $name, region: $region, repo: $repo)';
  }
...
class _$_Func implements _Func {
  ...
  @override
  String toString() {
    return 'Func(id: $id, runtime: $runtime, source: $source, branch: $branch, repo: $repo, updated: $updated, created: $created, entrypoint: $entrypoint, subfolder: $subfolder, url: $url, env_vars: $env_vars, name: $name, region: $region, status: $status)';
  }
