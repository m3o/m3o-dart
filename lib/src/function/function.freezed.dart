...
class _$_DeployRequest implements _DeployRequest {
  ...
  @override
  String toString() {
    return 'DeployRequest(name: $name, runtime: $runtime, subfolder: $subfolder, branch: $branch, env_vars: $env_vars, region: $region, repo: $repo, source: $source, entrypoint: $entrypoint)';
  }
...
class _$_Func implements _Func {
  ...
  @override
  String toString() {
    return 'Func(name: $name, runtime: $runtime, subfolder: $subfolder, repo: $repo, source: $source, status: $status, url: $url, created: $created, entrypoint: $entrypoint, id: $id, updated: $updated, branch: $branch, env_vars: $env_vars, region: $region)';
  }
