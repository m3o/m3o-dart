...
class _$_DeployRequest implements _DeployRequest {
  ...
  @override
  String toString() {
    return 'DeployRequest(branch: $branch, name: $name, subfolder: $subfolder, repo: $repo, runtime: $runtime, source: $source, entrypoint: $entrypoint, env_vars: $env_vars, region: $region)';
  }
...
class _$_Func implements _Func {
  ...
  @override
  String toString() {
    return 'Func(id: $id, status: $status, subfolder: $subfolder, entrypoint: $entrypoint, name: $name, repo: $repo, source: $source, branch: $branch, created: $created, runtime: $runtime, url: $url, env_vars: $env_vars, region: $region, updated: $updated)';
  }
