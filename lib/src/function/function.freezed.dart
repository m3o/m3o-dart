...
class _$_DeployRequest implements _DeployRequest {
  ...
  @override
  String toString() {
    return 'DeployRequest(source: $source, branch: $branch, env_vars: $env_vars, region: $region, repo: $repo, entrypoint: $entrypoint, name: $name, runtime: $runtime, subfolder: $subfolder)';
  }
...
class _$_Func implements _Func {
  ...
  @override
  String toString() {
    return 'Func(updated: $updated, entrypoint: $entrypoint, region: $region, repo: $repo, runtime: $runtime, status: $status, subfolder: $subfolder, url: $url, created: $created, env_vars: $env_vars, id: $id, name: $name, branch: $branch, source: $source)';
  }
