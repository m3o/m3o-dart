...
class _$_DeployRequest implements _DeployRequest {
  ...
  @override
  String toString() {
    return 'DeployRequest(branch: $branch, region: $region, subfolder: $subfolder, entrypoint: $entrypoint, env_vars: $env_vars, name: $name, repo: $repo, runtime: $runtime, source: $source)';
  }
...
class _$_Func implements _Func {
  ...
  @override
  String toString() {
    return 'Func(runtime: $runtime, subfolder: $subfolder, source: $source, updated: $updated, url: $url, entrypoint: $entrypoint, name: $name, repo: $repo, status: $status, branch: $branch, env_vars: $env_vars, id: $id, created: $created, region: $region)';
  }
