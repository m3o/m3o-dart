...
class _$_DeployRequest implements _DeployRequest {
  ...
  @override
  String toString() {
    return 'DeployRequest(source: $source, subfolder: $subfolder, repo: $repo, entrypoint: $entrypoint, env_vars: $env_vars, name: $name, region: $region, runtime: $runtime, branch: $branch)';
  }
...
class _$_Func implements _Func {
  ...
  @override
  String toString() {
    return 'Func(entrypoint: $entrypoint, name: $name, status: $status, subfolder: $subfolder, url: $url, branch: $branch, created: $created, id: $id, region: $region, source: $source, env_vars: $env_vars, repo: $repo, runtime: $runtime, updated: $updated)';
  }
