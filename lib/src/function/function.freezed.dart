...
class _$_DeployRequest implements _DeployRequest {
  ...
  @override
  String toString() {
    return 'DeployRequest(source: $source, subfolder: $subfolder, branch: $branch, entrypoint: $entrypoint, env_vars: $env_vars, runtime: $runtime, name: $name, region: $region, repo: $repo)';
  }
...
class _$_Func implements _Func {
  ...
  @override
  String toString() {
    return 'Func(entrypoint: $entrypoint, repo: $repo, runtime: $runtime, branch: $branch, env_vars: $env_vars, region: $region, subfolder: $subfolder, created: $created, id: $id, url: $url, name: $name, source: $source, status: $status, updated: $updated)';
  }
