...
class _$_DeployRequest implements _DeployRequest {
  ...
  @override
  String toString() {
    return 'DeployRequest(region: $region, repo: $repo, source: $source, subfolder: $subfolder, branch: $branch, name: $name, runtime: $runtime, entrypoint: $entrypoint, env_vars: $env_vars)';
  }
...
class _$_Func implements _Func {
  ...
  @override
  String toString() {
    return 'Func(env_vars: $env_vars, subfolder: $subfolder, created: $created, entrypoint: $entrypoint, name: $name, runtime: $runtime, source: $source, status: $status, updated: $updated, branch: $branch, url: $url, id: $id, region: $region, repo: $repo)';
  }
