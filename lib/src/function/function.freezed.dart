...
class _$_DeployRequest implements _DeployRequest {
  ...
  @override
  String toString() {
    return 'DeployRequest(branch: $branch, name: $name, repo: $repo, runtime: $runtime, source: $source, subfolder: $subfolder, entrypoint: $entrypoint, env_vars: $env_vars, region: $region)';
  }
...
class _$_Func implements _Func {
  ...
  @override
  String toString() {
    return 'Func(created: $created, entrypoint: $entrypoint, region: $region, runtime: $runtime, env_vars: $env_vars, status: $status, subfolder: $subfolder, url: $url, id: $id, repo: $repo, updated: $updated, branch: $branch, name: $name, source: $source)';
  }
