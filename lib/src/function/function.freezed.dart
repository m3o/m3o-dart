...
class _$_DeployRequest implements _DeployRequest {
  ...
  @override
  String toString() {
    return 'DeployRequest(repo: $repo, runtime: $runtime, subfolder: $subfolder, env_vars: $env_vars, region: $region, name: $name, source: $source, branch: $branch, entrypoint: $entrypoint)';
  }
...
class _$_Func implements _Func {
  ...
  @override
  String toString() {
    return 'Func(subfolder: $subfolder, entrypoint: $entrypoint, status: $status, updated: $updated, env_vars: $env_vars, name: $name, repo: $repo, runtime: $runtime, source: $source, url: $url, branch: $branch, created: $created, id: $id, region: $region)';
  }
