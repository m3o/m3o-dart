...
class _$_DeployRequest implements _DeployRequest {
  ...
  @override
  String toString() {
    return 'DeployRequest(runtime: $runtime, source: $source, subfolder: $subfolder, entrypoint: $entrypoint, name: $name, region: $region, repo: $repo, branch: $branch, env_vars: $env_vars)';
  }
...
class _$_Func implements _Func {
  ...
  @override
  String toString() {
    return 'Func(url: $url, repo: $repo, status: $status, subfolder: $subfolder, updated: $updated, branch: $branch, created: $created, runtime: $runtime, entrypoint: $entrypoint, id: $id, region: $region, env_vars: $env_vars, name: $name, source: $source)';
  }
