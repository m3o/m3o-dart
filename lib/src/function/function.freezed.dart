...
class _$_DeployRequest implements _DeployRequest {
  ...
  @override
  String toString() {
    return 'DeployRequest(source: $source, entrypoint: $entrypoint, repo: $repo, name: $name, region: $region, runtime: $runtime, subfolder: $subfolder, branch: $branch, env_vars: $env_vars)';
  }
...
class _$_Func implements _Func {
  ...
  @override
  String toString() {
    return 'Func(updated: $updated, url: $url, branch: $branch, created: $created, entrypoint: $entrypoint, runtime: $runtime, source: $source, env_vars: $env_vars, name: $name, status: $status, subfolder: $subfolder, id: $id, region: $region, repo: $repo)';
  }
