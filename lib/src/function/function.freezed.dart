...
class _$_DeployRequest implements _DeployRequest {
  ...
  @override
  String toString() {
    return 'DeployRequest(branch: $branch, env_vars: $env_vars, name: $name, runtime: $runtime, source: $source, entrypoint: $entrypoint, region: $region, repo: $repo, subfolder: $subfolder)';
  }
...
class _$_Func implements _Func {
  ...
  @override
  String toString() {
    return 'Func(subfolder: $subfolder, status: $status, created: $created, entrypoint: $entrypoint, runtime: $runtime, source: $source, branch: $branch, updated: $updated, id: $id, name: $name, region: $region, repo: $repo, url: $url, env_vars: $env_vars)';
  }
