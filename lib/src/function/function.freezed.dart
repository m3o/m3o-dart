...
class _$_Func implements _Func {
  ...
  @override
  String toString() {
    return 'Func(region: $region, runtime: $runtime, name: $name, status: $status, url: $url, source: $source, subfolder: $subfolder, updated: $updated, branch: $branch, env_vars: $env_vars, id: $id, created: $created, entrypoint: $entrypoint, repo: $repo)';
  }
