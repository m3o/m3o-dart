...
class _$_DeployRequest implements _DeployRequest {
  ...
  @override
  String toString() {
    return 'DeployRequest(entrypoint: $entrypoint, region: $region, runtime: $runtime, subfolder: $subfolder, branch: $branch, env_vars: $env_vars, name: $name, repo: $repo, source: $source)';
  }
...
class _$_Func implements _Func {
  ...
  @override
  String toString() {
    return 'Func(created: $created, name: $name, updated: $updated, branch: $branch, id: $id, region: $region, runtime: $runtime, source: $source, status: $status, url: $url, entrypoint: $entrypoint, env_vars: $env_vars, repo: $repo, subfolder: $subfolder)';
  }
