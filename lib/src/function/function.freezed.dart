...
class _$_DeployRequest implements _DeployRequest {
  ...
  @override
  String toString() {
    return 'DeployRequest(branch: $branch, name: $name, repo: $repo, runtime: $runtime, entrypoint: $entrypoint, env_vars: $env_vars, region: $region, source: $source, subfolder: $subfolder)';
  }
...
class _$_Func implements _Func {
  ...
  @override
  String toString() {
    return 'Func(id: $id, source: $source, url: $url, entrypoint: $entrypoint, env_vars: $env_vars, status: $status, branch: $branch, created: $created, name: $name, region: $region, runtime: $runtime, subfolder: $subfolder, repo: $repo, updated: $updated)';
  }
