...
class _$_DeployRequest implements _DeployRequest {
  ...
  @override
  String toString() {
    return 'DeployRequest(name: $name, repo: $repo, source: $source, subfolder: $subfolder, branch: $branch, entrypoint: $entrypoint, env_vars: $env_vars, region: $region, runtime: $runtime)';
  }
...
class _$_Func implements _Func {
  ...
  @override
  String toString() {
    return 'Func(source: $source, status: $status, entrypoint: $entrypoint, id: $id, region: $region, url: $url, branch: $branch, env_vars: $env_vars, created: $created, name: $name, repo: $repo, runtime: $runtime, subfolder: $subfolder, updated: $updated)';
  }
