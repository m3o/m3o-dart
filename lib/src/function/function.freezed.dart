...
class _$_DeployRequest implements _DeployRequest {
  ...
  @override
  String toString() {
    return 'DeployRequest(branch: $branch, entrypoint: $entrypoint, env_vars: $env_vars, subfolder: $subfolder, name: $name, region: $region, repo: $repo, runtime: $runtime, source: $source)';
  }
...
class _$_Func implements _Func {
  ...
  @override
  String toString() {
    return 'Func(branch: $branch, region: $region, source: $source, subfolder: $subfolder, entrypoint: $entrypoint, name: $name, repo: $repo, updated: $updated, url: $url, id: $id, created: $created, env_vars: $env_vars, runtime: $runtime, status: $status)';
  }
