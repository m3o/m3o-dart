...
class _$_DeployRequest implements _DeployRequest {
  ...
  @override
  String toString() {
    return 'DeployRequest(repo: $repo, subfolder: $subfolder, name: $name, region: $region, env_vars: $env_vars, runtime: $runtime, source: $source, branch: $branch, entrypoint: $entrypoint)';
  }
...
class _$_Func implements _Func {
  ...
  @override
  String toString() {
    return 'Func(subfolder: $subfolder, name: $name, runtime: $runtime, source: $source, status: $status, id: $id, updated: $updated, branch: $branch, created: $created, region: $region, repo: $repo, entrypoint: $entrypoint, env_vars: $env_vars, url: $url)';
  }
