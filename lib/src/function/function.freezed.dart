...
class _$_Func implements _Func {
  ...
  @override
  String toString() {
    return 'Func(region: $region, repo: $repo, source: $source, entrypoint: $entrypoint, id: $id, status: $status, updated: $updated, created: $created, env_vars: $env_vars, name: $name, url: $url, branch: $branch, runtime: $runtime, subfolder: $subfolder)';
  }
