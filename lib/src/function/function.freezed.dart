...
class _$_DeployRequest implements _DeployRequest {
  ...
  @override
  String toString() {
    return 'DeployRequest(env_vars: $env_vars, runtime: $runtime, branch: $branch, entrypoint: $entrypoint, name: $name, region: $region, repo: $repo, source: $source, subfolder: $subfolder)';
  }
...
class _$_Func implements _Func {
  ...
  @override
  String toString() {
    return 'Func(runtime: $runtime, source: $source, updated: $updated, url: $url, created: $created, id: $id, env_vars: $env_vars, status: $status, region: $region, subfolder: $subfolder, branch: $branch, entrypoint: $entrypoint, name: $name, repo: $repo)';
  }
