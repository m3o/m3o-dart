...
class _$_DeployRequest implements _DeployRequest {
  ...
  @override
  String toString() {
    return 'DeployRequest(name: $name, runtime: $runtime, source: $source, subfolder: $subfolder, repo: $repo, branch: $branch, entrypoint: $entrypoint, env_vars: $env_vars, region: $region)';
  }
...
class _$_Func implements _Func {
  ...
  @override
  String toString() {
    return 'Func(env_vars: $env_vars, id: $id, region: $region, runtime: $runtime, entrypoint: $entrypoint, url: $url, created: $created, name: $name, repo: $repo, status: $status, branch: $branch, source: $source, subfolder: $subfolder, updated: $updated)';
  }
