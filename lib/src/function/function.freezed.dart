...
class _$_DeployRequest implements _DeployRequest {
  ...
  @override
  String toString() {
    return 'DeployRequest(env_vars: $env_vars, region: $region, subfolder: $subfolder, branch: $branch, entrypoint: $entrypoint, runtime: $runtime, source: $source, name: $name, repo: $repo)';
  }
...
class _$_Func implements _Func {
  ...
  @override
  String toString() {
    return 'Func(name: $name, subfolder: $subfolder, entrypoint: $entrypoint, runtime: $runtime, source: $source, status: $status, branch: $branch, created: $created, env_vars: $env_vars, updated: $updated, id: $id, region: $region, repo: $repo, url: $url)';
  }
