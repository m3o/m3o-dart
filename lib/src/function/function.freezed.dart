...
class _$_DeployRequest implements _DeployRequest {
  ...
  @override
  String toString() {
    return 'DeployRequest(env_vars: $env_vars, region: $region, source: $source, subfolder: $subfolder, entrypoint: $entrypoint, name: $name, repo: $repo, runtime: $runtime, branch: $branch)';
  }
...
class _$_Func implements _Func {
  ...
  @override
  String toString() {
    return 'Func(updated: $updated, branch: $branch, repo: $repo, runtime: $runtime, subfolder: $subfolder, created: $created, env_vars: $env_vars, id: $id, entrypoint: $entrypoint, name: $name, region: $region, status: $status, source: $source, url: $url)';
  }
