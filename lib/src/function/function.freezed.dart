...
class _$_DeployRequest implements _DeployRequest {
  ...
  @override
  String toString() {
    return 'DeployRequest(env_vars: $env_vars, name: $name, source: $source, entrypoint: $entrypoint, region: $region, repo: $repo, runtime: $runtime, subfolder: $subfolder, branch: $branch)';
  }
...
class _$_Func implements _Func {
  ...
  @override
  String toString() {
    return 'Func(id: $id, name: $name, region: $region, runtime: $runtime, entrypoint: $entrypoint, env_vars: $env_vars, repo: $repo, updated: $updated, url: $url, created: $created, source: $source, subfolder: $subfolder, branch: $branch, status: $status)';
  }
