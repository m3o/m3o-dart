...
class _$_DeployRequest implements _DeployRequest {
  ...
  @override
  String toString() {
    return 'DeployRequest(region: $region, repo: $repo, entrypoint: $entrypoint, name: $name, runtime: $runtime, source: $source, subfolder: $subfolder, branch: $branch, env_vars: $env_vars)';
  }
...
class _$_Func implements _Func {
  ...
  @override
  String toString() {
    return 'Func(id: $id, region: $region, branch: $branch, entrypoint: $entrypoint, runtime: $runtime, status: $status, subfolder: $subfolder, created: $created, env_vars: $env_vars, url: $url, repo: $repo, source: $source, name: $name, updated: $updated)';
  }
