...
class _$_DeployRequest implements _DeployRequest {
  ...
  @override
  String toString() {
    return 'DeployRequest(branch: $branch, region: $region, runtime: $runtime, entrypoint: $entrypoint, env_vars: $env_vars, name: $name, repo: $repo, source: $source, subfolder: $subfolder)';
  }
...
class _$_Func implements _Func {
  ...
  @override
  String toString() {
    return 'Func(url: $url, region: $region, repo: $repo, env_vars: $env_vars, name: $name, updated: $updated, branch: $branch, created: $created, status: $status, subfolder: $subfolder, runtime: $runtime, source: $source, entrypoint: $entrypoint, id: $id)';
  }
