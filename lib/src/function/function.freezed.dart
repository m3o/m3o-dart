...
class _$_DeployRequest implements _DeployRequest {
  ...
  @override
  String toString() {
    return 'DeployRequest(branch: $branch, entrypoint: $entrypoint, env_vars: $env_vars, name: $name, repo: $repo, subfolder: $subfolder, region: $region, runtime: $runtime, source: $source)';
  }
...
class _$_Func implements _Func {
  ...
  @override
  String toString() {
    return 'Func(status: $status, branch: $branch, entrypoint: $entrypoint, env_vars: $env_vars, name: $name, source: $source, id: $id, created: $created, region: $region, runtime: $runtime, subfolder: $subfolder, url: $url, repo: $repo, updated: $updated)';
  }
