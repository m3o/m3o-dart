...
class _$_DeployRequest implements _DeployRequest {
  ...
  @override
  String toString() {
    return 'DeployRequest(branch: $branch, entrypoint: $entrypoint, region: $region, repo: $repo, runtime: $runtime, source: $source, subfolder: $subfolder, env_vars: $env_vars, name: $name)';
  }
...
class _$_Func implements _Func {
  ...
  @override
  String toString() {
    return 'Func(entrypoint: $entrypoint, env_vars: $env_vars, region: $region, source: $source, updated: $updated, url: $url, id: $id, name: $name, status: $status, subfolder: $subfolder, created: $created, repo: $repo, runtime: $runtime, branch: $branch)';
  }
