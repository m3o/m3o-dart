...
class _$_DeployRequest implements _DeployRequest {
  ...
  @override
  String toString() {
    return 'DeployRequest(branch: $branch, env_vars: $env_vars, name: $name, subfolder: $subfolder, entrypoint: $entrypoint, region: $region, repo: $repo, runtime: $runtime, source: $source)';
  }
...
class _$_Func implements _Func {
  ...
  @override
  String toString() {
    return 'Func(env_vars: $env_vars, name: $name, source: $source, status: $status, subfolder: $subfolder, branch: $branch, entrypoint: $entrypoint, repo: $repo, updated: $updated, url: $url, created: $created, id: $id, region: $region, runtime: $runtime)';
  }
