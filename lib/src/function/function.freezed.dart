...
class _$_DeployRequest implements _DeployRequest {
  ...
  @override
  String toString() {
    return 'DeployRequest(entrypoint: $entrypoint, name: $name, repo: $repo, branch: $branch, env_vars: $env_vars, region: $region, runtime: $runtime, source: $source, subfolder: $subfolder)';
  }
...
class _$_Func implements _Func {
  ...
  @override
  String toString() {
    return 'Func(region: $region, status: $status, subfolder: $subfolder, created: $created, entrypoint: $entrypoint, updated: $updated, id: $id, source: $source, branch: $branch, env_vars: $env_vars, name: $name, repo: $repo, runtime: $runtime, url: $url)';
  }
