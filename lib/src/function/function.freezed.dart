...
class _$_DeployRequest implements _DeployRequest {
  ...
  @override
  String toString() {
    return 'DeployRequest(branch: $branch, name: $name, repo: $repo, subfolder: $subfolder, entrypoint: $entrypoint, env_vars: $env_vars, region: $region, runtime: $runtime, source: $source)';
  }
...
class _$_Func implements _Func {
  ...
  @override
  String toString() {
    return 'Func(name: $name, region: $region, source: $source, subfolder: $subfolder, env_vars: $env_vars, created: $created, entrypoint: $entrypoint, repo: $repo, status: $status, updated: $updated, branch: $branch, runtime: $runtime, id: $id, url: $url)';
  }
