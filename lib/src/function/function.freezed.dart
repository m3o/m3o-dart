...
class _$_Func implements _Func {
  ...
  @override
  String toString() {
    return 'Func(updated: $updated, status: $status, created: $created, entrypoint: $entrypoint, id: $id, region: $region, env_vars: $env_vars, repo: $repo, source: $source, url: $url, branch: $branch, name: $name, runtime: $runtime, subfolder: $subfolder)';
  }
