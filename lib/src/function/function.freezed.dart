...
class _$_DeployRequest implements _DeployRequest {
  ...
  @override
  String toString() {
    return 'DeployRequest(entrypoint: $entrypoint, env_vars: $env_vars, name: $name, region: $region, repo: $repo, subfolder: $subfolder, branch: $branch, runtime: $runtime, source: $source)';
  }
...
class _$_Func implements _Func {
  ...
  @override
  String toString() {
    return 'Func(branch: $branch, env_vars: $env_vars, name: $name, subfolder: $subfolder, created: $created, runtime: $runtime, source: $source, id: $id, region: $region, repo: $repo, status: $status, url: $url, entrypoint: $entrypoint, updated: $updated)';
  }
