...
class _$_Func implements _Func {
  ...
  @override
  String toString() {
    return 'Func(name: $name, url: $url, repo: $repo, source: $source, status: $status, subfolder: $subfolder, created: $created, entrypoint: $entrypoint, id: $id, runtime: $runtime, updated: $updated, branch: $branch, env_vars: $env_vars, region: $region)';
  }
