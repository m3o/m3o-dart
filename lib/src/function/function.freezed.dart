...
class _$_DeployRequest implements _DeployRequest {
  ...
  @override
  String toString() {
    return 'DeployRequest(env_vars: $env_vars, name: $name, region: $region, subfolder: $subfolder, branch: $branch, entrypoint: $entrypoint, repo: $repo, runtime: $runtime, source: $source)';
  }
...
class _$_Func implements _Func {
  ...
  @override
  String toString() {
    return 'Func(branch: $branch, url: $url, created: $created, entrypoint: $entrypoint, env_vars: $env_vars, updated: $updated, id: $id, region: $region, repo: $repo, runtime: $runtime, source: $source, status: $status, subfolder: $subfolder, name: $name)';
  }
