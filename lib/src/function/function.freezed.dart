...
class _$_DeployRequest implements _DeployRequest {
  ...
  @override
  String toString() {
    return 'DeployRequest(source: $source, branch: $branch, region: $region, repo: $repo, runtime: $runtime, subfolder: $subfolder, entrypoint: $entrypoint, env_vars: $env_vars, name: $name)';
  }
...
class _$_Func implements _Func {
  ...
  @override
  String toString() {
    return 'Func(entrypoint: $entrypoint, source: $source, branch: $branch, env_vars: $env_vars, id: $id, region: $region, repo: $repo, url: $url, runtime: $runtime, subfolder: $subfolder, created: $created, name: $name, status: $status, updated: $updated)';
  }
