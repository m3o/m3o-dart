...
class _$_DeployRequest implements _DeployRequest {
  ...
  @override
  String toString() {
    return 'DeployRequest(repo: $repo, source: $source, subfolder: $subfolder, branch: $branch, env_vars: $env_vars, region: $region, runtime: $runtime, entrypoint: $entrypoint, name: $name)';
  }
...
class _$_Func implements _Func {
  ...
  @override
  String toString() {
    return 'Func(source: $source, url: $url, name: $name, repo: $repo, created: $created, status: $status, branch: $branch, id: $id, region: $region, runtime: $runtime, subfolder: $subfolder, updated: $updated, entrypoint: $entrypoint, env_vars: $env_vars)';
  }
