...
class _$_DeployRequest implements _DeployRequest {
  ...
  @override
  String toString() {
    return 'DeployRequest(branch: $branch, region: $region, repo: $repo, subfolder: $subfolder, source: $source, entrypoint: $entrypoint, env_vars: $env_vars, name: $name, runtime: $runtime)';
  }
...
class _$_Func implements _Func {
  ...
  @override
  String toString() {
    return 'Func(source: $source, status: $status, updated: $updated, env_vars: $env_vars, id: $id, region: $region, url: $url, branch: $branch, name: $name, repo: $repo, runtime: $runtime, subfolder: $subfolder, created: $created, entrypoint: $entrypoint)';
  }
