...
class _$_DeployRequest implements _DeployRequest {
  ...
  @override
  String toString() {
    return 'DeployRequest(entrypoint: $entrypoint, region: $region, repo: $repo, subfolder: $subfolder, branch: $branch, env_vars: $env_vars, name: $name, runtime: $runtime, source: $source)';
  }
...
class _$_Func implements _Func {
  ...
  @override
  String toString() {
    return 'Func(entrypoint: $entrypoint, env_vars: $env_vars, name: $name, source: $source, branch: $branch, id: $id, region: $region, created: $created, runtime: $runtime, status: $status, updated: $updated, repo: $repo, subfolder: $subfolder, url: $url)';
  }
