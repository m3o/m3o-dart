...
class _$_DeployRequest implements _DeployRequest {
  ...
  @override
  String toString() {
    return 'DeployRequest(repo: $repo, subfolder: $subfolder, branch: $branch, env_vars: $env_vars, name: $name, region: $region, runtime: $runtime, source: $source, entrypoint: $entrypoint)';
  }
...
class _$_Func implements _Func {
  ...
  @override
  String toString() {
    return 'Func(id: $id, runtime: $runtime, source: $source, created: $created, subfolder: $subfolder, updated: $updated, entrypoint: $entrypoint, region: $region, url: $url, branch: $branch, env_vars: $env_vars, name: $name, repo: $repo, status: $status)';
  }
