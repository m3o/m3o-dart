...
class _$_Func implements _Func {
  ...
  @override
  String toString() {
    return 'Func(runtime: $runtime, branch: $branch, created: $created, entrypoint: $entrypoint, id: $id, name: $name, source: $source, env_vars: $env_vars, region: $region, repo: $repo, status: $status, subfolder: $subfolder, updated: $updated, url: $url)';
  }
