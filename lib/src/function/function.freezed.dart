...
class _$_DeployRequest implements _DeployRequest {
  ...
  @override
  String toString() {
    return 'DeployRequest(region: $region, runtime: $runtime, source: $source, branch: $branch, entrypoint: $entrypoint, env_vars: $env_vars, name: $name, repo: $repo, subfolder: $subfolder)';
  }
...
class _$_Func implements _Func {
  ...
  @override
  String toString() {
    return 'Func(env_vars: $env_vars, name: $name, repo: $repo, runtime: $runtime, status: $status, subfolder: $subfolder, branch: $branch, updated: $updated, entrypoint: $entrypoint, id: $id, source: $source, url: $url, created: $created, region: $region)';
  }
