...
class _$_DeployRequest implements _DeployRequest {
  ...
  @override
  String toString() {
    return 'DeployRequest(subfolder: $subfolder, branch: $branch, entrypoint: $entrypoint, env_vars: $env_vars, repo: $repo, runtime: $runtime, name: $name, region: $region, source: $source)';
  }
...
class _$_Func implements _Func {
  ...
  @override
  String toString() {
    return 'Func(env_vars: $env_vars, entrypoint: $entrypoint, id: $id, repo: $repo, source: $source, subfolder: $subfolder, branch: $branch, created: $created, runtime: $runtime, status: $status, updated: $updated, name: $name, region: $region, url: $url)';
  }
