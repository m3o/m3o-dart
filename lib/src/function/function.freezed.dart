...
class _$_DeployRequest implements _DeployRequest {
  ...
  @override
  String toString() {
    return 'DeployRequest(branch: $branch, entrypoint: $entrypoint, name: $name, repo: $repo, subfolder: $subfolder, env_vars: $env_vars, region: $region, runtime: $runtime, source: $source)';
  }
...
class _$_Func implements _Func {
  ...
  @override
  String toString() {
    return 'Func(region: $region, source: $source, status: $status, id: $id, branch: $branch, env_vars: $env_vars, name: $name, repo: $repo, created: $created, entrypoint: $entrypoint, runtime: $runtime, subfolder: $subfolder, updated: $updated, url: $url)';
  }
