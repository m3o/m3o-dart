...
class _$_DeployRequest implements _DeployRequest {
  ...
  @override
  String toString() {
    return 'DeployRequest(entrypoint: $entrypoint, env_vars: $env_vars, region: $region, branch: $branch, repo: $repo, runtime: $runtime, source: $source, subfolder: $subfolder, name: $name)';
  }
...
class _$_Func implements _Func {
  ...
  @override
  String toString() {
    return 'Func(source: $source, name: $name, env_vars: $env_vars, runtime: $runtime, created: $created, url: $url, status: $status, entrypoint: $entrypoint, id: $id, region: $region, repo: $repo, subfolder: $subfolder, updated: $updated, branch: $branch)';
  }
