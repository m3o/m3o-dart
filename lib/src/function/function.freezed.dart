...
class _$_DeployRequest implements _DeployRequest {
  ...
  @override
  String toString() {
    return 'DeployRequest(region: $region, repo: $repo, runtime: $runtime, source: $source, subfolder: $subfolder, branch: $branch, env_vars: $env_vars, name: $name, entrypoint: $entrypoint)';
  }
...
class _$_Func implements _Func {
  ...
  @override
  String toString() {
    return 'Func(status: $status, url: $url, entrypoint: $entrypoint, id: $id, repo: $repo, subfolder: $subfolder, created: $created, env_vars: $env_vars, runtime: $runtime, source: $source, updated: $updated, branch: $branch, region: $region, name: $name)';
  }
