...
class _$_DeployRequest implements _DeployRequest {
  ...
  @override
  String toString() {
    return 'DeployRequest(repo: $repo, source: $source, branch: $branch, entrypoint: $entrypoint, env_vars: $env_vars, subfolder: $subfolder, name: $name, region: $region, runtime: $runtime)';
  }
...
class _$_Func implements _Func {
  ...
  @override
  String toString() {
    return 'Func(branch: $branch, repo: $repo, source: $source, url: $url, name: $name, runtime: $runtime, updated: $updated, created: $created, entrypoint: $entrypoint, env_vars: $env_vars, id: $id, region: $region, status: $status, subfolder: $subfolder)';
  }
