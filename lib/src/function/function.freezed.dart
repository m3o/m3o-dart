...
class _$_DeployRequest implements _DeployRequest {
  ...
  @override
  String toString() {
    return 'DeployRequest(runtime: $runtime, source: $source, entrypoint: $entrypoint, env_vars: $env_vars, region: $region, repo: $repo, branch: $branch, name: $name, subfolder: $subfolder)';
  }
...
class _$_Func implements _Func {
  ...
  @override
  String toString() {
    return 'Func(branch: $branch, created: $created, source: $source, url: $url, name: $name, status: $status, updated: $updated, entrypoint: $entrypoint, region: $region, repo: $repo, runtime: $runtime, env_vars: $env_vars, id: $id, subfolder: $subfolder)';
  }
