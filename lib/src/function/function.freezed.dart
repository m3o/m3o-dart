...
class _$_DeployRequest implements _DeployRequest {
  ...
  @override
  String toString() {
    return 'DeployRequest(entrypoint: $entrypoint, name: $name, region: $region, source: $source, subfolder: $subfolder, branch: $branch, env_vars: $env_vars, repo: $repo, runtime: $runtime)';
  }
...
class _$_Func implements _Func {
  ...
  @override
  String toString() {
    return 'Func(updated: $updated, name: $name, region: $region, runtime: $runtime, source: $source, created: $created, env_vars: $env_vars, repo: $repo, url: $url, id: $id, status: $status, branch: $branch, entrypoint: $entrypoint, subfolder: $subfolder)';
  }
