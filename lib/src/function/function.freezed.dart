...
class _$_DeployRequest implements _DeployRequest {
  ...
  @override
  String toString() {
    return 'DeployRequest(env_vars: $env_vars, name: $name, region: $region, runtime: $runtime, source: $source, branch: $branch, entrypoint: $entrypoint, repo: $repo, subfolder: $subfolder)';
  }
...
class _$_Func implements _Func {
  ...
  @override
  String toString() {
    return 'Func(name: $name, region: $region, repo: $repo, source: $source, branch: $branch, entrypoint: $entrypoint, runtime: $runtime, subfolder: $subfolder, url: $url, created: $created, status: $status, updated: $updated, env_vars: $env_vars, id: $id)';
  }
