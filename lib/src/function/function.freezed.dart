...
class _$_DeployRequest implements _DeployRequest {
  ...
  @override
  String toString() {
    return 'DeployRequest(env_vars: $env_vars, name: $name, repo: $repo, subfolder: $subfolder, branch: $branch, entrypoint: $entrypoint, region: $region, runtime: $runtime, source: $source)';
  }
...
class _$_Func implements _Func {
  ...
  @override
  String toString() {
    return 'Func(created: $created, repo: $repo, source: $source, updated: $updated, id: $id, status: $status, url: $url, subfolder: $subfolder, branch: $branch, entrypoint: $entrypoint, env_vars: $env_vars, region: $region, name: $name, runtime: $runtime)';
  }
