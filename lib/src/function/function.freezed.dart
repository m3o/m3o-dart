...
class _$_DeployRequest implements _DeployRequest {
  ...
  @override
  String toString() {
    return 'DeployRequest(subfolder: $subfolder, branch: $branch, entrypoint: $entrypoint, env_vars: $env_vars, name: $name, repo: $repo, source: $source, region: $region, runtime: $runtime)';
  }
...
class _$_Func implements _Func {
  ...
  @override
  String toString() {
    return 'Func(entrypoint: $entrypoint, id: $id, url: $url, updated: $updated, branch: $branch, created: $created, name: $name, source: $source, status: $status, region: $region, repo: $repo, env_vars: $env_vars, runtime: $runtime, subfolder: $subfolder)';
  }
