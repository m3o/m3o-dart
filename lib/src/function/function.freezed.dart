...
class _$_DeployRequest implements _DeployRequest {
  ...
  @override
  String toString() {
    return 'DeployRequest(env_vars: $env_vars, name: $name, source: $source, branch: $branch, region: $region, repo: $repo, runtime: $runtime, subfolder: $subfolder, entrypoint: $entrypoint)';
  }
...
class _$_Func implements _Func {
  ...
  @override
  String toString() {
    return 'Func(url: $url, created: $created, env_vars: $env_vars, id: $id, region: $region, status: $status, updated: $updated, entrypoint: $entrypoint, source: $source, subfolder: $subfolder, branch: $branch, name: $name, runtime: $runtime, repo: $repo)';
  }
